(()=>{function ze(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Re(t=!1){let e=window.location.pathname,r=e==="/"||e==="/index.html",a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ue=1e3;function W(t){let e=null,r=t.onClose||null,o=t.onOpen||null;function s(){e&&(e.style.zIndex=++Ue)}function a(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",g),o&&setTimeout(o,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ue,e.addEventListener("mousedown",s);let b=t.icon||"bx-window",n="",f="",T;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((v,i)=>{let u=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,T=`<div class="window-content">${t.tabs.map((v,i)=>`<div class="tab-content ${i===0?"active":""}" data-tab-content="${i}">${v.content}</div>`).join("")}</div>`):(t.title&&(f=`<div class="window-title">${t.title}</div>`),T=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
...
`,be=null,V=new Set,ve=[];async function J(t=!1){let e=document.getElementById("alerts-list");if(!e)return;_t(),t&&(e.innerHTML="<p>Updating...</p>");let r="/events?ml=1000&format=json&event.type=system.notification.generated";try{let o=await A(r);if(!o.ok)throw new Error("Service is offline or unreachable.");let a=(await o.json()).events||[];be=Date.now(),U(0,be);let g=Date.now(),d=24*60*60*1e3,c=a.filter(i=>{let u=localStorage.getItem(`alert_read_ts_${i.id}`);if(!u)return!0;let x=parseInt(u);return g-x<d});c.sort((i,u)=>{let x=S=>{let B=S.event;if(typeof B=="string")try{B=JSON.parse(B)}catch{return"low"}return(B.priority||"low").toLowerCase()},L=S=>S==="critical"?4:S==="high"?3:S==="medium"?2:1,w=L(x(i)),C=L(x(u));return w!==C?C-w:u.timestamp-i.timestamp}),ve=c;let m=i=>{let u=i.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return"low"}return(u.priority||"low").toLowerCase()},y=[],b=new Set(c.map(i=>m(i))).size>1;if(c.length>0){let i=null;c.forEach(u=>{let x=m(u);b&&x!==i&&(y.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),i=x),y.push(u)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=M("empty","No alerts yet."),ge();return}let n=i=>{let u=i.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let x=(u.title||"Untitled Alert").trim(),L=(u.body||"No description provided.").trim(),w=(u.priority||"low").toLowerCase(),C=!!u.alert,S=(u.category||"system").trim(),B=u.related_event_ids||[],D=u.audit_event_id,H=!!localStorage.getItem(`alert_read_ts_${i.id}`),O=new Date(i.timestamp*1e3),k=O.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),E=O.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=H?"event-border-grey":"event-border-blue";!H&&C&&($="event-border-red"),H&&(w==="high"||w==="critical")?$="event-border-red":H&&w==="medium"&&($="event-border-orange");let _=H?"alert-read":"alert-unread",I=V.has(i.id),R=I?"expanded":"",q=I?"display: block;":"display: none;",Me="",Be="";B.length>0&&(Be=`
            <div style="flex: 1; min-width: 150px;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
                    ${B.map(G=>`<a href="#" onclick="window.dexter.viewEvent('${G}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${G.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let De="";D&&(De=`
            ...
            `;let F=document.createElement("div");F.className=`event-item notification-item ${$} ${_} ${R} cursor-pointer priority-${w}`,F.dataset.alertId=i.id,F.onclick=function(G){if(this.classList.contains("expanded")){this.classList.remove("expanded"),V.delete(i.id);let ie=this.querySelector(".event-details");ie&&(ie.style.display="none")}else{this.classList.add("expanded"),V.add(i.id);let ie=this.querySelector(".event-details");if(ie&&(ie.style.display="block"),!localStorage.getItem(`alert_read_ts_${i.id}`)){localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ee="event-border-grey";w==="high"||w==="critical"?Ee="event-border-red":w==="medium"&&(Ee="event-border-orange"),this.classList.add(Ee),ge()}}};let Qt=x,Tt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[S]||"bx-bell";F.innerHTML=`
                ...
                <div class="event-content">
                    <div class="event-service">
                        ...
                        DEXTER ${C?'<span class="alert-badge" style="color: #ff4d4d; font-size: 0.8em; margin-left: 5px;">[ALERT]</span>':""}
                    </div>
...
`,st=null,se=new Set,at=[];async function ne(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Nt();let r="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let o=await A(r);if(!o.ok)throw new Error("Service is offline or unreachable.");let a=(await o.json()).events||[];if(at=a,st=Date.now(),U(2,st),a.length===0){e.innerHTML=M("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),oe(2,0);return}t&&(e.innerHTML="");let g=p=>{let b=p.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let n=(b.title||"Untitled Blueprint").trim(),f=(b.summary||b.body||"No summary provided.").trim(),T=(b.content||"").trim(),h=(b.category||"architecture").trim(),l=(b.affected_services||[]).map(I=>I.trim()),v=(b.implementation_path||[]).map(I=>I.trim()),i=b.approved===!0,u=new Date(p.timestamp*1e3),x=u.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),L=u.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),w=se.has(p.id),C=w?"display: block;":"display: none;",S=document.createElement("div");S.className=`event-item notification-item event-border-purple cursor-pointer ${w?"expanded":""} ${i?"blueprint-approved":""}`,S.dataset.blueprintId=p.id,i&&(S.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",S.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let D=i?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";S.onclick=function(I){if(this.classList.contains("expanded")){this.classList.remove("expanded"),se.delete(p.id);let q=this.querySelector(".event-details");q&&(q.style.display="none")}else{this.classList.add("expanded"),se.add(p.id);let q=this.querySelector(".event-details");q&&(q.style.display="block")}};let z="";v.length>0&&(z=`
                ...
                `);let H=l.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${l.join(", ")}</span></div>`:"<div></div>",O=i?`
            ...
            `;S.innerHTML=`
                ...
                <div class="event-content">
                    ...
                    <div class="event-details" style="${C}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px; color: #fff;">${N(f)}</div>
...
`,xe=null,X=new Set,ce=[],P="all",Pt={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed"],moderation:["moderation.explicit_content.deleted"]},Ot={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Ut(t){for(let[e,r]of Object.entries(Pt))if(r.includes(t))return e;return"system"}function qt(t){return Ot[t]||"bx-square-rounded"}async function Q(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Ft();let o=`/events?ml=${P==="all"?100:250}&format=json`;P!=="all"&&(o+=`&category=${P}`);try{let s=await A(o);if(!s.ok)throw new Error("Service unreachable");if(ce=((await s.json()).events||[]).filter(b=>{let n=b.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return!0}let f=n.type;return!(f==="system.blueprint.generated"||f==="system.notification.generated")}),xe=Date.now(),U(1,xe),ce.length===0){e.innerHTML=M("empty","No events found for this filter.");return}t&&(e.innerHTML="");let d=b=>{let n=b.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return null}let f=n.type,T=Ut(f),h=qt(f),l=f==="engagement.decision"||f==="messaging.bot.sent_message"||f==="messaging.user.sent_message"||f==="moderation.explicit_content.deleted"||f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="system.cli.command"||f==="system.analysis.audit"||f==="system.test.completed"||f==="error_occurred"||f==="system.cli.status"||f==="system.attention.expired"||f.startsWith("system.roadmap")||f.startsWith("system.process"),v="event-border-grey";l&&(f==="moderation.explicit_content.deleted"||f==="error_occurred"?v="event-border-red":f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="system.analysis.audit"?v="event-border-purple":f==="system.attention.expired"||f==="system.cli.command"||f==="system.cli.status"?v="event-border-orange":f==="system.test.completed"?v=n.test?.status==="OK"&&n.lint?.status==="OK"&&n.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let i=l?"cursor-pointer":"",u=X.has(b.id),x=u?"expanded":"",L=u?"display: block;":"display: none;",w=new Date(b.timestamp*1e3),C=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),B=lt(f,n),D=n.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${n.user_level})</span>`:"",z="";if(l){let k="";if(f==="engagement.decision"){let E=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                    ...
                    `}else if(f==="system.attention.expired"){let E=I=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${I}</h5>`,$=n.timestamp-n.last_active,_=Math.floor($/60);k=`
                    ...
                    `}else if(f==="system.analysis.audit"){let E=n.success?"#03dac6":"#ff4d4d",$=n.success?"SUCCESS":"FAILED",_=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,I="";n.error&&(I=`
                            <div class="event-detail-block">
                                ${_("Error")}
                    ...
                    `}else if(f==="messaging.user.sent_message"){let E="";n.attachments&&n.attachments.length>0&&(E=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${n.attachments.map(_=>{let I=_.content_type&&_.content_type.startsWith("image/"),R=(_.size/1024).toFixed(1)+" KB";return`
...
`);return`
            ...
            ${ct()}
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):a.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),g&&l.STORAGE&&l.STORAGE.length>0?g.innerHTML=l.STORAGE.map(v=>{let i=(v.USED/1073741824).toFixed(1),u=(v.SIZE/(1024*1024*1024)).toFixed(1),x=v.SIZE>0?(v.USED/v.SIZE*100).toFixed(0):0,L=v.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):g&&(g.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let l=await pt();l?(d(l),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},e.dataset.listenerAttached="true"),o&&!o.hasChildNodes())){let l=await pt();d(l)}if(!t)return;let c=await ht();if(!c||!c.services){t.children.length===0&&(t.innerHTML=M("offline","Failed to load system metrics.","The event service may be offline."));return}dt=Date.now(),U(0,dt);let m=c.services||[];Array.from(t.children).forEach(l=>{l.classList.contains("service-widget")||l.remove()});function y(l){return!l||l==="N/A"||l==="unknown"||l.trim()===""?"-":l}function p(l){if(!l||l==="N/A"||l==="unknown")return"-";let v=l.match(/^(\d+\.\d+\.\d+)/);return v?v[0]:l.split(".").slice(0,3).join(".")||"-"}function b(l){return!l||l.length<=28?l:l.substring(0,28)+"..."}function n(l){if(!l||l==="N/A"||l==="unknown")return"-";let v=l.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!v)return"-";let i=parseInt(v[1])||0,u=parseInt(v[2])||0,x=parseInt(v[3])||0,L=parseFloat(v[4])||0,w=i*86400+u*3600+x*60+L,C=Math.floor(w/86400);if(C>0)return`${C}d`;let S=Math.floor(w/3600);if(S>0)return`${S}h`;let B=Math.floor(w/60);return B>0?`${B}m`:`${Math.floor(w)}s`}function f(l){let v=l.status==="online",i=v?"service-widget-online":"service-widget-offline",u=v?"bx-check-circle":"bx-x-circle",x=v?"OK":"BAD",L=l.version?p(l.version.str):"-",w=l.cpu&&l.cpu!=="N/A"?l.cpu:"-",C=l.memory&&l.memory!=="N/A"?l.memory:"-",S=w!=="-"?"#00ff00":"#666",B=w!=="-"?"#fff":"#666",D=C!=="-"?"#00ff00":"#666",z=C!=="-"?"#fff":"#666",H=n(l.uptime),O="";return v?O=`
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${z};">${C}</span>
                    </div>
                </div>`:O='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${i}" data-service-id="${l.id}"><div class="service-widget-header"><i class="bx ${u}"></i><h3>${l.short_name||l.id}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${b(l.domain&&l.port?`${l.domain}:${l.port}`:"")}</span></div>${O}</div></div>`}let T=new Map(Array.from(t.querySelectorAll(".service-widget")).map(l=>[l.dataset.serviceId,l])),h=new Set(m.map(l=>l.id));for(let[l,v]of T)h.has(l)||v.remove();m.forEach(l=>{let v=f(l),i=T.get(l.id);i?i.outerHTML!==v&&(i.outerHTML=v):t.insertAdjacentHTML("beforeend",v)})}async function Ie(){let t=document.getElementById("models-widgets");if(!t)return;let e=await ht();if(!e){t.children.length===0&&(t.innerHTML=M("offline","Failed to load model status.","The event service may be offline."));return}mt=Date.now(),U(2,mt);let r=e.models||[],o=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function s(c){let m=c.status==="Ready";return`
        ...
        `)};e&&v(e,document.getElementById("guardian-t1-stats"),c.t1,"t1"),r&&v(r,document.getElementById("guardian-t2-stats"),c.t2,"t2");let i=document.getElementById("system-state-label"),u=document.getElementById("system-state-val");if(u&&c.system_state){let x=c.system_state,L=formatDuration(c.system_state_time||0);i&&(i.textContent=`State: ${x.toUpperCase()}`),u.textContent=L,x==="idle"?u.style.color=c.system_state_time>300?"#5eff5e":"#fff":u.style.color="#bb86fc"}s&&(s.textContent=formatDuration(c.total_idle_time||0)),a&&(a.textContent=formatDuration(c.total_active_time||0)),g&&(g.textContent=formatDuration(c.total_waste_time||0))}else[e,r,o,s,a,g].forEach(h=>{h&&(h.textContent="-",h.style.color="#666")});let m=await Gt(),y=[],p=[],b=[];m&&(Array.isArray(m)?y=m:(y=m.active||[],p=m.queue||[],b=m.history||[],b.sort((T,h)=>(h.end_time||0)-(T.end_time||0)))),y.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=M("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),Le(t,y,!1));let n=document.getElementById("processes-queue-widgets");n&&(p.length===0?!n.querySelector(".tab-placeholder")&&!n.querySelector('div[style*="font-style: italic"]')&&(n.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(n.innerHTML="",Le(n,p,!1)));let f=document.getElementById("processes-history-widgets");f&&(b.length===0?f.querySelector(".tab-placeholder")||(f.innerHTML=M("empty","No recent history.")):(f.querySelector(".tab-placeholder")&&(f.innerHTML=""),Le(f,b,!0))),oe(1,y.length)}function Le(t,e,r){function o(d){let c="";d.end_time?c=`${d.end_time-d.start_time}s`:c=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let m=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",y=d.channel_id,p={"system-guardian":"Guardian Worker","system-cli-op":"CLI Operation"};if(p[y]?y=p[y]:/^\d+$/.test(y)&&(y=`Channel ${y}`),r)return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Jt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),_e=!0,r}function wt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),_e=!1}function Et(t,e,r="output"){if(!_e)return;let o=document.createElement("div");o.className=`terminal-line terminal-${r}`,r==="prompt"?o.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:o.innerHTML=fe(e),t.appendChild(o),t.scrollTop=t.scrollHeight}async function Yt(t){let e=$t.find(s=>s.id===t);if(!e)return;let r=Kt(e);Et(r,`dex ${t}`,"prompt");let o=e.demo_output||["Executing command...","\u2713 Done."];for(let s of o){await new Promise(g=>setTimeout(g,400+Math.random()*600));let a="output";s.includes("[ERROR]")?a="error":s.includes("[SUCCESS]")||s.includes("\u2713")?a="success":s.includes("!")&&(a="warning"),Et(r,s,a)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function St(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Jt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let r=e.querySelector("code").textContent;navigator.clipboard.writeText(r).then(()=>{let o=e.querySelector("i");o.className="bx bx-check",o.style.color="#5eff5e",setTimeout(()=>{o.className="bx bx-copy",o.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(r=>{r.addEventListener("mouseenter",()=>{r.style.transform="translateY(-5px)",r.style.borderColor="rgba(255,255,255,0.15)",r.style.backgroundColor="rgba(255,255,255,0.05)"}),r.addEventListener("mouseleave",()=>{r.style.transform="translateY(0)",r.style.borderColor="rgba(255,255,255,0.05)",r.style.backgroundColor="rgba(255,255,255,0.03)"}),r.addEventListener("click",()=>{let o=r.dataset.cmd;Yt(o)})})}async function Xt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${$e()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Ct(){Xt(),Ve(),ze();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&St();let e=qe();Re(e),Oe();let r=document.getElementById("nav-left-container");r&&r.addEventListener("click",()=>{if(a.length>0)p();else{let i=window.location.pathname;if(!(i==="/"||i==="/index.html")){let L=(i.endsWith("/")&&i.length>1?i.slice(0,-1):i).split("/");L.pop();let w=L.join("/")||"/";window.location.href=w}}});let o=window.location.pathname==="/"||window.location.pathname==="/index.html",s=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!o&&!s&&document.querySelector("footer")?.classList.add("hide");let a=[],g=document.getElementById("windows-container");g&&g.setAttribute("data-count","0");let d=i=>{localStorage.setItem("dex_last_window",i)};function c(){return 1}function m(){for(;a.length>1;)a.shift().close(!0);let i=document.getElementById("windows-container"),u=document.querySelector("nav"),x=document.querySelector("footer"),L=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");i&&i.setAttribute("data-count",a.length),a.forEach(D=>{let z=document.getElementById(D.id);z&&z.classList.remove("hide-close")}),me(ae());let C=document.getElementById("dexter-menu-container"),S=document.getElementById("nav-window-switcher"),B=document.getElementById("settings-icon");if(Pe(a.length>0),a.length>0){if(x?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),u?.classList.add("window-open"),i&&(i.style.paddingTop="60px"),C&&(C.style.display="none"),B&&(B.style.display="none"),S){let D=a[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(D)?(S.innerHTML=`
            ...
            <div class="dropdown-item" id="workspace-menu-item"><i class='bx bx-brain'></i> Workspace</div>
        `);let u=document.getElementById("dexter-menu-container"),x=document.getElementById("dexter-menu-btn");u&&i&&x&&(u.addEventListener("mouseenter",()=>{i.classList.add("active"),x.classList.add("active")}),u.addEventListener("mouseleave",()=>{i.classList.remove("active"),x.classList.remove("active")}),x.addEventListener("click",L=>{L.stopPropagation();let w=localStorage.getItem("dex_last_window")||"alerts-window",C=null;w==="alerts-window"?C=b:w==="events-window"?C=n:w==="monitor-window"?C=T:w==="contacts-window"?C=f:w==="workspace-window"&&(C=h),C&&y(C)})),document.getElementById("alerts-menu-item")?.addEventListener("click",()=>{d("alerts-window"),y(b)}),document.getElementById("events-menu-item")?.addEventListener("click",()=>{d("events-window"),y(n)}),document.getElementById("monitor-menu-item")?.addEventListener("click",()=>{d("monitor-window"),y(T)}),document.getElementById("contacts-menu-item")?.addEventListener("click",()=>{d("contacts-window"),y(f)}),document.getElementById("workspace-menu-item")?.addEventListener("click",()=>{d("workspace-window"),y(h)}),document.getElementById("settings-icon")?.addEventListener("click",()=>y(l)),document.getElementById("close-all-windows")?.addEventListener("click",()=>p()),setInterval(()=>{b.isOpen()?J():Qe(),n.isOpen()&&Q(),T.isOpen()&&yt(),h.isOpen()&&Se()},5e3)}else document.getElementById("login-btn")?.addEventListener("click",()=>{v.open(),setTimeout(()=>{document.getElementById("login-form")?.addEventListener("submit",i=>{i.preventDefault();try{je(document.getElementById("email-input").value),window.location.reload()}catch(u){let x=document.getElementById("login-error");x&&(x.textContent=u.message,x.style.display="block")}})},100)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ct):Ct();})();
