(()=>{function _e(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ae(t=!1){let a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Me=1e3;function G(t){let e=null,a=t.onClose||null,i=t.onOpen||null;function o(){e&&(e.style.zIndex=++Me)}function r(){if(e){e.classList.add("open"),o(),window.addEventListener("resize",c),i&&setTimeout(i,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",e.style.zIndex=++Me,e.addEventListener("mousedown",o);let m=t.icon||"bx-window",n="",s="",l;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((w,d)=>{let v=w.icon?`<i class="bx ${w.icon}"></i>`:`<span class="tab-glyph">${w.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${l}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),u()}),window.addEventListener("resize",c),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let x=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(w=>w.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(w=>w.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${x}"]`).classList.add("active"),g(y,e)})}),setTimeout(()=>{e.classList.add("open"),i&&i()},10)}function c(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&g(p,e)}function g(p,m){setTimeout(()=>{let n=m.querySelector(".tab-bar");if(!n)return;let s=Array.from(n.querySelectorAll(".tab")),l=s.indexOf(p),y=n.clientWidth,x=s[Math.max(0,l-2)],w=s[Math.min(s.length-1,l+2)],d=x.offsetLeft-n.offsetLeft-25,h=w.offsetLeft+w.offsetWidth-n.offsetLeft+25-d,C=h<=y?d-(y-h)/2:p.offsetLeft-n.offsetLeft-y/2+p.offsetWidth/2;n.scrollTo({left:C,behavior:"smooth"})},350)}function u(p=!1){e&&(window.removeEventListener("resize",c),p?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function f(p){let m=e?.querySelector(".window-content");m&&(m.innerHTML=p)}function b(){return e&&e.classList.contains("open")}return{open:r,close:u,setContent:f,isOpen:b,focus:o,id:t.id}}function Be(){return!0}function De(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Ne(t){localStorage.setItem("easter_user_email",t.trim())}var He="easter_theme",D={AUTO:"auto",DEFAULT:"default",ANIMATED:"animated"};function ve(){return localStorage.getItem(He)||D.AUTO}function pt(){let t=window.innerWidth,e=window.innerHeight,a=window.innerHeight===window.screen.height&&window.innerWidth===window.screen.width;return t>1920&&e>1080?D.ANIMATED:(t===1920&&e===1080&&a||t<=1920||e<=1080,D.DEFAULT)}function Oe(t){if(!Object.values(D).includes(t))throw new Error("Invalid theme");localStorage.setItem(He,t),ge(t)}function ge(t,e=!1){let a=document.body,i=t===D.AUTO?pt():t;if(e||(a.classList.add("theme-transitioning"),setTimeout(()=>{a.classList.remove("theme-transitioning")},300)),Object.values(D).forEach(o=>{a.classList.remove(`theme-${o}`)}),a.classList.add(`theme-${t}`),i===D.ANIMATED){if(!document.querySelector(".background")){let o=document.createElement("div");o.className="background",document.body.prepend(o)}}else{let o=document.querySelector(".background");o&&(e?o.remove():(o.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{o.remove()},400)))}}function Pe(){let t=ve();if(ge(t,!0),t===D.AUTO){let e;window.addEventListener("resize",()=>{clearTimeout(e),e=setTimeout(()=>{ge(D.AUTO)},300)})}}function T(t,e,a=null){let o={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${o} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function k(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function N(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let i=Date.now(),o=Math.floor((i-e)/1e3),r;o<60?r=`${o}s ago`:o<3600?r=`${Math.floor(o/60)}m ago`:r=`${Math.floor(o/3600)}h ago`,a.textContent=`Last updated: ${r}`}function z(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let i=a.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e,i.style.display="flex"):i.style.display="none")}function ie(){let t=document.getElementById("notifications-list");if(!t)return;let e=t.querySelectorAll(".notification-unread").length;z(0,e)}function ye(){return"https://event.easter.company"}function mt(){return"https://discord.easter.company"}var ut="http://127.0.0.1:8100",ft="http://127.0.0.1:8300",gt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function ae(t){let e=k(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(o,r)=>{let c=gt[r];return c?`<span class="${c}">`:""});let a=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return a>i&&(e+="</span>".repeat(a-i)),e}var V=null,J=null,se=!1,ne=!1;async function L(t,e={}){if(V)try{let o=await fetch(V+t,e);if(o.ok)return o;V=null}catch{V=null}let a=ye(),i=ut;try{let o=await fetch(a+t,e);if(o.ok)return V=a,se&&(console.log("\u2728 Production event service restored."),se=!1),o;throw new Error("Primary failed")}catch{se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),se=!0);try{let r=await fetch(i+t,e);if(r.ok)return V=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function ze(t,e={}){if(J)try{let o=await fetch(J+t,e);if(o.ok)return o;J=null}catch{J=null}let a=mt(),i=ft;try{let o=await fetch(a+t,e);if(o.ok)return J=a,ne&&(console.log("\u2728 Production discord service restored."),ne=!1),o;throw new Error("Primary failed")}catch{ne||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),ne=!0);try{let r=await fetch(i+t,e);if(r.ok)return J=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Ue=()=>`
...
`,oe=null,R=new Set,le=[];async function j(t=!1){let e=document.getElementById("notifications-list");if(!e)return;vt(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await L(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];oe=Date.now(),N(0,oe);let c=Date.now(),g=24*60*60*1e3,u=r.filter(d=>{let v=localStorage.getItem(`notification_read_ts_${d.id}`);if(!v)return!0;let h=parseInt(v);return c-h<g});u.sort((d,v)=>{let h=I=>{let _=I.event;if(typeof _=="string")try{_=JSON.parse(_)}catch{return"low"}return(_.priority||"low").toLowerCase()},C=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,$=C(h(d)),E=C(h(v));return $!==E?E-$:v.timestamp-d.timestamp}),le=u;let f=d=>{let v=d.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return"low"}return(v.priority||"low").toLowerCase()},b=[],m=new Set(u.map(d=>f(d))).size>1;if(u.length>0){let d=null;u.forEach(v=>{let h=f(v);m&&h!==d&&(b.push({id:`divider-${h}`,type:"divider",label:h.toUpperCase()}),d=h),b.push(v)})}if(t&&(e.innerHTML=""),u.length===0){e.innerHTML=T("empty","No notifications yet."),ie();return}let n=d=>{let v=d.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let h=v.title||"Untitled Notification",C=v.body||"No description provided.",$=v.priority||"low",E=!!v.alert,I=v.category||"system",_=v.related_event_ids||[],H=!!localStorage.getItem(`notification_read_ts_${d.id}`),P=new Date(d.timestamp*1e3),M=P.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=P.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=H?"event-border-grey":"event-border-blue";!H&&E&&(A="event-border-red"),H&&($==="high"||$==="critical")?A="event-border-red":H&&$==="medium"&&(A="event-border-orange");let O=H?"notification-read":"notification-unread",B=R.has(d.id),pe=B?"expanded":"",me=B?"display: block;":"display: none;",Se="",ke="";_.length>0&&(ke=`
...
`,q=new Set,je=[],K=null;async function F(t=!1){let e=document.getElementById("roadmap-list");if(e){yt();try{let a=await L("/roadmap");if(!a.ok)throw new Error("Offline");let i=await a.json();if(je=i,i.length===0){e.innerHTML=T("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let o=f=>{let b=q.has(f.id),p=f.state==="draft",m=f.state==="published",n=f.state==="consumed",s="event-border-grey";m&&(s="event-border-blue"),n&&(s="event-border-purple");let y=new Date(f.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),x=document.createElement("div");x.className=`event-item notification-item ${s} cursor-pointer ${b?"expanded":""}`,x.dataset.itemId=f.id,x.onclick=d=>{if(d.target.closest("button"))return;x.classList.contains("expanded")?(x.classList.remove("expanded"),x.querySelector(".event-details").style.display="none",q.delete(f.id)):(x.classList.add("expanded"),x.querySelector(".event-details").style.display="block",q.add(f.id))};let w=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${f.state.toUpperCase()}]</span>`;return x.innerHTML=`
        <div class="event-time">
      ...
      `,x.querySelector(".edit-btn")?.addEventListener("click",()=>bt(f)),x.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ht(f)),x.querySelector(".delete-btn")?.addEventListener("click",()=>xt(f.id)),x.querySelector(".close-details-btn")?.addEventListener("click",d=>{d.stopPropagation(),x.classList.remove("expanded"),x.querySelector(".event-details").style.display="none",q.delete(f.id)}),x},r=Array.from(e.children),c=new Map(r.map(f=>[f.dataset.itemId,f])),g=new Set(i.map(f=>f.id));r.forEach(f=>{let b=f.dataset.itemId;(!b||!g.has(b))&&f.remove()});let u=null;i.forEach((f,b)=>{let p=c.get(f.id);(!p||t)&&(p&&p.remove(),p=o(f),!p)||(b===0?e.firstElementChild!==p&&e.prepend(p):u&&u.nextElementSibling!==p&&u.after(p),u=p)})}catch{e.innerHTML=T("error","Failed to load roadmap.")}}}function yt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),o=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{K=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",K=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input").value;if(!r.trim())return;let c=K?`/roadmap/${K}`:"/roadmap",g=K?"PATCH":"POST";try{await L(c,{method:g,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})}),document.getElementById("roadmap-editor-container").style.display="none",F(!0)}catch(u){console.error(u)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{je.forEach(r=>q.add(r.id)),F(!0)},i.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{q.clear(),F(!0)},o.dataset.listenerAttached="true")}function bt(t){K=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function ht(t){let e=t.state==="published"?"draft":"published";try{await L(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),F(!0)}catch(a){console.error(a)}}async function xt(t){if(confirm("Delete this roadmap item?"))try{await L(`/roadmap/${t}`,{method:"DELETE"}),q.delete(t),F(!0)}catch(e){console.error(e)}}var Fe=()=>`
    <div class="notifications-actions">
...
`,qe=null,Y=new Set,We=[];async function re(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;wt();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await L(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];if(We=r,qe=Date.now(),N(2,qe),r.length===0){e.innerHTML=T("empty","No architectural blueprints generated yet.","The Analyst Worker will generate these when idle."),z(1,0);return}t&&(e.innerHTML="");let c=p=>{let m=p.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let n=m.title||"Untitled Blueprint",s=m.summary||m.body||"No summary provided.",l=m.content||"",y=m.category||"architecture",x=m.affected_services||[],w=m.implementation_path||[],d=new Date(p.timestamp*1e3),v=d.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),h=d.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),C=Y.has(p.id),$=C?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${C?"expanded":""}`,E.dataset.blueprintId=p.id,E.onclick=function(H){if(this.classList.contains("expanded")){this.classList.remove("expanded"),Y.delete(p.id);let M=this.querySelector(".event-details");M&&(M.style.display="none")}else{this.classList.add("expanded"),Y.add(p.id);let M=this.querySelector(".event-details");M&&(M.style.display="block")}};let I=x.length>0?`<div class="blueprint-meta-row"><strong>Affected:</strong> ${x.join(", ")}</div>`:"",_="";w.length>0&&(_=`
                    <div class="blueprint-path">
                        <h5>Implementation Path</h5>
                        <ul>
                            ${w.map(H=>`<li>${k(H)}</li>`).join("")}
                        </ul>
                    </div>
                `),E.innerHTML=`
                <div class="event-time">
            ...
            `;let W=E.querySelector(".close-details-btn");return W&&W.addEventListener("click",H=>{H.stopPropagation(),E.classList.remove("expanded");let P=E.querySelector(".event-details");P&&(P.style.display="none"),Y.delete(p.id)}),E},g=Array.from(e.children),u=new Map(g.map(p=>[p.dataset.blueprintId,p])),f=new Set(r.map(p=>p.id));g.forEach(p=>{let m=p.dataset.blueprintId;(!m||!f.has(m))&&p.remove()});let b=null;r.forEach((p,m)=>{let n=u.get(p.id);(!n||t)&&(n&&n.remove(),n=c(p),!n)||(m===0?e.firstElementChild!==n&&e.prepend(n):b&&b.nextElementSibling!==n&&b.after(n),b=n)}),z(2,r.length)}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=T("offline","Failed to load blueprints.","The event service may be offline or unreachable."))}}function wt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{We.forEach(a=>Y.add(a.id)),re(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Y.clear(),re(!0)},e.dataset.listenerAttached="true")}var Ge=()=>`
...
`;async function be(){await Promise.all([F(),re()])}var Je=()=>`
    <div class="notifications-actions">
...
`,Ve=null;async function he(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=()=>he(),e.dataset.listenerAttached="true");try{let a=await ze("/contacts");if(!a.ok)throw new Error("Service unreachable");let o=(await a.json()).members||[];if(Ve=Date.now(),N(4,Ve),o.length===0){t.innerHTML=T("empty","No contacts found.","Check your Discord connection.");return}let r={Me:0,"Master User":1,Admin:2,Moderator:3,Contributor:4,User:5,Anyone:6};o.sort((c,g)=>{let u=r[c.level]??10,f=r[g.level]??10;return u!==f?u-f:c.username.localeCompare(g.username)}),t.innerHTML=o.map(c=>{let g=c.color?"#"+c.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",u=c.status==="online"?"#5eff5e":c.status==="idle"?"#ffa500":c.status==="dnd"?"#ff4d4d":"#666",f="#888";c.level==="Me"||c.level==="Master User"?f="#bb86fc":c.level==="Admin"?f="#cf6679":c.level==="Moderator"?f="#03dac6":c.level==="Contributor"&&(f="#ffa500");let b=c.level==="Me",p=b?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",m=b?"2px solid #bb86fc":`1px solid ${g}33`;return`
                <div class="user-profile-section" style="background: ${p}; padding: 15px; border-radius: 8px; border: ${m}; display: flex; align-items: center; gap: 12px; position: relative; overflow: hidden;">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        ...
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${f}; font-weight: 600; text-transform: uppercase;">${b?"DEXTER (ME)":c.level}</span>
                        </div>
...
`,ce=null,X=new Set,te=[],de="all",$t={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed"],moderation:["moderation.explicit_content.deleted"]},Lt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Ye(t){for(let[e,a]of Object.entries($t))if(a.includes(t))return e;return"system"}function Tt(t){return Lt[t]||"bx-square-rounded"}async function Z(t=!1){let e=document.getElementById("events-timeline");if(!e)return;St();let i=`/events?ml=${de==="all"?100:250}&format=json&exclude_types=system.notification.generated`;try{let o=await L(i);if(!o.ok)throw new Error("Service is offline or unreachable.");let c=(await o.json()).events||[],g=c;if(de!=="all"&&(g=c.filter(n=>{let s=n.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!1}return Ye(s.type)===de})),te=g.slice(0,50),ce=Date.now(),N(1,ce),te.length===0){e.innerHTML=T("empty","No events found for this filter.");return}t&&(e.innerHTML="");let u=n=>{let s=n.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let l=s.type,y=Ye(l),x=Tt(l),w=l==="engagement.decision"||l==="messaging.bot.sent_message"||l==="messaging.user.sent_message"||l==="moderation.explicit_content.deleted"||l==="analysis.link.completed"||l==="analysis.visual.completed"||l==="system.cli.command"||l==="system.analysis.audit"||l==="system.test.completed"||l==="error_occurred"||l==="system.cli.status"||l.startsWith("system.roadmap")||l.startsWith("system.process"),d="event-border-grey";w&&(l==="moderation.explicit_content.deleted"||l==="error_occurred"?d="event-border-red":l==="analysis.link.completed"||l==="analysis.visual.completed"||l==="system.analysis.audit"?d="event-border-purple":l==="system.cli.command"||l==="system.cli.status"?d="event-border-orange":l==="system.test.completed"?d=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let v=w?"cursor-pointer":"",h=X.has(n.id),C=h?"expanded":"",$=h?"display: block;":"display: none;",E=new Date(n.timestamp*1e3),I=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),W=Ke(l,s),H=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",P="";if(w){let S="";if(l==="engagement.decision")S=`
                    ...
                    `;else if(l==="analysis.visual.completed"){let A="";s.base64_preview?A=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(A=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(l==="messaging.user.sent_message"){let A="";s.attachments&&s.attachments.length>0&&(A=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(B=>{let pe=B.content_type&&B.content_type.startsWith("image/"),me=(B.size/1024).toFixed(1)+" KB";return`
                ...
                `}let M=document.createElement("div");if(M.className=`event-item ${d} ${v} ${C}`,M.dataset.eventId=n.id,M.onclick=function(S){if(!w)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),X.delete(n.id);let O=this.querySelector(".event-details");O&&(O.style.display="none")}else{this.classList.add("expanded"),X.add(n.id);let O=this.querySelector(".event-details");O&&(O.style.display="block")}},M.innerHTML=`
                <div class="event-time">
            ...
            `,w){let S=M.querySelector(".close-details-btn");S&&S.addEventListener("click",A=>{A.stopPropagation();let O=A.target.closest(".event-item");if(O){O.classList.remove("expanded"),X.delete(n.id);let B=O.querySelector(".event-details");B&&(B.style.display="none")}})}return M},f=Array.from(e.children),b=new Map(f.map(n=>[n.dataset.eventId,n])),p=new Set(te.map(n=>n.id));f.forEach(n=>{let s=n.dataset.eventId;(!s||!p.has(s))&&n.remove()});let m=null;te.forEach((n,s)=>{let l=b.get(n.id);(!l||t)&&(l&&l.remove(),l=u(n),!l)||(s===0?e.firstElementChild!==l&&e.prepend(l):m&&m.nextElementSibling!==l&&m.after(l),m=l)}),ce=Date.now(),N(1,ce)}catch(o){console.error("Error fetching events:",o),e.children.length===0&&(e.innerHTML=T("offline","Failed to load events.","The event service may be offline or unreachable."))}}function St(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),a=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{te.forEach(i=>X.add(i.id)),Z(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{X.clear(),Z(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{a.querySelectorAll(".filter-btn").forEach(o=>o.classList.remove("active")),i.classList.add("active"),de=i.dataset.filter,Z(!0)}}),a.dataset.listenerAttached="true")}function Ze(){return`
...
`),u=[...c.logs];if(u.length<25){let b=25-u.length;for(let p=0;p<b;p++)u.push("")}else u.length>25&&(u=u.slice(-25));let f=u.map(b=>ae(b)).join(`
`);return`
    ...
    `;async function we(){await Promise.all([at(),At(),It()]),await xe()}var Qe=null,et=null,tt=null;async function it(){try{return await(await L("/system_monitor")).json()}catch{return null}}async function st(){try{return await(await L("/system/hardware")).json()}catch{return null}}async function Ct(){try{return await(await L("/processes")).json()}catch{return null}}async function _t(){try{return await(await L("/analyst/status")).json()}catch{return null}}async function At(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-info-content"),a=document.getElementById("hardware-refresh-btn"),i=n=>{if(!n){e.innerHTML='<p style="color: #ff4d4d;">Failed to load hardware info.</p>';return}let s="",l=(n.MEMORY_BYTES/(1024*1024*1024)).toFixed(1);if(s+=`
            <div class="service-widget" style="padding: 10px; min-height: 80px;">
            ...
            </div>`,n.CPU&&n.CPU.length>0){let y=n.CPU[0];s+=`
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                    <div class="service-widget-header" style="margin-bottom: 5px;">
                ...
                </div>`}if(n.GPU&&n.GPU.length>0&&n.GPU.forEach((y,x)=>{let w=(y.VRAM/1073741824).toFixed(1);s+=`
                    <div class="service-widget" style="padding: 10px; min-height: 80px;">
                        <div class="service-widget-header" style="margin-bottom: 5px;">
                    ...
                    </div>`}),n.STORAGE&&n.STORAGE.length>0){let y=0,x=0;n.STORAGE.forEach(h=>{y+=h.USED,x+=h.SIZE});let w=(y/(1024*1024*1024)).toFixed(1),d=(x/(1024*1024*1024)).toFixed(1),v=x>0?(y/x*100).toFixed(0):0;s+=`
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                    <div class="service-widget-header" style="margin-bottom: 5px;">
                ...
                </div>`}e.innerHTML=s};if(e&&a){a.dataset.listenerAttached||(a.onclick=async()=>{a.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let s=await st();s?(i(s),a.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{a.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML='<p style="color: #ff4d4d;">Failed to refresh.</p>',a.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{a.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},a.dataset.listenerAttached="true");let n=e.querySelector("p");if(n&&n.textContent==="Loading hardware info..."){let s=await st();i(s)}}if(!t)return;let o=await it();if(!o||!o.services){t.innerHTML=T("offline","Failed to load system metrics.","The event service may be offline or unreachable.");return}Qe=Date.now(),N(3,Qe);let r=o.services||[];Array.from(t.children).forEach(n=>{n.classList.contains("service-widget")||n.remove()});function c(n){return!n||n==="N/A"||n==="unknown"||n.trim()===""?"-":n}function g(n){if(!n||n==="N/A"||n==="unknown")return"-";let s=n.match(/^(\d+\.\d+\.\d+)/);return s?s[0]:n.split(".").slice(0,3).join(".")||"-"}function u(n){return!n||n.length<=28?n:n.substring(0,28)+"..."}function f(n){if(!n||n==="N/A"||n==="unknown")return"-";let s=n.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!s)return"-";let l=parseInt(s[1])||0,y=parseInt(s[2])||0,x=parseInt(s[3])||0,w=parseFloat(s[4])||0,d=l*86400+y*3600+x*60+w,v=Math.floor(d/86400);if(v>0)return`${v}d`;let h=Math.floor(d/3600);if(h>0)return`${h}h`;let C=Math.floor(d/60);return C>0?`${C}m`:`${Math.floor(d)}s`}function b(n){let s=n.status==="online",l=s?"service-widget-online":"service-widget-offline",y=s?"bx-check-circle":"bx-x-circle",x=s?"OK":"BAD",w=n.version?g(n.version.str):"-",d=n.cpu&&n.cpu!=="N/A"?n.cpu:"-",v=n.memory&&n.memory!=="N/A"?n.memory:"-",h=d!=="-"?"#00ff00":"#666",C=d!=="-"?"#fff":"#666",$=v!=="-"?"#00ff00":"#666",E=v!=="-"?"#fff":"#666",I=f(n.uptime),_="";return s?_=`
                ...
                </div>`:_='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${l}" data-service-id="${n.id}"><div class="service-widget-header"><i class="bx ${y}"></i><h3>${n.short_name||n.id}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${u(n.domain&&n.port?`${n.domain}:${n.port}`:"")}</span></div>${_}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(n=>[n.dataset.serviceId,n])),m=new Set(r.map(n=>n.id));for(let[n,s]of p)m.has(n)||s.remove();r.forEach(n=>{let s=b(n),l=p.get(n.id);l?l.outerHTML!==s&&(l.outerHTML=s):t.insertAdjacentHTML("beforeend",s)})}async function It(){let t=document.getElementById("models-widgets");if(!t)return;let e=await it();if(!e){t.innerHTML=T("offline","Failed to load model status.");return}et=Date.now(),N(3,et);let a=e.models||[],i=e.whisper;Array.from(t.children).forEach(g=>{g.classList.contains("service-widget")||g.remove()});function o(g){let u=g.status==="Ready";return`
                ...
                </div>`}function r(g){let u=g.status==="Downloaded",f=u?"service-widget-online":"service-widget-offline",b=u?"OK":"MISSING",p=u&&g.size>0?`${(g.size/1e9).toFixed(2)} GB`:"-",m=g.name;return g.type==="custom"&&m.endsWith(":latest")&&(m=m.replace(":latest","")),`<div class="service-widget ${f}" data-model-name="${g.name}"><div class="service-widget-header"><i class="bx ${u?"bx-check-circle":"bx-x-circle"}"></i><h3>${m}</h3><span class="service-widget-status">${b}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${g.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${p}</span></div></div></div>`}let c="";if(i&&(c+=o(i)),c+=a.map(r).join(""),!c){t.innerHTML=T("empty","No models found.");return}t.innerHTML!==c&&(t.innerHTML=c)}async function at(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("analyst-t1-val"),a=document.getElementById("analyst-t2-val"),i=document.getElementById("analyst-t3-val"),o=document.getElementById("analyst-idle-val"),r=document.getElementById("analyst-reset-btn");r&&!r.dataset.listenerAttached&&(r.onclick=async()=>{r.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await L("/analyst/reset?tier=all",{method:"POST"}),setTimeout(()=>{r.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{r.innerHTML="<i class='bx bx-refresh'></i> Reset Analyst"},2e3)},500),at()}catch{r.innerHTML="<i class='bx bx-error'></i> Failed"}},r.dataset.listenerAttached="true");let c=await _t();if(c){let m=Math.floor(Date.now()/1e3),n=c.active_tier,s=(l,y,x)=>{if(n===x||x==="guardian"&&n==="tests"){l.textContent="Working",l.style.color="#bb86fc";return}let w=y-m;if(w<=0)l.textContent="Ready",l.style.color="#5eff5e";else{let d=Math.floor(w/60),v=w%60;l.textContent=`${d}m ${v}s`,l.style.color="#fff"}};if(e&&c.guardian&&s(e,c.guardian.next_run,"guardian"),a&&c.architect&&s(a,c.architect.next_run,"architect"),i&&c.strategist&&s(i,c.strategist.next_run,"strategist"),o&&c.system_idle_time!==void 0){let l=c.system_idle_time,y=Math.floor(l/60),x=l%60;o.textContent=`${y}m ${x}s`,l>300?o.style.color="#5eff5e":l>60?o.style.color="#ffa500":o.style.color="#fff"}}else[e,a,i,o].forEach(n=>{n&&(n.textContent="Offline",n.style.color="#ff4d4d")});let g=await Ct(),u=document.getElementById("vitals-processes-val");if(u)if(g){let m=g.length;u.textContent=m>0?`${m} Active`:"Idle",u.style.color=m>0?"#bb86fc":"#fff"}else u.textContent="-",u.style.color="#888";if(g===null){t.innerHTML=T("offline","Failed to load process status.");return}if(tt=Date.now(),N(3,tt),g.length===0){t.innerHTML=T("empty","No active processes."),z(3,0);return}(t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML="");function f(m){let n=Math.floor(Date.now()/1e3-m.start_time),s=m.retries>0?`<span class="process-retry-badge">Retry ${m.retries}</span>`:"",l=m.channel_id,y={"system-discord":"Discord Engine","system-analyst":"Analyst Worker","system-cli-op":"CLI Operation"};return y[l]?l=y[l]:/^\d+$/.test(l)&&(l=`Channel ${l}`),`
                ...
                ${Object.values(D).map(o=>`
                    <div class="theme-card ${t===o?"active":""}" data-theme="${o}">
                        ...
                        <div class="theme-info">
                            <h3>${o}</h3>
                            <p>${o===D.AUTO?"Automatic theme selection.":o===D.DEFAULT?"Simple, black, default.":"Colourful, not bright."}</p>
...
dex config set <service> <field> <value>`}}],Mt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,i]of Object.entries(t)){let o=lt.filter(r=>r.category===a);o.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>ot(),document.getElementById("terminal-action-btn").onclick=()=>ot());let a=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");a.innerHTML="";let o=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return i.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Te=!0,a}function ot(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Te=!1}function Le(t,e,a="output"){if(!Te)return;let i=document.createElement("div");i.className=`terminal-line terminal-${a}`,a==="prompt"?i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:i.innerHTML=ae(e),t.appendChild(i),t.scrollTop=t.scrollHeight}async function Dt(t){let e=lt.find(i=>i.id===t);if(!e)return;let a=Bt(e);Le(a,`dex ${t}`,"prompt");try{let o=(await L("/cli/execute",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:t,args:[]})})).body.getReader(),r=new TextDecoder;for(;;){let{value:c,done:g}=await o.read();if(g)break;r.decode(c,{stream:!0}).split(`
`).forEach(b=>{if(b.trim()==="")return;let p="output";b.includes("[ERROR]")?p="error":b.includes("[SUCCESS]")||b.includes("\u2713")?p="success":b.includes("!")&&(p="warning"),Le(a,b,p)})}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed"}catch(i){Le(a,`Connection Error: ${i.message}`,"error"),document.getElementById("terminal-status-badge").className="terminal-status status-error",document.getElementById("terminal-status-badge").textContent="Failed"}finally{document.getElementById("terminal-action-btn").style.display="block"}}function rt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Mt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code").textContent;navigator.clipboard.writeText(a).then(()=>{let i=e.querySelector("i");i.className="bx bx-check",i.style.color="#5eff5e",setTimeout(()=>{i.className="bx bx-copy",i.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(a=>{a.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let i=a.dataset.cmd;if(i==="chat"){alert("Connection to cognitive core pending deployment...");return}Dt(i)})})}async function Nt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${ye()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable. Redirecting to 404."),window.location.href="/404.html"}}function ct(){Nt(),Pe(),_e(),window.location.pathname.includes("/dex")&&rt();let t=Be();Ae(t),Ie();let e=window.location.pathname==="/"||window.location.pathname==="/index.html",a=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!e&&!a&&document.querySelector("footer")?.classList.add("hide");let i=[],o=document.getElementById("windows-container");o&&o.setAttribute("data-count","0");function r(){return window.innerWidth>=1900?2:1}function c(){let s=r();for(;i.length>s;)i.shift().close(!0);let l=document.getElementById("windows-container"),y=document.querySelector("nav"),x=document.querySelector("footer"),w=window.location.pathname.includes("/dex"),d=window.location.pathname.includes("404")||!!document.getElementById("error-main-view"),v=window.location.pathname==="/"||window.location.pathname==="/index.html";l&&l.setAttribute("data-count",i.length);let h=i.length>1||i.length===1&&window.innerWidth<1200;i.forEach($=>{let E=document.getElementById($.id);E&&(i.length===1?E.classList.add("hide-close"):E.classList.remove("hide-close"))});let C={"feed-window":"feed-icon","monitor-window":"monitor-icon","workspace-window":"workspace-icon","settings-window":"settings-icon"};Object.values(C).forEach($=>document.getElementById($)?.classList.remove("active")),i.forEach($=>{let E=C[$.id];E&&document.getElementById(E)?.classList.add("active")}),i.length>0?(x?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),y?.classList.add("window-open"),h?l&&(l.style.paddingTop="60px"):l&&(l.style.paddingTop="100px")):(y?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),l&&(l.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),v||d?x?.classList.remove("hide"):x?.classList.add("hide"))}function g(s){if(s.isOpen()){s.close();return}let l=r();i.length>=l&&i.shift().close(!0),i.push(s),s.open(),c()}function u(){[...i].forEach(l=>l.close()),i=[]}window.addEventListener("resize",c);let f=G({id:"feed-window",icon:"bx-news",tabs:[{icon:"bx-bell",title:"Notifications",content:Ue()},{icon:"bx-calendar-event",title:"Events",content:Xe()}],onOpen:()=>{j(),Z()},onClose:()=>{let s=i.indexOf(f);s>-1&&i.splice(s,1),c()}}),b=G({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bx-server",title:"System",content:nt()},{icon:"bx-book-content",title:"Contacts",content:Je()}],onOpen:()=>{we(),he()},onClose:()=>{let s=i.indexOf(b);s>-1&&i.splice(s,1),c()}}),p=G({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:Ge(),onOpen:()=>be(),onClose:()=>{let s=i.indexOf(p);s>-1&&i.splice(s,1),c()}}),m=G({id:"settings-window",title:"Settings",icon:"bx-cog",content:Ee(),onOpen:()=>$e(m),onClose:()=>{let s=i.indexOf(m);s>-1&&i.splice(s,1),c()}}),n=G({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="https://github.com/eastercompany" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});t?(document.getElementById("feed-icon")?.addEventListener("click",()=>g(f)),document.getElementById("monitor-icon")?.addEventListener("click",()=>g(b)),document.getElementById("workspace-icon")?.addEventListener("click",()=>g(p)),document.getElementById("settings-icon")?.addEventListener("click",()=>g(m)),document.getElementById("close-all-windows")?.addEventListener("click",()=>u()),setInterval(()=>{f.isOpen()&&(j(),Z()),b.isOpen()&&we(),p.isOpen()&&be()},5e3)):document.getElementById("login-btn")?.addEventListener("click",()=>{n.open(),setTimeout(()=>{document.getElementById("login-form")?.addEventListener("submit",s=>{s.preventDefault();try{Ne(document.getElementById("email-input").value),window.location.reload()}catch(l){let y=document.getElementById("login-error");y&&(y.textContent=l.message,y.style.display="block")}})},100)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ct):ct();})();
