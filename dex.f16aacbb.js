(()=>{function Ge(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Je(t=!1){let e=window.location.pathname,n=e==="/"||e==="/index.html",o=`
    ...
    `}
        ...
        `}
    `,l=document.createElement("nav");l.innerHTML=o,document.body.prepend(l)}function Ve(t){let e=window.location.pathname,n=e==="/"||e==="/index.html",a=document.getElementById("nav-chevron"),s=document.querySelector(".nav-left");!a||!s||(t||!n?(a.style.display="block",s.style.cursor="pointer",s.classList.add("recording"),s.onmouseenter=()=>{a.style.transform="translateX(-3px)"},s.onmouseleave=()=>{a.style.transform="translateX(0)"}):(a.style.display="none",s.style.cursor="default",s.classList.remove("recording"),s.onmouseenter=null,s.onmouseleave=null))}function We(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ze=1e3;function te(t){let e=null,n=t.onClose||null,a=t.onOpen||null;function s(){e&&(e.style.zIndex=++Ze)}function o(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let g=document.getElementById("windows-container");g||(g=document.createElement("div"),g.id="windows-container",g.className="windows-container",document.body.appendChild(g)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ze,e.addEventListener("mousedown",s);let b=t.icon||"bx-window",i="",f="",E;t.tabs&&t.tabs.length>0?(i=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${E}
        `,g.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),u()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let c=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),m(y,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let g=e.querySelector(".tab.active");g&&m(g,e)}function m(g,b){setTimeout(()=>{let i=b.querySelector(".tab-bar");if(!i)return;let f=Array.from(i.querySelectorAll(".tab")),E=f.indexOf(g),y=i.clientWidth,c=f[Math.max(0,E-2)],v=f[Math.min(f.length-1,E+2)],r=c.offsetLeft-i.offsetLeft-25,h=v.offsetLeft+v.offsetWidth-i.offsetLeft+25-r,M=h<=y?r-(y-h)/2:g.offsetLeft-i.offsetLeft-y/2+g.offsetWidth/2;i.scrollTo({left:M,behavior:"smooth"})},350)}function u(g=!1){e&&(window.removeEventListener("resize",l),g?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(g){let b=e?.querySelector(".window-content");b&&(b.innerHTML=g)}function x(){return e&&e.classList.contains("open")}return{open:o,close:u,setContent:p,isOpen:x,focus:s,id:t.id}}function he(){return!!localStorage.getItem("easter_user_email")}function Ke(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Ye(t){localStorage.setItem("easter_user_email",t.trim())}var Xe="easter_theme",K={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ge(){return localStorage.getItem(Xe)||K.DARK}function Qe(t){if(!Object.values(K).includes(t))throw new Error("Invalid theme");localStorage.setItem(Xe,t),we(t)}function we(t){let e=document.body;if(Object.values(K).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[K.LIGHT,K.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function et(){let t=ge();we(t)}function N(t,e,n=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function B(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function J(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let a=Date.now(),s=Math.floor((a-e)/1e3),o;s<60?o=`${s}s ago`:s<3600?o=`${Math.floor(s/60)}m ago`:o=`${Math.floor(s/3600)}h ago`,n.textContent=`Last updated: ${o}`}var Pt=0;function be(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let a=n.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var Y=0,X=0;function tt(t){Y=t,me()}function st(t){X=t,me()}function me(){let t=Y+X;Pt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",n.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}let s=document.getElementById("switch-alerts");if(s){let l=s.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",s.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let o=document.getElementById("switch-workspace");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",o.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}}function $e(){let t=document.getElementById("alerts-list");if(!t)return;Y=t.querySelectorAll(".alert-unread:not(.priority-low)").length,me()}function it(){let t=document.getElementById("blueprints-list");if(!t)return;X=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,me()}function Be(){return"https://event.easter.company"}function Ot(){return"https://discord.easter.company"}var Ut="http://127.0.0.1:8100",jt="http://127.0.0.1:8300",qt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Ee(t){let e=B(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,o)=>{let l=qt[o];return l?`<span class="${l}">`:""});let n=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return n>a&&(e+="</span>".repeat(n-a)),e}function se(t){if(!t)return"";let e=B(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,a)=>{let s=a.split("|").map(o=>o.trim());return s.every(o=>o.match(/^:?-+:?$/))?"":`<div class="md-table-row">${s.map(o=>`<span class="md-table-cell">${o}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Ft="https://sterling-javelin-12539.upstash.io",Gt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function Jt(){return window.location.hostname==="easter.company"&&!he()}async function Ce(t,...e){try{let a=await(await fetch(Ft,{method:"POST",headers:{Authorization:`Bearer ${Gt}`},body:JSON.stringify([t,...e])})).json();if(a.error)throw new Error(a.error);return a.result}catch(n){return console.error("Upstash Error:",n),null}}async function _(t,e={}){if(Jt()){if(t.startsWith("/system_monitor")||t.startsWith("/system/status")){let s=await Ce("GET","state:system:monitor");if(!s)throw new Error("No public data available");return new Response(s,{status:200,headers:{"Content-Type":"application/json"}})}if(t.startsWith("/processes")){let s=await Ce("GET","state:system:processes");if(!s)throw new Error("No public data available");return new Response(s,{status:200})}if(t.startsWith("/events")){let s=await Ce("ZRANGE","events:timeline","0","49","REV");if(!s||s.length===0)return new Response(JSON.stringify({events:[],count:0}),{status:200});let o=s.map(u=>`event:${u}`),l=await Ce("MGET",...o),m=[];return l.forEach(u=>{if(u)try{m.push(JSON.parse(u))}catch{}}),new Response(JSON.stringify({events:m,count:m.length}),{status:200})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(resolvedBaseUrl)try{let s=await fetch(resolvedBaseUrl+t,e);if(s.ok)return s;resolvedBaseUrl=null}catch{resolvedBaseUrl=null}let n=Be(),a=Ut;try{let s=await fetch(n+t,e);if(s.ok)return resolvedBaseUrl=n,isFallingBack&&(console.log("\u2728 Production event service restored."),isFallingBack=!1),s;throw new Error("Primary failed")}catch{isFallingBack||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),isFallingBack=!0);try{let o=await fetch(a+t,e);if(o.ok)return resolvedBaseUrl=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}async function ke(t,e={}){if(resolvedDiscordBaseUrl)try{let s=await fetch(resolvedDiscordBaseUrl+t,e);if(s.ok)return s;resolvedDiscordBaseUrl=null}catch{resolvedDiscordBaseUrl=null}let n=Ot(),a=jt;try{let s=await fetch(n+t,e);if(s.ok)return resolvedDiscordBaseUrl=n,isDiscordFallingBack&&(console.log("\u2728 Production discord service restored."),isDiscordFallingBack=!1),s;throw new Error("Primary failed")}catch{isDiscordFallingBack||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),isDiscordFallingBack=!0);try{let o=await fetch(a+t,e);if(o.ok)return resolvedDiscordBaseUrl=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}var nt=()=>`
...
`,Se=null,ie=new Set,Te=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Vt(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await _(n);if(!a.ok)throw new Error("Service is offline or unreachable.");let o=(await a.json()).events||[];Se=Date.now(),J(0,Se);let l=Date.now(),m=24*60*60*1e3,u=o.filter(r=>{let d=localStorage.getItem(`alert_read_ts_${r.id}`);if(!d)return!0;let h=parseInt(d);return l-h<m});u.sort((r,d)=>{let h=I=>{let w=I.event;if(typeof w=="string")try{w=JSON.parse(w)}catch{return"low"}return(w.priority||"low").toLowerCase()},M=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,A=M(h(r)),L=M(h(d));return A!==L?L-A:d.timestamp-r.timestamp}),Te=u;let p=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return"low"}return(d.priority||"low").toLowerCase()},x=[],b=new Set(u.map(r=>p(r))).size>1;if(u.length>0){let r=null;u.forEach(d=>{let h=p(d);b&&h!==r&&(x.push({id:`divider-${h}`,type:"divider",label:h.toUpperCase()}),r=h),x.push(d)})}if(t&&(e.innerHTML=""),u.length===0){e.innerHTML=N("empty","No alerts yet."),$e();return}let i=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return null}let h=(d.title||"Untitled Alert").trim(),M=(d.body||"No description provided.").trim(),A=d.summary||"",L=d.content||"",I=d.protocol||"",w=(d.priority||"low").toLowerCase(),H=!!d.alert,D=(d.category||"system").trim(),z=d.related_event_ids||[],O=d.audit_event_id,U=!!localStorage.getItem(`alert_read_ts_${r.id}`),S=new Date(r.timestamp*1e3),C=S.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=S.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=U?"event-border-grey":"event-border-blue";!U&&H&&(T="event-border-red"),U&&(w==="high"||w==="critical")?T="event-border-red":U&&w==="medium"&&(T="event-border-orange");let k=U?"alert-read":"alert-unread",R=ie.has(r.id),P=R?"expanded":"",Q=R?"display: block;":"display: none;",j="",q="";z.length>0&&(q=`
        ...
        `,j=`
                ...
                ${Z}
            `;let G=document.createElement("div");G.className=`event-item notification-item ${T} ${k} ${P} cursor-pointer priority-${w}`,G.dataset.alertId=r.id,G.onclick=function(ee){if(this.classList.contains("expanded")){this.classList.remove("expanded"),ie.delete(r.id);let fe=this.querySelector(".event-details");fe&&(fe.style.display="none")}else{this.classList.add("expanded"),ie.add(r.id);let fe=this.querySelector(".event-details");if(fe&&(fe.style.display="block"),!localStorage.getItem(`alert_read_ts_${r.id}`)){localStorage.setItem(`alert_read_ts_${r.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ie="event-border-grey";w==="high"||w==="critical"?Ie="event-border-red":w==="medium"&&(Ie="event-border-orange"),this.classList.add(Ie),$e()}}};let je=`${I?I.toUpperCase():"GUARDIAN"} ALERT: ${A||h}`,Nt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[D]||"bx-bell",Rt=w==="high"||w==="critical"?"#ff4d4d":w==="medium"?"#ffa500":"#888";G.innerHTML=`
...
`,ct=null,re=new Set,mt=[];async function le(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Xt();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await _(n);if(!a.ok)throw new Error("Service is offline or unreachable.");let o=(await a.json()).events||[];if(mt=o,ct=Date.now(),J(2,ct),o.length===0){e.innerHTML=N("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),be(2,0);return}t&&(e.innerHTML="");let l=g=>{let b=g.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let i=(b.title||"Untitled Blueprint").trim(),f=(b.summary||b.body||"No summary provided.").trim(),E=(b.content||"").trim(),y=(b.category||"architecture").trim(),c=(b.related_services||b.affected_services||[]).map(k=>k.trim()),v=(b.implementation_path||[]).map(k=>k.trim()),r=b.source_event_ids||[],d=b.approved===!0,h=new Date(g.timestamp*1e3),M=h.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=h.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=re.has(g.id),I=L?"display: block;":"display: none;",w=document.createElement("div");w.className=`event-item notification-item event-border-purple cursor-pointer ${L?"expanded":""} ${d?"blueprint-approved":""}`,w.dataset.blueprintId=g.id,d&&(w.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",w.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let D=d?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[y]||"bx-paint";w.onclick=function(k){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(g.id);let P=this.querySelector(".event-details");P&&(P.style.display="none")}else{this.classList.add("expanded"),re.add(g.id);let P=this.querySelector(".event-details");P&&(P.style.display="block")}};let z="";v.length>0&&(z=`
            ...
            `;let S=w.querySelector(".blueprint-approve-btn");S&&(S.onclick=async k=>{k.stopPropagation(),S.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${g.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&le(!0)}catch(R){console.error("Failed to approve blueprint:",R)}});let C=w.querySelector(".blueprint-delete-btn");C&&(C.onclick=async k=>{k.stopPropagation();let R=!d;C.innerHTML=R?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${g.id}`,{method:"DELETE"})).ok&&le(!0)}catch(P){console.error("Failed to delete blueprint:",P)}});let $=w.querySelector(".event-details");$&&$.addEventListener("click",k=>{k.stopPropagation()});let T=w.querySelector(".close-details-btn");return T&&T.addEventListener("click",k=>{k.stopPropagation(),w.classList.remove("expanded");let R=w.querySelector(".event-details");R&&(R.style.display="none"),re.delete(g.id)}),w},m=Array.from(e.children),u=new Map(m.map(g=>[g.dataset.blueprintId,g])),p=new Set(o.map(g=>g.id));m.forEach(g=>{let b=g.dataset.blueprintId;(!b||!p.has(b))&&g.remove()});let x=null;o.forEach((g,b)=>{let i=u.get(g.id);(!i||t)&&(i&&i.remove(),i=l(g),!i)||(b===0?e.firstElementChild!==i&&e.prepend(i):x&&x.nextElementSibling!==i&&x.after(i),x=i)}),be(2,o.length),it()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=N("offline","Failed to load blueprints.","The event service may be offline."))}}async function ut(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let a=(await e.json()).events||[],s=0;a.forEach(o=>{let l=o.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&s++}),st(s)}catch{}}function Xt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),n=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{mt.forEach(a=>re.add(a.id)),le(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{re.clear(),le(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),re.clear(),le(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var ft=()=>`
...
`;async function _e(){await Promise.all([oe(),le()])}var Qt=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function gt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"VS Code"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function bt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Qt,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),ke(`/profile/${t.id}`).then(async n=>{if(n.ok){let a=await n.json();De(e,t,a)}else{console.log("Profile not found or error, using mock data.");let a=gt(t.id,t.username);De(e,t,a)}}).catch(n=>{console.error("Profile fetch error:",n);let a=gt(t.id,t.username);De(e,t,a)})}function De(t,e,n){let a=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",s=()=>{let E=(n.badges||[]).map(M=>`<span class="profile-badge ${M==="Creator"?"master":""}">${M}</span>`).join(""),y=(n.attributes||n.facts||[]).map(M=>{let A=M.key||M.k,L=M.value||M.v;return`
            <div class="fact-chip">
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ht()}
        </div>`;async function At(){await Promise.all([ye(),Re(),Pe()]),await xe()}var wt=null,Ct=null;async function It(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function $t(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function cs(){try{return await(await _("/processes")).json()}catch{return null}}async function ds(){try{return await(await _("/agent/status")).json()}catch{return null}}async function Re(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),s=document.querySelector("#hw-ram .hw-content"),o=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),m=c=>{if(c){if(n&&(n.innerHTML=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ms=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,a]of Object.entries(t)){let s=Dt.filter(o=>o.category===n);s.length!==0&&(e+=`
    ...
    </div>`,e},Ue=!1;function us(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Bt(),document.getElementById("terminal-action-btn").onclick=()=>Bt());let n=document.getElementById("cli-terminal-body"),a=document.getElementById("cli-docs-pane");n.innerHTML="";let s=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return a.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ue=!0,n}function Bt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ue=!1}function _t(t,e,n="output"){if(!Ue)return;let a=document.createElement("div");a.className=`terminal-line terminal-${n}`,n==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=Ee(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function fs(t){let e=Dt.find(s=>s.id===t);if(!e)return;let n=us(e);_t(n,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let s of a){await new Promise(l=>setTimeout(l,400+Math.random()*600));let o="output";s.includes("[ERROR]")?o="error":s.includes("[SUCCESS]")||s.includes("\u2713")?o="success":s.includes("!")&&(o="warning"),_t(n,s,o)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function zt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=ms();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code").textContent;navigator.clipboard.writeText(n).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(n=>{n.addEventListener("mouseenter",()=>{n.style.transform="translateY(-5px)",n.style.borderColor="rgba(255,255,255,0.15)",n.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{n.style.transform="translateY(0)",n.style.borderColor="rgba(255,255,255,0.05)",n.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let a=n.dataset.cmd;fs(a)})})}async function gs(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${Be()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Ht(){gs(),et(),Ge();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&zt();let e=he();Je(e),We();let n=document.getElementById("nav-left-container");n&&n.addEventListener("click",()=>{if(o.length>0)g();else{let r=window.location.pathname;if(!(r==="/"||r==="/index.html")){let M=(r.endsWith("/")&&r.length>1?r.slice(0,-1):r).split("/");M.pop();let A=M.join("/")||"/";window.location.href=A}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",s=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!s&&document.querySelector("footer")?.classList.add("hide");let o=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let m=r=>{localStorage.setItem("dex_last_window",r)};function u(){return 1}function p(){for(;o.length>1;)o.shift().close(!0);let r=document.getElementById("windows-container"),d=document.querySelector("nav"),h=document.querySelector("footer"),M=window.location.pathname==="/"||window.location.pathname==="/index.html",A=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");r&&r.setAttribute("data-count",o.length),o.forEach(H=>{let D=document.getElementById(H.id);D&&D.classList.remove("hide-close")}),we(ge());let L=document.getElementById("dexter-menu-container"),I=document.getElementById("nav-window-switcher"),w=document.getElementById("settings-icon");if(Ve(o.length>0),o.length>0){if(h?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),d?.classList.add("window-open"),r&&(r.style.paddingTop="60px"),L&&(L.style.display="none"),w&&(w.style.display="none"),I){let H=o[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(H)?(I.innerHTML=`
