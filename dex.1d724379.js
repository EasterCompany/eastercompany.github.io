(()=>{function Ae(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ie(o=!1){let l=`
        <div class="nav-left">
    ...
    `,p=document.createElement("nav");p.innerHTML=l,document.body.prepend(p)}function $e(){let o=`
    ...
    `,a=document.createElement("footer");a.innerHTML=o,document.body.appendChild(a)}function ae(o){let a=null,l=o.onClose||null,p=o.onOpen||null;function E(){if(a){a.classList.add("open"),p&&setTimeout(p,10);return}let b=document.getElementById("windows-container");b||(b=document.createElement("div"),b.id="windows-container",b.className="windows-container",document.body.appendChild(b)),a=document.createElement("div"),a.id=o.id,a.className="window";let T=o.icon||"bx-window",_="",w="",C;o.tabs&&o.tabs.length>0?(_=`<div class="tab-bar">${o.tabs.map((S,A)=>{let H;return S.icon?H=`<i class="bx ${S.icon}"></i>`:S.title&&S.title.length>0?H=`<span class="tab-glyph">${S.title.charAt(0).toUpperCase()}</span>`:H='<i class="bx bx-question-mark"></i>',`
        ...
        `;a.innerHTML=x+C,b.appendChild(a);let te=a.querySelector(".window-close");te&&te.addEventListener("click",ne=>{ne.stopPropagation(),g()}),o.tabs&&o.tabs.length>0&&a.querySelectorAll(".tab").forEach(M=>{M.addEventListener("click",()=>{let S=M.getAttribute("data-tab-index");a.querySelectorAll(".tab").forEach(A=>A.classList.remove("active")),M.classList.add("active"),a.querySelectorAll(".tab-content").forEach(A=>A.classList.remove("active")),a.querySelector(`.tab-content[data-tab-content="${S}"]`).classList.add("active")})}),setTimeout(()=>{a.classList.add("open"),p&&p()},10)}function g(b=!1){a&&(b?(a.classList.add("switching"),a.classList.remove("open"),setTimeout(()=>{a&&a.parentNode&&a.parentNode.removeChild(a),a=null},200)):(a.classList.remove("open"),l&&l(),setTimeout(()=>{a&&a.parentNode&&a.parentNode.removeChild(a),a=null},400)))}function L(b){if(a){let T=a.querySelector(".window-content");T&&(T.innerHTML=b)}}function $(){return a&&a.classList.contains("open")}return{open:E,close:g,setContent:L,isOpen:$,id:o.id}}var pe="easter_user_email";function Ce(){return localStorage.getItem(pe)!==null}function fe(){return localStorage.getItem(pe)}function Me(o){if(!o||!o.includes("@"))throw new Error("Invalid email address");if(!o.trim().toLowerCase().endsWith("@easter.company"))throw new Error("Access denied. Please check your credentials.");localStorage.setItem(pe,o.trim())}var ke="easter_theme",v={AUTO:"auto",DEFAULT:"default",ANIMATED:"animated"};function ge(){return localStorage.getItem(ke)||v.AUTO}function qe(){let o=window.innerWidth,a=window.innerHeight,l=window.innerHeight===window.screen.height&&window.innerWidth===window.screen.width;return o>1920&&a>1080?v.ANIMATED:(o===1920&&a===1080&&l||o<=1920||a<=1080,v.DEFAULT)}function Ne(o){if(!Object.values(v).includes(o))throw new Error("Invalid theme");localStorage.setItem(ke,o),ve(o)}function ve(o,a=!1){let l=document.body,p=o===v.AUTO?qe():o;if(a||(l.classList.add("theme-transitioning"),setTimeout(()=>{l.classList.remove("theme-transitioning")},300)),Object.values(v).forEach(E=>{l.classList.remove(`theme-${E}`)}),l.classList.add(`theme-${o}`),p===v.ANIMATED){if(!document.querySelector(".background")){let E=document.createElement("div");E.className="background",document.body.prepend(E)}}else{let E=document.querySelector(".background");E&&(a?E.remove():(E.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{E.remove()},400)))}}function De(){let o=ge();if(ve(o,!0),o===v.AUTO){let a;window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{ve(v.AUTO)},300)})}}function ee(o,a,l=null){let E={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[o]||"bx-info-circle",g=l?`<p class="placeholder-action">${l}</p>`:"";return`
    ...
    `}async function he(){let o=document.getElementById("logs-container");if(!o)return!1;o.classList.remove("placeholder-active");let a=localStorage.getItem("service_map");if(!a)return o.classList.add("placeholder-active"),o.innerHTML=ee("config","No service map configured.","Please upload your service-map.json in Settings to enable log monitoring."),!1;let l;try{l=JSON.parse(a)}catch(L){return console.error("Error parsing service_map from localStorage:",L),o.classList.add("placeholder-active"),o.innerHTML=ee("error","Invalid service map data.","Please re-upload a valid service-map.json file in Settings."),!1}let p=null;if(l&&typeof l.services=="object"){let L=["cs","be","th"];for(let $ of L)if(Array.isArray(l.services[$])){let b=l.services[$].find(T=>T.short_name==="event"||T.id==="event"||T.id==="dex-event-service");if(b){p=b;break}}}if(!p)return o.classList.add("placeholder-active"),o.innerHTML=ee("error","Event service not found in service map.","Please ensure dex-event-service is configured in your service-map.json."),!1;let g=`http://${p.domain==="0.0.0.0"?"localhost":p.domain}:${p.port}/logs`;try{let L=await fetch(g);if(!L.ok)return o.classList.add("placeholder-active"),o.innerHTML=ee("offline","Event service is offline.","Please ensure the event service is running."),!1;let $=await L.json();if(!$||$.length===0)return o.classList.add("placeholder-active"),o.innerHTML=ee("empty","No logs found.","Service logs will appear here when available."),!1;let b=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],T=$.filter(w=>!b.includes(w.id));T.forEach(w=>{w.logs.reverse()}),T.reverse();let _=T.map(w=>{let C=w.logs.join(`
`);return`
        ...
        `,icon:"bx-log-in",onClose:p});function g(e,t,i=null){let c={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[e]||"bx-info-circle",y=i?`<p class="placeholder-action">${i}</p>`:"";return`
            <div class="tab-placeholder">
