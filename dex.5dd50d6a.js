(()=>{function Ze(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ke(t=!1){let e=window.location.pathname,n=e==="/"||e==="/index.html",o=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Qe=1e3;function ie(t){let e=null,n=t.onClose||null,a=t.onOpen||null;function i(){e&&(e.style.zIndex=++Qe)}function o(){if(e){e.classList.add("open"),i(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let g=document.getElementById("windows-container");g||(g=document.createElement("div"),g.id="windows-container",g.className="windows-container",document.body.appendChild(g)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Qe,e.addEventListener("mousedown",i);let b=t.icon||"bx-window",s="",f="",E;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${E}
        `,g.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),p()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let c=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),u(y,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let g=e.querySelector(".tab.active");g&&u(g,e)}function u(g,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let f=Array.from(s.querySelectorAll(".tab")),E=f.indexOf(g),y=s.clientWidth,c=f[Math.max(0,E-2)],v=f[Math.min(f.length-1,E+2)],r=c.offsetLeft-s.offsetLeft-25,h=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,M=h<=y?r-(y-h)/2:g.offsetLeft-s.offsetLeft-y/2+g.offsetWidth/2;s.scrollTo({left:M,behavior:"smooth"})},350)}function p(g=!1){e&&(window.removeEventListener("resize",l),g?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function m(g){let b=e?.querySelector(".window-content");b&&(b.innerHTML=g)}function x(){return e&&e.classList.contains("open")}return{open:o,close:p,setContent:m,isOpen:x,focus:i,id:t.id}}function et(){return!!localStorage.getItem("easter_user_email")}function tt(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function st(t){localStorage.setItem("easter_user_email",t.trim())}var it="easter_theme",X={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ye(){return localStorage.getItem(it)||X.DARK}function nt(t){if(!Object.values(X).includes(t))throw new Error("Invalid theme");localStorage.setItem(it,t),Ee(t)}function Ee(t){let e=document.body;if(Object.values(X).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[X.LIGHT,X.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function at(){let t=ye();Ee(t)}function N(t,e,n=null){let i={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${i} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function B(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let a=Date.now(),i=Math.floor((a-e)/1e3),o;i<60?o=`${i}s ago`:i<3600?o=`${Math.floor(i/60)}m ago`:o=`${Math.floor(i/3600)}h ago`,n.textContent=`Last updated: ${o}`}var Jt=0;function he(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let a=n.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var Q=0,ee=0;function rt(t){Q=t,be()}function lt(t){ee=t,be()}function be(){let t=Q+ee;Jt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",n.appendChild(l)),l.textContent=Q>9?"9+":Q,l.style.display=Q>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=ee>9?"9+":ee,l.style.display=ee>0?"flex":"none"}let i=document.getElementById("switch-alerts");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=Q>9?"9+":Q,l.style.display=Q>0?"flex":"none"}let o=document.getElementById("switch-workspace");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",o.appendChild(l)),l.textContent=ee>9?"9+":ee,l.style.display=ee>0?"flex":"none"}}function Te(){let t=document.getElementById("alerts-list");if(!t)return;Q=t.querySelectorAll(".alert-unread:not(.priority-low)").length,be()}function ct(){let t=document.getElementById("blueprints-list");if(!t)return;ee=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,be()}function Gt(){return"https://event.easter.company"}function Wt(){return"https://discord.easter.company"}var Vt="http://127.0.0.1:8100",Zt="http://127.0.0.1:8300",Kt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Le(t){let e=B(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(i,o)=>{let l=Kt[o];return l?`<span class="${l}">`:""});let n=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return n>a&&(e+="</span>".repeat(n-a)),e}function oe(t){if(!t)return"";let e=B(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,a)=>{let i=a.split("|").map(o=>o.trim());return i.every(o=>o.match(/^:?-+:?$/))?"":`<div class="md-table-row">${i.map(o=>`<span class="md-table-cell">${o}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Yt="https://sterling-javelin-12539.upstash.io",Xt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function K(){return window.location.hostname==="easter.company"}var O=null,dt="dex_dashboard_snapshot";function Qt(){let t=localStorage.getItem(dt);if(t)try{O=JSON.parse(t)}catch{O=null}}async function ot(){if(!K())return;let t=await ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);O=e,localStorage.setItem(dt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}function es(){if(!K())return;Qt();let t=Date.now();(!O||t/1e3-O.timestamp>120)&&ot(),setInterval(()=>{new Date().getSeconds()===59&&ot()},1e3)}K()&&es();async function ts(t,...e){try{let a=await(await fetch(Yt,{method:"POST",headers:{Authorization:`Bearer ${Xt}`},body:JSON.stringify([t,...e])})).json();if(a.error)throw new Error(a.error);return a.result}catch(n){return console.error("Upstash Error:",n),null}}var fe=null,ge=null,Se=!1,ke=!1;async function _(t,e={}){if(K()){if(!O)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(O.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(O.processes),{status:200});if(t.startsWith("/events")){let i=new URLSearchParams(t.split("?")[1]||""),o=i.get("type")||i.get("event.type"),l=i.get("category"),u=i.get("order")||"desc",p=[];return o==="system.notification.generated"?p=[...O.alerts||[]]:l==="messaging"?p=[...O.messaging_events||[]]:l==="system"?p=[...O.system_events||[]]:l==="cognitive"?p=[...O.cognitive_events||[]]:l==="moderation"?p=[...O.moderation_events||[]]:p=[...O.events||[]],u==="asc"?p.sort((m,x)=>m.timestamp-x.timestamp):p.sort((m,x)=>x.timestamp-m.timestamp),new Response(JSON.stringify({events:p,count:p.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/profile/")){let i=t.split("/")[2],o=O.profiles?O.profiles[i]:null;return o?new Response(JSON.stringify(o),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(fe)try{let i=await fetch(fe+t,e);if(i.ok)return i;fe=null}catch{fe=null}let n=Gt(),a=Vt;try{let i=await fetch(n+t,e);if(i.ok)return fe=n,Se&&(console.log("\u2728 Production event service restored."),Se=!1),i;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),Se=!0);try{let o=await fetch(a+t,e);if(o.ok)return fe=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}async function Me(t,e={}){if(K()){if(!O)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(O.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let i=t.split("/")[2],o=(O.contacts?.members||[]).find(l=>l.id===i);return o?new Response(JSON.stringify(o),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(ge)try{let i=await fetch(ge+t,e);if(i.ok)return i;ge=null}catch{ge=null}let n=Wt(),a=Zt;try{let i=await fetch(n+t,e);if(i.ok)return ge=n,ke&&(console.log("\u2728 Production discord service restored."),ke=!1),i;throw new Error("Primary failed")}catch{ke||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),ke=!0);try{let o=await fetch(a+t,e);if(o.ok)return ge=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}var pt=()=>`
...
`,Ae=null,re=new Set,Ie=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;ss(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await _(n);if(!a.ok)throw new Error("Service is offline or unreachable.");let o=(await a.json()).events||[];Ae=Date.now(),W(0,Ae);let l=Date.now(),u=24*60*60*1e3,p=o.filter(r=>{let d=localStorage.getItem(`alert_read_ts_${r.id}`);if(!d)return!0;let h=parseInt(d);return l-h<u});p.sort((r,d)=>{let h=I=>{let w=I.event;if(typeof w=="string")try{w=JSON.parse(w)}catch{return"low"}return(w.priority||"low").toLowerCase()},M=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,A=M(h(r)),L=M(h(d));return A!==L?L-A:d.timestamp-r.timestamp}),Ie=p;let m=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return"low"}return(d.priority||"low").toLowerCase()},x=[],b=new Set(p.map(r=>m(r))).size>1;if(p.length>0){let r=null;p.forEach(d=>{let h=m(d);b&&h!==r&&(x.push({id:`divider-${h}`,type:"divider",label:h.toUpperCase()}),r=h),x.push(d)})}if(t&&(e.innerHTML=""),p.length===0){e.innerHTML=N("empty","No alerts yet."),Te();return}let s=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return null}let h=(d.title||"Untitled Alert").trim(),M=(d.body||"No description provided.").trim(),A=d.summary||"",L=d.content||"",I=d.protocol||"",w=(d.priority||"low").toLowerCase(),H=!!d.alert,D=(d.category||"system").trim(),z=d.related_event_ids||[],U=d.audit_event_id,j=!!localStorage.getItem(`alert_read_ts_${r.id}`),k=new Date(r.timestamp*1e3),C=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=j?"event-border-grey":"event-border-blue";!j&&H&&(T="event-border-red"),j&&(w==="high"||w==="critical")?T="event-border-red":j&&w==="medium"&&(T="event-border-orange");let S=j?"alert-read":"alert-unread",R=re.has(r.id),P=R?"expanded":"",te=R?"display: block;":"display: none;",q="",F="";z.length>0&&(F=`
        ...
        `,q=`
            ...
            `;let We=G.querySelector(".event-details");We&&We.addEventListener("click",se=>{se.stopPropagation()});let Ve=G.querySelector(".close-details-btn");return Ve&&Ve.addEventListener("click",se=>{se.stopPropagation(),G.classList.remove("expanded");let De=G.querySelector(".event-details");De&&(De.style.display="none"),re.delete(r.id)}),G},f=r=>{let d=document.createElement("div");d.className="notification-divider",d.dataset.alertId=r.id;let h="#888888";return r.label==="CRITICAL"?h="#ff4d4d":r.label==="HIGH"?h="#ff8888":r.label==="MEDIUM"&&(h="#ffa500"),d.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${h}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,d.innerHTML=`<span style="white-space: nowrap;">${r.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${h}44, transparent); flex-grow: 1;"></div>`,d},E=Array.from(e.children),y=new Map(E.map(r=>[r.dataset.alertId,r])),c=new Set(x.map(r=>r.id));E.forEach(r=>{let d=r.dataset.alertId;(!d||!c.has(d))&&r.remove()});let v=null;x.forEach((r,d)=>{let h=y.get(r.id);(!h||t)&&(h&&h.remove(),r.type==="divider"?h=f(r):h=s(r),!h)||(d===0?e.firstElementChild!==h&&e.prepend(h):v&&v.nextElementSibling!==h&&v.after(h),v=h)}),Ae=Date.now(),W(0,Ae),Te()}catch(a){console.error("Error fetching alerts:",a),e.children.length===0&&(e.innerHTML=N("offline","Failed to load alerts.","The event service may be offline."))}}function ss(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),n=document.getElementById("alerts-close-all"),a=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ie.forEach(i=>{localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ie.forEach(i=>{re.add(i.id),localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ne(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{re.clear(),ne(!0)},n.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let i=Date.now()-48*60*60*1e3;Ie.forEach(o=>{localStorage.setItem(`alert_read_ts_${o.id}`,i.toString())}),re.clear(),ne(!0)}catch(i){console.error("Failed to clear alerts:",i)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}async function He(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let a=(await e.json()).events||[],i=0;a.forEach(o=>{let l=o.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${o.id}`)||i++}),rt(i)}catch{}}var mt=()=>`
...
`,le=new Set,ft=[],ve=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){is();try{let n=await _("/roadmap");if(!n.ok)throw new Error("Offline");let a=await n.json();ft=a;let i=m=>{let x=le.has(m.id),g=m.state==="published",b=m.state==="consumed",s="event-border-grey";g&&(s="event-border-blue"),b&&(s="event-border-purple");let E=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),y=document.createElement("div");y.className=`event-item notification-item ${s} cursor-pointer ${x?"expanded":""}`,y.dataset.itemId=m.id,y.onclick=r=>{if(r.target.closest("button"))return;y.classList.contains("expanded")?(y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(m.id)):(y.classList.add("expanded"),y.querySelector(".event-details").style.display="block",le.add(m.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;y.innerHTML=`
      ...
      `;let v=y.querySelector(".event-details");return v&&v.addEventListener("click",r=>{r.stopPropagation()}),y.querySelector(".edit-btn")?.addEventListener("click",()=>ns(m)),y.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>as(m)),y.querySelector(".delete-btn")?.addEventListener("click",()=>os(m.id)),y.querySelector(".close-details-btn")?.addEventListener("click",r=>{r.stopPropagation(),y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(m.id)}),y},o=Array.from(e.children),l=new Map(o.map(m=>[m.dataset.itemId,m])),u=new Set(a.map(m=>m.id));if(o.forEach(m=>{let x=m.dataset.itemId;(!x||!u.has(x))&&m.remove()}),a.length===0){e.innerHTML=N("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let p=null;a.forEach((m,x)=>{let g=l.get(m.id);(!g||t)&&(g&&g.remove(),g=i(m),!g)||(x===0?e.firstElementChild!==g&&e.prepend(g):p&&p.nextElementSibling!==g&&p.after(g),p=g)})}catch{e.children.length===0&&(e.innerHTML=N("offline","Failed to load roadmap.","The event service may be offline."))}}}function is(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),i=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ve=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",ve=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let o=document.getElementById("roadmap-editor-input").value;if(!o.trim())return;let l=ve?`/roadmap/${ve}`:"/roadmap",u=ve?"PATCH":"POST";try{await _(l,{method:u,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:o})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(p){console.error(p)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{ft.forEach(o=>le.add(o.id)),ce(!0)},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{le.clear(),ce(!0)},i.dataset.listenerAttached="true")}function ns(t){ve=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function as(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(n){console.error(n)}}async function os(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var bt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`;function wt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"VS Code"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Ct(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=ls,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),Me(`/profile/${t.id}`).then(async n=>{if(n.ok){let a=await n.json();Re(e,t,a)}else{console.log("Profile not found or error, using mock data.");let a=wt(t.id,t.username);Re(e,t,a)}}).catch(n=>{console.error("Profile fetch error:",n);let a=wt(t.id,t.username);Re(e,t,a)})}function Re(t,e,n){let a=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",i=()=>{let E=(n.badges||[]).map(M=>`<span class="profile-badge ${M==="Creator"?"master":""}">${M}</span>`).join(""),y=(n.attributes||n.facts||[]).map(M=>{let A=M.key||M.k,L=M.value||M.v;return`
            <div class="fact-chip">
...
`,cs=null;async function Oe(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...",await Oe(),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let a=n.target.closest(".user-profile-card");if(a)try{let i=JSON.parse(a.dataset.user);Ct(i)}catch(i){console.error("Failed to parse user data",i)}},t.dataset.listenerAttached="true");try{let n=await Me("/contacts");if(!n.ok)throw new Error("Service unreachable");let i=(await n.json()).members||[];if(cs=Date.now(),i.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let o={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};i.sort((l,u)=>{let p=o[l.level]??10,m=o[u.level]??10;return p!==m?p-m:l.username.localeCompare(u.username)}),t.innerHTML=i.map(l=>{let u=l.color?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",p=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",m="#888";l.level==="Me"||l.level==="Master"?m="#bb86fc":l.level==="Admin"?m="#cf6679":l.level==="Moderator"?m="#03dac6":l.level==="Contributor"&&(m="#ffa500");let x=l.level==="Me",g=x?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",b=x?"2px solid #bb86fc":`1px solid ${u}33`;return`
...
`,_e=null,me=new Set,we=[],J="all",ps={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},ms={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function us(t){for(let[e,n]of Object.entries(ps))if(n.includes(t))return e;return"system"}function fs(t){return ms[t]||"bx-square-rounded"}async function ae(t=!1){let e=document.getElementById("events-timeline");if(!e)return;gs();let a=`/events?ml=${J==="all"?100:250}&format=json`;J!=="all"&&(a+=`&category=${J}`);try{let i=await _(a);if(!i.ok)throw new Error("Service unreachable");if(we=((await i.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let f=s.type;return!(f==="system.blueprint.generated"||f==="system.notification.generated")}),_e=Date.now(),W(1,_e),we.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let u=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let f=s.type,E=us(f),y=fs(f),c=f==="engagement.decision"||f==="messaging.bot.sent_message"||f==="messaging.user.sent_message"||f==="moderation.explicit_content.deleted"||f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="analysis.user.message_signals"||f==="system.cli.command"||f==="system.analysis.audit"||f==="system.test.completed"||f==="error_occurred"||f==="system.cli.status"||f==="system.attention.expired"||f.startsWith("system.roadmap")||f.startsWith("system.process"),v="event-border-grey";c&&(f==="moderation.explicit_content.deleted"||f==="error_occurred"?v="event-border-red":f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="system.analysis.audit"||f==="analysis.user.message_signals"?v="event-border-purple":f==="system.attention.expired"||f==="system.cli.command"||f==="system.cli.status"?v="event-border-orange":f==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",d=me.has(b.id),h=d?"expanded":"",M=d?"display: block;":"display: none;",A=new Date(b.timestamp*1e3),L=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),I=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),w=Et(f,s),H=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",D="";if(c){let k="";if(f==="engagement.decision"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
            ...
            `;let U=z.querySelector(".event-details");if(U&&U.addEventListener("click",k=>{k.stopPropagation()}),c){let k=z.querySelector(".close-details-btn");k&&k.addEventListener("click",C=>{C.stopPropagation();let $=C.target.closest(".event-item");if($){$.classList.remove("expanded"),me.delete(b.id);let T=$.querySelector(".event-details");T&&(T.style.display="none")}})}let V=z.querySelector(".prev-btn"),j=z.querySelector(".next-btn");if(V&&j){let k=0,C=z.querySelectorAll(".history-slide"),$=C.length,T=()=>{C.forEach((S,R)=>{S.style.display=R===k?"block":"none"}),V.disabled=k===0,j.disabled=k===$-1,V.style.opacity=k===0?"0.5":"1",j.style.opacity=k===$-1?"0.5":"1"};V.addEventListener("click",S=>{S.stopPropagation(),k>0&&(k--,T())}),j.addEventListener("click",S=>{S.stopPropagation(),k<$-1&&(k++,T())}),T()}return z},p=Array.from(e.children),m=new Map(p.map(b=>[b.dataset.eventId,b])),x=new Set(we.map(b=>b.id));p.forEach(b=>{let s=b.dataset.eventId;(!s||!x.has(s))&&b.remove()});let g=null;we.forEach((b,s)=>{let f=m.get(b.id);(!f||t)&&(f&&f.remove(),f=u(b),!f)||(s===0?e.firstElementChild!==f&&e.prepend(f):g&&g.nextElementSibling!==f&&g.after(f),g=f)}),_e=Date.now(),W(1,_e)}catch(i){console.error("Error fetching events:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load events.","The event service may be offline."))}}function gs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),n=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{we.forEach(i=>me.add(i.id)),ae(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ae(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{n.querySelectorAll(".filter-btn").forEach(o=>o.classList.remove("active")),i.classList.add("active"),J=i.dataset.filter,ae(!0)}}),n.dataset.listenerAttached="true"),n&&n.querySelectorAll(".filter-btn").forEach(i=>{i.dataset.filter===J?i.classList.add("active"):i.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let i=J==="all"?"ALL":J.toUpperCase();if(confirm(`Are you sure you want to delete ${i} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let o="/events";if(J!=="all"?o+=`?category=${J}`:o+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(o,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ae(!0)}catch(o){console.error("Failed to clear events:",o),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var bs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,St=bs;function kt(){return`
    ...
    `}var vs=null;async function Ce(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let n=await e.json();if(!n||n.length===0)return t.innerHTML=N("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let a=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],i=n.filter(l=>!a.includes(l.id));i.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),i.reverse();let o=i.map(l=>{let u=l.logs.join(`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${kt()}
        </div>`;async function Ht(){await Promise.all([$e(),je(),qe()]),await Ce()}var Tt=null,Lt=null;async function Nt(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function Mt(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function xs(){try{return await(await _("/processes")).json()}catch{return null}}async function ys(){try{return await(await _("/agent/status")).json()}catch{return null}}async function je(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),i=document.querySelector("#hw-ram .hw-content"),o=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),u=c=>{if(c){if(n&&(n.innerHTML=`
                ...
                </div>`),i){let v=(c.MEMORY_BYTES/1073741824).toFixed(1);i.innerHTML=`
                ...
                </div>`}function l(p){let m=p.status==="Downloaded",x=m?"service-widget-online":"service-widget-offline",g=m?"OK":"MISSING",b=m&&p.size>0?`${(p.size/1e9).toFixed(2)} GB`:"-",s=p.name;return p.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${p.name}"><div class="service-widget-header"><i class="bx ${m?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${g}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${p.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let u="";if(a&&(u+=i(a)),e.xtts&&(u+=o(e.xtts)),u+=n.map(l).join(""),!u){t.innerHTML=N("empty","No models found.");return}t.innerHTML!==u&&(t.innerHTML=u)}async function $e(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),n=document.getElementById("guardian-architect-val"),a=document.getElementById("guardian-idle-val"),i=document.getElementById("guardian-total-idle"),o=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),u=document.getElementById("guardian-reset-btn"),p=document.getElementById("analyzer-reset-btn");u&&!u.dataset.listenerAttached&&(u.onclick=async()=>{u.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await _("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{u.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{u.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),$e()}catch{u.innerHTML="<i class='bx bx-error'></i> Failed"}},u.dataset.listenerAttached="true"),p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{p.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await _("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{p.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{p.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),$e()}catch{p.innerHTML="<i class='bx bx-error'></i> Failed"}},p.dataset.listenerAttached="true");let m=await ys();if(m){let y=Math.floor(Date.now()/1e3),c=m.active_tier,v=m.active_synthesis,r=m.protocol_aliases||{sentry:"Sentry",architect:"Architect",synthesis:"Synthesis"},d=w=>{w<0&&(w=0);let H=Math.floor(w/3600),D=Math.floor(w%3600/60),z=w%60;return H>0?`${H}h ${D}m`:D>0?`${D}m ${z}s`:`${z}s`},h=(w,H,D,z,U)=>{if(!w)return;let V=r[z]||z.toUpperCase(),j=w.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(j&&(j.textContent=V),U&&U.includes(z))w.textContent="Working",w.style.color="#bb86fc";else if(D){let C=D.next_run-y;if(C<=0)w.textContent="Ready",w.style.color="#5eff5e";else{let $=Math.floor(C/60),T=C%60;w.textContent=`${$}m ${T}s`,w.style.color="#fff"}}H&&D&&(H.innerHTML=`
        ...
        <div class="process-history-item" data-channel-id="${u.channel_id}-${u.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let i=n?".process-history-item":".process-widget",o=new Map(Array.from(t.querySelectorAll(i)).map(u=>[u.dataset.channelId,u])),l=new Set(e.map(u=>`${u.channel_id}-${u.start_time}`));for(let[u,p]of o)l.has(u)||p.remove();e.forEach(u=>{let p=`${u.channel_id}-${u.start_time}`,m=a(u),x=o.get(p);if(x){x.outerHTML!==m&&(x.outerHTML=m);let g=t.querySelector(`[data-channel-id="${p}"]`);g&&t.appendChild(g)}else t.insertAdjacentHTML("beforeend",m)})}function Be(){let t=ye(),e=tt()||"master@easter.company",n={enabled:Notification.permission==="granted",supported:"Notification"in window},a=localStorage.getItem("easter_analytics_enabled")!=="false";return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ws=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,a]of Object.entries(t)){let i=Pt.filter(o=>o.category===n);i.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Rt(),document.getElementById("terminal-action-btn").onclick=()=>Rt());let n=document.getElementById("cli-terminal-body"),a=document.getElementById("cli-docs-pane");n.innerHTML="";let i=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return a.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Je=!0,n}function Rt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Je=!1}function Ot(t,e,n="output"){if(!Je)return;let a=document.createElement("div");a.className=`terminal-line terminal-${n}`,n==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=Le(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function $s(t){let e=Pt.find(i=>i.id===t);if(!e)return;let n=Cs(e);Ot(n,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let i of a){await new Promise(l=>setTimeout(l,400+Math.random()*600));let o="output";i.includes("[ERROR]")?o="error":i.includes("[SUCCESS]")||i.includes("\u2713")?o="success":i.includes("!")&&(o="warning"),Ot(n,i,o)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Ut(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=ws();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code").textContent;navigator.clipboard.writeText(n).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(n=>{n.addEventListener("mouseenter",()=>{n.style.transform="translateY(-5px)",n.style.borderColor="rgba(255,255,255,0.15)",n.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{n.style.transform="translateY(0)",n.style.borderColor="rgba(255,255,255,0.05)",n.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let a=n.dataset.cmd;$s(a)})})}async function Es(){try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function jt(){Es(),at(),Ze();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&Ut();let e=et();Ke(e),Xe();let n=document.getElementById("nav-left-container");n&&n.addEventListener("click",()=>{if(o.length>0)g();else{let r=window.location.pathname;if(!(r==="/"||r==="/index.html")){let M=(r.endsWith("/")&&r.length>1?r.slice(0,-1):r).split("/");M.pop();let A=M.join("/")||"/";window.location.href=A}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",i=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!i&&document.querySelector("footer")?.classList.add("hide");let o=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let u=r=>{localStorage.setItem("dex_last_window",r)};function p(){return 1}function m(){for(;o.length>1;)o.shift().close(!0);let r=document.getElementById("windows-container"),d=document.querySelector("nav"),h=document.querySelector("footer"),M=window.location.pathname==="/"||window.location.pathname==="/index.html",A=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");r&&r.setAttribute("data-count",o.length),o.forEach(H=>{let D=document.getElementById(H.id);D&&D.classList.remove("hide-close")}),Ee(ye());let L=document.getElementById("dexter-menu-container"),I=document.getElementById("nav-window-switcher"),w=document.getElementById("settings-icon");if(Ye(o.length>0),o.length>0){if(h?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),d?.classList.add("window-open"),r&&(r.style.paddingTop="60px"),L&&(L.style.display="none"),w&&(w.style.display="none"),I){let H=o[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(H)?(I.innerHTML=`
