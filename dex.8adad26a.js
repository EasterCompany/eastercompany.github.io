(()=>{function Ue(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function je(t=!1){let e=window.location.pathname,o=e==="/"||e==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var We=1e3;function X(t){let e=null,o=t.onClose||null,a=t.onOpen||null;function n(){e&&(e.style.zIndex=++We)}function i(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++We,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",u="",A;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let m=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${A}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),d()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let c=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),p(h,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&p(f,e)}function p(f,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),A=u.indexOf(f),h=s.clientWidth,c=u[Math.max(0,A-2)],v=u[Math.min(u.length-1,A+2)],r=c.offsetLeft-s.offsetLeft-25,y=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,C=y<=h?r-(h-y)/2:f.offsetLeft-s.offsetLeft-h/2+f.offsetWidth/2;s.scrollTo({left:C,behavior:"smooth"})},350)}function d(f=!1){e&&(window.removeEventListener("resize",l),f?(e.remove(),e=null):(e.classList.remove("open"),o&&o(),setTimeout(()=>{e?.remove(),e=null},400)))}function g(f){let b=e?.querySelector(".window-content");b&&(b.innerHTML=f)}function x(){return e&&e.classList.contains("open")}return{open:i,close:d,setContent:g,isOpen:x,focus:n,id:t.id}}function Ve(){return!0}function Je(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Ke(t){localStorage.setItem("easter_user_email",t.trim())}var Ye="easter_theme",W={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ge(){return localStorage.getItem(Ye)||W.DARK}function Xe(t){if(!Object.values(W).includes(t))throw new Error("Invalid theme");localStorage.setItem(Ye,t),he(t)}function he(t){let e=document.body;if(Object.values(W).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[W.LIGHT,W.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function Qe(){let t=ge();he(t)}function D(t,e,o=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",i=o?`<p class="placeholder-action">${o}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${i}</div>`}function H(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function F(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!o)return;if(!e){o.textContent="Last updated: never";return}let a=Date.now(),n=Math.floor((a-e)/1e3),i;n<60?i=`${n}s ago`:n<3600?i=`${Math.floor(n/60)}m ago`:i=`${Math.floor(n/3600)}h ago`,o.textContent=`Last updated: ${i}`}var Bt=0;function fe(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!o)return;let a=o.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var V=0,J=0;function Ze(t){V=t,ce()}function et(t){J=t,ce()}function ce(){let t=V+J;Bt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let o=document.getElementById("alerts-menu-item");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",o.appendChild(l)),l.textContent=V>9?"9+":V,l.style.display=V>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=J>9?"9+":J,l.style.display=J>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=V>9?"9+":V,l.style.display=V>0?"flex":"none"}let i=document.getElementById("switch-workspace");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=J>9?"9+":J,l.style.display=J>0?"flex":"none"}}function $e(){let t=document.getElementById("alerts-list");if(!t)return;V=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ce()}function tt(){let t=document.getElementById("blueprints-list");if(!t)return;J=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ce()}function Be(){return"https://event.easter.company"}function Dt(){return"https://discord.easter.company"}var Ht="http://127.0.0.1:8100",Nt="http://127.0.0.1:8300",zt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Se(t){let e=H(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,i)=>{let l=zt[i];return l?`<span class="${l}">`:""});let o=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return o>a&&(e+="</span>".repeat(o-a)),e}function be(t){if(!t)return"";let e=H(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(o,a)=>{let n=a.split("|").map(i=>i.trim());return n.every(i=>i.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(i=>`<span class="md-table-cell">${i}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var re=null,le=null,we=!1,Ee=!1;async function M(t,e={}){if(re)try{let n=await fetch(re+t,e);if(n.ok)return n;re=null}catch{re=null}let o=Be(),a=Ht;try{let n=await fetch(o+t,e);if(n.ok)return re=o,we&&(console.log("\u2728 Production event service restored."),we=!1),n;throw new Error("Primary failed")}catch{we||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),we=!0);try{let i=await fetch(a+t,e);if(i.ok)return re=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}async function st(t,e={}){if(le)try{let n=await fetch(le+t,e);if(n.ok)return n;le=null}catch{le=null}let o=Dt(),a=Nt;try{let n=await fetch(o+t,e);if(n.ok)return le=o,Ee&&(console.log("\u2728 Production discord service restored."),Ee=!1),n;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),Ee=!0);try{let i=await fetch(a+t,e);if(i.ok)return le=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}var nt=()=>`
...
`,Ce=null,Q=new Set,ke=[];async function Z(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Pt(),t&&(e.innerHTML="<p>Updating...</p>");let o="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await M(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];Ce=Date.now(),F(0,Ce);let l=Date.now(),p=24*60*60*1e3,d=i.filter(r=>{let m=localStorage.getItem(`alert_read_ts_${r.id}`);if(!m)return!0;let y=parseInt(m);return l-y<p});d.sort((r,m)=>{let y=L=>{let T=L.event;if(typeof T=="string")try{T=JSON.parse(T)}catch{return"low"}return(T.priority||"low").toLowerCase()},C=L=>L==="critical"?4:L==="high"?3:L==="medium"?2:1,E=C(y(r)),S=C(y(m));return E!==S?S-E:m.timestamp-r.timestamp}),ke=d;let g=r=>{let m=r.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return"low"}return(m.priority||"low").toLowerCase()},x=[],b=new Set(d.map(r=>g(r))).size>1;if(d.length>0){let r=null;d.forEach(m=>{let y=g(m);b&&y!==r&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),r=y),x.push(m)})}if(t&&(e.innerHTML=""),d.length===0){e.innerHTML=D("empty","No alerts yet."),$e();return}let s=r=>{let m=r.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let y=(m.title||"Untitled Alert").trim(),C=(m.body||"No description provided.").trim(),E=(m.priority||"low").toLowerCase(),S=!!m.alert,L=(m.category||"system").trim(),T=m.related_event_ids||[],N=m.audit_event_id,B=!!localStorage.getItem(`alert_read_ts_${r.id}`),R=new Date(r.timestamp*1e3),j=R.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),K=R.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=B?"event-border-grey":"event-border-blue";!B&&S&&(k="event-border-red"),B&&(E==="high"||E==="critical")?k="event-border-red":B&&E==="medium"&&(k="event-border-orange");let w=B?"alert-read":"alert-unread",$=Q.has(r.id),_=$?"expanded":"",I=$?"display: block;":"display: none;",z="",O="";T.length>0&&(O=`
            ...
            <div style="flex: 1; min-width: 120px;">
                ...
                <div class="event-detail-block" style="text-align: left;">
                    ...
                    <div class="detail-pre" style="color: #fff;">${be(C)}</div>
                </div>
            `;let P=document.createElement("div");P.className=`event-item notification-item ${k} ${w} ${_} cursor-pointer priority-${E}`,P.dataset.alertId=r.id,P.onclick=function(Y){if(this.classList.contains("expanded")){this.classList.remove("expanded"),Q.delete(r.id);let ue=this.querySelector(".event-details");ue&&(ue.style.display="none")}else{this.classList.add("expanded"),Q.add(r.id);let ue=this.querySelector(".event-details");if(ue&&(ue.style.display="block"),!localStorage.getItem(`alert_read_ts_${r.id}`)){localStorage.setItem(`alert_read_ts_${r.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Me="event-border-grey";E==="high"||E==="critical"?Me="event-border-red":E==="medium"&&(Me="event-border-orange"),this.classList.add(Me),$e()}}};let G=y,me={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[L]||"bx-bell";P.innerHTML=`
            ...
            `;let ye=P.querySelector(".event-details");ye&&ye.addEventListener("click",Y=>{Y.stopPropagation()});let Ae=P.querySelector(".close-details-btn");return Ae&&Ae.addEventListener("click",Y=>{Y.stopPropagation(),P.classList.remove("expanded");let _e=P.querySelector(".event-details");_e&&(_e.style.display="none"),Q.delete(r.id)}),P},u=r=>{let m=document.createElement("div");m.className="notification-divider",m.dataset.alertId=r.id;let y="#888888";return r.label==="CRITICAL"?y="#ff4d4d":r.label==="HIGH"?y="#ff8888":r.label==="MEDIUM"&&(y="#ffa500"),m.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,m.innerHTML=`<span style="white-space: nowrap;">${r.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,m},A=Array.from(e.children),h=new Map(A.map(r=>[r.dataset.alertId,r])),c=new Set(x.map(r=>r.id));A.forEach(r=>{let m=r.dataset.alertId;(!m||!c.has(m))&&r.remove()});let v=null;x.forEach((r,m)=>{let y=h.get(r.id);(!y||t)&&(y&&y.remove(),r.type==="divider"?y=u(r):y=s(r),!y)||(m===0?e.firstElementChild!==y&&e.prepend(y):v&&v.nextElementSibling!==y&&v.after(y),v=y)}),Ce=Date.now(),F(0,Ce),$e()}catch(a){console.error("Error fetching alerts:",a),e.children.length===0&&(e.innerHTML=D("offline","Failed to load alerts.","The event service may be offline."))}}function Pt(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),o=document.getElementById("alerts-close-all"),a=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ke.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),Z(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ke.forEach(n=>{Q.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),Z(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{Q.clear(),Z(!0)},o.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;ke.forEach(i=>{localStorage.setItem(`alert_read_ts_${i.id}`,n.toString())}),Q.clear(),Z(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}async function it(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await M(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${i.id}`)||n++}),Ze(n)}catch{}}var at=()=>`
...
`,ee=new Set,rt=[],de=null;async function te(t=!1){let e=document.getElementById("roadmap-list");if(e){Rt();try{let o=await M("/roadmap");if(!o.ok)throw new Error("Offline");let a=await o.json();rt=a;let n=g=>{let x=ee.has(g.id),f=g.state==="published",b=g.state==="consumed",s="event-border-grey";f&&(s="event-border-blue"),b&&(s="event-border-purple");let A=new Date(g.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${s} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=g.id,h.onclick=r=>{if(r.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ee.delete(g.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",ee.add(g.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${g.state.toUpperCase()}]</span>`;h.innerHTML=`
      ...
      `;let v=h.querySelector(".event-details");return v&&v.addEventListener("click",r=>{r.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Ot(g)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>qt(g)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Ut(g.id)),h.querySelector(".close-details-btn")?.addEventListener("click",r=>{r.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ee.delete(g.id)}),h},i=Array.from(e.children),l=new Map(i.map(g=>[g.dataset.itemId,g])),p=new Set(a.map(g=>g.id));if(i.forEach(g=>{let x=g.dataset.itemId;(!x||!p.has(x))&&g.remove()}),a.length===0){e.innerHTML=D("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let d=null;a.forEach((g,x)=>{let f=l.get(g.id);(!f||t)&&(f&&f.remove(),f=n(g),!f)||(x===0?e.firstElementChild!==f&&e.prepend(f):d&&d.nextElementSibling!==f&&d.after(f),d=f)})}catch{e.children.length===0&&(e.innerHTML=D("offline","Failed to load roadmap.","The event service may be offline."))}}}function Rt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),o=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{de=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",de=null},o.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let i=document.getElementById("roadmap-editor-input").value;if(!i.trim())return;let l=de?`/roadmap/${de}`:"/roadmap",p=de?"PATCH":"POST";try{await M(l,{method:p,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:i})}),document.getElementById("roadmap-editor-container").style.display="none",te(!0)}catch(d){console.error(d)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{rt.forEach(i=>ee.add(i.id)),te(!0)},a.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ee.clear(),te(!0)},n.dataset.listenerAttached="true")}function Ot(t){de=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function qt(t){let e=t.state==="published"?"draft":"published";try{await M(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),te(!0)}catch(o){console.error(o)}}async function Ut(t){if(confirm("Delete this roadmap item?"))try{await M(`/roadmap/${t}`,{method:"DELETE"}),ee.delete(t),te(!0)}catch(e){console.error(e)}}var ct=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,lt=null,se=new Set,pt=[];async function ne(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;jt();let o="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await M(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];if(pt=i,lt=Date.now(),F(2,lt),i.length===0){e.innerHTML=D("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),fe(2,0);return}t&&(e.innerHTML="");let l=f=>{let b=f.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let s=(b.title||"Untitled Blueprint").trim(),u=(b.summary||b.body||"No summary provided.").trim(),A=(b.content||"").trim(),h=(b.category||"architecture").trim(),c=(b.related_services||b.affected_services||[]).map(I=>I.trim()),v=(b.implementation_path||[]).map(I=>I.trim()),r=b.source_event_ids||[],m=b.approved===!0,y=new Date(f.timestamp*1e3),C=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),E=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=se.has(f.id),L=S?"display: block;":"display: none;",T=document.createElement("div");T.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${m?"blueprint-approved":""}`,T.dataset.blueprintId=f.id,m&&(T.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",T.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let U=m?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";T.onclick=function(I){if(this.classList.contains("expanded")){this.classList.remove("expanded"),se.delete(f.id);let O=this.querySelector(".event-details");O&&(O.style.display="none")}else{this.classList.add("expanded"),se.add(f.id);let O=this.querySelector(".event-details");O&&(O.style.display="block")}};let B="";v.length>0&&(B=`
            ...
            `;let k=T.querySelector(".blueprint-approve-btn");k&&(k.onclick=async I=>{I.stopPropagation(),k.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await M(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ne(!0)}catch(z){console.error("Failed to approve blueprint:",z)}});let w=T.querySelector(".blueprint-delete-btn");w&&(w.onclick=async I=>{I.stopPropagation();let z=!m;w.innerHTML=z?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await M(`/events/${f.id}`,{method:"DELETE"})).ok&&ne(!0)}catch(O){console.error("Failed to delete blueprint:",O)}});let $=T.querySelector(".event-details");$&&$.addEventListener("click",I=>{I.stopPropagation()});let _=T.querySelector(".close-details-btn");return _&&_.addEventListener("click",I=>{I.stopPropagation(),T.classList.remove("expanded");let z=T.querySelector(".event-details");z&&(z.style.display="none"),se.delete(f.id)}),T},p=Array.from(e.children),d=new Map(p.map(f=>[f.dataset.blueprintId,f])),g=new Set(i.map(f=>f.id));p.forEach(f=>{let b=f.dataset.blueprintId;(!b||!g.has(b))&&f.remove()});let x=null;i.forEach((f,b)=>{let s=d.get(f.id);(!s||t)&&(s&&s.remove(),s=l(f),!s)||(b===0?e.firstElementChild!==s&&e.prepend(s):x&&x.nextElementSibling!==s&&x.after(s),x=s)}),fe(2,i.length),tt()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=D("offline","Failed to load blueprints.","The event service may be offline."))}}async function mt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await M(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),et(n)}catch{}}function jt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),o=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{pt.forEach(a=>se.add(a.id)),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{se.clear(),ne(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){o.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.blueprint.generated",{method:"DELETE"}),se.clear(),ne(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{o.innerHTML="<i class='bx bx-trash'></i> Clear"}}},o.dataset.listenerAttached="true")}var ut=()=>`
...
`;async function De(){await Promise.all([te(),ne()])}var gt=()=>`
...
`,Te=null,ie=new Set,ve=[],q="all",Wt={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision"],moderation:["moderation.explicit_content.deleted"]},Vt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Jt(t){for(let[e,o]of Object.entries(Wt))if(o.includes(t))return e;return"system"}function Kt(t){return Vt[t]||"bx-square-rounded"}async function ae(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Yt();let a=`/events?ml=${q==="all"?100:250}&format=json`;q!=="all"&&(a+=`&category=${q}`);try{let n=await M(a);if(!n.ok)throw new Error("Service unreachable");if(ve=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Te=Date.now(),F(1,Te),ve.length===0){e.innerHTML=D("empty","No events found for this filter.");return}t&&(e.innerHTML="");let p=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,A=Jt(u),h=Kt(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),v="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?v="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"?v="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?v="event-border-orange":u==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",m=ie.has(b.id),y=m?"expanded":"",C=m?"display: block;":"display: none;",E=new Date(b.timestamp*1e3),S=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),L=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=ft(u,s),N=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",U="";if(c){let k="";if(u==="engagement.decision"){let w=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                    ...
                    `}else if(u==="system.attention.expired"){let w=I=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${I}</h5>`,$=s.timestamp-s.last_active,_=Math.floor($/60);k=`
                    ...
                    `}else if(u==="system.analysis.audit"){let w=s.success?"#03dac6":"#ff4d4d",$=s.success?"SUCCESS":"FAILED",_=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,I="";s.error&&(I=`
                        ...
                        `);let z="";if(s.chat_history&&s.chat_history.length>0){let P=s.chat_history.length,G=s.chat_history.map((oe,me)=>{let ye=oe.role==="user"?"#03dac6":oe.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${me}" style="display: ${me===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; text-transform: uppercase; color: ${ye}; letter-spacing: 1px; font-weight: bold;">${oe.role}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${me+1} of ${P}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${H(oe.content)}</div>
                                </div>
                            `}).join("");z=`
                            <div class="event-detail-block">
                        ...
                        `}let O="";if(s.corrections&&s.corrections.length>0){let P=s.corrections.map((G,oe)=>`
                ...
                `}let B=document.createElement("div");B.className=`event-item ${v} ${r} ${y}`,B.dataset.eventId=b.id,B.onclick=function(k){if(!c)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),ie.delete(b.id);let $=this.querySelector(".event-details");$&&($.style.display="none")}else{this.classList.add("expanded"),ie.add(b.id);let $=this.querySelector(".event-details");$&&($.style.display="block")}},B.innerHTML=`
                <div class="event-time">
            ...
            `;let R=B.querySelector(".event-details");if(R&&R.addEventListener("click",k=>{k.stopPropagation()}),c){let k=B.querySelector(".close-details-btn");k&&k.addEventListener("click",w=>{w.stopPropagation();let $=w.target.closest(".event-item");if($){$.classList.remove("expanded"),ie.delete(b.id);let _=$.querySelector(".event-details");_&&(_.style.display="none")}})}let j=B.querySelector(".prev-btn"),K=B.querySelector(".next-btn");if(j&&K){let k=0,w=B.querySelectorAll(".history-slide"),$=w.length,_=()=>{w.forEach((I,z)=>{I.style.display=z===k?"block":"none"}),j.disabled=k===0,K.disabled=k===$-1,j.style.opacity=k===0?"0.5":"1",K.style.opacity=k===$-1?"0.5":"1"};j.addEventListener("click",I=>{I.stopPropagation(),k>0&&(k--,_())}),K.addEventListener("click",I=>{I.stopPropagation(),k<$-1&&(k++,_())}),_()}return B},d=Array.from(e.children),g=new Map(d.map(b=>[b.dataset.eventId,b])),x=new Set(ve.map(b=>b.id));d.forEach(b=>{let s=b.dataset.eventId;(!s||!x.has(s))&&b.remove()});let f=null;ve.forEach((b,s)=>{let u=g.get(b.id);(!u||t)&&(u&&u.remove(),u=p(b),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):f&&f.nextElementSibling!==u&&f.after(u),f=u)}),Te=Date.now(),F(1,Te)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=D("offline","Failed to load events.","The event service may be offline."))}}function Yt(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),o=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ve.forEach(n=>ie.add(n.id)),ae(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ie.clear(),ae(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{o.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active")),n.classList.add("active"),q=n.dataset.filter,ae(!0)}}),o.dataset.listenerAttached="true"),o&&o.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===q?n.classList.add("active"):n.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let n=q==="all"?"ALL":q.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let i="/events";if(q!=="all"?i+=`?category=${q}`:i+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await M(i,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ie.clear(),ae(!0)}catch(i){console.error("Failed to clear events:",i),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}function bt(){return`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${bt()}
        </div>`;async function kt(){await Promise.all([Le(),Pe(),Re()]),await xe()}var vt=null,xt=null;async function Tt(){try{return await(await M("/system_monitor")).json()}catch{return null}}async function yt(){try{return await(await M("/system/hardware")).json()}catch{return null}}async function Qt(){try{return await(await M("/processes")).json()}catch{return null}}async function Zt(){try{return await(await M("/agent/status")).json()}catch{return null}}async function Pe(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),o=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),i=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),p=c=>{if(c){if(o&&(o.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):i.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),l&&c.STORAGE&&c.STORAGE.length>0?l.innerHTML=c.STORAGE.map(v=>{let r=(v.USED/1073741824).toFixed(1),m=(v.SIZE/(1024*1024*1024)).toFixed(1),y=v.SIZE>0?(v.USED/v.SIZE*100).toFixed(0):0,C=v.MOUNT_POINT||"Unmounted";return`
                ...
                </div>`:R='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${r}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${m}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${y}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${b(c.domain&&c.port?`${c.domain}:${c.port}`:"")}</span></div>${R}</div></div>`}let A=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),h=new Set(g.map(c=>c.id));for(let[c,v]of A)h.has(c)||v.remove();g.forEach(c=>{let v=u(c),r=A.get(c.id);r?r.outerHTML!==v&&(r.outerHTML=v):t.insertAdjacentHTML("beforeend",v)})}async function Re(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Tt();if(!e){t.children.length===0&&(t.innerHTML=D("offline","Failed to load model status.","The event service may be offline."));return}xt=Date.now(),F(2,xt);let o=e.models||[],a=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function n(d){let g=d.status==="Ready";return`
                ...
                </div>`}function l(d){let g=d.status==="Downloaded",x=g?"service-widget-online":"service-widget-offline",f=g?"OK":"MISSING",b=g&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${g?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let p="";if(a&&(p+=n(a)),e.xtts&&(p+=i(e.xtts)),p+=o.map(l).join(""),!p){t.innerHTML=D("empty","No models found.");return}t.innerHTML!==p&&(t.innerHTML=p)}async function Le(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-t1-val"),o=document.getElementById("guardian-t2-val"),a=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),i=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),p=document.getElementById("guardian-reset-btn");p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{p.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await M("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{p.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{p.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),Le()}catch{p.innerHTML="<i class='bx bx-error'></i> Failed"}},p.dataset.listenerAttached="true");let d=await Zt();if(d){let A=Math.floor(Date.now()/1e3),h=d.active_tier,c=d.protocol_aliases||{t1:"Sentry",t2:"Architect"},v=C=>{C<0&&(C=0);let E=Math.floor(C/3600),S=Math.floor(C%3600/60),L=C%60;return E>0?`${E}h ${S}m`:S>0?`${S}m ${L}s`:`${L}s`},r=(C,E,S,L)=>{let T=c[L]||L.toUpperCase(),N=C.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(N&&(N.textContent=T),h===L)C.textContent="Working",C.style.color="#bb86fc";else if(L==="t1"&&h==="tests")C.textContent="Testing",C.style.color="#03dac6";else if(S){let B=S.next_run-A;if(B<=0)C.textContent="Ready",C.style.color="#5eff5e";else{let R=Math.floor(B/60),j=B%60;C.textContent=`${R}m ${j}s`,C.style.color="#fff"}}E&&S&&(E.innerHTML=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ts=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[o,a]of Object.entries(t)){let n=At.filter(i=>i.category===o);n.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Lt(),document.getElementById("terminal-action-btn").onclick=()=>Lt());let o=document.getElementById("cli-terminal-body"),a=document.getElementById("cli-docs-pane");o.innerHTML="";let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return a.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),qe=!0,o}function Lt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),qe=!1}function It(t,e,o="output"){if(!qe)return;let a=document.createElement("div");a.className=`terminal-line terminal-${o}`,o==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=Se(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function ns(t){let e=At.find(n=>n.id===t);if(!e)return;let o=ss(e);It(o,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let n of a){await new Promise(l=>setTimeout(l,400+Math.random()*600));let i="output";n.includes("[ERROR]")?i="error":n.includes("[SUCCESS]")||n.includes("\u2713")?i="success":n.includes("!")&&(i="warning"),It(o,n,i)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function _t(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=ts();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let o=e.querySelector("code").textContent;navigator.clipboard.writeText(o).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(o=>{o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-5px)",o.style.borderColor="rgba(255,255,255,0.15)",o.style.backgroundColor="rgba(255,255,255,0.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)",o.style.borderColor="rgba(255,255,255,0.05)",o.style.backgroundColor="rgba(255,255,255,0.03)"}),o.addEventListener("click",()=>{let a=o.dataset.cmd;ns(a)})})}async function is(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${Be()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Mt(){is(),Qe(),Ue();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&_t();let e=Ve();je(e),Ge();let o=document.getElementById("nav-left-container");o&&o.addEventListener("click",()=>{if(i.length>0)f();else{let r=window.location.pathname;if(!(r==="/"||r==="/index.html")){let C=(r.endsWith("/")&&r.length>1?r.slice(0,-1):r).split("/");C.pop();let E=C.join("/")||"/";window.location.href=E}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",n=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!n&&document.querySelector("footer")?.classList.add("hide");let i=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let p=r=>{localStorage.setItem("dex_last_window",r)};function d(){return 1}function g(){for(;i.length>1;)i.shift().close(!0);let r=document.getElementById("windows-container"),m=document.querySelector("nav"),y=document.querySelector("footer"),C=window.location.pathname==="/"||window.location.pathname==="/index.html",E=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");r&&r.setAttribute("data-count",i.length),i.forEach(N=>{let U=document.getElementById(N.id);U&&U.classList.remove("hide-close")}),he(ge());let S=document.getElementById("dexter-menu-container"),L=document.getElementById("nav-window-switcher"),T=document.getElementById("settings-icon");if(Fe(i.length>0),i.length>0){if(y?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),m?.classList.add("window-open"),r&&(r.style.paddingTop="60px"),S&&(S.style.display="none"),T&&(T.style.display="none"),L){let N=i[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(N)?(L.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{p("alerts-window"),x(b)}),document.getElementById("switch-events").addEventListener("click",()=>{p("events-window"),x(s)}),document.getElementById("switch-monitor").addEventListener("click",()=>{p("monitor-window"),x(A)}),document.getElementById("switch-contacts").addEventListener("click",()=>{p("contacts-window"),x(u)}),document.getElementById("switch-workspace").addEventListener("click",()=>{p("workspace-window"),x(h)})):L.innerHTML=""}}else m?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),r&&(r.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),C||E?y?.classList.remove("hide"):y?.classList.add("hide"),S&&(S.style.display="flex"),T&&(T.style.display="block"),L&&(L.innerHTML="");ce()}function x(r){if(r.isOpen()){r.close();return}for(;i.length>0;)i.pop().close(!0);i.push(r),r.open(),g()}function f(){[...i].forEach(m=>m.close()),i=[]}window.addEventListener("resize",g);let b=X({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:nt(),onOpen:()=>Z(),onClose:()=>{let r=i.indexOf(b);r>-1&&i.splice(r,1),g()}}),s=X({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Ne(),onOpen:()=>{s.setContent(Ne()),ae()},onClose:()=>{let r=i.indexOf(s);r>-1&&i.splice(r,1),g()}}),u=X({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:gt(),onOpen:()=>He(),onClose:()=>{let r=i.indexOf(u);r>-1&&i.splice(r,1),g()}}),A=X({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Et()},{icon:"bxs-component",title:"Processes",content:wt()},{icon:"bxs-brain",title:"Models",content:$t()},{icon:"bxs-hdd",title:"Hardware",content:St()},{icon:"bxs-terminal",title:"Logs",content:Ct()},{icon:"bxs-zap",title:"Agents",content:ht()}],onOpen:()=>{Pe(),Le(),Re(),xe()},onClose:()=>{let r=i.indexOf(A);r>-1&&i.splice(r,1),g()}}),h=X({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:ut(),onOpen:()=>De(),onClose:()=>{let r=i.indexOf(h);r>-1&&i.splice(r,1),g()}}),c=X({id:"settings-window",title:"Settings",icon:"bx-cog",content:Ie(),onOpen:()=>{c.setContent(Ie()),Oe(c)},onClose:()=>{let r=i.indexOf(c);r>-1&&i.splice(r,1),g()}}),v=X({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="/dexter/contribute" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});if(window.dexter={viewEvent:r=>{s.isOpen()||x(s),setTimeout(()=>{let m=document.querySelector(`.event-item[data-event-id="${r}"]`);m&&(m.scrollIntoView({behavior:"smooth",block:"center"}),m.classList.add("flash-highlight"),m.classList.contains("expanded")||m.click(),setTimeout(()=>m.classList.remove("flash-highlight"),2e3))},500)},viewAlert:r=>{b.isOpen()||x(b),setTimeout(()=>{let m=document.querySelector(`.event-item[data-alert-id="${r}"]`);m&&(m.scrollIntoView({behavior:"smooth",block:"center"}),m.classList.add("flash-highlight"),m.classList.contains("expanded")||m.click(),setTimeout(()=>m.classList.remove("flash-highlight"),2e3))},500)}},e){let r=document.getElementById("dexter-dropdown");r&&(r.innerHTML=`
