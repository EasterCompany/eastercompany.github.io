(()=>{function me(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function ue(e=!1){let n=`
        <div class="nav-left">
    ...
    `,r=document.createElement("nav");r.innerHTML=n,document.body.prepend(r)}function ve(){let e=`
    ...
    `,t=document.createElement("footer");t.innerHTML=e,document.body.appendChild(t)}function B(e){let t=null,n=e.onClose||null,r=e.onOpen||null;function i(){if(t){t.classList.add("open"),r&&setTimeout(r,10);return}let d=document.getElementById("windows-container");d||(d=document.createElement("div"),d.id="windows-container",d.className="windows-container",document.body.appendChild(d)),t=document.createElement("div"),t.id=e.id,t.className="window";let b=e.icon||"bx-window",s="",p="",v;e.tabs&&e.tabs.length>0?(s=`<div class="tab-bar">${e.tabs.map((o,g)=>{let y;return o.icon?y=`<i class="bx ${o.icon}"></i>`:o.title&&o.title.length>0?y=`<span class="tab-glyph">${o.title.charAt(0).toUpperCase()}</span>`:y='<i class="bx bx-question-mark"></i>',`
        ...
        `;t.innerHTML=h+v,d.appendChild(t);let f=t.querySelector(".window-close");f&&f.addEventListener("click",l=>{l.stopPropagation(),a()}),e.tabs&&e.tabs.length>0&&t.querySelectorAll(".tab").forEach(m=>{m.addEventListener("click",()=>{let o=m.getAttribute("data-tab-index");t.querySelectorAll(".tab").forEach(g=>g.classList.remove("active")),m.classList.add("active"),t.querySelectorAll(".tab-content").forEach(g=>g.classList.remove("active")),t.querySelector(`.tab-content[data-tab-content="${o}"]`).classList.add("active")})}),setTimeout(()=>{t.classList.add("open"),r&&r()},10)}function a(d=!1){t&&(d?(t.classList.add("switching"),t.classList.remove("open"),setTimeout(()=>{t&&t.parentNode&&t.parentNode.removeChild(t),t=null},200)):(t.classList.remove("open"),n&&n(),setTimeout(()=>{t&&t.parentNode&&t.parentNode.removeChild(t),t=null},400)))}function u(d){if(t){let b=t.querySelector(".window-content");b&&(b.innerHTML=d)}}function c(){return t&&t.classList.contains("open")}return{open:i,close:a,setContent:u,isOpen:c,id:e.id}}var Z="easter_user_email";function ge(){return localStorage.getItem(Z)!==null}function R(){return localStorage.getItem(Z)}function fe(e){if(!e||!e.includes("@"))throw new Error("Invalid email address");if(!e.trim().toLowerCase().endsWith("@easter.company"))throw new Error("Access denied. Please check your credentials.");localStorage.setItem(Z,e.trim())}var be="easter_theme",_={AUTO:"auto",DEFAULT:"default",ANIMATED:"animated"};function te(){return localStorage.getItem(be)||_.AUTO}function Me(){let e=window.innerWidth,t=window.innerHeight,n=window.innerHeight===window.screen.height&&window.innerWidth===window.screen.width;return e>1920&&t>1080?_.ANIMATED:(e===1920&&t===1080&&n||e<=1920||t<=1080,_.DEFAULT)}function he(e){if(!Object.values(_).includes(e))throw new Error("Invalid theme");localStorage.setItem(be,e),ee(e)}function ee(e,t=!1){let n=document.body,r=e===_.AUTO?Me():e;if(t||(n.classList.add("theme-transitioning"),setTimeout(()=>{n.classList.remove("theme-transitioning")},300)),Object.values(_).forEach(i=>{n.classList.remove(`theme-${i}`)}),n.classList.add(`theme-${e}`),r===_.ANIMATED){if(!document.querySelector(".background")){let i=document.createElement("div");i.className="background",document.body.prepend(i)}}else{let i=document.querySelector(".background");i&&(t?i.remove():(i.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{i.remove()},400)))}}function ye(){let e=te();if(ee(e,!0),e===_.AUTO){let t;window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{ee(_.AUTO)},300)})}}function j(e,t,n=null){let i={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[e]||"bx-info-circle",a=n?`<p class="placeholder-action">${n}</p>`:"";return`
    ...
    `}var se=null;async function ne(){let e=document.getElementById("logs-container");if(!e)return!1;e.classList.remove("placeholder-active");let t=localStorage.getItem("service_map");if(!t)return e.classList.add("placeholder-active"),e.innerHTML=j("config","No service map configured.","Please upload your service-map.json in Settings to enable log monitoring."),!1;let n;try{n=JSON.parse(t)}catch(u){return console.error("Error parsing service_map from localStorage:",u),e.classList.add("placeholder-active"),e.innerHTML=j("error","Invalid service map data.","Please re-upload a valid service-map.json file in Settings."),!1}let r=null;if(n&&typeof n.services=="object"){let u=["cs","be","th"];for(let c of u)if(Array.isArray(n.services[c])){let d=n.services[c].find(b=>b.short_name==="event"||b.id==="event"||b.id==="dex-event-service");if(d){r=d;break}}}if(!r)return e.classList.add("placeholder-active"),e.innerHTML=j("error","Event service not found in service map.","Please ensure dex-event-service is configured in your service-map.json."),!1;let a=`http://${r.domain==="0.0.0.0"?"localhost":r.domain}:${r.port}/logs`;try{let u=await fetch(a);if(!u.ok)return e.classList.add("placeholder-active"),e.innerHTML=j("offline","Event service is offline.","Please ensure the event service is running."),!1;let c=await u.json();if(!c||c.length===0)return e.classList.add("placeholder-active"),e.innerHTML=j("empty","No logs found.","Service logs will appear here when available."),!1;let d=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],b=c.filter(p=>!d.includes(p.id));b.forEach(p=>{p.logs&&Array.isArray(p.logs)?p.logs.reverse():p.logs=[]}),b.reverse();let s=b.map(p=>{let v=p.logs.join(`
`);return`
            ...
            `}).join("");return e.innerHTML=s,document.querySelectorAll(".copy-logs-btn").forEach(p=>{p.addEventListener("click",()=>{let v=unescape(p.dataset.logs);navigator.clipboard.writeText(v).then(()=>{let h=p.querySelector("i");h.classList.remove("bx-copy"),h.classList.add("bx-check"),setTimeout(()=>{h.classList.remove("bx-check"),h.classList.add("bx-copy")},2e3)})})}),se=Date.now(),!0}catch(u){return console.error("Error fetching logs:",u),e.classList.add("placeholder-active"),e.innerHTML=j("offline","Failed to load logs.","The event service may be offline, unreachable, or blocked by a browser extension (e.g., ad blocker)."),!1}}function w(e,t,n=null){let i={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[e]||"bx-info-circle",a=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${i} placeholder-icon'></i><p class="placeholder-message">${t}</p>${a}</div>`}function M(e){return e&&e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function T(e,t){let n=document.querySelector(`.tab[data-tab-index="${e}"] .tab-subtitle`);if(!n)return;if(!t){n.textContent="Last updated: never";return}let i=(Date.now()-t)/1e3,a;if(i<30)a=`${Math.floor(i)}s ago`;else{n.textContent="Last updated: never";return}n.textContent=`Last updated: ${a}`}function z(){let e=document.getElementById("notifications-list");if(!e)return;let t=e.querySelectorAll(".notification-unread").length,n=document.querySelector('.tab[data-tab-index="0"]');if(n){let r=n.querySelector(".notification-badge");t>0?(r||(r=document.createElement("span"),r.className="notification-badge",n.appendChild(r)),r.textContent=t>9?"9+":t,r.style.display="flex"):r&&(r.style.display="none")}}var Ie={message_received:"{user} posted in {channel}: {message}",action_performed:"{actor} {action} {target}",log_entry:"[{level}] {message}",error_occurred:"ERROR: {error}",status_change:"{entity} changed status to {new_status}",metric_recorded:"{metric_name}: {value}{unit}","messaging.user.joined_voice":"{user_name} joined voice channel {channel_name}","messaging.user.left_voice":"{user_name} left voice channel {channel_name}","messaging.user.sent_message":"{user_name} in {channel_name}: {content}","messaging.bot.sent_message":"Dexter sent in {channel_name}: {content}","messaging.bot.joined_voice":"Dexter joined voice channel {channel_name}","messaging.bot.voice_response":"Dexter said: {content}","messaging.bot.status_update":"Dexter status changed to {status}: {details}","messaging.user.speaking.started":"{user_name} started speaking","messaging.user.speaking.stopped":"{user_name} stopped speaking","messaging.user.transcribed":"{user_name} said: {transcription}","messaging.user.joined_server":"{user_name} joined {server_name}","messaging.webhook.message":"{user_name} (Webhook): {content}","webhook.processed":"Webhook processed: {status}",voice_speaking_started:"User {user_id} started speaking in voice channel {channel_id}",voice_speaking_stopped:"User {user_id} stopped speaking in voice channel {channel_id}",voice_transcribed:"{user_name} said: {transcription}","engagement.decision":"Engagement Decision: {decision} ({reason})",bot_response:"Bot Responded: {response}","moderation.explicit_content.deleted":"Explicit content deleted in {channel_name} from {user_name}: {reason}","analysis.link.completed":"Analyzed link: {url}","analysis.visual.completed":"Analyzed image: {filename}","system.cli.command":"CLI Command: {command} {args} ({status})","system.cli.status":"CLI Status: {message}","system.notification.generated":"Notification ({priority}): {title}"};function xe(e,t){let n=Ie[e];if(e==="voice_transcribed"&&!t.user_name&&t.user_id&&(n="User {user_id} said in voice channel {channel_id}: {transcription}"),e==="system.notification.generated"&&(n=`Notification (${t.priority?t.priority.charAt(0).toUpperCase()+t.priority.slice(1):"Low"}): ${t.title}`),!n)return e;let r=n.replace(/\{(\w+)\}/g,(i,a)=>t[a]!==void 0&&t[a]!==null?t[a]:i);return(e==="messaging.user.transcribed"||e==="voice_transcribed")&&t.detected_language&&t.detected_language!=="en"&&t.english_translation&&(r+=` (Translation: ${t.english_translation})`),r}var $e=()=>'<div id="events-timeline" class="events-timeline"><p>Loading events...</p></div>',J=null;async function ie(){let e=document.getElementById("events-timeline");if(!e)return;let t=localStorage.getItem("service_map");if(!t){e.innerHTML=w("config","No service map configured.","Upload service-map.json in Settings.");return}let n=null;try{n=(JSON.parse(t).services?.cs||[]).find(u=>u.id==="dex-event-service")}catch{e.innerHTML=w("error","Invalid service map data.");return}if(!n){e.innerHTML=w("error","Event service not found in service map.");return}let i=`http://${n.domain==="0.0.0.0"?"localhost":n.domain}:${n.port}/events?ml=50&format=json&exclude_types=system.notification.generated`;try{let a=new Set(Array.from(e.querySelectorAll(".event-item.expanded")).map(f=>f.dataset.eventId).filter(f=>f)),u=await fetch(i);if(!u.ok)throw new Error("Service is offline or unreachable.");let d=(await u.json()).events||[];if(d.length===0){e.innerHTML=w("empty","No events found.");return}let b=f=>{let l=f.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{return null}let m=l.type,o=m==="engagement.decision"||m==="messaging.bot.sent_message"||m==="messaging.user.sent_message"||m==="moderation.explicit_content.deleted"||m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="system.cli.command",g="event-border-grey";o&&(m==="moderation.explicit_content.deleted"?g="event-border-red":m==="analysis.link.completed"||m==="analysis.visual.completed"?g="event-border-purple":m==="system.cli.command"?g="event-border-orange":g="event-border-blue");let y=o?"cursor-pointer":"",k=a.has(f.id),x=k?"expanded":"",N=k?"display: block;":"display: none;",E=new Date(f.timestamp*1e3),ce=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),D=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),P=xe(m,l),F="";if(o){let $="";if(m==="engagement.decision")$=`
                        ...
                        `;else if(m==="messaging.bot.sent_message")$=`
                            <div class="event-detail-row">
                        ...
                        `;else if(m==="moderation.explicit_content.deleted")$=`
                            <div class="event-detail-row">
                        ...
                        `;else if(m==="analysis.link.completed")$=`
                            <div class="event-detail-row">
                        ...
                        `;else if(m==="analysis.visual.completed"){let S="";l.base64_preview?S=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${l.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:l.url&&(S=`<div class="event-detail-block"><img src="${l.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),$=`
                            <div class="event-detail-row">
                        ...
                        `;else if(m==="messaging.user.sent_message"){let S="";l.attachments&&l.attachments.length>0&&(S=`
                                <div class="event-detail-block">
                                    ...
                                    <div class="attachments-grid">${l.attachments.map(L=>{let X=L.content_type&&L.content_type.startsWith("image/"),W=(L.size/1024).toFixed(1)+" KB";return`
                                    <div class="attachment-item">
                                        ...
                                        <div class="attachment-info">
                                            ...
                                            <span class="attachment-meta">${L.content_type} \u2022 ${W}</span>
                                        </div>
                                    </div>`}).join("")}</div>
                                </div>`),$=`
                            <div class="event-detail-row">
                    ...
                    `}let I=document.createElement("div");if(I.className=`event-item ${g} ${y} ${x}`,I.dataset.eventId=f.id,I.onclick=function($){if(!o)return;this.classList.toggle("expanded");let S=this.querySelector(".event-details");S&&(S.style.display=S.style.display==="none"?"block":"none")},I.innerHTML=`
                    <div class="event-time">
                        <span class="event-time-main">${ce}</span>
                ...
                `,o){let $=I.querySelector(".close-details-btn");$&&$.addEventListener("click",S=>{S.stopPropagation();let A=S.target.closest(".event-item");if(A){A.classList.remove("expanded");let L=A.querySelector(".event-details");L&&(L.style.display="none")}})}return I},s=Array.from(e.children),p=new Map(s.map(f=>[f.dataset.eventId,f])),v=new Set(d.map(f=>f.id));s.forEach(f=>{(!f.dataset.eventId||!v.has(f.dataset.eventId))&&f.remove()});let h=null;d.forEach((f,l)=>{let m=p.get(f.id);!m&&(m=b(f),!m)||(l===0?e.firstElementChild!==m&&e.prepend(m):h&&h.nextElementSibling!==m&&h.after(m),h=m)}),J=Date.now(),T(2,J)}catch(a){console.error("Error fetching events:",a),e.children.length===0&&(e.innerHTML=w("offline","Failed to load events.","The event service may be offline or unreachable."))}}var Se=()=>'<div id="notifications-list" class="notifications-list events-timeline" style="display: flex; flex-direction: column; gap: 15px;"><p>Loading notifications...</p></div>',G=null;async function ae(){let e=document.getElementById("notifications-list");if(!e)return;let t=localStorage.getItem("service_map");if(!t){e.innerHTML=w("config","No service map configured.","Upload service-map.json in Settings.");return}let n=null;try{n=(JSON.parse(t).services?.cs||[]).find(u=>u.id==="dex-event-service")}catch{e.innerHTML=w("error","Invalid service map data.");return}if(!n){e.innerHTML=w("error","Event service not found in service map.");return}let i=`http://${n.domain==="0.0.0.0"?"localhost":n.domain}:${n.port}/events?ml=1000&format=json&event.type=system.notification.generated`;try{let a=await fetch(i);if(!a.ok)throw new Error("Service is offline or unreachable.");let c=(await a.json()).events||[],d=Date.now(),b=24*60*60*1e3,s=c.filter(o=>{let g=localStorage.getItem(`notification_read_ts_${o.id}`);if(!g)return!0;let y=parseInt(g);return d-y<b});if(s.length===0){e.innerHTML=w("empty","No notifications yet."),z();return}let p=o=>{let g=o.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let y=g.title||"Untitled Notification",k=g.body||"No description provided.",x=g.priority||"low",N=g.category||"system",E=g.related_event_ids||[],D=!!localStorage.getItem(`notification_read_ts_${o.id}`),P=new Date(o.timestamp*1e3),F=P.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),I=P.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=D?"event-border-grey":"event-border-blue";D&&(x==="high"||x==="critical")?$="event-border-red":D&&x==="medium"&&($="event-border-orange");let S=D?"notification-read":"notification-unread",A=v.has(o.id),L=A?"expanded":"",X=A?"display: block;":"display: none;",W="";E.length>0&&(W=`
                    <div class="event-detail-row">
                        <span class="detail-label">Related Events:</span>
                        <span class="detail-value">${E.map(O=>`<span class="related-event-id" style="font-family: monospace; opacity: 0.7;">${O.substring(0,8)}...</span>`).join(", ")}</span>
                    </div>`);let C=document.createElement("div");C.className=`event-item notification-item ${$} ${S} ${L} cursor-pointer`,C.dataset.notificationId=o.id,C.onclick=function(O){this.classList.toggle("expanded");let H=this.querySelector(".event-details");if(H){let pe=H.style.display==="none";if(H.style.display=pe?"block":"none",pe){if(v.add(o.id),!localStorage.getItem(`notification_read_ts_${o.id}`)){localStorage.setItem(`notification_read_ts_${o.id}`,Date.now().toString()),this.classList.add("notification-read"),this.classList.remove("notification-unread"),this.classList.remove("event-border-blue");let Q="event-border-grey";x==="high"||x==="critical"?Q="event-border-red":x==="medium"&&(Q="event-border-orange"),this.classList.add(Q),z()}}else v.delete(o.id)}},C.innerHTML=`
                <div class="event-time">
            ...
            </div>`}function q(e){let t=document.querySelector("#settings-window .window-content");if(!t)return;t.querySelectorAll(".theme-card").forEach(c=>{c.addEventListener("click",function(){let d=this.dataset.theme;he(d),e.setContent(U()),q(e)})});function n(c,d,b,s,p,v,h){let f=document.getElementById(c),l=document.getElementById(d),m=document.getElementById(b),o=document.getElementById(s),g=document.getElementById(p);f&&l&&(f.onclick=()=>l.click(),l.onchange=y=>{let k=y.target.files[0];if(!k)return;if(k.name!==h){o.textContent=`File must be named "${h}"`,o.style.display="block",l.value="";return}let x=new FileReader;x.onload=N=>{try{let E=JSON.parse(N.target.result);localStorage.setItem(v,JSON.stringify(E)),m.textContent=h,o.style.display="none",e.setContent(U()),q(e)}catch{o.textContent="Invalid JSON format",o.style.display="block",l.value=""}},x.onerror=()=>{o.textContent="Failed to read file",o.style.display="block",l.value=""},x.readAsText(k)}),g&&(g.onclick=()=>{localStorage.removeItem(v),e.setContent(U()),q(e)})}n("service-map-upload-btn","service-map-input","service-map-file-name","service-map-error","service-map-delete-btn","service_map","service-map.json"),n("server-map-upload-btn","server-map-input","server-map-file-name","server-map-error","server-map-delete-btn","server_map","server-map.json"),n("options-upload-btn","options-input","options-file-name","options-error","options-delete-btn","user_options","options.json");let r=document.getElementById("notifications-toggle");if(r){let c="permissions"in navigator&&navigator.permissions.query({name:"microphone"});(!c||c.state==="denied")&&(r.disabled=!0),r.onclick=async d=>{if(d.target.checked)try{await Notification.requestPermission()!=="granted"&&(d.target.checked=!1)}catch{d.target.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),d.target.checked=!0)}}let i=document.getElementById("microphone-toggle");async function a(){let c="permissions"in navigator?await navigator.permissions.query({name:"microphone"}):null;i&&(i.disabled=!c||c.state==="denied",i.checked=c?.state==="granted");let d=document.querySelector("#microphone-setting-item .settings-item-description");d&&(d.textContent=c?c.state==="granted"?"Microphone access granted":"Allow access to your microphone":"Not supported in this browser")}a(),i&&!i.disabled&&(i.onclick=async c=>{if(c.target.checked)try{await navigator.mediaDevices.getUserMedia({audio:!0}),a()}catch{c.target.checked=!1,a()}else("permissions"in navigator&&await navigator.permissions.query({name:"microphone"}))?.state==="granted"&&(alert("To disable microphone access, please use your browser settings."),c.target.checked=!0)});let u=document.getElementById("analytics-toggle");u&&(u.checked=localStorage.getItem("easter_analytics_enabled")!=="false",u.onclick=c=>{let d=c.target.checked;localStorage.setItem("easter_analytics_enabled",d),window.EASTER_ANALYTICS_ENABLED=d,window.EASTER_DEBUG_MODE=d})}function ke(){console.log("Welcome to Easter Company."),ye(),me();let e=ge();ue(e),ve();let t=document.querySelector("footer"),n=null;function r(){n=null,t?.classList.remove("hide"),document.querySelectorAll(".nav-right i").forEach(s=>s.classList.remove("active","inactive"))}function i(s,p=null){let v=n&&n.id===s.id;n&&n.close(!v),v?n=null:setTimeout(()=>{s.open(),n=s,document.querySelectorAll(".nav-right i").forEach(h=>{let f=h===p;h.classList.toggle("active",f),h.classList.toggle("inactive",!f&&p)}),t?.classList.add("hide")},n?220:0)}async function a(){await Promise.all([oe(),le(),ie(),re(),ae(),ne()]);let s=setInterval(()=>{if(!b.isOpen())return clearInterval(s);T(3,se),T(2,J),T(4,Y),T(5,V),T(1,K),T(0,G)},1e3),p=setInterval(()=>{if(!b.isOpen())return clearInterval(p);ie(),re(),ae(),ne()},3e3),v=setInterval(()=>{if(!b.isOpen())return clearInterval(v);oe(),le()},6e4)}let u=B({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="https://github.com/eastercompany" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in",onClose:r}),c=B({id:"user-window",title:"User Profile",content:`<p>Logged in as: ${R()||"Unknown"}</p>`,icon:"bx-user",onClose:r}),d=B({id:"settings-window",title:"Settings",content:U(),icon:"bx-cog",onClose:r,onOpen:()=>{d.setContent(U()),setTimeout(()=>q(d),50)}}),b=B({id:"message-window",tabs:[{icon:"bx-bell",title:"Notifications",content:Se(),"data-tab-index":0},{icon:"bx-cog",title:"Processes",content:Le(),"data-tab-index":1},{icon:"bx-calendar-event",title:"Events",content:$e(),"data-tab-index":2},{icon:"bx-history",title:"Logs",content:we(),"data-tab-index":3},{icon:"bx-brain",title:"Models",content:_e(),"data-tab-index":4},{icon:"bx-line-chart",title:"Services",content:Te(),"data-tab-index":5}],icon:"bxs-message-dots",onClose:r,onOpen:()=>setTimeout(a,100)});e?(document.getElementById("user-icon")?.addEventListener("click",s=>i(c,s.currentTarget)),document.getElementById("message-icon")?.addEventListener("click",s=>i(b,s.currentTarget)),document.getElementById("settings-icon")?.addEventListener("click",s=>i(d,s.currentTarget))):document.getElementById("login-btn")?.addEventListener("click",()=>{i(u),setTimeout(()=>{document.getElementById("login-form")?.addEventListener("submit",s=>{s.preventDefault();try{fe(document.getElementById("email-input").value),window.location.reload()}catch(p){let v=document.getElementById("login-error");v&&(v.textContent=p.message,v.style.display="block")}})},100)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ke):ke();})();
//# sourceMappingURL=dex.72e5ed71.js.map
