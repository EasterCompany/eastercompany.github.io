(()=>{function Ke(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ye(){let t=window.location.pathname,e=t==="/"||t==="/index.html",s=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Qe=1e3;function ne(t){let e=null,i=t.onClose||null,a=t.onOpen||null;function s(){e&&(e.style.zIndex=++Qe)}function l(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",o),a&&setTimeout(a,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Qe,e.addEventListener("mousedown",s);let b=t.icon||"bx-window",n="",f="",S;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((x,u)=>{let g=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,S=`<div class="window-content">${t.tabs.map((x,u)=>`<div class="tab-content ${u===0?"active":""}" data-tab-content="${u}">${x.content}</div>`).join("")}</div>`):(t.title&&(f=`<div class="window-title">${t.title}</div>`),S=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${S}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),c()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let r=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(x=>x.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(x=>x.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${r}"]`).classList.add("active"),v(y,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&v(m,e)}function v(m,b){setTimeout(()=>{let n=b.querySelector(".tab-bar");if(!n)return;let f=Array.from(n.querySelectorAll(".tab")),S=f.indexOf(m),y=n.clientWidth,r=f[Math.max(0,S-2)],x=f[Math.min(f.length-1,S+2)],u=r.offsetLeft-n.offsetLeft-25,d=x.offsetLeft+x.offsetWidth-n.offsetLeft+25-u,E=d<=y?u-(y-d)/2:m.offsetLeft-n.offsetLeft-y/2+m.offsetWidth/2;n.scrollTo({left:E,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),i&&i(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){let b=e?.querySelector(".window-content");b&&(b.innerHTML=m)}function h(){return e&&e.classList.contains("open")}return{open:l,close:c,setContent:p,isOpen:h,focus:s,id:t.id}}var et="easter_theme",ae={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ne(){return localStorage.getItem(et)||ae.DARK}function tt(t){if(!Object.values(ae).includes(t))throw new Error("Invalid theme");localStorage.setItem(et,t),st(t)}function st(t){let e=document.body;if(Object.values(ae).forEach(i=>{e.classList.remove(`theme-${i}`)}),e.classList.add(`theme-${t}`),!document.querySelector(".background")){let i=document.createElement("div");i.className="background",document.body.prepend(i)}e.classList.add("is-animated")}function it(){let t=Ne();st(t)}function R(t,e,i=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=i?`<p class="placeholder-action">${i}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function D(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Z(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!i)return;if(!e){i.textContent="Last updated: never";return}let a=Date.now(),s=Math.floor((a-e)/1e3),l;s<60?l=`${s}s ago`:s<3600?l=`${Math.floor(s/60)}m ago`:l=`${Math.floor(s/3600)}h ago`,i.textContent=`Last updated: ${l}`}var qt=0;function he(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!i)return;let a=i.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var X=0,Q=0;function at(t){X=t,ve()}function ot(t){Q=t,ve()}function ve(){let t=X+Q;qt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let i=document.getElementById("alerts-menu-item");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",i.appendChild(o)),o.textContent=X>9?"9+":X,o.style.display=X>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",a.appendChild(o)),o.textContent=Q>9?"9+":Q,o.style.display=Q>0?"flex":"none"}let s=document.getElementById("switch-alerts");if(s){let o=s.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",s.appendChild(o)),o.textContent=X>9?"9+":X,o.style.display=X>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let o=l.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",l.appendChild(o)),o.textContent=Q>9?"9+":Q,o.style.display=Q>0?"flex":"none"}}function ke(){let t=document.getElementById("alerts-list");if(!t)return;X=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ve()}function rt(){let t=document.getElementById("blueprints-list");if(!t)return;Q=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ve()}function jt(){return"https://event.easter.company"}function Ft(){return"https://discord.easter.company"}var Jt="http://127.0.0.1:8100",Gt="http://127.0.0.1:8300",Wt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Te(t){let e=D(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,l)=>{let o=Wt[l];return o?`<span class="${o}">`:""});let i=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return i>a&&(e+="</span>".repeat(i-a)),e}function oe(t){if(!t)return"";let e=D(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(i,a)=>{let s=a.split("|").map(l=>l.trim());return s.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${s.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Vt="https://sterling-javelin-12539.upstash.io",Zt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function z(){return window.location.hostname==="easter.company"}var P=null,lt="dex_dashboard_snapshot";function Kt(){let t=localStorage.getItem(lt);if(t)try{P=JSON.parse(t)}catch{P=null}}async function nt(){if(!z())return;let t=await Qt("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,localStorage.setItem(lt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}function Yt(){if(!P||!P.agent_status)return;let t=P.agent_status;typeof t.system_state_time=="number"&&(t.system_state_time+=1)}async function Xt(){if(!z())return;Kt();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await nt(),setInterval(()=>{new Date().getSeconds()===59&&nt(),Yt()},1e3)}z()&&Xt();async function Qt(t,...e){try{let a=await(await fetch(Vt,{method:"POST",headers:{Authorization:`Bearer ${Zt}`},body:JSON.stringify([t,...e])})).json();if(a.error)throw new Error(a.error);return a.result}catch(i){return console.error("Upstash Error:",i),null}}var ge=null,be=null,Ee=!1,Se=!1;async function B(t,e={}){if(z()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let s=new URLSearchParams(t.split("?")[1]||""),l=s.get("type")||s.get("event.type"),o=s.get("category"),v=s.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...P.alerts||[]]:o==="messaging"?c=[...P.messaging_events||[]]:o==="system"?c=[...P.system_events||[]]:o==="cognitive"?c=[...P.cognitive_events||[]]:o==="moderation"?c=[...P.moderation_events||[]]:c=[...P.events||[]],v==="asc"?c.sort((p,h)=>p.timestamp-h.timestamp):c.sort((p,h)=>h.timestamp-p.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let s=t.split("/")[2],l=P.profiles?P.profiles[s]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ge)try{let s=await fetch(ge+t,e);if(s.ok)return s;ge=null}catch{ge=null}let i=jt(),a=Jt;try{let s=await fetch(i+t,e);if(s.ok)return ge=i,Ee&&(console.log("\u2728 Production event service restored."),Ee=!1),s;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),Ee=!0);try{let l=await fetch(a+t,e);if(l.ok)return ge=a,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function Le(t,e={}){if(z()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let s=t.split("/")[2],l=(P.contacts?.members||[]).find(o=>o.id===s);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(be)try{let s=await fetch(be+t,e);if(s.ok)return s;be=null}catch{be=null}let i=Ft(),a=Gt;try{let s=await fetch(i+t,e);if(s.ok)return be=i,Se&&(console.log("\u2728 Production discord service restored."),Se=!1),s;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),Se=!0);try{let l=await fetch(a+t,e);if(l.ok)return be=a,l;throw new Error("Fallback failed")}catch(l){throw l}}}var ct=()=>`
...
`,Me=null,re=new Set,Ae=[];async function se(t=!1){let e=document.getElementById("alerts-list");if(!e)return;es(),t&&(e.innerHTML="<p>Updating...</p>");let i="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await B(i);if(!a.ok)throw new Error("Service is offline or unreachable.");let l=(await a.json()).events||[];Me=Date.now(),Z(0,Me);let o=Date.now(),v=24*60*60*1e3,c=l.filter(u=>{let g=localStorage.getItem(`alert_read_ts_${u.id}`);if(!g)return!0;let d=parseInt(g);return o-d<v});c.sort((u,g)=>{let d=I=>{let w=I.event;if(typeof w=="string")try{w=JSON.parse(w)}catch{return"low"}return(w.priority||"low").toLowerCase()},E=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,M=E(d(u)),A=E(d(g));return M!==A?A-M:g.timestamp-u.timestamp}),Ae=c;let p=u=>{let g=u.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},h=[],b=new Set(c.map(u=>p(u))).size>1;if(c.length>0){let u=null;c.forEach(g=>{let d=p(g);b&&d!==u&&(h.push({id:`divider-${d}`,type:"divider",label:d.toUpperCase()}),u=d),h.push(g)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=R("empty","No alerts yet."),ke();return}let n=u=>{let g=u.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let d=(g.title||"Untitled Alert").trim(),E=(g.body||"No description provided.").trim(),M=g.summary||"",A=g.content||"",I=g.protocol||"",w=(g.priority||"low").toLowerCase(),H=!!g.alert,N=(g.category||"system").trim(),_=g.related_event_ids||[],O=g.audit_event_id,j=!!localStorage.getItem(`alert_read_ts_${u.id}`),k=new Date(u.timestamp*1e3),C=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=j?"event-border-grey":"event-border-blue";!j&&H&&(L="event-border-red"),j&&(w==="high"||w==="critical")?L="event-border-red":j&&w==="medium"&&(L="event-border-orange");let T=j?"alert-read":"alert-unread",q=re.has(u.id),F=q?"expanded":"",ee=q?"display: block;":"display: none;",J="",G="";_.length>0&&(G=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${_.map(te=>`<a href="#" onclick="window.dexter.viewEvent('${te}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${te.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let K="";O&&(K=`
        ...
        `,J=`
                ...
                ${Y}
            `;let V=document.createElement("div");V.className=`event-item notification-item ${L} ${T} ${F} cursor-pointer priority-${w}`,V.dataset.alertId=u.id,V.onclick=function(te){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(u.id);let ye=this.querySelector(".event-details");ye&&(ye.style.display="none")}else{this.classList.add("expanded"),re.add(u.id);let ye=this.querySelector(".event-details");if(ye&&(ye.style.display="block"),!localStorage.getItem(`alert_read_ts_${u.id}`)){localStorage.setItem(`alert_read_ts_${u.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let ze="event-border-grey";w==="high"||w==="critical"?ze="event-border-red":w==="medium"&&(ze="event-border-orange"),this.classList.add(ze),ke()}}};let We=`${I?I.toUpperCase():"GUARDIAN"} ALERT: ${M||d}`,Ot={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[N]||"bx-bell",Ut=w==="high"||w==="critical"?"#ff4d4d":w==="medium"?"#ffa500":"#888";V.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    ...
                    <div class="event-message">${oe(We)}</div>
                    <div class="event-details" style="${ee}">
                        ${J}
                    </div>
                </div>
            `;let Ve=V.querySelector(".event-details");Ve&&Ve.addEventListener("click",te=>{te.stopPropagation()});let Ze=V.querySelector(".close-details-btn");return Ze&&Ze.addEventListener("click",te=>{te.stopPropagation(),V.classList.remove("expanded");let De=V.querySelector(".event-details");De&&(De.style.display="none"),re.delete(u.id)}),V},f=u=>{let g=document.createElement("div");g.className="notification-divider",g.dataset.alertId=u.id;let d="#888888";return u.label==="CRITICAL"?d="#ff4d4d":u.label==="HIGH"?d="#ff8888":u.label==="MEDIUM"&&(d="#ffa500"),g.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${d}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,g.innerHTML=`<span style="white-space: nowrap;">${u.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${d}44, transparent); flex-grow: 1;"></div>`,g},S=Array.from(e.children),y=new Map(S.map(u=>[u.dataset.alertId,u])),r=new Set(h.map(u=>u.id));S.forEach(u=>{let g=u.dataset.alertId;(!g||!r.has(g))&&u.remove()});let x=null;h.forEach((u,g)=>{let d=y.get(u.id);(!d||t)&&(d&&d.remove(),u.type==="divider"?d=f(u):d=n(u),!d)||(g===0?e.firstElementChild!==d&&e.prepend(d):x&&x.nextElementSibling!==d&&x.after(d),x=d)}),Me=Date.now(),Z(0,Me),ke()}catch(a){console.error("Error fetching alerts:",a),e.children.length===0&&(e.innerHTML=R("offline","Failed to load alerts.","The event service may be offline."))}}function es(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),i=document.getElementById("alerts-close-all"),a=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ae.forEach(s=>{localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),se(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ae.forEach(s=>{re.add(s.id),localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),se(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{re.clear(),se(!0)},i.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.notification.generated",{method:"DELETE"});let s=Date.now()-48*60*60*1e3;Ae.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,s.toString())}),re.clear(),se(!0)}catch(s){console.error("Failed to clear alerts:",s)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}async function He(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await B(t);if(!e.ok)return;let a=(await e.json()).events||[],s=0;a.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}if((o.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||s++}),at(s)}catch{}}var dt=()=>`
...
`,le=new Set,Ie=[],xe=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){ts();try{let i=await B("/roadmap");if(!i.ok)throw new Error("Offline");let a=await i.json();Ie=a;let s=p=>{let h=le.has(p.id),m=p.state==="published",b=p.state==="consumed",n="event-border-grey";m&&(n="event-border-blue"),b&&(n="event-border-purple");let S=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),y=document.createElement("div");y.className=`event-item notification-item ${n} cursor-pointer ${h?"expanded":""}`,y.dataset.itemId=p.id,y.onclick=u=>{if(u.target.closest("button"))return;y.classList.contains("expanded")?(y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(p.id)):(y.classList.add("expanded"),y.querySelector(".event-details").style.display="block",le.add(p.id))};let r=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;y.innerHTML=`
        <div class="event-time">
          <span class="event-time-main">${S.split(",")[1]}</span>
          <span class="event-date">${S.split(",")[0]}</span>
        </div>
        <div class="event-content">
          <div class="event-service">ROADMAP ${r}</div>
          <div class="event-message" style="white-space: pre-wrap;">${D(p.content)}</div>
      ...
      `;let x=y.querySelector(".event-details");return x&&x.addEventListener("click",u=>{u.stopPropagation()}),y.querySelector(".edit-btn")?.addEventListener("click",()=>ss(p)),y.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>is(p)),y.querySelector(".delete-btn")?.addEventListener("click",()=>ns(p.id)),y.querySelector(".close-details-btn")?.addEventListener("click",u=>{u.stopPropagation(),y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(p.id)}),y},l=Array.from(e.children),o=new Map(l.map(p=>[p.dataset.itemId,p])),v=new Set(a.map(p=>p.id));if(l.forEach(p=>{let h=p.dataset.itemId;(!h||!v.has(h))&&p.remove()}),!Ie||Ie.length===0){e.innerHTML=R("empty","Your roadmap is empty.",z()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;a.forEach((p,h)=>{let m=o.get(p.id);(!m||t)&&(m&&m.remove(),m=s(p),!m)||(h===0?e.firstElementChild!==m&&e.prepend(m):c&&c.nextElementSibling!==m&&c.after(m),c=m)})}catch{e.children.length===0&&(e.innerHTML=R("offline","Failed to load roadmap.","The event service may be offline."))}}}function ts(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),i=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),s=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{xe=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",xe=null},i.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input").value;if(!l.trim())return;let o=xe?`/roadmap/${xe}`:"/roadmap",v=xe?"PATCH":"POST";try{await B(o,{method:v,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(c){console.error(c)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{Ie.forEach(l=>le.add(l.id)),ce(!0)},a.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{le.clear(),ce(!0)},s.dataset.listenerAttached="true")}function ss(t){xe=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function is(t){let e=t.state==="published"?"draft":"published";try{await B(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(i){console.error(i)}}async function ns(t){if(confirm("Delete this roadmap item?"))try{await B(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var ut=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,mt=null,de=new Set,gt=[];async function pe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;as();let i="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await B(i);if(!a.ok)throw new Error("Service is offline or unreachable.");let l=(await a.json()).events||[];if(gt=l,mt=Date.now(),Z(2,mt),l.length===0){e.innerHTML=R("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),he(2,0);return}t&&(e.innerHTML="");let o=m=>{let b=m.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let n=(b.title||"Untitled Blueprint").trim(),f=(b.summary||b.body||"No summary provided.").trim(),S=(b.content||"").trim(),y=(b.category||"architecture").trim(),r=(b.related_services||b.affected_services||[]).map(T=>T.trim()),x=(b.implementation_path||[]).map(T=>T.trim()),u=b.source_event_ids||[],g=b.approved===!0,d=new Date(m.timestamp*1e3),E=d.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),M=d.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=de.has(m.id),I=A?"display: block;":"display: none;",w=document.createElement("div");w.className=`event-item notification-item event-border-purple cursor-pointer ${A?"expanded":""} ${g?"blueprint-approved":""}`,w.dataset.blueprintId=m.id,g&&(w.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",w.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let N=g?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[y]||"bx-paint";w.onclick=function(T){if(this.classList.contains("expanded")){this.classList.remove("expanded"),de.delete(m.id);let F=this.querySelector(".event-details");F&&(F.style.display="none")}else{this.classList.add("expanded"),de.add(m.id);let F=this.querySelector(".event-details");F&&(F.style.display="block")}};let _="";x.length>0&&(_=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${x.map(T=>`<li style="margin-bottom: 5px;">${D(T)}</li>`).join("")}</ul></div>
                    </div>
                `);let O="";u.length>0&&(O=`
                ...
                `);let U=r.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${r.join(", ")}</span></div>`:"<div></div>",j=g?`
            ...
            `;w.innerHTML=`
                ...
                <div class="event-icon" style="${g?"color: #03dac6;":""}"><i class='bx ${N}'></i></div>
                <div class="event-content">
                    ...
                    <div class="event-details" style="${I}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${D(f)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${D(S)}</div>
                        </div>
                        ${_}
                        ${O}
                        ${j}
            ...
            `;let k=w.querySelector(".blueprint-approve-btn");k&&(k.onclick=async T=>{T.stopPropagation(),k.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await B(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&pe(!0)}catch(q){console.error("Failed to approve blueprint:",q)}});let C=w.querySelector(".blueprint-delete-btn");C&&(C.onclick=async T=>{T.stopPropagation();let q=!g;C.innerHTML=q?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await B(`/events/${m.id}`,{method:"DELETE"})).ok&&pe(!0)}catch(F){console.error("Failed to delete blueprint:",F)}});let $=w.querySelector(".event-details");$&&$.addEventListener("click",T=>{T.stopPropagation()});let L=w.querySelector(".close-details-btn");return L&&L.addEventListener("click",T=>{T.stopPropagation(),w.classList.remove("expanded");let q=w.querySelector(".event-details");q&&(q.style.display="none"),de.delete(m.id)}),w},v=Array.from(e.children),c=new Map(v.map(m=>[m.dataset.blueprintId,m])),p=new Set(l.map(m=>m.id));v.forEach(m=>{let b=m.dataset.blueprintId;(!b||!p.has(b))&&m.remove()});let h=null;l.forEach((m,b)=>{let n=c.get(m.id);(!n||t)&&(n&&n.remove(),n=o(m),!n)||(b===0?e.firstElementChild!==n&&e.prepend(n):h&&h.nextElementSibling!==n&&h.after(n),h=n)}),he(2,l.length),rt()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=R("offline","Failed to load blueprints.","The event service may be offline."))}}async function bt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await B(t);if(!e.ok)return;let a=(await e.json()).events||[],s=0;a.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}o.approved!==!0&&s++}),ot(s)}catch{}}function as(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),i=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{gt.forEach(a=>de.add(a.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{de.clear(),pe(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.blueprint.generated",{method:"DELETE"}),de.clear(),pe(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var vt=()=>`
...
`;async function Pe(){await Promise.all([ce(),pe()])}var os=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function xt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function yt(t){if(!document.getElementById("dex-profile-styles")){let i=document.createElement("style");i.id="dex-profile-styles",i.textContent=os,document.head.appendChild(i)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",i=>{i.target===e&&(e.classList.remove("active"),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),Le(`/profile/${t.id}`).then(async i=>{if(i.ok){let a=await i.json();Re(e,t,a)}else{console.log("Profile not found or error, using mock data.");let a=xt(t.id,t.username);Re(e,t,a)}}).catch(i=>{console.error("Profile fetch error:",i);let a=xt(t.id,t.username);Re(e,t,a)})}function Re(t,e,i){let a=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",s=()=>{let S=(i.badges||[]).map(E=>`<span class="profile-badge ${E==="Creator"?"master":""}">${E}</span>`).join(""),y=(i.attributes||i.facts||[]).map(E=>{let M=E.key||E.k,A=E.value||E.v;return`
            <div class="fact-chip">
                <span class="fact-key">${M}:</span>
                <span class="fact-val">${A}</span>
            </div>
        `}).join(""),r=i.cognitive_model||i,x=r.technical_level||r.techLevel||0,u=r.communication_style||r.commStyle||"Unknown",g=r.patience_level||r.patience||"Unknown",d=r.vibe||"Unknown";return`
                ...
                <div class="profile-section">
                    ...
                    <div class="cog-metric">
                        ...
                        <div class="cog-bar-bg">
                            <div class="cog-bar-fill" style="width: ${Math.min(x*10,100)}%;"></div>
                        </div>
                    </div>
                    ...
                    <div class="cog-metric">
                     ...
                     <div class="cog-metric">
                        <div class="cog-label">
                            ...
                            <span style="font-family: 'JetBrains Mono'; color: #bb86fc;">${d}</span>
                        </div>
                    </div>
                </div>
        ...
        `},l=()=>{let S=i.dossier||{},y=S.identity||{},r=S.career||{},x=S.personal||{},u=S.social||[];return`
            <div class="dossier-grid">
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div class="dossier-value">${r.jobTitle||"Unknown"}</div>
                        <div style="font-size: 0.8em; color: #888; margin-top: 2px;">@ ${r.company||"Unknown"}</div>
                        <div style="height: 15px;"></div>
                         <div class="dossier-label">Key Skills</div>
                         <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                            ${(r.skills||[]).map(g=>`<span style="font-size: 0.75em; background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">${g}</span>`).join("")}
                         </div>
                    </div>
                </div>
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="margin-top: 10px;">
                            ${(x.hobbies||[]).map(g=>`<div class="dossier-list-item">${g}</div>`).join("")}
                        </div>
                    </div>
                    ...
                    <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(x.habits||[]).map(g=>`<div class="dossier-list-item">${g}</div>`).join("")}
                        </div>
                    </div>
                     ...
                     <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(x.vices||[]).map(g=>`<div class="dossier-list-item" style="color: #cf6679;">${g}</div>`).join("")}
                        </div>
                    </div>
                </div>
            ...
            ${Object.entries(S).map(([y,r])=>`
                <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 10px; height: 150px; background: rgba(255,255,255,0.05); border-radius: 5px; position: relative; overflow: hidden;">
                        <div style="position: absolute; bottom: 0; left: 0; width: 100%; height: ${r}%; background: ${r>50?"#03dac6":"#cf6679"}; transition: height 1s;"></div>
                    </div>
                    <div style="font-size: 0.8em; text-transform: uppercase; letter-spacing: 1px; color: #aaa;">${y.substring(0,4)}</div>
                    <div style="font-family: monospace;">${r}%</div>
                </div>
            `).join("")}
        </div>
...
`,rs=null;async function Oe(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Oe(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=i=>{let a=i.target.closest(".user-profile-card");if(a)try{let s=JSON.parse(a.dataset.user);yt(s)}catch(s){console.error("Failed to parse user data",s)}},t.dataset.listenerAttached="true");try{let i=await Le("/contacts");if(!i.ok)throw new Error("Service unreachable");let s=(await i.json()).members||[];if(rs=Date.now(),s.length===0){t.innerHTML=R("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};s.sort((o,v)=>{let c=l[o.level]??10,p=l[v.level]??10;return c!==p?c-p:o.username.localeCompare(v.username)}),t.innerHTML=s.map(o=>{let v=o.color?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",c=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",p="#888";o.level==="Me"||o.level==="Master"?p="#bb86fc":o.level==="Admin"?p="#cf6679":o.level==="Moderator"?p="#03dac6":o.level==="Contributor"&&(p="#ffa500");let h=o.level==="Me",m=h?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",b=h?"2px solid #bb86fc":`1px solid ${v}33`;return`
...
`,_e=null,me=new Set,we=[],W="all",cs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},ds={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function ps(t){for(let[e,i]of Object.entries(cs))if(i.includes(t))return e;return"system"}function ms(t){return ds[t]||"bx-square-rounded"}async function ie(t=!1){let e=document.getElementById("events-timeline");if(!e)return;us();let a=`/events?ml=${W==="all"?100:250}&format=json`;W!=="all"&&(a+=`&category=${W}`);try{let s=await B(a);if(!s.ok)throw new Error("Service unreachable");if(we=((await s.json()).events||[]).filter(b=>{let n=b.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return!0}let f=n.type;return!(f==="system.blueprint.generated"||f==="system.notification.generated")}),_e=Date.now(),Z(1,_e),we.length===0){e.innerHTML=R("empty","No events found for this filter.");return}t&&(e.innerHTML="");let v=b=>{let n=b.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return null}let f=n.type,S=ps(f),y=ms(f),r=f==="engagement.decision"||f==="messaging.bot.sent_message"||f==="messaging.user.sent_message"||f==="moderation.explicit_content.deleted"||f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="analysis.user.message_signals"||f==="system.cli.command"||f==="system.analysis.audit"||f==="system.test.completed"||f==="error_occurred"||f==="system.cli.status"||f==="system.attention.expired"||f.startsWith("system.roadmap")||f.startsWith("system.process"),x="event-border-grey";r&&(f==="moderation.explicit_content.deleted"||f==="error_occurred"?x="event-border-red":f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="system.analysis.audit"||f==="analysis.user.message_signals"?x="event-border-purple":f==="system.attention.expired"||f==="system.cli.command"||f==="system.cli.status"?x="event-border-orange":f==="system.test.completed"?x=n.test?.status==="OK"&&n.lint?.status==="OK"&&n.format?.status==="OK"?"event-border-blue":"event-border-red":x="event-border-blue");let u=r?"cursor-pointer":"",g=me.has(b.id),d=g?"expanded":"",E=g?"display: block;":"display: none;",M=new Date(b.timestamp*1e3),A=M.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),I=M.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),w=wt(f,n),H=n.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${n.user_level})</span>`:"",N="";if(r){let k="";if(f==="engagement.decision"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                    ...
                    `}else if(f==="system.attention.expired"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,$=n.timestamp-n.last_active,L=Math.floor($/60);k=`
                    ...
                    `}else if(f==="messaging.bot.sent_message"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,$="";n.eval_count&&($=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let L="";if(n.chat_history&&n.chat_history.length>0){let T=n.chat_history.length,q=n.chat_history.map((F,ee)=>{let J=F.role.toUpperCase();J==="ASSISTANT"&&(J="DEXTER");let G=F.role==="user"?"#03dac6":F.role==="system"?"#ffb74d":"#bb86fc",K=ee===T-1?"block":"none";return`
                                <div class="history-slide" data-index="${ee}" style="display: ${K};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${G}; letter-spacing: 1px; font-weight: bold;">${J}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${ee+1} of ${T}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${D(F.content)}</div>
                                </div>
                            `}).join("");L=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(f==="analysis.user.message_signals"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,$=n.signals||{};k=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${($.topics||[]).map(T=>`<span class="profile-badge">${T}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${C("Raw Model Output")}
                            <pre class="detail-pre">${D(n.raw_output)||"None"}</pre>
                        </div>
                    `}else if(f==="moderation.explicit_content.deleted"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(f==="analysis.link.completed"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${D(n.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${C("Description")}
                            <pre class="detail-pre">${D(n.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Content Summary")}
                            <pre class="detail-pre">${D(n.summary)||"None"}</pre>
                        </div>
                    `}else if(f==="analysis.visual.completed"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,$="";n.base64_preview?$=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${n.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:n.url&&($=`<div class="event-detail-block"><img src="${n.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(f==="analysis.router.decision"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Input Context")}
                            <pre class="detail-pre">${D(n.raw_input)||"None"}</pre>
                        </div>
                    `}else if(f==="system.cli.command"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Output")}
                            <pre class="detail-pre">${D(n.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(f==="system.analysis.audit"){let C=n.success?"#03dac6":"#ff4d4d",$=n.success?"SUCCESS":"FAILED",L=J=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${J}</h5>`,T="";n.error&&(T=`
                            <div class="event-detail-block">
                                ${L("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${D(n.error)}</pre>
                            </div>
                        `);let q="";if(n.chat_history&&n.chat_history.length>0){let J=n.chat_history.length,G=n.chat_history.map((K,ue)=>{let Y=K.role.toUpperCase();Y==="USER"&&(Y="SYSTEM"),Y==="ASSISTANT"&&(Y="AGENT");let V=K.role==="user"?"#03dac6":K.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ue}" style="display: ${ue===0?"block":"none"};">
                                    ...
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${D(K.content)}</div>
                                </div>
                            `}).join("");q=`
                            <div class="event-detail-block">
                        ...
                        `}let F="";if(n.corrections&&n.corrections.length>0){let J=n.corrections.map((G,K)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                ...
                                ${G.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${D(G.snippet)}</div>`:""}
                            </div>
                        `).join("");F=`
                            <div class="event-detail-block">
                                ${L(`Corrections (${n.corrections.length})`)}
                                ${J}
                            </div>
                        `}let ee="";if(n.parsed_results&&n.parsed_results.length>0){let J=n.parsed_results.map(G=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${D(G.title)}</div>
                                <div style="color: #ddd;">${D(G.summary)}</div>
                            </div>
                        `).join("");ee=`
                            <div class="event-detail-block">
                                ${L("Parsed Results")}
                        ...
                        ${F}
                        ${q}
                    `}else if(f==="system.test.completed"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(f==="error_occurred"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${C("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${D(n.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Context")}
                            <pre class="detail-pre">${JSON.stringify(n.context||{},null,2)}</pre>
                        </div>
                    `}else if(f==="system.cli.status"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${C("Message")}
                            <pre class="detail-pre">${D(n.message)}</pre>
                        </div>
                    `}else if(f==="messaging.user.sent_message"){let C="";n.attachments&&n.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${n.attachments.map(L=>{let T=L.content_type&&L.content_type.startsWith("image/"),q=(L.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${T?`<div class="attachment-thumb-container"><img src="${L.url}" alt="${L.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                                    <div class="attachment-info">
                                        <a href="${L.url}" target="_blank" class="attachment-link">${L.filename}</a>
                                        <span class="attachment-meta">${L.content_type} \u2022 ${q}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                ...
                `}let _=document.createElement("div");_.className=`event-item ${x} ${u} ${d}`,_.dataset.eventId=b.id,_.onclick=function(k){if(!r)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),me.delete(b.id);let $=this.querySelector(".event-details");$&&($.style.display="none")}else{this.classList.add("expanded"),me.add(b.id);let $=this.querySelector(".event-details");$&&($.style.display="block")}},_.innerHTML=`
                <div class="event-time">
            ...
            `;let O=_.querySelector(".event-details");if(O&&O.addEventListener("click",k=>{k.stopPropagation()}),r){let k=_.querySelector(".close-details-btn");k&&k.addEventListener("click",C=>{C.stopPropagation();let $=C.target.closest(".event-item");if($){$.classList.remove("expanded"),me.delete(b.id);let L=$.querySelector(".event-details");L&&(L.style.display="none")}})}let U=_.querySelector(".prev-btn"),j=_.querySelector(".next-btn");if(U&&j){let k=0,C=_.querySelectorAll(".history-slide"),$=C.length,L=()=>{C.forEach((T,q)=>{T.style.display=q===k?"block":"none"}),U.disabled=k===0,j.disabled=k===$-1,U.style.opacity=k===0?"0.5":"1",j.style.opacity=k===$-1?"0.5":"1"};U.addEventListener("click",T=>{T.stopPropagation(),k>0&&(k--,L())}),j.addEventListener("click",T=>{T.stopPropagation(),k<$-1&&(k++,L())}),L()}return _},c=Array.from(e.children),p=new Map(c.map(b=>[b.dataset.eventId,b])),h=new Set(we.map(b=>b.id));c.forEach(b=>{let n=b.dataset.eventId;(!n||!h.has(n))&&b.remove()});let m=null;we.forEach((b,n)=>{let f=p.get(b.id);(!f||t)&&(f&&f.remove(),f=v(b),!f)||(n===0?e.firstElementChild!==f&&e.prepend(f):m&&m.nextElementSibling!==f&&m.after(f),m=f)}),_e=Date.now(),Z(1,_e)}catch(s){console.error("Error fetching events:",s),e.children.length===0&&(e.innerHTML=R("offline","Failed to load events.","The event service may be offline."))}}function us(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),i=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{we.forEach(s=>me.add(s.id)),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ie(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.querySelectorAll(".filter-btn").forEach(s=>{s.onclick=()=>{i.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),s.classList.add("active"),W=s.dataset.filter,ie(!0)}}),i.dataset.listenerAttached="true"),i&&i.querySelectorAll(".filter-btn").forEach(s=>{s.dataset.filter===W?s.classList.add("active"):s.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let s=W==="all"?"ALL":W.toUpperCase();if(confirm(`Are you sure you want to delete ${s} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(W!=="all"?l+=`?category=${W}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await B(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ie(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var fs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Ct=fs;function $t(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var gs=null;async function Ce(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await B("/logs");if(!e.ok)throw new Error("Logs offline");let i=await e.json();if(!i||i.length===0)return t.innerHTML=R("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let a=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],s=i.filter(o=>!a.includes(o.id));s.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),s.reverse();let l=s.map(o=>{let v=o.logs.join(`
`),c=[...o.logs];if(c.length<25){let h=25-c.length;for(let m=0;m<h;m++)c.push("")}else c.length>25&&(c=c.slice(-25));let p=c.map(h=>Te(h)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(o=>{o.addEventListener("click",()=>{let v=unescape(o.dataset.logs);navigator.clipboard.writeText(v).then(()=>{let c=o.querySelector("i");c.classList.remove("bx-copy"),c.classList.add("bx-check"),setTimeout(()=>{c.classList.remove("bx-check"),c.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(o=>{o.addEventListener("click",async()=>{let v=o.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${v}?`))try{(await B(`/logs?service_id=${v}`,{method:"DELETE"})).ok&&Ce()}catch(c){console.error("Error clearing logs:",c)}})}),gs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=R("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Tt=()=>{let t=z()?"display: none;":"";return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${$t()}
        </div>`;async function Bt(){await Promise.all([$e(),je(),Fe()]),await Ce()}var Et=null,St=null;async function Dt(){try{return await(await B("/system_monitor")).json()}catch{return null}}async function kt(){try{return await(await B("/system/hardware")).json()}catch{return null}}async function bs(){try{return await(await B("/processes")).json()}catch{return null}}async function vs(){try{return await(await B("/agent/status")).json()}catch{return null}}async function je(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),i=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),s=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),o=document.querySelector("#hw-storage .hw-content"),v=r=>{if(r){if(i&&(i.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}l&&(r.GPU&&r.GPU.length>0?l.innerHTML=r.GPU.map(x=>{let u=(x.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),o&&r.STORAGE&&r.STORAGE.length>0?o.innerHTML=r.STORAGE.map(x=>{let u=(x.USED/1073741824).toFixed(1),g=(x.SIZE/(1024*1024*1024)).toFixed(1),d=x.SIZE>0?(x.USED/x.SIZE*100).toFixed(0):0,E=x.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):o&&(o.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let r=await kt();r?(v(r),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),a&&!a.hasChildNodes())){let r=await kt();v(r)}if(!t)return;let c=await Dt();if(!c||!c.services){t.children.length===0&&(t.innerHTML=R("offline","Failed to load system metrics.","The event service may be offline."));return}Et=Date.now(),Z(0,Et);let p=c.services||[];Array.from(t.children).forEach(r=>{r.classList.contains("service-widget")||r.remove()});function h(r){return!r||r==="N/A"||r==="unknown"||r.trim()===""?"-":r}function m(r){if(!r||r==="N/A"||r==="unknown")return"-";let x=r.match(/^(\d+\.\d+\.\d+)/);return x?x[0]:r.split(".").slice(0,3).join(".")||"-"}function b(r){return!r||r.length<=28?r:r.substring(0,28)+"..."}function n(r){if(!r||r==="N/A"||r==="unknown")return"-";let x=r.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!x)return"-";let u=parseInt(x[1])||0,g=parseInt(x[2])||0,d=parseInt(x[3])||0,E=parseFloat(x[4])||0,M=u*86400+g*3600+d*60+E,A=Math.floor(M/86400);if(A>0)return`${A}d`;let I=Math.floor(M/3600);if(I>0)return`${I}h`;let w=Math.floor(M/60);return w>0?`${w}m`:`${Math.floor(M)}s`}function f(r){let x=r.status==="online",u=x?"service-widget-online":"service-widget-offline",g=x?"bx-check-circle":"bx-x-circle",d=x?"OK":"BAD",E=r.version?m(r.version.str):"-",M=r.cpu&&r.cpu!=="N/A"?r.cpu:"-",A=r.memory&&r.memory!=="N/A"?r.memory:"-",I=M!=="-"?"#00ff00":"#666",w=M!=="-"?"#fff":"#666",H=A!=="-"?"#00ff00":"#666",N=A!=="-"?"#fff":"#666",_=n(r.uptime),O="";x?O=`
                ...
                </div>`:O='<div class="service-widget-footer offline"><span>OFFLINE</span></div>';let U=z()?"easter.company":b(r.domain&&r.port?`${r.domain}:${r.port}`:"");return`<div class="service-widget ${u}" data-service-id="${r.id}"><div class="service-widget-header"><i class="bx ${g}"></i><h3>${r.short_name||r.id}</h3><span class="service-widget-status">${d}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${U}</span></div>${O}</div></div>`}let S=new Map(Array.from(t.querySelectorAll(".service-widget")).map(r=>[r.dataset.serviceId,r])),y=new Set(p.map(r=>r.id));for(let[r,x]of S)y.has(r)||x.remove();p.forEach(r=>{let x=f(r),u=S.get(r.id);u?u.outerHTML!==x&&(u.outerHTML=x):t.insertAdjacentHTML("beforeend",x)})}async function Fe(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Dt();if(!e){t.children.length===0&&(t.innerHTML=R("offline","Failed to load model status.","The event service may be offline."));return}St=Date.now(),Z(2,St);let i=e.models||[],a=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function s(c){let p=c.status==="Ready";return`
                ...
                </div>`}function o(c){let p=c.status==="Downloaded",h=p?"service-widget-online":"service-widget-offline",m=p?"OK":"MISSING",b=p&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",n=c.name;return c.type==="custom"&&n.endsWith(":latest")&&(n=n.replace(":latest","")),`<div class="service-widget ${h}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${p?"bx-check-circle":"bx-x-circle"}"></i><h3>${n}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let v="";if(a&&(v+=s(a)),e.xtts&&(v+=l(e.xtts)),v+=i.map(o).join(""),!v){t.innerHTML=R("empty","No models found.");return}t.innerHTML!==v&&(t.innerHTML=v)}async function $e(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-architect-val"),a=document.getElementById("guardian-idle-val"),s=document.getElementById("guardian-total-idle"),l=document.getElementById("guardian-total-active"),o=document.getElementById("guardian-total-waste"),v=document.getElementById("guardian-reset-btn"),c=document.getElementById("analyzer-reset-btn");v&&!v.dataset.listenerAttached&&(v.onclick=async()=>{v.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{v.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{v.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),$e()}catch{v.innerHTML="<i class='bx bx-error'></i>"}},v.dataset.listenerAttached="true"),c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{c.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),$e()}catch{c.innerHTML="<i class='bx bx-error'></i>"}},c.dataset.listenerAttached="true");let p=await vs();if(p){let y=Math.floor(Date.now()/1e3),r=p.active_tier,x=p.active_synthesis,u=p.protocol_aliases||{sentry:"Sentry",architect:"Architect",synthesis:"Synthesis"},g=w=>{w<0&&(w=0);let H=Math.floor(w/3600),N=Math.floor(w%3600/60),_=w%60;return H>0?`${H}h ${N}m`:N>0?`${N}m ${_}s`:`${_}s`},d=(w,H,N,_,O)=>{if(!w)return;let U=u[_]||_.toUpperCase(),j=w.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(j&&(j.textContent=U),O&&O.includes(_))w.textContent="Working",w.style.color="#bb86fc";else if(N){let C=N.next_run-y;if(C<=0)w.textContent="Ready",w.style.color="#5eff5e";else{let $=Math.floor(C/60),L=C%60;w.textContent=`${$}m ${L}s`,w.style.color="#fff"}}H&&N&&(H.innerHTML=`
          <div style="display: flex; flex-direction: column; gap: 2px;">
            <span>Runs: ${N.attempts||0}</span>
            <span style="color: ${N.failures>0?"#ffa500":"#666"}">Fails: ${N.failures||0}</span>
            <span style="color: ${N.absolute_failures>0?"#ff4d4d":"#666"}">Aborted: ${N.absolute_failures||0}</span>
          </div>
        `)};e&&d(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry",r),i&&d(i,document.getElementById("guardian-architect-stats"),p.architect,"architect",r);let E=document.getElementById("analyzer-synthesis-val"),M=document.getElementById("analyzer-synthesis-stats");E&&d(E,M,p.synthesis,"synthesis",x);let A=document.getElementById("system-state-label"),I=document.getElementById("system-state-val");if(I&&p.system_state){let w=p.system_state,H=g(p.system_state_time||0);A&&(A.textContent=`State: ${w.toUpperCase()}`),I.textContent=H,w==="idle"?I.style.color=p.system_state_time>300?"#5eff5e":"#fff":I.style.color="#bb86fc"}s&&(s.textContent=g(p.total_idle_time||0)),l&&(l.textContent=g(p.total_active_time||0)),o&&(o.textContent=g(p.total_waste_time||0))}else[e,i,a,s,l,o].forEach(r=>{r&&(r.textContent="-",r.style.color="#666")});let h=await bs(),m=[],b=[],n=[];h&&(Array.isArray(h)?m=h:(m=h.active||[],b=h.queue||[],n=h.history||[],n.sort((y,r)=>(r.end_time||0)-(y.end_time||0)))),m.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=R("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),qe(t,m,!1));let f=document.getElementById("processes-queue-widgets");f&&(b.length===0?!f.querySelector(".tab-placeholder")&&!f.querySelector('div[style*="font-style: italic"]')&&(f.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(f.innerHTML="",qe(f,b,!1)));let S=document.getElementById("processes-history-widgets");S&&(n.length===0?S.querySelector(".tab-placeholder")||(S.innerHTML=R("empty","No recent history.")):(S.querySelector(".tab-placeholder")&&(S.innerHTML=""),qe(S,n,!0))),he(1,m.length)}function qe(t,e,i){function a(v){let c="";v.end_time?c=`${v.end_time-v.start_time}s`:c=`${Math.floor(Date.now()/1e3-v.start_time)}s`;let p=v.retries>0?`<span class="process-retry-badge">Retry ${v.retries}</span>`:"",h=v.channel_id,m={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(m[h]?h=m[h]:/^\d+$/.test(h)&&(h=`Channel ${h}`),i)return`
        <div class="process-history-item" data-channel-id="${v.channel_id}-${v.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
                ...
                <span style="color: #fff; font-weight: 600;">${h}</span>
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let s=i?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(s)).map(v=>[v.dataset.channelId,v])),o=new Set(e.map(v=>`${v.channel_id}-${v.start_time}`));for(let[v,c]of l)o.has(v)||c.remove();e.forEach(v=>{let c=`${v.channel_id}-${v.start_time}`,p=a(v),h=l.get(c);if(h){h.outerHTML!==p&&(h.outerHTML=p);let m=t.querySelector(`[data-channel-id="${c}"]`);m&&t.appendChild(m)}else t.insertAdjacentHTML("beforeend",p)})}function Be(){let t=Ne(),e={enabled:Notification.permission==="granted",supported:"Notification"in window};return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ys=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
        <div class="cli-dashboard">
            ...
            <div class="cli-divider">
                ...
                <span>Interactive Demos (v${xs})</span>
                <i class='bx bx-chevron-down'></i>
            </div>
    `;for(let[i,a]of Object.entries(t)){let s=Ht.filter(l=>l.category===i);s.length!==0&&(e+=`
    ...
    </div>`,e},Ge=!1;function hs(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ge=!0,i}function zt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ge=!1}function Nt(t,e,i="output"){if(!Ge)return;let a=document.createElement("div");a.className=`terminal-line terminal-${i}`,i==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=Te(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function ws(t){let e=Ht.find(s=>s.id===t);if(!e)return;let i=hs(e);Nt(i,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let s of a){await new Promise(o=>setTimeout(o,400+Math.random()*600));let l="output";s.includes("[ERROR]")?l="error":s.includes("[SUCCESS]")||s.includes("\u2713")?l="success":s.includes("!")&&(l="warning"),Nt(i,s,l)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Pt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=ys();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let i=e.querySelector("code").textContent;navigator.clipboard.writeText(i).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(i=>{i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),i.addEventListener("click",()=>{let a=i.dataset.cmd;ws(a)})})}async function Cs(){try{if(!(await B("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Rt(){Cs(),it(),Ke();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Pt(),Ye(),Xe();let e=document.getElementById("nav-left-container");e&&e.addEventListener("click",()=>{let d=document.getElementById("dexter-dropdown"),E=document.getElementById("dexter-menu-btn");if(d&&d.classList.contains("active")){d.classList.remove("active"),E.classList.remove("active"),l?.classList.remove("menu-open"),s.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1));return}if(s.length>0)h();else{let M=window.location.pathname;if(!(M==="/"||M==="/index.html")){let w=(M.endsWith("/")&&M.length>1?M.slice(0,-1):M).split("/");w.pop();let H=w.join("/")||"/";window.location.href=H}}});let i=window.location.pathname==="/"||window.location.pathname==="/index.html",a=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!i&&!a&&document.querySelector("footer")?.classList.add("hide");let s=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let o=d=>{localStorage.setItem("dex_last_window",d)};function v(){return 1}function c(){for(;s.length>1;)s.shift().close(!0);let d=document.getElementById("windows-container"),E=document.querySelector("nav"),M=document.querySelector("footer"),A=window.location.pathname==="/"||window.location.pathname==="/index.html",I=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");d&&d.setAttribute("data-count",s.length),s.forEach(U=>{let j=document.getElementById(U.id);j&&j.classList.remove("hide-close")});let w=document.getElementById("dexter-menu-container"),H=document.getElementById("nav-window-switcher"),N=document.getElementById("settings-icon"),_=document.getElementById("close-all-windows"),O=window.innerWidth<880;if(O||(r&&r.classList.remove("active"),u&&u.classList.remove("active"),d&&d.classList.remove("menu-open")),fe(s.length>0),s.length>0)if(M?.classList.add("hide"),_&&(_.style.display=O?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),E?.classList.add("window-open"),d&&(d.style.paddingTop="60px"),w&&(w.style.display=O?"flex":"none"),N&&(N.style.display=O?"block":"none"),!O&&H){let U=s[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(U)?(H.innerHTML=`
                      <div class="nav-switch-btn ${U==="alerts-window"?"active":""}" id="switch-alerts"><i class='bx bx-bell'></i> Alerts</div>
                      <div class="nav-switch-btn ${U==="events-window"?"active":""}" id="switch-events"><i class='bx bx-calendar-event'></i> Events</div>
                      <div class="nav-switch-btn ${U==="monitor-window"?"active":""}" id="switch-monitor"><i class='bx bx-pulse'></i> Monitor</div>
                      <div class="nav-switch-btn ${U==="contacts-window"?"active":""}" id="switch-contacts"><i class='bx bx-book-content'></i> Contacts</div>
                      <div class="nav-switch-btn ${U==="workspace-window"?"active":""}" id="switch-workspace"><i class='bx bx-brain'></i> Workspace</div>
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{o("alerts-window"),p(m)}),document.getElementById("switch-events").addEventListener("click",()=>{o("events-window"),p(b)}),document.getElementById("switch-monitor").addEventListener("click",()=>{o("monitor-window"),p(f)}),document.getElementById("switch-contacts").addEventListener("click",()=>{o("contacts-window"),p(n)}),document.getElementById("switch-workspace").addEventListener("click",()=>{o("workspace-window"),p(S)})):H.innerHTML=""}else H&&(H.innerHTML="");else E?.classList.remove("window-open"),_&&(_.style.display="none"),d&&(d.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),A||I?M?.classList.remove("hide"):M?.classList.add("hide"),w&&(w.style.display="flex"),N&&(N.style.display="block"),H&&(H.innerHTML="");ve()}function p(d){if(d.isOpen()){d.close();return}for(;s.length>0;)s.pop().close(!0);s.push(d),d.open(),c()}function h(){[...s].forEach(E=>E.close()),s=[]}window.addEventListener("resize",c);let m=ne({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:ct(),onOpen:()=>se(),onClose:()=>{let d=s.indexOf(m);d>-1&&s.splice(d,1),c()}}),b=ne({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Ue(),onOpen:()=>{b.setContent(Ue()),ie()},onClose:()=>{let d=s.indexOf(b);d>-1&&s.splice(d,1),c()}}),n=ne({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:ht(),onOpen:()=>Oe(),onClose:()=>{let d=s.indexOf(n);d>-1&&s.splice(d,1),c()}}),f=ne({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Mt()},{icon:"bxs-component",title:"Processes",content:Lt()},{icon:"bxs-brain",title:"Models",content:At()},{icon:"bxs-hdd",title:"Hardware",content:It()},{icon:"bxs-terminal",title:"Logs",content:_t()},{icon:"bxs-zap",title:"Agents",content:Tt()}].filter(d=>z()?d.title!=="Hardware"&&d.title!=="Logs":!0),onOpen:()=>{je(),$e(),Fe(),Ce()},onClose:()=>{let d=s.indexOf(f);d>-1&&s.splice(d,1),c()}}),S=ne({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:vt(),onOpen:()=>Pe(),onClose:()=>{let d=s.indexOf(S);d>-1&&s.splice(d,1),c()}}),y=ne({id:"settings-window",title:"Settings",icon:"bx-cog",content:Be(),onOpen:()=>{y.setContent(Be()),Je(y)},onClose:()=>{let d=s.indexOf(y);d>-1&&s.splice(d,1),c()}});window.dexter={viewEvent:d=>{b.isOpen()||p(b),setTimeout(()=>{let E=document.querySelector(`.event-item[data-event-id="${d}"]`);E&&(E.scrollIntoView({behavior:"smooth",block:"center"}),E.classList.add("flash-highlight"),E.classList.contains("expanded")||E.click(),setTimeout(()=>E.classList.remove("flash-highlight"),2e3))},500)},viewAlert:d=>{m.isOpen()||p(m),setTimeout(()=>{let E=document.querySelector(`.event-item[data-alert-id="${d}"]`);E&&(E.scrollIntoView({behavior:"smooth",block:"center"}),E.classList.add("flash-highlight"),E.classList.contains("expanded")||E.click(),setTimeout(()=>E.classList.remove("flash-highlight"),2e3))},500)}};let r=document.getElementById("dexter-dropdown");r&&(r.innerHTML=`
          ...
          <div class="dropdown-item" id="workspace-menu-item"><i class='bx bx-brain'></i> Workspace</div>
      `);let x=document.getElementById("dexter-menu-container"),u=document.getElementById("dexter-menu-btn");x&&r&&u&&(u.addEventListener("click",d=>{d.stopPropagation();let E=window.innerWidth<880;r.classList.toggle("active"),u.classList.toggle("active");let M=r.classList.contains("active");if(E){let A=document.querySelector("nav"),I=document.getElementById("windows-container");M?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),A?.classList.add("window-open"),I?.classList.add("menu-open"),fe(!0)):(I?.classList.remove("menu-open"),s.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),A?.classList.remove("window-open"),fe(!1)))}}),document.addEventListener("click",()=>{let d=window.innerWidth<880,E=r.classList.contains("active");if(r.classList.remove("active"),u.classList.remove("active"),d&&E){document.getElementById("windows-container")?.classList.remove("menu-open");let A=document.querySelector("nav");s.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),A?.classList.remove("window-open"),fe(!1))}}),r.addEventListener("click",d=>{d.stopPropagation()}));let g=()=>{r&&u&&(r.classList.remove("active"),u.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};document.getElementById("alerts-menu-item")?.addEventListener("click",()=>{g(),o("alerts-window"),p(m)}),document.getElementById("events-menu-item")?.addEventListener("click",()=>{g(),o("events-window"),p(b)}),document.getElementById("monitor-menu-item")?.addEventListener("click",()=>{g(),o("monitor-window"),p(f)}),document.getElementById("contacts-menu-item")?.addEventListener("click",()=>{g(),o("contacts-window"),p(n)}),document.getElementById("workspace-menu-item")?.addEventListener("click",()=>{g(),o("workspace-window"),p(S)}),document.getElementById("settings-icon")?.addEventListener("click",()=>p(y)),document.getElementById("close-all-windows")?.addEventListener("click",()=>h()),z()||setInterval(()=>{b.isOpen()&&ie(),m.isOpen()?se():He()},1e3),setInterval(()=>{z()&&(m.isOpen()?se():He()),S.isOpen()?Pe():bt(),z()&&b.isOpen()&&ie(),f.isOpen()&&Bt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Rt):Rt();})();
