"use strict";(()=>{function dt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.prepend(t)}}function pt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var ut=1e3;function ue(t){let e=null,a=t.onClose||null,n=t.onOpen||null;function i(){e&&(e.style.zIndex=(++ut).toString())}function r(){if(e){e.classList.add("open"),i(),window.addEventListener("resize",o),n&&setTimeout(n,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++ut).toString(),e.addEventListener("mousedown",i);let v=t.icon||"bx-window",s="",u="",C,I='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((x,y)=>{let c=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,C=`<div class="window-content">${t.tabs.map((x,y)=>`<div class="tab-content ${y===0?"active":""}" data-tab-content="${y}">${x.content}${I}</div>`).join("")}</div>`):(t.title&&(u=`<div class="window-title">${t.title}</div>`),C=`<div class="window-content">${t.content||""}${I}</div>`),e.innerHTML=`
            ...
            ${C}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",b=>{b.stopPropagation(),d()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach(b=>{b.addEventListener("click",()=>{if(!e)return;let p=b.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(y=>y.classList.remove("active")),b.classList.add("active"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.remove("active"));let x=e.querySelector(`.tab-content[data-tab-content="${p}"]`);x&&x.classList.add("active"),g(b,e)})}),setTimeout(()=>{e&&e.classList.add("open"),n&&n()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&g(m,e)}function g(m,v){setTimeout(()=>{let s=v.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),C=u.indexOf(m),I=s.clientWidth,b=u[Math.max(0,C-2)],p=u[Math.min(u.length-1,C+2)],x=s,y=b.offsetLeft-x.offsetLeft-25,l=p.offsetLeft+p.offsetWidth-x.offsetLeft+25-y,w=l<=I?y-(I-l)/2:m.offsetLeft-x.offsetLeft-I/2+m.offsetWidth/2;s.scrollTo({left:w,behavior:"smooth"})},350)}function d(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function h(m){t.content=m;let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function T(){return!!(e&&e.classList.contains("open"))}return{open:r,close:d,setContent:h,isOpen:T,focus:i,id:t.id}}var ft="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ye(){return localStorage.getItem(ft)||ee.DARK}function gt(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(ft,t),bt(t)}function bt(t){let e=document.body;Object.values(ee).forEach(r=>{e.classList.remove(`theme-${r}`)}),e.classList.add(`theme-${t}`);let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.getElementsByTagName("head")[0].appendChild(a));let n={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},i=n[t]||n[ee.DARK];if(a.setAttribute("content",i),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}e.classList.add("is-animated")}function vt(){let t=Ye();bt(t)}function J(t,e,a=null,n="default"){let r={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${n}"><i class='bx ${r} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function j(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let n=Date.now(),i=Math.floor((n-e)/1e3),r;i<60?r=`${i}s ago`:i<3600?r=`${Math.floor(i/60)}m ago`:r=`${Math.floor(i/3600)}h ago`,a.textContent=`Last updated: ${r}`}var ms=0;function Oe(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let n=a.querySelector(".notification-badge");n&&(e>0?(n.textContent=e>9?"9+":e.toString(),n.style.display="flex"):n.style.display="none")}var ae=0,oe=0;function xt(t){ae=t,Le()}function ht(t){oe=t,Le()}function Le(){let t=ae+oe;ms=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let a=document.getElementById("alerts-menu-item");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",a.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}let n=document.getElementById("workspace-menu-item");if(n){let o=n.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",n.appendChild(o)),o.textContent=oe>9?"9+":oe.toString(),o.style.display=oe>0?"flex":"none"}let i=document.getElementById("switch-alerts");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",i.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}let r=document.getElementById("switch-workspace");if(r){let o=r.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",r.appendChild(o)),o.textContent=oe>9?"9+":oe.toString(),o.style.display=oe>0?"flex":"none"}}function Qe(){let t=document.getElementById("alerts-list");if(!t)return;ae=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Le()}function wt(){let t=document.getElementById("blueprints-list");if(!t)return;oe=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Le()}function us(){return"https://event.easter.company"}function fs(){return"https://discord.easter.company"}var gs="http://127.0.0.1:8100",bs="http://127.0.0.1:8300",vs={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function je(t){let e=j(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(i,r)=>{let o=vs[r];return o?`<span class="${o}">`:""});let a=(e.match(/<span/g)||[]).length,n=(e.match(/<\/span/g)||[]).length;return a>n&&(e+="</span>".repeat(a-n)),e}function le(t){if(!t)return"";let e=j(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(a,n)=>{let i=n.split("|").map(r=>r.trim());return i.every(r=>r.match(/^:?-+:?$/))?"":`<div class="md-table-row">${i.map(r=>`<span class="md-table-cell">${r}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}function ie(){let t=document.getElementById("windows-container"),e=t?parseInt(t.getAttribute("data-count")||"0"):0,a=document.querySelector(".profile-overlay.active"),n=document.querySelector("#cli-terminal-overlay.active");return e>0||!!a||!!n}var ys="https://sterling-javelin-12539.upstash.io",xs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function P(){return window.location.hostname.includes("easter.company")}var F=null,re={lastDashboard:0,lastFrontend:0},Xe=!1,Ct=0,Et="dex_dashboard_snapshot";function hs(){let t=localStorage.getItem(Et);if(t)try{let e=JSON.parse(t);F=e,re.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{F=null}}async function yt(){if(!(!P()||Xe)){Xe=!0,Ct=Math.floor(Date.now()/1e3);try{let t=await Es("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);F=e,re.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),re.lastFrontend=Date.now(),localStorage.setItem(Et,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Xe=!1}}}function ws(){if(!F||!F.agent_status)return;let t=F.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Cs(){if(!P())return;hs();let t=Math.floor(Date.now()/1e3),e=F?t-F.timestamp:1/0;(!F||e>120)&&await yt(),setInterval(()=>{let a=new Date,n=Math.floor(Date.now()/1e3),i=F?n-F.timestamp:1/0,r=n-Ct,o=a.getSeconds()===59,g=i>300,d=r>60;(o&&d||g&&d)&&yt(),ws()},1e3)}P()&&Cs();async function Es(t,...e){try{let n=await(await fetch(ys,{method:"POST",headers:{Authorization:`Bearer ${xs}`},body:JSON.stringify([t,...e])})).json();if(n.error)throw new Error(n.error);return n.result}catch(a){return console.error("Upstash Error:",a),null}}var Se=null,ke=null,Pe=!1,Re=!1;async function _(t,e={}){if(P()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(F.monitor),{status:200});if(t.startsWith("/system/options"))return new Response(JSON.stringify(F.options||{}),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(F.processes),{status:200});if(t.startsWith("/events")){let i=new URLSearchParams(t.split("?")[1]||""),r=i.get("type")||i.get("event.type"),o=i.get("category"),g=i.get("order")||"desc",d=[];return r==="system.notification.generated"?d=[...F.alerts||[]]:r==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...F.blueprints||[]]:o==="messaging"?d=[...F.messaging_events||[]]:o==="system"?d=[...F.system_events||[]]:o==="cognitive"?d=[...F.cognitive_events||[]]:o==="moderation"?d=[...F.moderation_events||[]]:d=[...F.events||[]],g==="asc"?d.sort((h,T)=>h.timestamp-T.timestamp):d.sort((h,T)=>T.timestamp-h.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(F.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let i=t.split("/")[2],r=F.profiles?F.profiles[i]:null;return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(F.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(F.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(Se)try{let i=await fetch(Se+t,e);if(i.ok)return i;Se=null}catch{Se=null}let a=us(),n=gs;try{let i=await fetch(a+t,e);if(i.ok)return Se=a,Pe&&(console.log("\u2728 Production event service restored."),Pe=!1),i;throw new Error("Primary failed")}catch{Pe||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${n}`),Pe=!0);try{let r=await fetch(n+t,e);if(r.ok)return Se=n,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function fe(t,e={}){if(P()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(F.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let i=t.split("/")[2],r=(F.contacts?.members||[]).find(o=>o.id===i);return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(ke)try{let i=await fetch(ke+t,e);if(i.ok)return i;ke=null}catch{ke=null}let a=fs(),n=bs;try{let i=await fetch(a+t,e);if(i.ok)return ke=a,Re&&(console.log("\u2728 Production discord service restored."),Re=!1),i;throw new Error("Primary failed")}catch{Re||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${n}`),Re=!0);try{let r=await fetch(n+t,e);if(r.ok)return ke=n,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Tt=()=>`
...
`,qe=null,ge=new Set,Ue=[];async function pe(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Ts(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let n=await _(a);if(!n.ok)throw new Error("Service is offline or unreachable.");let r=(await n.json()).events||[];qe=Date.now(),te(0,qe);let o=Date.now(),g=24*60*60*1e3,d=r.filter(p=>{let x=localStorage.getItem(`alert_read_ts_${p.id}`);if(!x)return!0;let y=parseInt(x);return o-y<g});d.sort((p,x)=>{let y=E=>{let f=E.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return"low"}return(f.priority||"low").toLowerCase()},c=E=>E==="critical"?4:E==="high"?3:E==="medium"?2:1,l=c(y(p)),w=c(y(x));return l!==w?w-l:x.timestamp-p.timestamp}),Ue=d;let h=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return"low"}return(x.priority||"low").toLowerCase()},T=[];if(d.length===0)T.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let x=new Set(d.map(c=>h(c))).size>1,y=null;d.forEach(c=>{let l=h(c);x&&l!==y&&(T.push({id:`divider-${l}`,type:"divider",label:l.toUpperCase()}),y=l),T.push(c)})}t&&(e.innerHTML="");let m=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return null}let y=(x.title||"Untitled Alert").trim(),c=(x.body||"No description provided.").trim(),l=x.summary||"",w=x.content||"",E=x.protocol||"",f=(x.priority||"low").toLowerCase(),S=!!x.alert,B=(x.category||"system").trim(),k=x.related_event_ids||[],D=x.audit_event_id,U=!!localStorage.getItem(`alert_read_ts_${p.id}`),G=new Date(p.timestamp*1e3),H=G.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=G.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=U?"event-border-grey":"event-border-blue";!U&&S&&(M="event-border-red"),U&&(f==="high"||f==="critical")?M="event-border-red":U&&f==="medium"&&(M="event-border-orange");let A=U?"alert-read":"alert-unread",O=ge.has(p.id),R=O?"expanded":"",V=O?"display: block;":"display: none;",L="",z="";k.length>0&&(z=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${k.map(de=>`<a href="#" onclick="window.dexter.viewEvent('${de}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${de.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let N="";D&&(N=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #ddd; font-size: 0.85em; white-space: pre-wrap; line-height: 1.6; text-align: left;">${le(w)}</div>
            </div>
        `:Y=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${le(c)}</div>
            </div>
        `,L=`
            ...
            `;let K=document.createElement("div");K.className=`event-item notification-item ${M} ${A} ${R} cursor-pointer priority-${f}`,K.dataset.alertId=p.id,K.onclick=function(de){let Q=this;if(Q.classList.contains("expanded")){Q.classList.remove("expanded"),ge.delete(p.id);let Be=Q.querySelector(".event-details");Be&&(Be.style.display="none")}else{Q.classList.add("expanded"),ge.add(p.id);let Be=Q.querySelector(".event-details");if(Be&&(Be.style.display="block"),!localStorage.getItem(`alert_read_ts_${p.id}`)){localStorage.setItem(`alert_read_ts_${p.id}`,Date.now().toString()),Q.classList.add("alert-read"),Q.classList.remove("alert-unread"),Q.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ze="event-border-grey";f==="high"||f==="critical"?Ze="event-border-red":f==="medium"&&(Ze="event-border-orange"),Q.classList.add(Ze),Qe()}}};let Ee=`${E?E.toUpperCase():"GUARDIAN"} ALERT: ${l||y}`,Ve={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[B]||"bx-bell",Ke=f==="high"||f==="critical"?"#ff4d4d":f==="medium"?"#ffa500":"#888";K.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Ke}; font-size: 0.8em; margin-left: 5px;">[${f.toUpperCase()}]</span>
                    </div>
            ...
            `;let lt=K.querySelector(".event-details");lt&&lt.addEventListener("click",de=>{de.stopPropagation()});let ct=K.querySelector(".close-details-btn");return ct&&ct.addEventListener("click",de=>{de.stopPropagation(),K.classList.remove("expanded");let Q=K.querySelector(".event-details");Q&&(Q.style.display="none"),ge.delete(p.id)}),K},v=p=>{let x=document.createElement("div");x.className="notification-divider",x.dataset.alertId=p.id;let y="#888888";return p.label==="CRITICAL"?y="#ff4d4d":p.label==="HIGH"?y="#ff8888":p.label==="MEDIUM"&&(y="#ffa500"),x.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,x.innerHTML=`<span style="white-space: nowrap;">${p.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,x},s=p=>{let x=document.createElement("div");x.innerHTML=J("empty",p.message,null,p.id);let y=x.firstElementChild;return y.dataset.alertId=p.id,y},u=Array.from(e.children),C=new Map(u.map(p=>[p.dataset.alertId,p])),I=new Set(T.map(p=>p.id));u.forEach(p=>{let x=p.dataset.alertId;(!x||!I.has(x))&&p.remove()});let b=null;T.forEach((p,x)=>{let y=C.get(p.id);if(!y||t){if(y&&y.remove(),p.type==="divider")y=v(p);else if(p.type==="placeholder")y=s(p);else{let c=m(p);if(!c)return;y=c}if(!y)return}x===0?e.firstElementChild!==y&&e.prepend(y):b&&b.nextElementSibling!==y&&b.after(y),b=y}),qe=Date.now(),te(0,qe),Qe()}catch(n){console.error("Error fetching alerts:",n),e.children.length===0&&(e.innerHTML=J("offline","Failed to load alerts.","The event service may be offline."))}}function Ts(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),a=document.getElementById("alerts-close-all"),n=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ue.forEach(i=>{localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ue.forEach(i=>{ge.add(i.id),localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),pe(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{ge.clear(),pe(!0)},a.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let i=Date.now()-48*60*60*1e3;Ue.forEach(r=>{localStorage.setItem(`alert_read_ts_${r.id}`,i.toString())}),ge.clear(),pe(!0)}catch(i){console.error("Failed to clear alerts:",i)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}async function et(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let n=(await e.json()).events||[],i=0;n.forEach(r=>{let o=r.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}if((o.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${r.id}`)||i++}),xt(i)}catch{}}var $t=()=>`
...
`,be=new Set,kt=[],Me=null;async function ve(t=!1){let e=document.getElementById("roadmap-list");if(e){$s();try{let a=await _("/roadmap");if(!a.ok)throw new Error("Offline");let n=await a.json();kt=n;let i=m=>{let v=be.has(m.id),s=m.state==="published",u=m.state==="consumed",C="event-border-grey";s&&(C="event-border-blue"),u&&(C="event-border-purple");let b=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),p=document.createElement("div");p.className=`event-item notification-item ${C} cursor-pointer ${v?"expanded":""}`,p.dataset.itemId=m.id,p.onclick=c=>{if(c.target.closest("button"))return;if(p.classList.contains("expanded")){p.classList.remove("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="none"),be.delete(m.id)}else{p.classList.add("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="block"),be.add(m.id)}};let x=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;p.innerHTML=`
        <div class="event-time">
      ...
      `;let y=p.querySelector(".event-details");return y&&y.addEventListener("click",c=>{c.stopPropagation()}),p.querySelector(".edit-btn")?.addEventListener("click",()=>Ss(m)),p.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ks(m)),p.querySelector(".delete-btn")?.addEventListener("click",()=>Ls(m.id)),p.querySelector(".close-details-btn")?.addEventListener("click",c=>{c.stopPropagation(),p.classList.remove("expanded");let l=p.querySelector(".event-details");l&&(l.style.display="none"),be.delete(m.id)}),p},r=m=>{let v=document.createElement("div");v.innerHTML=J("empty",m.message,m.action,m.id);let s=v.firstElementChild;return s.dataset.itemId=m.id,s},o=[];!n||n.length===0?o.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:P()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):n.forEach(m=>o.push({...m,type:"item"}));let g=Array.from(e.children),d=new Map(g.map(m=>[m.dataset.itemId,m])),h=new Set(o.map(m=>m.id));g.forEach(m=>{let v=m.dataset.itemId;(!v||!h.has(v))&&m.remove()}),t&&(e.innerHTML="");let T=null;o.forEach((m,v)=>{let s=d.get(m.id);(!s||t)&&(s&&s.remove(),m.type==="placeholder"?s=r(m):s=i(m),!s)||(v===0?e.firstElementChild!==s&&e.prepend(s):T&&T.nextElementSibling!==s&&T.after(s),T=s)})}catch{e.children.length===0&&(e.innerHTML=J("offline","Failed to load roadmap.","The event service may be offline."))}}}function $s(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),n=document.getElementById("roadmap-expand-all"),i=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Me=null;let r=document.getElementById("roadmap-editor-input");r&&(r.value="");let o=document.getElementById("roadmap-editor-container");o&&(o.style.display="block")},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="none"),Me=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input"),o=r?r.value:"";if(!o.trim())return;let g=Me?`/roadmap/${Me}`:"/roadmap",d=Me?"PATCH":"POST";try{await _(g,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:o})});let h=document.getElementById("roadmap-editor-container");h&&(h.style.display="none"),ve(!0)}catch(h){console.error(h)}},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{kt.forEach(r=>be.add(r.id)),ve(!0)},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{be.clear(),ve(!0)},i.dataset.listenerAttached="true")}function Ss(t){Me=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let a=document.getElementById("roadmap-editor-container");a&&(a.style.display="block",a.scrollIntoView({behavior:"smooth"}))}async function ks(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ve(!0)}catch(a){console.error(a)}}async function Ls(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),be.delete(t),ve(!0)}catch(e){console.error(e)}}var Mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,Lt=null,ye=new Set,At=[];async function xe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Ms();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let n=await _(a);if(!n.ok)throw new Error("Service is offline or unreachable.");let r=(await n.json()).events||[];At=r,Lt=Date.now(),te(2,Lt);let o=s=>{let u=s.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let C=(u.title||"Untitled Blueprint").trim(),I=(u.summary||u.body||"No summary provided.").trim(),b=(u.content||"").trim(),p=(u.category||"architecture").trim(),x=(u.related_services||u.affected_services||[]).map(L=>L.trim()),y=(u.implementation_path||[]).map(L=>L.trim()),c=u.source_event_ids||[],l=u.approved===!0,w=new Date(s.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),f=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=ye.has(s.id),B=S?"display: block;":"display: none;",k=document.createElement("div");k.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${l?"blueprint-approved":""}`,k.dataset.blueprintId=s.id,l&&(k.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",k.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let W=l?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[p]||"bx-paint";k.onclick=function(L){let z=this;if(z.classList.contains("expanded")){z.classList.remove("expanded"),ye.delete(s.id);let q=z.querySelector(".event-details");q&&(q.style.display="none")}else{z.classList.add("expanded"),ye.add(s.id);let q=z.querySelector(".event-details");q&&(q.style.display="block")}};let U="";y.length>0&&(U=`
            ...
            `;let A=k.querySelector(".blueprint-approve-btn");A&&(A.onclick=async L=>{L.stopPropagation(),A.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${s.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&xe(!0)}catch(z){console.error("Failed to approve blueprint:",z)}});let O=k.querySelector(".blueprint-delete-btn");O&&(O.onclick=async L=>{L.stopPropagation();let z=!l;O.innerHTML=z?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${s.id}`,{method:"DELETE"})).ok&&xe(!0)}catch(N){console.error("Failed to delete blueprint:",N)}});let R=k.querySelector(".event-details");R&&R.addEventListener("click",L=>{L.stopPropagation()});let V=k.querySelector(".close-details-btn");return V&&V.addEventListener("click",L=>{L.stopPropagation(),k.classList.remove("expanded");let z=k.querySelector(".event-details");z&&(z.style.display="none"),ye.delete(s.id)}),k},g=s=>{let u=document.createElement("div");u.innerHTML=J("empty",s.message,s.action,s.id);let C=u.firstElementChild;return C.dataset.blueprintId=s.id,C},d=[];r.length===0?d.push({id:"placeholder-empty",type:"placeholder",message:"No architectural blueprints generated yet.",action:"The Imaginator will synthesize these during system idle periods."}):r.forEach(s=>d.push({...s,type:"blueprint"})),t&&(e.innerHTML="");let h=Array.from(e.children),T=new Map(h.map(s=>[s.dataset.blueprintId,s])),m=new Set(d.map(s=>s.id));h.forEach(s=>{let u=s.dataset.blueprintId;(!u||!m.has(u))&&s.remove()});let v=null;d.forEach((s,u)=>{let C=T.get(s.id);(!C||t)&&(C&&C.remove(),s.type==="placeholder"?C=g(s):C=o(s),!C)||(u===0?e.firstElementChild!==C&&e.prepend(C):v&&v.nextElementSibling!==C&&v.after(C),v=C)}),Oe(2,r.length),wt()}catch(n){console.error("Error fetching blueprints:",n),e.children.length===0&&(e.innerHTML=J("offline","Failed to load blueprints.","The event service may be offline."))}}async function Bt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let n=(await e.json()).events||[],i=0;n.forEach(r=>{let o=r.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}o.approved!==!0&&i++}),ht(i)}catch{}}function Ms(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),a=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{At.forEach(n=>ye.add(n.id)),xe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ye.clear(),xe(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),ye.clear(),xe(!0)}catch(n){console.error("Failed to clear blueprints:",n)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var ce="STANDBY",Ht=null,Ie=[],X=null,Fe=null,_t=()=>`
  ...
  `}async function Ae(){let t=document.getElementById("progress-view-root");t&&(ce!==Ht&&(t.innerHTML=Dt(),Ht=ce),ce==="ACTIVE"&&Hs())}function Hs(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),a=document.getElementById("active-task-progress-text"),n=document.getElementById("terminal-output");if(t&&X&&(t.innerText=X.title),e&&X&&(e.style.width=`${X.progress}%`),a&&X&&(a.innerText=`${X.progress}% COMPLETE`),n){let i=n.children.length;if(Ie.length>i){for(let r=i;r<Ie.length;r++){let o=Ie[r],g=document.createElement("div");g.className="terminal-line",g.innerHTML=`
            <span class="line-time">${o.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${j(o.msg)}</span>
        `,n.appendChild(g)}n.scrollTop=n.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{ce="ACTIVE",Ie=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],X={title:"Refactoring System Event Bus",progress:10},Ae();let t=0,e=setInterval(()=>{if(ce!=="ACTIVE"){clearInterval(e);return}t++,X.progress=Math.min(100,X.progress+Math.floor(Math.random()*15));let a=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<a.length&&Ie.push({time:new Date().toLocaleTimeString(),msg:a[t]}),X.progress>=100&&(ce="COMPLETED",Fe={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),Ae()},1500)});window.addEventListener("dex-mock-stop",()=>{ce="STANDBY",Ae()});window.addEventListener("dex-mock-reset",()=>{ce="STANDBY",Ae()});var zt=()=>`
...
`,Nt=()=>`
    ...
    `,He=[],_e={"313071000877137920":"Owen",dexter:"Dexter"},se=[],he=null;async function De(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),a=document.getElementById("create-chore-form"),n=document.getElementById("save-chore-btn"),i=document.getElementById("cancel-chore-btn"),r=document.getElementById("new-chore-owner"),o=document.getElementById("selected-recipients"),g=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),h=document.getElementById("new-chore-url"),T=document.getElementById("new-chore-schedule"),m=document.getElementById("new-chore-time"),v=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(v&&!v.dataset.initialValueAttached){let l=Intl.DateTimeFormat().resolvedOptions().timeZone,w=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===l){w=!0;break}if(!w){let E=document.createElement("option");E.value=l,E.textContent=l.replace("_"," "),v.appendChild(E)}v.value=l,v.dataset.initialValueAttached="true"}T&&s&&!T.dataset.timeListenerAttached&&(T.addEventListener("change",()=>{s.style.display=T.value==="daily"?"block":"none"}),T.dataset.timeListenerAttached="true");let u=document.getElementById("form-title"),C=document.getElementById("form-icon");function I(){if(o){if(se.length===0){o.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}o.innerHTML=se.sort((l,w)=>{let E=l.startsWith("channel:"),f=w.startsWith("channel:");return E&&!f?-1:!E&&f?1:0}).map(l=>{let w=_e[l]||l,E=l.startsWith("channel:");return`
      ...
      `}).join(""),o.querySelectorAll(".remove-recipient").forEach(l=>{l.onclick=()=>{let w=l.dataset.id;se=se.filter(E=>E!==w),I()}})}}function b(l){l&&!se.includes(l)&&(se.push(l),I()),r&&(r.value="")}function p(l=null){if(a){if(he=l?l.id:null,l){if(u&&(u.textContent="Update Research Task"),C&&(C.className="bx bx-edit-alt",C.style.color="#03dac6"),n&&(n.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=l.natural_instruction),h&&(h.value=l.execution_plan?.entry_url||""),T&&(T.value=l.schedule,s&&(s.style.display=l.schedule==="daily"?"block":"none")),m&&l.run_at&&(m.value=l.run_at),v&&l.timezone){let w=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===l.timezone){w=!0;break}if(!w){let E=document.createElement("option");E.value=l.timezone,E.textContent=l.timezone.replace("_"," "),v.appendChild(E)}v.value=l.timezone}se=l.recipients||(l.owner_id?[l.owner_id]:[]),I()}else u&&(u.textContent="Initialize Research Task"),C&&(C.className="bx bx-plus-circle",C.style.color="#bb86fc"),n&&(n.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),h&&(h.value=""),T&&(T.value="every_24h"),se=[],I();a.style.display="block",a.scrollIntoView({behavior:"smooth",block:"start"})}}let x=document.getElementById("contacts-group"),y=document.getElementById("channels-group");if(x&&!x.dataset.populated&&!P())try{fe("/contacts").then(async l=>{l.ok&&(((await l.json()).members||[]).forEach(f=>{if(_e[f.id]=f.nickname||f.username,f.id==="313071000877137920")return;let S=document.createElement("option");S.value=f.id;let B=f.nickname||f.username;S.textContent=`${B} (${f.username})`,x.appendChild(S)}),x.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(y&&!y.dataset.populated&&!P())try{fe("/channels").then(async l=>{l.ok&&((await l.json()).forEach(E=>{let f=`channel:${E.id}`;_e[f]=E.name;let S=document.createElement("option");S.value=f,S.textContent=`#${E.name} (${E.guild})`,y.appendChild(S)}),y.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}r&&!r.dataset.listenerAttached&&(r.onchange=()=>{b(r.value)},r.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onchange=()=>c(),g.dataset.listenerAttached="true");function c(){if(!t)return;let l=g?.value||"all",w=l==="all"?He:He.filter(f=>(f.recipients||(f.owner_id?[f.owner_id]:[])).includes(l));if(w.length===0){t.innerHTML=J("empty",l==="all"?"No active tasks.":"No tasks found for this owner.",P()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let E=w.map(f=>{let S=f.last_run===0?"Never":new Date(f.last_run*1e3).toLocaleString(),B=f.memory?f.memory.length:0,k=f.status==="active"?"#03dac6":"#666",W=(f.recipients||(f.owner_id?[f.owner_id]:[])).sort((U,G)=>{let H=U.startsWith("channel:"),$=G.startsWith("channel:");return H&&!$?-1:!H&&$?1:0}).map(U=>{let G=_e[U]||U.substring(0,8),H=U.startsWith("channel:");return`<span title="${G}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${U==="dexter"?"bx-terminal":H?"bx-hash":"bx-user"}'></i>${G}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=E,t.querySelectorAll(".edit-chore-btn").forEach(f=>{f.onclick=S=>{S.stopPropagation();let B=f.dataset.id,k=He.find(D=>D.id===B);k&&p(k)}}),t.querySelectorAll(".reset-chore-btn").forEach(f=>{f.onclick=async S=>{S.stopPropagation();let B=f.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(f.innerHTML="<i class='bx bx-loader-alt spin'></i>",await _(`/chores/${B}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),De())}}),t.querySelectorAll(".delete-chore-btn").forEach(f=>{f.onclick=async S=>{S.stopPropagation();let B=f.dataset.id;confirm("Delete this task?")&&(await _(`/chores/${B}`,{method:"DELETE"}),De())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{a&&(a.style.display==="none"||he!==null?p(null):a.style.display="none")},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{a&&(a.style.display="none")},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let l=document.getElementById("new-chore-instruction"),w=document.getElementById("new-chore-url"),E=document.getElementById("new-chore-schedule"),f=l?.value,S=E?.value||"every_24h",B=S==="daily"?m?.value:"",k=S==="daily"?v?.value:"";if(!f)return;if(se.length===0){alert("Please add at least one recipient.");return}let D=n.innerHTML;n.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let W=he?"PATCH":"POST",U=he?`/chores/${he}`:"/chores";await _(U,{method:W,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:f,entry_url:w?.value,schedule:S,run_at:B,timezone:k})}),a&&(a.style.display="none"),l&&(l.value=""),w&&(w.value=""),he=null,se=[],De()}catch(W){console.error(W),alert(he?"Failed to update research task":"Failed to create research task")}finally{n.innerHTML=D}},n.dataset.listenerAttached="true");try{let l=await _("/chores");if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);if(He=await l.json()||[],g){let E=g.value,f=new Set;He.forEach(S=>{S.owner_id&&f.add(S.owner_id),S.recipients&&S.recipients.forEach(B=>f.add(B))}),g.innerHTML='<option value="all">All Recipients</option>',f.forEach(S=>{let B=document.createElement("option");B.value=S;let k=S.startsWith("channel:"),D=_e[S]||`Recipient: ${S.substring(0,8)}`;B.textContent=(k&&!D.startsWith("#")?"#":"")+D,g.appendChild(B)}),g.value=E,g.selectedIndex===-1&&(g.value="all")}c()}catch(l){console.error("Failed to fetch chores",l)}}var Pt=()=>`
...
`;function qt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=_s,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),ie()||(document.body.style.overflow=""),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden";let a=n=>{e.innerHTML=`
    ...
    `;let i=e.querySelector(".close-profile-btn");i&&i.addEventListener("click",()=>{e.click()})};fe(`/profile/${t.id}`).then(async n=>{if(n.ok){let i=await n.json();Ds(e,t,i)}else console.log("Profile not found (404) or error."),a("Profile Data Unavailable")}).catch(n=>{console.error("Profile fetch error:",n),a("Connection Failed")})}function Ds(t,e,a){let n=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",i=()=>{let C=(a.attributes||a.facts||[]).map(c=>{let l=c.key||c.k,w=c.value||c.v;return`
            <div class="fact-chip">
                <span class="fact-key">${l}:</span>
                <span class="fact-val">${w}</span>
            </div>
        `}).join(""),I=a.cognitive_model||a,b=I.technical_level||I.techLevel||0,p=I.communication_style||I.commStyle||"Unknown",x=I.patience_level||I.patience||"Unknown",y=I.vibe||"Unknown";return`
        ...
        `},r=()=>{let C=a.dossier||{},I=C.identity||{},b=C.career||{},p=C.personal||{},x=C.social||[];return`
    ...
    `;t.innerHTML=h;let T=t.querySelector(".profile-card"),m=t.querySelector("#profile-expand-toggle"),v=t.querySelectorAll(".profile-tab-btn"),s=t.querySelectorAll(".tab-content"),u=t.querySelector(".close-profile-btn");u&&u.addEventListener("click",()=>{t.classList.remove("active"),ie()||(document.body.style.overflow=""),setTimeout(()=>t.remove(),300)}),v.forEach(C=>{C.addEventListener("click",()=>{v.forEach(p=>p.classList.remove("active")),s.forEach(p=>p.classList.remove("active")),C.classList.add("active");let I=C.dataset.tab,b=t.querySelector(`#tab-${I}`);b&&b.classList.add("active")})}),m&&m.addEventListener("click",()=>{T.classList.toggle("expanded");let C=T.classList.contains("expanded");m.innerHTML=C?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var Ut=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
...
`,zs=null;async function st(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await st(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=a=>{let i=a.target.closest(".user-profile-card");if(i&&i.dataset.user)try{let r=JSON.parse(i.dataset.user);qt(r)}catch(r){console.error("Failed to parse user data",r)}},t.dataset.listenerAttached="true");try{let a=await fe("/contacts");if(!a.ok)throw new Error("Service unreachable");let i=(await a.json()).members||[];if(zs=Date.now(),i.length===0){t.innerHTML=J("empty","No contacts found.","Check your Discord connection.");return}let r={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};i.sort((o,g)=>{let d=r[o.level]??10,h=r[g.level]??10;return d!==h?d-h:o.username.localeCompare(g.username)}),t.innerHTML=i.map(o=>{let g=o.color&&o.color!==0,d=g?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",h=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",T="#888";o.level==="Me"||o.level==="Master"?T="#bb86fc":o.level==="Admin"?T="#cf6679":o.level==="Moderator"?T="#03dac6":o.level==="Contributor"&&(T="#ffa500");let m=o.level==="Me",v=m?"rgba(187, 134, 252, 0.08)":g?`${d}11`:"rgba(255,255,255,0.03)",s=m?"2px solid #bb86fc":g?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div style="position: relative;">
                        <img src="${o.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${m?"2px solid #bb86fc":g?`2px solid ${d}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${g?d:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${o.nickname||o.username}</h3>
...
`,Je=null,we=new Set,ze=[],Z="all",Ps={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Rs={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,a]of Object.entries(Ps))if(a.includes(t))return e;return"system"}function js(t){return Rs[t]||"bx-square-rounded"}async function me(t=!1){let e=document.getElementById("events-timeline");if(!e)return;qs();let n=`/events?ml=${Z==="all"?100:250}&format=json&exclude_types=system.process.registered,system.process.unregistered`;Z!=="all"&&(n+=`&category=${Z}`);try{let i=await _(n);if(!i.ok)throw new Error("Service unreachable");if(ze=((await i.json()).events||[]).filter(v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Je=Date.now(),te(1,Je),ze.length===0){e.innerHTML=J("empty","No events found for this filter.");return}t&&(e.innerHTML="");let g=v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,C=Os(u),I=js(u),b=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.bot.voice_response"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),p="event-border-grey";b&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?p="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"||u==="engagement.decision"?p="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?p="event-border-orange":u==="system.test.completed"?p=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let x=b?"cursor-pointer":"",y=we.has(v.id),c=y?"expanded":"",l=y?"display: block;":"display: none;",w=new Date(v.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),f=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Ft(u,s),B=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",k="";if(b){let H="";if(u==="engagement.decision"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;H=`
                    ...
                    `}else if(u==="system.attention.expired"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,M=s.timestamp-s.last_active,A=Math.floor(M/60);H=`
            ...
            `}let A="";s.eval_count&&(A=`
                        ...
                        `}
                    `}else if(u==="messaging.bot.voice_response"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,M="",A=[],O=s.raw_input||"";if(O.startsWith("[{")&&O.endsWith("}]")){let R=O.match(/{.*?}/g);R&&(A=R.map(V=>{let L=V.substring(1,V.length-1),z=L.indexOf(" "),N=L.substring(0,z),q=L.substring(z+1);return q=q.replace(/\[\]$/,"").trim(),{role:N,content:q}}))}if(A.length>0&&s.response_raw&&A.push({role:"assistant",content:s.response_raw}),A.length>0){let R=A.length,V=A.map((L,z)=>{let N=L.role.toUpperCase();N==="ASSISTANT"&&(N="DEXTER");let q=L.role==="user"?"#03dac6":L.role==="system"?"#ffb74d":"#bb86fc",Y=z===R-1?"block":"none";return`
                                <div class="history-slide" data-index="${z}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${q}; letter-spacing: 1px; font-weight: bold;">${N}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${z+1} of ${R}</span>
                    ...
                    `}else if(u==="system.analysis.audit"){let $=s.success?"#03dac6":"#ff4d4d",M=s.success?"SUCCESS":"FAILED",A=z=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${z}</h5>`,O="";s.error&&(O=`
                            <div class="event-detail-block">
                                ${A("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${j(s.error)}</pre>
                            </div>
                        `);let R="";if(s.chat_history&&s.chat_history.length>0){let z=s.chat_history.length,N=s.chat_history.map((q,Y)=>{let K=q.name?q.name.toUpperCase():q.role.toUpperCase();!q.name&&K==="USER"&&(K="SYSTEM"),!q.name&&K==="ASSISTANT"&&(K="AGENT");let Ee=q.role==="user"?"#03dac6":q.role==="system"?"#ffb74d":"#bb86fc";return`
                ...
                `}let D=document.createElement("div");D.className=`event-item ${p} ${x} ${c}`,D.dataset.eventId=v.id,D.onclick=function(H){if(!b)return;let $=this;if($.classList.contains("expanded")){$.classList.remove("expanded"),we.delete(v.id);let A=$.querySelector(".event-details");A&&(A.style.display="none")}else{$.classList.add("expanded"),we.add(v.id);let A=$.querySelector(".event-details");A&&(A.style.display="block")}},D.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${E}</span>
                    <span class="event-date">${f}</span>
                </div>
            ...
            `;let W=D.querySelector(".event-details");if(W&&W.addEventListener("click",H=>{H.stopPropagation()}),b){let H=D.querySelector(".close-details-btn");H&&H.addEventListener("click",$=>{$.stopPropagation();let M=$.target.closest(".event-item");if(M){M.classList.remove("expanded"),we.delete(v.id);let A=M.querySelector(".event-details");A&&(A.style.display="none")}})}let U=D.querySelector(".prev-btn"),G=D.querySelector(".next-btn");if(U&&G){let H=0,$=Array.from(D.querySelectorAll(".history-slide")),M=$.length,A=()=>{$.forEach((O,R)=>{O.style.display=R===H?"block":"none"}),U.disabled=H===0,G.disabled=H===M-1,U.style.opacity=H===0?"0.5":"1",G.style.opacity=H===M-1?"0.5":"1"};U.addEventListener("click",O=>{O.stopPropagation(),H>0&&(H--,A())}),G.addEventListener("click",O=>{O.stopPropagation(),H<M-1&&(H++,A())}),A()}return D},d=Array.from(e.children),h=new Map(d.map(v=>[v.dataset.eventId,v])),T=new Set(ze.map(v=>v.id));d.forEach(v=>{let s=v.dataset.eventId;(!s||!T.has(s))&&v.remove()});let m=null;ze.forEach((v,s)=>{let u=h.get(v.id);(!u||t)&&(u&&u.remove(),u=g(v),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):m&&m.nextElementSibling!==u&&m.after(u),m=u)}),Je=Date.now(),te(1,Je)}catch(i){console.error("Error fetching events:",i),e.children.length===0&&(e.innerHTML=J("offline","Failed to load events.","The event service may be offline."))}}function qs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),a=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ze.forEach(i=>we.add(i.id)),me(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{we.clear(),me(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{a.querySelectorAll(".filter-btn").forEach(r=>r.classList.remove("active")),i.classList.add("active"),Z=i.dataset.filter||"all",me(!0)}}),a.dataset.listenerAttached="true"),a&&a.querySelectorAll(".filter-btn").forEach(i=>{i.dataset.filter===Z?i.classList.add("active"):i.classList.remove("active")});let n=document.getElementById("events-clear");n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let i=Z==="all"?"ALL":Z.toUpperCase();if(confirm(`Are you sure you want to delete ${i} events from the backend? This cannot be undone.`)){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let r="/events";if(Z!=="all"?r+=`?category=${Z}`:r+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(r,{method:"DELETE"})).ok)throw new Error("Failed to delete events");we.clear(),me(!0)}catch(r){console.error("Failed to clear events:",r),alert("Failed to clear events. Check console.")}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var Us=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Jt=Us;function Wt(){return`
    ...
    `}var Fs=null;async function Ne(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let a=await e.json();if(!a||a.length===0)return t.innerHTML=J("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let n=["local-ollama-0","local-cache-0"],i=a.filter(o=>!n.includes(o.id));i.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),i.reverse();let r=i.map(o=>{let g=o.logs.join(`
`),d=[...o.logs];if(d.length<25){let T=25-d.length;for(let m=0;m<T;m++)d.push("")}else d.length>25&&(d=d.slice(-25));let h=d.map(T=>je(T)).join(`
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Wt()}
        </div>`;async function ss(){Js(),await Promise.all([ne(),Ce(),at()]),await Ne()}var We=null;function Js(){We||(We=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(We),We=null;return}ne(!0)},1e3))}var Gt=null,Vt=null;async function ns(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function Kt(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function Ws(){try{return await(await _("/processes")).json()}catch{return null}}async function Gs(){try{return await(await _("/agent/status")).json()}catch{return null}}async function Ce(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),a=document.getElementById("global-restart-btn"),n=document.getElementById("global-stop-btn"),i=document.getElementById("global-start-btn"),r=(c,l)=>{c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{let w=c.innerHTML;c.innerHTML="<i class='bx bx-loader-alt spin'></i>",c.disabled=!0;try{await _(`/system/service/${l}`,{method:"POST",body:JSON.stringify({service:"all"})}),setTimeout(()=>Ce(),2e3),setTimeout(()=>Ce(),5e3),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML=w,c.disabled=!1},1e3)},1e3)}catch(E){console.error(E),c.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{c.innerHTML=w,c.disabled=!1},2e3)}},c.dataset.listenerAttached="true")};r(a,"restart"),r(n,"stop"),r(i,"start");let o=document.querySelector("#hw-os .hw-content"),g=document.querySelector("#hw-cpu .hw-content"),d=document.querySelector("#hw-ram .hw-content"),h=document.querySelector("#hw-gpu .hw-content"),T=document.querySelector("#hw-storage .hw-content"),m=c=>{if(c){if(o&&(o.innerHTML=`
                ...
                </div>`}if(g&&c.CPU&&c.CPU.length>0){let l=c.CPU[0];g.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="padding: 15px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                        ...
                        <div style="background: rgba(255,255,255,0.05); height: 6px; border-radius: 3px; overflow: hidden;">
                             <div style="background: ${Number(f)>90?"#cf6679":"#03dac6"}; width: ${f}%; height: 100%; box-shadow: 0 0 10px ${Number(f)>90?"#cf667944":"#03dac644"};"></div>
                        </div>
                    </div>`}).join(""):T&&(T.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let c=await Kt();c?(m(c),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),g&&!g.hasChildNodes())){let c=await Kt();m(c)}if(!t)return;t.dataset.controlsAttached||(t.addEventListener("click",async c=>{let l=c.target.closest(".svc-btn");if(!l)return;let w=l,E=w.dataset.action,f=w.dataset.service;if(!E||!f)return;let S=w.innerHTML;w.innerHTML="<i class='bx bx-loader-alt spin'></i>",w.classList.add("loading"),w.disabled=!0;try{await _(`/system/service/${E}`,{method:"POST",body:JSON.stringify({service:f})}),setTimeout(()=>Ce(),1e3),setTimeout(()=>Ce(),3e3)}catch(B){console.error(B),alert(`Failed to ${E} ${f}`),w.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{w.innerHTML=S,w.classList.remove("loading"),w.disabled=!1},2e3)}}),t.dataset.controlsAttached="true");let v=await ns();if(!v||!v.services){t.children.length===0&&(t.innerHTML=J("offline","Failed to load system metrics.","The event service may be offline."));let c=document.querySelector('[data-service-id="upstash-redis-ro"]');if(c){c.className="service-widget service-widget-offline",c.querySelector(".service-widget-status").textContent="ERROR";let l=c.querySelector(".service-widget-body");l&&(l.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Gt=P()&&re.lastDashboard||Date.now(),te(0,Gt||0);let s=v.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let c=document.getElementById("upstash-countdown");if(c){let E=59-new Date().getSeconds();E<=0&&(E+=60),c.textContent=`${E}s`}},1e3)),Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function u(c){if(!c||c==="N/A"||c==="unknown")return"-";let l=c.match(/^(\d+\.\d+\.\d+)/);return l?l[0]:c.split(".").slice(0,3).join(".")||"-"}function C(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function I(c){if(!c||c==="N/A"||c==="unknown")return"-";let l=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!l)return"-";let w=parseInt(l[1])||0,E=parseInt(l[2])||0,f=parseInt(l[3])||0,S=parseFloat(l[4])||0,B=w*86400+E*3600+f*60+S,k=Math.floor(B/86400);if(k>0)return`${k}d`;let D=Math.floor(B/3600);if(D>0)return`${D}h`;let W=Math.floor(B/60);return W>0?`${W}m`:`${Math.floor(B)}s`}function b(c){if(c.id==="upstash-redis-ro"){let R=P()&&(re.lastFrontend||re.lastDashboard)||Date.now();return`
            ...
            </div>`}let l=c.status==="online",w=l?"service-widget-online":"service-widget-offline",E=l?"bx-check-circle":"bx-x-circle",f=l?"OK":"BAD",S=c.version?u(c.version.str):"-",B=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",k=c.memory&&c.memory!=="N/A"?c.memory:"-",D=B!=="-"?"#00ff00":"#666",W=B!=="-"?"#fff":"#666",U=k!=="-"?"#00ff00":"#666",G=k!=="-"?"#fff":"#666",H=I(c.uptime),$="",M=c.type!=="os"&&c.type!=="cli"&&c.type!=="prd",A="";M&&!P()&&(A=`
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                ...
                </div>${A}`:$=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${A}`;let O=P()?"easter.company":C(c.domain&&c.port?`${c.domain}:${c.port}`:"");return`<div class="service-widget ${w}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${E}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${$}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),x=new Set(s.map(c=>c.id));for(let[c,l]of p)x.has(c)||l.remove();let y=new Set;s.forEach(c=>{if(y.has(c.id))return;y.add(c.id);let l=b(c),w=p.get(c.id);if(w&&w.parentNode)if(c.id==="upstash-redis-ro"){let E=P()&&(re.lastFrontend||re.lastDashboard)||Date.now(),f=new Date(E).toLocaleTimeString(),S=w.querySelector(".sync-time-label");S&&(S.textContent=`Last synced: ${f}`)}else w.outerHTML!==l&&(w.outerHTML=l);else t.insertAdjacentHTML("beforeend",l)})}async function at(){let t=document.getElementById("models-widgets");if(!t)return;let e=await ns();if(!e){t.children.length===0&&(t.innerHTML=J("offline","Failed to load model status.","The event service may be offline."));return}Vt=Date.now(),te(2,Vt);let a=e.models||[],n=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function i(d){let h=d.status==="Ready";return`
                ...
                </div>`}function o(d){let h=d.status==="Downloaded",T=h?"service-widget-online":"service-widget-offline",m=h?"OK":"MISSING",v=h&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${T}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${h?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let g="";if(n&&(g+=i(n)),e.xtts&&(g+=r(e.xtts)),g+=a.map(o).join(""),!g){t.innerHTML=J("empty","No models found.");return}t.innerHTML!==g&&(t.innerHTML=g)}async function ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let a=document.getElementById("guardian-sentry-val"),n=document.getElementById("guardian-idle-val"),i=document.getElementById("guardian-total-idle"),r=document.getElementById("guardian-total-active"),o=document.getElementById("guardian-total-waste"),g=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn"),h=document.getElementById("fabricator-reset-btn"),T=document.getElementById("courier-reset-btn"),m=document.getElementById("system-pause-toggle-btn");m&&!m.dataset.listenerAttached&&(m.onclick=async()=>{let c=m.querySelector(".bx-play")?"/agent/resume":"/agent/pause";m.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _(c,{method:"POST"}),await ne()}catch{m.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>ne(),2e3)}},m.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onclick=async()=>{g.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=all",{method:"POST"}),setTimeout(()=>{g.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{g.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{g.innerHTML="<i class='bx bx-error'></i>"}},g.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true"),h&&!h.dataset.listenerAttached&&(h.onclick=async()=>{h.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{h.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{h.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{h.innerHTML="<i class='bx bx-error'></i>"}},h.dataset.listenerAttached="true"),T&&!T.dataset.listenerAttached&&(T.onclick=async()=>{T.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{T.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{T.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{T.innerHTML="<i class='bx bx-error'></i>"}},T.dataset.listenerAttached="true");let v=document.getElementById("imaginator-reset-btn");v&&!v.dataset.listenerAttached&&(v.onclick=async()=>{v.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=alert_review",{method:"POST"}),setTimeout(()=>{v.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{v.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{v.innerHTML="<i class='bx bx-error'></i>"}},v.dataset.listenerAttached="true");let s=await Gs();if(s&&s.agents){let y=s.agents.guardian||{protocols:{}},c=s.agents.analyzer||{protocols:{}},l=s.agents.imaginator||{protocols:{}},w=s.agents.fabricator||{protocols:{}},E=s.agents.courier||{protocols:{}},f=s.system||{},S=Math.floor(Date.now()/1e3),B={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},k=L=>{L<0&&(L=0);let z=Math.floor(L/3600),N=Math.floor(L%3600/60),q=L%60;return z>0?`${z}h ${N}m`:N>0?`${N}m ${q}s`:`${q}s`},D=(L,z,N,q)=>{if(!L)return;let Y=B[q]||q.toUpperCase(),K=L.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(K&&(K.textContent=Y),!N){L.textContent="Inactive",L.style.color="#666";return}let Ee=N.status;if(Ee==="Working")L.textContent="Working",L.style.color="#bb86fc";else if(Ee==="Ready")L.textContent="Ready",L.style.color="#5eff5e";else{let Te=N.cooldown;if(P()&&(Te=N.next_run-S),Te<=0)L.textContent="Ready",L.style.color="#5eff5e";else{let Ve=Math.floor(Te/60),Ke=Te%60;L.textContent=`${Ve}m ${Ke}s`,L.style.color="#fff"}}z&&N.stats&&(z.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
          ...
          `)};a&&D(a,document.getElementById("guardian-sentry-stats"),y.protocols.sentry,"sentry");let W=document.getElementById("analyzer-synthesis-val"),U=document.getElementById("analyzer-synthesis-stats");W&&D(W,U,c.protocols.synthesis,"synthesis");let G=document.getElementById("imaginator-alert_review-val"),H=document.getElementById("imaginator-alert_review-stats");G&&D(G,H,l.protocols.alert_review,"alert_review");let $=document.getElementById("fabricator-construction-val"),M=document.getElementById("fabricator-construction-stats");$&&D($,M,w.protocols.construction,"construction");let A=document.getElementById("courier-researcher-val"),O=document.getElementById("courier-researcher-stats");A&&D(A,O,E.protocols.researcher,"researcher");let R=document.getElementById("system-state-label"),V=document.getElementById("system-state-val");if(V&&f.state){let L=f.state,z=k(f.state_time||0);R&&(R.textContent=`State: ${L.toUpperCase()}`),V.textContent=z,L==="idle"?V.style.color=f.state_time>300?"#5eff5e":"#fff":V.style.color="#bb86fc",m&&(L==="paused"?(m.innerHTML="<i class='bx bx-play'></i>",m.title="Resume System",m.style.color="#ff9800"):(m.innerHTML="<i class='bx bx-pause'></i>",m.title="Pause System",m.style.color=""))}i&&(i.textContent=k(f.metrics?.total_idle_time||0)),r&&(r.textContent=k(f.metrics?.total_active_time||0)),o&&(o.textContent=k(f.metrics?.total_waste_time||0))}else[a,n,i,r,o].forEach(c=>{c&&(c.textContent="-",c.style.color="#666")});if(t)return;let u=await Ws(),C=[],I=[],b=[];u&&(Array.isArray(u)?C=u:(C=u.active||[],I=u.queue||[],b=u.history||[],b.sort((y,c)=>(c.end_time||0)-(y.end_time||0)))),e&&(C.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=J("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),it(e,C,!1)));let p=document.getElementById("processes-queue-widgets");p&&(I.length===0?!p.querySelector(".tab-placeholder")&&!p.querySelector('div[style*="font-style: italic"]')&&(p.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(p.innerHTML="",it(p,I,!1)));let x=document.getElementById("processes-history-widgets");x&&(b.length===0?x.querySelector(".tab-placeholder")||(x.innerHTML=J("empty","No recent history.")):(x.querySelector(".tab-placeholder")&&(x.innerHTML=""),it(x,b,!0))),Oe(1,C.length)}function it(t,e,a){function n(d){let h="";d.end_time?h=`${d.end_time-d.start_time}s`:h=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let T=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",m=d.channel_id,v={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent","voice-mode":"Voice Interaction"};if(v[m]?m=v[m]:/^\d+$/.test(m)&&(m=`Channel ${m}`),a)return`
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let i=a?".process-history-item":".process-widget",r=new Map(Array.from(t.querySelectorAll(i)).map(d=>[d.dataset.channelId,d])),o=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,h]of r)d&&!o.has(d)&&h.remove();let g=new Set;e.forEach(d=>{let h=`${d.channel_id}-${d.start_time}`;if(g.has(h))return;g.add(h);let T=n(d),m=r.get(h);if(m&&m.parentNode){m.outerHTML!==T&&(m.outerHTML=T);let v=t.querySelector(`[data-channel-id="${h}"]`);v&&t.appendChild(v)}else t.insertAdjacentHTML("beforeend",T)})}function Ge(){let t=Ye(),e="Notification"in window,a={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function ot(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(n=>{n.addEventListener("click",function(){let i=this.dataset.theme;i&&(gt(i),t.setContent(Ge()),ot(t))})});let a=document.getElementById("notifications-toggle");a&&"Notification"in window?a.onclick=async n=>{let i=n.target;if(i.checked)try{await Notification.requestPermission()!=="granted"&&(i.checked=!1)}catch{i.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),i.checked=!0)}:a&&(a.disabled=!0),Vs()}async function Vs(){let t=document.getElementById("service-config-list"),e=document.getElementById("ollama-config-list");if(!t||!e)return;let a=P();try{let i=await(await _("/system/options")).json(),r=i.services||i||{},o=i.ollama||i||{},g="",d=(C,I,b)=>`
        <div class="settings-item">
            <div class="settings-item-info">
            ...
            <label class="toggle-switch">
                <input type="checkbox" class="service-device-toggle" data-service="${I}" ${b==="cuda"?"checked":""} ${a?"disabled":""}>
                <span class="toggle-slider"></span>
            </label>
        </div>`;r.stt&&(g+=d("STT Service","stt",r.stt.device||"cpu")),r.tts&&(g+=d("TTS Service","tts",r.tts.device||"cpu")),g?a&&(g+='<div style="font-size: 0.7em; color: #666; font-style: italic; margin-top: 15px; text-align: center;">* Service configuration is read-only in public mode.</div>'):g='<div style="padding: 20px; text-align: center; color: #666;">No configurable services found.</div>',t.innerHTML=g;let h="",T=o.utility_device||"cpu",m=o.utility_speed||"smart",v=a?"disabled":"";if(h+=`
        <div class="settings-item">
            <div class="settings-item-info">
        ...
        </div>`,a?h+='<div style="font-size: 0.7em; color: #666; font-style: italic; margin-top: 15px; text-align: center;">* Optimization is read-only in public mode.</div>':h+=`<div style="font-size: 0.7em; color: #ffa500; font-style: italic; margin-top: 10px; text-align: center;"><i class='bx bx-info-circle'></i> Changing these settings requires a 'dex restart' to re-apply.</div>`,e.innerHTML=h,a)return;t.querySelectorAll(".service-device-toggle").forEach(C=>{C.addEventListener("change",async I=>{let b=I.target,p=b.dataset.service,x=b.checked?"cuda":"cpu";b.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:p,key:"device",value:x})})}catch{b.checked=!b.checked,alert("Failed to update configuration.")}finally{b.disabled=!1}})});let s=document.getElementById("ollama-utility-device-select");s&&s.addEventListener("change",async C=>{let I=C.target,b=I.value;I.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:"ollama",key:"utility_device",value:b})})}catch{alert("Failed to update utility hardware setting.")}finally{I.disabled=!1}});let u=document.getElementById("ollama-utility-speed-select");u&&u.addEventListener("change",async C=>{let I=C.target,b=I.value;I.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:"ollama",key:"utility_speed",value:b})})}catch{alert("Failed to update utility intelligence setting.")}finally{I.disabled=!1}})}catch{t.innerHTML='<div style="padding: 20px; text-align: center; color: #cf6679;">Failed to load configuration.</div>',e.innerHTML='<div style="padding: 20px; text-align: center; color: #cf6679;">Failed to load optimization settings.</div>'}}var as=()=>`
    ...
    `;async function os(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await is(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await is(t)}async function is(t){try{let e=await _("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let a=await e.json();if(!a||a.length===0){t.innerHTML=J("empty","No web history found.");return}let n=`
        ...
        `;a.forEach((g,d)=>{let h=new Date(g.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),T=g.screenshot?`<img src="data:image/png;base64,${g.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';n+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ks=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,n]of Object.entries(t)){let i=cs.filter(r=>r.category===a);i.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>rs());let h=document.getElementById("terminal-action-btn");h&&(h.onclick=()=>rs())}let a=document.getElementById("cli-terminal-body"),n=document.getElementById("cli-docs-pane");a&&(a.innerHTML="");let i=t.docs||{overview:t.description,details:[],extended_usage:t.usage};n&&(n.innerHTML=`
    ...
    `);let r=document.getElementById("terminal-cmd-name");r&&(r.textContent=`dex ${t.id}`);let o=document.getElementById("terminal-status-badge");o&&(o.className="terminal-status status-running",o.textContent="Running");let g=document.getElementById("terminal-action-btn");return g&&(g.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",rt=!0,a}function rs(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),ie()||(document.body.style.overflow=""),rt=!1}function ls(t,e,a="output"){if(!rt||!t)return;let n=document.createElement("div");if(n.className=`terminal-line terminal-${a}`,a==="prompt")n.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let i=je(e);n.innerHTML=i||e}t.appendChild(n),t.scrollTop=t.scrollHeight}async function Ys(t){let e=cs.find(o=>o.id===t);if(!e)return;let a=Zs(e);a&&ls(a,`dex ${t}`,"prompt");let n=e.demo_output||["Executing command...","\u2713 Done."];for(let o of n){await new Promise(d=>setTimeout(d,400+Math.random()*600));let g="output";o.includes("[ERROR]")?g="error":o.includes("[SUCCESS]")||o.includes("\u2713")?g="success":o.includes("!")&&(g="warning"),a&&ls(a,o,g)}let i=document.getElementById("terminal-status-badge");i&&(i.className="terminal-status status-success",i.textContent="Completed (Demo)");let r=document.getElementById("terminal-action-btn");r&&(r.style.display="block")}function ds(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ks();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code"),n=a?a.textContent:"";n&&navigator.clipboard.writeText(n).then(()=>{let i=e.querySelector("i");i&&(i.className="bx bx-check",i.style.color="#5eff5e",setTimeout(()=>{i.className="bx bx-copy",i.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(a=>{let n=a;a.addEventListener("mouseenter",()=>{n.style.transform="translateY(-5px)",n.style.borderColor="rgba(255,255,255,0.15)",n.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{n.style.transform="translateY(0)",n.style.borderColor="rgba(255,255,255,0.05)",n.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let i=n.dataset.cmd;i&&Ys(i)})})}async function Xs(){if(!P())try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ps(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}pt(),mt(),Xs(),vt(),dt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ds();let e=[],a=document.getElementById("windows-container");a&&a.setAttribute("data-count","0");let n=b=>{localStorage.setItem("dex_last_window",b)};function i(){for(;e.length>1;)e.shift().close(!0);let b=document.getElementById("windows-container"),p=document.querySelector("nav"),x=document.querySelector("footer"),y=window.location.pathname==="/"||window.location.pathname==="/index.html",c=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");b&&b.setAttribute("data-count",e.length.toString()),e.forEach(k=>{let D=document.getElementById(k.id);D&&D.classList.remove("hide-close")});let l=document.getElementById("dexter-menu-container"),w=document.getElementById("nav-window-switcher"),E=document.getElementById("settings-icon"),f=document.getElementById("docs-icon"),S=document.getElementById("close-all-windows"),B=window.innerWidth<880;if(!B){let k=document.getElementById("dexter-dropdown"),D=document.getElementById("dexter-menu-btn");k&&k.classList.remove("active"),D&&D.classList.remove("active"),b&&b.classList.remove("menu-open")}if($e(e.length>0),e.length>0)if(x?.classList.add("hide"),S&&(S.style.display=B?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",p?.classList.add("window-open"),b&&(b.style.paddingTop="60px"),l&&(l.style.display=B?"flex":"none"),f&&(f.style.display=B?"block":"none"),E&&(E.style.display=B?"block":"none"),!B&&w){let k=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(k)?(w.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{n("alerts-window"),r(g)}),document.getElementById("switch-events")?.addEventListener("click",()=>{n("events-window"),r(d)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{n("monitor-window"),r(T)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{n("contacts-window"),r(h)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{n("workspace-window"),r(m)})):w.innerHTML=""}else w&&(w.innerHTML="");else p?.classList.remove("window-open"),S&&(S.style.display="none"),b&&(b.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),ie()||(document.body.style.overflow=""),y||c?x?.classList.remove("hide"):x?.classList.add("hide"),l&&(l.style.display="flex"),f&&(f.style.display="block"),E&&(E.style.display="block"),w&&(w.innerHTML="");Le()}function r(b){if(b.isOpen()){b.close();return}for(;e.length>0;)e.pop().close(!0);e.push(b),b.open(),i()}function o(){[...e].forEach(p=>p.close()),e=[]}window.addEventListener("resize",i);let g=ue({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Tt(),onOpen:()=>pe(),onClose:()=>{let b=e.indexOf(g);b>-1&&e.splice(b,1),i()}}),d=ue({id:"events-window",title:"Events",icon:"bx-calendar-event",content:nt(),onOpen:()=>{d.setContent(nt()),me()},onClose:()=>{let b=e.indexOf(d);b>-1&&e.splice(b,1),i()}}),h=ue({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ut(),onOpen:()=>st(),onClose:()=>{let b=e.indexOf(h);b>-1&&e.splice(b,1),i()}}),T=ue({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Xt()},{icon:"bxs-component",title:"Processes",content:Yt()},{icon:"bxs-brain",title:"Models",content:Qt()},{icon:"bx-globe",title:"Web",content:as()},{icon:"bxs-hdd",title:"Hardware",content:es()},{icon:"bxs-terminal",title:"Logs",content:ts()},{icon:"bxs-zap",title:"Agents",content:Zt()}].filter(b=>P()?b.title!=="Hardware"&&b.title!=="Logs":!0),onOpen:()=>{Ce(),ne(),at(),os(),Ne()},onClose:()=>{let b=e.indexOf(T);b>-1&&e.splice(b,1),i()}}),m=ue({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Pt()},{icon:"bx-map-alt",title:"Roadmap",content:Rt()},{icon:"bx-paint",title:"Blueprints",content:Ot()},{icon:"bx-task",title:"Tasks",content:jt()}],onOpen:()=>tt(),onClose:()=>{let b=e.indexOf(m);b>-1&&e.splice(b,1),i()}}),v=ue({id:"settings-window",title:"Settings",icon:"bx-cog",content:Ge(),onOpen:()=>{v.setContent(Ge()),ot(v)},onClose:()=>{let b=e.indexOf(v);b>-1&&e.splice(b,1),i()}});window.dexter={viewEvent:b=>{d.isOpen()||r(d),setTimeout(()=>{let p=document.querySelector(`.event-item[data-event-id="${b}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)},viewAlert:b=>{g.isOpen()||r(g),setTimeout(()=>{let p=document.querySelector(`.event-item[data-alert-id="${b}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)}};let s=()=>{let b=document.getElementById("dexter-dropdown"),p=document.getElementById("dexter-menu-btn");b&&p&&(b.classList.remove("active"),p.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let b=document.getElementById("dexter-menu-btn"),p=document.getElementById("settings-icon"),x=document.getElementById("docs-icon"),y=document.getElementById("close-all-windows"),c=document.getElementById("nav-left-container"),l=document.getElementById("dexter-dropdown"),w=document.getElementById("windows-container");b&&l&&(b.onclick=f=>{f.stopPropagation();let S=window.innerWidth<880;if(S)l.style.top="",l.style.left="",l.style.right="",l.style.transform="";else{let k=b.getBoundingClientRect(),W=document.querySelector("nav").getBoundingClientRect(),U=220,G=10,$=k.left+k.width/2-U/2,M=W.right-10;$+U>M&&($=M-U),$<10&&($=10),l.style.top=W.bottom+G+"px",l.style.left=$+"px",l.style.right="auto",l.style.transform="none"}l.classList.toggle("active"),b.classList.toggle("active");let B=l.classList.contains("active");if(S){let k=document.querySelector("nav");B?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),k?.classList.add("window-open"),w?.classList.add("menu-open"),$e(!0)):(w?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),k?.classList.remove("window-open"),ie()||$e(!1)))}}),p&&(p.onclick=f=>{f.stopPropagation(),r(v)}),x&&(x.onclick=f=>{f.stopPropagation(),window.location.href="/docs"}),y&&(y.onclick=f=>{f.stopPropagation(),o()});let E=(f,S,B)=>{let k=document.getElementById(f);k&&(k.onclick=D=>{D.stopPropagation(),s(),B&&n(B),r(S)})};E("alerts-menu-item",g,"alerts-window"),E("events-menu-item",d,"events-window"),E("monitor-menu-item",T,"monitor-window"),E("contacts-menu-item",h,"contacts-window"),E("workspace-menu-item",m,"workspace-window"),c&&(c.onclick=f=>{if(f.stopPropagation(),l&&l.classList.contains("active")){s(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),ie()||$e(!1));return}if(e.length>0)o();else{let S=window.location.pathname;if(!(S==="/"||S==="/index.html")){let k=S.endsWith("/")&&S.length>1?S.slice(0,-1):S;if(k.includes("/docs/page/")){window.location.href="/";return}let D=k.split("/");D.pop();let W=D.join("/")||"/";window.location.href=W}}}),document.addEventListener("click",()=>{let f=window.innerWidth<880;l&&l.classList.contains("active")&&(s(),f&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),ie()||$e(!1)))}),l&&(l.onclick=f=>f.stopPropagation())})();let C=window.location.pathname==="/"||window.location.pathname==="/index.html",I=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!C&&!I&&document.querySelector("footer")?.classList.add("hide"),P()||setInterval(()=>{d.isOpen()&&me(),g.isOpen()?pe():et()},1e3),setInterval(()=>{P()&&(g.isOpen()?pe():et()),m.isOpen()?tt():Bt(),P()&&d.isOpen()&&me(),T.isOpen()&&ss()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ps):ps();})();
