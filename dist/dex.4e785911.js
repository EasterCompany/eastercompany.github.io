(()=>{function et(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function tt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var it=1e3;function oe(t){let e=null,i=t.onClose||null,s=t.onOpen||null;function n(){e&&(e.style.zIndex=++it)}function c(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",r),s&&setTimeout(s,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++it,e.addEventListener("mousedown",n);let g=t.icon||"bx-window",a="",b="",E;t.tabs&&t.tabs.length>0?(a=`<div class="tab-bar">${t.tabs.map((o,d)=>{let m=o.icon?`<i class="bx ${o.icon}"></i>`:`<span class="tab-glyph">${o.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,E=`<div class="window-content">${t.tabs.map((o,d)=>`<div class="tab-content ${d===0?"active":""}" data-tab-content="${d}">${o.content}</div>`).join("")}</div>`):(t.title&&(b=`<div class="window-title">${t.title}</div>`),E=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${E}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",w=>{w.stopPropagation(),l()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(w=>{w.addEventListener("click",()=>{let u=w.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(o=>o.classList.remove("active")),w.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${u}"]`).classList.add("active"),x(w,e)})}),setTimeout(()=>{e.classList.add("open"),s&&s()},10)}function r(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&x(p,e)}function x(p,g){setTimeout(()=>{let a=g.querySelector(".tab-bar");if(!a)return;let b=Array.from(a.querySelectorAll(".tab")),E=b.indexOf(p),w=a.clientWidth,u=b[Math.max(0,E-2)],o=b[Math.min(b.length-1,E+2)],d=u.offsetLeft-a.offsetLeft-25,v=o.offsetLeft+o.offsetWidth-a.offsetLeft+25-d,M=v<=w?d-(w-v)/2:p.offsetLeft-a.offsetLeft-w/2+p.offsetWidth/2;a.scrollTo({left:M,behavior:"smooth"})},350)}function l(p=!1){e&&(window.removeEventListener("resize",r),p?(e.remove(),e=null):(e.classList.remove("open"),i&&i(),setTimeout(()=>{e?.remove(),e=null},400)))}function f(p){t.content=p;let g=e?.querySelector(".window-content");g&&(g.innerHTML=p)}function y(){return e&&e.classList.contains("open")}return{open:c,close:l,setContent:f,isOpen:y,focus:n,id:t.id}}var nt="easter_theme",Y={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Re(){return localStorage.getItem(nt)||Y.DARK}function at(t){if(!Object.values(Y).includes(t))throw new Error("Invalid theme");localStorage.setItem(nt,t),ot(t)}function ot(t){let e=document.documentElement,i=document.body;Object.values(Y).forEach(r=>{i.classList.remove(`theme-${r}`)}),i.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let n={[Y.DARK]:"#050507",[Y.LIGHT]:"#FFFFFF",[Y.LEGACY]:"#000000"},c=n[t]||n[Y.DARK];if(s.setAttribute("content",c),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}i.classList.add("is-animated")}function rt(){let t=Re();ot(t)}function H(t,e,i=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",c=i?`<p class="placeholder-action">${i}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${c}</div>`}function R(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function X(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!i)return;if(!e){i.textContent="Last updated: never";return}let s=Date.now(),n=Math.floor((s-e)/1e3),c;n<60?c=`${n}s ago`:n<3600?c=`${Math.floor(n/60)}m ago`:c=`${Math.floor(n/3600)}h ago`,i.textContent=`Last updated: ${c}`}var Yt=0;function $e(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!i)return;let s=i.querySelector(".notification-badge");s&&(e>0?(s.textContent=e>9?"9+":e,s.style.display="flex"):s.style.display="none")}var ee=0,te=0;function ct(t){ee=t,ye()}function dt(t){te=t,ye()}function ye(){let t=ee+te;Yt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let i=document.getElementById("alerts-menu-item");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",i.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let s=document.getElementById("workspace-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",n.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let c=document.getElementById("switch-workspace");if(c){let r=c.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",c.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}}function Le(){let t=document.getElementById("alerts-list");if(!t)return;ee=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ye()}function pt(){let t=document.getElementById("blueprints-list");if(!t)return;te=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ye()}function Xt(){return"https://event.easter.company"}function Qt(){return"https://discord.easter.company"}var es="http://127.0.0.1:8100",ts="http://127.0.0.1:8300",ss={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Me(t){let e=R(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,c)=>{let r=ss[c];return r?`<span class="${r}">`:""});let i=(e.match(/<span/g)||[]).length,s=(e.match(/<\/span/g)||[]).length;return i>s&&(e+="</span>".repeat(i-s)),e}function re(t){if(!t)return"";let e=R(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(i,s)=>{let n=s.split("|").map(c=>c.trim());return n.every(c=>c.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(c=>`<span class="md-table-cell">${c}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var is="https://sterling-javelin-12539.upstash.io",ns="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function D(){return window.location.hostname.includes("easter.company")}var P=null,se={lastDashboard:0,lastFrontend:0},Oe=!1,mt=0,ut="dex_dashboard_snapshot";function as(){let t=localStorage.getItem(ut);if(t)try{let e=JSON.parse(t);P=e,se.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{P=null}}async function lt(){if(!(!D()||Oe)){Oe=!0,mt=Math.floor(Date.now()/1e3);try{let t=await ls("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,se.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),se.lastFrontend=Date.now(),localStorage.setItem(ut,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Oe=!1}}}function os(){if(!P||!P.agent_status)return;let t=P.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function rs(){if(!D())return;as();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await lt(),setInterval(()=>{let i=new Date,s=Math.floor(Date.now()/1e3),n=P?s-P.timestamp:1/0,c=s-mt,r=i.getSeconds()===59,x=n>300,l=c>60;(r&&l||x&&l)&&lt(),os()},1e3)}D()&&rs();async function ls(t,...e){try{let s=await(await fetch(is,{method:"POST",headers:{Authorization:`Bearer ${ns}`},body:JSON.stringify([t,...e])})).json();if(s.error)throw new Error(s.error);return s.result}catch(i){return console.error("Upstash Error:",i),null}}var ve=null,xe=null,ke=!1,Te=!1;async function I(t,e={}){if(D()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),c=n.get("type")||n.get("event.type"),r=n.get("category"),x=n.get("order")||"desc",l=[];return c==="system.notification.generated"?l=[...P.alerts||[]]:c==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?l=[...P.blueprints||[]]:r==="messaging"?l=[...P.messaging_events||[]]:r==="system"?l=[...P.system_events||[]]:r==="cognitive"?l=[...P.cognitive_events||[]]:r==="moderation"?l=[...P.moderation_events||[]]:l=[...P.events||[]],x==="asc"?l.sort((f,y)=>f.timestamp-y.timestamp):l.sort((f,y)=>y.timestamp-f.timestamp),new Response(JSON.stringify({events:l,count:l.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],c=P.profiles?P.profiles[n]:null;return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(P.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ve)try{let n=await fetch(ve+t,e);if(n.ok)return n;ve=null}catch{ve=null}let i=Xt(),s=es;try{let n=await fetch(i+t,e);if(n.ok)return ve=i,ke&&(console.log("\u2728 Production event service restored."),ke=!1),n;throw new Error("Primary failed")}catch{ke||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${s}`),ke=!0);try{let c=await fetch(s+t,e);if(c.ok)return ve=s,c;throw new Error("Fallback failed")}catch(c){throw c}}}async function Ae(t,e={}){if(D()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],c=(P.contacts?.members||[]).find(r=>r.id===n);return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(xe)try{let n=await fetch(xe+t,e);if(n.ok)return n;xe=null}catch{xe=null}let i=Qt(),s=ts;try{let n=await fetch(i+t,e);if(n.ok)return xe=i,Te&&(console.log("\u2728 Production discord service restored."),Te=!1),n;throw new Error("Primary failed")}catch{Te||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${s}`),Te=!0);try{let c=await fetch(s+t,e);if(c.ok)return xe=s,c;throw new Error("Fallback failed")}catch(c){throw c}}}var ft=()=>`
...
`,Ie=null,le=new Set,Be=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;cs(),t&&(e.innerHTML="<p>Updating...</p>");let i="/events?ml=1000&format=json&event.type=system.notification.generated";try{let s=await I(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let c=(await s.json()).events||[];Ie=Date.now(),X(0,Ie);let r=Date.now(),x=24*60*60*1e3,l=c.filter(d=>{let m=localStorage.getItem(`alert_read_ts_${d.id}`);if(!m)return!0;let v=parseInt(m);return r-v<x});l.sort((d,m)=>{let v=T=>{let S=T.event;if(typeof S=="string")try{S=JSON.parse(S)}catch{return"low"}return(S.priority||"low").toLowerCase()},M=T=>T==="critical"?4:T==="high"?3:T==="medium"?2:1,B=M(v(d)),k=M(v(m));return B!==k?k-B:m.timestamp-d.timestamp}),Be=l;let f=d=>{let m=d.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return"low"}return(m.priority||"low").toLowerCase()},y=[],g=new Set(l.map(d=>f(d))).size>1;if(l.length>0){let d=null;l.forEach(m=>{let v=f(m);g&&v!==d&&(y.push({id:`divider-${v}`,type:"divider",label:v.toUpperCase()}),d=v),y.push(m)})}if(t&&(e.innerHTML=""),l.length===0){e.innerHTML=H("empty","No alerts yet."),Le();return}let a=d=>{let m=d.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let v=(m.title||"Untitled Alert").trim(),M=(m.body||"No description provided.").trim(),B=m.summary||"",k=m.content||"",T=m.protocol||"",S=(m.priority||"low").toLowerCase(),_=!!m.alert,q=(m.category||"system").trim(),O=m.related_event_ids||[],J=m.audit_event_id,L=!!localStorage.getItem(`alert_read_ts_${d.id}`),$=new Date(d.timestamp*1e3),h=$.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),C=$.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=L?"event-border-grey":"event-border-blue";!L&&_&&(A="event-border-red"),L&&(S==="high"||S==="critical")?A="event-border-red":L&&S==="medium"&&(A="event-border-orange");let N=L?"alert-read":"alert-unread",z=le.has(d.id),U=z?"expanded":"",F=z?"display: block;":"display: none;",W="",G="";O.length>0&&(G=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${O.map(ie=>`<a href="#" onclick="window.dexter.viewEvent('${ie}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${ie.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let V="";J&&(V=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #ddd; font-size: 0.85em; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re(k)}</div>
            </div>
        `:Q=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re(M)}</div>
            </div>
        `,W=`
                <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                    ...
                    <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="metadata-value" style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee;">${q}</div>
                    </div>
                    ${ge}
                    ${V}
                    ${G}
                ...
                ${Q}
            `;let Z=document.createElement("div");Z.className=`event-item notification-item ${A} ${N} ${U} cursor-pointer priority-${S}`,Z.dataset.alertId=d.id,Z.onclick=function(ie){if(this.classList.contains("expanded")){this.classList.remove("expanded"),le.delete(d.id);let Ce=this.querySelector(".event-details");Ce&&(Ce.style.display="none")}else{this.classList.add("expanded"),le.add(d.id);let Ce=this.querySelector(".event-details");if(Ce&&(Ce.style.display="block"),!localStorage.getItem(`alert_read_ts_${d.id}`)){localStorage.setItem(`alert_read_ts_${d.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Pe="event-border-grey";S==="high"||S==="critical"?Pe="event-border-red":S==="medium"&&(Pe="event-border-orange"),this.classList.add(Pe),Le()}}};let Ye=`${T?T.toUpperCase():"GUARDIAN"} ALERT: ${B||v}`,Kt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[q]||"bx-bell",Zt=S==="high"||S==="critical"?"#ff4d4d":S==="medium"?"#ffa500":"#888";Z.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Zt}; font-size: 0.8em; margin-left: 5px;">[${S.toUpperCase()}]</span>
                    </div>
                    <div class="event-message">${re(Ye)}</div>
                    <div class="event-details" style="${F}">
                        ${W}
                    </div>
                </div>
            `;let Xe=Z.querySelector(".event-details");Xe&&Xe.addEventListener("click",ie=>{ie.stopPropagation()});let Qe=Z.querySelector(".close-details-btn");return Qe&&Qe.addEventListener("click",ie=>{ie.stopPropagation(),Z.classList.remove("expanded");let He=Z.querySelector(".event-details");He&&(He.style.display="none"),le.delete(d.id)}),Z},b=d=>{let m=document.createElement("div");m.className="notification-divider",m.dataset.alertId=d.id;let v="#888888";return d.label==="CRITICAL"?v="#ff4d4d":d.label==="HIGH"?v="#ff8888":d.label==="MEDIUM"&&(v="#ffa500"),m.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${v}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,m.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${v}44, transparent); flex-grow: 1;"></div>`,m},E=Array.from(e.children),w=new Map(E.map(d=>[d.dataset.alertId,d])),u=new Set(y.map(d=>d.id));E.forEach(d=>{let m=d.dataset.alertId;(!m||!u.has(m))&&d.remove()});let o=null;y.forEach((d,m)=>{let v=w.get(d.id);(!v||t)&&(v&&v.remove(),d.type==="divider"?v=b(d):v=a(d),!v)||(m===0?e.firstElementChild!==v&&e.prepend(v):o&&o.nextElementSibling!==v&&o.after(v),o=v)}),Ie=Date.now(),X(0,Ie),Le()}catch(s){console.error("Error fetching alerts:",s),e.children.length===0&&(e.innerHTML=H("offline","Failed to load alerts.","The event service may be offline."))}}function cs(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),i=document.getElementById("alerts-close-all"),s=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Be.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Be.forEach(n=>{le.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ne(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{le.clear(),ne(!0)},i.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;Be.forEach(c=>{localStorage.setItem(`alert_read_ts_${c.id}`,n.toString())}),le.clear(),ne(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}async function Ue(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(c=>{let r=c.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${c.id}`)||n++}),ct(n)}catch{}}var gt=()=>`
...
`,ce=new Set,_e=[],he=null;async function de(t=!1){let e=document.getElementById("roadmap-list");if(e){ds();try{let i=await I("/roadmap");if(!i.ok)throw new Error("Offline");let s=await i.json();_e=s;let n=f=>{let y=ce.has(f.id),p=f.state==="published",g=f.state==="consumed",a="event-border-grey";p&&(a="event-border-blue"),g&&(a="event-border-purple");let E=new Date(f.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),w=document.createElement("div");w.className=`event-item notification-item ${a} cursor-pointer ${y?"expanded":""}`,w.dataset.itemId=f.id,w.onclick=d=>{if(d.target.closest("button"))return;w.classList.contains("expanded")?(w.classList.remove("expanded"),w.querySelector(".event-details").style.display="none",ce.delete(f.id)):(w.classList.add("expanded"),w.querySelector(".event-details").style.display="block",ce.add(f.id))};let u=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${f.state.toUpperCase()}]</span>`;w.innerHTML=`
        <div class="event-time">
        ...
        <div class="event-content">
          ...
          <div class="event-message" style="white-space: pre-wrap;">${R(f.content)}</div>
      ...
      `;let o=w.querySelector(".event-details");return o&&o.addEventListener("click",d=>{d.stopPropagation()}),w.querySelector(".edit-btn")?.addEventListener("click",()=>ps(f)),w.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ms(f)),w.querySelector(".delete-btn")?.addEventListener("click",()=>us(f.id)),w.querySelector(".close-details-btn")?.addEventListener("click",d=>{d.stopPropagation(),w.classList.remove("expanded"),w.querySelector(".event-details").style.display="none",ce.delete(f.id)}),w},c=Array.from(e.children),r=new Map(c.map(f=>[f.dataset.itemId,f])),x=new Set(s.map(f=>f.id));if(c.forEach(f=>{let y=f.dataset.itemId;(!y||!x.has(y))&&f.remove()}),!_e||_e.length===0){e.innerHTML=H("empty","Your roadmap is empty.",D()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let l=null;s.forEach((f,y)=>{let p=r.get(f.id);(!p||t)&&(p&&p.remove(),p=n(f),!p)||(y===0?e.firstElementChild!==p&&e.prepend(p):l&&l.nextElementSibling!==p&&l.after(p),l=p)})}catch{e.children.length===0&&(e.innerHTML=H("offline","Failed to load roadmap.","The event service may be offline."))}}}function ds(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),i=document.getElementById("roadmap-cancel"),s=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{he=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",he=null},i.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let c=document.getElementById("roadmap-editor-input").value;if(!c.trim())return;let r=he?`/roadmap/${he}`:"/roadmap",x=he?"PATCH":"POST";try{await I(r,{method:x,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:c})}),document.getElementById("roadmap-editor-container").style.display="none",de(!0)}catch(l){console.error(l)}},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{_e.forEach(c=>ce.add(c.id)),de(!0)},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ce.clear(),de(!0)},n.dataset.listenerAttached="true")}function ps(t){he=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function ms(t){let e=t.state==="published"?"draft":"published";try{await I(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),de(!0)}catch(i){console.error(i)}}async function us(t){if(confirm("Delete this roadmap item?"))try{await I(`/roadmap/${t}`,{method:"DELETE"}),ce.delete(t),de(!0)}catch(e){console.error(e)}}var xt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,vt=null,pe=new Set,ht=[];async function me(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;fs();let i="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let s=await I(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let c=(await s.json()).events||[];if(ht=c,vt=Date.now(),X(2,vt),c.length===0){e.innerHTML=H("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),$e(2,0);return}t&&(e.innerHTML="");let r=p=>{let g=p.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let a=(g.title||"Untitled Blueprint").trim(),b=(g.summary||g.body||"No summary provided.").trim(),E=(g.content||"").trim(),w=(g.category||"architecture").trim(),u=(g.related_services||g.affected_services||[]).map(z=>z.trim()),o=(g.implementation_path||[]).map(z=>z.trim()),d=g.source_event_ids||[],m=g.approved===!0,v=new Date(p.timestamp*1e3),M=v.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),B=v.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=pe.has(p.id),T=k?"display: block;":"display: none;",S=document.createElement("div");S.className=`event-item notification-item event-border-purple cursor-pointer ${k?"expanded":""} ${m?"blueprint-approved":""}`,S.dataset.blueprintId=p.id,m&&(S.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",S.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let q=m?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[w]||"bx-paint";S.onclick=function(z){if(this.classList.contains("expanded")){this.classList.remove("expanded"),pe.delete(p.id);let F=this.querySelector(".event-details");F&&(F.style.display="none")}else{this.classList.add("expanded"),pe.add(p.id);let F=this.querySelector(".event-details");F&&(F.style.display="block")}};let O="";o.length>0&&(O=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${o.map(z=>`<li style="margin-bottom: 5px;">${R(z)}</li>`).join("")}</ul></div>
                    </div>
                `);let J="";d.length>0&&(J=`
                ...
                `);let j=u.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${u.join(", ")}</span></div>`:"<div></div>",L=D(),$=m?`
            ...
            `;S.innerHTML=`
                ...
                <div class="event-icon" style="${m?"color: #03dac6;":""}"><i class='bx ${q}'></i></div>
                <div class="event-content">
                    ...
                    <div class="event-details" style="${T}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${R(b)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${R(E)}</div>
                        </div>
                        ${O}
                        ${J}
                        ${$}
            ...
            `;let h=S.querySelector(".blueprint-approve-btn");h&&(h.onclick=async z=>{z.stopPropagation(),h.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await I(`/events/${p.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&me(!0)}catch(U){console.error("Failed to approve blueprint:",U)}});let C=S.querySelector(".blueprint-delete-btn");C&&(C.onclick=async z=>{z.stopPropagation();let U=!m;C.innerHTML=U?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await I(`/events/${p.id}`,{method:"DELETE"})).ok&&me(!0)}catch(F){console.error("Failed to delete blueprint:",F)}});let A=S.querySelector(".event-details");A&&A.addEventListener("click",z=>{z.stopPropagation()});let N=S.querySelector(".close-details-btn");return N&&N.addEventListener("click",z=>{z.stopPropagation(),S.classList.remove("expanded");let U=S.querySelector(".event-details");U&&(U.style.display="none"),pe.delete(p.id)}),S},x=Array.from(e.children),l=new Map(x.map(p=>[p.dataset.blueprintId,p])),f=new Set(c.map(p=>p.id));x.forEach(p=>{let g=p.dataset.blueprintId;(!g||!f.has(g))&&p.remove()});let y=null;c.forEach((p,g)=>{let a=l.get(p.id);(!a||t)&&(a&&a.remove(),a=r(p),!a)||(g===0?e.firstElementChild!==a&&e.prepend(a):y&&y.nextElementSibling!==a&&y.after(a),y=a)}),$e(2,c.length),pt()}catch(s){console.error("Error fetching blueprints:",s),e.children.length===0&&(e.innerHTML=H("offline","Failed to load blueprints.","The event service may be offline."))}}async function wt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(c=>{let r=c.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&n++}),dt(n)}catch{}}function fs(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),i=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ht.forEach(s=>pe.add(s.id)),me(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{pe.clear(),me(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.blueprint.generated",{method:"DELETE"}),pe.clear(),me(!0)}catch(s){console.error("Failed to clear blueprints:",s)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var Ct=()=>`
...
`;async function qe(){await Promise.all([de(),me()])}var $t=()=>`
    ...
    `;async function we(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),i=document.getElementById("create-chore-form"),s=document.getElementById("save-chore-btn"),n=document.getElementById("cancel-chore-btn");if(e&&!e.dataset.listenerAttached&&(e.onclick=()=>{i.style.display=i.style.display==="none"?"block":"none"},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{i.style.display="none"},n.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let c=document.getElementById("new-chore-instruction").value,r=document.getElementById("new-chore-url").value,x=document.getElementById("new-chore-owner").value||"313071000877137920";if(c){s.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:x,natural_instruction:c,entry_url:r,schedule:"every_6h"})}),i.style.display="none",document.getElementById("new-chore-instruction").value="",document.getElementById("new-chore-url").value="",we()}catch(l){console.error(l),alert("Failed to create chore")}finally{s.innerHTML="Create Task"}}},s.dataset.listenerAttached="true"),!!t)try{let c=await I("/chores");if(!c.ok)throw new Error(`HTTP error! status: ${c.status}`);let r=await c.json();if(!Array.isArray(r)||r.length===0){t.innerHTML=H("empty","No active chores.","Create one to start monitoring.");return}let x=r.map(l=>{let f=l.last_run===0?"Never":new Date(l.last_run*1e3).toLocaleString(),y=l.memory?l.memory.length:0,p=l.status==="active"?"#03dac6":"#666";return`
            ...
            `}).join("");t.innerHTML=x,t.querySelectorAll(".delete-chore-btn").forEach(l=>{l.onclick=async f=>{f.stopPropagation(),confirm("Delete this chore?")&&(await I(`/chores/${l.dataset.id}`,{method:"DELETE"}),we())}})}catch(c){console.error("Failed to fetch chores",c)}}var gs=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function St(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Et(t){if(!document.getElementById("dex-profile-styles")){let i=document.createElement("style");i.id="dex-profile-styles",i.textContent=gs,document.head.appendChild(i)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",i=>{i.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",Ae(`/profile/${t.id}`).then(async i=>{if(i.ok){let s=await i.json();je(e,t,s)}else{console.log("Profile not found or error, using mock data.");let s=St(t.id,t.username);je(e,t,s)}}).catch(i=>{console.error("Profile fetch error:",i);let s=St(t.id,t.username);je(e,t,s)})}function je(t,e,i){let s=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",n=()=>{let E=(i.badges||[]).map(M=>`<span class="profile-badge ${M==="Creator"?"master":""}">${M}</span>`).join(""),w=(i.attributes||i.facts||[]).map(M=>{let B=M.key||M.k,k=M.value||M.v;return`
            <div class="fact-chip">
                <span class="fact-key">${B}:</span>
                <span class="fact-val">${k}</span>
            </div>
        `}).join(""),u=i.cognitive_model||i,o=u.technical_level||u.techLevel||0,d=u.communication_style||u.commStyle||"Unknown",m=u.patience_level||u.patience||"Unknown",v=u.vibe||"Unknown";return`
        ...
        `},c=()=>{let E=i.dossier||{},w=E.identity||{},u=E.career||{},o=E.personal||{},d=E.social||[];return`
    ...
    `,f=`
        <div class="profile-card">
            ...
            <div class="profile-body">
                ...
                <div id="tab-topics" class="tab-content">${x()}</div>
...
`,bs=null;async function Fe(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Fe(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=i=>{let s=i.target.closest(".user-profile-card");if(s)try{let n=JSON.parse(s.dataset.user);Et(n)}catch(n){console.error("Failed to parse user data",n)}},t.dataset.listenerAttached="true");try{let i=await Ae("/contacts");if(!i.ok)throw new Error("Service unreachable");let n=(await i.json()).members||[];if(bs=Date.now(),n.length===0){t.innerHTML=H("empty","No contacts found.","Check your Discord connection.");return}let c={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((r,x)=>{let l=c[r.level]??10,f=c[x.level]??10;return l!==f?l-f:r.username.localeCompare(x.username)}),t.innerHTML=n.map(r=>{let x=r.color&&r.color!==0,l=x?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",f=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",y="#888";r.level==="Me"||r.level==="Master"?y="#bb86fc":r.level==="Admin"?y="#cf6679":r.level==="Moderator"?y="#03dac6":r.level==="Contributor"&&(y="#ffa500");let p=r.level==="Me",g=p?"rgba(187, 134, 252, 0.08)":x?`${l}11`:"rgba(255,255,255,0.03)",a=p?"2px solid #bb86fc":x?`1px solid ${l}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${p?"#bb86fc":x?l:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${r.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${p?"2px solid #bb86fc":x?`2px solid ${l}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${x?l:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${r.username}</h3>
...
`,De=null,ue=new Set,Se=[],K="all",xs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},ys={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function hs(t){for(let[e,i]of Object.entries(xs))if(i.includes(t))return e;return"system"}function ws(t){return ys[t]||"bx-square-rounded"}async function ae(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Cs();let s=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(s+=`&category=${K}`);try{let n=await I(s);if(!n.ok)throw new Error("Service unreachable");if(Se=((await n.json()).events||[]).filter(g=>{let a=g.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return!0}let b=a.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),De=Date.now(),X(1,De),Se.length===0){e.innerHTML=H("empty","No events found for this filter.");return}t&&(e.innerHTML="");let x=g=>{let a=g.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return null}let b=a.type,E=hs(b),w=ws(b),u=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),o="event-border-grey";u&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?o="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?o="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?o="event-border-orange":b==="system.test.completed"?o=a.test?.status==="OK"&&a.lint?.status==="OK"&&a.format?.status==="OK"?"event-border-blue":"event-border-red":o="event-border-blue");let d=u?"cursor-pointer":"",m=ue.has(g.id),v=m?"expanded":"",M=m?"display: block;":"display: none;",B=new Date(g.timestamp*1e3),k=B.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=B.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Tt(b,a),_=a.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${a.user_level})</span>`:"",q="";if(u){let $="";if(b==="engagement.decision"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        ...
                        <div class="event-detail-block">
                            ${h("Raw Engagement Output")}
                            <pre class="detail-pre">${a.engagement_raw||"None"}</pre>
                        </div>
                    `}else if(b==="system.attention.expired"){let h=N=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${N}</h5>`,C=a.timestamp-a.last_active,A=Math.floor(C/60);$=`
                        ...
                        <div class="event-detail-block">
                            ${h("Context (Last Input)")}
                            <div class="detail-pre">${re(a.last_input||"None")}</div>
                        </div>
                        <div class="event-detail-block">
                            ${h("Thought Process (Last Output)")}
                            <div class="detail-pre">${re(a.last_output||"None")}</div>
                        </div>
                    `}else if(b==="messaging.bot.sent_message"){let h=N=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${N}</h5>`,C="";a.eval_count&&(C=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let A="";if(a.chat_history&&a.chat_history.length>0){let N=a.chat_history.length,z=a.chat_history.map((U,F)=>{let W=U.name?U.name.toUpperCase():U.role.toUpperCase();!U.name&&W==="ASSISTANT"&&(W="DEXTER");let G=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",V=F===N-1?"block":"none";return`
                                <div class="history-slide" data-index="${F}" style="display: ${V};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${G}; letter-spacing: 1px; font-weight: bold;">${W}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${F+1} of ${N}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${R(U.content)}</div>
                                </div>
                            `}).join("");A=`
                            <div class="event-detail-block">
                        ...
                        ${A||`
                            ...
                            <div class="event-detail-block">
                                ${h("Raw Response Output")}
                                <pre class="detail-pre">${a.response_raw||"None"}</pre>
                            </div>
                        `}
                    `}else if(b==="analysis.user.message_signals"){let h=N=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${N}</h5>`,C=a.signals||{};$=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${(C.topics||[]).map(N=>`<span class="profile-badge">${N}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${h("Raw Model Output")}
                            <pre class="detail-pre">${R(a.raw_output)||"None"}</pre>
                        </div>
                    `}else if(b==="moderation.explicit_content.deleted"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="analysis.link.completed"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${R(a.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${h("Description")}
                            <pre class="detail-pre">${R(a.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${h("Content Summary")}
                            <pre class="detail-pre">${R(a.summary)||"None"}</pre>
                        </div>
                    `}else if(b==="analysis.visual.completed"){let h=A=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${A}</h5>`,C="";a.base64_preview?C=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${a.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:a.url&&(C=`<div class="event-detail-block"><img src="${a.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),$=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        ${C}
                        <div class="event-detail-block">
                            ${h("Visual Description")}
                            <pre class="detail-pre">${R(a.description)||"None"}</pre>
                        </div>
                    `}else if(b==="analysis.router.decision"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${h("Input Context")}
                            <pre class="detail-pre">${R(a.raw_input)||"None"}</pre>
                        </div>
                    `}else if(b==="system.cli.command"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${h("Output")}
                            <pre class="detail-pre">${R(a.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(b==="system.analysis.audit"){let h=a.success?"#03dac6":"#ff4d4d",C=a.success?"SUCCESS":"FAILED",A=W=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${W}</h5>`,N="";a.error&&(N=`
                            <div class="event-detail-block">
                                ${A("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${R(a.error)}</pre>
                            </div>
                        `);let z="";if(a.chat_history&&a.chat_history.length>0){let W=a.chat_history.length,G=a.chat_history.map((V,ge)=>{let Q=V.name?V.name.toUpperCase():V.role.toUpperCase();!V.name&&Q==="USER"&&(Q="SYSTEM"),!V.name&&Q==="ASSISTANT"&&(Q="AGENT");let Z=V.role==="user"?"#03dac6":V.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ge}" style="display: ${ge===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; text-transform: uppercase; color: ${Z}; letter-spacing: 1px; font-weight: bold;">${Q}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${ge+1} of ${W}</span>
                                    </div>
                            ...
                            <div class="event-detail-block">
                                ...
                                <div class="history-carousel" style="position: relative; background: rgba(255,255,255,0.03); border-radius: 4px; padding: 15px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        ...
                                        <button class="carousel-btn next-btn" style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 0.8em; transition: background 0.2s;" ${W<=1?"disabled":""}>Next <i class='bx bx-chevron-right'></i></button>
                                    </div>
                                </div>
                            </div>
                        `}let U="";if(a.corrections&&a.corrections.length>0){let W=a.corrections.map((G,V)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                ...
                                ${G.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${R(G.snippet)}</div>`:""}
                            </div>
                        `).join("");U=`
                            <div class="event-detail-block">
                                ${A(`Corrections (${a.corrections.length})`)}
                                ${W}
                            </div>
                        `}let F="";if(a.parsed_results&&a.parsed_results.length>0){let W=a.parsed_results.map(G=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${R(G.title)}</div>
                                <div style="color: #ddd;">${R(G.summary)}</div>
                            </div>
                        `).join("");F=`
                            <div class="event-detail-block">
                                ${A("Parsed Results")}
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${h}; font-weight: bold;">${C} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${a.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${U}
                        ${z}
                    `}else if(b==="system.test.completed"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="error_occurred"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${h("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${R(a.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${h("Context")}
                            <pre class="detail-pre">${JSON.stringify(a.context||{},null,2)}</pre>
                        </div>
                    `}else if(b==="system.cli.status"){let h=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;$=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${h("Message")}
                            <pre class="detail-pre">${R(a.message)}</pre>
                        </div>
                    `}else if(b==="messaging.user.sent_message"){let h="";a.attachments&&a.attachments.length>0&&(h=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${a.attachments.map(A=>{let N=A.content_type&&A.content_type.startsWith("image/"),z=(A.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${N?`<div class="attachment-thumb-container"><img src="${A.url}" alt="${A.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                                    <div class="attachment-info">
                                        <a href="${A.url}" target="_blank" class="attachment-link">${A.filename}</a>
                                        <span class="attachment-meta">${A.content_type} \u2022 ${z}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),$=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                ...
                `}let O=document.createElement("div");O.className=`event-item ${o} ${d} ${v}`,O.dataset.eventId=g.id,O.onclick=function($){if(!u)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),ue.delete(g.id);let C=this.querySelector(".event-details");C&&(C.style.display="none")}else{this.classList.add("expanded"),ue.add(g.id);let C=this.querySelector(".event-details");C&&(C.style.display="block")}},O.innerHTML=`
                <div class="event-time">
            ...
            `;let J=O.querySelector(".event-details");if(J&&J.addEventListener("click",$=>{$.stopPropagation()}),u){let $=O.querySelector(".close-details-btn");$&&$.addEventListener("click",h=>{h.stopPropagation();let C=h.target.closest(".event-item");if(C){C.classList.remove("expanded"),ue.delete(g.id);let A=C.querySelector(".event-details");A&&(A.style.display="none")}})}let j=O.querySelector(".prev-btn"),L=O.querySelector(".next-btn");if(j&&L){let $=0,h=O.querySelectorAll(".history-slide"),C=h.length,A=()=>{h.forEach((N,z)=>{N.style.display=z===$?"block":"none"}),j.disabled=$===0,L.disabled=$===C-1,j.style.opacity=$===0?"0.5":"1",L.style.opacity=$===C-1?"0.5":"1"};j.addEventListener("click",N=>{N.stopPropagation(),$>0&&($--,A())}),L.addEventListener("click",N=>{N.stopPropagation(),$<C-1&&($++,A())}),A()}return O},l=Array.from(e.children),f=new Map(l.map(g=>[g.dataset.eventId,g])),y=new Set(Se.map(g=>g.id));l.forEach(g=>{let a=g.dataset.eventId;(!a||!y.has(a))&&g.remove()});let p=null;Se.forEach((g,a)=>{let b=f.get(g.id);(!b||t)&&(b&&b.remove(),b=x(g),!b)||(a===0?e.firstElementChild!==b&&e.prepend(b):p&&p.nextElementSibling!==b&&p.after(b),p=b)}),De=Date.now(),X(1,De)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=H("offline","Failed to load events.","The event service may be offline."))}}function Cs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),i=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Se.forEach(n=>ue.add(n.id)),ae(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ue.clear(),ae(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{i.querySelectorAll(".filter-btn").forEach(c=>c.classList.remove("active")),n.classList.add("active"),K=n.dataset.filter,ae(!0)}}),i.dataset.listenerAttached="true"),i&&i.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===K?n.classList.add("active"):n.classList.remove("active")});let s=document.getElementById("events-clear");s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let n=K==="all"?"ALL":K.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let c="/events";if(K!=="all"?c+=`?category=${K}`:c+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await I(c,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ue.clear(),ae(!0)}catch(c){console.error("Failed to clear events:",c),alert("Failed to clear events. Check console.")}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var $s=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Lt=$s;function Mt(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var Ss=null;async function Ee(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await I("/logs");if(!e.ok)throw new Error("Logs offline");let i=await e.json();if(!i||i.length===0)return t.innerHTML=H("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let s=["local-ollama-0","local-cache-0"],n=i.filter(r=>!s.includes(r.id));n.forEach(r=>{r.logs&&Array.isArray(r.logs)?r.logs.reverse():r.logs=[]}),n.reverse();let c=n.map(r=>{let x=r.logs.join(`
...
`);return`
                <div class="log-report">
                    <div class="log-report-header">
                        ...
                        <div style="display: flex; gap: 5px;">
                            <button class="log-action-btn copy-logs-btn" data-logs="${escape(x)}" title="Copy Logs">
            ...
            `}).join("");return t.innerHTML=c,document.querySelectorAll(".copy-logs-btn").forEach(r=>{r.addEventListener("click",()=>{let x=unescape(r.dataset.logs);navigator.clipboard.writeText(x).then(()=>{let l=r.querySelector("i");l.classList.remove("bx-copy"),l.classList.add("bx-check"),setTimeout(()=>{l.classList.remove("bx-check"),l.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(r=>{r.addEventListener("click",async()=>{let x=r.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${x}?`))try{(await I(`/logs?service_id=${x}`,{method:"DELETE"})).ok&&Ee()}catch(l){console.error("Error clearing logs:",l)}})}),Ss=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=H("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var _t=()=>{let t=D()?"display: none;":"";return`
        <div class="system-section-header">
        ...
        <div id="services-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,Nt=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Mt()}
        </div>`;async function Rt(){Es(),await Promise.all([fe(),Ge(),Ve(),we()]),await Ee()}var ze=null;function Es(){ze||(ze=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(ze),ze=null;return}fe(!0)},1e3))}var At=null,It=null;async function Ot(){try{return await(await I("/system_monitor")).json()}catch{return null}}async function Bt(){try{return await(await I("/system/hardware")).json()}catch{return null}}async function ks(){try{return await(await I("/processes")).json()}catch{return null}}async function Ts(){try{return await(await I("/agent/status")).json()}catch{return null}}async function Ge(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),i=document.querySelector("#hw-os .hw-content"),s=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),c=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),x=o=>{if(o){if(i&&(i.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let o=await Bt();o?(x(o),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),s&&!s.hasChildNodes())){let o=await Bt();x(o)}if(!t)return;let l=await Ot();if(!l||!l.services){t.children.length===0&&(t.innerHTML=H("offline","Failed to load system metrics.","The event service may be offline."));let o=document.querySelector('[data-service-id="upstash-redis-ro"]');if(o){o.className="service-widget service-widget-offline",o.querySelector(".service-widget-status").textContent="ERROR";let d=o.querySelector(".service-widget-body");d&&(d.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}At=D()&&se.lastDashboard||Date.now(),X(0,At);let f=l.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let o=document.getElementById("upstash-countdown");if(o){let v=59-new Date().getSeconds();v<=0&&(v+=60),o.textContent=`${v}s`}},1e3)),Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function y(o){return!o||o==="N/A"||o==="unknown"||o.trim()===""?"-":o}function p(o){if(!o||o==="N/A"||o==="unknown")return"-";let d=o.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:o.split(".").slice(0,3).join(".")||"-"}function g(o){return!o||o.length<=28?o:o.substring(0,28)+"..."}function a(o){if(!o||o==="N/A"||o==="unknown")return"-";let d=o.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let m=parseInt(d[1])||0,v=parseInt(d[2])||0,M=parseInt(d[3])||0,B=parseFloat(d[4])||0,k=m*86400+v*3600+M*60+B,T=Math.floor(k/86400);if(T>0)return`${T}d`;let S=Math.floor(k/3600);if(S>0)return`${S}h`;let _=Math.floor(k/60);return _>0?`${_}m`:`${Math.floor(k)}s`}function b(o){if(o.id==="upstash-redis-ro"){let $=D()&&(se.lastFrontend||se.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
                ...
                <div class="service-widget-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 10px 0;">
                    ...
                    <div class="sync-time-label" style="font-size: 0.6em; color: #444; margin-top: 10px;">Last synced: ${new Date($).toLocaleTimeString()}</div>
                </div>
            </div>`}let d=o.status==="online",m=d?"service-widget-online":"service-widget-offline",v=d?"bx-check-circle":"bx-x-circle",M=d?"OK":"BAD",B=o.version?p(o.version.str):"-",k=o.cpu&&o.cpu!=="N/A"?o.cpu:"-",T=o.memory&&o.memory!=="N/A"?o.memory:"-",S=k!=="-"?"#00ff00":"#666",_=k!=="-"?"#fff":"#666",q=T!=="-"?"#00ff00":"#666",O=T!=="-"?"#fff":"#666",J=a(o.uptime),j="";d?j=`
                <div class="service-widget-info">
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${_};">${k}</span>
                    </div>
                    <div class="service-widget-item">
                        <i class="bx bxs-chip" style="color: ${q};"></i>
                        <span style="color: ${O};">${T}</span>
                    </div>
                </div>`:j='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let L=D()?"easter.company":g(o.domain&&o.port?`${o.domain}:${o.port}`:"");return`<div class="service-widget ${m}" data-service-id="${o.id}"><div class="service-widget-header"><i class="bx ${v}"></i><h3>${o.short_name||o.id}</h3><span class="service-widget-status">${M}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${L}</span></div>${j}</div></div>`}let E=new Map(Array.from(t.querySelectorAll(".service-widget")).map(o=>[o.dataset.serviceId,o])),w=new Set(f.map(o=>o.id));for(let[o,d]of E)w.has(o)||d.remove();let u=new Set;f.forEach(o=>{if(u.has(o.id))return;u.add(o.id);let d=b(o),m=E.get(o.id);if(m&&m.parentNode)if(o.id==="upstash-redis-ro"){let v=D()&&(se.lastFrontend||se.lastDashboard)||Date.now(),M=new Date(v).toLocaleTimeString(),B=m.querySelector(".sync-time-label");B&&(B.textContent=`Last synced: ${M}`)}else m.outerHTML!==d&&(m.outerHTML=d);else t.insertAdjacentHTML("beforeend",d)})}async function Ve(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Ot();if(!e){t.children.length===0&&(t.innerHTML=H("offline","Failed to load model status.","The event service may be offline."));return}It=Date.now(),X(2,It);let i=e.models||[],s=e.whisper;Array.from(t.children).forEach(l=>{l.classList.contains("service-widget")||l.remove()});function n(l){let f=l.status==="Ready";return`
                ...
                </div>`}function r(l){let f=l.status==="Downloaded",y=f?"service-widget-online":"service-widget-offline",p=f?"OK":"MISSING",g=f&&l.size>0?`${(l.size/1e9).toFixed(2)} GB`:"-",a=l.name;return l.type==="custom"&&a.endsWith(":latest")&&(a=a.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${l.name}"><div class="service-widget-header"><i class="bx ${f?"bx-check-circle":"bx-x-circle"}"></i><h3>${a}</h3><span class="service-widget-status">${p}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${l.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${g}</span></div></div></div>`}let x="";if(s&&(x+=n(s)),e.xtts&&(x+=c(e.xtts)),x+=i.map(r).join(""),!x){t.innerHTML=H("empty","No models found.");return}t.innerHTML!==x&&(t.innerHTML=x)}async function fe(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let i=document.getElementById("guardian-sentry-val"),s=document.getElementById("guardian-architect-val"),n=document.getElementById("guardian-idle-val"),c=document.getElementById("guardian-total-idle"),r=document.getElementById("guardian-total-active"),x=document.getElementById("guardian-total-waste"),l=document.getElementById("guardian-reset-btn"),f=document.getElementById("analyzer-reset-btn"),y=document.getElementById("system-pause-toggle-btn");y&&!y.dataset.listenerAttached&&(y.onclick=async()=>{let d=y.querySelector(".bx-play")?"/agent/resume":"/agent/pause";y.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I(d,{method:"POST"}),setTimeout(()=>fe(),500)}catch{y.innerHTML="<i class='bx bx-error'></i>"}},y.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.onclick=async()=>{l.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{l.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{l.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),fe()}catch{l.innerHTML="<i class='bx bx-error'></i>"}},l.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onclick=async()=>{f.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{f.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{f.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),fe()}catch{f.innerHTML="<i class='bx bx-error'></i>"}},f.dataset.listenerAttached="true");let p=await Ts();if(p&&p.agents){let o=p.agents.guardian||{protocols:{}},d=p.agents.analyzer||{protocols:{}},m=p.agents.imaginator||{protocols:{}},v=p.system||{},M=Math.floor(Date.now()/1e3),B={sentry:"Sentry",architect:"Architect",synthesis:"Synthesis",alert_review:"Alert Review"},k=L=>{L<0&&(L=0);let $=Math.floor(L/3600),h=Math.floor(L%3600/60),C=L%60;return $>0?`${$}h ${h}m`:h>0?`${h}m ${C}s`:`${C}s`},T=(L,$,h,C)=>{if(!L)return;let A=B[C]||C.toUpperCase(),N=L.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(N&&(N.textContent=A),!h){L.textContent="Inactive",L.style.color="#666";return}let z=h.status;if(z==="Working")L.textContent="Working",L.style.color="#bb86fc";else if(z==="Ready")L.textContent="Ready",L.style.color="#5eff5e";else{let U=h.cooldown;if(D()&&(U=h.next_run-M),U<=0)L.textContent="Ready",L.style.color="#5eff5e";else{let F=Math.floor(U/60),W=U%60;L.textContent=`${F}m ${W}s`,L.style.color="#fff"}}$&&h.stats&&($.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
              <span>Runs: ${h.stats.runs||0}</span>
              <span style="color: ${h.stats.failures>0?"#ffa500":"#666"}">Fails: ${h.stats.failures||0}</span>
              <span style="color: ${h.stats.aborted>0?"#ff4d4d":"#666"}">Aborted: ${h.stats.aborted||0}</span>
            </div>
          `)};i&&T(i,document.getElementById("guardian-sentry-stats"),o.protocols.sentry,"sentry"),s&&T(s,document.getElementById("guardian-architect-stats"),o.protocols.architect,"architect");let S=document.getElementById("analyzer-synthesis-val"),_=document.getElementById("analyzer-synthesis-stats");S&&T(S,_,d.protocols.synthesis,"synthesis");let q=document.getElementById("imaginator-alert_review-val"),O=document.getElementById("imaginator-alert_review-stats");q&&T(q,O,m.protocols.alert_review,"alert_review");let J=document.getElementById("system-state-label"),j=document.getElementById("system-state-val");if(j&&v.state){let L=v.state,$=k(v.state_time||0);J&&(J.textContent=`State: ${L.toUpperCase()}`),j.textContent=$,L==="idle"?j.style.color=v.state_time>300?"#5eff5e":"#fff":j.style.color="#bb86fc",y&&(y.querySelector(".bx-loader-alt")||y.querySelector(".bx-error")||(L==="paused"?(y.innerHTML="<i class='bx bx-play'></i>",y.title="Resume System",y.style.color="#ff9800"):(y.innerHTML="<i class='bx bx-pause'></i>",y.title="Pause System",y.style.color="")))}c&&(c.textContent=k(v.metrics?.total_idle_time||0)),r&&(r.textContent=k(v.metrics?.total_active_time||0)),x&&(x.textContent=k(v.metrics?.total_waste_time||0))}else[i,s,n,c,r,x].forEach(d=>{d&&(d.textContent="-",d.style.color="#666")});if(t)return;let g=await ks(),a=[],b=[],E=[];g&&(Array.isArray(g)?a=g:(a=g.active||[],b=g.queue||[],E=g.history||[],E.sort((o,d)=>(d.end_time||0)-(o.end_time||0)))),a.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=H("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),We(e,a,!1));let w=document.getElementById("processes-queue-widgets");w&&(b.length===0?!w.querySelector(".tab-placeholder")&&!w.querySelector('div[style*="font-style: italic"]')&&(w.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(w.innerHTML="",We(w,b,!1)));let u=document.getElementById("processes-history-widgets");u&&(E.length===0?u.querySelector(".tab-placeholder")||(u.innerHTML=H("empty","No recent history.")):(u.querySelector(".tab-placeholder")&&(u.innerHTML=""),We(u,E,!0))),$e(1,a.length)}function We(t,e,i){function s(l){let f="";l.end_time?f=`${l.end_time-l.start_time}s`:f=`${Math.floor(Date.now()/1e3-l.start_time)}s`;let y=l.retries>0?`<span class="process-retry-badge">Retry ${l.retries}</span>`:"",p=l.channel_id,g={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(g[p]?p=g[p]:/^\d+$/.test(p)&&(p=`Channel ${p}`),i)return`
    ...
    `;async function jt(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Ut(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await Ut(t)}async function Ut(t){try{let e=await I("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let i=await e.json();if(!i||i.length===0){t.innerHTML=H("empty","No web history found.");return}let s=`
            <div style="display: flex; flex-direction: column; height: 100%;">
        ...
        `;i.forEach((x,l)=>{let f=new Date(x.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),y=x.screenshot?`<img src="data:image/png;base64,${x.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';s+=`
                <div class="web-card" style="flex: 0 0 100%; height: 100%; display: flex; flex-direction: column; scroll-snap-align: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; box-sizing: border-box; max-width: 100%; overflow: hidden;">
                    ...
                    <h3 style="margin-bottom: 5px; color: #fff; text-align: left; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex-shrink: 0; font-size: 1.1em;">${x.title||"No Title"}</h3>
                    <a href="${x.url}" target="_blank" style="color: #bb86fc; font-size: 0.8em; margin-bottom: 15px; display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex-shrink: 0; text-decoration: none;">${x.url}</a>
                    
                    ${y}

                    <div style="flex: 1; background: rgba(0,0,0,0.3); padding: 12px; border-radius: 8px; overflow-y: auto; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; color: #aaa; white-space: pre-wrap; border: 1px solid rgba(255,255,255,0.03);">${x.content?x.content.replace(/</g,"&lt;").replace(/>/g,"&gt;"):"No content available"}</div>
                </div>
            `}),s+=`
                </div>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ls=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[i,s]of Object.entries(t)){let n=Wt.filter(c=>c.category===i);n.length!==0&&(e+=`
    ...
    </div>`,e},Ze=!1;function Ms(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Ft(),document.getElementById("terminal-action-btn").onclick=()=>Ft());let i=document.getElementById("cli-terminal-body"),s=document.getElementById("cli-docs-pane");i.innerHTML="";let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return s.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),document.body.style.overflow="hidden",Ze=!0,i}function Ft(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",Ze=!1}function Jt(t,e,i="output"){if(!Ze)return;let s=document.createElement("div");s.className=`terminal-line terminal-${i}`,i==="prompt"?s.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:s.innerHTML=Me(e),t.appendChild(s),t.scrollTop=t.scrollHeight}async function As(t){let e=Wt.find(n=>n.id===t);if(!e)return;let i=Ms(e);Jt(i,`dex ${t}`,"prompt");let s=e.demo_output||["Executing command...","\u2713 Done."];for(let n of s){await new Promise(r=>setTimeout(r,400+Math.random()*600));let c="output";n.includes("[ERROR]")?c="error":n.includes("[SUCCESS]")||n.includes("\u2713")?c="success":n.includes("!")&&(c="warning"),Jt(i,n,c)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Gt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ls();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let i=e.querySelector("code").textContent;navigator.clipboard.writeText(i).then(()=>{let s=e.querySelector("i");s.className="bx bx-check",s.style.color="#5eff5e",setTimeout(()=>{s.className="bx bx-copy",s.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(i=>{i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),i.addEventListener("click",()=>{let s=i.dataset.cmd;As(s)})})}async function Is(){if(!D())try{if(!(await I("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Vt(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}tt(),st(),Is(),rt(),et();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Gt();let e=[],i=document.getElementById("windows-container");i&&i.setAttribute("data-count","0");let s=u=>{localStorage.setItem("dex_last_window",u)};function n(){for(;e.length>1;)e.shift().close(!0);let u=document.getElementById("windows-container"),o=document.querySelector("nav"),d=document.querySelector("footer"),m=window.location.pathname==="/"||window.location.pathname==="/index.html",v=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");u&&u.setAttribute("data-count",e.length),e.forEach(_=>{let q=document.getElementById(_.id);q&&q.classList.remove("hide-close")});let M=document.getElementById("dexter-menu-container"),B=document.getElementById("nav-window-switcher"),k=document.getElementById("settings-icon"),T=document.getElementById("close-all-windows"),S=window.innerWidth<880;if(!S){let _=document.getElementById("dexter-dropdown"),q=document.getElementById("dexter-menu-btn");_&&_.classList.remove("active"),q&&q.classList.remove("active"),u&&u.classList.remove("menu-open")}if(be(e.length>0),e.length>0)if(d?.classList.add("hide"),T&&(T.style.display=S?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",o?.classList.add("window-open"),u&&(u.style.paddingTop="60px"),M&&(M.style.display=S?"flex":"none"),k&&(k.style.display=S?"block":"none"),!S&&B){let _=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(_)?(B.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{s("alerts-window"),c(x)}),document.getElementById("switch-events").addEventListener("click",()=>{s("events-window"),c(l)}),document.getElementById("switch-monitor").addEventListener("click",()=>{s("monitor-window"),c(y)}),document.getElementById("switch-contacts").addEventListener("click",()=>{s("contacts-window"),c(f)}),document.getElementById("switch-workspace").addEventListener("click",()=>{s("workspace-window"),c(p)})):B.innerHTML=""}else B&&(B.innerHTML="");else o?.classList.remove("window-open"),T&&(T.style.display="none"),u&&(u.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",m||v?d?.classList.remove("hide"):d?.classList.add("hide"),M&&(M.style.display="flex"),k&&(k.style.display="block"),B&&(B.innerHTML="");ye()}function c(u){if(u.isOpen()){u.close();return}for(;e.length>0;)e.pop().close(!0);e.push(u),u.open(),n()}function r(){[...e].forEach(o=>o.close()),e=[]}window.addEventListener("resize",n);let x=oe({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:ft(),onOpen:()=>ne(),onClose:()=>{let u=e.indexOf(x);u>-1&&e.splice(u,1),n()}}),l=oe({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Je(),onOpen:()=>{l.setContent(Je()),ae()},onClose:()=>{let u=e.indexOf(l);u>-1&&e.splice(u,1),n()}}),f=oe({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:kt(),onOpen:()=>Fe(),onClose:()=>{let u=e.indexOf(f);u>-1&&e.splice(u,1),n()}}),y=oe({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:zt()},{icon:"bxs-component",title:"Processes",content:Dt()},{icon:"bxs-brain",title:"Models",content:Nt()},{icon:"bx-globe",title:"Web",content:qt()},{icon:"bxs-hdd",title:"Hardware",content:Ht()},{icon:"bxs-terminal",title:"Logs",content:Pt()},{icon:"bxs-zap",title:"Agents",content:_t()},{icon:"bx-task",title:"Chores",content:$t()}].filter(u=>D()?u.title!=="Hardware"&&u.title!=="Logs":!0),onOpen:()=>{Ge(),fe(),Ve(),jt(),Ee(),we()},onClose:()=>{let u=e.indexOf(y);u>-1&&e.splice(u,1),n()}}),p=oe({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:Ct(),onOpen:()=>qe(),onClose:()=>{let u=e.indexOf(p);u>-1&&e.splice(u,1),n()}}),g=oe({id:"settings-window",title:"Settings",icon:"bx-cog",content:Ne(),onOpen:()=>{g.setContent(Ne()),Ke(g)},onClose:()=>{let u=e.indexOf(g);u>-1&&e.splice(u,1),n()}});window.dexter={viewEvent:u=>{l.isOpen()||c(l),setTimeout(()=>{let o=document.querySelector(`.event-item[data-event-id="${u}"]`);o&&(o.scrollIntoView({behavior:"smooth",block:"center"}),o.classList.add("flash-highlight"),o.classList.contains("expanded")||o.click(),setTimeout(()=>o.classList.remove("flash-highlight"),2e3))},500)},viewAlert:u=>{x.isOpen()||c(x),setTimeout(()=>{let o=document.querySelector(`.event-item[data-alert-id="${u}"]`);o&&(o.scrollIntoView({behavior:"smooth",block:"center"}),o.classList.add("flash-highlight"),o.classList.contains("expanded")||o.click(),setTimeout(()=>o.classList.remove("flash-highlight"),2e3))},500)}};let a=()=>{let u=document.getElementById("dexter-dropdown"),o=document.getElementById("dexter-menu-btn");u&&o&&(u.classList.remove("active"),o.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let u=document.getElementById("dexter-menu-btn"),o=document.getElementById("settings-icon"),d=document.getElementById("close-all-windows"),m=document.getElementById("nav-left-container"),v=document.getElementById("dexter-dropdown"),M=document.getElementById("windows-container");u&&v&&(u.onclick=k=>{k.stopPropagation();let T=window.innerWidth<880;if(T)v.style.top="",v.style.left="",v.style.right="",v.style.transform="";else{let _=u.getBoundingClientRect(),O=document.querySelector("nav").getBoundingClientRect(),J=220,j=10,$=_.left+_.width/2-J/2,h=O.right-10;$+J>h&&($=h-J),$<10&&($=10),v.style.top=O.bottom+j+"px",v.style.left=$+"px",v.style.right="auto",v.style.transform="none"}v.classList.toggle("active"),u.classList.toggle("active");let S=v.classList.contains("active");if(T){let _=document.querySelector("nav");S?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),_?.classList.add("window-open"),M?.classList.add("menu-open"),be(!0)):(M?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),_?.classList.remove("window-open"),be(!1)))}}),o&&(o.onclick=k=>{k.stopPropagation(),c(g)}),d&&(d.onclick=k=>{k.stopPropagation(),r()});let B=(k,T,S)=>{let _=document.getElementById(k);_&&(_.onclick=q=>{q.stopPropagation(),a(),S&&s(S),c(T)})};B("alerts-menu-item",x,"alerts-window"),B("events-menu-item",l,"events-window"),B("monitor-menu-item",y,"monitor-window"),B("contacts-menu-item",f,"contacts-window"),B("workspace-menu-item",p,"workspace-window"),m&&(m.onclick=k=>{if(k.stopPropagation(),v&&v.classList.contains("active")){a(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),be(!1));return}if(e.length>0)r();else{let T=window.location.pathname;if(!(T==="/"||T==="/index.html")){let q=(T.endsWith("/")&&T.length>1?T.slice(0,-1):T).split("/");q.pop();let O=q.join("/")||"/";window.location.href=O}}}),document.addEventListener("click",()=>{let k=window.innerWidth<880;v&&v.classList.contains("active")&&(a(),k&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),be(!1)))}),v&&(v.onclick=k=>k.stopPropagation())})();let E=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!E&&!w&&document.querySelector("footer")?.classList.add("hide"),D()||setInterval(()=>{l.isOpen()&&ae(),x.isOpen()?ne():Ue()},1e3),setInterval(()=>{D()&&(x.isOpen()?ne():Ue()),p.isOpen()?qe():wt(),D()&&l.isOpen()&&ae(),y.isOpen()&&Rt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Vt):Vt();})();
