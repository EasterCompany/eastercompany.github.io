"use strict";(()=>{function ct(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.prepend(t)}}function dt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",s=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var mt=1e3;function le(t){let e=null,i=t.onClose||null,n=t.onOpen||null;function s(){e&&(e.style.zIndex=(++mt).toString())}function o(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",a),n&&setTimeout(n,10);return}let x=document.getElementById("windows-container");x||(x=document.createElement("div"),x.id="windows-container",x.className="windows-container",document.body.appendChild(x)),e=document.createElement("div"),e.id=t.id,e.className="window",t.className&&e.classList.add(t.className),t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++mt).toString(),e.addEventListener("mousedown",s);let h=t.icon||"bx-window",r="",u="",L,C='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(r=`<div class="tab-bar">${t.tabs.map((v,y)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,L=`<div class="window-content">${t.tabs.map((v,y)=>`<div class="tab-content ${y===0?"active":""}" data-tab-content="${y}">${v.content}${C}</div>`).join("")}</div>`):(t.title&&(u=`<div class="window-title">${t.title}</div>`),L=`<div class="window-content">${t.content||""}${C}</div>`),e.innerHTML=`
...
`,Mt=()=>`
    ...
    `,_e=[],Be={"313071000877137920":"Owen",dexter:"Dexter"},ie=[],he=null;async function He(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),i=document.getElementById("create-chore-form"),n=document.getElementById("save-chore-btn"),s=document.getElementById("cancel-chore-btn"),o=document.getElementById("new-chore-owner"),a=document.getElementById("selected-recipients"),p=document.getElementById("task-filter-owner"),c=document.getElementById("new-chore-instruction"),g=document.getElementById("new-chore-url"),T=document.getElementById("new-chore-schedule"),x=document.getElementById("new-chore-time"),h=document.getElementById("new-chore-timezone"),r=document.getElementById("new-chore-time-group");if(h&&!h.dataset.initialValueAttached){let l=Intl.DateTimeFormat().resolvedOptions().timeZone,k=!1;for(let E=0;E<h.options.length;E++)if(h.options[E].value===l){k=!0;break}if(!k){let E=document.createElement("option");E.value=l,E.textContent=l.replace("_"," "),h.appendChild(E)}h.value=l,h.dataset.initialValueAttached="true"}T&&r&&!T.dataset.timeListenerAttached&&(T.addEventListener("change",()=>{r.style.display=T.value==="daily"?"block":"none"}),T.dataset.timeListenerAttached="true");let u=document.getElementById("form-title"),L=document.getElementById("form-icon");function C(){if(a){if(ie.length===0){a.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}a.innerHTML=ie.sort((l,k)=>{let E=l.startsWith("channel:"),m=k.startsWith("channel:");return E&&!m?-1:!E&&m?1:0}).map(l=>{let k=Be[l]||l,E=l.startsWith("channel:");return`
      ...
      `}).join(""),a.querySelectorAll(".remove-recipient").forEach(l=>{l.onclick=()=>{let k=l.dataset.id;ie=ie.filter(E=>E!==k),C()}})}}function b(l){l&&!ie.includes(l)&&(ie.push(l),C()),o&&(o.value="")}function f(l=null){if(i){if(he=l?l.id:null,l){if(u&&(u.textContent="Update Research Task"),L&&(L.className="bx bx-edit-alt",L.style.color="#03dac6"),n&&(n.innerHTML="<i class='bx bx-check'></i> Update Task"),c&&(c.value=l.natural_instruction),g&&(g.value=l.execution_plan?.entry_url||""),T&&(T.value=l.schedule,r&&(r.style.display=l.schedule==="daily"?"block":"none")),x&&l.run_at&&(x.value=l.run_at),h&&l.timezone){let k=!1;for(let E=0;E<h.options.length;E++)if(h.options[E].value===l.timezone){k=!0;break}if(!k){let E=document.createElement("option");E.value=l.timezone,E.textContent=l.timezone.replace("_"," "),h.appendChild(E)}h.value=l.timezone}ie=l.recipients||(l.owner_id?[l.owner_id]:[]),C()}else u&&(u.textContent="Initialize Research Task"),L&&(L.className="bx bx-plus-circle",L.style.color="#bb86fc"),n&&(n.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),c&&(c.value=""),g&&(g.value=""),T&&(T.value="every_24h"),ie=[],C();i.style.display="block",i.scrollIntoView({behavior:"smooth",block:"start"})}}let v=document.getElementById("contacts-group"),y=document.getElementById("channels-group");if(v&&!v.dataset.populated&&!z())try{ve("/contacts").then(async l=>{l.ok&&(((await l.json()).members||[]).forEach(m=>{if(Be[m.id]=m.nickname||m.username,m.id==="313071000877137920")return;let w=document.createElement("option");w.value=m.id;let I=m.nickname||m.username;w.textContent=`${I} (${m.username})`,v.appendChild(w)}),v.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(y&&!y.dataset.populated&&!z())try{ve("/channels").then(async l=>{l.ok&&((await l.json()).forEach(E=>{let m=`channel:${E.id}`;Be[m]=E.name;let w=document.createElement("option");w.value=m,w.textContent=`#${E.name} (${E.guild})`,y.appendChild(w)}),y.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}o&&!o.dataset.listenerAttached&&(o.onchange=()=>{b(o.value)},o.dataset.listenerAttached="true"),p&&!p.dataset.listenerAttached&&(p.onchange=()=>d(),p.dataset.listenerAttached="true");function d(){if(!t)return;let l=p?.value||"all",k=l==="all"?_e:_e.filter(m=>(m.recipients||(m.owner_id?[m.owner_id]:[])).includes(l));if(k.length===0){t.innerHTML=G("empty",l==="all"?"No active tasks.":"No tasks found for this owner.",z()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let E=k.map(m=>{let w=m.last_run===0?"Never":new Date(m.last_run*1e3).toLocaleString(),I=m.memory?m.memory.length:0,M=m.status==="active"?"#03dac6":"#666",N=(m.recipients||(m.owner_id?[m.owner_id]:[])).sort((q,Y)=>{let A=q.startsWith("channel:"),$=Y.startsWith("channel:");return A&&!$?-1:!A&&$?1:0}).map(q=>{let Y=Be[q]||q.substring(0,8),A=q.startsWith("channel:");return`<span title="${Y}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${q==="dexter"?"bx-terminal":A?"bx-hash":"bx-user"}'></i>${Y}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=E,t.querySelectorAll(".edit-chore-btn").forEach(m=>{m.onclick=w=>{w.stopPropagation();let I=m.dataset.id,M=_e.find(B=>B.id===I);M&&f(M)}}),t.querySelectorAll(".reset-chore-btn").forEach(m=>{m.onclick=async w=>{w.stopPropagation();let I=m.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(m.innerHTML="<i class='bx bx-loader-alt spin'></i>",await H(`/chores/${I}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),He())}}),t.querySelectorAll(".delete-chore-btn").forEach(m=>{m.onclick=async w=>{w.stopPropagation();let I=m.dataset.id;confirm("Delete this task?")&&(await H(`/chores/${I}`,{method:"DELETE"}),He())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{i&&(i.style.display==="none"||he!==null?f(null):i.style.display="none")},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{i&&(i.style.display="none")},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let l=document.getElementById("new-chore-instruction"),k=document.getElementById("new-chore-url"),E=document.getElementById("new-chore-schedule"),m=l?.value,w=E?.value||"every_24h",I=w==="daily"?x?.value:"",M=w==="daily"?h?.value:"";if(!m)return;if(ie.length===0){alert("Please add at least one recipient.");return}let B=n.innerHTML;n.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let N=he?"PATCH":"POST",q=he?`/chores/${he}`:"/chores";await H(q,{method:N,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:ie,natural_instruction:m,entry_url:k?.value,schedule:w,run_at:I,timezone:M})}),i&&(i.style.display="none"),l&&(l.value=""),k&&(k.value=""),he=null,ie=[],He()}catch(N){console.error(N),alert(he?"Failed to update research task":"Failed to create research task")}finally{n.innerHTML=B}},n.dataset.listenerAttached="true");try{let l=await H("/chores");if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);if(_e=await l.json()||[],p){let E=p.value,m=new Set;_e.forEach(w=>{w.owner_id&&m.add(w.owner_id),w.recipients&&w.recipients.forEach(I=>m.add(I))}),p.innerHTML='<option value="all">All Recipients</option>',m.forEach(w=>{let I=document.createElement("option");I.value=w;let M=w.startsWith("channel:"),B=Be[w]||`Recipient: ${w.substring(0,8)}`;I.textContent=(M&&!B.startsWith("#")?"#":"")+B,p.appendChild(I)}),p.value=E,p.selectedIndex===-1&&(p.value="all")}d()}catch(l){console.error("Failed to fetch chores",l)}}var Ct=()=>`
...
`;function At(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=xs,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `;let s=e.querySelector(".close-profile-btn");s&&s.addEventListener("click",()=>{e.click()})};ve(`/profile/${t.id}`).then(async n=>{if(n.ok){let s=await n.json();hs(e,t,s)}else console.log("Profile not found (404) or error."),i("Profile Data Unavailable")}).catch(n=>{console.error("Profile fetch error:",n),i("Connection Failed")})}function hs(t,e,i){let n=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",s=()=>{let L=(i.attributes||i.facts||[]).map(d=>{let l=d.key||d.k,k=d.value||d.v;return`
        ...
        `}).join(""),C=i.cognitive_model||i,b=C.technical_level||C.techLevel||0,f=C.communication_style||C.commStyle||"Unknown",v=C.patience_level||C.patience||"Unknown",y=C.vibe||"Unknown";return`
        ...
        `},o=()=>{let L=i.dossier||{},C=L.identity||{},b=L.career||{},f=L.personal||{},v=L.social||[];return`
...
`,Je=null,we=new Set,ze=[],Q="all",Ts={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals","system.cognitive.model_inference"],moderation:["moderation.explicit_content.deleted"]},$s={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart","system.cognitive.model_inference":"bx-brain"};function ks(t){for(let[e,i]of Object.entries(Ts))if(i.includes(t))return e;return"system"}function Ss(t){return $s[t]||"bx-square-rounded"}async function ue(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Ls();let n=`/events?ml=${Q==="all"?100:250}&format=json&exclude_types=system.process.registered,system.process.unregistered`;Q!=="all"&&(n+=`&category=${Q}`);try{let s=await H(n);if(!s.ok)throw new Error("Service unreachable");if(ze=((await s.json()).events||[]).filter(h=>{let r=h.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{return!0}let u=r.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Je=Date.now(),pe(1,Je),ze.length===0){e.innerHTML=G("empty","No events found for this filter.");return}t&&(e.innerHTML="");let p=h=>{let r=h.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{return null}let u=r.type,L=ks(u),C=Ss(u),b=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.bot.voice_response"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.cognitive.model_inference"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),f="event-border-grey";b&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?f="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"||u==="engagement.decision"?f="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?f="event-border-orange":u==="system.test.completed"?f=r.test?.status==="OK"&&r.lint?.status==="OK"&&r.format?.status==="OK"?"event-border-blue":"event-border-red":f="event-border-blue");let v=b?"cursor-pointer":"",y=we.has(h.id),d=y?"expanded":"",l=y?"display: block;":"display: none;",k=new Date(h.timestamp*1e3),E=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),m=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),w=Bt(u,r),I=r.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${r.user_level})</span>`:"",M="";if(b){let A="";if(u==="engagement.decision"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                    ...
                    `}else if(u==="system.cognitive.model_inference"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                    ...
                    `}else if(u==="system.attention.expired"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,S=r.timestamp-r.last_active,_=Math.floor(S/60);A=`
                        <div class="event-detail-row">
            ...
            `}let _="";r.eval_count&&(_=`
                        ...
                        `}
                    `}else if(u==="messaging.bot.voice_response"){let $=D=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${D}</h5>`,S="",_=[],P=r.raw_input||"";if(P.startsWith("[{")&&P.endsWith("}]")){let D=P.match(/{.*?}/g);D&&(_=D.map(K=>{let U=K.substring(1,K.length-1),j=U.indexOf(" "),F=U.substring(0,j),V=U.substring(j+1);return V=V.replace(/\[\]$/,"").trim(),{role:F,content:V}}))}if(_.length>0&&r.response_raw&&_.push({role:"assistant",content:r.response_raw}),_.length>0){let D=_.length,K=_.map((U,j)=>{let F=U.role.toUpperCase();F==="ASSISTANT"&&(F="DEXTER");let V=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",ee=j===D-1?"block":"none";return`
                                <div class="history-slide" data-index="${j}" style="display: ${ee};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${V}; letter-spacing: 1px; font-weight: bold;">${F}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${j+1} of ${D}</span>
                    ...
                    `}else if(u==="analysis.user.message_signals"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,S=r.signals||{};A=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(u==="moderation.explicit_content.deleted"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.link.completed"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.visual.completed"){let $=_=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${_}</h5>`,S="";r.base64_preview?S=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${r.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:r.url?S=`<div class="event-detail-block"><img src="${r.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:S=`
              <div class="event-detail-block" style="margin-top: 10px; height: 100px; background: rgba(255,255,255,0.02); border: 1px dashed rgba(255,255,255,0.1); border-radius: 4px; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #444;">
                ...
                <span style="font-size: 0.65em; font-family: 'JetBrains Mono', monospace; text-transform: uppercase; letter-spacing: 1px; opacity: 0.5;">Visual Data Restricted</span>
                    ...
                    `}else if(u==="analysis.router.decision"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.cli.command"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.analysis.audit"){let $=r.success?"#03dac6":"#ff4d4d",S=r.success?"SUCCESS":"FAILED",_=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,P="";r.error&&(P=`
                            <div class="event-detail-block">
                                ${_("Error")}
                        ...
                        `).join("");K=`
                            <div class="event-detail-block">
                                ${_(`Corrections (${r.corrections.length})`)}
                                ${j}
                            </div>
                        ...
                        ${K}
                        ${D}
                    `}else if(u==="system.test.completed"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="error_occurred"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.cli.status"){let $=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;A=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                    ...
                    `}else if(u==="messaging.user.sent_message"){let $="";r.attachments&&r.attachments.length>0&&($=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${r.attachments.map(_=>{let P=_.content_type&&_.content_type.startsWith("image/"),D=(_.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${P?`<div class="attachment-thumb-container"><img src="${_.url}" alt="${_.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                                    <div class="attachment-info">
                                        <a href="${_.url}" target="_blank" class="attachment-link">${_.filename}</a>
                                        <span class="attachment-meta">${_.content_type} \u2022 ${D}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),A=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                ...
                `}let B=document.createElement("div");B.className=`event-item ${f} ${v} ${d}`,B.dataset.eventId=h.id,B.onclick=function(A){if(!b)return;let $=this;if($.classList.contains("expanded")){$.classList.remove("expanded"),we.delete(h.id);let _=$.querySelector(".event-details");_&&(_.style.display="none")}else{$.classList.add("expanded"),we.add(h.id);let _=$.querySelector(".event-details");_&&(_.style.display="block")}},B.innerHTML=`
                <div class="event-time">
  ...
  `}async function Nt(){try{let e=await(await H("/processes")).json(),i=e.active||[],n=e.history||[],s=i.find(a=>a.channel_id==="system-fabricator");if(s){Ee="ACTIVE";let p=Math.floor(Date.now()/1e3)-s.start_time,c=10,g="REVIEW";p>30&&(c=30,g="INVESTIGATION"),p>120&&(c=60,g="CONSTRUCTION"),p>300&&(c=90,g="REPORTING"),te={title:s.state||"Fabricating system improvements...",progress:c,phase:g};let T=new Date(s.updated_at*1e3).toLocaleTimeString();(ae.length===0||ae[ae.length-1].msg!==s.state)&&(ae.push({time:T,msg:s.state}),ae.length>50&&ae.shift())}else{let a=n.find(p=>p.channel_id==="system-fabricator");if(a&&Date.now()/1e3-a.end_time<60){Ee="COMPLETED";let p=a.end_time-a.start_time;nt={duration:`${Math.floor(p/60)}m ${p%60}s`,steps:0,result:a.state,timestamp:a.end_time}}else Ee="STANDBY",ae=[]}let o=document.getElementById("progress-view-root");o&&(Ee!==zt&&(o.innerHTML=Rt(),zt=Ee),Ee==="ACTIVE"&&_s())}catch(t){console.error("Failed to update progress:",t)}}function _s(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),i=document.getElementById("active-task-progress-text"),n=document.getElementById("active-task-phase"),s=document.getElementById("terminal-output");if(t&&te&&(t.innerText=te.title),e&&te&&(e.style.width=`${te.progress}%`),i&&te&&(i.innerText=`${te.progress}% COMPLETE`),n&&te&&(n.innerText=`PHASE: ${te.phase}`),s){let o=s.children.length;if(ae.length>o){for(let a=o;a<ae.length;a++){let p=ae[a],c=document.createElement("div");c.className="terminal-line",c.innerHTML=`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ...
            <div class="service-category-grid system-monitor-widgets" style="padding-bottom: 20px;">
                ${l.map(k=>y(k)).join("")}
            </div>`)}),t.innerHTML!==C&&(t.innerHTML=C);function b(d){if(!d||d==="N/A"||d==="unknown")return"-";let l=d.match(/^(\d+\.\d+\.\d+)/);return l?l[0]:d.split(".").slice(0,3).join(".")||"-"}function f(d){return!d||d.length<=22?d:d.substring(0,22)+"..."}function v(d){if(!d||d==="N/A"||d==="unknown")return"-";let l=d.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!l)return"-";let k=parseInt(l[1])||0,E=parseInt(l[2])||0,m=parseInt(l[3])||0,w=parseFloat(l[4])||0,I=k*86400+E*3600+m*60+w,M=Math.floor(I/86400);if(M>0)return`${M}d`;let B=Math.floor(I/3600);if(B>0)return`${B}h`;let N=Math.floor(I/60);return N>0?`${N}m`:`${Math.floor(I)}s`}function y(d){if(d.id==="upstash-redis-ro"){let D=z()&&(be.lastFrontend||be.lastDashboard)||Date.now();return`
            ...
            </div>`}let l=d.status==="online",k=l?"service-widget-online":"service-widget-offline",E=l?"bx-check-circle":"bx-x-circle",m=l?"OK":"BAD",w=d.version?b(d.version.str):"-",I=d.cpu&&d.cpu!=="N/A"?d.cpu:"-",M=d.memory&&d.memory!=="N/A"?d.memory:"-",B=I!=="-"?"#00ff00":"#666",N=I!=="-"?"#fff":"#666",q=M!=="-"?"#00ff00":"#666",Y=M!=="-"?"#fff":"#666",A=v(d.uptime),$="",S=d.type!=="os"&&d.type!=="cli"&&d.type!=="prd"&&d.type!=="md",_="";if(S&&!z()&&(_=`
        ...
        </div>`;let r=c.channel_id==="system-test",u=r?"#03dac6":"#fff",L=r?"border: 1px solid #03dac644;":"",C=r?"bx-shield-quarter":"bx-cog";return`
                <div class="service-widget process-widget" data-channel-id="${c.channel_id}-${c.start_time}" style="${L}">
                    <div class="service-widget-header">
                        <i class="bx ${C}" style="color: ${u}"></i>
