"use strict";(()=>{function rt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function lt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var dt=1e3;function pe(t){let e=null,s=t.onClose||null,i=t.onOpen||null;function n(){e&&(e.style.zIndex=(++dt).toString())}function r(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++dt).toString(),e.addEventListener("mousedown",n);let u=t.icon||"bx-window",a="",b="",E;t.tabs&&t.tabs.length>0?(a=`<div class="tab-bar">${t.tabs.map((p,f)=>{let v=p.icon?`<i class="bx ${p.icon}"></i>`:`<span class="tab-glyph">${p.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,E=`<div class="window-content">${t.tabs.map((p,f)=>`<div class="tab-content ${f===0?"active":""}" data-tab-content="${f}">${p.content}</div>`).join("")}</div>`):(t.title&&(b=`<div class="window-title">${t.title}</div>`),E=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${E}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),c()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{if(!e)return;let o=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(f=>f.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(f=>f.classList.remove("active"));let p=e.querySelector(`.tab-content[data-tab-content="${o}"]`);p&&p.classList.add("active"),g(h,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function l(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&g(m,e)}function g(m,u){setTimeout(()=>{let a=u.querySelector(".tab-bar");if(!a)return;let b=Array.from(a.querySelectorAll(".tab")),E=b.indexOf(m),h=a.clientWidth,o=b[Math.max(0,E-2)],p=b[Math.min(b.length-1,E+2)],f=a,v=o.offsetLeft-f.offsetLeft-25,M=p.offsetLeft+p.offsetWidth-f.offsetLeft+25-v,A=M<=h?v-(h-M)/2:m.offsetLeft-f.offsetLeft-h/2+m.offsetWidth/2;a.scrollTo({left:A,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",l),m?(e.remove(),e=null):(e.classList.remove("open"),s&&s(),setTimeout(()=>{e?.remove(),e=null},400)))}function d(m){t.content=m;let u=e?.querySelector(".window-content");u&&(u.innerHTML=m)}function y(){return!!(e&&e.classList.contains("open"))}return{open:r,close:c,setContent:d,isOpen:y,focus:n,id:t.id}}var pt="easter_theme",Q={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Je(){return localStorage.getItem(pt)||Q.DARK}function mt(t){if(!Object.values(Q).includes(t))throw new Error("Invalid theme");localStorage.setItem(pt,t),ut(t)}function ut(t){let e=document.body;Object.values(Q).forEach(r=>{e.classList.remove(`theme-${r}`)}),e.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let i={[Q.DARK]:"#050507",[Q.LIGHT]:"#FFFFFF",[Q.LEGACY]:"#000000"},n=i[t]||i[Q.DARK];if(s.setAttribute("content",n),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}e.classList.add("is-animated")}function ft(){let t=Je();ut(t)}function N(t,e,s=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=s?`<p class="placeholder-action">${s}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function z(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function ee(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!s)return;if(!e){s.textContent="Last updated: never";return}let i=Date.now(),n=Math.floor((i-e)/1e3),r;n<60?r=`${n}s ago`:n<3600?r=`${Math.floor(n/60)}m ago`:r=`${Math.floor(n/3600)}h ago`,s.textContent=`Last updated: ${r}`}var ps=0;function Me(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!s)return;let i=s.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var se=0,ne=0;function bt(t){se=t,Ce()}function vt(t){ne=t,Ce()}function Ce(){let t=se+ne;ps=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let s=document.getElementById("alerts-menu-item");if(s){let l=s.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",s.appendChild(l)),l.textContent=se>9?"9+":se.toString(),l.style.display=se>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",i.appendChild(l)),l.textContent=ne>9?"9+":ne.toString(),l.style.display=ne>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=se>9?"9+":se.toString(),l.style.display=se>0?"flex":"none"}let r=document.getElementById("switch-workspace");if(r){let l=r.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",r.appendChild(l)),l.textContent=ne>9?"9+":ne.toString(),l.style.display=ne>0?"flex":"none"}}function _e(){let t=document.getElementById("alerts-list");if(!t)return;se=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Ce()}function yt(){let t=document.getElementById("blueprints-list");if(!t)return;ne=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Ce()}function ms(){return"https://event.easter.company"}function us(){return"https://discord.easter.company"}var fs="http://127.0.0.1:8100",gs="http://127.0.0.1:8300",bs={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function He(t){let e=z(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,r)=>{let l=bs[r];return l?`<span class="${l}">`:""});let s=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return s>i&&(e+="</span>".repeat(s-i)),e}function me(t){if(!t)return"";let e=z(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(s,i)=>{let n=i.split("|").map(r=>r.trim());return n.every(r=>r.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(r=>`<span class="md-table-cell">${r}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var vs="https://sterling-javelin-12539.upstash.io",ys="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function B(){return window.location.hostname.includes("easter.company")}var P=null,ie={lastDashboard:0,lastFrontend:0},We=!1,xt=0,ht="dex_dashboard_snapshot";function xs(){let t=localStorage.getItem(ht);if(t)try{let e=JSON.parse(t);P=e,ie.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{P=null}}async function gt(){if(!(!B()||We)){We=!0,xt=Math.floor(Date.now()/1e3);try{let t=await Cs("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,ie.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),ie.lastFrontend=Date.now(),localStorage.setItem(ht,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{We=!1}}}function hs(){if(!P||!P.agent_status)return;let t=P.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function ws(){if(!B())return;xs();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await gt(),setInterval(()=>{let s=new Date,i=Math.floor(Date.now()/1e3),n=P?i-P.timestamp:1/0,r=i-xt,l=s.getSeconds()===59,g=n>300,c=r>60;(l&&c||g&&c)&&gt(),hs()},1e3)}B()&&ws();async function Cs(t,...e){try{let i=await(await fetch(vs,{method:"POST",headers:{Authorization:`Bearer ${ys}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(s){return console.error("Upstash Error:",s),null}}var he=null,we=null,Ie=!1,Be=!1;async function _(t,e={}){if(B()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),r=n.get("type")||n.get("event.type"),l=n.get("category"),g=n.get("order")||"desc",c=[];return r==="system.notification.generated"?c=[...P.alerts||[]]:r==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...P.blueprints||[]]:l==="messaging"?c=[...P.messaging_events||[]]:l==="system"?c=[...P.system_events||[]]:l==="cognitive"?c=[...P.cognitive_events||[]]:l==="moderation"?c=[...P.moderation_events||[]]:c=[...P.events||[]],g==="asc"?c.sort((d,y)=>d.timestamp-y.timestamp):c.sort((d,y)=>y.timestamp-d.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],r=P.profiles?P.profiles[n]:null;return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(P.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(he)try{let n=await fetch(he+t,e);if(n.ok)return n;he=null}catch{he=null}let s=ms(),i=fs;try{let n=await fetch(s+t,e);if(n.ok)return he=s,Ie&&(console.log("\u2728 Production event service restored."),Ie=!1),n;throw new Error("Primary failed")}catch{Ie||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ie=!0);try{let r=await fetch(i+t,e);if(r.ok)return he=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function Ee(t,e={}){if(B()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],r=(P.contacts?.members||[]).find(l=>l.id===n);return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(we)try{let n=await fetch(we+t,e);if(n.ok)return n;we=null}catch{we=null}let s=us(),i=gs;try{let n=await fetch(s+t,e);if(n.ok)return we=s,Be&&(console.log("\u2728 Production discord service restored."),Be=!1),n;throw new Error("Primary failed")}catch{Be||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Be=!0);try{let r=await fetch(i+t,e);if(r.ok)return we=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}var wt=()=>`
...
`,De=null,ue=new Set,ze=[];async function ce(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Es(),t&&(e.innerHTML="<p>Updating...</p>");let s="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await _(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];De=Date.now(),ee(0,De);let l=Date.now(),g=24*60*60*1e3,c=r.filter(f=>{let v=localStorage.getItem(`alert_read_ts_${f.id}`);if(!v)return!0;let x=parseInt(v);return l-x<g});c.sort((f,v)=>{let x=S=>{let $=S.event;if(typeof $=="string")try{$=JSON.parse($)}catch{return"low"}return($.priority||"low").toLowerCase()},M=S=>S==="critical"?4:S==="high"?3:S==="medium"?2:1,A=M(x(f)),I=M(x(v));return A!==I?I-A:v.timestamp-f.timestamp}),ze=c;let d=f=>{let v=f.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return"low"}return(v.priority||"low").toLowerCase()},y=[],u=new Set(c.map(f=>d(f))).size>1;if(c.length>0){let f=null;c.forEach(v=>{let x=d(v);u&&x!==f&&(y.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),f=x),y.push(v)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=N("empty","No alerts yet."),_e();return}let a=f=>{let v=f.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let x=(v.title||"Untitled Alert").trim(),M=(v.body||"No description provided.").trim(),A=v.summary||"",I=v.content||"",S=v.protocol||"",$=(v.priority||"low").toLowerCase(),D=!!v.alert,j=(v.category||"system").trim(),O=v.related_event_ids||[],q=v.audit_event_id,J=!!localStorage.getItem(`alert_read_ts_${f.id}`),k=new Date(f.timestamp*1e3),C=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),w=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=J?"event-border-grey":"event-border-blue";!J&&D&&(T="event-border-red"),J&&($==="high"||$==="critical")?T="event-border-red":J&&$==="medium"&&(T="event-border-orange");let L=J?"alert-read":"alert-unread",H=ue.has(f.id),R=H?"expanded":"",V=H?"display: block;":"display: none;",U="",F="";O.length>0&&(F=`
            ...
            <div style="flex: 1; min-width: 100px; text-align: center;">
                ...
                <div class="metadata-value" style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #bb86fc; font-weight: bold;">${S}</div>
            </div>`);let te="";I?te=`
        ...
        `,U=`
                ...
                ${te}
            `;let X=document.createElement("div");X.className=`event-item notification-item ${T} ${L} ${R} cursor-pointer priority-${$}`,X.dataset.alertId=f.id,X.onclick=function(le){let Y=this;if(Y.classList.contains("expanded")){Y.classList.remove("expanded"),ue.delete(f.id);let Se=Y.querySelector(".event-details");Se&&(Se.style.display="none")}else{Y.classList.add("expanded"),ue.add(f.id);let Se=Y.querySelector(".event-details");if(Se&&(Se.style.display="block"),!localStorage.getItem(`alert_read_ts_${f.id}`)){localStorage.setItem(`alert_read_ts_${f.id}`,Date.now().toString()),Y.classList.add("alert-read"),Y.classList.remove("alert-unread"),Y.classList.remove("event-border-blue","event-border-red","event-border-purple");let Fe="event-border-grey";$==="high"||$==="critical"?Fe="event-border-red":$==="medium"&&(Fe="event-border-orange"),Y.classList.add(Fe),_e()}}};let it=`${S?S.toUpperCase():"GUARDIAN"} ALERT: ${A||x}`,cs={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[j]||"bx-bell",ds=$==="high"||$==="critical"?"#ff4d4d":$==="medium"?"#ffa500":"#888";X.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${C}</span>
                    <span class="event-date">${w}</span>
                </div>
                <div class="event-icon"><i class='bx ${cs}'></i></div>
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${ds}; font-size: 0.8em; margin-left: 5px;">[${$.toUpperCase()}]</span>
                    </div>
                    <div class="event-message">${me(it)}</div>
                    <div class="event-details" style="${V}">
                        ${U}
                    </div>
                </div>
            `;let at=X.querySelector(".event-details");at&&at.addEventListener("click",le=>{le.stopPropagation()});let ot=X.querySelector(".close-details-btn");return ot&&ot.addEventListener("click",le=>{le.stopPropagation(),X.classList.remove("expanded");let Y=X.querySelector(".event-details");Y&&(Y.style.display="none"),ue.delete(f.id)}),X},b=f=>{let v=document.createElement("div");v.className="notification-divider",v.dataset.alertId=f.id;let x="#888888";return f.label==="CRITICAL"?x="#ff4d4d":f.label==="HIGH"?x="#ff8888":f.label==="MEDIUM"&&(x="#ffa500"),v.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${x}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,v.innerHTML=`<span style="white-space: nowrap;">${f.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${x}44, transparent); flex-grow: 1;"></div>`,v},E=Array.from(e.children),h=new Map(E.map(f=>[f.dataset.alertId,f])),o=new Set(y.map(f=>f.id));E.forEach(f=>{let v=f.dataset.alertId;(!v||!o.has(v))&&f.remove()});let p=null;y.forEach((f,v)=>{let x=h.get(f.id);if(!x||t){if(x&&x.remove(),f.type==="divider")x=b(f);else{let M=a(f);if(!M)return;x=M}if(!x)return}v===0?e.firstElementChild!==x&&e.prepend(x):p&&p.nextElementSibling!==x&&p.after(x),p=x}),De=Date.now(),ee(0,De),_e()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load alerts.","The event service may be offline."))}}function Es(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),s=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ze.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ce(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ze.forEach(n=>{ue.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ce(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{ue.clear(),ce(!0)},s.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;ze.forEach(r=>{localStorage.setItem(`alert_read_ts_${r.id}`,n.toString())}),ue.clear(),ce(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function Ge(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(r=>{let l=r.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${r.id}`)||n++}),bt(n)}catch{}}var Ct=()=>`
...
`,fe=new Set,Ne=[],$e=null;async function ge(t=!1){let e=document.getElementById("roadmap-list");if(e){$s();try{let s=await _("/roadmap");if(!s.ok)throw new Error("Offline");let i=await s.json();Ne=i;let n=d=>{let y=fe.has(d.id),m=d.state==="published",u=d.state==="consumed",a="event-border-grey";m&&(a="event-border-blue"),u&&(a="event-border-purple");let E=new Date(d.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${a} cursor-pointer ${y?"expanded":""}`,h.dataset.itemId=d.id,h.onclick=f=>{if(f.target.closest("button"))return;if(h.classList.contains("expanded")){h.classList.remove("expanded");let x=h.querySelector(".event-details");x&&(x.style.display="none"),fe.delete(d.id)}else{h.classList.add("expanded");let x=h.querySelector(".event-details");x&&(x.style.display="block"),fe.add(d.id)}};let o=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${d.state.toUpperCase()}]</span>`;h.innerHTML=`
        <div class="event-time">
      ...
      `;let p=h.querySelector(".event-details");return p&&p.addEventListener("click",f=>{f.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Ts(d)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ks(d)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Ss(d.id)),h.querySelector(".close-details-btn")?.addEventListener("click",f=>{f.stopPropagation(),h.classList.remove("expanded");let v=h.querySelector(".event-details");v&&(v.style.display="none"),fe.delete(d.id)}),h},r=Array.from(e.children),l=new Map(r.map(d=>[d.dataset.itemId,d])),g=new Set(i.map(d=>d.id));if(r.forEach(d=>{let y=d.dataset.itemId;(!y||!g.has(y))&&d.remove()}),!Ne||Ne.length===0){e.innerHTML=N("empty","Your roadmap is empty.",B()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;i.forEach((d,y)=>{let m=l.get(d.id);(!m||t)&&(m&&m.remove(),m=n(d),!m)||(y===0?e.firstElementChild!==m&&e.prepend(m):c&&c.nextElementSibling!==m&&c.after(m),c=m)})}catch{e.children.length===0&&(e.innerHTML=N("offline","Failed to load roadmap.","The event service may be offline."))}}}function $s(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),s=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{$e=null;let r=document.getElementById("roadmap-editor-input");r&&(r.value="");let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="block")},t.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="none"),$e=null},s.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input"),l=r?r.value:"";if(!l.trim())return;let g=$e?`/roadmap/${$e}`:"/roadmap",c=$e?"PATCH":"POST";try{await _(g,{method:c,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})});let d=document.getElementById("roadmap-editor-container");d&&(d.style.display="none"),ge(!0)}catch(d){console.error(d)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{Ne.forEach(r=>fe.add(r.id)),ge(!0)},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{fe.clear(),ge(!0)},n.dataset.listenerAttached="true")}function Ts(t){$e=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let s=document.getElementById("roadmap-editor-container");s&&(s.style.display="block",s.scrollIntoView({behavior:"smooth"}))}async function ks(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ge(!0)}catch(s){console.error(s)}}async function Ss(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),fe.delete(t),ge(!0)}catch(e){console.error(e)}}var Tt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,$t=null,be=new Set,St=[];async function ve(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Ms();let s="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await _(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];if(St=r,$t=Date.now(),ee(2,$t),r.length===0){e.innerHTML=N("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),Me(2,0);return}t&&(e.innerHTML="");let l=m=>{let u=m.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let a=(u.title||"Untitled Blueprint").trim(),b=(u.summary||u.body||"No summary provided.").trim(),E=(u.content||"").trim(),h=(u.category||"architecture").trim(),o=(u.related_services||u.affected_services||[]).map(H=>H.trim()),p=(u.implementation_path||[]).map(H=>H.trim()),f=u.source_event_ids||[],v=u.approved===!0,x=new Date(m.timestamp*1e3),M=x.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=x.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),I=be.has(m.id),S=I?"display: block;":"display: none;",$=document.createElement("div");$.className=`event-item notification-item event-border-purple cursor-pointer ${I?"expanded":""} ${v?"blueprint-approved":""}`,$.dataset.blueprintId=m.id,v&&($.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",$.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let j=v?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";$.onclick=function(H){let R=this;if(R.classList.contains("expanded")){R.classList.remove("expanded"),be.delete(m.id);let U=R.querySelector(".event-details");U&&(U.style.display="none")}else{R.classList.add("expanded"),be.add(m.id);let U=R.querySelector(".event-details");U&&(U.style.display="block")}};let O="";p.length>0&&(O=`
                ...
                `);let G=o.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${o.join(", ")}</span></div>`:"<div></div>",J=B(),k=v?`
            ...
            `;$.innerHTML=`
                ...
                <div class="event-icon" style="${v?"color: #03dac6;":""}"><i class='bx ${j}'></i></div>
                <div class="event-content">
                    ...
                    <div class="event-details" style="${S}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${z(b)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${z(E)}</div>
                        </div>
                        ${O}
                        ${q}
                        ${k}
            ...
            `;let C=$.querySelector(".blueprint-approve-btn");C&&(C.onclick=async H=>{H.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ve(!0)}catch(R){console.error("Failed to approve blueprint:",R)}});let w=$.querySelector(".blueprint-delete-btn");w&&(w.onclick=async H=>{H.stopPropagation();let R=!v;w.innerHTML=R?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${m.id}`,{method:"DELETE"})).ok&&ve(!0)}catch(V){console.error("Failed to delete blueprint:",V)}});let T=$.querySelector(".event-details");T&&T.addEventListener("click",H=>{H.stopPropagation()});let L=$.querySelector(".close-details-btn");return L&&L.addEventListener("click",H=>{H.stopPropagation(),$.classList.remove("expanded");let R=$.querySelector(".event-details");R&&(R.style.display="none"),be.delete(m.id)}),$},g=Array.from(e.children),c=new Map(g.map(m=>[m.dataset.blueprintId,m])),d=new Set(r.map(m=>m.id));g.forEach(m=>{let u=m.dataset.blueprintId;(!u||!d.has(u))&&m.remove()});let y=null;r.forEach((m,u)=>{let a=c.get(m.id);if(!a||t){a&&a.remove();let b=l(m);if(!b)return;a=b}u===0?e.firstElementChild!==a&&e.prepend(a):y&&y.nextElementSibling!==a&&y.after(a),y=a}),Me(2,r.length),yt()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load blueprints.","The event service may be offline."))}}async function Mt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(r=>{let l=r.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),vt(n)}catch{}}function Ms(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),s=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{St.forEach(i=>be.add(i.id)),ve(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{be.clear(),ve(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),be.clear(),ve(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var ae="STANDBY",Lt=null,Te=[],Z=null,Re=null,At=()=>`
    <div id="progress-view-root" class="progress-container">
        <!-- Initial render will happen here -->
        ${It()}
    </div>
  `;function It(){switch(ae){case"ACTIVE":return As();case"COMPLETED":return Is();case"STANDBY":default:return Ls()}}function Ls(){return`
    ...
    <div class="mission-summary-card">
        ...
        <div class="summary-stat-grid">
            <div class="summary-stat">
                <span class="summary-stat-value">${Re?.duration||"12m 4s"}</span>
                <span class="summary-stat-label">Duration</span>
            </div>
            <div class="summary-stat">
                <span class="summary-stat-value">${Re?.steps||"42"}</span>
        ...
        <div style="background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; margin-bottom: 30px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-family: 'JetBrains Mono'; font-size: 0.9em; color: #bb86fc;">${Re?.result||"Optimized Event Bus"}</span>
  ...
  `}async function ke(){let t=document.getElementById("progress-view-root");t&&(ae!==Lt&&(t.innerHTML=It(),Lt=ae),ae==="ACTIVE"&&Bs())}function Bs(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),s=document.getElementById("active-task-progress-text"),i=document.getElementById("terminal-output");if(t&&Z&&(t.innerText=Z.title),e&&Z&&(e.style.width=`${Z.progress}%`),s&&Z&&(s.innerText=`${Z.progress}% COMPLETE`),i){let n=i.children.length;if(Te.length>n){for(let r=n;r<Te.length;r++){let l=Te[r],g=document.createElement("div");g.className="terminal-line",g.innerHTML=`
            <span class="line-time">${l.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${z(l.msg)}</span>
        `,i.appendChild(g)}i.scrollTop=i.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{ae="ACTIVE",Te=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],Z={title:"Refactoring System Event Bus",progress:10},ke();let t=0,e=setInterval(()=>{if(ae!=="ACTIVE"){clearInterval(e);return}t++,Z.progress=Math.min(100,Z.progress+Math.floor(Math.random()*15));let s=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<s.length&&Te.push({time:new Date().toLocaleTimeString(),msg:s[t]}),Z.progress>=100&&(ae="COMPLETED",Re={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),ke()},1500)});window.addEventListener("dex-mock-stop",()=>{ae="STANDBY",ke()});window.addEventListener("dex-mock-reset",()=>{ae="STANDBY",ke()});var Bt=()=>`
...
`,_t=()=>`
    ...
    `,Pe=[],Ve={"313071000877137920":"Owen"};async function Oe(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),s=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),n=document.getElementById("cancel-chore-btn"),r=document.getElementById("new-chore-owner"),l=document.getElementById("task-owner-label"),g=document.getElementById("task-filter-owner");if(r&&!r.dataset.populated&&!B())try{Ee("/contacts").then(async d=>{d.ok&&(((await d.json()).members||[]).forEach(u=>{if(Ve[u.id]=u.nickname||u.username,u.id==="313071000877137920")return;let a=document.createElement("option");a.value=u.id;let b=u.nickname||u.username;a.textContent=`${b} (${u.username})`,r.appendChild(a)}),r.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}r&&l&&!r.dataset.listenerAttached&&(r.onchange=()=>{let d=r.options[r.selectedIndex];if(d){let y=d.text.split(" (")[0];d.value==="dexter"&&(y="Dexter"),l.textContent=`Report result to: ${y}`}},r.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onchange=()=>c(),g.dataset.listenerAttached="true");function c(){if(!t)return;let d=g?.value||"all",y=d==="all"?Pe:Pe.filter(u=>u.owner_id===d);if(y.length===0){t.innerHTML=N("empty",d==="all"?"No active tasks.":"No tasks found for this owner.",B()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let m=y.map(u=>{let a=u.last_run===0?"Never":new Date(u.last_run*1e3).toLocaleString(),b=u.memory?u.memory.length:0,E=u.status==="active"?"#03dac6":"#666",h=Ve[u.owner_id]||u.owner_id.substring(0,8);return`
            ...
            `}).join("");t.innerHTML=m,t.querySelectorAll(".delete-chore-btn").forEach(u=>{u.onclick=async a=>{a.stopPropagation();let b=u.dataset.id;confirm("Delete this task?")&&(await _(`/chores/${b}`,{method:"DELETE"}),Oe())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{s&&(s.style.display=s.style.display==="none"?"block":"none")},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{s&&(s.style.display="none")},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let d=document.getElementById("new-chore-instruction"),y=document.getElementById("new-chore-url"),m=document.getElementById("new-chore-owner"),u=document.getElementById("new-chore-schedule"),a=d?.value,b=y?.value,E=m?.value||"313071000877137920",h=u?.value||"every_24h";if(a){i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:E,natural_instruction:a,entry_url:b,schedule:h})}),s&&(s.style.display="none"),d&&(d.value=""),y&&(y.value=""),Oe()}catch(o){console.error(o),alert("Failed to create research task")}finally{i.innerHTML="<i class='bx bx-zap'></i> Deploy Task"}}},i.dataset.listenerAttached="true");try{let d=await _("/chores");if(!d.ok)throw new Error(`HTTP error! status: ${d.status}`);if(Pe=await d.json()||[],g){let m=g.value,u=Array.from(new Set(Pe.map(a=>a.owner_id)));g.innerHTML='<option value="all">All Owners</option>',u.forEach(a=>{let b=document.createElement("option");b.value=a,b.textContent=Ve[a]||`Owner: ${a.substring(0,8)}`,g.appendChild(b)}),g.value=m,g.selectedIndex===-1&&(g.value="all")}c()}catch(d){console.error("Failed to fetch chores",d)}}var Ht=()=>`
...
`;async function Ke(){await Promise.all([ge(),ve(),ke(),Oe()])}var _s=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function Rt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Pt(t){if(!document.getElementById("dex-profile-styles")){let s=document.createElement("style");s.id="dex-profile-styles",s.textContent=_s,document.head.appendChild(s)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",s=>{s.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",Ee(`/profile/${t.id}`).then(async s=>{if(s.ok){let i=await s.json();Ze(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=Rt(t.id,t.username);Ze(e,t,i)}}).catch(s=>{console.error("Profile fetch error:",s);let i=Rt(t.id,t.username);Ze(e,t,i)})}function Ze(t,e,s){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",n=()=>{let E=(s.attributes||s.facts||[]).map(x=>{let M=x.key||x.k,A=x.value||x.v;return`
            <div class="fact-chip">
                <span class="fact-key">${M}:</span>
                <span class="fact-val">${A}</span>
            </div>
        `}).join(""),h=s.cognitive_model||s,o=h.technical_level||h.techLevel||0,p=h.communication_style||h.commStyle||"Unknown",f=h.patience_level||h.patience||"Unknown",v=h.vibe||"Unknown";return`
        ...
        `},r=()=>{let E=s.dossier||{},h=E.identity||{},o=E.career||{},p=E.personal||{},f=E.social||[];return`
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="height: 15px;"></div>
                         ...
                         <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                            ${(o.skills||[]).map(v=>`<span style="font-size: 0.75em; background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">${v}</span>`).join("")}
                         </div>
                    </div>
                </div>
        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                ...
                <div class="profile-identity">
                    <h2>${z(e.username)}</h2>
                    <div class="profile-badges">${(s.badges||[]).map(E=>`<span class="profile-badge ${E==="Creator"?"master":""}">${E}</span>`).join("")}</div>
                </div>
            </div>
    ...
    `;t.innerHTML=d;let y=t.querySelector(".profile-card"),m=t.querySelector("#profile-expand-toggle"),u=t.querySelectorAll(".profile-tab-btn"),a=t.querySelectorAll(".tab-content"),b=t.querySelector(".close-profile-btn");b&&b.addEventListener("click",()=>{t.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>t.remove(),300)}),u.forEach(E=>{E.addEventListener("click",()=>{u.forEach(p=>p.classList.remove("active")),a.forEach(p=>p.classList.remove("active")),E.classList.add("active");let h=E.dataset.tab,o=t.querySelector(`#tab-${h}`);o&&o.classList.add("active")})}),m&&m.addEventListener("click",()=>{y.classList.toggle("expanded");let E=y.classList.contains("expanded");m.innerHTML=E?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var Ot=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
...
`,Hs=null;async function Ye(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Ye(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=s=>{let n=s.target.closest(".user-profile-card");if(n&&n.dataset.user)try{let r=JSON.parse(n.dataset.user);Pt(r)}catch(r){console.error("Failed to parse user data",r)}},t.dataset.listenerAttached="true");try{let s=await Ee("/contacts");if(!s.ok)throw new Error("Service unreachable");let n=(await s.json()).members||[];if(Hs=Date.now(),n.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let r={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((l,g)=>{let c=r[l.level]??10,d=r[g.level]??10;return c!==d?c-d:l.username.localeCompare(g.username)}),t.innerHTML=n.map(l=>{let g=l.color&&l.color!==0,c=g?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",d=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",y="#888";l.level==="Me"||l.level==="Master"?y="#bb86fc":l.level==="Admin"?y="#cf6679":l.level==="Moderator"?y="#03dac6":l.level==="Contributor"&&(y="#ffa500");let m=l.level==="Me",u=m?"rgba(187, 134, 252, 0.08)":g?`${c}11`:"rgba(255,255,255,0.03)",a=m?"2px solid #bb86fc":g?`1px solid ${c}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${m?"#bb86fc":g?c:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${l.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${m?"2px solid #bb86fc":g?`2px solid ${c}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${g?c:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${l.nickname||l.username}</h3>
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${y}; font-weight: 600; text-transform: uppercase;">${m?"DEXTER (ME)":l.level}</span>
...
`,je=null,ye=new Set,Le=[],K="all",zs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ns={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Rs(t){for(let[e,s]of Object.entries(zs))if(s.includes(t))return e;return"system"}function Ps(t){return Ns[t]||"bx-square-rounded"}async function de(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Os();let i=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(i+=`&category=${K}`);try{let n=await _(i);if(!n.ok)throw new Error("Service unreachable");if(Le=((await n.json()).events||[]).filter(u=>{let a=u.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return!0}let b=a.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),je=Date.now(),ee(1,je),Le.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let g=u=>{let a=u.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return null}let b=a.type,E=Rs(b),h=Ps(b),o=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),p="event-border-grey";o&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?p="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?p="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?p="event-border-orange":b==="system.test.completed"?p=a.test?.status==="OK"&&a.lint?.status==="OK"&&a.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let f=o?"cursor-pointer":"",v=ye.has(u.id),x=v?"expanded":"",M=v?"display: block;":"display: none;",A=new Date(u.timestamp*1e3),I=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=jt(b,a),D=a.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${a.user_level})</span>`:"",j="";if(o){let k="";if(b==="engagement.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                    ...
                    `}else if(b==="system.attention.expired"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,w=a.timestamp-a.last_active,T=Math.floor(w/60);k=`
                    ...
                    `}else if(b==="messaging.bot.sent_message"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,w="";a.eval_count&&(w=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let T="";if(a.chat_history&&a.chat_history.length>0){let L=a.chat_history.length,H=a.chat_history.map((R,V)=>{let U=R.name?R.name.toUpperCase():R.role.toUpperCase();!R.name&&U==="ASSISTANT"&&(U="DEXTER");let F=R.role==="user"?"#03dac6":R.role==="system"?"#ffb74d":"#bb86fc",W=V===L-1?"block":"none";return`
                                <div class="history-slide" data-index="${V}" style="display: ${W};">
                                    ...
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${z(R.content)}</div>
                                </div>
                            `}).join("");T=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(b==="analysis.user.message_signals"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,w=a.signals||{};k=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                                <div style="font-size: 0.65em; text-transform: uppercase; color: #666; letter-spacing: 1px; margin-bottom: 4px;">Sentiment</div>
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${w.sentiment>.3?"#03dac6":w.sentiment<-.3?"#cf6679":"#aaa"}; font-weight: bold;">${w.sentiment?.toFixed(2)||0}</div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                                <div style="font-size: 0.65em; text-transform: uppercase; color: #666; letter-spacing: 1px; margin-bottom: 4px;">Intent</div>
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; text-transform: uppercase;">${w.intent||"N/A"}</div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                                <div style="font-size: 0.65em; text-transform: uppercase; color: #666; letter-spacing: 1px; margin-bottom: 4px;">Tech Depth</div>
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee;">${w.technical_depth||0}/10</div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                                <div style="font-size: 0.65em; text-transform: uppercase; color: #666; letter-spacing: 1px; margin-bottom: 4px;">Mood</div>
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #bb86fc;">${w.mood||"N/A"}</div>
                            </div>
                        </div>
                        <div class="event-detail-block">
                            ${C("Extracted Topics")}
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${(w.topics||[]).map(L=>`<span class="profile-badge">${L}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${C("Raw Model Output")}
                            <pre class="detail-pre">${z(a.raw_output)||"None"}</pre>
                        </div>
                    `}else if(b==="moderation.explicit_content.deleted"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="analysis.link.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${z(a.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${C("Description")}
                            <pre class="detail-pre">${z(a.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Content Summary")}
                            <pre class="detail-pre">${z(a.summary)||"None"}</pre>
                        </div>
                    `}else if(b==="analysis.visual.completed"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,w="";a.base64_preview?w=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${a.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:a.url&&(w=`<div class="event-detail-block"><img src="${a.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(b==="analysis.router.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Input Context")}
                            <pre class="detail-pre">${z(a.raw_input)||"None"}</pre>
                        </div>
                    `}else if(b==="system.cli.command"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Output")}
                            <pre class="detail-pre">${z(a.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(b==="system.analysis.audit"){let C=a.success?"#03dac6":"#ff4d4d",w=a.success?"SUCCESS":"FAILED",T=U=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${U}</h5>`,L="";a.error&&(L=`
                            <div class="event-detail-block">
                                ${T("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${z(a.error)}</pre>
                            </div>
                        `);let H="";if(a.chat_history&&a.chat_history.length>0){let U=a.chat_history.length,F=a.chat_history.map((W,re)=>{let te=W.name?W.name.toUpperCase():W.role.toUpperCase();!W.name&&te==="USER"&&(te="SYSTEM"),!W.name&&te==="ASSISTANT"&&(te="AGENT");let X=W.role==="user"?"#03dac6":W.role==="system"?"#ffb74d":"#bb86fc";return`
                        ...
                        `}let R="";if(a.corrections&&a.corrections.length>0){let U=a.corrections.map((F,W)=>`
                        ...
                        `).join("");R=`
                            <div class="event-detail-block">
                                ${T(`Corrections (${a.corrections.length})`)}
                                ${U}
                            </div>
                        `}let V="";if(a.parsed_results&&a.parsed_results.length>0){let U=a.parsed_results.map(F=>`
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${C}; font-weight: bold;">${w} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${a.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${R}
                        ${H}
                    `}else if(b==="system.test.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="error_occurred"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${C("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${z(a.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Context")}
                            <pre class="detail-pre">${JSON.stringify(a.context||{},null,2)}</pre>
                        </div>
                    `}else if(b==="system.cli.status"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${C("Message")}
                            <pre class="detail-pre">${z(a.message)}</pre>
                        </div>
                    `}else if(b==="messaging.user.sent_message"){let C="";a.attachments&&a.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${a.attachments.map(T=>{let L=T.content_type&&T.content_type.startsWith("image/"),H=(T.size/1024).toFixed(1)+" KB";return`
                ...
                `}let O=document.createElement("div");O.className=`event-item ${p} ${f} ${x}`,O.dataset.eventId=u.id,O.onclick=function(k){if(!o)return;let C=this;if(C.classList.contains("expanded")){C.classList.remove("expanded"),ye.delete(u.id);let T=C.querySelector(".event-details");T&&(T.style.display="none")}else{C.classList.add("expanded"),ye.add(u.id);let T=C.querySelector(".event-details");T&&(T.style.display="block")}},O.innerHTML=`
                <div class="event-time">
            ...
            `;let q=O.querySelector(".event-details");if(q&&q.addEventListener("click",k=>{k.stopPropagation()}),o){let k=O.querySelector(".close-details-btn");k&&k.addEventListener("click",C=>{C.stopPropagation();let w=C.target.closest(".event-item");if(w){w.classList.remove("expanded"),ye.delete(u.id);let T=w.querySelector(".event-details");T&&(T.style.display="none")}})}let G=O.querySelector(".prev-btn"),J=O.querySelector(".next-btn");if(G&&J){let k=0,C=Array.from(O.querySelectorAll(".history-slide")),w=C.length,T=()=>{C.forEach((L,H)=>{L.style.display=H===k?"block":"none"}),G.disabled=k===0,J.disabled=k===w-1,G.style.opacity=k===0?"0.5":"1",J.style.opacity=k===w-1?"0.5":"1"};G.addEventListener("click",L=>{L.stopPropagation(),k>0&&(k--,T())}),J.addEventListener("click",L=>{L.stopPropagation(),k<w-1&&(k++,T())}),T()}return O},c=Array.from(e.children),d=new Map(c.map(u=>[u.dataset.eventId,u])),y=new Set(Le.map(u=>u.id));c.forEach(u=>{let a=u.dataset.eventId;(!a||!y.has(a))&&u.remove()});let m=null;Le.forEach((u,a)=>{let b=d.get(u.id);(!b||t)&&(b&&b.remove(),b=g(u),!b)||(a===0?e.firstElementChild!==b&&e.prepend(b):m&&m.nextElementSibling!==b&&m.after(b),m=b)}),je=Date.now(),ee(1,je)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=N("offline","Failed to load events.","The event service may be offline."))}}function Os(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),s=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Le.forEach(n=>ye.add(n.id)),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ye.clear(),de(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{s.querySelectorAll(".filter-btn").forEach(r=>r.classList.remove("active")),n.classList.add("active"),K=n.dataset.filter||"all",de(!0)}}),s.dataset.listenerAttached="true"),s&&s.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===K?n.classList.add("active"):n.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let n=K==="all"?"ALL":K.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let r="/events";if(K!=="all"?r+=`?category=${K}`:r+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(r,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ye.clear(),de(!0)}catch(r){console.error("Failed to clear events:",r),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var js=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Ut=js;function qt(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var Us=null;async function Ae(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let s=await e.json();if(!s||s.length===0)return t.innerHTML=N("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0"],n=s.filter(l=>!i.includes(l.id));n.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),n.reverse();let r=n.map(l=>{let g=l.logs.join(`
`),c=[...l.logs];if(c.length<25){let y=25-c.length;for(let m=0;m<y;m++)c.push("")}else c.length>25&&(c=c.slice(-25));let d=c.map(y=>He(y)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=r,document.querySelectorAll(".copy-logs-btn").forEach(l=>{l.addEventListener("click",()=>{let g=l,c=unescape(g.dataset.logs||"");navigator.clipboard.writeText(c).then(()=>{let d=g.querySelector("i");d&&(d.classList.remove("bx-copy"),d.classList.add("bx-check"),setTimeout(()=>{d.classList.remove("bx-check"),d.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(l=>{l.addEventListener("click",async()=>{let c=l.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${c}?`))try{(await _(`/logs?service_id=${c}`,{method:"DELETE"})).ok&&Ae()}catch(d){console.error("Error clearing logs:",d)}})}),Us=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=N("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Gt=()=>{let t=B()?"display: none;":"";return`
        ...
        <div id="services-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,Zt=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${qt()}
        </div>`;async function Qt(){qs(),await Promise.all([oe(),et(),tt()]),await Ae()}var Ue=null;function qs(){Ue||(Ue=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Ue),Ue=null;return}oe(!0)},1e3))}var Ft=null,Jt=null;async function es(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function Wt(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function Fs(){try{return await(await _("/processes")).json()}catch{return null}}async function Js(){try{return await(await _("/agent/status")).json()}catch{return null}}async function et(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),s=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),r=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),g=o=>{if(o){if(s&&(s.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                ...
                </div>`}r&&(o.GPU&&o.GPU.length>0?r.innerHTML=o.GPU.map(p=>{let f=(p.VRAM/1073741824).toFixed(1);return`
                    ...
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let o=await Wt();o?(g(o),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),i&&!i.hasChildNodes())){let o=await Wt();g(o)}if(!t)return;let c=await es();if(!c||!c.services){t.children.length===0&&(t.innerHTML=N("offline","Failed to load system metrics.","The event service may be offline."));let o=document.querySelector('[data-service-id="upstash-redis-ro"]');if(o){o.className="service-widget service-widget-offline",o.querySelector(".service-widget-status").textContent="ERROR";let p=o.querySelector(".service-widget-body");p&&(p.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Ft=B()&&ie.lastDashboard||Date.now(),ee(0,Ft||0);let d=c.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let o=document.getElementById("upstash-countdown");if(o){let v=59-new Date().getSeconds();v<=0&&(v+=60),o.textContent=`${v}s`}},1e3)),Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function y(o){if(!o||o==="N/A"||o==="unknown")return"-";let p=o.match(/^(\d+\.\d+\.\d+)/);return p?p[0]:o.split(".").slice(0,3).join(".")||"-"}function m(o){return!o||o.length<=28?o:o.substring(0,28)+"..."}function u(o){if(!o||o==="N/A"||o==="unknown")return"-";let p=o.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!p)return"-";let f=parseInt(p[1])||0,v=parseInt(p[2])||0,x=parseInt(p[3])||0,M=parseFloat(p[4])||0,A=f*86400+v*3600+x*60+M,I=Math.floor(A/86400);if(I>0)return`${I}d`;let S=Math.floor(A/3600);if(S>0)return`${S}h`;let $=Math.floor(A/60);return $>0?`${$}m`:`${Math.floor(A)}s`}function a(o){if(o.id==="upstash-redis-ro"){let J=B()&&(ie.lastFrontend||ie.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
            ...
            </div>`}let p=o.status==="online",f=p?"service-widget-online":"service-widget-offline",v=p?"bx-check-circle":"bx-x-circle",x=p?"OK":"BAD",M=o.version?y(o.version.str):"-",A=o.cpu&&o.cpu!=="N/A"?o.cpu:"-",I=o.memory&&o.memory!=="N/A"?o.memory:"-",S=A!=="-"?"#00ff00":"#666",$=A!=="-"?"#fff":"#666",D=I!=="-"?"#00ff00":"#666",j=I!=="-"?"#fff":"#666",O=u(o.uptime),q="";p?q=`
                ...
                </div>`:q='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let G=B()?"easter.company":m(o.domain&&o.port?`${o.domain}:${o.port}`:"");return`<div class="service-widget ${f}" data-service-id="${o.id}"><div class="service-widget-header"><i class="bx ${v}"></i><h3>${o.short_name||o.id}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${G}</span></div>${q}</div></div>`}let b=new Map(Array.from(t.querySelectorAll(".service-widget")).map(o=>[o.dataset.serviceId,o])),E=new Set(d.map(o=>o.id));for(let[o,p]of b)E.has(o)||p.remove();let h=new Set;d.forEach(o=>{if(h.has(o.id))return;h.add(o.id);let p=a(o),f=b.get(o.id);if(f&&f.parentNode)if(o.id==="upstash-redis-ro"){let v=B()&&(ie.lastFrontend||ie.lastDashboard)||Date.now(),x=new Date(v).toLocaleTimeString(),M=f.querySelector(".sync-time-label");M&&(M.textContent=`Last synced: ${x}`)}else f.outerHTML!==p&&(f.outerHTML=p);else t.insertAdjacentHTML("beforeend",p)})}async function tt(){let t=document.getElementById("models-widgets");if(!t)return;let e=await es();if(!e){t.children.length===0&&(t.innerHTML=N("offline","Failed to load model status.","The event service may be offline."));return}Jt=Date.now(),ee(2,Jt);let s=e.models||[],i=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function n(c){let d=c.status==="Ready";return`
                ...
                </div>`}function l(c){let d=c.status==="Downloaded",y=d?"service-widget-online":"service-widget-offline",m=d?"OK":"MISSING",u=d&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",a=c.name;return c.type==="custom"&&a.endsWith(":latest")&&(a=a.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${d?"bx-check-circle":"bx-x-circle"}"></i><h3>${a}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${u}</span></div></div></div>`}let g="";if(i&&(g+=n(i)),e.xtts&&(g+=r(e.xtts)),g+=s.map(l).join(""),!g){t.innerHTML=N("empty","No models found.");return}t.innerHTML!==g&&(t.innerHTML=g)}async function oe(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let s=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),r=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),g=document.getElementById("guardian-reset-btn"),c=document.getElementById("analyzer-reset-btn"),d=document.getElementById("fabricator-reset-btn"),y=document.getElementById("system-pause-toggle-btn");y&&!y.dataset.listenerAttached&&(y.onclick=async()=>{let f=y.querySelector(".bx-play")?"/agent/resume":"/agent/pause";y.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _(f,{method:"POST"}),await oe()}catch{y.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>oe(),2e3)}},y.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onclick=async()=>{g.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{g.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{g.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{g.innerHTML="<i class='bx bx-error'></i>"}},g.dataset.listenerAttached="true"),c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{c.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{c.innerHTML="<i class='bx bx-error'></i>"}},c.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/fabricator/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true");let m=await Js();if(m&&m.agents){let p=m.agents.guardian||{protocols:{}},f=m.agents.analyzer||{protocols:{}},v=m.agents.imaginator||{protocols:{}},x=m.agents.fabricator||{protocols:{}},M=m.system||{},A=Math.floor(Date.now()/1e3),I={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction"},S=w=>{w<0&&(w=0);let T=Math.floor(w/3600),L=Math.floor(w%3600/60),H=w%60;return T>0?`${T}h ${L}m`:L>0?`${L}m ${H}s`:`${H}s`},$=(w,T,L,H)=>{if(!w)return;let R=I[H]||H.toUpperCase(),V=w.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(V&&(V.textContent=R),!L){w.textContent="Inactive",w.style.color="#666";return}let U=L.status;if(U==="Working")w.textContent="Working",w.style.color="#bb86fc";else if(U==="Ready")w.textContent="Ready",w.style.color="#5eff5e";else{let F=L.cooldown;if(B()&&(F=L.next_run-A),F<=0)w.textContent="Ready",w.style.color="#5eff5e";else{let W=Math.floor(F/60),re=F%60;w.textContent=`${W}m ${re}s`,w.style.color="#fff"}}T&&L.stats&&(T.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
          ...
          `)};s&&$(s,document.getElementById("guardian-sentry-stats"),p.protocols.sentry,"sentry");let D=document.getElementById("analyzer-synthesis-val"),j=document.getElementById("analyzer-synthesis-stats");D&&$(D,j,f.protocols.synthesis,"synthesis");let O=document.getElementById("imaginator-alert_review-val"),q=document.getElementById("imaginator-alert_review-stats");O&&$(O,q,v.protocols.alert_review,"alert_review");let G=document.getElementById("fabricator-construction-val"),J=document.getElementById("fabricator-construction-stats");G&&$(G,J,x.protocols.construction,"construction");let k=document.getElementById("system-state-label"),C=document.getElementById("system-state-val");if(C&&M.state){let w=M.state,T=S(M.state_time||0);k&&(k.textContent=`State: ${w.toUpperCase()}`),C.textContent=T,w==="idle"?C.style.color=M.state_time>300?"#5eff5e":"#fff":C.style.color="#bb86fc",y&&(w==="paused"?(y.innerHTML="<i class='bx bx-play'></i>",y.title="Resume System",y.style.color="#ff9800"):(y.innerHTML="<i class='bx bx-pause'></i>",y.title="Pause System",y.style.color=""))}n&&(n.textContent=S(M.metrics?.total_idle_time||0)),r&&(r.textContent=S(M.metrics?.total_active_time||0)),l&&(l.textContent=S(M.metrics?.total_waste_time||0))}else[s,i,n,r,l].forEach(f=>{f&&(f.textContent="-",f.style.color="#666")});if(t)return;let u=await Fs(),a=[],b=[],E=[];u&&(Array.isArray(u)?a=u:(a=u.active||[],b=u.queue||[],E=u.history||[],E.sort((p,f)=>(f.end_time||0)-(p.end_time||0)))),e&&(a.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=N("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),Qe(e,a,!1)));let h=document.getElementById("processes-queue-widgets");h&&(b.length===0?!h.querySelector(".tab-placeholder")&&!h.querySelector('div[style*="font-style: italic"]')&&(h.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(h.innerHTML="",Qe(h,b,!1)));let o=document.getElementById("processes-history-widgets");o&&(E.length===0?o.querySelector(".tab-placeholder")||(o.innerHTML=N("empty","No recent history.")):(o.querySelector(".tab-placeholder")&&(o.innerHTML=""),Qe(o,E,!0))),Me(1,a.length)}function Qe(t,e,s){function i(c){let d="";c.end_time?d=`${c.end_time-c.start_time}s`:d=`${Math.floor(Date.now()/1e3-c.start_time)}s`;let y=c.retries>0?`<span class="process-retry-badge">Retry ${c.retries}</span>`:"",m=c.channel_id,u={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(u[m]?m=u[m]:/^\d+$/.test(m)&&(m=`Channel ${m}`),s)return`
        <div class="process-history-item" data-channel-id="${c.channel_id}-${c.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let n=s?".process-history-item":".process-widget",r=new Map(Array.from(t.querySelectorAll(n)).map(c=>[c.dataset.channelId,c])),l=new Set(e.map(c=>`${c.channel_id}-${c.start_time}`));for(let[c,d]of r)c&&!l.has(c)&&d.remove();let g=new Set;e.forEach(c=>{let d=`${c.channel_id}-${c.start_time}`;if(g.has(d))return;g.add(d);let y=i(c),m=r.get(d);if(m&&m.parentNode){m.outerHTML!==y&&(m.outerHTML=y);let u=t.querySelector(`[data-channel-id="${d}"]`);u&&t.appendChild(u)}else t.insertAdjacentHTML("beforeend",y)})}function qe(){let t=Je(),e="Notification"in window,s={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function st(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(i=>{i.addEventListener("click",function(){let n=this.dataset.theme;n&&(mt(n),t.setContent(qe()),st(t))})});let s=document.getElementById("notifications-toggle");s&&"Notification"in window?s.onclick=async i=>{let n=i.target;if(n.checked)try{await Notification.requestPermission()!=="granted"&&(n.checked=!1)}catch{n.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),n.checked=!0)}:s&&(s.disabled=!0)}var ss=()=>`
    ...
    `;async function ns(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await ts(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await ts(t)}async function ts(t){try{let e=await _("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let s=await e.json();if(!s||s.length===0){t.innerHTML=N("empty","No web history found.");return}let i=`
            <div style="display: flex; flex-direction: column; height: 100%;">
        ...
        `;s.forEach((g,c)=>{let d=new Date(g.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),y=g.screenshot?`<img src="data:image/png;base64,${g.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';i+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ws=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[s,i]of Object.entries(t)){let n=os.filter(r=>r.category===s);n.length!==0&&(e+=`
    ...
    </div>`,e},nt=!1;function Gs(t){let e=document.getElementById("cli-terminal-overlay");if(!e){e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e);let c=document.getElementById("close-terminal-btn");c&&(c.onclick=()=>is());let d=document.getElementById("terminal-action-btn");d&&(d.onclick=()=>is())}let s=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");s&&(s.innerHTML="");let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let r=document.getElementById("terminal-cmd-name");r&&(r.textContent=`dex ${t.id}`);let l=document.getElementById("terminal-status-badge");l&&(l.className="terminal-status status-running",l.textContent="Running");let g=document.getElementById("terminal-action-btn");return g&&(g.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",nt=!0,s}function is(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",nt=!1}function as(t,e,s="output"){if(!nt||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${s}`,s==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let n=He(e);i.innerHTML=n||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Vs(t){let e=os.find(l=>l.id===t);if(!e)return;let s=Gs(e);s&&as(s,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let l of i){await new Promise(c=>setTimeout(c,400+Math.random()*600));let g="output";l.includes("[ERROR]")?g="error":l.includes("[SUCCESS]")||l.includes("\u2713")?g="success":l.includes("!")&&(g="warning"),s&&as(s,l,g)}let n=document.getElementById("terminal-status-badge");n&&(n.className="terminal-status status-success",n.textContent="Completed (Demo)");let r=document.getElementById("terminal-action-btn");r&&(r.style.display="block")}function rs(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ws();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let s=e.querySelector("code"),i=s?s.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let n=e.querySelector("i");n&&(n.className="bx bx-check",n.style.color="#5eff5e",setTimeout(()=>{n.className="bx bx-copy",n.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(s=>{let i=s;s.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),s.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),s.addEventListener("click",()=>{let n=i.dataset.cmd;n&&Vs(n)})})}async function Ks(){if(!B())try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ls(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}lt(),ct(),Ks(),ft(),rt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&rs();let e=[],s=document.getElementById("windows-container");s&&s.setAttribute("data-count","0");let i=o=>{localStorage.setItem("dex_last_window",o)};function n(){for(;e.length>1;)e.shift().close(!0);let o=document.getElementById("windows-container"),p=document.querySelector("nav"),f=document.querySelector("footer"),v=window.location.pathname==="/"||window.location.pathname==="/index.html",x=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");o&&o.setAttribute("data-count",e.length.toString()),e.forEach(D=>{let j=document.getElementById(D.id);j&&j.classList.remove("hide-close")});let M=document.getElementById("dexter-menu-container"),A=document.getElementById("nav-window-switcher"),I=document.getElementById("settings-icon"),S=document.getElementById("close-all-windows"),$=window.innerWidth<880;if(!$){let D=document.getElementById("dexter-dropdown"),j=document.getElementById("dexter-menu-btn");D&&D.classList.remove("active"),j&&j.classList.remove("active"),o&&o.classList.remove("menu-open")}if(xe(e.length>0),e.length>0)if(f?.classList.add("hide"),S&&(S.style.display=$?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",p?.classList.add("window-open"),o&&(o.style.paddingTop="60px"),M&&(M.style.display=$?"flex":"none"),I&&(I.style.display=$?"block":"none"),!$&&A){let D=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(D)?(A.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),r(g)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),r(c)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),r(y)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),r(d)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),r(m)})):A.innerHTML=""}else A&&(A.innerHTML="");else p?.classList.remove("window-open"),S&&(S.style.display="none"),o&&(o.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",v||x?f?.classList.remove("hide"):f?.classList.add("hide"),M&&(M.style.display="flex"),I&&(I.style.display="block"),A&&(A.innerHTML="");Ce()}function r(o){if(o.isOpen()){o.close();return}for(;e.length>0;)e.pop().close(!0);e.push(o),o.open(),n()}function l(){[...e].forEach(p=>p.close()),e=[]}window.addEventListener("resize",n);let g=pe({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:wt(),onOpen:()=>ce(),onClose:()=>{let o=e.indexOf(g);o>-1&&e.splice(o,1),n()}}),c=pe({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Xe(),onOpen:()=>{c.setContent(Xe()),de()},onClose:()=>{let o=e.indexOf(c);o>-1&&e.splice(o,1),n()}}),d=pe({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ot(),onOpen:()=>Ye(),onClose:()=>{let o=e.indexOf(d);o>-1&&e.splice(o,1),n()}}),y=pe({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Kt()},{icon:"bxs-component",title:"Processes",content:Vt()},{icon:"bxs-brain",title:"Models",content:Zt()},{icon:"bx-globe",title:"Web",content:ss()},{icon:"bxs-hdd",title:"Hardware",content:Yt()},{icon:"bxs-terminal",title:"Logs",content:Xt()},{icon:"bxs-zap",title:"Agents",content:Gt()}].filter(o=>B()?o.title!=="Hardware"&&o.title!=="Logs":!0),onOpen:()=>{et(),oe(),tt(),ns(),Ae()},onClose:()=>{let o=e.indexOf(y);o>-1&&e.splice(o,1),n()}}),m=pe({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Ht()},{icon:"bx-map-alt",title:"Roadmap",content:Dt()},{icon:"bx-paint",title:"Blueprints",content:zt()},{icon:"bx-task",title:"Tasks",content:Nt()}],onOpen:()=>Ke(),onClose:()=>{let o=e.indexOf(m);o>-1&&e.splice(o,1),n()}}),u=pe({id:"settings-window",title:"Settings",icon:"bx-cog",content:qe(),onOpen:()=>{u.setContent(qe()),st(u)},onClose:()=>{let o=e.indexOf(u);o>-1&&e.splice(o,1),n()}});window.dexter={viewEvent:o=>{c.isOpen()||r(c),setTimeout(()=>{let p=document.querySelector(`.event-item[data-event-id="${o}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)},viewAlert:o=>{g.isOpen()||r(g),setTimeout(()=>{let p=document.querySelector(`.event-item[data-alert-id="${o}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)}};let a=()=>{let o=document.getElementById("dexter-dropdown"),p=document.getElementById("dexter-menu-btn");o&&p&&(o.classList.remove("active"),p.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let o=document.getElementById("dexter-menu-btn"),p=document.getElementById("settings-icon"),f=document.getElementById("close-all-windows"),v=document.getElementById("nav-left-container"),x=document.getElementById("dexter-dropdown"),M=document.getElementById("windows-container");o&&x&&(o.onclick=I=>{I.stopPropagation();let S=window.innerWidth<880;if(S)x.style.top="",x.style.left="",x.style.right="",x.style.transform="";else{let D=o.getBoundingClientRect(),O=document.querySelector("nav").getBoundingClientRect(),q=220,G=10,k=D.left+D.width/2-q/2,C=O.right-10;k+q>C&&(k=C-q),k<10&&(k=10),x.style.top=O.bottom+G+"px",x.style.left=k+"px",x.style.right="auto",x.style.transform="none"}x.classList.toggle("active"),o.classList.toggle("active");let $=x.classList.contains("active");if(S){let D=document.querySelector("nav");$?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),D?.classList.add("window-open"),M?.classList.add("menu-open"),xe(!0)):(M?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),D?.classList.remove("window-open"),xe(!1)))}}),p&&(p.onclick=I=>{I.stopPropagation(),r(u)}),f&&(f.onclick=I=>{I.stopPropagation(),l()});let A=(I,S,$)=>{let D=document.getElementById(I);D&&(D.onclick=j=>{j.stopPropagation(),a(),$&&i($),r(S)})};A("alerts-menu-item",g,"alerts-window"),A("events-menu-item",c,"events-window"),A("monitor-menu-item",y,"monitor-window"),A("contacts-menu-item",d,"contacts-window"),A("workspace-menu-item",m,"workspace-window"),v&&(v.onclick=I=>{if(I.stopPropagation(),x&&x.classList.contains("active")){a(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1));return}if(e.length>0)l();else{let S=window.location.pathname;if(!(S==="/"||S==="/index.html")){let j=(S.endsWith("/")&&S.length>1?S.slice(0,-1):S).split("/");j.pop();let O=j.join("/")||"/";window.location.href=O}}}),document.addEventListener("click",()=>{let I=window.innerWidth<880;x&&x.classList.contains("active")&&(a(),I&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1)))}),x&&(x.onclick=I=>I.stopPropagation())})();let E=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!E&&!h&&document.querySelector("footer")?.classList.add("hide"),B()||setInterval(()=>{c.isOpen()&&de(),g.isOpen()?ce():Ge()},1e3),setInterval(()=>{B()&&(g.isOpen()?ce():Ge()),m.isOpen()?Ke():Mt(),B()&&c.isOpen()&&de(),y.isOpen()&&Qt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ls):ls();})();
