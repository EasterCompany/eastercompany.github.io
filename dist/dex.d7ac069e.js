(()=>{function tt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function st(){let t=window.location.pathname,e=t==="/"||t==="/index.html",i=`
    ...
    `,document.body.appendChild(r)}function fe(t){let e=window.location.pathname,n=e==="/"||e==="/index.html",s=document.getElementById("nav-chevron"),i=document.querySelector(".nav-left");!s||!i||(t||!n?(s.style.display="block",i.style.cursor="pointer",i.classList.add("recording"),i.onmouseenter=()=>{s.style.transform="translateX(-3px)"},i.onmouseleave=()=>{s.style.transform="translateX(0)"}):(s.style.display="none",i.style.cursor="default",i.classList.remove("recording"),i.onmouseenter=null,i.onmouseleave=null))}function it(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var nt=1e3;function ae(t){let e=null,n=t.onClose||null,s=t.onOpen||null;function i(){e&&(e.style.zIndex=++nt)}function l(){if(e){e.classList.add("open"),i(),window.addEventListener("resize",r),s&&setTimeout(s,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++nt,e.addEventListener("mousedown",i);let b=t.icon||"bx-window",a="",g="",E;t.tabs&&t.tabs.length>0?(a=`<div class="tab-bar">${t.tabs.map((o,d)=>{let u=o.icon?`<i class="bx ${o.icon}"></i>`:`<span class="tab-glyph">${o.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,E=`<div class="window-content">${t.tabs.map((o,d)=>`<div class="tab-content ${d===0?"active":""}" data-tab-content="${d}">${o.content}</div>`).join("")}</div>`):(t.title&&(g=`<div class="window-title">${t.title}</div>`),E=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${E}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),c()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let f=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(o=>o.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${f}"]`).classList.add("active"),v(h,e)})}),setTimeout(()=>{e.classList.add("open"),s&&s()},10)}function r(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&v(p,e)}function v(p,b){setTimeout(()=>{let a=b.querySelector(".tab-bar");if(!a)return;let g=Array.from(a.querySelectorAll(".tab")),E=g.indexOf(p),h=a.clientWidth,f=g[Math.max(0,E-2)],o=g[Math.min(g.length-1,E+2)],d=f.offsetLeft-a.offsetLeft-25,x=o.offsetLeft+o.offsetWidth-a.offsetLeft+25-d,L=x<=h?d-(h-x)/2:p.offsetLeft-a.offsetLeft-h/2+p.offsetWidth/2;a.scrollTo({left:L,behavior:"smooth"})},350)}function c(p=!1){e&&(window.removeEventListener("resize",r),p?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function m(p){t.content=p;let b=e?.querySelector(".window-content");b&&(b.innerHTML=p)}function y(){return e&&e.classList.contains("open")}return{open:l,close:c,setContent:m,isOpen:y,focus:i,id:t.id}}var at="easter_theme",Y={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Oe(){return localStorage.getItem(at)||Y.DARK}function ot(t){if(!Object.values(Y).includes(t))throw new Error("Invalid theme");localStorage.setItem(at,t),rt(t)}function rt(t){let e=document.documentElement,n=document.body;Object.values(Y).forEach(r=>{n.classList.remove(`theme-${r}`)}),n.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let i={[Y.DARK]:"#050507",[Y.LIGHT]:"#FFFFFF",[Y.LEGACY]:"#000000"},l=i[t]||i[Y.DARK];if(s.setAttribute("content",l),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}n.classList.add("is-animated")}function lt(){let t=Oe();rt(t)}function z(t,e,n=null){let i={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${i} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function H(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function X(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let s=Date.now(),i=Math.floor((s-e)/1e3),l;i<60?l=`${i}s ago`:i<3600?l=`${Math.floor(i/60)}m ago`:l=`${Math.floor(i/3600)}h ago`,n.textContent=`Last updated: ${l}`}var Xt=0;function we(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let s=n.querySelector(".notification-badge");s&&(e>0?(s.textContent=e>9?"9+":e,s.style.display="flex"):s.style.display="none")}var ee=0,te=0;function dt(t){ee=t,ve()}function pt(t){te=t,ve()}function ve(){let t=ee+te;Xt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",n.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let s=document.getElementById("workspace-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}let i=document.getElementById("switch-alerts");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",i.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let r=l.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",l.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}}function ke(){let t=document.getElementById("alerts-list");if(!t)return;ee=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ve()}function mt(){let t=document.getElementById("blueprints-list");if(!t)return;te=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ve()}function Qt(){return"https://event.easter.company"}function es(){return"https://discord.easter.company"}var ts="http://127.0.0.1:8100",ss="http://127.0.0.1:8300",is={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Te(t){let e=H(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(i,l)=>{let r=is[l];return r?`<span class="${r}">`:""});let n=(e.match(/<span/g)||[]).length,s=(e.match(/<\/span/g)||[]).length;return n>s&&(e+="</span>".repeat(n-s)),e}function oe(t){if(!t)return"";let e=H(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,s)=>{let i=s.split("|").map(l=>l.trim());return i.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${i.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var ns="https://sterling-javelin-12539.upstash.io",as="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function _(){return window.location.hostname==="easter.company"}var N=null,Le=0,Me=0,Ue=!1,ut=0,ft="dex_dashboard_snapshot";function os(){let t=localStorage.getItem(ft);if(t)try{let e=JSON.parse(t);N=e,Le=e.timestamp*1e3}catch{N=null}}async function ct(){if(!(!_()||Ue)){Ue=!0,ut=Math.floor(Date.now()/1e3);try{let t=await cs("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);N=e,Le=e.timestamp*1e3,Me=Date.now(),localStorage.setItem(ft,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ue=!1}}}function rs(){if(!N||!N.agent_status)return;let t=N.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1,t.system.metrics&&(t.system.state==="idle"?typeof t.system.metrics.total_idle_time=="number"&&(t.system.metrics.total_idle_time+=1):typeof t.system.metrics.total_active_time=="number"&&(t.system.metrics.total_active_time+=1)))}async function ls(){if(!_())return;os();let t=Math.floor(Date.now()/1e3),e=N?t-N.timestamp:1/0;(!N||e>120)&&await ct(),setInterval(()=>{let n=new Date,s=Math.floor(Date.now()/1e3),i=N?s-N.timestamp:1/0,l=s-ut,r=n.getSeconds()===59,v=i>300,c=l>60;(r&&c||v&&c)&&ct(),rs()},1e3)}_()&&ls();async function cs(t,...e){try{let s=await(await fetch(ns,{method:"POST",headers:{Authorization:`Bearer ${as}`},body:JSON.stringify([t,...e])})).json();if(s.error)throw new Error(s.error);return s.result}catch(n){return console.error("Upstash Error:",n),null}}var ge=null,be=null,Se=!1,Ee=!1;async function I(t,e={}){if(_()){if(!N)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(N.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(N.processes),{status:200});if(t.startsWith("/events")){let i=new URLSearchParams(t.split("?")[1]||""),l=i.get("type")||i.get("event.type"),r=i.get("category"),v=i.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...N.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...N.blueprints||[]]:r==="messaging"?c=[...N.messaging_events||[]]:r==="system"?c=[...N.system_events||[]]:r==="cognitive"?c=[...N.cognitive_events||[]]:r==="moderation"?c=[...N.moderation_events||[]]:c=[...N.events||[]],v==="asc"?c.sort((m,y)=>m.timestamp-y.timestamp):c.sort((m,y)=>y.timestamp-m.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(N.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let i=t.split("/")[2],l=N.profiles?N.profiles[i]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(N.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ge)try{let i=await fetch(ge+t,e);if(i.ok)return i;ge=null}catch{ge=null}let n=Qt(),s=ts;try{let i=await fetch(n+t,e);if(i.ok)return ge=n,Se&&(console.log("\u2728 Production event service restored."),Se=!1),i;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${s}`),Se=!0);try{let l=await fetch(s+t,e);if(l.ok)return ge=s,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function Ae(t,e={}){if(_()){if(!N)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(N.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let i=t.split("/")[2],l=(N.contacts?.members||[]).find(r=>r.id===i);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(be)try{let i=await fetch(be+t,e);if(i.ok)return i;be=null}catch{be=null}let n=es(),s=ss;try{let i=await fetch(n+t,e);if(i.ok)return be=n,Ee&&(console.log("\u2728 Production discord service restored."),Ee=!1),i;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${s}`),Ee=!0);try{let l=await fetch(s+t,e);if(l.ok)return be=s,l;throw new Error("Fallback failed")}catch(l){throw l}}}var gt=()=>`
...
`,Ie=null,re=new Set,Be=[];async function ie(t=!1){let e=document.getElementById("alerts-list");if(!e)return;ds(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let s=await I(n);if(!s.ok)throw new Error("Service is offline or unreachable.");let l=(await s.json()).events||[];Ie=Date.now(),X(0,Ie);let r=Date.now(),v=24*60*60*1e3,c=l.filter(d=>{let u=localStorage.getItem(`alert_read_ts_${d.id}`);if(!u)return!0;let x=parseInt(u);return r-x<v});c.sort((d,u)=>{let x=T=>{let $=T.event;if(typeof $=="string")try{$=JSON.parse($)}catch{return"low"}return($.priority||"low").toLowerCase()},L=T=>T==="critical"?4:T==="high"?3:T==="medium"?2:1,A=L(x(d)),k=L(x(u));return A!==k?k-A:u.timestamp-d.timestamp}),Be=c;let m=d=>{let u=d.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return"low"}return(u.priority||"low").toLowerCase()},y=[],b=new Set(c.map(d=>m(d))).size>1;if(c.length>0){let d=null;c.forEach(u=>{let x=m(u);b&&x!==d&&(y.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),d=x),y.push(u)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=z("empty","No alerts yet."),ke();return}let a=d=>{let u=d.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let x=(u.title||"Untitled Alert").trim(),L=(u.body||"No description provided.").trim(),A=u.summary||"",k=u.content||"",T=u.protocol||"",$=(u.priority||"low").toLowerCase(),B=!!u.alert,O=(u.category||"system").trim(),R=u.related_event_ids||[],F=u.audit_event_id,q=!!localStorage.getItem(`alert_read_ts_${d.id}`),S=new Date(d.timestamp*1e3),w=S.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),C=S.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=q?"event-border-grey":"event-border-blue";!q&&B&&(M="event-border-red"),q&&($==="high"||$==="critical")?M="event-border-red":q&&$==="medium"&&(M="event-border-orange");let P=q?"alert-read":"alert-unread",D=re.has(d.id),U=D?"expanded":"",j=D?"display: block;":"display: none;",J="",G="";R.length>0&&(G=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${R.map(se=>`<a href="#" onclick="window.dexter.viewEvent('${se}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${se.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let V="";F&&(V=`
        ...
        `,J=`
            ...
            `;let Qe=Z.querySelector(".event-details");Qe&&Qe.addEventListener("click",se=>{se.stopPropagation()});let et=Z.querySelector(".close-details-btn");return et&&et.addEventListener("click",se=>{se.stopPropagation(),Z.classList.remove("expanded");let Pe=Z.querySelector(".event-details");Pe&&(Pe.style.display="none"),re.delete(d.id)}),Z},g=d=>{let u=document.createElement("div");u.className="notification-divider",u.dataset.alertId=d.id;let x="#888888";return d.label==="CRITICAL"?x="#ff4d4d":d.label==="HIGH"?x="#ff8888":d.label==="MEDIUM"&&(x="#ffa500"),u.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${x}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,u.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${x}44, transparent); flex-grow: 1;"></div>`,u},E=Array.from(e.children),h=new Map(E.map(d=>[d.dataset.alertId,d])),f=new Set(y.map(d=>d.id));E.forEach(d=>{let u=d.dataset.alertId;(!u||!f.has(u))&&d.remove()});let o=null;y.forEach((d,u)=>{let x=h.get(d.id);(!x||t)&&(x&&x.remove(),d.type==="divider"?x=g(d):x=a(d),!x)||(u===0?e.firstElementChild!==x&&e.prepend(x):o&&o.nextElementSibling!==x&&o.after(x),o=x)}),Ie=Date.now(),X(0,Ie),ke()}catch(s){console.error("Error fetching alerts:",s),e.children.length===0&&(e.innerHTML=z("offline","Failed to load alerts.","The event service may be offline."))}}function ds(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),n=document.getElementById("alerts-close-all"),s=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Be.forEach(i=>{localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Be.forEach(i=>{re.add(i.id),localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ie(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{re.clear(),ie(!0)},n.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.notification.generated",{method:"DELETE"});let i=Date.now()-48*60*60*1e3;Be.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,i.toString())}),re.clear(),ie(!0)}catch(i){console.error("Failed to clear alerts:",i)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}async function je(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],i=0;s.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||i++}),dt(i)}catch{}}var bt=()=>`
...
`,le=new Set,_e=[],xe=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){ps();try{let n=await I("/roadmap");if(!n.ok)throw new Error("Offline");let s=await n.json();_e=s;let i=m=>{let y=le.has(m.id),p=m.state==="published",b=m.state==="consumed",a="event-border-grey";p&&(a="event-border-blue"),b&&(a="event-border-purple");let E=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${a} cursor-pointer ${y?"expanded":""}`,h.dataset.itemId=m.id,h.onclick=d=>{if(d.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",le.delete(m.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",le.add(m.id))};let f=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;h.innerHTML=`
        <div class="event-time">
        ...
        <div class="event-content">
          ...
          <div class="event-message" style="white-space: pre-wrap;">${H(m.content)}</div>
      ...
      `;let o=h.querySelector(".event-details");return o&&o.addEventListener("click",d=>{d.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>ms(m)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>us(m)),h.querySelector(".delete-btn")?.addEventListener("click",()=>fs(m.id)),h.querySelector(".close-details-btn")?.addEventListener("click",d=>{d.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",le.delete(m.id)}),h},l=Array.from(e.children),r=new Map(l.map(m=>[m.dataset.itemId,m])),v=new Set(s.map(m=>m.id));if(l.forEach(m=>{let y=m.dataset.itemId;(!y||!v.has(y))&&m.remove()}),!_e||_e.length===0){e.innerHTML=z("empty","Your roadmap is empty.",_()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;s.forEach((m,y)=>{let p=r.get(m.id);(!p||t)&&(p&&p.remove(),p=i(m),!p)||(y===0?e.firstElementChild!==p&&e.prepend(p):c&&c.nextElementSibling!==p&&c.after(p),c=p)})}catch{e.children.length===0&&(e.innerHTML=z("offline","Failed to load roadmap.","The event service may be offline."))}}}function ps(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),s=document.getElementById("roadmap-expand-all"),i=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{xe=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",xe=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input").value;if(!l.trim())return;let r=xe?`/roadmap/${xe}`:"/roadmap",v=xe?"PATCH":"POST";try{await I(r,{method:v,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(c){console.error(c)}},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{_e.forEach(l=>le.add(l.id)),ce(!0)},s.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{le.clear(),ce(!0)},i.dataset.listenerAttached="true")}function ms(t){xe=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function us(t){let e=t.state==="published"?"draft":"published";try{await I(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(n){console.error(n)}}async function fs(t){if(confirm("Delete this roadmap item?"))try{await I(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var yt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,xt=null,de=new Set,wt=[];async function pe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;gs();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let s=await I(n);if(!s.ok)throw new Error("Service is offline or unreachable.");let l=(await s.json()).events||[];if(wt=l,xt=Date.now(),X(2,xt),l.length===0){e.innerHTML=z("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),we(2,0);return}t&&(e.innerHTML="");let r=p=>{let b=p.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let a=(b.title||"Untitled Blueprint").trim(),g=(b.summary||b.body||"No summary provided.").trim(),E=(b.content||"").trim(),h=(b.category||"architecture").trim(),f=(b.related_services||b.affected_services||[]).map(D=>D.trim()),o=(b.implementation_path||[]).map(D=>D.trim()),d=b.source_event_ids||[],u=b.approved===!0,x=new Date(p.timestamp*1e3),L=x.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=x.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=de.has(p.id),T=k?"display: block;":"display: none;",$=document.createElement("div");$.className=`event-item notification-item event-border-purple cursor-pointer ${k?"expanded":""} ${u?"blueprint-approved":""}`,$.dataset.blueprintId=p.id,u&&($.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",$.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let O=u?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";$.onclick=function(D){if(this.classList.contains("expanded")){this.classList.remove("expanded"),de.delete(p.id);let j=this.querySelector(".event-details");j&&(j.style.display="none")}else{this.classList.add("expanded"),de.add(p.id);let j=this.querySelector(".event-details");j&&(j.style.display="block")}};let R="";o.length>0&&(R=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${o.map(D=>`<li style="margin-bottom: 5px;">${H(D)}</li>`).join("")}</ul></div>
                    </div>
                `);let F="";d.length>0&&(F=`
                ...
                `);let W=f.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${f.join(", ")}</span></div>`:"<div></div>",q=_(),S=u?`
            ...
            `;$.innerHTML=`
                ...
                <div class="event-icon" style="${u?"color: #03dac6;":""}"><i class='bx ${O}'></i></div>
                <div class="event-content">
                    ...
                    <div class="event-details" style="${T}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${H(g)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${H(E)}</div>
                        </div>
                        ${R}
                        ${F}
                        ${S}
            ...
            `;let w=$.querySelector(".blueprint-approve-btn");w&&(w.onclick=async D=>{D.stopPropagation(),w.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await I(`/events/${p.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&pe(!0)}catch(U){console.error("Failed to approve blueprint:",U)}});let C=$.querySelector(".blueprint-delete-btn");C&&(C.onclick=async D=>{D.stopPropagation();let U=!u;C.innerHTML=U?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await I(`/events/${p.id}`,{method:"DELETE"})).ok&&pe(!0)}catch(j){console.error("Failed to delete blueprint:",j)}});let M=$.querySelector(".event-details");M&&M.addEventListener("click",D=>{D.stopPropagation()});let P=$.querySelector(".close-details-btn");return P&&P.addEventListener("click",D=>{D.stopPropagation(),$.classList.remove("expanded");let U=$.querySelector(".event-details");U&&(U.style.display="none"),de.delete(p.id)}),$},v=Array.from(e.children),c=new Map(v.map(p=>[p.dataset.blueprintId,p])),m=new Set(l.map(p=>p.id));v.forEach(p=>{let b=p.dataset.blueprintId;(!b||!m.has(b))&&p.remove()});let y=null;l.forEach((p,b)=>{let a=c.get(p.id);(!a||t)&&(a&&a.remove(),a=r(p),!a)||(b===0?e.firstElementChild!==a&&e.prepend(a):y&&y.nextElementSibling!==a&&y.after(a),y=a)}),we(2,l.length),mt()}catch(s){console.error("Error fetching blueprints:",s),e.children.length===0&&(e.innerHTML=z("offline","Failed to load blueprints.","The event service may be offline."))}}async function Ct(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],i=0;s.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&i++}),pt(i)}catch{}}function gs(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),n=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{wt.forEach(s=>de.add(s.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{de.clear(),pe(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.blueprint.generated",{method:"DELETE"}),de.clear(),pe(!0)}catch(s){console.error("Failed to clear blueprints:",s)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var $t=()=>`
...
`;async function qe(){await Promise.all([ce(),pe()])}var St=()=>`
    ...
    `;async function ye(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),s=document.getElementById("save-chore-btn"),i=document.getElementById("cancel-chore-btn");if(e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n.style.display=n.style.display==="none"?"block":"none"},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{n.style.display="none"},i.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let l=document.getElementById("new-chore-instruction").value,r=document.getElementById("new-chore-url").value,v=document.getElementById("new-chore-owner").value||"313071000877137920";if(l){s.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:v,natural_instruction:l,entry_url:r,schedule:"every_6h"})}),n.style.display="none",document.getElementById("new-chore-instruction").value="",document.getElementById("new-chore-url").value="",ye()}catch(c){console.error(c),alert("Failed to create chore")}finally{s.innerHTML="Create Task"}}},s.dataset.listenerAttached="true"),!!t)try{let l=await I("/chores");if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);let r=await l.json();if(!Array.isArray(r)||r.length===0){t.innerHTML=z("empty","No active chores.","Create one to start monitoring.");return}let v=r.map(c=>{let m=c.last_run===0?"Never":new Date(c.last_run*1e3).toLocaleString(),y=c.memory?c.memory.length:0,p=c.status==="active"?"#03dac6":"#666";return`
            ...
            `}).join("");t.innerHTML=v,t.querySelectorAll(".delete-chore-btn").forEach(c=>{c.onclick=async m=>{m.stopPropagation(),confirm("Delete this chore?")&&(await I(`/chores/${c.dataset.id}`,{method:"DELETE"}),ye())}})}catch(l){console.error("Failed to fetch chores",l)}}var bs=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function Et(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function kt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=bs,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",Ae(`/profile/${t.id}`).then(async n=>{if(n.ok){let s=await n.json();Fe(e,t,s)}else{console.log("Profile not found or error, using mock data.");let s=Et(t.id,t.username);Fe(e,t,s)}}).catch(n=>{console.error("Profile fetch error:",n);let s=Et(t.id,t.username);Fe(e,t,s)})}function Fe(t,e,n){let s=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",i=()=>{let E=(n.badges||[]).map(L=>`<span class="profile-badge ${L==="Creator"?"master":""}">${L}</span>`).join(""),h=(n.attributes||n.facts||[]).map(L=>{let A=L.key||L.k,k=L.value||L.v;return`
            <div class="fact-chip">
                <span class="fact-key">${A}:</span>
                <span class="fact-val">${k}</span>
            </div>
        `}).join(""),f=n.cognitive_model||n,o=f.technical_level||f.techLevel||0,d=f.communication_style||f.commStyle||"Unknown",u=f.patience_level||f.patience||"Unknown",x=f.vibe||"Unknown";return`
        ...
        `},l=()=>{let E=n.dossier||{},h=E.identity||{},f=E.career||{},o=E.personal||{},d=E.social||[];return`
...
`,vs=null;async function Je(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Je(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let s=n.target.closest(".user-profile-card");if(s)try{let i=JSON.parse(s.dataset.user);kt(i)}catch(i){console.error("Failed to parse user data",i)}},t.dataset.listenerAttached="true");try{let n=await Ae("/contacts");if(!n.ok)throw new Error("Service unreachable");let i=(await n.json()).members||[];if(vs=Date.now(),i.length===0){t.innerHTML=z("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};i.sort((r,v)=>{let c=l[r.level]??10,m=l[v.level]??10;return c!==m?c-m:r.username.localeCompare(v.username)}),t.innerHTML=i.map(r=>{let v=r.color?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",c=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",m="#888";r.level==="Me"||r.level==="Master"?m="#bb86fc":r.level==="Admin"?m="#cf6679":r.level==="Moderator"?m="#03dac6":r.level==="Contributor"&&(m="#ffa500");let y=r.level==="Me",p=y?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",b=y?"2px solid #bb86fc":`1px solid ${v}33`;return`
...
`,De=null,me=new Set,Ce=[],K="all",ys={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},hs={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function ws(t){for(let[e,n]of Object.entries(ys))if(n.includes(t))return e;return"system"}function Cs(t){return hs[t]||"bx-square-rounded"}async function ne(t=!1){let e=document.getElementById("events-timeline");if(!e)return;$s();let s=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(s+=`&category=${K}`);try{let i=await I(s);if(!i.ok)throw new Error("Service unreachable");if(Ce=((await i.json()).events||[]).filter(b=>{let a=b.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return!0}let g=a.type;return!(g==="system.blueprint.generated"||g==="system.notification.generated")}),De=Date.now(),X(1,De),Ce.length===0){e.innerHTML=z("empty","No events found for this filter.");return}t&&(e.innerHTML="");let v=b=>{let a=b.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return null}let g=a.type,E=ws(g),h=Cs(g),f=g==="engagement.decision"||g==="messaging.bot.sent_message"||g==="messaging.user.sent_message"||g==="moderation.explicit_content.deleted"||g==="analysis.link.completed"||g==="analysis.visual.completed"||g==="analysis.router.decision"||g==="analysis.user.message_signals"||g==="system.cli.command"||g==="system.analysis.audit"||g==="system.test.completed"||g==="error_occurred"||g==="system.cli.status"||g==="system.attention.expired"||g.startsWith("system.roadmap")||g.startsWith("system.process"),o="event-border-grey";f&&(g==="moderation.explicit_content.deleted"||g==="error_occurred"?o="event-border-red":g==="analysis.link.completed"||g==="analysis.visual.completed"||g==="analysis.router.decision"||g==="system.analysis.audit"||g==="analysis.user.message_signals"?o="event-border-purple":g==="system.attention.expired"||g==="system.cli.command"||g==="system.cli.status"?o="event-border-orange":g==="system.test.completed"?o=a.test?.status==="OK"&&a.lint?.status==="OK"&&a.format?.status==="OK"?"event-border-blue":"event-border-red":o="event-border-blue");let d=f?"cursor-pointer":"",u=me.has(b.id),x=u?"expanded":"",L=u?"display: block;":"display: none;",A=new Date(b.timestamp*1e3),k=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=Lt(g,a),B=a.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${a.user_level})</span>`:"",O="";if(f){let S="";if(g==="engagement.decision"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                    ...
                    `}else if(g==="system.attention.expired"){let w=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,C=a.timestamp-a.last_active,M=Math.floor(C/60);S=`
                    ...
                    `}else if(g==="messaging.bot.sent_message"){let w=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,C="";a.eval_count&&(C=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let M="";if(a.chat_history&&a.chat_history.length>0){let P=a.chat_history.length,D=a.chat_history.map((U,j)=>{let J=U.name?U.name.toUpperCase():U.role.toUpperCase();!U.name&&J==="ASSISTANT"&&(J="DEXTER");let G=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",V=j===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${j}" style="display: ${V};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${j+1} of ${P}</span>
                                    </div>
                        ...
                        `}
                    `}else if(g==="analysis.user.message_signals"){let w=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,C=a.signals||{};S=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${(C.topics||[]).map(P=>`<span class="profile-badge">${P}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${w("Raw Model Output")}
                            <pre class="detail-pre">${H(a.raw_output)||"None"}</pre>
                        </div>
                    `}else if(g==="moderation.explicit_content.deleted"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="analysis.link.completed"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${H(a.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${w("Description")}
                            <pre class="detail-pre">${H(a.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${w("Content Summary")}
                            <pre class="detail-pre">${H(a.summary)||"None"}</pre>
                        </div>
                    `}else if(g==="analysis.visual.completed"){let w=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`,C="";a.base64_preview?C=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${a.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:a.url&&(C=`<div class="event-detail-block"><img src="${a.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(g==="analysis.router.decision"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${w("Input Context")}
                            <pre class="detail-pre">${H(a.raw_input)||"None"}</pre>
                        </div>
                    `}else if(g==="system.cli.command"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${w("Output")}
                            <pre class="detail-pre">${H(a.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(g==="system.analysis.audit"){let w=a.success?"#03dac6":"#ff4d4d",C=a.success?"SUCCESS":"FAILED",M=J=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${J}</h5>`,P="";a.error&&(P=`
                            <div class="event-detail-block">
                                ${M("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${H(a.error)}</pre>
                            </div>
                        `);let D="";if(a.chat_history&&a.chat_history.length>0){let J=a.chat_history.length,G=a.chat_history.map((V,ue)=>{let Q=V.name?V.name.toUpperCase():V.role.toUpperCase();!V.name&&Q==="USER"&&(Q="SYSTEM"),!V.name&&Q==="ASSISTANT"&&(Q="AGENT");let Z=V.role==="user"?"#03dac6":V.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ue}" style="display: ${ue===0?"block":"none"};">
                                    ...
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${H(V.content)}</div>
                                </div>
                            `}).join("");D=`
                            <div class="event-detail-block">
                        ...
                        `}let U="";if(a.corrections&&a.corrections.length>0){let J=a.corrections.map((G,V)=>`
                        ...
                        `}let j="";if(a.parsed_results&&a.parsed_results.length>0){let J=a.parsed_results.map(G=>`
                        ...
                        ${U}
                        ${D}
                    `}else if(g==="system.test.completed"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="error_occurred"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${w("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${H(a.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${w("Context")}
                            <pre class="detail-pre">${JSON.stringify(a.context||{},null,2)}</pre>
                        </div>
                    `}else if(g==="system.cli.status"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${w("Message")}
                            <pre class="detail-pre">${H(a.message)}</pre>
                        </div>
                    `}else if(g==="messaging.user.sent_message"){let w="";a.attachments&&a.attachments.length>0&&(w=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${a.attachments.map(M=>{let P=M.content_type&&M.content_type.startsWith("image/"),D=(M.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${P?`<div class="attachment-thumb-container"><img src="${M.url}" alt="${M.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
            ...
            `;let F=R.querySelector(".event-details");if(F&&F.addEventListener("click",S=>{S.stopPropagation()}),f){let S=R.querySelector(".close-details-btn");S&&S.addEventListener("click",w=>{w.stopPropagation();let C=w.target.closest(".event-item");if(C){C.classList.remove("expanded"),me.delete(b.id);let M=C.querySelector(".event-details");M&&(M.style.display="none")}})}let W=R.querySelector(".prev-btn"),q=R.querySelector(".next-btn");if(W&&q){let S=0,w=R.querySelectorAll(".history-slide"),C=w.length,M=()=>{w.forEach((P,D)=>{P.style.display=D===S?"block":"none"}),W.disabled=S===0,q.disabled=S===C-1,W.style.opacity=S===0?"0.5":"1",q.style.opacity=S===C-1?"0.5":"1"};W.addEventListener("click",P=>{P.stopPropagation(),S>0&&(S--,M())}),q.addEventListener("click",P=>{P.stopPropagation(),S<C-1&&(S++,M())}),M()}return R},c=Array.from(e.children),m=new Map(c.map(b=>[b.dataset.eventId,b])),y=new Set(Ce.map(b=>b.id));c.forEach(b=>{let a=b.dataset.eventId;(!a||!y.has(a))&&b.remove()});let p=null;Ce.forEach((b,a)=>{let g=m.get(b.id);(!g||t)&&(g&&g.remove(),g=v(b),!g)||(a===0?e.firstElementChild!==g&&e.prepend(g):p&&p.nextElementSibling!==g&&p.after(g),p=g)}),De=Date.now(),X(1,De)}catch(i){console.error("Error fetching events:",i),e.children.length===0&&(e.innerHTML=z("offline","Failed to load events.","The event service may be offline."))}}function $s(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),n=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ce.forEach(i=>me.add(i.id)),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ne(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{n.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),i.classList.add("active"),K=i.dataset.filter,ne(!0)}}),n.dataset.listenerAttached="true"),n&&n.querySelectorAll(".filter-btn").forEach(i=>{i.dataset.filter===K?i.classList.add("active"):i.classList.remove("active")});let s=document.getElementById("events-clear");s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let i=K==="all"?"ALL":K.toUpperCase();if(confirm(`Are you sure you want to delete ${i} events from the backend? This cannot be undone.`)){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(K!=="all"?l+=`?category=${K}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await I(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ne(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var Ss=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Mt=Ss;function At(){return`
    ...
    `}var Es=null;async function $e(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await I("/logs");if(!e.ok)throw new Error("Logs offline");let n=await e.json();if(!n||n.length===0)return t.innerHTML=z("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let s=["local-ollama-0","local-cache-0"],i=n.filter(r=>!s.includes(r.id));i.forEach(r=>{r.logs&&Array.isArray(r.logs)?r.logs.reverse():r.logs=[]}),i.reverse();let l=i.map(r=>{let v=r.logs.join(`
`),c=[...r.logs];if(c.length<25){let y=25-c.length;for(let p=0;p<y;p++)c.push("")}else c.length>25&&(c=c.slice(-25));let m=c.map(y=>Te(y)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(r=>{r.addEventListener("click",()=>{let v=unescape(r.dataset.logs);navigator.clipboard.writeText(v).then(()=>{let c=r.querySelector("i");c.classList.remove("bx-copy"),c.classList.add("bx-check"),setTimeout(()=>{c.classList.remove("bx-check"),c.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(r=>{r.addEventListener("click",async()=>{let v=r.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${v}?`))try{(await I(`/logs?service_id=${v}`,{method:"DELETE"})).ok&&$e()}catch(c){console.error("Error clearing logs:",c)}})}),Es=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=z("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Dt=()=>{let t=_()?"display: none;":"";return`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${At()}
        </div>`;async function Ot(){ks(),await Promise.all([Ne(),Ve(),Ke(),ye()]),await $e()}var ze=null;function ks(){ze||(ze=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(ze),ze=null;return}Ne(!0)},1e3))}var It=null,Bt=null;async function Ut(){try{return await(await I("/system_monitor")).json()}catch{return null}}async function _t(){try{return await(await I("/system/hardware")).json()}catch{return null}}async function Ts(){try{return await(await I("/processes")).json()}catch{return null}}async function Ls(){try{return await(await I("/agent/status")).json()}catch{return null}}async function Ve(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.querySelector("#hw-os .hw-content"),s=document.querySelector("#hw-cpu .hw-content"),i=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),v=o=>{if(o){if(n&&(n.innerHTML=`
                ...
                </div>`),i){let d=(o.MEMORY_BYTES/1073741824).toFixed(1);i.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                ...
                </div>`}l&&(o.GPU&&o.GPU.length>0?l.innerHTML=o.GPU.map(d=>{let u=(d.VRAM/1073741824).toFixed(1);return`
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let o=await _t();o?(v(o),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),s&&!s.hasChildNodes())){let o=await _t();v(o)}if(!t)return;let c=await Ut();if(!c||!c.services){t.children.length===0&&(t.innerHTML=z("offline","Failed to load system metrics.","The event service may be offline."));let o=document.querySelector('[data-service-id="upstash-redis-ro"]');if(o){o.className="service-widget service-widget-offline",o.querySelector(".service-widget-status").textContent="ERROR";let d=o.querySelector(".service-widget-body");d&&(d.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}It=_()&&Le||Date.now(),X(0,It);let m=c.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let o=document.getElementById("upstash-countdown");if(o){let x=59-new Date().getSeconds();x<=0&&(x+=60),o.textContent=`${x}s`}},1e3)),Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function y(o){return!o||o==="N/A"||o==="unknown"||o.trim()===""?"-":o}function p(o){if(!o||o==="N/A"||o==="unknown")return"-";let d=o.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:o.split(".").slice(0,3).join(".")||"-"}function b(o){return!o||o.length<=28?o:o.substring(0,28)+"..."}function a(o){if(!o||o==="N/A"||o==="unknown")return"-";let d=o.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let u=parseInt(d[1])||0,x=parseInt(d[2])||0,L=parseInt(d[3])||0,A=parseFloat(d[4])||0,k=u*86400+x*3600+L*60+A,T=Math.floor(k/86400);if(T>0)return`${T}d`;let $=Math.floor(k/3600);if($>0)return`${$}h`;let B=Math.floor(k/60);return B>0?`${B}m`:`${Math.floor(k)}s`}function g(o){if(o.id==="upstash-redis-ro"){let S=_()&&Me||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
                ...
                <div class="service-widget-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 10px 0;">
                    ...
                    <div class="sync-time-label" style="font-size: 0.6em; color: #444; margin-top: 10px;">Last synced: ${new Date(S).toLocaleTimeString()}</div>
                </div>
            </div>`}let d=o.status==="online",u=d?"service-widget-online":"service-widget-offline",x=d?"bx-check-circle":"bx-x-circle",L=d?"OK":"BAD",A=o.version?p(o.version.str):"-",k=o.cpu&&o.cpu!=="N/A"?o.cpu:"-",T=o.memory&&o.memory!=="N/A"?o.memory:"-",$=k!=="-"?"#00ff00":"#666",B=k!=="-"?"#fff":"#666",O=T!=="-"?"#00ff00":"#666",R=T!=="-"?"#fff":"#666",F=a(o.uptime),W="";d?W=`
                <div class="service-widget-info">
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${B};">${k}</span>
                    </div>
                    <div class="service-widget-item">
                        <i class="bx bxs-chip" style="color: ${O};"></i>
                        <span style="color: ${R};">${T}</span>
                    </div>
                </div>`:W='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let q=_()?"easter.company":b(o.domain&&o.port?`${o.domain}:${o.port}`:"");return`<div class="service-widget ${u}" data-service-id="${o.id}"><div class="service-widget-header"><i class="bx ${x}"></i><h3>${o.short_name||o.id}</h3><span class="service-widget-status">${L}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${q}</span></div>${W}</div></div>`}let E=new Map(Array.from(t.querySelectorAll(".service-widget")).map(o=>[o.dataset.serviceId,o])),h=new Set(m.map(o=>o.id));for(let[o,d]of E)h.has(o)||d.remove();let f=new Set;m.forEach(o=>{if(f.has(o.id))return;f.add(o.id);let d=g(o),u=E.get(o.id);if(u&&u.parentNode)if(o.id==="upstash-redis-ro"){let x=_()&&Me||Date.now(),L=new Date(x).toLocaleTimeString(),A=u.querySelector(".sync-time-label");A&&(A.textContent=`Last synced: ${L}`)}else u.outerHTML!==d&&(u.outerHTML=d);else t.insertAdjacentHTML("beforeend",d)})}async function Ke(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Ut();if(!e){t.children.length===0&&(t.innerHTML=z("offline","Failed to load model status.","The event service may be offline."));return}Bt=Date.now(),X(2,Bt);let n=e.models||[],s=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function i(c){let m=c.status==="Ready";return`
                ...
                </div>`}function l(c){let m=c.status==="Ready";return`
                ...
                </div>`}function r(c){let m=c.status==="Downloaded",y=m?"service-widget-online":"service-widget-offline",p=m?"OK":"MISSING",b=m&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",a=c.name;return c.type==="custom"&&a.endsWith(":latest")&&(a=a.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${m?"bx-check-circle":"bx-x-circle"}"></i><h3>${a}</h3><span class="service-widget-status">${p}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let v="";if(s&&(v+=i(s)),e.xtts&&(v+=l(e.xtts)),v+=n.map(r).join(""),!v){t.innerHTML=z("empty","No models found.");return}t.innerHTML!==v&&(t.innerHTML=v)}async function Ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let n=document.getElementById("guardian-sentry-val");analyzerResetBtn&&!analyzerResetBtn.dataset.listenerAttached&&(analyzerResetBtn.dataset.listenerAttached="true");let s=await Ls();if(s&&s.agents&&(totalIdleVal&&(totalIdleVal.textContent=formatDuration(systemData.metrics?.total_idle_time||0)),totalActiveVal&&(totalActiveVal.textContent=formatDuration(systemData.metrics?.total_active_time||0)),totalWasteVal&&(totalWasteVal.textContent=formatDuration(systemData.metrics?.total_waste_time||0))),t)return;let i=await Ts(),l=[],r=[],v=[];i&&(Array.isArray(i)?l=i:(l=i.active||[],r=i.queue||[],v=i.history||[],v.sort((y,p)=>(p.end_time||0)-(y.end_time||0)))),l.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=z("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),Ge(e,l,!1));let c=document.getElementById("processes-queue-widgets");c&&(r.length===0?!c.querySelector(".tab-placeholder")&&!c.querySelector('div[style*="font-style: italic"]')&&(c.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(c.innerHTML="",Ge(c,r,!1)));let m=document.getElementById("processes-history-widgets");m&&(v.length===0?m.querySelector(".tab-placeholder")||(m.innerHTML=z("empty","No recent history.")):(m.querySelector(".tab-placeholder")&&(m.innerHTML=""),Ge(m,v,!0))),we(1,l.length)}function Ge(t,e,n){function s(c){let m="";c.end_time?m=`${c.end_time-c.start_time}s`:m=`${Math.floor(Date.now()/1e3-c.start_time)}s`;let y=c.retries>0?`<span class="process-retry-badge">Retry ${c.retries}</span>`:"",p=c.channel_id,b={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(b[p]?p=b[p]:/^\d+$/.test(p)&&(p=`Channel ${p}`),n)return`
        <div class="process-history-item" data-channel-id="${c.channel_id}-${c.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let i=n?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(i)).map(c=>[c.dataset.channelId,c])),r=new Set(e.map(c=>`${c.channel_id}-${c.start_time}`));for(let[c,m]of l)r.has(c)||m.remove();let v=new Set;e.forEach(c=>{let m=`${c.channel_id}-${c.start_time}`;if(v.has(m))return;v.add(m);let y=s(c),p=l.get(m);if(p&&p.parentNode){p.outerHTML!==y&&(p.outerHTML=y);let b=t.querySelector(`[data-channel-id="${m}"]`);b&&t.appendChild(b)}else t.insertAdjacentHTML("beforeend",y)})}function He(){let t=Oe(),e="Notification"in window,n={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function Ze(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(s=>{s.addEventListener("click",function(){let i=this.dataset.theme;ot(i),t.setContent(He()),Ze(t)})});let n=document.getElementById("notifications-toggle");n&&"Notification"in window?n.onclick=async s=>{if(s.target.checked)try{await Notification.requestPermission()!=="granted"&&(s.target.checked=!1)}catch{s.target.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),s.target.checked=!0)}:n&&(n.disabled=!0)}var qt=()=>`
    ...
    `;async function Ft(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await jt(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await jt(t)}async function jt(t){try{let e=await I("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let n=await e.json();if(!n||n.length===0){t.innerHTML=z("empty","No web history found.");return}let s=`
        ...
        `;n.forEach((v,c)=>{let m=new Date(v.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),y=v.screenshot?`<img src="data:image/png;base64,${v.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';s+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ms=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,s]of Object.entries(t)){let i=Gt.filter(l=>l.category===n);i.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Jt(),document.getElementById("terminal-action-btn").onclick=()=>Jt());let n=document.getElementById("cli-terminal-body"),s=document.getElementById("cli-docs-pane");n.innerHTML="";let i=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return s.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),document.body.style.overflow="hidden",Ye=!0,n}function Jt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",Ye=!1}function Wt(t,e,n="output"){if(!Ye)return;let s=document.createElement("div");s.className=`terminal-line terminal-${n}`,n==="prompt"?s.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:s.innerHTML=Te(e),t.appendChild(s),t.scrollTop=t.scrollHeight}async function Is(t){let e=Gt.find(i=>i.id===t);if(!e)return;let n=As(e);Wt(n,`dex ${t}`,"prompt");let s=e.demo_output||["Executing command...","\u2713 Done."];for(let i of s){await new Promise(r=>setTimeout(r,400+Math.random()*600));let l="output";i.includes("[ERROR]")?l="error":i.includes("[SUCCESS]")||i.includes("\u2713")?l="success":i.includes("!")&&(l="warning"),Wt(n,i,l)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Vt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ms();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code").textContent;navigator.clipboard.writeText(n).then(()=>{let s=e.querySelector("i");s.className="bx bx-check",s.style.color="#5eff5e",setTimeout(()=>{s.className="bx bx-copy",s.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(n=>{n.addEventListener("mouseenter",()=>{n.style.transform="translateY(-5px)",n.style.borderColor="rgba(255,255,255,0.15)",n.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{n.style.transform="translateY(0)",n.style.borderColor="rgba(255,255,255,0.05)",n.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let s=n.dataset.cmd;Is(s)})})}async function Bs(){if(!_())try{if(!(await I("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Kt(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}st(),it(),Bs(),lt(),tt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Vt();let e=[],n=document.getElementById("windows-container");n&&n.setAttribute("data-count","0");let s=f=>{localStorage.setItem("dex_last_window",f)};function i(){for(;e.length>1;)e.shift().close(!0);let f=document.getElementById("windows-container"),o=document.querySelector("nav"),d=document.querySelector("footer"),u=window.location.pathname==="/"||window.location.pathname==="/index.html",x=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");f&&f.setAttribute("data-count",e.length),e.forEach(B=>{let O=document.getElementById(B.id);O&&O.classList.remove("hide-close")});let L=document.getElementById("dexter-menu-container"),A=document.getElementById("nav-window-switcher"),k=document.getElementById("settings-icon"),T=document.getElementById("close-all-windows"),$=window.innerWidth<880;if(!$){let B=document.getElementById("dexter-dropdown"),O=document.getElementById("dexter-menu-btn");B&&B.classList.remove("active"),O&&O.classList.remove("active"),f&&f.classList.remove("menu-open")}if(fe(e.length>0),e.length>0)if(d?.classList.add("hide"),T&&(T.style.display=$?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",o?.classList.add("window-open"),f&&(f.style.paddingTop="60px"),L&&(L.style.display=$?"flex":"none"),k&&(k.style.display=$?"block":"none"),!$&&A){let B=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(B)?(A.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{s("alerts-window"),l(v)}),document.getElementById("switch-events").addEventListener("click",()=>{s("events-window"),l(c)}),document.getElementById("switch-monitor").addEventListener("click",()=>{s("monitor-window"),l(y)}),document.getElementById("switch-contacts").addEventListener("click",()=>{s("contacts-window"),l(m)}),document.getElementById("switch-workspace").addEventListener("click",()=>{s("workspace-window"),l(p)})):A.innerHTML=""}else A&&(A.innerHTML="");else o?.classList.remove("window-open"),T&&(T.style.display="none"),f&&(f.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",u||x?d?.classList.remove("hide"):d?.classList.add("hide"),L&&(L.style.display="flex"),k&&(k.style.display="block"),A&&(A.innerHTML="");ve()}function l(f){if(f.isOpen()){f.close();return}for(;e.length>0;)e.pop().close(!0);e.push(f),f.open(),i()}function r(){[...e].forEach(o=>o.close()),e=[]}window.addEventListener("resize",i);let v=ae({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:gt(),onOpen:()=>ie(),onClose:()=>{let f=e.indexOf(v);f>-1&&e.splice(f,1),i()}}),c=ae({id:"events-window",title:"Events",icon:"bx-calendar-event",content:We(),onOpen:()=>{c.setContent(We()),ne()},onClose:()=>{let f=e.indexOf(c);f>-1&&e.splice(f,1),i()}}),m=ae({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Tt(),onOpen:()=>Je(),onClose:()=>{let f=e.indexOf(m);f>-1&&e.splice(f,1),i()}}),y=ae({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Nt()},{icon:"bxs-component",title:"Processes",content:zt()},{icon:"bxs-brain",title:"Models",content:Ht()},{icon:"bx-globe",title:"Web",content:qt()},{icon:"bxs-hdd",title:"Hardware",content:Pt()},{icon:"bxs-terminal",title:"Logs",content:Rt()},{icon:"bxs-zap",title:"Agents",content:Dt()},{icon:"bx-task",title:"Chores",content:St()}].filter(f=>_()?f.title!=="Hardware"&&f.title!=="Logs":!0),onOpen:()=>{Ve(),Ne(),Ke(),Ft(),$e(),ye()},onClose:()=>{let f=e.indexOf(y);f>-1&&e.splice(f,1),i()}}),p=ae({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:$t(),onOpen:()=>qe(),onClose:()=>{let f=e.indexOf(p);f>-1&&e.splice(f,1),i()}}),b=ae({id:"settings-window",title:"Settings",icon:"bx-cog",content:He(),onOpen:()=>{b.setContent(He()),Ze(b)},onClose:()=>{let f=e.indexOf(b);f>-1&&e.splice(f,1),i()}});window.dexter={viewEvent:f=>{c.isOpen()||l(c),setTimeout(()=>{let o=document.querySelector(`.event-item[data-event-id="${f}"]`);o&&(o.scrollIntoView({behavior:"smooth",block:"center"}),o.classList.add("flash-highlight"),o.classList.contains("expanded")||o.click(),setTimeout(()=>o.classList.remove("flash-highlight"),2e3))},500)},viewAlert:f=>{v.isOpen()||l(v),setTimeout(()=>{let o=document.querySelector(`.event-item[data-alert-id="${f}"]`);o&&(o.scrollIntoView({behavior:"smooth",block:"center"}),o.classList.add("flash-highlight"),o.classList.contains("expanded")||o.click(),setTimeout(()=>o.classList.remove("flash-highlight"),2e3))},500)}};let a=()=>{let f=document.getElementById("dexter-dropdown"),o=document.getElementById("dexter-menu-btn");f&&o&&(f.classList.remove("active"),o.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let f=document.getElementById("dexter-menu-btn"),o=document.getElementById("settings-icon"),d=document.getElementById("close-all-windows"),u=document.getElementById("nav-left-container"),x=document.getElementById("dexter-dropdown"),L=document.getElementById("windows-container");f&&x&&(f.onclick=k=>{k.stopPropagation();let T=window.innerWidth<880;if(T)x.style.top="",x.style.left="",x.style.right="",x.style.transform="";else{let B=f.getBoundingClientRect(),R=document.querySelector("nav").getBoundingClientRect(),F=220,W=10,S=B.left+B.width/2-F/2,w=R.right-10;S+F>w&&(S=w-F),S<10&&(S=10),x.style.top=R.bottom+W+"px",x.style.left=S+"px",x.style.right="auto",x.style.transform="none"}x.classList.toggle("active"),f.classList.toggle("active");let $=x.classList.contains("active");if(T){let B=document.querySelector("nav");$?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),B?.classList.add("window-open"),L?.classList.add("menu-open"),fe(!0)):(L?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),B?.classList.remove("window-open"),fe(!1)))}}),o&&(o.onclick=k=>{k.stopPropagation(),l(b)}),d&&(d.onclick=k=>{k.stopPropagation(),r()});let A=(k,T,$)=>{let B=document.getElementById(k);B&&(B.onclick=O=>{O.stopPropagation(),a(),$&&s($),l(T)})};A("alerts-menu-item",v,"alerts-window"),A("events-menu-item",c,"events-window"),A("monitor-menu-item",y,"monitor-window"),A("contacts-menu-item",m,"contacts-window"),A("workspace-menu-item",p,"workspace-window"),u&&(u.onclick=k=>{if(k.stopPropagation(),x&&x.classList.contains("active")){a(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1));return}if(e.length>0)r();else{let T=window.location.pathname;if(!(T==="/"||T==="/index.html")){let O=(T.endsWith("/")&&T.length>1?T.slice(0,-1):T).split("/");O.pop();let R=O.join("/")||"/";window.location.href=R}}}),document.addEventListener("click",()=>{let k=window.innerWidth<880;x&&x.classList.contains("active")&&(a(),k&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1)))}),x&&(x.onclick=k=>k.stopPropagation())})();let E=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!E&&!h&&document.querySelector("footer")?.classList.add("hide"),_()||setInterval(()=>{c.isOpen()&&ne(),v.isOpen()?ie():je()},1e3),setInterval(()=>{_()&&(v.isOpen()?ie():je()),p.isOpen()?qe():Ct(),_()&&c.isOpen()&&ne(),y.isOpen()&&Ot()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Kt):Kt();})();
