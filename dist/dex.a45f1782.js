"use strict";(()=>{function ct(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function dt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var mt=1e3;function ue(t){let e=null,n=t.onClose||null,i=t.onOpen||null;function a(){e&&(e.style.zIndex=(++mt).toString())}function c(){if(e){e.classList.add("open"),a(),window.addEventListener("resize",r),i&&setTimeout(i,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++mt).toString(),e.addEventListener("mousedown",a);let y=t.icon||"bx-window",s="",m="",C,I='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((u,g)=>{let $=u.icon?`<i class="bx ${u.icon}"></i>`:`<span class="tab-glyph">${u.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,C=`<div class="window-content">${t.tabs.map((u,g)=>`<div class="tab-content ${g===0?"active":""}" data-tab-content="${g}">${u.content}${I}</div>`).join("")}</div>`):(t.title&&(m=`<div class="window-title">${t.title}</div>`),C=`<div class="window-content">${t.content||""}${I}</div>`),e.innerHTML=`
            ...
            ${C}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",o=>{o.stopPropagation(),d()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(o=>{o.addEventListener("click",()=>{if(!e)return;let l=o.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(g=>g.classList.remove("active")),o.classList.add("active"),e.querySelectorAll(".tab-content").forEach(g=>g.classList.remove("active"));let u=e.querySelector(`.tab-content[data-tab-content="${l}"]`);u&&u.classList.add("active"),b(o,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function r(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&b(p,e)}function b(p,y){setTimeout(()=>{let s=y.querySelector(".tab-bar");if(!s)return;let m=Array.from(s.querySelectorAll(".tab")),C=m.indexOf(p),I=s.clientWidth,o=m[Math.max(0,C-2)],l=m[Math.min(m.length-1,C+2)],u=s,g=o.offsetLeft-u.offsetLeft-25,f=l.offsetLeft+l.offsetWidth-u.offsetLeft+25-g,E=f<=I?g-(I-f)/2:p.offsetLeft-u.offsetLeft-I/2+p.offsetWidth/2;s.scrollTo({left:E,behavior:"smooth"})},350)}function d(p=!1){e&&(window.removeEventListener("resize",r),p?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function x(p){t.content=p;let y=e?.querySelector(".window-content");y&&(y.innerHTML=p)}function w(){return!!(e&&e.classList.contains("open"))}return{open:c,close:d,setContent:x,isOpen:w,focus:a,id:t.id}}var ut="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ve(){return localStorage.getItem(ut)||ee.DARK}function ft(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(ut,t),gt(t)}function gt(t){let e=document.body;Object.values(ee).forEach(c=>{e.classList.remove(`theme-${c}`)}),e.classList.add(`theme-${t}`);let n=document.querySelector('meta[name="theme-color"]');n||(n=document.createElement("meta"),n.name="theme-color",document.getElementsByTagName("head")[0].appendChild(n));let i={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},a=i[t]||i[ee.DARK];if(n.setAttribute("content",a),!document.querySelector(".background")){let c=document.createElement("div");c.className="background",document.body.prepend(c)}e.classList.add("is-animated")}function bt(){let t=Ve();gt(t)}function J(t,e,n=null,i="default"){let c={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${i}"><i class='bx ${c} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function P(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let i=Date.now(),a=Math.floor((i-e)/1e3),c;a<60?c=`${a}s ago`:a<3600?c=`${Math.floor(a/60)}m ago`:c=`${Math.floor(a/3600)}h ago`,n.textContent=`Last updated: ${c}`}var us=0;function Ne(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let i=n.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var ie=0,ae=0;function yt(t){ie=t,$e()}function xt(t){ae=t,$e()}function $e(){let t=ie+ae;us=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",n.appendChild(r)),r.textContent=ie>9?"9+":ie.toString(),r.style.display=ie>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",i.appendChild(r)),r.textContent=ae>9?"9+":ae.toString(),r.style.display=ae>0?"flex":"none"}let a=document.getElementById("switch-alerts");if(a){let r=a.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",a.appendChild(r)),r.textContent=ie>9?"9+":ie.toString(),r.style.display=ie>0?"flex":"none"}let c=document.getElementById("switch-workspace");if(c){let r=c.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",c.appendChild(r)),r.textContent=ae>9?"9+":ae.toString(),r.style.display=ae>0?"flex":"none"}}function Ze(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,$e()}function ht(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,$e()}function fs(){return"https://event.easter.company"}function gs(){return"https://discord.easter.company"}var bs="http://127.0.0.1:8100",vs="http://127.0.0.1:8300",ys={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Re(t){let e=P(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(a,c)=>{let r=ys[c];return r?`<span class="${r}">`:""});let n=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return n>i&&(e+="</span>".repeat(n-i)),e}function re(t){if(!t)return"";let e=P(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,i)=>{let a=i.split("|").map(c=>c.trim());return a.every(c=>c.match(/^:?-+:?$/))?"":`<div class="md-table-row">${a.map(c=>`<span class="md-table-cell">${c}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var xs="https://sterling-javelin-12539.upstash.io",hs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function z(){return window.location.hostname.includes("easter.company")}var F=null,oe={lastDashboard:0,lastFrontend:0},Ke=!1,wt=0,Ct="dex_dashboard_snapshot";function ws(){let t=localStorage.getItem(Ct);if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{F=null}}async function vt(){if(!(!z()||Ke)){Ke=!0,wt=Math.floor(Date.now()/1e3);try{let t=await Ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Ct,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ke=!1}}}function Cs(){if(!F||!F.agent_status)return;let t=F.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Es(){if(!z())return;ws();let t=Math.floor(Date.now()/1e3),e=F?t-F.timestamp:1/0;(!F||e>120)&&await vt(),setInterval(()=>{let n=new Date,i=Math.floor(Date.now()/1e3),a=F?i-F.timestamp:1/0,c=i-wt,r=n.getSeconds()===59,b=a>300,d=c>60;(r&&d||b&&d)&&vt(),Cs()},1e3)}z()&&Es();async function Ts(t,...e){try{let i=await(await fetch(xs,{method:"POST",headers:{Authorization:`Bearer ${hs}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(n){return console.error("Upstash Error:",n),null}}var Ee=null,Te=null,De=!1,ze=!1;async function D(t,e={}){if(z()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(F.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(F.processes),{status:200});if(t.startsWith("/events")){let a=new URLSearchParams(t.split("?")[1]||""),c=a.get("type")||a.get("event.type"),r=a.get("category"),b=a.get("order")||"desc",d=[];return c==="system.notification.generated"?d=[...F.alerts||[]]:c==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...F.blueprints||[]]:r==="messaging"?d=[...F.messaging_events||[]]:r==="system"?d=[...F.system_events||[]]:r==="cognitive"?d=[...F.cognitive_events||[]]:r==="moderation"?d=[...F.moderation_events||[]]:d=[...F.events||[]],b==="asc"?d.sort((x,w)=>x.timestamp-w.timestamp):d.sort((x,w)=>w.timestamp-x.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(F.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let a=t.split("/")[2],c=F.profiles?F.profiles[a]:null;return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(F.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(F.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(Ee)try{let a=await fetch(Ee+t,e);if(a.ok)return a;Ee=null}catch{Ee=null}let n=fs(),i=bs;try{let a=await fetch(n+t,e);if(a.ok)return Ee=n,De&&(console.log("\u2728 Production event service restored."),De=!1),a;throw new Error("Primary failed")}catch{De||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),De=!0);try{let c=await fetch(i+t,e);if(c.ok)return Ee=i,c;throw new Error("Fallback failed")}catch(c){throw c}}}async function fe(t,e={}){if(z()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(F.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let a=t.split("/")[2],c=(F.contacts?.members||[]).find(r=>r.id===a);return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(Te)try{let a=await fetch(Te+t,e);if(a.ok)return a;Te=null}catch{Te=null}let n=gs(),i=vs;try{let a=await fetch(n+t,e);if(a.ok)return Te=n,ze&&(console.log("\u2728 Production discord service restored."),ze=!1),a;throw new Error("Primary failed")}catch{ze||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),ze=!0);try{let c=await fetch(i+t,e);if(c.ok)return Te=i,c;throw new Error("Fallback failed")}catch(c){throw c}}}var Et=()=>`
...
`,Pe=null,ge=new Set,Oe=[];async function pe(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let c=(await i.json()).events||[];Pe=Date.now(),te(0,Pe);let r=Date.now(),b=24*60*60*1e3,d=c.filter(l=>{let u=localStorage.getItem(`alert_read_ts_${l.id}`);if(!u)return!0;let g=parseInt(u);return r-g<b});d.sort((l,u)=>{let g=h=>{let v=h.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return"low"}return(v.priority||"low").toLowerCase()},$=h=>h==="critical"?4:h==="high"?3:h==="medium"?2:1,f=$(g(l)),E=$(g(u));return f!==E?E-f:u.timestamp-l.timestamp}),Oe=d;let x=l=>{let u=l.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return"low"}return(u.priority||"low").toLowerCase()},w=[];if(d.length===0)w.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let u=new Set(d.map($=>x($))).size>1,g=null;d.forEach($=>{let f=x($);u&&f!==g&&(w.push({id:`divider-${f}`,type:"divider",label:f.toUpperCase()}),g=f),w.push($)})}t&&(e.innerHTML="");let p=l=>{let u=l.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let g=(u.title||"Untitled Alert").trim(),$=(u.body||"No description provided.").trim(),f=u.summary||"",E=u.content||"",h=u.protocol||"",v=(u.priority||"low").toLowerCase(),k=!!u.alert,M=(u.category||"system").trim(),A=u.related_event_ids||[],N=u.audit_event_id,O=!!localStorage.getItem(`alert_read_ts_${l.id}`),V=new Date(l.timestamp*1e3),L=V.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=V.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=O?"event-border-grey":"event-border-blue";!O&&k&&(S="event-border-red"),O&&(v==="high"||v==="critical")?S="event-border-red":O&&v==="medium"&&(S="event-border-orange");let _=O?"alert-read":"alert-unread",j=ge.has(l.id),U=j?"expanded":"",R=j?"display: block;":"display: none;",H="",B="";A.length>0&&(B=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${A.map(de=>`<a href="#" onclick="window.dexter.viewEvent('${de}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${de.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let q="";N&&(q=`
            <div style="flex: 1; min-width: 120px; text-align: center;">
                <div style="font-size: 0.65em; text-transform: uppercase; color: #666; letter-spacing: 1px; margin-bottom: 4px;">Audit</div>
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    <a href="#" onclick="window.dexter.viewEvent('${N}'); return false;" style="color: #bb86fc; text-decoration: none; border-bottom: 1px dashed rgba(187, 134, 252, 0.3); white-space: nowrap;">${N.substring(0,8)}...</a>
                </div>
            </div>`);let W="";h&&(W=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #ddd; font-size: 0.85em; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re(E)}</div>
            </div>
        `:X=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re($)}</div>
            </div>
        `,H=`
                ...
                ${X}
            `;let K=document.createElement("div");K.className=`event-item notification-item ${S} ${_} ${U} cursor-pointer priority-${v}`,K.dataset.alertId=l.id,K.onclick=function(de){let Q=this;if(Q.classList.contains("expanded")){Q.classList.remove("expanded"),ge.delete(l.id);let Le=Q.querySelector(".event-details");Le&&(Le.style.display="none")}else{Q.classList.add("expanded"),ge.add(l.id);let Le=Q.querySelector(".event-details");if(Le&&(Le.style.display="block"),!localStorage.getItem(`alert_read_ts_${l.id}`)){localStorage.setItem(`alert_read_ts_${l.id}`,Date.now().toString()),Q.classList.add("alert-read"),Q.classList.remove("alert-unread"),Q.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ge="event-border-grey";v==="high"||v==="critical"?Ge="event-border-red":v==="medium"&&(Ge="event-border-orange"),Q.classList.add(Ge),Ze()}}};let ce=`${h?h.toUpperCase():"GUARDIAN"} ALERT: ${f||g}`,We={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[M]||"bx-bell",ms=v==="high"||v==="critical"?"#ff4d4d":v==="medium"?"#ffa500":"#888";K.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${ms}; font-size: 0.8em; margin-left: 5px;">[${v.toUpperCase()}]</span>
                    </div>
                    <div class="event-message">${re(ce)}</div>
                    <div class="event-details" style="${R}">
                        ${H}
                    </div>
                </div>
            `;let rt=K.querySelector(".event-details");rt&&rt.addEventListener("click",de=>{de.stopPropagation()});let lt=K.querySelector(".close-details-btn");return lt&&lt.addEventListener("click",de=>{de.stopPropagation(),K.classList.remove("expanded");let Q=K.querySelector(".event-details");Q&&(Q.style.display="none"),ge.delete(l.id)}),K},y=l=>{let u=document.createElement("div");u.className="notification-divider",u.dataset.alertId=l.id;let g="#888888";return l.label==="CRITICAL"?g="#ff4d4d":l.label==="HIGH"?g="#ff8888":l.label==="MEDIUM"&&(g="#ffa500"),u.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${g}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,u.innerHTML=`<span style="white-space: nowrap;">${l.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${g}44, transparent); flex-grow: 1;"></div>`,u},s=l=>{let u=document.createElement("div");u.innerHTML=J("empty",l.message,null,l.id);let g=u.firstElementChild;return g.dataset.alertId=l.id,g},m=Array.from(e.children),C=new Map(m.map(l=>[l.dataset.alertId,l])),I=new Set(w.map(l=>l.id));m.forEach(l=>{let u=l.dataset.alertId;(!u||!I.has(u))&&l.remove()});let o=null;w.forEach((l,u)=>{let g=C.get(l.id);if(!g||t){if(g&&g.remove(),l.type==="divider")g=y(l);else if(l.type==="placeholder")g=s(l);else{let $=p(l);if(!$)return;g=$}if(!g)return}u===0?e.firstElementChild!==g&&e.prepend(g):o&&o.nextElementSibling!==g&&o.after(g),o=g}),Pe=Date.now(),te(0,Pe),Ze()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=J("offline","Failed to load alerts.","The event service may be offline."))}}function $s(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),n=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Oe.forEach(a=>{localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Oe.forEach(a=>{ge.add(a.id),localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),pe(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ge.clear(),pe(!0)},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await D("/events?type=system.notification.generated",{method:"DELETE"});let a=Date.now()-48*60*60*1e3;Oe.forEach(c=>{localStorage.setItem(`alert_read_ts_${c.id}`,a.toString())}),ge.clear(),pe(!0)}catch(a){console.error("Failed to clear alerts:",a)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function Ye(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await D(t);if(!e.ok)return;let i=(await e.json()).events||[],a=0;i.forEach(c=>{let r=c.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${c.id}`)||a++}),yt(a)}catch{}}var Tt=()=>`
...
`,be=new Set,kt=[],ke=null;async function ve(t=!1){let e=document.getElementById("roadmap-list");if(e){ks();try{let n=await D("/roadmap");if(!n.ok)throw new Error("Offline");let i=await n.json();kt=i;let a=p=>{let y=be.has(p.id),s=p.state==="published",m=p.state==="consumed",C="event-border-grey";s&&(C="event-border-blue"),m&&(C="event-border-purple");let o=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),l=document.createElement("div");l.className=`event-item notification-item ${C} cursor-pointer ${y?"expanded":""}`,l.dataset.itemId=p.id,l.onclick=$=>{if($.target.closest("button"))return;if(l.classList.contains("expanded")){l.classList.remove("expanded");let E=l.querySelector(".event-details");E&&(E.style.display="none"),be.delete(p.id)}else{l.classList.add("expanded");let E=l.querySelector(".event-details");E&&(E.style.display="block"),be.add(p.id)}};let u=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;l.innerHTML=`
        <div class="event-time">
      ...
      `;let g=l.querySelector(".event-details");return g&&g.addEventListener("click",$=>{$.stopPropagation()}),l.querySelector(".edit-btn")?.addEventListener("click",()=>Ss(p)),l.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ms(p)),l.querySelector(".delete-btn")?.addEventListener("click",()=>Ls(p.id)),l.querySelector(".close-details-btn")?.addEventListener("click",$=>{$.stopPropagation(),l.classList.remove("expanded");let f=l.querySelector(".event-details");f&&(f.style.display="none"),be.delete(p.id)}),l},c=p=>{let y=document.createElement("div");y.innerHTML=J("empty",p.message,p.action,p.id);let s=y.firstElementChild;return s.dataset.itemId=p.id,s},r=[];!i||i.length===0?r.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:z()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):i.forEach(p=>r.push({...p,type:"item"}));let b=Array.from(e.children),d=new Map(b.map(p=>[p.dataset.itemId,p])),x=new Set(r.map(p=>p.id));b.forEach(p=>{let y=p.dataset.itemId;(!y||!x.has(y))&&p.remove()}),t&&(e.innerHTML="");let w=null;r.forEach((p,y)=>{let s=d.get(p.id);(!s||t)&&(s&&s.remove(),p.type==="placeholder"?s=c(p):s=a(p),!s)||(y===0?e.firstElementChild!==s&&e.prepend(s):w&&w.nextElementSibling!==s&&w.after(s),w=s)})}catch{e.children.length===0&&(e.innerHTML=J("offline","Failed to load roadmap.","The event service may be offline."))}}}function ks(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),a=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ke=null;let c=document.getElementById("roadmap-editor-input");c&&(c.value="");let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="block")},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{let c=document.getElementById("roadmap-editor-container");c&&(c.style.display="none"),ke=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let c=document.getElementById("roadmap-editor-input"),r=c?c.value:"";if(!r.trim())return;let b=ke?`/roadmap/${ke}`:"/roadmap",d=ke?"PATCH":"POST";try{await D(b,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})});let x=document.getElementById("roadmap-editor-container");x&&(x.style.display="none"),ve(!0)}catch(x){console.error(x)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{kt.forEach(c=>be.add(c.id)),ve(!0)},i.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{be.clear(),ve(!0)},a.dataset.listenerAttached="true")}function Ss(t){ke=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let n=document.getElementById("roadmap-editor-container");n&&(n.style.display="block",n.scrollIntoView({behavior:"smooth"}))}async function Ms(t){let e=t.state==="published"?"draft":"published";try{await D(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ve(!0)}catch(n){console.error(n)}}async function Ls(t){if(confirm("Delete this roadmap item?"))try{await D(`/roadmap/${t}`,{method:"DELETE"}),be.delete(t),ve(!0)}catch(e){console.error(e)}}var Mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,St=null,ye=new Set,At=[];async function xe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;As();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let c=(await i.json()).events||[];At=c,St=Date.now(),te(2,St);let r=s=>{let m=s.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let C=(m.title||"Untitled Blueprint").trim(),I=(m.summary||m.body||"No summary provided.").trim(),o=(m.content||"").trim(),l=(m.category||"architecture").trim(),u=(m.related_services||m.affected_services||[]).map(H=>H.trim()),g=(m.implementation_path||[]).map(H=>H.trim()),$=m.source_event_ids||[],f=m.approved===!0,E=new Date(s.timestamp*1e3),h=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),v=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=ye.has(s.id),M=k?"display: block;":"display: none;",A=document.createElement("div");A.className=`event-item notification-item event-border-purple cursor-pointer ${k?"expanded":""} ${f?"blueprint-approved":""}`,A.dataset.blueprintId=s.id,f&&(A.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",A.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let G=f?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[l]||"bx-paint";A.onclick=function(H){let B=this;if(B.classList.contains("expanded")){B.classList.remove("expanded"),ye.delete(s.id);let W=B.querySelector(".event-details");W&&(W.style.display="none")}else{B.classList.add("expanded"),ye.add(s.id);let W=B.querySelector(".event-details");W&&(W.style.display="block")}};let O="";g.length>0&&(O=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${g.map(H=>`<li style="margin-bottom: 5px;">${P(H)}</li>`).join("")}</ul></div>
                    </div>
                `);let V="";$.length>0&&(V=`
                ...
                `);let L=u.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${u.join(", ")}</span></div>`:"<div></div>",T=z(),S=f?`
            ...
            `;A.innerHTML=`
                ...
                <div class="event-icon" style="${f?"color: #03dac6;":""}"><i class='bx ${G}'></i></div>
                <div class="event-content">
                    ...
                    <div class="event-details" style="${M}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${P(I)}</div>
            ...
            `;let _=A.querySelector(".blueprint-approve-btn");_&&(_.onclick=async H=>{H.stopPropagation(),_.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await D(`/events/${s.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&xe(!0)}catch(B){console.error("Failed to approve blueprint:",B)}});let j=A.querySelector(".blueprint-delete-btn");j&&(j.onclick=async H=>{H.stopPropagation();let B=!f;j.innerHTML=B?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await D(`/events/${s.id}`,{method:"DELETE"})).ok&&xe(!0)}catch(q){console.error("Failed to delete blueprint:",q)}});let U=A.querySelector(".event-details");U&&U.addEventListener("click",H=>{H.stopPropagation()});let R=A.querySelector(".close-details-btn");return R&&R.addEventListener("click",H=>{H.stopPropagation(),A.classList.remove("expanded");let B=A.querySelector(".event-details");B&&(B.style.display="none"),ye.delete(s.id)}),A},b=s=>{let m=document.createElement("div");m.innerHTML=J("empty",s.message,s.action,s.id);let C=m.firstElementChild;return C.dataset.blueprintId=s.id,C},d=[];c.length===0?d.push({id:"placeholder-empty",type:"placeholder",message:"No architectural blueprints generated yet.",action:"The Imaginator will synthesize these during system idle periods."}):c.forEach(s=>d.push({...s,type:"blueprint"})),t&&(e.innerHTML="");let x=Array.from(e.children),w=new Map(x.map(s=>[s.dataset.blueprintId,s])),p=new Set(d.map(s=>s.id));x.forEach(s=>{let m=s.dataset.blueprintId;(!m||!p.has(m))&&s.remove()});let y=null;d.forEach((s,m)=>{let C=w.get(s.id);(!C||t)&&(C&&C.remove(),s.type==="placeholder"?C=b(s):C=r(s),!C)||(m===0?e.firstElementChild!==C&&e.prepend(C):y&&y.nextElementSibling!==C&&y.after(C),y=C)}),Ne(2,c.length),ht()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=J("offline","Failed to load blueprints.","The event service may be offline."))}}async function It(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await D(t);if(!e.ok)return;let i=(await e.json()).events||[],a=0;i.forEach(c=>{let r=c.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&a++}),xt(a)}catch{}}function As(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),n=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{At.forEach(i=>ye.add(i.id)),xe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ye.clear(),xe(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await D("/events?type=system.blueprint.generated",{method:"DELETE"}),ye.clear(),xe(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var le="STANDBY",Bt=null,Se=[],Y=null,je=null,_t=()=>`
    <div id="progress-view-root" class="progress-container">
        <!-- Initial render will happen here -->
        ${Ht()}
    </div>
  `;function Ht(){switch(le){case"ACTIVE":return Bs();case"COMPLETED":return _s();case"STANDBY":default:return Is()}}function Is(){return`
    ...
    <div class="mission-summary-card">
        ...
        <div class="summary-stat-grid">
            <div class="summary-stat">
                <span class="summary-stat-value">${je?.duration||"12m 4s"}</span>
                <span class="summary-stat-label">Duration</span>
            </div>
            <div class="summary-stat">
                <span class="summary-stat-value">${je?.steps||"42"}</span>
        ...
        <div style="background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; margin-bottom: 30px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-family: 'JetBrains Mono'; font-size: 0.9em; color: #bb86fc;">${je?.result||"Optimized Event Bus"}</span>
  ...
  `}async function Me(){let t=document.getElementById("progress-view-root");t&&(le!==Bt&&(t.innerHTML=Ht(),Bt=le),le==="ACTIVE"&&Hs())}function Hs(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),n=document.getElementById("active-task-progress-text"),i=document.getElementById("terminal-output");if(t&&Y&&(t.innerText=Y.title),e&&Y&&(e.style.width=`${Y.progress}%`),n&&Y&&(n.innerText=`${Y.progress}% COMPLETE`),i){let a=i.children.length;if(Se.length>a){for(let c=a;c<Se.length;c++){let r=Se[c],b=document.createElement("div");b.className="terminal-line",b.innerHTML=`
            <span class="line-time">${r.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${P(r.msg)}</span>
        `,i.appendChild(b)}i.scrollTop=i.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{le="ACTIVE",Se=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],Y={title:"Refactoring System Event Bus",progress:10},Me();let t=0,e=setInterval(()=>{if(le!=="ACTIVE"){clearInterval(e);return}t++,Y.progress=Math.min(100,Y.progress+Math.floor(Math.random()*15));let n=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<n.length&&Se.push({time:new Date().toLocaleTimeString(),msg:n[t]}),Y.progress>=100&&(le="COMPLETED",je={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),Me()},1500)});window.addEventListener("dex-mock-stop",()=>{le="STANDBY",Me()});window.addEventListener("dex-mock-reset",()=>{le="STANDBY",Me()});var Dt=()=>`
...
`,zt=()=>`
    ...
    `,Ae=[],Ie={"313071000877137920":"Owen",dexter:"Dexter"},se=[],he=null;async function Be(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),a=document.getElementById("cancel-chore-btn"),c=document.getElementById("new-chore-owner"),r=document.getElementById("selected-recipients"),b=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),x=document.getElementById("new-chore-url"),w=document.getElementById("new-chore-schedule"),p=document.getElementById("new-chore-time"),y=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(y&&!y.dataset.initialValueAttached){let f=Intl.DateTimeFormat().resolvedOptions().timeZone,E=!1;for(let h=0;h<y.options.length;h++)if(y.options[h].value===f){E=!0;break}if(!E){let h=document.createElement("option");h.value=f,h.textContent=f.replace("_"," "),y.appendChild(h)}y.value=f,y.dataset.initialValueAttached="true"}w&&s&&!w.dataset.timeListenerAttached&&(w.addEventListener("change",()=>{s.style.display=w.value==="daily"?"block":"none"}),w.dataset.timeListenerAttached="true");let m=document.getElementById("form-title"),C=document.getElementById("form-icon");function I(){if(r){if(se.length===0){r.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}r.innerHTML=se.sort((f,E)=>{let h=f.startsWith("channel:"),v=E.startsWith("channel:");return h&&!v?-1:!h&&v?1:0}).map(f=>{let E=Ie[f]||f,h=f.startsWith("channel:");return`
        <div class="recipient-badge" style="display: flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.05); padding: 4px 10px; border-radius: 15px; border: 1px solid rgba(255,255,255,0.1); font-size: 0.75em; color: ${f==="dexter"?"#bb86fc":h?"#03dac6":"#fff"};">
          <i class='bx ${f==="dexter"?"bx-terminal":h?"bx-hash":"bx-user"}'></i>
          <span>${E}</span>
          <i class='bx bx-x remove-recipient' data-id="${f}" style="cursor: pointer; margin-left: 4px; opacity: 0.6;"></i>
        </div>
      `}).join(""),r.querySelectorAll(".remove-recipient").forEach(f=>{f.onclick=()=>{let E=f.dataset.id;se=se.filter(h=>h!==E),I()}})}}function o(f){f&&!se.includes(f)&&(se.push(f),I()),c&&(c.value="")}function l(f=null){if(n){if(he=f?f.id:null,f){if(m&&(m.textContent="Update Research Task"),C&&(C.className="bx bx-edit-alt",C.style.color="#03dac6"),i&&(i.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=f.natural_instruction),x&&(x.value=f.execution_plan?.entry_url||""),w&&(w.value=f.schedule,s&&(s.style.display=f.schedule==="daily"?"block":"none")),p&&f.run_at&&(p.value=f.run_at),y&&f.timezone){let E=!1;for(let h=0;h<y.options.length;h++)if(y.options[h].value===f.timezone){E=!0;break}if(!E){let h=document.createElement("option");h.value=f.timezone,h.textContent=f.timezone.replace("_"," "),y.appendChild(h)}y.value=f.timezone}se=f.recipients||(f.owner_id?[f.owner_id]:[]),I()}else m&&(m.textContent="Initialize Research Task"),C&&(C.className="bx bx-plus-circle",C.style.color="#bb86fc"),i&&(i.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),x&&(x.value=""),w&&(w.value="every_24h"),se=[],I();n.style.display="block",n.scrollIntoView({behavior:"smooth",block:"start"})}}let u=document.getElementById("contacts-group"),g=document.getElementById("channels-group");if(u&&!u.dataset.populated&&!z())try{fe("/contacts").then(async f=>{f.ok&&(((await f.json()).members||[]).forEach(v=>{if(Ie[v.id]=v.nickname||v.username,v.id==="313071000877137920")return;let k=document.createElement("option");k.value=v.id;let M=v.nickname||v.username;k.textContent=`${M} (${v.username})`,u.appendChild(k)}),u.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(g&&!g.dataset.populated&&!z())try{fe("/channels").then(async f=>{f.ok&&((await f.json()).forEach(h=>{let v=`channel:${h.id}`;Ie[v]=h.name;let k=document.createElement("option");k.value=v,k.textContent=`#${h.name} (${h.guild})`,g.appendChild(k)}),g.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}c&&!c.dataset.listenerAttached&&(c.onchange=()=>{o(c.value)},c.dataset.listenerAttached="true"),b&&!b.dataset.listenerAttached&&(b.onchange=()=>$(),b.dataset.listenerAttached="true");function $(){if(!t)return;let f=b?.value||"all",E=f==="all"?Ae:Ae.filter(v=>(v.recipients||(v.owner_id?[v.owner_id]:[])).includes(f));if(E.length===0){t.innerHTML=J("empty",f==="all"?"No active tasks.":"No tasks found for this owner.",z()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let h=E.map(v=>{let k=v.last_run===0?"Never":new Date(v.last_run*1e3).toLocaleString(),M=v.memory?v.memory.length:0,A=v.status==="active"?"#03dac6":"#666",G=(v.recipients||(v.owner_id?[v.owner_id]:[])).sort((O,V)=>{let L=O.startsWith("channel:"),T=V.startsWith("channel:");return L&&!T?-1:!L&&T?1:0}).map(O=>{let V=Ie[O]||O.substring(0,8),L=O.startsWith("channel:");return`<span title="${V}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${O==="dexter"?"bx-terminal":L?"bx-hash":"bx-user"}'></i>${V}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=h,t.querySelectorAll(".edit-chore-btn").forEach(v=>{v.onclick=k=>{k.stopPropagation();let M=v.dataset.id,A=Ae.find(N=>N.id===M);A&&l(A)}}),t.querySelectorAll(".reset-chore-btn").forEach(v=>{v.onclick=async k=>{k.stopPropagation();let M=v.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(v.innerHTML="<i class='bx bx-loader-alt spin'></i>",await D(`/chores/${M}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),Be())}}),t.querySelectorAll(".delete-chore-btn").forEach(v=>{v.onclick=async k=>{k.stopPropagation();let M=v.dataset.id;confirm("Delete this task?")&&(await D(`/chores/${M}`,{method:"DELETE"}),Be())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n&&(n.style.display==="none"||he!==null?l(null):n.style.display="none")},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{n&&(n.style.display="none")},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let f=document.getElementById("new-chore-instruction"),E=document.getElementById("new-chore-url"),h=document.getElementById("new-chore-schedule"),v=f?.value,k=h?.value||"every_24h",M=k==="daily"?p?.value:"",A=k==="daily"?y?.value:"";if(!v)return;if(se.length===0){alert("Please add at least one recipient.");return}let N=i.innerHTML;i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let G=he?"PATCH":"POST",O=he?`/chores/${he}`:"/chores";await D(O,{method:G,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:v,entry_url:E?.value,schedule:k,run_at:M,timezone:A})}),n&&(n.style.display="none"),f&&(f.value=""),E&&(E.value=""),he=null,se=[],Be()}catch(G){console.error(G),alert(he?"Failed to update research task":"Failed to create research task")}finally{i.innerHTML=N}},i.dataset.listenerAttached="true");try{let f=await D("/chores");if(!f.ok)throw new Error(`HTTP error! status: ${f.status}`);if(Ae=await f.json()||[],b){let h=b.value,v=new Set;Ae.forEach(k=>{k.owner_id&&v.add(k.owner_id),k.recipients&&k.recipients.forEach(M=>v.add(M))}),b.innerHTML='<option value="all">All Recipients</option>',v.forEach(k=>{let M=document.createElement("option");M.value=k;let A=k.startsWith("channel:"),N=Ie[k]||`Recipient: ${k.substring(0,8)}`;M.textContent=(A&&!N.startsWith("#")?"#":"")+N,b.appendChild(M)}),b.value=h,b.selectedIndex===-1&&(b.value="all")}$()}catch(f){console.error("Failed to fetch chores",f)}}var Nt=()=>`
...
`;async function Xe(){await Promise.all([ve(),xe(),Me(),Be()])}var Ds=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function jt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Ut(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Ds,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",fe(`/profile/${t.id}`).then(async n=>{if(n.ok){let i=await n.json();Qe(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=jt(t.id,t.username);Qe(e,t,i)}}).catch(n=>{console.error("Profile fetch error:",n);let i=jt(t.id,t.username);Qe(e,t,i)})}function Qe(t,e,n){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",a=()=>{let C=(n.attributes||n.facts||[]).map($=>{let f=$.key||$.k,E=$.value||$.v;return`
            <div class="fact-chip">
                <span class="fact-key">${f}:</span>
                <span class="fact-val">${E}</span>
            </div>
        `}).join(""),I=n.cognitive_model||n,o=I.technical_level||I.techLevel||0,l=I.communication_style||I.commStyle||"Unknown",u=I.patience_level||I.patience||"Unknown",g=I.vibe||"Unknown";return`
        ...
        `},c=()=>{let C=n.dossier||{},I=C.identity||{},o=C.career||{},l=C.personal||{},u=C.social||[];return`
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="margin-top: 10px;">
                            ${(l.hobbies||[]).map(g=>`<div class="dossier-list-item">${g}</div>`).join("")}
                        </div>
                    </div>
                    ...
                    <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(l.habits||[]).map(g=>`<div class="dossier-list-item">${g}</div>`).join("")}
                        </div>
                    </div>
                     ...
                     <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(l.vices||[]).map(g=>`<div class="dossier-list-item" style="color: #cf6679;">${g}</div>`).join("")}
                        </div>
                    </div>
                </div>
        ...
        <div style="margin-top: 40px;">
            ...
            <div style="height: 100px; border-bottom: 1px solid #333; display: flex; align-items: flex-end; gap: 5px; padding-bottom: 5px;">
                ${Array.from({length:40}).map(()=>{let I=Math.floor(Math.random()*80)+10;return`<div style="flex: 1; background: ${Math.random()>.7?"#cf6679":Math.random()>.5?"#03dac6":"#444"}; height: ${I}%; border-radius: 2px;"></div>`}).join("")}
            </div>
        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                ...
                <div class="profile-identity">
                    <h2>${P(e.username)}</h2>
                    <div class="profile-badges">${(n.badges||[]).map(C=>`<span class="profile-badge ${C==="Creator"?"master":""}">${C}</span>`).join("")}</div>
                </div>
            </div>
    ...
    `;t.innerHTML=x;let w=t.querySelector(".profile-card"),p=t.querySelector("#profile-expand-toggle"),y=t.querySelectorAll(".profile-tab-btn"),s=t.querySelectorAll(".tab-content"),m=t.querySelector(".close-profile-btn");m&&m.addEventListener("click",()=>{t.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>t.remove(),300)}),y.forEach(C=>{C.addEventListener("click",()=>{y.forEach(l=>l.classList.remove("active")),s.forEach(l=>l.classList.remove("active")),C.classList.add("active");let I=C.dataset.tab,o=t.querySelector(`#tab-${I}`);o&&o.classList.add("active")})}),p&&p.addEventListener("click",()=>{w.classList.toggle("expanded");let C=w.classList.contains("expanded");p.innerHTML=C?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var qt=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
...
`,zs=null;async function et(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await et(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let a=n.target.closest(".user-profile-card");if(a&&a.dataset.user)try{let c=JSON.parse(a.dataset.user);Ut(c)}catch(c){console.error("Failed to parse user data",c)}},t.dataset.listenerAttached="true");try{let n=await fe("/contacts");if(!n.ok)throw new Error("Service unreachable");let a=(await n.json()).members||[];if(zs=Date.now(),a.length===0){t.innerHTML=J("empty","No contacts found.","Check your Discord connection.");return}let c={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};a.sort((r,b)=>{let d=c[r.level]??10,x=c[b.level]??10;return d!==x?d-x:r.username.localeCompare(b.username)}),t.innerHTML=a.map(r=>{let b=r.color&&r.color!==0,d=b?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",x=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",w="#888";r.level==="Me"||r.level==="Master"?w="#bb86fc":r.level==="Admin"?w="#cf6679":r.level==="Moderator"?w="#03dac6":r.level==="Contributor"&&(w="#ffa500");let p=r.level==="Me",y=p?"rgba(187, 134, 252, 0.08)":b?`${d}11`:"rgba(255,255,255,0.03)",s=p?"2px solid #bb86fc":b?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${p?"#bb86fc":b?d:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${r.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${p?"2px solid #bb86fc":b?`2px solid ${d}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${b?d:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${r.nickname||r.username}</h3>
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${w}; font-weight: 600; text-transform: uppercase;">${p?"DEXTER (ME)":r.level}</span>
...
`,Ue=null,we=new Set,_e=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Rs))if(n.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function me(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let i=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(i+=`&category=${Z}`);try{let a=await D(i);if(!a.ok)throw new Error("Service unreachable");if(_e=((await a.json()).events||[]).filter(y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let m=s.type;return!(m==="system.blueprint.generated"||m==="system.notification.generated")}),Ue=Date.now(),te(1,Ue),_e.length===0){e.innerHTML=J("empty","No events found for this filter.");return}t&&(e.innerHTML="");let b=y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let m=s.type,C=Os(m),I=js(m),o=m==="engagement.decision"||m==="messaging.bot.sent_message"||m==="messaging.bot.voice_response"||m==="messaging.user.sent_message"||m==="moderation.explicit_content.deleted"||m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="analysis.user.message_signals"||m==="system.cli.command"||m==="system.analysis.audit"||m==="system.test.completed"||m==="error_occurred"||m==="system.cli.status"||m==="system.attention.expired"||m.startsWith("system.roadmap")||m.startsWith("system.process"),l="event-border-grey";o&&(m==="moderation.explicit_content.deleted"||m==="error_occurred"?l="event-border-red":m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="system.analysis.audit"||m==="analysis.user.message_signals"?l="event-border-purple":m==="system.attention.expired"||m==="system.cli.command"||m==="system.cli.status"?l="event-border-orange":m==="system.test.completed"?l=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":l="event-border-blue");let u=o?"cursor-pointer":"",g=we.has(y.id),$=g?"expanded":"",f=g?"display: block;":"display: none;",E=new Date(y.timestamp*1e3),h=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),v=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=Ft(m,s),M=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",A="";if(o){let L="";if(m==="engagement.decision"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                    ...
                    `}else if(m==="system.attention.expired"){let T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,S=s.timestamp-s.last_active,_=Math.floor(S/60);L=`
                    ...
                    `}else if(m==="messaging.bot.sent_message"){let T=U=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${U}</h5>`,S="";if(s.embed){let U=s.embed,R=U.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${P(U.title)}</div>`:"",H=U.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(U.description)}</div>`:"",B=(U.fields||[]).map(q=>`
              <div style="margin-top: 10px;">
                <div style="font-size: 0.7em; text-transform: uppercase; color: #666; letter-spacing: 1px;">${P(q.name)}</div>
                <div style="font-size: 0.85em; color: #eee; white-space: pre-wrap;">${re(q.value)}</div>
              </div>
            `).join("");S=`
              <div class="discord-embed" style="margin-top: 15px; padding: 12px; border-left: 4px solid ${U.color?"#"+U.color.toString(16).padStart(6,"0"):"#bb86fc"}; background: rgba(255,255,255,0.02); border-radius: 0 4px 4px 0;">
                ${R}
                ${H}
                ${B}
              </div>
            `}let _="";s.eval_count&&(_=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let j="";if(s.chat_history&&s.chat_history.length>0){let U=s.chat_history.length,R=s.chat_history.map((H,B)=>{let q=H.name?H.name.toUpperCase():H.role.toUpperCase();!H.name&&q==="ASSISTANT"&&(q="DEXTER");let W=H.role==="user"?"#03dac6":H.role==="system"?"#ffb74d":"#bb86fc",X=B===U-1?"block":"none";return`
                                <div class="history-slide" data-index="${B}" style="display: ${X};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${W}; letter-spacing: 1px; font-weight: bold;">${q}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${B+1} of ${U}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${P(H.content)}</div>
                                </div>
                            `}).join("");j=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(m==="messaging.bot.voice_response"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Response Model:</span>
                            <span class="detail-value">${s.response_model||"N/A"}</span>
                        </div>
                    ...
                    `}else if(m==="analysis.user.message_signals"){let T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,S=s.signals||{};L=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${(S.topics||[]).map(j=>`<span class="profile-badge">${j}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                    ...
                    `}else if(m==="moderation.explicit_content.deleted"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="analysis.link.completed"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="analysis.visual.completed"){let T=_=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${_}</h5>`,S="";s.base64_preview?S=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(S=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(m==="analysis.router.decision"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="system.cli.command"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="system.analysis.audit"){let T=s.success?"#03dac6":"#ff4d4d",S=s.success?"SUCCESS":"FAILED",_=B=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${B}</h5>`,j="";s.error&&(j=`
                            <div class="event-detail-block">
                                ${_("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${P(s.error)}</pre>
                            </div>
                        `);let U="";if(s.chat_history&&s.chat_history.length>0){let B=s.chat_history.length,q=s.chat_history.map((W,X)=>{let K=W.name?W.name.toUpperCase():W.role.toUpperCase();!W.name&&K==="USER"&&(K="SYSTEM"),!W.name&&K==="ASSISTANT"&&(K="AGENT");let ce=W.role==="user"?"#03dac6":W.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${X}" style="display: ${X===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; text-transform: uppercase; color: ${ce}; letter-spacing: 1px; font-weight: bold;">${K}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${X+1} of ${B}</span>
                                    </div>
                            ...
                            <div class="event-detail-block">
                                ...
                                <div class="history-carousel" style="position: relative; background: rgba(255,255,255,0.03); border-radius: 4px; padding: 15px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        ...
                                        <button class="carousel-btn next-btn" style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 0.8em; transition: background 0.2s;" ${B<=1?"disabled":""}>Next <i class='bx bx-chevron-right'></i></button>
                                    </div>
                                </div>
                            </div>
                        `}let R="";if(s.corrections&&s.corrections.length>0){let B=s.corrections.map((q,W)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                ...
                                ${q.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${P(q.snippet)}</div>`:""}
                            </div>
                        `).join("");R=`
                            <div class="event-detail-block">
                        ...
                        `}let H="";if(s.parsed_results&&s.parsed_results.length>0){let B=s.parsed_results.map(q=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${P(q.title)}</div>
                                <div style="color: #ddd;">${P(q.summary)}</div>
                            </div>
                        `).join("");H=`
                            <div class="event-detail-block">
                                ${_("Parsed Results")}
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${T}; font-weight: bold;">${S} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${s.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${R}
                        ${U}
                    `}else if(m==="system.test.completed"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="error_occurred"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(m==="system.cli.status"){let T=S=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${S}</h5>`;L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                    ...
                    `}else if(m==="messaging.user.sent_message"){let T="";s.attachments&&s.attachments.length>0&&(T=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(_=>{let j=_.content_type&&_.content_type.startsWith("image/"),U=(_.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${j?`<div class="attachment-thumb-container"><img src="${_.url}" alt="${_.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                                    <div class="attachment-info">
                                        <a href="${_.url}" target="_blank" class="attachment-link">${_.filename}</a>
                                        <span class="attachment-meta">${_.content_type} \u2022 ${U}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                ...
                `}let N=document.createElement("div");N.className=`event-item ${l} ${u} ${$}`,N.dataset.eventId=y.id,N.onclick=function(L){if(!o)return;let T=this;if(T.classList.contains("expanded")){T.classList.remove("expanded"),we.delete(y.id);let _=T.querySelector(".event-details");_&&(_.style.display="none")}else{T.classList.add("expanded"),we.add(y.id);let _=T.querySelector(".event-details");_&&(_.style.display="block")}},N.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${h}</span>
                    <span class="event-date">${v}</span>
                </div>
            ...
            `;let G=N.querySelector(".event-details");if(G&&G.addEventListener("click",L=>{L.stopPropagation()}),o){let L=N.querySelector(".close-details-btn");L&&L.addEventListener("click",T=>{T.stopPropagation();let S=T.target.closest(".event-item");if(S){S.classList.remove("expanded"),we.delete(y.id);let _=S.querySelector(".event-details");_&&(_.style.display="none")}})}let O=N.querySelector(".prev-btn"),V=N.querySelector(".next-btn");if(O&&V){let L=0,T=Array.from(N.querySelectorAll(".history-slide")),S=T.length,_=()=>{T.forEach((j,U)=>{j.style.display=U===L?"block":"none"}),O.disabled=L===0,V.disabled=L===S-1,O.style.opacity=L===0?"0.5":"1",V.style.opacity=L===S-1?"0.5":"1"};O.addEventListener("click",j=>{j.stopPropagation(),L>0&&(L--,_())}),V.addEventListener("click",j=>{j.stopPropagation(),L<S-1&&(L++,_())}),_()}return N},d=Array.from(e.children),x=new Map(d.map(y=>[y.dataset.eventId,y])),w=new Set(_e.map(y=>y.id));d.forEach(y=>{let s=y.dataset.eventId;(!s||!w.has(s))&&y.remove()});let p=null;_e.forEach((y,s)=>{let m=x.get(y.id);(!m||t)&&(m&&m.remove(),m=b(y),!m)||(s===0?e.firstElementChild!==m&&e.prepend(m):p&&p.nextElementSibling!==m&&p.after(m),p=m)}),Ue=Date.now(),te(1,Ue)}catch(a){console.error("Error fetching events:",a),e.children.length===0&&(e.innerHTML=J("offline","Failed to load events.","The event service may be offline."))}}function Us(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),n=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{_e.forEach(a=>we.add(a.id)),me(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{we.clear(),me(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.querySelectorAll(".filter-btn").forEach(a=>{a.onclick=()=>{n.querySelectorAll(".filter-btn").forEach(c=>c.classList.remove("active")),a.classList.add("active"),Z=a.dataset.filter||"all",me(!0)}}),n.dataset.listenerAttached="true"),n&&n.querySelectorAll(".filter-btn").forEach(a=>{a.dataset.filter===Z?a.classList.add("active"):a.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let a=Z==="all"?"ALL":Z.toUpperCase();if(confirm(`Are you sure you want to delete ${a} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let c="/events";if(Z!=="all"?c+=`?category=${Z}`:c+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await D(c,{method:"DELETE"})).ok)throw new Error("Failed to delete events");we.clear(),me(!0)}catch(c){console.error("Failed to clear events:",c),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var qs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`);return`
            ...
            `}).join("");return t.innerHTML=c,document.querySelectorAll(".copy-logs-btn").forEach(r=>{r.addEventListener("click",()=>{let b=r,d=unescape(b.dataset.logs||"");navigator.clipboard.writeText(d).then(()=>{let x=b.querySelector("i");x&&(x.classList.remove("bx-copy"),x.classList.add("bx-check"),setTimeout(()=>{x.classList.remove("bx-check"),x.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(r=>{r.addEventListener("click",async()=>{let d=r.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${d}?`))try{(await D(`/logs?service_id=${d}`,{method:"DELETE"})).ok&&He()}catch(x){console.error("Error clearing logs:",x)}})}),Fs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=J("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Zt=()=>{let t=z()?"display: none;":"";return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Wt()}
        </div>`;async function ss(){Js(),await Promise.all([ne(),nt(),it()]),await He()}var qe=null;function Js(){qe||(qe=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(qe),qe=null;return}ne(!0)},1e3))}var Gt=null,Vt=null;async function ns(){try{return await(await D("/system_monitor")).json()}catch{return null}}async function Kt(){try{return await(await D("/system/hardware")).json()}catch{return null}}async function Ws(){try{return await(await D("/processes")).json()}catch{return null}}async function Gs(){try{return await(await D("/agent/status")).json()}catch{return null}}async function nt(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),a=document.querySelector("#hw-ram .hw-content"),c=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),b=o=>{if(o){if(n&&(n.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                ...
                </div>`}c&&(o.GPU&&o.GPU.length>0?c.innerHTML=o.GPU.map(l=>{let u=(l.VRAM/1073741824).toFixed(1);return`
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let o=await Kt();o?(b(o),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),i&&!i.hasChildNodes())){let o=await Kt();b(o)}if(!t)return;let d=await ns();if(!d||!d.services){t.children.length===0&&(t.innerHTML=J("offline","Failed to load system metrics.","The event service may be offline."));let o=document.querySelector('[data-service-id="upstash-redis-ro"]');if(o){o.className="service-widget service-widget-offline",o.querySelector(".service-widget-status").textContent="ERROR";let l=o.querySelector(".service-widget-body");l&&(l.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Gt=z()&&oe.lastDashboard||Date.now(),te(0,Gt||0);let x=d.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let o=document.getElementById("upstash-countdown");if(o){let g=59-new Date().getSeconds();g<=0&&(g+=60),o.textContent=`${g}s`}},1e3)),Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function w(o){if(!o||o==="N/A"||o==="unknown")return"-";let l=o.match(/^(\d+\.\d+\.\d+)/);return l?l[0]:o.split(".").slice(0,3).join(".")||"-"}function p(o){return!o||o.length<=28?o:o.substring(0,28)+"..."}function y(o){if(!o||o==="N/A"||o==="unknown")return"-";let l=o.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!l)return"-";let u=parseInt(l[1])||0,g=parseInt(l[2])||0,$=parseInt(l[3])||0,f=parseFloat(l[4])||0,E=u*86400+g*3600+$*60+f,h=Math.floor(E/86400);if(h>0)return`${h}d`;let v=Math.floor(E/3600);if(v>0)return`${v}h`;let k=Math.floor(E/60);return k>0?`${k}m`:`${Math.floor(E)}s`}function s(o){if(o.id==="upstash-redis-ro"){let V=z()&&(oe.lastFrontend||oe.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
                ...
                <div class="service-widget-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 10px 0;">
                    ...
                    <div class="sync-time-label" style="font-size: 0.6em; color: #444; margin-top: 10px;">Last synced: ${new Date(V).toLocaleTimeString()}</div>
                </div>
            </div>`}let l=o.status==="online",u=l?"service-widget-online":"service-widget-offline",g=l?"bx-check-circle":"bx-x-circle",$=l?"OK":"BAD",f=o.version?w(o.version.str):"-",E=o.cpu&&o.cpu!=="N/A"?o.cpu:"-",h=o.memory&&o.memory!=="N/A"?o.memory:"-",v=E!=="-"?"#00ff00":"#666",k=E!=="-"?"#fff":"#666",M=h!=="-"?"#00ff00":"#666",A=h!=="-"?"#fff":"#666",N=y(o.uptime),G="";l?G=`
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${k};">${E}</span>
                    </div>
                    <div class="service-widget-item">
                        <i class="bx bxs-chip" style="color: ${M};"></i>
                        <span style="color: ${A};">${h}</span>
                    </div>
                </div>`:G='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let O=z()?"easter.company":p(o.domain&&o.port?`${o.domain}:${o.port}`:"");return`<div class="service-widget ${u}" data-service-id="${o.id}"><div class="service-widget-header"><i class="bx ${g}"></i><h3>${o.short_name||o.id}</h3><span class="service-widget-status">${$}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${G}</div></div>`}let m=new Map(Array.from(t.querySelectorAll(".service-widget")).map(o=>[o.dataset.serviceId,o])),C=new Set(x.map(o=>o.id));for(let[o,l]of m)C.has(o)||l.remove();let I=new Set;x.forEach(o=>{if(I.has(o.id))return;I.add(o.id);let l=s(o),u=m.get(o.id);if(u&&u.parentNode)if(o.id==="upstash-redis-ro"){let g=z()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),$=new Date(g).toLocaleTimeString(),f=u.querySelector(".sync-time-label");f&&(f.textContent=`Last synced: ${$}`)}else u.outerHTML!==l&&(u.outerHTML=l);else t.insertAdjacentHTML("beforeend",l)})}async function it(){let t=document.getElementById("models-widgets");if(!t)return;let e=await ns();if(!e){t.children.length===0&&(t.innerHTML=J("offline","Failed to load model status.","The event service may be offline."));return}Vt=Date.now(),te(2,Vt);let n=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function a(d){let x=d.status==="Ready";return`
                ...
                </div>`}function r(d){let x=d.status==="Downloaded",w=x?"service-widget-online":"service-widget-offline",p=x?"OK":"MISSING",y=x&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${w}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${x?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${p}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${y}</span></div></div></div>`}let b="";if(i&&(b+=a(i)),e.xtts&&(b+=c(e.xtts)),b+=n.map(r).join(""),!b){t.innerHTML=J("empty","No models found.");return}t.innerHTML!==b&&(t.innerHTML=b)}async function ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let n=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-idle-val"),a=document.getElementById("guardian-total-idle"),c=document.getElementById("guardian-total-active"),r=document.getElementById("guardian-total-waste"),b=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn"),x=document.getElementById("fabricator-reset-btn"),w=document.getElementById("courier-reset-btn"),p=document.getElementById("system-pause-toggle-btn");p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{let g=p.querySelector(".bx-play")?"/agent/resume":"/agent/pause";p.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D(g,{method:"POST"}),await ne()}catch{p.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>ne(),2e3)}},p.dataset.listenerAttached="true"),b&&!b.dataset.listenerAttached&&(b.onclick=async()=>{b.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{b.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{b.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{b.innerHTML="<i class='bx bx-error'></i>"}},b.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true"),x&&!x.dataset.listenerAttached&&(x.onclick=async()=>{x.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/fabricator/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{x.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{x.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{x.innerHTML="<i class='bx bx-error'></i>"}},x.dataset.listenerAttached="true"),w&&!w.dataset.listenerAttached&&(w.onclick=async()=>{w.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{w.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{w.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{w.innerHTML="<i class='bx bx-error'></i>"}},w.dataset.listenerAttached="true");let y=await Gs();if(y&&y.agents){let u=y.agents.guardian||{protocols:{}},g=y.agents.analyzer||{protocols:{}},$=y.agents.imaginator||{protocols:{}},f=y.agents.fabricator||{protocols:{}},E=y.agents.courier||{protocols:{}},h=y.system||{},v=Math.floor(Date.now()/1e3),k={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},M=R=>{R<0&&(R=0);let H=Math.floor(R/3600),B=Math.floor(R%3600/60),q=R%60;return H>0?`${H}h ${B}m`:B>0?`${B}m ${q}s`:`${q}s`},A=(R,H,B,q)=>{if(!R)return;let W=k[q]||q.toUpperCase(),X=R.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(X&&(X.textContent=W),!B){R.textContent="Inactive",R.style.color="#666";return}let K=B.status;if(K==="Working")R.textContent="Working",R.style.color="#bb86fc";else if(K==="Ready")R.textContent="Ready",R.style.color="#5eff5e";else{let ce=B.cooldown;if(z()&&(ce=B.next_run-v),ce<=0)R.textContent="Ready",R.style.color="#5eff5e";else{let Je=Math.floor(ce/60),We=ce%60;R.textContent=`${Je}m ${We}s`,R.style.color="#fff"}}H&&B.stats&&(H.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
              <span>Runs: ${B.stats.runs||0}</span>
              <span style="color: ${B.stats.failures>0?"#ffa500":"#666"}">Fails: ${B.stats.failures||0}</span>
              <span style="color: ${B.stats.aborted>0?"#ff4d4d":"#666"}">Aborted: ${B.stats.aborted||0}</span>
            </div>
          `)};n&&A(n,document.getElementById("guardian-sentry-stats"),u.protocols.sentry,"sentry");let N=document.getElementById("analyzer-synthesis-val"),G=document.getElementById("analyzer-synthesis-stats");N&&A(N,G,g.protocols.synthesis,"synthesis");let O=document.getElementById("imaginator-alert_review-val"),V=document.getElementById("imaginator-alert_review-stats");O&&A(O,V,$.protocols.alert_review,"alert_review");let L=document.getElementById("fabricator-construction-val"),T=document.getElementById("fabricator-construction-stats");L&&A(L,T,f.protocols.construction,"construction");let S=document.getElementById("courier-researcher-val"),_=document.getElementById("courier-researcher-stats");S&&A(S,_,E.protocols.researcher,"researcher");let j=document.getElementById("system-state-label"),U=document.getElementById("system-state-val");if(U&&h.state){let R=h.state,H=M(h.state_time||0);j&&(j.textContent=`State: ${R.toUpperCase()}`),U.textContent=H,R==="idle"?U.style.color=h.state_time>300?"#5eff5e":"#fff":U.style.color="#bb86fc",p&&(R==="paused"?(p.innerHTML="<i class='bx bx-play'></i>",p.title="Resume System",p.style.color="#ff9800"):(p.innerHTML="<i class='bx bx-pause'></i>",p.title="Pause System",p.style.color=""))}a&&(a.textContent=M(h.metrics?.total_idle_time||0)),c&&(c.textContent=M(h.metrics?.total_active_time||0)),r&&(r.textContent=M(h.metrics?.total_waste_time||0))}else[n,i,a,c,r].forEach(g=>{g&&(g.textContent="-",g.style.color="#666")});if(t)return;let s=await Ws(),m=[],C=[],I=[];s&&(Array.isArray(s)?m=s:(m=s.active||[],C=s.queue||[],I=s.history||[],I.sort((u,g)=>(g.end_time||0)-(u.end_time||0)))),e&&(m.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=J("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),st(e,m,!1)));let o=document.getElementById("processes-queue-widgets");o&&(C.length===0?!o.querySelector(".tab-placeholder")&&!o.querySelector('div[style*="font-style: italic"]')&&(o.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(o.innerHTML="",st(o,C,!1)));let l=document.getElementById("processes-history-widgets");l&&(I.length===0?l.querySelector(".tab-placeholder")||(l.innerHTML=J("empty","No recent history.")):(l.querySelector(".tab-placeholder")&&(l.innerHTML=""),st(l,I,!0))),Ne(1,m.length)}function st(t,e,n){function i(d){let x="";d.end_time?x=`${d.end_time-d.start_time}s`:x=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let w=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",p=d.channel_id,y={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent"};if(y[p]?p=y[p]:/^\d+$/.test(p)&&(p=`Channel ${p}`),n)return`
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let a=n?".process-history-item":".process-widget",c=new Map(Array.from(t.querySelectorAll(a)).map(d=>[d.dataset.channelId,d])),r=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,x]of c)d&&!r.has(d)&&x.remove();let b=new Set;e.forEach(d=>{let x=`${d.channel_id}-${d.start_time}`;if(b.has(x))return;b.add(x);let w=i(d),p=c.get(x);if(p&&p.parentNode){p.outerHTML!==w&&(p.outerHTML=w);let y=t.querySelector(`[data-channel-id="${x}"]`);y&&t.appendChild(y)}else t.insertAdjacentHTML("beforeend",w)})}function Fe(){let t=Ve(),e="Notification"in window,n={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function at(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(i=>{i.addEventListener("click",function(){let a=this.dataset.theme;a&&(ft(a),t.setContent(Fe()),at(t))})});let n=document.getElementById("notifications-toggle");n&&"Notification"in window?n.onclick=async i=>{let a=i.target;if(a.checked)try{await Notification.requestPermission()!=="granted"&&(a.checked=!1)}catch{a.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),a.checked=!0)}:n&&(n.disabled=!0)}var as=()=>`
    ...
    `;async function os(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await is(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await is(t)}async function is(t){try{let e=await D("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let n=await e.json();if(!n||n.length===0){t.innerHTML=J("empty","No web history found.");return}let i=`
        ...
        `;n.forEach((b,d)=>{let x=new Date(b.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),w=b.screenshot?`<img src="data:image/png;base64,${b.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';i+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Vs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,i]of Object.entries(t)){let a=cs.filter(c=>c.category===n);a.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>rs());let x=document.getElementById("terminal-action-btn");x&&(x.onclick=()=>rs())}let n=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");n&&(n.innerHTML="");let a=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let c=document.getElementById("terminal-cmd-name");c&&(c.textContent=`dex ${t.id}`);let r=document.getElementById("terminal-status-badge");r&&(r.className="terminal-status status-running",r.textContent="Running");let b=document.getElementById("terminal-action-btn");return b&&(b.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",ot=!0,n}function rs(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",ot=!1}function ls(t,e,n="output"){if(!ot||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${n}`,n==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let a=Re(e);i.innerHTML=a||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Zs(t){let e=cs.find(r=>r.id===t);if(!e)return;let n=Ks(e);n&&ls(n,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let r of i){await new Promise(d=>setTimeout(d,400+Math.random()*600));let b="output";r.includes("[ERROR]")?b="error":r.includes("[SUCCESS]")||r.includes("\u2713")?b="success":r.includes("!")&&(b="warning"),n&&ls(n,r,b)}let a=document.getElementById("terminal-status-badge");a&&(a.className="terminal-status status-success",a.textContent="Completed (Demo)");let c=document.getElementById("terminal-action-btn");c&&(c.style.display="block")}function ds(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Vs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code"),i=n?n.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let a=e.querySelector("i");a&&(a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(n=>{let i=n;n.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let a=i.dataset.cmd;a&&Zs(a)})})}async function Ys(){if(!z())try{if(!(await D("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ps(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}dt(),pt(),Ys(),bt(),ct();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ds();let e=[],n=document.getElementById("windows-container");n&&n.setAttribute("data-count","0");let i=o=>{localStorage.setItem("dex_last_window",o)};function a(){for(;e.length>1;)e.shift().close(!0);let o=document.getElementById("windows-container"),l=document.querySelector("nav"),u=document.querySelector("footer"),g=window.location.pathname==="/"||window.location.pathname==="/index.html",$=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");o&&o.setAttribute("data-count",e.length.toString()),e.forEach(M=>{let A=document.getElementById(M.id);A&&A.classList.remove("hide-close")});let f=document.getElementById("dexter-menu-container"),E=document.getElementById("nav-window-switcher"),h=document.getElementById("settings-icon"),v=document.getElementById("close-all-windows"),k=window.innerWidth<880;if(!k){let M=document.getElementById("dexter-dropdown"),A=document.getElementById("dexter-menu-btn");M&&M.classList.remove("active"),A&&A.classList.remove("active"),o&&o.classList.remove("menu-open")}if(Ce(e.length>0),e.length>0)if(u?.classList.add("hide"),v&&(v.style.display=k?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",l?.classList.add("window-open"),o&&(o.style.paddingTop="60px"),f&&(f.style.display=k?"flex":"none"),h&&(h.style.display=k?"block":"none"),!k&&E){let M=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(M)?(E.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),c(b)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),c(d)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),c(w)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),c(x)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),c(p)})):E.innerHTML=""}else E&&(E.innerHTML="");else l?.classList.remove("window-open"),v&&(v.style.display="none"),o&&(o.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",g||$?u?.classList.remove("hide"):u?.classList.add("hide"),f&&(f.style.display="flex"),h&&(h.style.display="block"),E&&(E.innerHTML="");$e()}function c(o){if(o.isOpen()){o.close();return}for(;e.length>0;)e.pop().close(!0);e.push(o),o.open(),a()}function r(){[...e].forEach(l=>l.close()),e=[]}window.addEventListener("resize",a);let b=ue({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Et(),onOpen:()=>pe(),onClose:()=>{let o=e.indexOf(b);o>-1&&e.splice(o,1),a()}}),d=ue({id:"events-window",title:"Events",icon:"bx-calendar-event",content:tt(),onOpen:()=>{d.setContent(tt()),me()},onClose:()=>{let o=e.indexOf(d);o>-1&&e.splice(o,1),a()}}),x=ue({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:qt(),onOpen:()=>et(),onClose:()=>{let o=e.indexOf(x);o>-1&&e.splice(o,1),a()}}),w=ue({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Xt()},{icon:"bxs-component",title:"Processes",content:Yt()},{icon:"bxs-brain",title:"Models",content:Qt()},{icon:"bx-globe",title:"Web",content:as()},{icon:"bxs-hdd",title:"Hardware",content:es()},{icon:"bxs-terminal",title:"Logs",content:ts()},{icon:"bxs-zap",title:"Agents",content:Zt()}].filter(o=>z()?o.title!=="Hardware"&&o.title!=="Logs":!0),onOpen:()=>{nt(),ne(),it(),os(),He()},onClose:()=>{let o=e.indexOf(w);o>-1&&e.splice(o,1),a()}}),p=ue({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Nt()},{icon:"bx-map-alt",title:"Roadmap",content:Rt()},{icon:"bx-paint",title:"Blueprints",content:Pt()},{icon:"bx-task",title:"Tasks",content:Ot()}],onOpen:()=>Xe(),onClose:()=>{let o=e.indexOf(p);o>-1&&e.splice(o,1),a()}}),y=ue({id:"settings-window",title:"Settings",icon:"bx-cog",content:Fe(),onOpen:()=>{y.setContent(Fe()),at(y)},onClose:()=>{let o=e.indexOf(y);o>-1&&e.splice(o,1),a()}});window.dexter={viewEvent:o=>{d.isOpen()||c(d),setTimeout(()=>{let l=document.querySelector(`.event-item[data-event-id="${o}"]`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.classList.add("flash-highlight"),l.classList.contains("expanded")||l.click(),setTimeout(()=>l.classList.remove("flash-highlight"),2e3))},500)},viewAlert:o=>{b.isOpen()||c(b),setTimeout(()=>{let l=document.querySelector(`.event-item[data-alert-id="${o}"]`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.classList.add("flash-highlight"),l.classList.contains("expanded")||l.click(),setTimeout(()=>l.classList.remove("flash-highlight"),2e3))},500)}};let s=()=>{let o=document.getElementById("dexter-dropdown"),l=document.getElementById("dexter-menu-btn");o&&l&&(o.classList.remove("active"),l.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let o=document.getElementById("dexter-menu-btn"),l=document.getElementById("settings-icon"),u=document.getElementById("close-all-windows"),g=document.getElementById("nav-left-container"),$=document.getElementById("dexter-dropdown"),f=document.getElementById("windows-container");o&&$&&(o.onclick=h=>{h.stopPropagation();let v=window.innerWidth<880;if(v)$.style.top="",$.style.left="",$.style.right="",$.style.transform="";else{let M=o.getBoundingClientRect(),N=document.querySelector("nav").getBoundingClientRect(),G=220,O=10,L=M.left+M.width/2-G/2,T=N.right-10;L+G>T&&(L=T-G),L<10&&(L=10),$.style.top=N.bottom+O+"px",$.style.left=L+"px",$.style.right="auto",$.style.transform="none"}$.classList.toggle("active"),o.classList.toggle("active");let k=$.classList.contains("active");if(v){let M=document.querySelector("nav");k?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),M?.classList.add("window-open"),f?.classList.add("menu-open"),Ce(!0)):(f?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),M?.classList.remove("window-open"),Ce(!1)))}}),l&&(l.onclick=h=>{h.stopPropagation(),c(y)}),u&&(u.onclick=h=>{h.stopPropagation(),r()});let E=(h,v,k)=>{let M=document.getElementById(h);M&&(M.onclick=A=>{A.stopPropagation(),s(),k&&i(k),c(v)})};E("alerts-menu-item",b,"alerts-window"),E("events-menu-item",d,"events-window"),E("monitor-menu-item",w,"monitor-window"),E("contacts-menu-item",x,"contacts-window"),E("workspace-menu-item",p,"workspace-window"),g&&(g.onclick=h=>{if(h.stopPropagation(),$&&$.classList.contains("active")){s(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Ce(!1));return}if(e.length>0)r();else{let v=window.location.pathname;if(!(v==="/"||v==="/index.html")){let A=(v.endsWith("/")&&v.length>1?v.slice(0,-1):v).split("/");A.pop();let N=A.join("/")||"/";window.location.href=N}}}),document.addEventListener("click",()=>{let h=window.innerWidth<880;$&&$.classList.contains("active")&&(s(),h&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Ce(!1)))}),$&&($.onclick=h=>h.stopPropagation())})();let C=window.location.pathname==="/"||window.location.pathname==="/index.html",I=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!C&&!I&&document.querySelector("footer")?.classList.add("hide"),z()||setInterval(()=>{d.isOpen()&&me(),b.isOpen()?pe():Ye()},1e3),setInterval(()=>{z()&&(b.isOpen()?pe():Ye()),p.isOpen()?Xe():It(),z()&&d.isOpen()&&me(),w.isOpen()&&ss()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ps):ps();})();
