"use strict";(()=>{function dt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function pt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var ut=1e3;function me(t){let e=null,n=t.onClose||null,i=t.onOpen||null;function a(){e&&(e.style.zIndex=(++ut).toString())}function l(){if(e){e.classList.add("open"),a(),window.addEventListener("resize",o),i&&setTimeout(i,10);return}let u=document.getElementById("windows-container");u||(u=document.createElement("div"),u.id="windows-container",u.className="windows-container",document.body.appendChild(u)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++ut).toString(),e.addEventListener("mousedown",a);let v=t.icon||"bx-window",s="",m="",w,B='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((h,y)=>{let c=h.icon?`<i class="bx ${h.icon}"></i>`:`<span class="tab-glyph">${h.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,w=`<div class="window-content">${t.tabs.map((h,y)=>`<div class="tab-content ${y===0?"active":""}" data-tab-content="${y}">${h.content}${B}</div>`).join("")}</div>`):(t.title&&(m=`<div class="window-title">${t.title}</div>`),w=`<div class="window-content">${t.content||""}${B}</div>`),e.innerHTML=`
...
`,je=null,ge=new Set,Ue=[];async function de(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await _(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];je=Date.now(),te(0,je);let o=Date.now(),f=24*60*60*1e3,d=l.filter(p=>{let h=localStorage.getItem(`alert_read_ts_${p.id}`);if(!h)return!0;let y=parseInt(h);return o-y<f});d.sort((p,h)=>{let y=E=>{let g=E.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},c=E=>E==="critical"?4:E==="high"?3:E==="medium"?2:1,r=c(y(p)),C=c(y(h));return r!==C?C-r:h.timestamp-p.timestamp}),Ue=d;let x=p=>{let h=p.event;if(typeof h=="string")try{h=JSON.parse(h)}catch{return"low"}return(h.priority||"low").toLowerCase()},T=[];if(d.length===0)T.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let h=new Set(d.map(c=>x(c))).size>1,y=null;d.forEach(c=>{let r=x(c);h&&r!==y&&(T.push({id:`divider-${r}`,type:"divider",label:r.toUpperCase()}),y=r),T.push(c)})}t&&(e.innerHTML="");let u=p=>{let h=p.event;if(typeof h=="string")try{h=JSON.parse(h)}catch{return null}let y=(h.title||"Untitled Alert").trim(),c=(h.body||"No description provided.").trim(),r=h.summary||"",C=h.content||"",E=h.protocol||"",g=(h.priority||"low").toLowerCase(),k=!!h.alert,A=(h.category||"system").trim(),M=h.related_event_ids||[],P=h.audit_event_id,q=!!localStorage.getItem(`alert_read_ts_${p.id}`),G=new Date(p.timestamp*1e3),H=G.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=G.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=q?"event-border-grey":"event-border-blue";!q&&k&&(L="event-border-red"),q&&(g==="high"||g==="critical")?L="event-border-red":q&&g==="medium"&&(L="event-border-orange");let I=q?"alert-read":"alert-unread",O=ge.has(p.id),R=O?"expanded":"",V=O?"display: block;":"display: none;",S="",D="";M.length>0&&(D=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${M.map(ce=>`<a href="#" onclick="window.dexter.viewEvent('${ce}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${ce.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let z="";P&&(z=`
...
`,Lt=null,ve=new Set,It=[];async function ye(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;As();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await _(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];It=l,Lt=Date.now(),te(2,Lt);let o=s=>{let m=s.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let w=(m.title||"Untitled Blueprint").trim(),B=(m.summary||m.body||"No summary provided.").trim(),b=(m.content||"").trim(),p=(m.category||"architecture").trim(),h=(m.related_services||m.affected_services||[]).map(S=>S.trim()),y=(m.implementation_path||[]).map(S=>S.trim()),c=m.source_event_ids||[],r=m.approved===!0,C=new Date(s.timestamp*1e3),E=C.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=C.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=ve.has(s.id),A=k?"display: block;":"display: none;",M=document.createElement("div");M.className=`event-item notification-item event-border-purple cursor-pointer ${k?"expanded":""} ${r?"blueprint-approved":""}`,M.dataset.blueprintId=s.id,r&&(M.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",M.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let W=r?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[p]||"bx-paint";M.onclick=function(S){let D=this;if(D.classList.contains("expanded")){D.classList.remove("expanded"),ve.delete(s.id);let U=D.querySelector(".event-details");U&&(U.style.display="none")}else{D.classList.add("expanded"),ve.add(s.id);let U=D.querySelector(".event-details");U&&(U.style.display="block")}};let q="";y.length>0&&(q=`
                ...
                `);let H=h.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${h.join(", ")}</span></div>`:"<div></div>",$=N(),L=r?`
            ...
            `;M.innerHTML=`
                ...
                <div class="event-content">
                    ...
                    <div class="event-details" style="${A}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${j(B)}</div>
...
`,Nt=()=>`
    ...
    `,Be=[],He={"313071000877137920":"Owen",dexter:"Dexter"},se=[],xe=null;async function _e(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),a=document.getElementById("cancel-chore-btn"),l=document.getElementById("new-chore-owner"),o=document.getElementById("selected-recipients"),f=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),x=document.getElementById("new-chore-url"),T=document.getElementById("new-chore-schedule"),u=document.getElementById("new-chore-time"),v=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(v&&!v.dataset.initialValueAttached){let r=Intl.DateTimeFormat().resolvedOptions().timeZone,C=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===r){C=!0;break}if(!C){let E=document.createElement("option");E.value=r,E.textContent=r.replace("_"," "),v.appendChild(E)}v.value=r,v.dataset.initialValueAttached="true"}T&&s&&!T.dataset.timeListenerAttached&&(T.addEventListener("change",()=>{s.style.display=T.value==="daily"?"block":"none"}),T.dataset.timeListenerAttached="true");let m=document.getElementById("form-title"),w=document.getElementById("form-icon");function B(){if(o){if(se.length===0){o.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}o.innerHTML=se.sort((r,C)=>{let E=r.startsWith("channel:"),g=C.startsWith("channel:");return E&&!g?-1:!E&&g?1:0}).map(r=>{let C=He[r]||r,E=r.startsWith("channel:");return`
      ...
      `}).join(""),o.querySelectorAll(".remove-recipient").forEach(r=>{r.onclick=()=>{let C=r.dataset.id;se=se.filter(E=>E!==C),B()}})}}function b(r){r&&!se.includes(r)&&(se.push(r),B()),l&&(l.value="")}function p(r=null){if(n){if(xe=r?r.id:null,r){if(m&&(m.textContent="Update Research Task"),w&&(w.className="bx bx-edit-alt",w.style.color="#03dac6"),i&&(i.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=r.natural_instruction),x&&(x.value=r.execution_plan?.entry_url||""),T&&(T.value=r.schedule,s&&(s.style.display=r.schedule==="daily"?"block":"none")),u&&r.run_at&&(u.value=r.run_at),v&&r.timezone){let C=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===r.timezone){C=!0;break}if(!C){let E=document.createElement("option");E.value=r.timezone,E.textContent=r.timezone.replace("_"," "),v.appendChild(E)}v.value=r.timezone}se=r.recipients||(r.owner_id?[r.owner_id]:[]),B()}else m&&(m.textContent="Initialize Research Task"),w&&(w.className="bx bx-plus-circle",w.style.color="#bb86fc"),i&&(i.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),x&&(x.value=""),T&&(T.value="every_24h"),se=[],B();n.style.display="block",n.scrollIntoView({behavior:"smooth",block:"start"})}}let h=document.getElementById("contacts-group"),y=document.getElementById("channels-group");if(h&&!h.dataset.populated&&!N())try{ue("/contacts").then(async r=>{r.ok&&(((await r.json()).members||[]).forEach(g=>{if(He[g.id]=g.nickname||g.username,g.id==="313071000877137920")return;let k=document.createElement("option");k.value=g.id;let A=g.nickname||g.username;k.textContent=`${A} (${g.username})`,h.appendChild(k)}),h.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(y&&!y.dataset.populated&&!N())try{ue("/channels").then(async r=>{r.ok&&((await r.json()).forEach(E=>{let g=`channel:${E.id}`;He[g]=E.name;let k=document.createElement("option");k.value=g,k.textContent=`#${E.name} (${E.guild})`,y.appendChild(k)}),y.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}l&&!l.dataset.listenerAttached&&(l.onchange=()=>{b(l.value)},l.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onchange=()=>c(),f.dataset.listenerAttached="true");function c(){if(!t)return;let r=f?.value||"all",C=r==="all"?Be:Be.filter(g=>(g.recipients||(g.owner_id?[g.owner_id]:[])).includes(r));if(C.length===0){t.innerHTML=J("empty",r==="all"?"No active tasks.":"No tasks found for this owner.",N()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let E=C.map(g=>{let k=g.last_run===0?"Never":new Date(g.last_run*1e3).toLocaleString(),A=g.memory?g.memory.length:0,M=g.status==="active"?"#03dac6":"#666",W=(g.recipients||(g.owner_id?[g.owner_id]:[])).sort((q,G)=>{let H=q.startsWith("channel:"),$=G.startsWith("channel:");return H&&!$?-1:!H&&$?1:0}).map(q=>{let G=He[q]||q.substring(0,8),H=q.startsWith("channel:");return`<span title="${G}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${q==="dexter"?"bx-terminal":H?"bx-hash":"bx-user"}'></i>${G}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=E,t.querySelectorAll(".edit-chore-btn").forEach(g=>{g.onclick=k=>{k.stopPropagation();let A=g.dataset.id,M=Be.find(P=>P.id===A);M&&p(M)}}),t.querySelectorAll(".reset-chore-btn").forEach(g=>{g.onclick=async k=>{k.stopPropagation();let A=g.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(g.innerHTML="<i class='bx bx-loader-alt spin'></i>",await _(`/chores/${A}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),_e())}}),t.querySelectorAll(".delete-chore-btn").forEach(g=>{g.onclick=async k=>{k.stopPropagation();let A=g.dataset.id;confirm("Delete this task?")&&(await _(`/chores/${A}`,{method:"DELETE"}),_e())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n&&(n.style.display==="none"||xe!==null?p(null):n.style.display="none")},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{n&&(n.style.display="none")},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let r=document.getElementById("new-chore-instruction"),C=document.getElementById("new-chore-url"),E=document.getElementById("new-chore-schedule"),g=r?.value,k=E?.value||"every_24h",A=k==="daily"?u?.value:"",M=k==="daily"?v?.value:"";if(!g)return;if(se.length===0){alert("Please add at least one recipient.");return}let P=i.innerHTML;i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let W=xe?"PATCH":"POST",q=xe?`/chores/${xe}`:"/chores";await _(q,{method:W,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:g,entry_url:C?.value,schedule:k,run_at:A,timezone:M})}),n&&(n.style.display="none"),r&&(r.value=""),C&&(C.value=""),xe=null,se=[],_e()}catch(W){console.error(W),alert(xe?"Failed to update research task":"Failed to create research task")}finally{i.innerHTML=P}},i.dataset.listenerAttached="true");try{let r=await _("/chores");if(!r.ok)throw new Error(`HTTP error! status: ${r.status}`);if(Be=await r.json()||[],f){let E=f.value,g=new Set;Be.forEach(k=>{k.owner_id&&g.add(k.owner_id),k.recipients&&k.recipients.forEach(A=>g.add(A))}),f.innerHTML='<option value="all">All Recipients</option>',g.forEach(k=>{let A=document.createElement("option");A.value=k;let M=k.startsWith("channel:"),P=He[k]||`Recipient: ${k.substring(0,8)}`;A.textContent=(M&&!P.startsWith("#")?"#":"")+P,f.appendChild(A)}),f.value=E,f.selectedIndex===-1&&(f.value="all")}c()}catch(r){console.error("Failed to fetch chores",r)}}var Pt=()=>`
...
`;function Ut(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function qt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Ds,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",ue(`/profile/${t.id}`).then(async n=>{if(n.ok){let i=await n.json();tt(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=Ut(t.id,t.username);tt(e,t,i)}}).catch(n=>{console.error("Profile fetch error:",n);let i=Ut(t.id,t.username);tt(e,t,i)})}function tt(t,e,n){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",a=()=>{let w=(n.attributes||n.facts||[]).map(c=>{let r=c.key||c.k,C=c.value||c.v;return`
        ...
        `}).join(""),B=n.cognitive_model||n,b=B.technical_level||B.techLevel||0,p=B.communication_style||B.commStyle||"Unknown",h=B.patience_level||B.patience||"Unknown",y=B.vibe||"Unknown";return`
        ...
        `},l=()=>{let w=n.dossier||{},B=w.identity||{},b=w.career||{},p=w.personal||{},h=w.social||[];return`
...
`,Fe=null,he=new Set,De=[],Z="all",Ps={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Rs={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Ps))if(n.includes(t))return e;return"system"}function js(t){return Rs[t]||"bx-square-rounded"}async function pe(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let i=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(i+=`&category=${Z}`);try{let a=await _(i);if(!a.ok)throw new Error("Service unreachable");if(De=((await a.json()).events||[]).filter(v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let m=s.type;return!(m==="system.blueprint.generated"||m==="system.notification.generated")}),Fe=Date.now(),te(1,Fe),De.length===0){e.innerHTML=J("empty","No events found for this filter.");return}t&&(e.innerHTML="");let f=v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let m=s.type,w=Os(m),B=js(m),b=m==="engagement.decision"||m==="messaging.bot.sent_message"||m==="messaging.bot.voice_response"||m==="messaging.user.sent_message"||m==="moderation.explicit_content.deleted"||m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="analysis.user.message_signals"||m==="system.cli.command"||m==="system.analysis.audit"||m==="system.test.completed"||m==="error_occurred"||m==="system.cli.status"||m==="system.attention.expired"||m.startsWith("system.roadmap")||m.startsWith("system.process"),p="event-border-grey";b&&(m==="moderation.explicit_content.deleted"||m==="error_occurred"?p="event-border-red":m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="system.analysis.audit"||m==="analysis.user.message_signals"||m==="engagement.decision"?p="event-border-purple":m==="system.attention.expired"||m==="system.cli.command"||m==="system.cli.status"?p="event-border-orange":m==="system.test.completed"?p=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let h=b?"cursor-pointer":"",y=he.has(v.id),c=y?"expanded":"",r=y?"display: block;":"display: none;",C=new Date(v.timestamp*1e3),E=C.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=C.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=Jt(m,s),A=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",M="";if(b){let H="";if(m==="engagement.decision"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                    ...
                    `}else if(m==="system.attention.expired"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,L=s.timestamp-s.last_active,I=Math.floor(L/60);H=`
                    ...
                    `}else if(m==="messaging.bot.sent_message"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,L="";if(s.embed){let R=s.embed,V=R.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${j(R.title)}</div>`:"",S=R.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(R.description)}</div>`:"",D=(R.fields||[]).map(z=>`
              <div style="margin-top: 10px;">
            ...
            `}let I="";s.eval_count&&(I=`
                        ...
                        `);let O="";if(s.chat_history&&s.chat_history.length>0){let R=s.chat_history.length,V=s.chat_history.map((S,D)=>{let z=S.name?S.name.toUpperCase():S.role.toUpperCase();!S.name&&z==="ASSISTANT"&&(z="DEXTER");let U=S.role==="user"?"#03dac6":S.role==="system"?"#ffb74d":"#bb86fc",Y=D===R-1?"block":"none";return`
                        ...
                        `}
                    `}else if(m==="messaging.bot.voice_response"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,L="",I=[],O=s.raw_input||"";if(O.startsWith("[{")&&O.endsWith("}]")){let R=O.match(/{.*?}/g);R&&(I=R.map(V=>{let S=V.substring(1,V.length-1),D=S.indexOf(" "),z=S.substring(0,D),U=S.substring(D+1);return U=U.replace(/\[\]$/,"").trim(),{role:z,content:U}}))}if(I.length>0&&s.response_raw&&I.push({role:"assistant",content:s.response_raw}),I.length>0){let R=I.length,V=I.map((S,D)=>{let z=S.role.toUpperCase();z==="ASSISTANT"&&(z="DEXTER");let U=S.role==="user"?"#03dac6":S.role==="system"?"#ffb74d":"#bb86fc",Y=D===R-1?"block":"none";return`
                                <div class="history-slide" data-index="${D}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${U}; letter-spacing: 1px; font-weight: bold;">${z}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${D+1} of ${R}</span>
                    ...
                    `}else if(m==="analysis.user.message_signals"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,L=s.signals||{};H=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(m==="moderation.explicit_content.deleted"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="analysis.link.completed"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="analysis.visual.completed"){let $=I=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${I}</h5>`,L="";s.base64_preview?L=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(L=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),H=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(m==="analysis.router.decision"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="system.cli.command"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="system.analysis.audit"){let $=s.success?"#03dac6":"#ff4d4d",L=s.success?"SUCCESS":"FAILED",I=D=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${D}</h5>`,O="";s.error&&(O=`
                            <div class="event-detail-block">
                                ${I("Error")}
                        ...
                        `}let V="";if(s.corrections&&s.corrections.length>0){let D=s.corrections.map((z,U)=>`
                        ...
                        `}let S="";if(s.parsed_results&&s.parsed_results.length>0){let D=s.parsed_results.map(z=>`
                        ...
                        ${V}
                        ${R}
                    `}else if(m==="system.test.completed"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="error_occurred"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(m==="system.cli.status"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ...
            </div>`}let r=c.status==="online",C=r?"service-widget-online":"service-widget-offline",E=r?"bx-check-circle":"bx-x-circle",g=r?"OK":"BAD",k=c.version?m(c.version.str):"-",A=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",M=c.memory&&c.memory!=="N/A"?c.memory:"-",P=A!=="-"?"#00ff00":"#666",W=A!=="-"?"#fff":"#666",q=M!=="-"?"#00ff00":"#666",G=M!=="-"?"#fff":"#666",H=B(c.uptime),$="",L=c.type!=="os"&&c.type!=="cli"&&c.type!=="prd",I="";L&&!N()&&(I=`
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${G};">${M}</span>
                    </div>
                </div>${I}`:$=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${I}`;let O=N()?"easter.company":w(c.domain&&c.port?`${c.domain}:${c.port}`:"");return`<div class="service-widget ${C}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${E}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${g}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${$}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),h=new Set(s.map(c=>c.id));for(let[c,r]of p)h.has(c)||r.remove();let y=new Set;s.forEach(c=>{if(y.has(c.id))return;y.add(c.id);let r=b(c),C=p.get(c.id);if(C&&C.parentNode)if(c.id==="upstash-redis-ro"){let E=N()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),g=new Date(E).toLocaleTimeString(),k=C.querySelector(".sync-time-label");k&&(k.textContent=`Last synced: ${g}`)}else C.outerHTML!==r&&(C.outerHTML=r);else t.insertAdjacentHTML("beforeend",r)})}async function at(){let t=document.getElementById("models-widgets");if(!t)return;let e=await is();if(!e){t.children.length===0&&(t.innerHTML=J("offline","Failed to load model status.","The event service may be offline."));return}Kt=Date.now(),te(2,Kt);let n=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function a(d){let x=d.status==="Ready";return`
          ...
          `)};n&&P(n,document.getElementById("guardian-sentry-stats"),y.protocols.sentry,"sentry");let W=document.getElementById("analyzer-synthesis-val"),q=document.getElementById("analyzer-synthesis-stats");W&&P(W,q,c.protocols.synthesis,"synthesis");let G=document.getElementById("imaginator-alert_review-val"),H=document.getElementById("imaginator-alert_review-stats");G&&P(G,H,r.protocols.alert_review,"alert_review");let $=document.getElementById("fabricator-construction-val"),L=document.getElementById("fabricator-construction-stats");$&&P($,L,C.protocols.construction,"construction");let I=document.getElementById("courier-researcher-val"),O=document.getElementById("courier-researcher-stats");I&&P(I,O,E.protocols.researcher,"researcher");let R=document.getElementById("system-state-label"),V=document.getElementById("system-state-val");if(V&&g.state){let S=g.state,D=M(g.state_time||0);R&&(R.textContent=`State: ${S.toUpperCase()}`),V.textContent=D,S==="idle"?V.style.color=g.state_time>300?"#5eff5e":"#fff":V.style.color="#bb86fc",u&&(S==="paused"?(u.innerHTML="<i class='bx bx-play'></i>",u.title="Resume System",u.style.color="#ff9800"):(u.innerHTML="<i class='bx bx-pause'></i>",u.title="Pause System",u.style.color=""))}a&&(a.textContent=M(g.metrics?.total_idle_time||0)),l&&(l.textContent=M(g.metrics?.total_active_time||0)),o&&(o.textContent=M(g.metrics?.total_waste_time||0))}else[n,i,a,l,o].forEach(c=>{c&&(c.textContent="-",c.style.color="#666")});if(t)return;let m=await Ws(),w=[],B=[],b=[];m&&(Array.isArray(m)?w=m:(w=m.active||[],B=m.queue||[],b=m.history||[],b.sort((y,c)=>(c.end_time||0)-(y.end_time||0)))),e&&(w.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=J("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),it(e,w,!1)));let p=document.getElementById("processes-queue-widgets");p&&(B.length===0?!p.querySelector(".tab-placeholder")&&!p.querySelector('div[style*="font-style: italic"]')&&(p.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(p.innerHTML="",it(p,B,!1)));let h=document.getElementById("processes-history-widgets");h&&(b.length===0?h.querySelector(".tab-placeholder")||(h.innerHTML=J("empty","No recent history.")):(h.querySelector(".tab-placeholder")&&(h.innerHTML=""),it(h,b,!0))),Re(1,w.length)}function it(t,e,n){function i(d){let x="";d.end_time?x=`${d.end_time-d.start_time}s`:x=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let T=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",u=d.channel_id,v={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent"};if(v[u]?u=v[u]:/^\d+$/.test(u)&&(u=`Channel ${u}`),n)return`
