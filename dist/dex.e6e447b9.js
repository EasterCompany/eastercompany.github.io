...
`,Fe=null,he=new Set,De=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Rs))if(n.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function pe(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let a=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(a+=`&category=${Z}`);try{let i=await _(a);if(!i.ok)throw new Error("Service unreachable");if(De=((await i.json()).events||[]).filter(v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Fe=Date.now(),te(1,Fe),De.length===0){e.innerHTML=J("empty","No events found for this filter.");return}t&&(e.innerHTML="");let b=v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,C=Os(u),A=js(u),f=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.bot.voice_response"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),p="event-border-grey";f&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?p="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"||u==="engagement.decision"?p="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?p="event-border-orange":u==="system.test.completed"?p=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let x=f?"cursor-pointer":"",y=he.has(v.id),c=y?"expanded":"",r=y?"display: block;":"display: none;",w=new Date(v.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Jt(u,s),B=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",M="";if(f){let H="";if(u==="engagement.decision"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                    ...
                    `}else if(u==="messaging.bot.sent_message"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,L="";if(s.embed){let P=s.embed,V=P.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${j(P.title)}</div>`:"",k=P.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(P.description)}</div>`:"",z=(P.fields||[]).map(N=>`
              <div style="margin-top: 10px;">
            ...
            `}let I="";s.eval_count&&(I=`
                        ...
                        `);let O="";if(s.chat_history&&s.chat_history.length>0){let P=s.chat_history.length,V=s.chat_history.map((k,z)=>{let N=k.name?k.name.toUpperCase():k.role.toUpperCase();!k.name&&N==="ASSISTANT"&&(N="DEXTER");let U=k.role==="user"?"#03dac6":k.role==="system"?"#ffb74d":"#bb86fc",Y=z===P-1?"block":"none";return`
                        ...
                        `}
                    `}else if(u==="messaging.bot.voice_response"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,L="",I=[],O=s.raw_input||"";if(O.startsWith("[{")&&O.endsWith("}]")){let P=O.match(/{.*?}/g);P&&(I=P.map(V=>{let k=V.substring(1,V.length-1),z=k.indexOf(" "),N=k.substring(0,z),U=k.substring(z+1);return U=U.replace(/\[\]$/,"").trim(),{role:N,content:U}}))}if(I.length>0&&s.response_raw&&I.push({role:"assistant",content:s.response_raw}),I.length>0){let P=I.length,V=I.map((k,z)=>{let N=k.role.toUpperCase();N==="ASSISTANT"&&(N="DEXTER");let U=k.role==="user"?"#03dac6":k.role==="system"?"#ffb74d":"#bb86fc",Y=z===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${z}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${U}; letter-spacing: 1px; font-weight: bold;">${N}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${z+1} of ${P}</span>
                    ...
                    `}else if(u==="system.analysis.audit"){let $=s.success?"#03dac6":"#ff4d4d",L=s.success?"SUCCESS":"FAILED",I=z=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${z}</h5>`,O="";s.error&&(O=`
                        ...
                        `}let k="";if(s.parsed_results&&s.parsed_results.length>0){let z=s.parsed_results.map(N=>`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ...
            </div>`}let r=c.status==="online",w=r?"service-widget-online":"service-widget-offline",E=r?"bx-check-circle":"bx-x-circle",g=r?"OK":"BAD",S=c.version?u(c.version.str):"-",B=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",M=c.memory&&c.memory!=="N/A"?c.memory:"-",D=B!=="-"?"#00ff00":"#666",W=B!=="-"?"#fff":"#666",q=M!=="-"?"#00ff00":"#666",G=M!=="-"?"#fff":"#666",H=A(c.uptime),$="",L=c.type!=="os"&&c.type!=="cli"&&c.type!=="prd",I="";L&&!R()&&(I=`
