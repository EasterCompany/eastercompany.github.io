"use strict";(()=>{function dt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function pt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",a=`
    ...
    `,r=document.createElement("nav");r.innerHTML=a,document.body.prepend(r);let o=document.createElement("div");o.id="dexter-dropdown",o.className="dexter-dropdown",o.innerHTML=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var ut=1e3;function me(t){let e=null,n=t.onClose||null,i=t.onOpen||null;function a(){e&&(e.style.zIndex=(++ut).toString())}function r(){if(e){e.classList.add("open"),a(),window.addEventListener("resize",o),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++ut).toString(),e.addEventListener("mousedown",a);let y=t.icon||"bx-window",s="",u="",T,H='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((x,v)=>{let l=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,T=`<div class="window-content">${t.tabs.map((x,v)=>`<div class="tab-content ${v===0?"active":""}" data-tab-content="${v}">${x.content}${H}</div>`).join("")}</div>`):(t.title&&(u=`<div class="window-title">${t.title}</div>`),T=`<div class="window-content">${t.content||""}${H}</div>`),e.innerHTML=`
            ...
            ${T}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",b=>{b.stopPropagation(),d()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach(b=>{b.addEventListener("click",()=>{if(!e)return;let p=b.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),b.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active"));let x=e.querySelector(`.tab-content[data-tab-content="${p}"]`);x&&x.classList.add("active"),f(b,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&f(m,e)}function f(m,y){setTimeout(()=>{let s=y.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),T=u.indexOf(m),H=s.clientWidth,b=u[Math.max(0,T-2)],p=u[Math.min(u.length-1,T+2)],x=s,v=b.offsetLeft-x.offsetLeft-25,c=p.offsetLeft+p.offsetWidth-x.offsetLeft+25-v,C=c<=H?v-(H-c)/2:m.offsetLeft-x.offsetLeft-H/2+m.offsetWidth/2;s.scrollTo({left:C,behavior:"smooth"})},350)}function d(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function h(m){t.content=m;let y=e?.querySelector(".window-content");y&&(y.innerHTML=m)}function E(){return!!(e&&e.classList.contains("open"))}return{open:r,close:d,setContent:h,isOpen:E,focus:a,id:t.id}}var gt="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ze(){return localStorage.getItem(gt)||ee.DARK}function ft(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(gt,t),bt(t)}function bt(t){let e=document.body;Object.values(ee).forEach(r=>{e.classList.remove(`theme-${r}`)}),e.classList.add(`theme-${t}`);let n=document.querySelector('meta[name="theme-color"]');n||(n=document.createElement("meta"),n.name="theme-color",document.getElementsByTagName("head")[0].appendChild(n));let i={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},a=i[t]||i[ee.DARK];if(n.setAttribute("content",a),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}e.classList.add("is-animated")}function vt(){let t=Ze();bt(t)}function F(t,e,n=null,i="default"){let r={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${i}"><i class='bx ${r} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function j(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let i=Date.now(),a=Math.floor((i-e)/1e3),r;a<60?r=`${a}s ago`:a<3600?r=`${Math.floor(a/60)}m ago`:r=`${Math.floor(a/3600)}h ago`,n.textContent=`Last updated: ${r}`}var us=0;function Pe(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let i=n.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var ie=0,ae=0;function xt(t){ie=t,Se()}function ht(t){ae=t,Se()}function Se(){let t=ie+ae;us=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let o=n.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",n.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",i.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}let a=document.getElementById("switch-alerts");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",a.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let r=document.getElementById("switch-workspace");if(r){let o=r.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",r.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}}function Xe(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Se()}function wt(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Se()}function gs(){return"https://event.easter.company"}function fs(){return"https://discord.easter.company"}var bs="http://127.0.0.1:8100",vs="http://127.0.0.1:8300",ys={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Oe(t){let e=j(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(a,r)=>{let o=ys[r];return o?`<span class="${o}">`:""});let n=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return n>i&&(e+="</span>".repeat(n-i)),e}function re(t){if(!t)return"";let e=j(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,i)=>{let a=i.split("|").map(r=>r.trim());return a.every(r=>r.match(/^:?-+:?$/))?"":`<div class="md-table-row">${a.map(r=>`<span class="md-table-cell">${r}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var xs="https://sterling-javelin-12539.upstash.io",hs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function N(){return window.location.hostname.includes("easter.company")}var q=null,oe={lastDashboard:0,lastFrontend:0},Ye=!1,Ct=0,Et="dex_dashboard_snapshot";function ws(){let t=localStorage.getItem(Et);if(t)try{let e=JSON.parse(t);q=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{q=null}}async function yt(){if(!(!N()||Ye)){Ye=!0,Ct=Math.floor(Date.now()/1e3);try{let t=await Ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);q=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Et,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ye=!1}}}function Cs(){if(!q||!q.agent_status)return;let t=q.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Es(){if(!N())return;ws();let t=Math.floor(Date.now()/1e3),e=q?t-q.timestamp:1/0;(!q||e>120)&&await yt(),setInterval(()=>{let n=new Date,i=Math.floor(Date.now()/1e3),a=q?i-q.timestamp:1/0,r=i-Ct,o=n.getSeconds()===59,f=a>300,d=r>60;(o&&d||f&&d)&&yt(),Cs()},1e3)}N()&&Es();async function Ts(t,...e){try{let i=await(await fetch(xs,{method:"POST",headers:{Authorization:`Bearer ${hs}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(n){return console.error("Upstash Error:",n),null}}var $e=null,ke=null,Ne=!1,Re=!1;async function D(t,e={}){if(N()){if(!q)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(q.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(q.processes),{status:200});if(t.startsWith("/events")){let a=new URLSearchParams(t.split("?")[1]||""),r=a.get("type")||a.get("event.type"),o=a.get("category"),f=a.get("order")||"desc",d=[];return r==="system.notification.generated"?d=[...q.alerts||[]]:r==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...q.blueprints||[]]:o==="messaging"?d=[...q.messaging_events||[]]:o==="system"?d=[...q.system_events||[]]:o==="cognitive"?d=[...q.cognitive_events||[]]:o==="moderation"?d=[...q.moderation_events||[]]:d=[...q.events||[]],f==="asc"?d.sort((h,E)=>h.timestamp-E.timestamp):d.sort((h,E)=>E.timestamp-h.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(q.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let a=t.split("/")[2],r=q.profiles?q.profiles[a]:null;return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(q.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(q.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if($e)try{let a=await fetch($e+t,e);if(a.ok)return a;$e=null}catch{$e=null}let n=gs(),i=bs;try{let a=await fetch(n+t,e);if(a.ok)return $e=n,Ne&&(console.log("\u2728 Production event service restored."),Ne=!1),a;throw new Error("Primary failed")}catch{Ne||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ne=!0);try{let r=await fetch(i+t,e);if(r.ok)return $e=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function ue(t,e={}){if(N()){if(!q)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(q.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let a=t.split("/")[2],r=(q.contacts?.members||[]).find(o=>o.id===a);return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(ke)try{let a=await fetch(ke+t,e);if(a.ok)return a;ke=null}catch{ke=null}let n=fs(),i=vs;try{let a=await fetch(n+t,e);if(a.ok)return ke=n,Re&&(console.log("\u2728 Production discord service restored."),Re=!1),a;throw new Error("Primary failed")}catch{Re||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Re=!0);try{let r=await fetch(i+t,e);if(r.ok)return ke=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Tt=()=>`
...
`,je=null,ge=new Set,Ue=[];async function de(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];je=Date.now(),te(0,je);let o=Date.now(),f=24*60*60*1e3,d=r.filter(p=>{let x=localStorage.getItem(`alert_read_ts_${p.id}`);if(!x)return!0;let v=parseInt(x);return o-v<f});d.sort((p,x)=>{let v=w=>{let g=w.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},l=w=>w==="critical"?4:w==="high"?3:w==="medium"?2:1,c=l(v(p)),C=l(v(x));return c!==C?C-c:x.timestamp-p.timestamp}),Ue=d;let h=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return"low"}return(x.priority||"low").toLowerCase()},E=[];if(d.length===0)E.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let x=new Set(d.map(l=>h(l))).size>1,v=null;d.forEach(l=>{let c=h(l);x&&c!==v&&(E.push({id:`divider-${c}`,type:"divider",label:c.toUpperCase()}),v=c),E.push(l)})}t&&(e.innerHTML="");let m=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return null}let v=(x.title||"Untitled Alert").trim(),l=(x.body||"No description provided.").trim(),c=x.summary||"",C=x.content||"",w=x.protocol||"",g=(x.priority||"low").toLowerCase(),S=!!x.alert,L=(x.category||"system").trim(),A=x.related_event_ids||[],R=x.audit_event_id,J=!!localStorage.getItem(`alert_read_ts_${p.id}`),V=new Date(p.timestamp*1e3),I=V.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=V.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=J?"event-border-grey":"event-border-blue";!J&&S&&(M="event-border-red"),J&&(g==="high"||g==="critical")?M="event-border-red":J&&g==="medium"&&(M="event-border-orange");let B=J?"alert-read":"alert-unread",O=ge.has(p.id),P=O?"expanded":"",G=O?"display: block;":"display: none;",k="",_="";A.length>0&&(_=`
        ...
        `:Y=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re(l)}</div>
            </div>
        `,k=`
...
`,fe=new Set,St=[],Le=null;async function be(t=!1){let e=document.getElementById("roadmap-list");if(e){ks();try{let n=await D("/roadmap");if(!n.ok)throw new Error("Offline");let i=await n.json();St=i;let a=m=>{let y=fe.has(m.id),s=m.state==="published",u=m.state==="consumed",T="event-border-grey";s&&(T="event-border-blue"),u&&(T="event-border-purple");let b=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),p=document.createElement("div");p.className=`event-item notification-item ${T} cursor-pointer ${y?"expanded":""}`,p.dataset.itemId=m.id,p.onclick=l=>{if(l.target.closest("button"))return;if(p.classList.contains("expanded")){p.classList.remove("expanded");let C=p.querySelector(".event-details");C&&(C.style.display="none"),fe.delete(m.id)}else{p.classList.add("expanded");let C=p.querySelector(".event-details");C&&(C.style.display="block"),fe.add(m.id)}};let x=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;p.innerHTML=`
        <div class="event-time">
      ...
      `;let v=p.querySelector(".event-details");return v&&v.addEventListener("click",l=>{l.stopPropagation()}),p.querySelector(".edit-btn")?.addEventListener("click",()=>Ss(m)),p.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ls(m)),p.querySelector(".delete-btn")?.addEventListener("click",()=>Ms(m.id)),p.querySelector(".close-details-btn")?.addEventListener("click",l=>{l.stopPropagation(),p.classList.remove("expanded");let c=p.querySelector(".event-details");c&&(c.style.display="none"),fe.delete(m.id)}),p},r=m=>{let y=document.createElement("div");y.innerHTML=F("empty",m.message,m.action,m.id);let s=y.firstElementChild;return s.dataset.itemId=m.id,s},o=[];!i||i.length===0?o.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:N()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):i.forEach(m=>o.push({...m,type:"item"}));let f=Array.from(e.children),d=new Map(f.map(m=>[m.dataset.itemId,m])),h=new Set(o.map(m=>m.id));f.forEach(m=>{let y=m.dataset.itemId;(!y||!h.has(y))&&m.remove()}),t&&(e.innerHTML="");let E=null;o.forEach((m,y)=>{let s=d.get(m.id);(!s||t)&&(s&&s.remove(),m.type==="placeholder"?s=r(m):s=a(m),!s)||(y===0?e.firstElementChild!==s&&e.prepend(s):E&&E.nextElementSibling!==s&&E.after(s),E=s)})}catch{e.children.length===0&&(e.innerHTML=F("offline","Failed to load roadmap.","The event service may be offline."))}}}function ks(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),a=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Le=null;let r=document.getElementById("roadmap-editor-input");r&&(r.value="");let o=document.getElementById("roadmap-editor-container");o&&(o.style.display="block")},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="none"),Le=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input"),o=r?r.value:"";if(!o.trim())return;let f=Le?`/roadmap/${Le}`:"/roadmap",d=Le?"PATCH":"POST";try{await D(f,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:o})});let h=document.getElementById("roadmap-editor-container");h&&(h.style.display="none"),be(!0)}catch(h){console.error(h)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{St.forEach(r=>fe.add(r.id)),be(!0)},i.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{fe.clear(),be(!0)},a.dataset.listenerAttached="true")}function Ss(t){Le=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let n=document.getElementById("roadmap-editor-container");n&&(n.style.display="block",n.scrollIntoView({behavior:"smooth"}))}async function Ls(t){let e=t.state==="published"?"draft":"published";try{await D(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),be(!0)}catch(n){console.error(n)}}async function Ms(t){if(confirm("Delete this roadmap item?"))try{await D(`/roadmap/${t}`,{method:"DELETE"}),fe.delete(t),be(!0)}catch(e){console.error(e)}}var Mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,Lt=null,ve=new Set,It=[];async function ye(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;As();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];It=r,Lt=Date.now(),te(2,Lt);let o=s=>{let u=s.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let T=(u.title||"Untitled Blueprint").trim(),H=(u.summary||u.body||"No summary provided.").trim(),b=(u.content||"").trim(),p=(u.category||"architecture").trim(),x=(u.related_services||u.affected_services||[]).map(k=>k.trim()),v=(u.implementation_path||[]).map(k=>k.trim()),l=u.source_event_ids||[],c=u.approved===!0,C=new Date(s.timestamp*1e3),w=C.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=C.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=ve.has(s.id),L=S?"display: block;":"display: none;",A=document.createElement("div");A.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${c?"blueprint-approved":""}`,A.dataset.blueprintId=s.id,c&&(A.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",A.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let W=c?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[p]||"bx-paint";A.onclick=function(k){let _=this;if(_.classList.contains("expanded")){_.classList.remove("expanded"),ve.delete(s.id);let U=_.querySelector(".event-details");U&&(U.style.display="none")}else{_.classList.add("expanded"),ve.add(s.id);let U=_.querySelector(".event-details");U&&(U.style.display="block")}};let J="";v.length>0&&(J=`
                ...
                `);let I=x.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${x.join(", ")}</span></div>`:"<div></div>",$=N(),M=c?`
...
`,Nt=()=>`
    ...
    `,Be=[],He={"313071000877137920":"Owen",dexter:"Dexter"},se=[],xe=null;async function _e(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),a=document.getElementById("cancel-chore-btn"),r=document.getElementById("new-chore-owner"),o=document.getElementById("selected-recipients"),f=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),h=document.getElementById("new-chore-url"),E=document.getElementById("new-chore-schedule"),m=document.getElementById("new-chore-time"),y=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(y&&!y.dataset.initialValueAttached){let c=Intl.DateTimeFormat().resolvedOptions().timeZone,C=!1;for(let w=0;w<y.options.length;w++)if(y.options[w].value===c){C=!0;break}if(!C){let w=document.createElement("option");w.value=c,w.textContent=c.replace("_"," "),y.appendChild(w)}y.value=c,y.dataset.initialValueAttached="true"}E&&s&&!E.dataset.timeListenerAttached&&(E.addEventListener("change",()=>{s.style.display=E.value==="daily"?"block":"none"}),E.dataset.timeListenerAttached="true");let u=document.getElementById("form-title"),T=document.getElementById("form-icon");function H(){if(o){if(se.length===0){o.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}o.innerHTML=se.sort((c,C)=>{let w=c.startsWith("channel:"),g=C.startsWith("channel:");return w&&!g?-1:!w&&g?1:0}).map(c=>{let C=He[c]||c,w=c.startsWith("channel:");return`
      ...
      `}).join(""),o.querySelectorAll(".remove-recipient").forEach(c=>{c.onclick=()=>{let C=c.dataset.id;se=se.filter(w=>w!==C),H()}})}}function b(c){c&&!se.includes(c)&&(se.push(c),H()),r&&(r.value="")}function p(c=null){if(n){if(xe=c?c.id:null,c){if(u&&(u.textContent="Update Research Task"),T&&(T.className="bx bx-edit-alt",T.style.color="#03dac6"),i&&(i.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=c.natural_instruction),h&&(h.value=c.execution_plan?.entry_url||""),E&&(E.value=c.schedule,s&&(s.style.display=c.schedule==="daily"?"block":"none")),m&&c.run_at&&(m.value=c.run_at),y&&c.timezone){let C=!1;for(let w=0;w<y.options.length;w++)if(y.options[w].value===c.timezone){C=!0;break}if(!C){let w=document.createElement("option");w.value=c.timezone,w.textContent=c.timezone.replace("_"," "),y.appendChild(w)}y.value=c.timezone}se=c.recipients||(c.owner_id?[c.owner_id]:[]),H()}else u&&(u.textContent="Initialize Research Task"),T&&(T.className="bx bx-plus-circle",T.style.color="#bb86fc"),i&&(i.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),h&&(h.value=""),E&&(E.value="every_24h"),se=[],H();n.style.display="block",n.scrollIntoView({behavior:"smooth",block:"start"})}}let x=document.getElementById("contacts-group"),v=document.getElementById("channels-group");if(x&&!x.dataset.populated&&!N())try{ue("/contacts").then(async c=>{c.ok&&(((await c.json()).members||[]).forEach(g=>{if(He[g.id]=g.nickname||g.username,g.id==="313071000877137920")return;let S=document.createElement("option");S.value=g.id;let L=g.nickname||g.username;S.textContent=`${L} (${g.username})`,x.appendChild(S)}),x.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(v&&!v.dataset.populated&&!N())try{ue("/channels").then(async c=>{c.ok&&((await c.json()).forEach(w=>{let g=`channel:${w.id}`;He[g]=w.name;let S=document.createElement("option");S.value=g,S.textContent=`#${w.name} (${w.guild})`,v.appendChild(S)}),v.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}r&&!r.dataset.listenerAttached&&(r.onchange=()=>{b(r.value)},r.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onchange=()=>l(),f.dataset.listenerAttached="true");function l(){if(!t)return;let c=f?.value||"all",C=c==="all"?Be:Be.filter(g=>(g.recipients||(g.owner_id?[g.owner_id]:[])).includes(c));if(C.length===0){t.innerHTML=F("empty",c==="all"?"No active tasks.":"No tasks found for this owner.",N()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let w=C.map(g=>{let S=g.last_run===0?"Never":new Date(g.last_run*1e3).toLocaleString(),L=g.memory?g.memory.length:0,A=g.status==="active"?"#03dac6":"#666",W=(g.recipients||(g.owner_id?[g.owner_id]:[])).sort((J,V)=>{let I=J.startsWith("channel:"),$=V.startsWith("channel:");return I&&!$?-1:!I&&$?1:0}).map(J=>{let V=He[J]||J.substring(0,8),I=J.startsWith("channel:");return`<span title="${V}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${J==="dexter"?"bx-terminal":I?"bx-hash":"bx-user"}'></i>${V}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=w,t.querySelectorAll(".edit-chore-btn").forEach(g=>{g.onclick=S=>{S.stopPropagation();let L=g.dataset.id,A=Be.find(R=>R.id===L);A&&p(A)}}),t.querySelectorAll(".reset-chore-btn").forEach(g=>{g.onclick=async S=>{S.stopPropagation();let L=g.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(g.innerHTML="<i class='bx bx-loader-alt spin'></i>",await D(`/chores/${L}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),_e())}}),t.querySelectorAll(".delete-chore-btn").forEach(g=>{g.onclick=async S=>{S.stopPropagation();let L=g.dataset.id;confirm("Delete this task?")&&(await D(`/chores/${L}`,{method:"DELETE"}),_e())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n&&(n.style.display==="none"||xe!==null?p(null):n.style.display="none")},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{n&&(n.style.display="none")},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let c=document.getElementById("new-chore-instruction"),C=document.getElementById("new-chore-url"),w=document.getElementById("new-chore-schedule"),g=c?.value,S=w?.value||"every_24h",L=S==="daily"?m?.value:"",A=S==="daily"?y?.value:"";if(!g)return;if(se.length===0){alert("Please add at least one recipient.");return}let R=i.innerHTML;i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let W=xe?"PATCH":"POST",J=xe?`/chores/${xe}`:"/chores";await D(J,{method:W,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:g,entry_url:C?.value,schedule:S,run_at:L,timezone:A})}),n&&(n.style.display="none"),c&&(c.value=""),C&&(C.value=""),xe=null,se=[],_e()}catch(W){console.error(W),alert(xe?"Failed to update research task":"Failed to create research task")}finally{i.innerHTML=R}},i.dataset.listenerAttached="true");try{let c=await D("/chores");if(!c.ok)throw new Error(`HTTP error! status: ${c.status}`);if(Be=await c.json()||[],f){let w=f.value,g=new Set;Be.forEach(S=>{S.owner_id&&g.add(S.owner_id),S.recipients&&S.recipients.forEach(L=>g.add(L))}),f.innerHTML='<option value="all">All Recipients</option>',g.forEach(S=>{let L=document.createElement("option");L.value=S;let A=S.startsWith("channel:"),R=He[S]||`Recipient: ${S.substring(0,8)}`;L.textContent=(A&&!R.startsWith("#")?"#":"")+R,f.appendChild(L)}),f.value=w,f.selectedIndex===-1&&(f.value="all")}l()}catch(c){console.error("Failed to fetch chores",c)}}var Rt=()=>`
...
`;function Ut(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function qt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Ds,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",ue(`/profile/${t.id}`).then(async n=>{if(n.ok){let i=await n.json();tt(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=Ut(t.id,t.username);tt(e,t,i)}}).catch(n=>{console.error("Profile fetch error:",n);let i=Ut(t.id,t.username);tt(e,t,i)})}function tt(t,e,n){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",a=()=>{let T=(n.attributes||n.facts||[]).map(l=>{let c=l.key||l.k,C=l.value||l.v;return`
        ...
        `},r=()=>{let T=n.dossier||{},H=T.identity||{},b=T.career||{},p=T.personal||{},x=T.social||[];return`
...
`,zs=null;async function st(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await st(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let a=n.target.closest(".user-profile-card");if(a&&a.dataset.user)try{let r=JSON.parse(a.dataset.user);qt(r)}catch(r){console.error("Failed to parse user data",r)}},t.dataset.listenerAttached="true");try{let n=await ue("/contacts");if(!n.ok)throw new Error("Service unreachable");let a=(await n.json()).members||[];if(zs=Date.now(),a.length===0){t.innerHTML=F("empty","No contacts found.","Check your Discord connection.");return}let r={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};a.sort((o,f)=>{let d=r[o.level]??10,h=r[f.level]??10;return d!==h?d-h:o.username.localeCompare(f.username)}),t.innerHTML=a.map(o=>{let f=o.color&&o.color!==0,d=f?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",h=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",E="#888";o.level==="Me"||o.level==="Master"?E="#bb86fc":o.level==="Admin"?E="#cf6679":o.level==="Moderator"?E="#03dac6":o.level==="Contributor"&&(E="#ffa500");let m=o.level==="Me",y=m?"rgba(187, 134, 252, 0.08)":f?`${d}11`:"rgba(255,255,255,0.03)",s=m?"2px solid #bb86fc":f?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
...
`,Fe=null,he=new Set,De=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Rs))if(n.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function pe(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let i=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(i+=`&category=${Z}`);try{let a=await D(i);if(!a.ok)throw new Error("Service unreachable");if(De=((await a.json()).events||[]).filter(y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Fe=Date.now(),te(1,Fe),De.length===0){e.innerHTML=F("empty","No events found for this filter.");return}t&&(e.innerHTML="");let f=y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,T=Os(u),H=js(u),b=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.bot.voice_response"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),p="event-border-grey";b&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?p="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"||u==="engagement.decision"?p="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?p="event-border-orange":u==="system.test.completed"?p=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let x=b?"cursor-pointer":"",v=he.has(y.id),l=v?"expanded":"",c=v?"display: block;":"display: none;",C=new Date(y.timestamp*1e3),w=C.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=C.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Jt(u,s),L=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",A="";if(b){let I="";if(u==="engagement.decision"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                    ...
                    `}else if(u==="system.attention.expired"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,M=s.timestamp-s.last_active,B=Math.floor(M/60);I=`
                    ...
                    `}else if(u==="messaging.bot.sent_message"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,M="";if(s.embed){let P=s.embed,G=P.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${j(P.title)}</div>`:"",k=P.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(P.description)}</div>`:"",_=(P.fields||[]).map(z=>`
              <div style="margin-top: 10px;">
            ...
            `}let B="";s.eval_count&&(B=`
                    ...
                    `}else if(u==="analysis.user.message_signals"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,M=s.signals||{};I=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(u==="moderation.explicit_content.deleted"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.link.completed"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.router.decision"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.cli.command"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.analysis.audit"){let $=s.success?"#03dac6":"#ff4d4d",M=s.success?"SUCCESS":"FAILED",B=_=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${_}</h5>`,O="";s.error&&(O=`
                            <div class="event-detail-block">
                                ${B("Error")}
                        ...
                        ${G}
                        ${P}
                    `}else if(u==="system.test.completed"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="error_occurred"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.cli.status"){let $=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;I=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
...
`,Wt=qs;function Gt(){return`
    ...
    `}var Fs=null;async function ze(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await D("/logs");if(!e.ok)throw new Error("Logs offline");let n=await e.json();if(!n||n.length===0)return t.innerHTML=F("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0"],a=n.filter(o=>!i.includes(o.id));a.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),a.reverse();let r=a.map(o=>{let f=o.logs.join(`
`),d=[...o.logs];if(d.length<25){let E=25-d.length;for(let m=0;m<E;m++)d.push("")}else d.length>25&&(d=d.slice(-25));let h=d.map(E=>Oe(E)).join(`
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Gt()}
        </div>`;async function ns(){Js(),await Promise.all([ne(),we(),at()]),await ze()}var Je=null;function Js(){Je||(Je=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Je),Je=null;return}ne(!0)},1e3))}var Vt=null,Kt=null;async function is(){try{return await(await D("/system_monitor")).json()}catch{return null}}async function Zt(){try{return await(await D("/system/hardware")).json()}catch{return null}}async function Ws(){try{return await(await D("/processes")).json()}catch{return null}}async function Gs(){try{return await(await D("/agent/status")).json()}catch{return null}}async function we(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.getElementById("global-restart-btn"),i=document.getElementById("global-stop-btn"),a=document.getElementById("global-start-btn"),r=(l,c)=>{l&&!l.dataset.listenerAttached&&(l.onclick=async()=>{let C=l.innerHTML;l.innerHTML="<i class='bx bx-loader-alt spin'></i>",l.disabled=!0;try{await D(`/system/service/${c}`,{method:"POST",body:JSON.stringify({service:"all"})}),setTimeout(()=>we(),2e3),setTimeout(()=>we(),5e3),setTimeout(()=>{l.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{l.innerHTML=C,l.disabled=!1},1e3)},1e3)}catch(w){console.error(w),l.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{l.innerHTML=C,l.disabled=!1},2e3)}},l.dataset.listenerAttached="true")};r(n,"restart"),r(i,"stop"),r(a,"start");let o=document.querySelector("#hw-os .hw-content"),f=document.querySelector("#hw-cpu .hw-content"),d=document.querySelector("#hw-ram .hw-content"),h=document.querySelector("#hw-gpu .hw-content"),E=document.querySelector("#hw-storage .hw-content"),m=l=>{if(l){if(o&&(o.innerHTML=`
                ...
                </div>`),d){let c=(l.MEMORY_BYTES/1073741824).toFixed(1);d.innerHTML=`
                ...
                </div>`}if(f&&l.CPU&&l.CPU.length>0){let c=l.CPU[0];f.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}h&&(l.GPU&&l.GPU.length>0?h.innerHTML=l.GPU.map(c=>{let C=(c.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):h.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),E&&l.STORAGE&&l.STORAGE.length>0?E.innerHTML=l.STORAGE.map(c=>{let C=(c.USED/1073741824).toFixed(1),w=(c.SIZE/(1024*1024*1024)).toFixed(1),g=c.SIZE>0?(c.USED/c.SIZE*100).toFixed(0):0,S=c.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):E&&(E.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let l=await Zt();l?(m(l),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),f&&!f.hasChildNodes())){let l=await Zt();m(l)}if(!t)return;t.dataset.controlsAttached||(t.addEventListener("click",async l=>{let c=l.target.closest(".svc-btn");if(!c)return;let C=c,w=C.dataset.action,g=C.dataset.service;if(!w||!g)return;let S=C.innerHTML;C.innerHTML="<i class='bx bx-loader-alt spin'></i>",C.classList.add("loading"),C.disabled=!0;try{await D(`/system/service/${w}`,{method:"POST",body:JSON.stringify({service:g})}),setTimeout(()=>we(),1e3),setTimeout(()=>we(),3e3)}catch(L){console.error(L),alert(`Failed to ${w} ${g}`),C.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{C.innerHTML=S,C.classList.remove("loading"),C.disabled=!1},2e3)}}),t.dataset.controlsAttached="true");let y=await is();if(!y||!y.services){t.children.length===0&&(t.innerHTML=F("offline","Failed to load system metrics.","The event service may be offline."));let l=document.querySelector('[data-service-id="upstash-redis-ro"]');if(l){l.className="service-widget service-widget-offline",l.querySelector(".service-widget-status").textContent="ERROR";let c=l.querySelector(".service-widget-body");c&&(c.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Vt=N()&&oe.lastDashboard||Date.now(),te(0,Vt||0);let s=y.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let l=document.getElementById("upstash-countdown");if(l){let w=59-new Date().getSeconds();w<=0&&(w+=60),l.textContent=`${w}s`}},1e3)),Array.from(t.children).forEach(l=>{l.classList.contains("service-widget")||l.remove()});function u(l){if(!l||l==="N/A"||l==="unknown")return"-";let c=l.match(/^(\d+\.\d+\.\d+)/);return c?c[0]:l.split(".").slice(0,3).join(".")||"-"}function T(l){return!l||l.length<=28?l:l.substring(0,28)+"..."}function H(l){if(!l||l==="N/A"||l==="unknown")return"-";let c=l.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!c)return"-";let C=parseInt(c[1])||0,w=parseInt(c[2])||0,g=parseInt(c[3])||0,S=parseFloat(c[4])||0,L=C*86400+w*3600+g*60+S,A=Math.floor(L/86400);if(A>0)return`${A}d`;let R=Math.floor(L/3600);if(R>0)return`${R}h`;let W=Math.floor(L/60);return W>0?`${W}m`:`${Math.floor(L)}s`}function b(l){if(l.id==="upstash-redis-ro"){let P=N()&&(oe.lastFrontend||oe.lastDashboard)||Date.now();return`
            ...
            </div>`}let c=l.status==="online",C=c?"service-widget-online":"service-widget-offline",w=c?"bx-check-circle":"bx-x-circle",g=c?"OK":"BAD",S=l.version?u(l.version.str):"-",L=l.cpu&&l.cpu!=="N/A"?l.cpu:"-",A=l.memory&&l.memory!=="N/A"?l.memory:"-",R=L!=="-"?"#00ff00":"#666",W=L!=="-"?"#fff":"#666",J=A!=="-"?"#00ff00":"#666",V=A!=="-"?"#fff":"#666",I=H(l.uptime),$="",M=l.type!=="os"&&l.type!=="cli"&&l.type!=="prd",B="";M&&!N()&&(B=`
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                <button class="svc-btn svc-restart" title="Restart Service" data-action="restart" data-service="${l.id}"><i class='bx bx-refresh'></i></button>
                <button class="svc-btn svc-stop" title="Stop Service" data-action="stop" data-service="${l.id}" ${c?"":"disabled"}><i class='bx bx-stop'></i></button>
                <button class="svc-btn svc-start" title="Start Service" data-action="start" data-service="${l.id}" ${c?"disabled":""}><i class='bx bx-play'></i></button>
            </div>`),c?$=`
                ...
                </div>${B}`:$=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${B}`;let O=N()?"easter.company":T(l.domain&&l.port?`${l.domain}:${l.port}`:"");return`<div class="service-widget ${C}" data-service-id="${l.id}"><div class="service-widget-header"><i class="bx ${w}"></i><h3>${l.short_name||l.id}</h3><span class="service-widget-status">${g}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${$}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(l=>[l.dataset.serviceId,l])),x=new Set(s.map(l=>l.id));for(let[l,c]of p)x.has(l)||c.remove();let v=new Set;s.forEach(l=>{if(v.has(l.id))return;v.add(l.id);let c=b(l),C=p.get(l.id);if(C&&C.parentNode)if(l.id==="upstash-redis-ro"){let w=N()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),g=new Date(w).toLocaleTimeString(),S=C.querySelector(".sync-time-label");S&&(S.textContent=`Last synced: ${g}`)}else C.outerHTML!==c&&(C.outerHTML=c);else t.insertAdjacentHTML("beforeend",c)})}async function at(){let t=document.getElementById("models-widgets");if(!t)return;let e=await is();if(!e){t.children.length===0&&(t.innerHTML=F("offline","Failed to load model status.","The event service may be offline."));return}Kt=Date.now(),te(2,Kt);let n=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function a(d){let h=d.status==="Ready";return`
                ...
                </div>`}function o(d){let h=d.status==="Downloaded",E=h?"service-widget-online":"service-widget-offline",m=h?"OK":"MISSING",y=h&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${E}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${h?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${y}</span></div></div></div>`}let f="";if(i&&(f+=a(i)),e.xtts&&(f+=r(e.xtts)),f+=n.map(o).join(""),!f){t.innerHTML=F("empty","No models found.");return}t.innerHTML!==f&&(t.innerHTML=f)}async function ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let n=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-idle-val"),a=document.getElementById("guardian-total-idle"),r=document.getElementById("guardian-total-active"),o=document.getElementById("guardian-total-waste"),f=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn"),h=document.getElementById("fabricator-reset-btn"),E=document.getElementById("courier-reset-btn"),m=document.getElementById("system-pause-toggle-btn");m&&!m.dataset.listenerAttached&&(m.onclick=async()=>{let l=m.querySelector(".bx-play")?"/agent/resume":"/agent/pause";m.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D(l,{method:"POST"}),await ne()}catch{m.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>ne(),2e3)}},m.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onclick=async()=>{f.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=all",{method:"POST"}),setTimeout(()=>{f.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{f.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{f.innerHTML="<i class='bx bx-error'></i>"}},f.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true"),h&&!h.dataset.listenerAttached&&(h.onclick=async()=>{h.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{h.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{h.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{h.innerHTML="<i class='bx bx-error'></i>"}},h.dataset.listenerAttached="true"),E&&!E.dataset.listenerAttached&&(E.onclick=async()=>{E.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{E.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{E.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{E.innerHTML="<i class='bx bx-error'></i>"}},E.dataset.listenerAttached="true");let y=document.getElementById("imaginator-reset-btn");y&&!y.dataset.listenerAttached&&(y.onclick=async()=>{y.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=alert_review",{method:"POST"}),setTimeout(()=>{y.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{y.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{y.innerHTML="<i class='bx bx-error'></i>"}},y.dataset.listenerAttached="true");let s=await Gs();if(s&&s.agents){let v=s.agents.guardian||{protocols:{}},l=s.agents.analyzer||{protocols:{}},c=s.agents.imaginator||{protocols:{}},C=s.agents.fabricator||{protocols:{}},w=s.agents.courier||{protocols:{}},g=s.system||{},S=Math.floor(Date.now()/1e3),L={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},A=k=>{k<0&&(k=0);let _=Math.floor(k/3600),z=Math.floor(k%3600/60),U=k%60;return _>0?`${_}h ${z}m`:z>0?`${z}m ${U}s`:`${U}s`},R=(k,_,z,U)=>{if(!k)return;let Y=L[U]||U.toUpperCase(),K=k.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(K&&(K.textContent=Y),!z){k.textContent="Inactive",k.style.color="#666";return}let Ce=z.status;if(Ce==="Working")k.textContent="Working",k.style.color="#bb86fc";else if(Ce==="Ready")k.textContent="Ready",k.style.color="#5eff5e";else{let Ee=z.cooldown;if(N()&&(Ee=z.next_run-S),Ee<=0)k.textContent="Ready",k.style.color="#5eff5e";else{let Ge=Math.floor(Ee/60),Ve=Ee%60;k.textContent=`${Ge}m ${Ve}s`,k.style.color="#fff"}}_&&z.stats&&(_.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
          ...
          `)};n&&R(n,document.getElementById("guardian-sentry-stats"),v.protocols.sentry,"sentry");let W=document.getElementById("analyzer-synthesis-val"),J=document.getElementById("analyzer-synthesis-stats");W&&R(W,J,l.protocols.synthesis,"synthesis");let V=document.getElementById("imaginator-alert_review-val"),I=document.getElementById("imaginator-alert_review-stats");V&&R(V,I,c.protocols.alert_review,"alert_review");let $=document.getElementById("fabricator-construction-val"),M=document.getElementById("fabricator-construction-stats");$&&R($,M,C.protocols.construction,"construction");let B=document.getElementById("courier-researcher-val"),O=document.getElementById("courier-researcher-stats");B&&R(B,O,w.protocols.researcher,"researcher");let P=document.getElementById("system-state-label"),G=document.getElementById("system-state-val");if(G&&g.state){let k=g.state,_=A(g.state_time||0);P&&(P.textContent=`State: ${k.toUpperCase()}`),G.textContent=_,k==="idle"?G.style.color=g.state_time>300?"#5eff5e":"#fff":G.style.color="#bb86fc",m&&(k==="paused"?(m.innerHTML="<i class='bx bx-play'></i>",m.title="Resume System",m.style.color="#ff9800"):(m.innerHTML="<i class='bx bx-pause'></i>",m.title="Pause System",m.style.color=""))}a&&(a.textContent=A(g.metrics?.total_idle_time||0)),r&&(r.textContent=A(g.metrics?.total_active_time||0)),o&&(o.textContent=A(g.metrics?.total_waste_time||0))}else[n,i,a,r,o].forEach(l=>{l&&(l.textContent="-",l.style.color="#666")});if(t)return;let u=await Ws(),T=[],H=[],b=[];u&&(Array.isArray(u)?T=u:(T=u.active||[],H=u.queue||[],b=u.history||[],b.sort((v,l)=>(l.end_time||0)-(v.end_time||0)))),e&&(T.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=F("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),it(e,T,!1)));let p=document.getElementById("processes-queue-widgets");p&&(H.length===0?!p.querySelector(".tab-placeholder")&&!p.querySelector('div[style*="font-style: italic"]')&&(p.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(p.innerHTML="",it(p,H,!1)));let x=document.getElementById("processes-history-widgets");x&&(b.length===0?x.querySelector(".tab-placeholder")||(x.innerHTML=F("empty","No recent history.")):(x.querySelector(".tab-placeholder")&&(x.innerHTML=""),it(x,b,!0))),Pe(1,T.length)}function it(t,e,n){function i(d){let h="";d.end_time?h=`${d.end_time-d.start_time}s`:h=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let E=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",m=d.channel_id,y={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent"};if(y[m]?m=y[m]:/^\d+$/.test(m)&&(m=`Channel ${m}`),n)return`
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let a=n?".process-history-item":".process-widget",r=new Map(Array.from(t.querySelectorAll(a)).map(d=>[d.dataset.channelId,d])),o=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,h]of r)d&&!o.has(d)&&h.remove();let f=new Set;e.forEach(d=>{let h=`${d.channel_id}-${d.start_time}`;if(f.has(h))return;f.add(h);let E=i(d),m=r.get(h);if(m&&m.parentNode){m.outerHTML!==E&&(m.outerHTML=E);let y=t.querySelector(`[data-channel-id="${h}"]`);y&&t.appendChild(y)}else t.insertAdjacentHTML("beforeend",E)})}function We(){let t=Ze(),e="Notification"in window,n={enabled:e&&Notification.permission==="granted",supported:e};return`
    ...
    `;async function rs(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await as(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await as(t)}async function as(t){try{let e=await D("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let n=await e.json();if(!n||n.length===0){t.innerHTML=F("empty","No web history found.");return}let i=`
        ...
        `;n.forEach((f,d)=>{let h=new Date(f.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),E=f.screenshot?`<img src="data:image/png;base64,${f.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';i+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ks=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,i]of Object.entries(t)){let a=ds.filter(r=>r.category===n);a.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>ls());let h=document.getElementById("terminal-action-btn");h&&(h.onclick=()=>ls())}let n=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");n&&(n.innerHTML="");let a=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let r=document.getElementById("terminal-cmd-name");r&&(r.textContent=`dex ${t.id}`);let o=document.getElementById("terminal-status-badge");o&&(o.className="terminal-status status-running",o.textContent="Running");let f=document.getElementById("terminal-action-btn");return f&&(f.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",rt=!0,n}function ls(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",rt=!1}function cs(t,e,n="output"){if(!rt||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${n}`,n==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let a=Oe(e);i.innerHTML=a||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Ys(t){let e=ds.find(o=>o.id===t);if(!e)return;let n=Zs(e);n&&cs(n,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let o of i){await new Promise(d=>setTimeout(d,400+Math.random()*600));let f="output";o.includes("[ERROR]")?f="error":o.includes("[SUCCESS]")||o.includes("\u2713")?f="success":o.includes("!")&&(f="warning"),n&&cs(n,o,f)}let a=document.getElementById("terminal-status-badge");a&&(a.className="terminal-status status-success",a.textContent="Completed (Demo)");let r=document.getElementById("terminal-action-btn");r&&(r.style.display="block")}function ps(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ks();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code"),i=n?n.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let a=e.querySelector("i");a&&(a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(n=>{let i=n;n.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let a=i.dataset.cmd;a&&Ys(a)})})}async function Xs(){if(!N())try{if(!(await D("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ms(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}pt(),mt(),Xs(),vt(),dt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ps();let e=[],n=document.getElementById("windows-container");n&&n.setAttribute("data-count","0");let i=b=>{localStorage.setItem("dex_last_window",b)};function a(){for(;e.length>1;)e.shift().close(!0);let b=document.getElementById("windows-container"),p=document.querySelector("nav"),x=document.querySelector("footer"),v=window.location.pathname==="/"||window.location.pathname==="/index.html",l=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");b&&b.setAttribute("data-count",e.length.toString()),e.forEach(L=>{let A=document.getElementById(L.id);A&&A.classList.remove("hide-close")});let c=document.getElementById("dexter-menu-container"),C=document.getElementById("nav-window-switcher"),w=document.getElementById("settings-icon"),g=document.getElementById("close-all-windows"),S=window.innerWidth<880;if(!S){let L=document.getElementById("dexter-dropdown"),A=document.getElementById("dexter-menu-btn");L&&L.classList.remove("active"),A&&A.classList.remove("active"),b&&b.classList.remove("menu-open")}if(Te(e.length>0),e.length>0)if(x?.classList.add("hide"),g&&(g.style.display=S?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",p?.classList.add("window-open"),b&&(b.style.paddingTop="60px"),c&&(c.style.display=S?"flex":"none"),w&&(w.style.display=S?"block":"none"),!S&&C){let L=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(L)?(C.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),r(f)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),r(d)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),r(E)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),r(h)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),r(m)})):C.innerHTML=""}else C&&(C.innerHTML="");else p?.classList.remove("window-open"),g&&(g.style.display="none"),b&&(b.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",v||l?x?.classList.remove("hide"):x?.classList.add("hide"),c&&(c.style.display="flex"),w&&(w.style.display="block"),C&&(C.innerHTML="");Se()}function r(b){if(b.isOpen()){b.close();return}for(;e.length>0;)e.pop().close(!0);e.push(b),b.open(),a()}function o(){[...e].forEach(p=>p.close()),e=[]}window.addEventListener("resize",a);let f=me({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Tt(),onOpen:()=>de(),onClose:()=>{let b=e.indexOf(f);b>-1&&e.splice(b,1),a()}}),d=me({id:"events-window",title:"Events",icon:"bx-calendar-event",content:nt(),onOpen:()=>{d.setContent(nt()),pe()},onClose:()=>{let b=e.indexOf(d);b>-1&&e.splice(b,1),a()}}),h=me({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ft(),onOpen:()=>st(),onClose:()=>{let b=e.indexOf(h);b>-1&&e.splice(b,1),a()}}),E=me({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Qt()},{icon:"bxs-component",title:"Processes",content:Xt()},{icon:"bxs-brain",title:"Models",content:es()},{icon:"bx-globe",title:"Web",content:os()},{icon:"bxs-hdd",title:"Hardware",content:ts()},{icon:"bxs-terminal",title:"Logs",content:ss()},{icon:"bxs-zap",title:"Agents",content:Yt()}].filter(b=>N()?b.title!=="Hardware"&&b.title!=="Logs":!0),onOpen:()=>{we(),ne(),at(),rs(),ze()},onClose:()=>{let b=e.indexOf(E);b>-1&&e.splice(b,1),a()}}),m=me({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Rt()},{icon:"bx-map-alt",title:"Roadmap",content:Pt()},{icon:"bx-paint",title:"Blueprints",content:Ot()},{icon:"bx-task",title:"Tasks",content:jt()}],onOpen:()=>et(),onClose:()=>{let b=e.indexOf(m);b>-1&&e.splice(b,1),a()}}),y=me({id:"settings-window",title:"Settings",icon:"bx-cog",content:We(),onOpen:()=>{y.setContent(We()),ot(y)},onClose:()=>{let b=e.indexOf(y);b>-1&&e.splice(b,1),a()}});window.dexter={viewEvent:b=>{d.isOpen()||r(d),setTimeout(()=>{let p=document.querySelector(`.event-item[data-event-id="${b}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)},viewAlert:b=>{f.isOpen()||r(f),setTimeout(()=>{let p=document.querySelector(`.event-item[data-alert-id="${b}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)}};let s=()=>{let b=document.getElementById("dexter-dropdown"),p=document.getElementById("dexter-menu-btn");b&&p&&(b.classList.remove("active"),p.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let b=document.getElementById("dexter-menu-btn"),p=document.getElementById("settings-icon"),x=document.getElementById("close-all-windows"),v=document.getElementById("nav-left-container"),l=document.getElementById("dexter-dropdown"),c=document.getElementById("windows-container");b&&l&&(b.onclick=w=>{w.stopPropagation();let g=window.innerWidth<880;if(g)l.style.top="",l.style.left="",l.style.right="",l.style.transform="";else{let L=b.getBoundingClientRect(),R=document.querySelector("nav").getBoundingClientRect(),W=220,J=10,I=L.left+L.width/2-W/2,$=R.right-10;I+W>$&&(I=$-W),I<10&&(I=10),l.style.top=R.bottom+J+"px",l.style.left=I+"px",l.style.right="auto",l.style.transform="none"}l.classList.toggle("active"),b.classList.toggle("active");let S=l.classList.contains("active");if(g){let L=document.querySelector("nav");S?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),L?.classList.add("window-open"),c?.classList.add("menu-open"),Te(!0)):(c?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),L?.classList.remove("window-open"),Te(!1)))}}),p&&(p.onclick=w=>{w.stopPropagation(),r(y)}),x&&(x.onclick=w=>{w.stopPropagation(),o()});let C=(w,g,S)=>{let L=document.getElementById(w);L&&(L.onclick=A=>{A.stopPropagation(),s(),S&&i(S),r(g)})};C("alerts-menu-item",f,"alerts-window"),C("events-menu-item",d,"events-window"),C("monitor-menu-item",E,"monitor-window"),C("contacts-menu-item",h,"contacts-window"),C("workspace-menu-item",m,"workspace-window"),v&&(v.onclick=w=>{if(w.stopPropagation(),l&&l.classList.contains("active")){s(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Te(!1));return}if(e.length>0)o();else{let g=window.location.pathname;if(!(g==="/"||g==="/index.html")){let A=(g.endsWith("/")&&g.length>1?g.slice(0,-1):g).split("/");A.pop();let R=A.join("/")||"/";window.location.href=R}}}),document.addEventListener("click",()=>{let w=window.innerWidth<880;l&&l.classList.contains("active")&&(s(),w&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Te(!1)))}),l&&(l.onclick=w=>w.stopPropagation())})();let T=window.location.pathname==="/"||window.location.pathname==="/index.html",H=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!T&&!H&&document.querySelector("footer")?.classList.add("hide"),N()||setInterval(()=>{d.isOpen()&&pe(),f.isOpen()?de():Qe()},1e3),setInterval(()=>{N()&&(f.isOpen()?de():Qe()),m.isOpen()?et():Bt(),N()&&d.isOpen()&&pe(),E.isOpen()&&ns()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ms):ms();})();
