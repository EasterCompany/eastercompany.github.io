...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ...
            </div>`}let d=a.status==="online",u=d?"service-widget-online":"service-widget-offline",f=d?"bx-check-circle":"bx-x-circle",x=d?"OK":"BAD",M=a.version?y(a.version.str):"-",A=a.cpu&&a.cpu!=="N/A"?a.cpu:"-",I=a.memory&&a.memory!=="N/A"?a.memory:"-",k=A!=="-"?"#00ff00":"#666",E=A!=="-"?"#fff":"#666",D=I!=="-"?"#00ff00":"#666",U=I!=="-"?"#fff":"#666",O=v(a.uptime),q="";d?q=`
                <div class="service-widget-info">
