"use strict";(()=>{function dt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function pt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",a=`
    ...
    `,c=document.createElement("nav");c.innerHTML=a,document.body.prepend(c);let l=document.createElement("div");l.id="dexter-dropdown",l.className="dexter-dropdown",l.innerHTML=`
    ...
    `,document.body.appendChild(l)}function Ee(t){let e=window.location.pathname,n=e==="/"||e==="/index.html",i=document.getElementById("nav-chevron"),a=document.querySelector(".nav-left");!i||!a||(t||!n?(i.style.display="block",a.style.cursor="pointer",a.classList.add("recording"),a.onmouseenter=()=>{i.style.transform="translateX(-3px)"},a.onmouseleave=()=>{i.style.transform="translateX(0)"}):(i.style.display="none",a.style.cursor="default",a.classList.remove("recording"),a.onmouseenter=null,a.onmouseleave=null))}function mt(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var ut=1e3;function me(t){let e=null,n=t.onClose||null,i=t.onOpen||null;function a(){e&&(e.style.zIndex=(++ut).toString())}function c(){if(e){e.classList.add("open"),a(),window.addEventListener("resize",l),i&&setTimeout(i,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++ut).toString(),e.addEventListener("mousedown",a);let y=t.icon||"bx-window",s="",m="",E,H='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((u,b)=>{let h=u.icon?`<i class="bx ${u.icon}"></i>`:`<span class="tab-glyph">${u.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,E=`<div class="window-content">${t.tabs.map((u,b)=>`<div class="tab-content ${b===0?"active":""}" data-tab-content="${b}">${u.content}${H}</div>`).join("")}</div>`):(t.title&&(m=`<div class="window-title">${t.title}</div>`),E=`<div class="window-content">${t.content||""}${H}</div>`),e.innerHTML=`
            ...
            ${E}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",o=>{o.stopPropagation(),d()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(o=>{o.addEventListener("click",()=>{if(!e)return;let r=o.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(b=>b.classList.remove("active")),o.classList.add("active"),e.querySelectorAll(".tab-content").forEach(b=>b.classList.remove("active"));let u=e.querySelector(`.tab-content[data-tab-content="${r}"]`);u&&u.classList.add("active"),f(o,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function l(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&f(p,e)}function f(p,y){setTimeout(()=>{let s=y.querySelector(".tab-bar");if(!s)return;let m=Array.from(s.querySelectorAll(".tab")),E=m.indexOf(p),H=s.clientWidth,o=m[Math.max(0,E-2)],r=m[Math.min(m.length-1,E+2)],u=s,b=o.offsetLeft-u.offsetLeft-25,g=r.offsetLeft+r.offsetWidth-u.offsetLeft+25-b,$=g<=H?b-(H-g)/2:p.offsetLeft-u.offsetLeft-H/2+p.offsetWidth/2;s.scrollTo({left:$,behavior:"smooth"})},350)}function d(p=!1){e&&(window.removeEventListener("resize",l),p?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function x(p){t.content=p;let y=e?.querySelector(".window-content");y&&(y.innerHTML=p)}function C(){return!!(e&&e.classList.contains("open"))}return{open:c,close:d,setContent:x,isOpen:C,focus:a,id:t.id}}var ft="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ze(){return localStorage.getItem(ft)||ee.DARK}function gt(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(ft,t),bt(t)}function bt(t){let e=document.body;Object.values(ee).forEach(c=>{e.classList.remove(`theme-${c}`)}),e.classList.add(`theme-${t}`);let n=document.querySelector('meta[name="theme-color"]');n||(n=document.createElement("meta"),n.name="theme-color",document.getElementsByTagName("head")[0].appendChild(n));let i={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},a=i[t]||i[ee.DARK];if(n.setAttribute("content",a),!document.querySelector(".background")){let c=document.createElement("div");c.className="background",document.body.prepend(c)}e.classList.add("is-animated")}function vt(){let t=Ze();bt(t)}function F(t,e,n=null,i="default"){let c={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${i}"><i class='bx ${c} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function O(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let i=Date.now(),a=Math.floor((i-e)/1e3),c;a<60?c=`${a}s ago`:a<3600?c=`${Math.floor(a/60)}m ago`:c=`${Math.floor(a/3600)}h ago`,n.textContent=`Last updated: ${c}`}var us=0;function Pe(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let i=n.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var ie=0,ae=0;function xt(t){ie=t,ke()}function ht(t){ae=t,ke()}function ke(){let t=ie+ae;us=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",n.appendChild(l)),l.textContent=ie>9?"9+":ie.toString(),l.style.display=ie>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",i.appendChild(l)),l.textContent=ae>9?"9+":ae.toString(),l.style.display=ae>0?"flex":"none"}let a=document.getElementById("switch-alerts");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",a.appendChild(l)),l.textContent=ie>9?"9+":ie.toString(),l.style.display=ie>0?"flex":"none"}let c=document.getElementById("switch-workspace");if(c){let l=c.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",c.appendChild(l)),l.textContent=ae>9?"9+":ae.toString(),l.style.display=ae>0?"flex":"none"}}function Xe(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ke()}function wt(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ke()}function fs(){return"https://event.easter.company"}function gs(){return"https://discord.easter.company"}var bs="http://127.0.0.1:8100",vs="http://127.0.0.1:8300",ys={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Oe(t){let e=O(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(a,c)=>{let l=ys[c];return l?`<span class="${l}">`:""});let n=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return n>i&&(e+="</span>".repeat(n-i)),e}function re(t){if(!t)return"";let e=O(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,i)=>{let a=i.split("|").map(c=>c.trim());return a.every(c=>c.match(/^:?-+:?$/))?"":`<div class="md-table-row">${a.map(c=>`<span class="md-table-cell">${c}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var xs="https://sterling-javelin-12539.upstash.io",hs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function N(){return window.location.hostname.includes("easter.company")}var q=null,oe={lastDashboard:0,lastFrontend:0},Ye=!1,Ct=0,Et="dex_dashboard_snapshot";function ws(){let t=localStorage.getItem(Et);if(t)try{let e=JSON.parse(t);q=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{q=null}}async function yt(){if(!(!N()||Ye)){Ye=!0,Ct=Math.floor(Date.now()/1e3);try{let t=await Ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);q=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Et,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ye=!1}}}function Cs(){if(!q||!q.agent_status)return;let t=q.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Es(){if(!N())return;ws();let t=Math.floor(Date.now()/1e3),e=q?t-q.timestamp:1/0;(!q||e>120)&&await yt(),setInterval(()=>{let n=new Date,i=Math.floor(Date.now()/1e3),a=q?i-q.timestamp:1/0,c=i-Ct,l=n.getSeconds()===59,f=a>300,d=c>60;(l&&d||f&&d)&&yt(),Cs()},1e3)}N()&&Es();async function Ts(t,...e){try{let i=await(await fetch(xs,{method:"POST",headers:{Authorization:`Bearer ${hs}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(n){return console.error("Upstash Error:",n),null}}var Te=null,$e=null,Ne=!1,Re=!1;async function D(t,e={}){if(N()){if(!q)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(q.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(q.processes),{status:200});if(t.startsWith("/events")){let a=new URLSearchParams(t.split("?")[1]||""),c=a.get("type")||a.get("event.type"),l=a.get("category"),f=a.get("order")||"desc",d=[];return c==="system.notification.generated"?d=[...q.alerts||[]]:c==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...q.blueprints||[]]:l==="messaging"?d=[...q.messaging_events||[]]:l==="system"?d=[...q.system_events||[]]:l==="cognitive"?d=[...q.cognitive_events||[]]:l==="moderation"?d=[...q.moderation_events||[]]:d=[...q.events||[]],f==="asc"?d.sort((x,C)=>x.timestamp-C.timestamp):d.sort((x,C)=>C.timestamp-x.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(q.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let a=t.split("/")[2],c=q.profiles?q.profiles[a]:null;return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(q.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(q.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(Te)try{let a=await fetch(Te+t,e);if(a.ok)return a;Te=null}catch{Te=null}let n=fs(),i=bs;try{let a=await fetch(n+t,e);if(a.ok)return Te=n,Ne&&(console.log("\u2728 Production event service restored."),Ne=!1),a;throw new Error("Primary failed")}catch{Ne||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ne=!0);try{let c=await fetch(i+t,e);if(c.ok)return Te=i,c;throw new Error("Fallback failed")}catch(c){throw c}}}async function ue(t,e={}){if(N()){if(!q)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(q.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let a=t.split("/")[2],c=(q.contacts?.members||[]).find(l=>l.id===a);return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if($e)try{let a=await fetch($e+t,e);if(a.ok)return a;$e=null}catch{$e=null}let n=gs(),i=vs;try{let a=await fetch(n+t,e);if(a.ok)return $e=n,Re&&(console.log("\u2728 Production discord service restored."),Re=!1),a;throw new Error("Primary failed")}catch{Re||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Re=!0);try{let c=await fetch(i+t,e);if(c.ok)return $e=i,c;throw new Error("Fallback failed")}catch(c){throw c}}}var Tt=()=>`
...
`,je=null,fe=new Set,Ue=[];async function de(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let c=(await i.json()).events||[];je=Date.now(),te(0,je);let l=Date.now(),f=24*60*60*1e3,d=c.filter(r=>{let u=localStorage.getItem(`alert_read_ts_${r.id}`);if(!u)return!0;let b=parseInt(u);return l-b<f});d.sort((r,u)=>{let b=w=>{let v=w.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return"low"}return(v.priority||"low").toLowerCase()},h=w=>w==="critical"?4:w==="high"?3:w==="medium"?2:1,g=h(b(r)),$=h(b(u));return g!==$?$-g:u.timestamp-r.timestamp}),Ue=d;let x=r=>{let u=r.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return"low"}return(u.priority||"low").toLowerCase()},C=[];if(d.length===0)C.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let u=new Set(d.map(h=>x(h))).size>1,b=null;d.forEach(h=>{let g=x(h);u&&g!==b&&(C.push({id:`divider-${g}`,type:"divider",label:g.toUpperCase()}),b=g),C.push(h)})}t&&(e.innerHTML="");let p=r=>{let u=r.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let b=(u.title||"Untitled Alert").trim(),h=(u.body||"No description provided.").trim(),g=u.summary||"",$=u.content||"",w=u.protocol||"",v=(u.priority||"low").toLowerCase(),S=!!u.alert,A=(u.category||"system").trim(),B=u.related_event_ids||[],R=u.audit_event_id,J=!!localStorage.getItem(`alert_read_ts_${r.id}`),W=new Date(r.timestamp*1e3),L=W.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=W.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=J?"event-border-grey":"event-border-blue";!J&&S&&(M="event-border-red"),J&&(v==="high"||v==="critical")?M="event-border-red":J&&v==="medium"&&(M="event-border-orange");let I=J?"alert-read":"alert-unread",j=fe.has(r.id),P=j?"expanded":"",V=j?"display: block;":"display: none;",k="",_="";B.length>0&&(_=`
            <div style="flex: 1; min-width: 150px; text-align: center;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; display: inline-block;">
                    ${B.map(ce=>`<a href="#" onclick="window.dexter.viewEvent('${ce}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${ce.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let z="";R&&(z=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #ddd; font-size: 0.85em; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re($)}</div>
            </div>
        `:Y=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${re(h)}</div>
            </div>
        `,k=`
                <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                    <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="metadata-value" style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee;">${u.related_services&&u.related_services.length>0?u.related_services.join(", "):u.related||"SYSTEM"}</div>
                    </div>
                    <div style="flex: 1; min-width: 100px; text-align: center;">
                ...
                ${Y}
            `;let K=document.createElement("div");K.className=`event-item notification-item ${M} ${I} ${P} cursor-pointer priority-${v}`,K.dataset.alertId=r.id,K.onclick=function(ce){let Q=this;if(Q.classList.contains("expanded")){Q.classList.remove("expanded"),fe.delete(r.id);let Ae=Q.querySelector(".event-details");Ae&&(Ae.style.display="none")}else{Q.classList.add("expanded"),fe.add(r.id);let Ae=Q.querySelector(".event-details");if(Ae&&(Ae.style.display="block"),!localStorage.getItem(`alert_read_ts_${r.id}`)){localStorage.setItem(`alert_read_ts_${r.id}`,Date.now().toString()),Q.classList.add("alert-read"),Q.classList.remove("alert-unread"),Q.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ke="event-border-grey";v==="high"||v==="critical"?Ke="event-border-red":v==="medium"&&(Ke="event-border-orange"),Q.classList.add(Ke),Xe()}}};let we=`${w?w.toUpperCase():"GUARDIAN"} ALERT: ${g||b}`,Ge={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[A]||"bx-bell",Ve=v==="high"||v==="critical"?"#ff4d4d":v==="medium"?"#ffa500":"#888";K.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Ve}; font-size: 0.8em; margin-left: 5px;">[${v.toUpperCase()}]</span>
                    </div>
                    <div class="event-message">${re(we)}</div>
                    <div class="event-details" style="${V}">
                        ${k}
                    </div>
                </div>
            `;let lt=K.querySelector(".event-details");lt&&lt.addEventListener("click",ce=>{ce.stopPropagation()});let ct=K.querySelector(".close-details-btn");return ct&&ct.addEventListener("click",ce=>{ce.stopPropagation(),K.classList.remove("expanded");let Q=K.querySelector(".event-details");Q&&(Q.style.display="none"),fe.delete(r.id)}),K},y=r=>{let u=document.createElement("div");u.className="notification-divider",u.dataset.alertId=r.id;let b="#888888";return r.label==="CRITICAL"?b="#ff4d4d":r.label==="HIGH"?b="#ff8888":r.label==="MEDIUM"&&(b="#ffa500"),u.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${b}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,u.innerHTML=`<span style="white-space: nowrap;">${r.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${b}44, transparent); flex-grow: 1;"></div>`,u},s=r=>{let u=document.createElement("div");u.innerHTML=F("empty",r.message,null,r.id);let b=u.firstElementChild;return b.dataset.alertId=r.id,b},m=Array.from(e.children),E=new Map(m.map(r=>[r.dataset.alertId,r])),H=new Set(C.map(r=>r.id));m.forEach(r=>{let u=r.dataset.alertId;(!u||!H.has(u))&&r.remove()});let o=null;C.forEach((r,u)=>{let b=E.get(r.id);if(!b||t){if(b&&b.remove(),r.type==="divider")b=y(r);else if(r.type==="placeholder")b=s(r);else{let h=p(r);if(!h)return;b=h}if(!b)return}u===0?e.firstElementChild!==b&&e.prepend(b):o&&o.nextElementSibling!==b&&o.after(b),o=b}),je=Date.now(),te(0,je),Xe()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=F("offline","Failed to load alerts.","The event service may be offline."))}}function $s(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),n=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ue.forEach(a=>{localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ue.forEach(a=>{fe.add(a.id),localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),de(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{fe.clear(),de(!0)},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await D("/events?type=system.notification.generated",{method:"DELETE"});let a=Date.now()-48*60*60*1e3;Ue.forEach(c=>{localStorage.setItem(`alert_read_ts_${c.id}`,a.toString())}),fe.clear(),de(!0)}catch(a){console.error("Failed to clear alerts:",a)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function Qe(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await D(t);if(!e.ok)return;let i=(await e.json()).events||[],a=0;i.forEach(c=>{let l=c.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${c.id}`)||a++}),xt(a)}catch{}}var $t=()=>`
...
`,ge=new Set,St=[],Se=null;async function be(t=!1){let e=document.getElementById("roadmap-list");if(e){ks();try{let n=await D("/roadmap");if(!n.ok)throw new Error("Offline");let i=await n.json();St=i;let a=p=>{let y=ge.has(p.id),s=p.state==="published",m=p.state==="consumed",E="event-border-grey";s&&(E="event-border-blue"),m&&(E="event-border-purple");let o=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),r=document.createElement("div");r.className=`event-item notification-item ${E} cursor-pointer ${y?"expanded":""}`,r.dataset.itemId=p.id,r.onclick=h=>{if(h.target.closest("button"))return;if(r.classList.contains("expanded")){r.classList.remove("expanded");let $=r.querySelector(".event-details");$&&($.style.display="none"),ge.delete(p.id)}else{r.classList.add("expanded");let $=r.querySelector(".event-details");$&&($.style.display="block"),ge.add(p.id)}};let u=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;r.innerHTML=`
        <div class="event-time">
          <span class="event-time-main">${o.split(",")[1]}</span>
          <span class="event-date">${o.split(",")[0]}</span>
        </div>
        <div class="event-content">
          <div class="event-service">ROADMAP ${u}</div>
          <div class="event-message" style="white-space: pre-wrap;">${O(p.content)}</div>
          <div class="event-details" style="${y?"display: block;":"display: none;"} ">
            ...
            `}
            ${m?`<div style="margin-top: 15px; font-size: 0.8em; color: #888;">Consumed at: ${new Date(p.consumed_at*1e3).toLocaleString()}</div>`:""}
          </div>
        </div>
      `;let b=r.querySelector(".event-details");return b&&b.addEventListener("click",h=>{h.stopPropagation()}),r.querySelector(".edit-btn")?.addEventListener("click",()=>Ss(p)),r.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ms(p)),r.querySelector(".delete-btn")?.addEventListener("click",()=>Ls(p.id)),r.querySelector(".close-details-btn")?.addEventListener("click",h=>{h.stopPropagation(),r.classList.remove("expanded");let g=r.querySelector(".event-details");g&&(g.style.display="none"),ge.delete(p.id)}),r},c=p=>{let y=document.createElement("div");y.innerHTML=F("empty",p.message,p.action,p.id);let s=y.firstElementChild;return s.dataset.itemId=p.id,s},l=[];!i||i.length===0?l.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:N()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):i.forEach(p=>l.push({...p,type:"item"}));let f=Array.from(e.children),d=new Map(f.map(p=>[p.dataset.itemId,p])),x=new Set(l.map(p=>p.id));f.forEach(p=>{let y=p.dataset.itemId;(!y||!x.has(y))&&p.remove()}),t&&(e.innerHTML="");let C=null;l.forEach((p,y)=>{let s=d.get(p.id);(!s||t)&&(s&&s.remove(),p.type==="placeholder"?s=c(p):s=a(p),!s)||(y===0?e.firstElementChild!==s&&e.prepend(s):C&&C.nextElementSibling!==s&&C.after(s),C=s)})}catch{e.children.length===0&&(e.innerHTML=F("offline","Failed to load roadmap.","The event service may be offline."))}}}function ks(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),a=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Se=null;let c=document.getElementById("roadmap-editor-input");c&&(c.value="");let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="block")},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{let c=document.getElementById("roadmap-editor-container");c&&(c.style.display="none"),Se=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let c=document.getElementById("roadmap-editor-input"),l=c?c.value:"";if(!l.trim())return;let f=Se?`/roadmap/${Se}`:"/roadmap",d=Se?"PATCH":"POST";try{await D(f,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})});let x=document.getElementById("roadmap-editor-container");x&&(x.style.display="none"),be(!0)}catch(x){console.error(x)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{St.forEach(c=>ge.add(c.id)),be(!0)},i.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{ge.clear(),be(!0)},a.dataset.listenerAttached="true")}function Ss(t){Se=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let n=document.getElementById("roadmap-editor-container");n&&(n.style.display="block",n.scrollIntoView({behavior:"smooth"}))}async function Ms(t){let e=t.state==="published"?"draft":"published";try{await D(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),be(!0)}catch(n){console.error(n)}}async function Ls(t){if(confirm("Delete this roadmap item?"))try{await D(`/roadmap/${t}`,{method:"DELETE"}),ge.delete(t),be(!0)}catch(e){console.error(e)}}var Lt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,Mt=null,ve=new Set,It=[];async function ye(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;As();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await D(n);if(!i.ok)throw new Error("Service is offline or unreachable.");let c=(await i.json()).events||[];It=c,Mt=Date.now(),te(2,Mt);let l=s=>{let m=s.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let E=(m.title||"Untitled Blueprint").trim(),H=(m.summary||m.body||"No summary provided.").trim(),o=(m.content||"").trim(),r=(m.category||"architecture").trim(),u=(m.related_services||m.affected_services||[]).map(k=>k.trim()),b=(m.implementation_path||[]).map(k=>k.trim()),h=m.source_event_ids||[],g=m.approved===!0,$=new Date(s.timestamp*1e3),w=$.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),v=$.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=ve.has(s.id),A=S?"display: block;":"display: none;",B=document.createElement("div");B.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${g?"blueprint-approved":""}`,B.dataset.blueprintId=s.id,g&&(B.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",B.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let G=g?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[r]||"bx-paint";B.onclick=function(k){let _=this;if(_.classList.contains("expanded")){_.classList.remove("expanded"),ve.delete(s.id);let U=_.querySelector(".event-details");U&&(U.style.display="none")}else{_.classList.add("expanded"),ve.add(s.id);let U=_.querySelector(".event-details");U&&(U.style.display="block")}};let J="";b.length>0&&(J=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${b.map(k=>`<li style="margin-bottom: 5px;">${O(k)}</li>`).join("")}</ul></div>
                    </div>
                `);let W="";h.length>0&&(W=`
                ...
                `);let L=u.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${u.join(", ")}</span></div>`:"<div></div>",T=N(),M=g?`
            ...
            `;B.innerHTML=`
                ...
                <div class="event-icon" style="${g?"color: #03dac6;":""}"><i class='bx ${G}'></i></div>
                <div class="event-content">
                    <div class="event-service">${r.toUpperCase()}</div>
                    ...
                    <div class="event-details" style="${A}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${O(H)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${O(o)}</div>
                        </div>
                        ${J}
                        ${W}
                        ${M}
            ...
            `;let I=B.querySelector(".blueprint-approve-btn");I&&(I.onclick=async k=>{k.stopPropagation(),I.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await D(`/events/${s.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ye(!0)}catch(_){console.error("Failed to approve blueprint:",_)}});let j=B.querySelector(".blueprint-delete-btn");j&&(j.onclick=async k=>{k.stopPropagation();let _=!g;j.innerHTML=_?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await D(`/events/${s.id}`,{method:"DELETE"})).ok&&ye(!0)}catch(z){console.error("Failed to delete blueprint:",z)}});let P=B.querySelector(".event-details");P&&P.addEventListener("click",k=>{k.stopPropagation()});let V=B.querySelector(".close-details-btn");return V&&V.addEventListener("click",k=>{k.stopPropagation(),B.classList.remove("expanded");let _=B.querySelector(".event-details");_&&(_.style.display="none"),ve.delete(s.id)}),B},f=s=>{let m=document.createElement("div");m.innerHTML=F("empty",s.message,s.action,s.id);let E=m.firstElementChild;return E.dataset.blueprintId=s.id,E},d=[];c.length===0?d.push({id:"placeholder-empty",type:"placeholder",message:"No architectural blueprints generated yet.",action:"The Imaginator will synthesize these during system idle periods."}):c.forEach(s=>d.push({...s,type:"blueprint"})),t&&(e.innerHTML="");let x=Array.from(e.children),C=new Map(x.map(s=>[s.dataset.blueprintId,s])),p=new Set(d.map(s=>s.id));x.forEach(s=>{let m=s.dataset.blueprintId;(!m||!p.has(m))&&s.remove()});let y=null;d.forEach((s,m)=>{let E=C.get(s.id);(!E||t)&&(E&&E.remove(),s.type==="placeholder"?E=f(s):E=l(s),!E)||(m===0?e.firstElementChild!==E&&e.prepend(E):y&&y.nextElementSibling!==E&&y.after(E),y=E)}),Pe(2,c.length),wt()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=F("offline","Failed to load blueprints.","The event service may be offline."))}}async function Bt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await D(t);if(!e.ok)return;let i=(await e.json()).events||[],a=0;i.forEach(c=>{let l=c.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&a++}),ht(a)}catch{}}function As(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),n=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{It.forEach(i=>ve.add(i.id)),ye(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ve.clear(),ye(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await D("/events?type=system.blueprint.generated",{method:"DELETE"}),ve.clear(),ye(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var le="STANDBY",Ht=null,Me=[],X=null,qe=null,_t=()=>`
    <div id="progress-view-root" class="progress-container">
        <!-- Initial render will happen here -->
        ${Dt()}
    </div>
  `;function Dt(){switch(le){case"ACTIVE":return Bs();case"COMPLETED":return Hs();case"STANDBY":default:return Is()}}function Is(){return`
    ...
    <div class="mission-summary-card">
        ...
        <div class="summary-stat-grid">
            <div class="summary-stat">
                <span class="summary-stat-value">${qe?.duration||"12m 4s"}</span>
                <span class="summary-stat-label">Duration</span>
            </div>
            <div class="summary-stat">
                <span class="summary-stat-value">${qe?.steps||"42"}</span>
        ...
        <div style="background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; margin-bottom: 30px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-family: 'JetBrains Mono'; font-size: 0.9em; color: #bb86fc;">${qe?.result||"Optimized Event Bus"}</span>
  ...
  `}async function Le(){let t=document.getElementById("progress-view-root");t&&(le!==Ht&&(t.innerHTML=Dt(),Ht=le),le==="ACTIVE"&&_s())}function _s(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),n=document.getElementById("active-task-progress-text"),i=document.getElementById("terminal-output");if(t&&X&&(t.innerText=X.title),e&&X&&(e.style.width=`${X.progress}%`),n&&X&&(n.innerText=`${X.progress}% COMPLETE`),i){let a=i.children.length;if(Me.length>a){for(let c=a;c<Me.length;c++){let l=Me[c],f=document.createElement("div");f.className="terminal-line",f.innerHTML=`
            <span class="line-time">${l.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${O(l.msg)}</span>
        `,i.appendChild(f)}i.scrollTop=i.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{le="ACTIVE",Me=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],X={title:"Refactoring System Event Bus",progress:10},Le();let t=0,e=setInterval(()=>{if(le!=="ACTIVE"){clearInterval(e);return}t++,X.progress=Math.min(100,X.progress+Math.floor(Math.random()*15));let n=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<n.length&&Me.push({time:new Date().toLocaleTimeString(),msg:n[t]}),X.progress>=100&&(le="COMPLETED",qe={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),Le()},1500)});window.addEventListener("dex-mock-stop",()=>{le="STANDBY",Le()});window.addEventListener("dex-mock-reset",()=>{le="STANDBY",Le()});var zt=()=>`
...
`,Nt=()=>`
    ...
    `,Ie=[],Be={"313071000877137920":"Owen",dexter:"Dexter"},se=[],xe=null;async function He(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),a=document.getElementById("cancel-chore-btn"),c=document.getElementById("new-chore-owner"),l=document.getElementById("selected-recipients"),f=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),x=document.getElementById("new-chore-url"),C=document.getElementById("new-chore-schedule"),p=document.getElementById("new-chore-time"),y=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(y&&!y.dataset.initialValueAttached){let g=Intl.DateTimeFormat().resolvedOptions().timeZone,$=!1;for(let w=0;w<y.options.length;w++)if(y.options[w].value===g){$=!0;break}if(!$){let w=document.createElement("option");w.value=g,w.textContent=g.replace("_"," "),y.appendChild(w)}y.value=g,y.dataset.initialValueAttached="true"}C&&s&&!C.dataset.timeListenerAttached&&(C.addEventListener("change",()=>{s.style.display=C.value==="daily"?"block":"none"}),C.dataset.timeListenerAttached="true");let m=document.getElementById("form-title"),E=document.getElementById("form-icon");function H(){if(l){if(se.length===0){l.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}l.innerHTML=se.sort((g,$)=>{let w=g.startsWith("channel:"),v=$.startsWith("channel:");return w&&!v?-1:!w&&v?1:0}).map(g=>{let $=Be[g]||g,w=g.startsWith("channel:");return`
        <div class="recipient-badge" style="display: flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.05); padding: 4px 10px; border-radius: 15px; border: 1px solid rgba(255,255,255,0.1); font-size: 0.75em; color: ${g==="dexter"?"#bb86fc":w?"#03dac6":"#fff"};">
          <i class='bx ${g==="dexter"?"bx-terminal":w?"bx-hash":"bx-user"}'></i>
          <span>${$}</span>
          <i class='bx bx-x remove-recipient' data-id="${g}" style="cursor: pointer; margin-left: 4px; opacity: 0.6;"></i>
        </div>
      `}).join(""),l.querySelectorAll(".remove-recipient").forEach(g=>{g.onclick=()=>{let $=g.dataset.id;se=se.filter(w=>w!==$),H()}})}}function o(g){g&&!se.includes(g)&&(se.push(g),H()),c&&(c.value="")}function r(g=null){if(n){if(xe=g?g.id:null,g){if(m&&(m.textContent="Update Research Task"),E&&(E.className="bx bx-edit-alt",E.style.color="#03dac6"),i&&(i.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=g.natural_instruction),x&&(x.value=g.execution_plan?.entry_url||""),C&&(C.value=g.schedule,s&&(s.style.display=g.schedule==="daily"?"block":"none")),p&&g.run_at&&(p.value=g.run_at),y&&g.timezone){let $=!1;for(let w=0;w<y.options.length;w++)if(y.options[w].value===g.timezone){$=!0;break}if(!$){let w=document.createElement("option");w.value=g.timezone,w.textContent=g.timezone.replace("_"," "),y.appendChild(w)}y.value=g.timezone}se=g.recipients||(g.owner_id?[g.owner_id]:[]),H()}else m&&(m.textContent="Initialize Research Task"),E&&(E.className="bx bx-plus-circle",E.style.color="#bb86fc"),i&&(i.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),x&&(x.value=""),C&&(C.value="every_24h"),se=[],H();n.style.display="block",n.scrollIntoView({behavior:"smooth",block:"start"})}}let u=document.getElementById("contacts-group"),b=document.getElementById("channels-group");if(u&&!u.dataset.populated&&!N())try{ue("/contacts").then(async g=>{g.ok&&(((await g.json()).members||[]).forEach(v=>{if(Be[v.id]=v.nickname||v.username,v.id==="313071000877137920")return;let S=document.createElement("option");S.value=v.id;let A=v.nickname||v.username;S.textContent=`${A} (${v.username})`,u.appendChild(S)}),u.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(b&&!b.dataset.populated&&!N())try{ue("/channels").then(async g=>{g.ok&&((await g.json()).forEach(w=>{let v=`channel:${w.id}`;Be[v]=w.name;let S=document.createElement("option");S.value=v,S.textContent=`#${w.name} (${w.guild})`,b.appendChild(S)}),b.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}c&&!c.dataset.listenerAttached&&(c.onchange=()=>{o(c.value)},c.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onchange=()=>h(),f.dataset.listenerAttached="true");function h(){if(!t)return;let g=f?.value||"all",$=g==="all"?Ie:Ie.filter(v=>(v.recipients||(v.owner_id?[v.owner_id]:[])).includes(g));if($.length===0){t.innerHTML=F("empty",g==="all"?"No active tasks.":"No tasks found for this owner.",N()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let w=$.map(v=>{let S=v.last_run===0?"Never":new Date(v.last_run*1e3).toLocaleString(),A=v.memory?v.memory.length:0,B=v.status==="active"?"#03dac6":"#666",G=(v.recipients||(v.owner_id?[v.owner_id]:[])).sort((J,W)=>{let L=J.startsWith("channel:"),T=W.startsWith("channel:");return L&&!T?-1:!L&&T?1:0}).map(J=>{let W=Be[J]||J.substring(0,8),L=J.startsWith("channel:");return`<span title="${W}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${J==="dexter"?"bx-terminal":L?"bx-hash":"bx-user"}'></i>${W}</span>`}).join("<span style='color: #444;'>, </span>");return`
                <div class="service-widget wide-task-card" style="border-left: 4px solid ${B}; width: 100%; display: flex; flex-direction: column; padding: 20px;">
                    <div class="service-widget-header" style="display: flex; align-items: flex-start; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 15px; margin-bottom: 15px;">
                        <div style="display: flex; gap: 15px; flex: 1;">
                            <i class='bx bx-search-alt' style="color: ${B}; font-size: 1.5em; margin-top: 2px;"></i>
                            <div style="text-align: left;">
                                <h3 style="font-size: 1.1em; white-space: normal; line-height: 1.4; font-weight: 600; margin: 0;">${v.natural_instruction}</h3>
                                <div style="margin-top: 8px; display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
                                    ...
                                    <span style="font-size: 0.7em; color: #666; font-family: 'JetBrains Mono', monospace;"><i class='bx bx-time' style="margin-right: 4px;"></i>${v.schedule}${v.run_at?" @ "+v.run_at+(v.timezone?" ("+v.timezone.split("/").pop()?.replace("_"," ")+")":""):""}</span>
                                </div>
                            </div>
                        </div>
                        <div style="display: flex; gap: 10px; align-items: center;">
                            <button class="icon-btn reset-chore-btn" data-id="${v.id}" title="Reset Progress" style="background: none; border: none; color: #ff9800; cursor: pointer; padding: 8px; border-radius: 50%; transition: background 0.2s;"><i class='bx bx-refresh' style="font-size: 1.2em;"></i></button>
                            <button class="icon-btn edit-chore-btn" data-id="${v.id}" style="background: none; border: none; color: #bb86fc; cursor: pointer; padding: 8px; border-radius: 50%; transition: background 0.2s;"><i class='bx bx-edit-alt' style="font-size: 1.2em;"></i></button>
                            <button class="icon-btn delete-chore-btn" data-id="${v.id}" style="background: none; border: none; color: #cf6679; cursor: pointer; padding: 8px; border-radius: 50%; transition: background 0.2s;"><i class='bx bx-trash' style="font-size: 1.2em;"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="service-widget-body" style="display: flex; flex-wrap: wrap; gap: 30px; align-items: center;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 2px; flex: 1; min-width: 200px;">
                            ...
                            <span style="font-size: 0.8em; color: #888; font-family: 'JetBrains Mono'; word-break: break-all;">${v.execution_plan.entry_url||"Autonomous Detection"}</span>
                        </div>
                    </div>
                </div>
            `}).join("");t.innerHTML=w,t.querySelectorAll(".edit-chore-btn").forEach(v=>{v.onclick=S=>{S.stopPropagation();let A=v.dataset.id,B=Ie.find(R=>R.id===A);B&&r(B)}}),t.querySelectorAll(".reset-chore-btn").forEach(v=>{v.onclick=async S=>{S.stopPropagation();let A=v.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(v.innerHTML="<i class='bx bx-loader-alt spin'></i>",await D(`/chores/${A}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),He())}}),t.querySelectorAll(".delete-chore-btn").forEach(v=>{v.onclick=async S=>{S.stopPropagation();let A=v.dataset.id;confirm("Delete this task?")&&(await D(`/chores/${A}`,{method:"DELETE"}),He())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n&&(n.style.display==="none"||xe!==null?r(null):n.style.display="none")},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{n&&(n.style.display="none")},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let g=document.getElementById("new-chore-instruction"),$=document.getElementById("new-chore-url"),w=document.getElementById("new-chore-schedule"),v=g?.value,S=w?.value||"every_24h",A=S==="daily"?p?.value:"",B=S==="daily"?y?.value:"";if(!v)return;if(se.length===0){alert("Please add at least one recipient.");return}let R=i.innerHTML;i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let G=xe?"PATCH":"POST",J=xe?`/chores/${xe}`:"/chores";await D(J,{method:G,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:v,entry_url:$?.value,schedule:S,run_at:A,timezone:B})}),n&&(n.style.display="none"),g&&(g.value=""),$&&($.value=""),xe=null,se=[],He()}catch(G){console.error(G),alert(xe?"Failed to update research task":"Failed to create research task")}finally{i.innerHTML=R}},i.dataset.listenerAttached="true");try{let g=await D("/chores");if(!g.ok)throw new Error(`HTTP error! status: ${g.status}`);if(Ie=await g.json()||[],f){let w=f.value,v=new Set;Ie.forEach(S=>{S.owner_id&&v.add(S.owner_id),S.recipients&&S.recipients.forEach(A=>v.add(A))}),f.innerHTML='<option value="all">All Recipients</option>',v.forEach(S=>{let A=document.createElement("option");A.value=S;let B=S.startsWith("channel:"),R=Be[S]||`Recipient: ${S.substring(0,8)}`;A.textContent=(B&&!R.startsWith("#")?"#":"")+R,f.appendChild(A)}),f.value=w,f.selectedIndex===-1&&(f.value="all")}h()}catch(g){console.error("Failed to fetch chores",g)}}var Rt=()=>`
...
`;async function et(){await Promise.all([be(),ye(),Le(),He()])}var Ds=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function Ut(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function qt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Ds,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",ue(`/profile/${t.id}`).then(async n=>{if(n.ok){let i=await n.json();tt(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=Ut(t.id,t.username);tt(e,t,i)}}).catch(n=>{console.error("Profile fetch error:",n);let i=Ut(t.id,t.username);tt(e,t,i)})}function tt(t,e,n){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",a=()=>{let E=(n.attributes||n.facts||[]).map(h=>{let g=h.key||h.k,$=h.value||h.v;return`
            <div class="fact-chip">
                <span class="fact-key">${g}:</span>
                <span class="fact-val">${$}</span>
            </div>
        `}).join(""),H=n.cognitive_model||n,o=H.technical_level||H.techLevel||0,r=H.communication_style||H.commStyle||"Unknown",u=H.patience_level||H.patience||"Unknown",b=H.vibe||"Unknown";return`
                    ...
                    <div class="cog-metric">
                     ...
                     <div class="cog-metric">
                        <div class="cog-label">
                            ...
                            <span style="font-family: 'JetBrains Mono'; color: #bb86fc;">${b}</span>
                        </div>
                    </div>
                </div>
        ...
        `},c=()=>{let E=n.dossier||{},H=E.identity||{},o=E.career||{},r=E.personal||{},u=E.social||[];return`
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="height: 15px;"></div>
                         ...
                         <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                            ${(o.skills||[]).map(b=>`<span style="font-size: 0.75em; background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">${b}</span>`).join("")}
                         </div>
                    </div>
                </div>
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="margin-top: 10px;">
                            ${(r.hobbies||[]).map(b=>`<div class="dossier-list-item">${b}</div>`).join("")}
                        </div>
                    </div>
                    ...
                    <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(r.habits||[]).map(b=>`<div class="dossier-list-item">${b}</div>`).join("")}
                        </div>
                    </div>
                     ...
                     <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(r.vices||[]).map(b=>`<div class="dossier-list-item" style="color: #cf6679;">${b}</div>`).join("")}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dossier-item" style="background: none; border: none; padding: 0;">
                        ${u.length>0?u.map(b=>`
                            <div class="friend-chip">
                                <div style="width: 35px; height: 35px; background: #333; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; color: #888;">${b.name.substring(0,1)}</div>
                                <div style="flex: 1;">
                                    <div style="color: #fff; font-weight: 500;">${b.name}</div>
                                    <div style="font-size: 0.75em; color: #888;">${b.relation}</div>
                                </div>
                                <div style="font-size: 0.8em; color: #03dac6;">${b.trust}</div>
                            </div>
    ...
    `,x=`
        <div class="profile-card">
            ...
            <div class="profile-body">
                ...
                <div id="tab-dossier" class="tab-content">${c()}</div>
    ...
    `;t.innerHTML=x;let C=t.querySelector(".profile-card"),p=t.querySelector("#profile-expand-toggle"),y=t.querySelectorAll(".profile-tab-btn"),s=t.querySelectorAll(".tab-content"),m=t.querySelector(".close-profile-btn");m&&m.addEventListener("click",()=>{t.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>t.remove(),300)}),y.forEach(E=>{E.addEventListener("click",()=>{y.forEach(r=>r.classList.remove("active")),s.forEach(r=>r.classList.remove("active")),E.classList.add("active");let H=E.dataset.tab,o=t.querySelector(`#tab-${H}`);o&&o.classList.add("active")})}),p&&p.addEventListener("click",()=>{C.classList.toggle("expanded");let E=C.classList.contains("expanded");p.innerHTML=E?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var Ft=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
...
`,zs=null;async function st(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await st(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let a=n.target.closest(".user-profile-card");if(a&&a.dataset.user)try{let c=JSON.parse(a.dataset.user);qt(c)}catch(c){console.error("Failed to parse user data",c)}},t.dataset.listenerAttached="true");try{let n=await ue("/contacts");if(!n.ok)throw new Error("Service unreachable");let a=(await n.json()).members||[];if(zs=Date.now(),a.length===0){t.innerHTML=F("empty","No contacts found.","Check your Discord connection.");return}let c={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};a.sort((l,f)=>{let d=c[l.level]??10,x=c[f.level]??10;return d!==x?d-x:l.username.localeCompare(f.username)}),t.innerHTML=a.map(l=>{let f=l.color&&l.color!==0,d=f?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",x=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",C="#888";l.level==="Me"||l.level==="Master"?C="#bb86fc":l.level==="Admin"?C="#cf6679":l.level==="Moderator"?C="#03dac6":l.level==="Contributor"&&(C="#ffa500");let p=l.level==="Me",y=p?"rgba(187, 134, 252, 0.08)":f?`${d}11`:"rgba(255,255,255,0.03)",s=p?"2px solid #bb86fc":f?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                     data-user="${JSON.stringify(l).replace(/"/g,"&quot;")}"
                     style="background: ${y}; padding: 15px; border-radius: 8px; border: ${s}; display: flex; align-items: center; gap: 12px; position: relative; overflow: hidden; cursor: pointer; transition: transform 0.2s, background 0.2s, box-shadow 0.2s;">
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${p?"#bb86fc":f?d:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${l.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${p?"2px solid #bb86fc":f?`2px solid ${d}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                        <div style="position: absolute; bottom: 0; right: 0; width: 12px; height: 12px; background: ${x}; border: 2px solid #1a1a1a; border-radius: 50%;"></div>
                    </div>
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${f?d:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${l.nickname||l.username}</h3>
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${C}; font-weight: 600; text-transform: uppercase;">${p?"DEXTER (ME)":l.level}</span>
...
`,Fe=null,he=new Set,_e=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Rs))if(n.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function pe(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let i=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(i+=`&category=${Z}`);try{let a=await D(i);if(!a.ok)throw new Error("Service unreachable");if(_e=((await a.json()).events||[]).filter(y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let m=s.type;return!(m==="system.blueprint.generated"||m==="system.notification.generated")}),Fe=Date.now(),te(1,Fe),_e.length===0){e.innerHTML=F("empty","No events found for this filter.");return}t&&(e.innerHTML="");let f=y=>{let s=y.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let m=s.type,E=Os(m),H=js(m),o=m==="engagement.decision"||m==="messaging.bot.sent_message"||m==="messaging.bot.voice_response"||m==="messaging.user.sent_message"||m==="moderation.explicit_content.deleted"||m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="analysis.user.message_signals"||m==="system.cli.command"||m==="system.analysis.audit"||m==="system.test.completed"||m==="error_occurred"||m==="system.cli.status"||m==="system.attention.expired"||m.startsWith("system.roadmap")||m.startsWith("system.process"),r="event-border-grey";o&&(m==="moderation.explicit_content.deleted"||m==="error_occurred"?r="event-border-red":m==="analysis.link.completed"||m==="analysis.visual.completed"||m==="analysis.router.decision"||m==="system.analysis.audit"||m==="analysis.user.message_signals"||m==="engagement.decision"?r="event-border-purple":m==="system.attention.expired"||m==="system.cli.command"||m==="system.cli.status"?r="event-border-orange":m==="system.test.completed"?r=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":r="event-border-blue");let u=o?"cursor-pointer":"",b=he.has(y.id),h=b?"expanded":"",g=b?"display: block;":"display: none;",$=new Date(y.timestamp*1e3),w=$.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),v=$.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Jt(m,s),A=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",B="";if(o){let L="";if(m==="engagement.decision"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                    ...
                    `}else if(m==="system.attention.expired"){let T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,M=s.timestamp-s.last_active,I=Math.floor(M/60);L=`
                    ...
                    `}else if(m==="messaging.bot.sent_message"){let T=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,M="";if(s.embed){let P=s.embed,V=P.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${O(P.title)}</div>`:"",k=P.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(P.description)}</div>`:"",_=(P.fields||[]).map(z=>`
              <div style="margin-top: 10px;">
                <div style="font-size: 0.7em; text-transform: uppercase; color: #666; letter-spacing: 1px;">${O(z.name)}</div>
                <div style="font-size: 0.85em; color: #eee; white-space: pre-wrap;">${re(z.value)}</div>
              </div>
            `).join("");M=`
            ...
            `}let I="";s.eval_count&&(I=`
                        ...
                        `);let j="";if(s.chat_history&&s.chat_history.length>0){let P=s.chat_history.length,V=s.chat_history.map((k,_)=>{let z=k.name?k.name.toUpperCase():k.role.toUpperCase();!k.name&&z==="ASSISTANT"&&(z="DEXTER");let U=k.role==="user"?"#03dac6":k.role==="system"?"#ffb74d":"#bb86fc",Y=_===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${_}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${U}; letter-spacing: 1px; font-weight: bold;">${z}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${_+1} of ${P}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${O(k.content)}</div>
                                </div>
                            `}).join("");j=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(m==="messaging.bot.voice_response"){let T=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,M="",I=[],j=s.raw_input||"";if(j.startsWith("[{")&&j.endsWith("}]")){let P=j.match(/{.*?}/g);P&&(I=P.map(V=>{let k=V.substring(1,V.length-1),_=k.indexOf(" "),z=k.substring(0,_),U=k.substring(_+1);return U=U.replace(/\[\]$/,"").trim(),{role:z,content:U}}))}if(I.length>0&&s.response_raw&&I.push({role:"assistant",content:s.response_raw}),I.length>0){let P=I.length,V=I.map((k,_)=>{let z=k.role.toUpperCase();z==="ASSISTANT"&&(z="DEXTER");let U=k.role==="user"?"#03dac6":k.role==="system"?"#ffb74d":"#bb86fc",Y=_===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${_}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${U}; letter-spacing: 1px; font-weight: bold;">${z}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${_+1} of ${P}</span>
                    ...
                    `}else if(m==="analysis.user.message_signals"){let T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,M=s.signals||{};L=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                ${(M.topics||[]).map(j=>`<span class="profile-badge">${j}</span>`).join("")||'<span style="color: #666;">No topics mapped.</span>'}
                            </div>
                        </div>
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${T("Raw Model Output")}
                            <pre class="detail-pre">${O(s.raw_output)||"None"}</pre>
                        </div>
                    `}else if(m==="moderation.explicit_content.deleted"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="analysis.link.completed"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${O(s.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${T("Description")}
                            <pre class="detail-pre">${O(s.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${T("Content Summary")}
                            <pre class="detail-pre">${O(s.summary)||"None"}</pre>
                        </div>
                    `}else if(m==="analysis.visual.completed"){let T=I=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${I}</h5>`,M="";s.base64_preview?M=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(M=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(m==="analysis.router.decision"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${T("Input Context")}
                            <pre class="detail-pre">${O(s.raw_input)||"None"}</pre>
                        </div>
                    `}else if(m==="system.cli.command"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${T("Output")}
                            <pre class="detail-pre">${O(s.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(m==="system.analysis.audit"){let T=s.success?"#03dac6":"#ff4d4d",M=s.success?"SUCCESS":"FAILED",I=_=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${_}</h5>`,j="";s.error&&(j=`
                            <div class="event-detail-block">
                                ${I("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${O(s.error)}</pre>
                            </div>
                        `);let P="";if(s.chat_history&&s.chat_history.length>0){let _=s.chat_history.length,z=s.chat_history.map((U,Y)=>{let K=U.name?U.name.toUpperCase():U.role.toUpperCase();!U.name&&K==="USER"&&(K="SYSTEM"),!U.name&&K==="ASSISTANT"&&(K="AGENT");let we=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${Y}" style="display: ${Y===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; text-transform: uppercase; color: ${we}; letter-spacing: 1px; font-weight: bold;">${K}</span>
                        ...
                        `}let V="";if(s.corrections&&s.corrections.length>0){let _=s.corrections.map((z,U)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                <div style="color: #ff4d4d; font-weight: bold; margin-bottom: 4px;">[${z.type}] ${z.guidance}</div>
                                ${z.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${O(z.snippet)}</div>`:""}
                            </div>
                        `).join("");V=`
                            <div class="event-detail-block">
                        ...
                        `}let k="";if(s.parsed_results&&s.parsed_results.length>0){let _=s.parsed_results.map(z=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${O(z.title)}</div>
                                <div style="color: #ddd;">${O(z.summary)}</div>
                            </div>
                        `).join("");k=`
                            <div class="event-detail-block">
                                ${I("Parsed Results")}
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${T}; font-weight: bold;">${M} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${s.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${V}
                        ${P}
                    `}else if(m==="system.test.completed"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row">
                    ...
                    `}else if(m==="error_occurred"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${T("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${O(s.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${T("Context")}
                            <pre class="detail-pre">${JSON.stringify(s.context||{},null,2)}</pre>
                        </div>
                    `}else if(m==="system.cli.status"){let T=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`;L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${T("Message")}
                            <pre class="detail-pre">${O(s.message)}</pre>
                        </div>
                    `}else if(m==="messaging.user.sent_message"){let T="";s.attachments&&s.attachments.length>0&&(T=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(I=>{let j=I.content_type&&I.content_type.startsWith("image/"),P=(I.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${j?`<div class="attachment-thumb-container"><img src="${I.url}" alt="${I.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                                    <div class="attachment-info">
                                        <a href="${I.url}" target="_blank" class="attachment-link">${I.filename}</a>
                                        <span class="attachment-meta">${I.content_type} \u2022 ${P}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),L=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                ...
                `}let R=document.createElement("div");R.className=`event-item ${r} ${u} ${h}`,R.dataset.eventId=y.id,R.onclick=function(L){if(!o)return;let T=this;if(T.classList.contains("expanded")){T.classList.remove("expanded"),he.delete(y.id);let I=T.querySelector(".event-details");I&&(I.style.display="none")}else{T.classList.add("expanded"),he.add(y.id);let I=T.querySelector(".event-details");I&&(I.style.display="block")}},R.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${w}</span>
                    <span class="event-date">${v}</span>
                </div>
            ...
            `;let G=R.querySelector(".event-details");if(G&&G.addEventListener("click",L=>{L.stopPropagation()}),o){let L=R.querySelector(".close-details-btn");L&&L.addEventListener("click",T=>{T.stopPropagation();let M=T.target.closest(".event-item");if(M){M.classList.remove("expanded"),he.delete(y.id);let I=M.querySelector(".event-details");I&&(I.style.display="none")}})}let J=R.querySelector(".prev-btn"),W=R.querySelector(".next-btn");if(J&&W){let L=0,T=Array.from(R.querySelectorAll(".history-slide")),M=T.length,I=()=>{T.forEach((j,P)=>{j.style.display=P===L?"block":"none"}),J.disabled=L===0,W.disabled=L===M-1,J.style.opacity=L===0?"0.5":"1",W.style.opacity=L===M-1?"0.5":"1"};J.addEventListener("click",j=>{j.stopPropagation(),L>0&&(L--,I())}),W.addEventListener("click",j=>{j.stopPropagation(),L<M-1&&(L++,I())}),I()}return R},d=Array.from(e.children),x=new Map(d.map(y=>[y.dataset.eventId,y])),C=new Set(_e.map(y=>y.id));d.forEach(y=>{let s=y.dataset.eventId;(!s||!C.has(s))&&y.remove()});let p=null;_e.forEach((y,s)=>{let m=x.get(y.id);(!m||t)&&(m&&m.remove(),m=f(y),!m)||(s===0?e.firstElementChild!==m&&e.prepend(m):p&&p.nextElementSibling!==m&&p.after(m),p=m)}),Fe=Date.now(),te(1,Fe)}catch(a){console.error("Error fetching events:",a),e.children.length===0&&(e.innerHTML=F("offline","Failed to load events.","The event service may be offline."))}}function Us(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),n=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{_e.forEach(a=>he.add(a.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{he.clear(),pe(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.querySelectorAll(".filter-btn").forEach(a=>{a.onclick=()=>{n.querySelectorAll(".filter-btn").forEach(c=>c.classList.remove("active")),a.classList.add("active"),Z=a.dataset.filter||"all",pe(!0)}}),n.dataset.listenerAttached="true"),n&&n.querySelectorAll(".filter-btn").forEach(a=>{a.dataset.filter===Z?a.classList.add("active"):a.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let a=Z==="all"?"ALL":Z.toUpperCase();if(confirm(`Are you sure you want to delete ${a} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let c="/events";if(Z!=="all"?c+=`?category=${Z}`:c+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await D(c,{method:"DELETE"})).ok)throw new Error("Failed to delete events");he.clear(),pe(!0)}catch(c){console.error("Failed to clear events:",c),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var qs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Wt=qs;function Gt(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var Fs=null;async function De(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await D("/logs");if(!e.ok)throw new Error("Logs offline");let n=await e.json();if(!n||n.length===0)return t.innerHTML=F("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0"],a=n.filter(l=>!i.includes(l.id));a.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),a.reverse();let c=a.map(l=>{let f=l.logs.join(`
`),d=[...l.logs];if(d.length<25){let C=25-d.length;for(let p=0;p<C;p++)d.push("")}else d.length>25&&(d=d.slice(-25));let x=d.map(C=>Oe(C)).join(`
`);return`
                <div class="log-report">
                    ...
                    <pre class="log-content">${x}</pre>
                </div>
            `}).join("");return t.innerHTML=c,document.querySelectorAll(".copy-logs-btn").forEach(l=>{l.addEventListener("click",()=>{let f=l,d=unescape(f.dataset.logs||"");navigator.clipboard.writeText(d).then(()=>{let x=f.querySelector("i");x&&(x.classList.remove("bx-copy"),x.classList.add("bx-check"),setTimeout(()=>{x.classList.remove("bx-check"),x.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(l=>{l.addEventListener("click",async()=>{let d=l.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${d}?`))try{(await D(`/logs?service_id=${d}`,{method:"DELETE"})).ok&&De()}catch(x){console.error("Error clearing logs:",x)}})}),Fs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=F("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Yt=()=>{let t=N()?"display: none;":"";return`
        ...
        <div id="services-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,es=()=>`
        <div class="system-section-header">
            <i class='bx bxs-brain' style="color: #03dac6;"></i>
            <h2>Cognitive Models</h2>
        </div>
        <div id="models-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,ts=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Gt()}
        </div>`;async function ns(){Js(),await Promise.all([ne(),ze(),at()]),await De()}var Je=null;function Js(){Je||(Je=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Je),Je=null;return}ne(!0)},1e3))}var Vt=null,Kt=null;async function is(){try{return await(await D("/system_monitor")).json()}catch{return null}}async function Zt(){try{return await(await D("/system/hardware")).json()}catch{return null}}async function Ws(){try{return await(await D("/processes")).json()}catch{return null}}async function Gs(){try{return await(await D("/agent/status")).json()}catch{return null}}async function ze(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),n=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),a=document.querySelector("#hw-ram .hw-content"),c=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),f=o=>{if(o){if(n&&(n.innerHTML=`
                ...
                </div>`),a){let r=(o.MEMORY_BYTES/1073741824).toFixed(1);a.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-size: 0.9em; color: #fff; font-weight: 400; letter-spacing: 0.5px;">Total System Memory</span>
                    <span style="font-size: 1.8em; font-weight: bold; color: #fff;">${r} <span style="font-size: 0.5em; color: #888; font-weight: normal; margin-left: 2px;">GB</span></span>
                </div>`}if(i&&o.CPU&&o.CPU.length>0){let r=o.CPU[0];i.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    <span style="font-size: 1.1em; color: #fff; font-weight: 400; letter-spacing: 0.5px;">${r.LABEL}</span>
                    <div style="display: flex; gap: 30px;">
                        <div style="text-align: right;"><span style="display: block; font-size: 1.3em; font-weight: bold; color: #03dac6; line-height: 1;">${r.COUNT}</span><span style="font-size: 0.65em; color: #666; text-transform: uppercase; font-weight: 700;">Cores</span></div>
                        <div style="text-align: right;"><span style="display: block; font-size: 1.3em; font-weight: bold; color: #bb86fc; line-height: 1;">${r.THREADS}</span><span style="font-size: 0.65em; color: #666; text-transform: uppercase; font-weight: 700;">Threads</span></div>
                    </div>
                </div>`}c&&(o.GPU&&o.GPU.length>0?c.innerHTML=o.GPU.map(r=>{let u=(r.VRAM/1073741824).toFixed(1);return`
                        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
                            <span style="font-size: 1.1em; color: #fff; font-weight: 400;">${r.LABEL}</span>
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):c.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),l&&o.STORAGE&&o.STORAGE.length>0?l.innerHTML=o.STORAGE.map(r=>{let u=(r.USED/1073741824).toFixed(1),b=(r.SIZE/(1024*1024*1024)).toFixed(1),h=r.SIZE>0?(r.USED/r.SIZE*100).toFixed(0):0,g=r.MOUNT_POINT||"Unmounted";return`
                    <div style="padding: 15px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div style="display: flex; align-items: center; gap: 8px;">
                                ...
                                <span style="font-weight: 600; color: #fff; font-size: 0.95em;">${r.DEVICE}</span>
                            </div>
                            <span style="font-size: 0.75em; color: #666; font-family: monospace; background: rgba(0,0,0,0.2); padding: 2px 6px; border-radius: 4px;">${g}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.75em; color: #888; margin-bottom: 6px; text-transform: uppercase; font-weight: 600; letter-spacing: 0.5px;">
                            <span>${u} GB Used</span>
                            <span>${b} GB Total</span>
                        </div>
                        <div style="background: rgba(255,255,255,0.05); height: 6px; border-radius: 3px; overflow: hidden;">
                             <div style="background: ${Number(h)>90?"#cf6679":"#03dac6"}; width: ${h}%; height: 100%; box-shadow: 0 0 10px ${Number(h)>90?"#cf667944":"#03dac644"};"></div>
                        </div>
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let o=await Zt();o?(f(o),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),i&&!i.hasChildNodes())){let o=await Zt();f(o)}if(!t)return;t.dataset.controlsAttached||(t.addEventListener("click",async o=>{let r=o.target.closest(".svc-btn");if(!r)return;let u=r,b=u.dataset.action,h=u.dataset.service;if(!b||!h)return;let g=u.innerHTML;u.innerHTML="<i class='bx bx-loader-alt spin'></i>",u.classList.add("loading"),u.disabled=!0;try{await D(`/system/service/${b}`,{method:"POST",body:JSON.stringify({service:h})}),setTimeout(()=>ze(),1e3),setTimeout(()=>ze(),3e3)}catch($){console.error($),alert(`Failed to ${b} ${h}`),u.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{u.innerHTML=g,u.classList.remove("loading"),u.disabled=!1},2e3)}}),t.dataset.controlsAttached="true");let d=await is();if(!d||!d.services){t.children.length===0&&(t.innerHTML=F("offline","Failed to load system metrics.","The event service may be offline."));let o=document.querySelector('[data-service-id="upstash-redis-ro"]');if(o){o.className="service-widget service-widget-offline",o.querySelector(".service-widget-status").textContent="ERROR";let r=o.querySelector(".service-widget-body");r&&(r.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Vt=N()&&oe.lastDashboard||Date.now(),te(0,Vt||0);let x=d.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let o=document.getElementById("upstash-countdown");if(o){let b=59-new Date().getSeconds();b<=0&&(b+=60),o.textContent=`${b}s`}},1e3)),Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function C(o){if(!o||o==="N/A"||o==="unknown")return"-";let r=o.match(/^(\d+\.\d+\.\d+)/);return r?r[0]:o.split(".").slice(0,3).join(".")||"-"}function p(o){return!o||o.length<=28?o:o.substring(0,28)+"..."}function y(o){if(!o||o==="N/A"||o==="unknown")return"-";let r=o.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!r)return"-";let u=parseInt(r[1])||0,b=parseInt(r[2])||0,h=parseInt(r[3])||0,g=parseFloat(r[4])||0,$=u*86400+b*3600+h*60+g,w=Math.floor($/86400);if(w>0)return`${w}d`;let v=Math.floor($/3600);if(v>0)return`${v}h`;let S=Math.floor($/60);return S>0?`${S}m`:`${Math.floor($)}s`}function s(o){if(o.id==="upstash-redis-ro"){let T=N()&&(oe.lastFrontend||oe.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
                ...
                <div class="service-widget-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 10px 0;">
                    ...
                    <div class="sync-time-label" style="font-size: 0.6em; color: #444; margin-top: 10px;">Last synced: ${new Date(T).toLocaleTimeString()}</div>
                </div>
            </div>`}let r=o.status==="online",u=r?"service-widget-online":"service-widget-offline",b=r?"bx-check-circle":"bx-x-circle",h=r?"OK":"BAD",g=o.version?C(o.version.str):"-",$=o.cpu&&o.cpu!=="N/A"?o.cpu:"-",w=o.memory&&o.memory!=="N/A"?o.memory:"-",v=$!=="-"?"#00ff00":"#666",S=$!=="-"?"#fff":"#666",A=w!=="-"?"#00ff00":"#666",B=w!=="-"?"#fff":"#666",R=y(o.uptime),G="",J=o.type!=="os"&&o.type!=="cli"&&o.type!=="prd",W="";J&&!N()&&(W=`
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                <button class="svc-btn svc-restart" title="Restart Service" data-action="restart" data-service="${o.id}"><i class='bx bx-refresh'></i></button>
                <button class="svc-btn svc-stop" title="Stop Service" data-action="stop" data-service="${o.id}" ${r?"":"disabled"}><i class='bx bx-stop'></i></button>
                <button class="svc-btn svc-start" title="Start Service" data-action="start" data-service="${o.id}" ${r?"disabled":""}><i class='bx bx-play'></i></button>
            </div>`),r?G=`
                <div class="service-widget-info">
                    <span class="info-label">Version:</span>
                    <span class="info-value metric-version-monospace">${g}</span>
                </div>
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${B};">${w}</span>
                    </div>
                </div>${W}`:G=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${W}`;let L=N()?"easter.company":p(o.domain&&o.port?`${o.domain}:${o.port}`:"");return`<div class="service-widget ${u}" data-service-id="${o.id}"><div class="service-widget-header"><i class="bx ${b}"></i><h3>${o.short_name||o.id}</h3><span class="service-widget-status">${h}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${L}</span></div>${G}</div></div>`}let m=new Map(Array.from(t.querySelectorAll(".service-widget")).map(o=>[o.dataset.serviceId,o])),E=new Set(x.map(o=>o.id));for(let[o,r]of m)E.has(o)||r.remove();let H=new Set;x.forEach(o=>{if(H.has(o.id))return;H.add(o.id);let r=s(o),u=m.get(o.id);if(u&&u.parentNode)if(o.id==="upstash-redis-ro"){let b=N()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),h=new Date(b).toLocaleTimeString(),g=u.querySelector(".sync-time-label");g&&(g.textContent=`Last synced: ${h}`)}else u.outerHTML!==r&&(u.outerHTML=r);else t.insertAdjacentHTML("beforeend",r)})}async function at(){let t=document.getElementById("models-widgets");if(!t)return;let e=await is();if(!e){t.children.length===0&&(t.innerHTML=F("offline","Failed to load model status.","The event service may be offline."));return}Kt=Date.now(),te(2,Kt);let n=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function a(d){let x=d.status==="Ready";return`
                ...
                </div>`}function c(d){let x=d.status==="Ready";return`
                <div class="service-widget ${x?"service-widget-online":"service-widget-offline"}" data-xtts-widget>
                    <div class="service-widget-header">
                ...
                </div>`}function l(d){let x=d.status==="Downloaded",C=x?"service-widget-online":"service-widget-offline",p=x?"OK":"MISSING",y=x&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${C}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${x?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${p}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${y}</span></div></div></div>`}let f="";if(i&&(f+=a(i)),e.xtts&&(f+=c(e.xtts)),f+=n.map(l).join(""),!f){t.innerHTML=F("empty","No models found.");return}t.innerHTML!==f&&(t.innerHTML=f)}async function ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let n=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-idle-val"),a=document.getElementById("guardian-total-idle"),c=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),f=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn"),x=document.getElementById("fabricator-reset-btn"),C=document.getElementById("courier-reset-btn"),p=document.getElementById("system-pause-toggle-btn");p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{let h=p.querySelector(".bx-play")?"/agent/resume":"/agent/pause";p.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D(h,{method:"POST"}),await ne()}catch{p.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>ne(),2e3)}},p.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onclick=async()=>{f.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=all",{method:"POST"}),setTimeout(()=>{f.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{f.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{f.innerHTML="<i class='bx bx-error'></i>"}},f.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true"),x&&!x.dataset.listenerAttached&&(x.onclick=async()=>{x.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{x.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{x.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{x.innerHTML="<i class='bx bx-error'></i>"}},x.dataset.listenerAttached="true"),C&&!C.dataset.listenerAttached&&(C.onclick=async()=>{C.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{C.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{C.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{C.innerHTML="<i class='bx bx-error'></i>"}},C.dataset.listenerAttached="true");let y=document.getElementById("imaginator-reset-btn");y&&!y.dataset.listenerAttached&&(y.onclick=async()=>{y.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await D("/agent/reset?protocol=alert_review",{method:"POST"}),setTimeout(()=>{y.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{y.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{y.innerHTML="<i class='bx bx-error'></i>"}},y.dataset.listenerAttached="true");let s=await Gs();if(s&&s.agents){let b=s.agents.guardian||{protocols:{}},h=s.agents.analyzer||{protocols:{}},g=s.agents.imaginator||{protocols:{}},$=s.agents.fabricator||{protocols:{}},w=s.agents.courier||{protocols:{}},v=s.system||{},S=Math.floor(Date.now()/1e3),A={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},B=k=>{k<0&&(k=0);let _=Math.floor(k/3600),z=Math.floor(k%3600/60),U=k%60;return _>0?`${_}h ${z}m`:z>0?`${z}m ${U}s`:`${U}s`},R=(k,_,z,U)=>{if(!k)return;let Y=A[U]||U.toUpperCase(),K=k.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(K&&(K.textContent=Y),!z){k.textContent="Inactive",k.style.color="#666";return}let we=z.status;if(we==="Working")k.textContent="Working",k.style.color="#bb86fc";else if(we==="Ready")k.textContent="Ready",k.style.color="#5eff5e";else{let Ce=z.cooldown;if(N()&&(Ce=z.next_run-S),Ce<=0)k.textContent="Ready",k.style.color="#5eff5e";else{let Ge=Math.floor(Ce/60),Ve=Ce%60;k.textContent=`${Ge}m ${Ve}s`,k.style.color="#fff"}}_&&z.stats&&(_.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
              <span>Runs: ${z.stats.runs||0}</span>
              <span style="color: ${z.stats.failures>0?"#ffa500":"#666"}">Fails: ${z.stats.failures||0}</span>
              <span style="color: ${z.stats.aborted>0?"#ff4d4d":"#666"}">Aborted: ${z.stats.aborted||0}</span>
            </div>
          `)};n&&R(n,document.getElementById("guardian-sentry-stats"),b.protocols.sentry,"sentry");let G=document.getElementById("analyzer-synthesis-val"),J=document.getElementById("analyzer-synthesis-stats");G&&R(G,J,h.protocols.synthesis,"synthesis");let W=document.getElementById("imaginator-alert_review-val"),L=document.getElementById("imaginator-alert_review-stats");W&&R(W,L,g.protocols.alert_review,"alert_review");let T=document.getElementById("fabricator-construction-val"),M=document.getElementById("fabricator-construction-stats");T&&R(T,M,$.protocols.construction,"construction");let I=document.getElementById("courier-researcher-val"),j=document.getElementById("courier-researcher-stats");I&&R(I,j,w.protocols.researcher,"researcher");let P=document.getElementById("system-state-label"),V=document.getElementById("system-state-val");if(V&&v.state){let k=v.state,_=B(v.state_time||0);P&&(P.textContent=`State: ${k.toUpperCase()}`),V.textContent=_,k==="idle"?V.style.color=v.state_time>300?"#5eff5e":"#fff":V.style.color="#bb86fc",p&&(k==="paused"?(p.innerHTML="<i class='bx bx-play'></i>",p.title="Resume System",p.style.color="#ff9800"):(p.innerHTML="<i class='bx bx-pause'></i>",p.title="Pause System",p.style.color=""))}a&&(a.textContent=B(v.metrics?.total_idle_time||0)),c&&(c.textContent=B(v.metrics?.total_active_time||0)),l&&(l.textContent=B(v.metrics?.total_waste_time||0))}else[n,i,a,c,l].forEach(h=>{h&&(h.textContent="-",h.style.color="#666")});if(t)return;let m=await Ws(),E=[],H=[],o=[];m&&(Array.isArray(m)?E=m:(E=m.active||[],H=m.queue||[],o=m.history||[],o.sort((b,h)=>(h.end_time||0)-(b.end_time||0)))),e&&(E.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=F("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),it(e,E,!1)));let r=document.getElementById("processes-queue-widgets");r&&(H.length===0?!r.querySelector(".tab-placeholder")&&!r.querySelector('div[style*="font-style: italic"]')&&(r.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(r.innerHTML="",it(r,H,!1)));let u=document.getElementById("processes-history-widgets");u&&(o.length===0?u.querySelector(".tab-placeholder")||(u.innerHTML=F("empty","No recent history.")):(u.querySelector(".tab-placeholder")&&(u.innerHTML=""),it(u,o,!0))),Pe(1,E.length)}function it(t,e,n){function i(d){let x="";d.end_time?x=`${d.end_time-d.start_time}s`:x=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let C=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",p=d.channel_id,y={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent"};if(y[p]?p=y[p]:/^\d+$/.test(p)&&(p=`Channel ${p}`),n)return`
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                <span>PID: ${d.pid}</span>
                <span style="color: #03dac6; min-width: 40px; text-align: right;">${x}</span>
            </div>
                ...
                <div class="service-widget process-widget" data-channel-id="${d.channel_id}-${d.start_time}" style="">
                    ...
                    <div class="service-widget-body">
                        ...
                        <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${s}">${x}</span>
                        </div>
                         <div class="service-widget-info">
                ...
                </div>`}let a=n?".process-history-item":".process-widget",c=new Map(Array.from(t.querySelectorAll(a)).map(d=>[d.dataset.channelId,d])),l=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,x]of c)d&&!l.has(d)&&x.remove();let f=new Set;e.forEach(d=>{let x=`${d.channel_id}-${d.start_time}`;if(f.has(x))return;f.add(x);let C=i(d),p=c.get(x);if(p&&p.parentNode){p.outerHTML!==C&&(p.outerHTML=C);let y=t.querySelector(`[data-channel-id="${x}"]`);y&&t.appendChild(y)}else t.insertAdjacentHTML("beforeend",C)})}function We(){let t=Ze(),e="Notification"in window,n={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function ot(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(i=>{i.addEventListener("click",function(){let a=this.dataset.theme;a&&(gt(a),t.setContent(We()),ot(t))})});let n=document.getElementById("notifications-toggle");n&&"Notification"in window?n.onclick=async i=>{let a=i.target;if(a.checked)try{await Notification.requestPermission()!=="granted"&&(a.checked=!1)}catch{a.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),a.checked=!0)}:n&&(n.disabled=!0),Vs()}async function Vs(){let t=document.getElementById("service-config-list");if(t)try{let n=await(await D("/system/options")).json();if(!n||Object.keys(n).length===0){t.innerHTML='<div style="padding: 20px; text-align: center; color: #666;">No configurable services found.</div>';return}let i="",a=(c,l,f)=>`
        <div class="settings-item">
            <div class="settings-item-info">
            ...
            <label class="toggle-switch">
                <input type="checkbox" class="service-device-toggle" data-service="${l}" ${f==="cuda"?"checked":""}>
                <span class="toggle-slider"></span>
            </label>
        </div>`;if(n.stt){let c=n.stt.device||"cpu";i+=a("STT Service","stt",c)}if(n.tts){let c=n.tts.device||"cpu";i+=a("TTS Service","tts",c)}t.innerHTML=i,t.querySelectorAll(".service-device-toggle").forEach(c=>{c.addEventListener("change",async l=>{let f=l.target,d=f.dataset.service,x=f.checked?"cuda":"cpu";f.disabled=!0;try{await D("/system/options",{method:"POST",body:JSON.stringify({service:d,key:"device",value:x})})}catch(C){console.error("Failed to update config",C),f.checked=!f.checked,alert("Failed to update configuration.")}finally{f.disabled=!1}})})}catch{t.innerHTML='<div style="padding: 20px; text-align: center; color: #cf6679;">Failed to load configuration.</div>'}}var os=()=>`
    ...
    `;async function rs(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await as(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await as(t)}async function as(t){try{let e=await D("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let n=await e.json();if(!n||n.length===0){t.innerHTML=F("empty","No web history found.");return}let i=`
            <div style="display: flex; flex-direction: column; height: 100%;">
        ...
        `;n.forEach((f,d)=>{let x=new Date(f.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),C=f.screenshot?`<img src="data:image/png;base64,${f.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';i+=`
                <div class="web-card" style="flex: 0 0 100%; height: 100%; display: flex; flex-direction: column; scroll-snap-align: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; box-sizing: border-box; max-width: 100%; overflow: hidden;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 10px; flex-shrink: 0;">
                        ...
                        <span style="color: #888; font-size: 0.8em; font-family: monospace;">${x}</span>
                    </div>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ks=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,i]of Object.entries(t)){let a=ds.filter(c=>c.category===n);a.length!==0&&(e+=`
                    ...
                    ${a.map(c=>`
                        <div class="cli-command-card ${c.dummy?"dummy":""}" data-cmd="${c.id}" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 25px; transition: all 0.3s ease; cursor: pointer; position: relative; overflow: hidden;">
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px; position: relative; z-index: 1;">
                                <i class='bx ${c.icon}' style="font-size: 2em; color: ${i.color};"></i>
    ...
    </div>`,e},rt=!1;function Zs(t){let e=document.getElementById("cli-terminal-overlay");if(!e){e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>ls());let x=document.getElementById("terminal-action-btn");x&&(x.onclick=()=>ls())}let n=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");n&&(n.innerHTML="");let a=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let c=document.getElementById("terminal-cmd-name");c&&(c.textContent=`dex ${t.id}`);let l=document.getElementById("terminal-status-badge");l&&(l.className="terminal-status status-running",l.textContent="Running");let f=document.getElementById("terminal-action-btn");return f&&(f.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",rt=!0,n}function ls(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",rt=!1}function cs(t,e,n="output"){if(!rt||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${n}`,n==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let a=Oe(e);i.innerHTML=a||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Ys(t){let e=ds.find(l=>l.id===t);if(!e)return;let n=Zs(e);n&&cs(n,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let l of i){await new Promise(d=>setTimeout(d,400+Math.random()*600));let f="output";l.includes("[ERROR]")?f="error":l.includes("[SUCCESS]")||l.includes("\u2713")?f="success":l.includes("!")&&(f="warning"),n&&cs(n,l,f)}let a=document.getElementById("terminal-status-badge");a&&(a.className="terminal-status status-success",a.textContent="Completed (Demo)");let c=document.getElementById("terminal-action-btn");c&&(c.style.display="block")}function ps(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ks();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code"),i=n?n.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let a=e.querySelector("i");a&&(a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(n=>{let i=n;n.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let a=i.dataset.cmd;a&&Ys(a)})})}async function Xs(){if(!N())try{if(!(await D("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ms(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}pt(),mt(),Xs(),vt(),dt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ps();let e=[],n=document.getElementById("windows-container");n&&n.setAttribute("data-count","0");let i=o=>{localStorage.setItem("dex_last_window",o)};function a(){for(;e.length>1;)e.shift().close(!0);let o=document.getElementById("windows-container"),r=document.querySelector("nav"),u=document.querySelector("footer"),b=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");o&&o.setAttribute("data-count",e.length.toString()),e.forEach(A=>{let B=document.getElementById(A.id);B&&B.classList.remove("hide-close")});let g=document.getElementById("dexter-menu-container"),$=document.getElementById("nav-window-switcher"),w=document.getElementById("settings-icon"),v=document.getElementById("close-all-windows"),S=window.innerWidth<880;if(!S){let A=document.getElementById("dexter-dropdown"),B=document.getElementById("dexter-menu-btn");A&&A.classList.remove("active"),B&&B.classList.remove("active"),o&&o.classList.remove("menu-open")}if(Ee(e.length>0),e.length>0)if(u?.classList.add("hide"),v&&(v.style.display=S?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",r?.classList.add("window-open"),o&&(o.style.paddingTop="60px"),g&&(g.style.display=S?"flex":"none"),w&&(w.style.display=S?"block":"none"),!S&&$){let A=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(A)?($.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),c(f)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),c(d)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),c(C)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),c(x)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),c(p)})):$.innerHTML=""}else $&&($.innerHTML="");else r?.classList.remove("window-open"),v&&(v.style.display="none"),o&&(o.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",b||h?u?.classList.remove("hide"):u?.classList.add("hide"),g&&(g.style.display="flex"),w&&(w.style.display="block"),$&&($.innerHTML="");ke()}function c(o){if(o.isOpen()){o.close();return}for(;e.length>0;)e.pop().close(!0);e.push(o),o.open(),a()}function l(){[...e].forEach(r=>r.close()),e=[]}window.addEventListener("resize",a);let f=me({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Tt(),onOpen:()=>de(),onClose:()=>{let o=e.indexOf(f);o>-1&&e.splice(o,1),a()}}),d=me({id:"events-window",title:"Events",icon:"bx-calendar-event",content:nt(),onOpen:()=>{d.setContent(nt()),pe()},onClose:()=>{let o=e.indexOf(d);o>-1&&e.splice(o,1),a()}}),x=me({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ft(),onOpen:()=>st(),onClose:()=>{let o=e.indexOf(x);o>-1&&e.splice(o,1),a()}}),C=me({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Qt()},{icon:"bxs-component",title:"Processes",content:Xt()},{icon:"bxs-brain",title:"Models",content:es()},{icon:"bx-globe",title:"Web",content:os()},{icon:"bxs-hdd",title:"Hardware",content:ts()},{icon:"bxs-terminal",title:"Logs",content:ss()},{icon:"bxs-zap",title:"Agents",content:Yt()}].filter(o=>N()?o.title!=="Hardware"&&o.title!=="Logs":!0),onOpen:()=>{ze(),ne(),at(),rs(),De()},onClose:()=>{let o=e.indexOf(C);o>-1&&e.splice(o,1),a()}}),p=me({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Rt()},{icon:"bx-map-alt",title:"Roadmap",content:Pt()},{icon:"bx-paint",title:"Blueprints",content:Ot()},{icon:"bx-task",title:"Tasks",content:jt()}],onOpen:()=>et(),onClose:()=>{let o=e.indexOf(p);o>-1&&e.splice(o,1),a()}}),y=me({id:"settings-window",title:"Settings",icon:"bx-cog",content:We(),onOpen:()=>{y.setContent(We()),ot(y)},onClose:()=>{let o=e.indexOf(y);o>-1&&e.splice(o,1),a()}});window.dexter={viewEvent:o=>{d.isOpen()||c(d),setTimeout(()=>{let r=document.querySelector(`.event-item[data-event-id="${o}"]`);r&&(r.scrollIntoView({behavior:"smooth",block:"center"}),r.classList.add("flash-highlight"),r.classList.contains("expanded")||r.click(),setTimeout(()=>r.classList.remove("flash-highlight"),2e3))},500)},viewAlert:o=>{f.isOpen()||c(f),setTimeout(()=>{let r=document.querySelector(`.event-item[data-alert-id="${o}"]`);r&&(r.scrollIntoView({behavior:"smooth",block:"center"}),r.classList.add("flash-highlight"),r.classList.contains("expanded")||r.click(),setTimeout(()=>r.classList.remove("flash-highlight"),2e3))},500)}};let s=()=>{let o=document.getElementById("dexter-dropdown"),r=document.getElementById("dexter-menu-btn");o&&r&&(o.classList.remove("active"),r.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let o=document.getElementById("dexter-menu-btn"),r=document.getElementById("settings-icon"),u=document.getElementById("close-all-windows"),b=document.getElementById("nav-left-container"),h=document.getElementById("dexter-dropdown"),g=document.getElementById("windows-container");o&&h&&(o.onclick=w=>{w.stopPropagation();let v=window.innerWidth<880;if(v)h.style.top="",h.style.left="",h.style.right="",h.style.transform="";else{let A=o.getBoundingClientRect(),R=document.querySelector("nav").getBoundingClientRect(),G=220,J=10,L=A.left+A.width/2-G/2,T=R.right-10;L+G>T&&(L=T-G),L<10&&(L=10),h.style.top=R.bottom+J+"px",h.style.left=L+"px",h.style.right="auto",h.style.transform="none"}h.classList.toggle("active"),o.classList.toggle("active");let S=h.classList.contains("active");if(v){let A=document.querySelector("nav");S?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),A?.classList.add("window-open"),g?.classList.add("menu-open"),Ee(!0)):(g?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),A?.classList.remove("window-open"),Ee(!1)))}}),r&&(r.onclick=w=>{w.stopPropagation(),c(y)}),u&&(u.onclick=w=>{w.stopPropagation(),l()});let $=(w,v,S)=>{let A=document.getElementById(w);A&&(A.onclick=B=>{B.stopPropagation(),s(),S&&i(S),c(v)})};$("alerts-menu-item",f,"alerts-window"),$("events-menu-item",d,"events-window"),$("monitor-menu-item",C,"monitor-window"),$("contacts-menu-item",x,"contacts-window"),$("workspace-menu-item",p,"workspace-window"),b&&(b.onclick=w=>{if(w.stopPropagation(),h&&h.classList.contains("active")){s(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Ee(!1));return}if(e.length>0)l();else{let v=window.location.pathname;if(!(v==="/"||v==="/index.html")){let B=(v.endsWith("/")&&v.length>1?v.slice(0,-1):v).split("/");B.pop();let R=B.join("/")||"/";window.location.href=R}}}),document.addEventListener("click",()=>{let w=window.innerWidth<880;h&&h.classList.contains("active")&&(s(),w&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Ee(!1)))}),h&&(h.onclick=w=>w.stopPropagation())})();let E=window.location.pathname==="/"||window.location.pathname==="/index.html",H=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!E&&!H&&document.querySelector("footer")?.classList.add("hide"),N()||setInterval(()=>{d.isOpen()&&pe(),f.isOpen()?de():Qe()},1e3),setInterval(()=>{N()&&(f.isOpen()?de():Qe()),p.isOpen()?et():Bt(),N()&&d.isOpen()&&pe(),C.isOpen()&&ns()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ms):ms();})();
