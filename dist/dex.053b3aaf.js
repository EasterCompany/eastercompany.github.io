"use strict";(()=>{function at(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function ot(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var lt=1e3;function ce(t){let e=null,s=t.onClose||null,i=t.onOpen||null;function n(){e&&(e.style.zIndex=(++lt).toString())}function l(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",r),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++lt).toString(),e.addEventListener("mousedown",n);let v=t.icon||"bx-window",o="",b="",$;t.tabs&&t.tabs.length>0?(o=`<div class="tab-bar">${t.tabs.map((d,u)=>{let f=d.icon?`<i class="bx ${d.icon}"></i>`:`<span class="tab-glyph">${d.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${$}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",w=>{w.stopPropagation(),c()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(w=>{w.addEventListener("click",()=>{if(!e)return;let a=w.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(u=>u.classList.remove("active")),w.classList.add("active"),e.querySelectorAll(".tab-content").forEach(u=>u.classList.remove("active"));let d=e.querySelector(`.tab-content[data-tab-content="${a}"]`);d&&d.classList.add("active"),g(w,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function r(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&g(m,e)}function g(m,v){setTimeout(()=>{let o=v.querySelector(".tab-bar");if(!o)return;let b=Array.from(o.querySelectorAll(".tab")),$=b.indexOf(m),w=o.clientWidth,a=b[Math.max(0,$-2)],d=b[Math.min(b.length-1,$+2)],u=o,f=a.offsetLeft-u.offsetLeft-25,M=d.offsetLeft+d.offsetWidth-u.offsetLeft+25-f,A=M<=w?f-(w-M)/2:m.offsetLeft-u.offsetLeft-w/2+m.offsetWidth/2;o.scrollTo({left:A,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",r),m?(e.remove(),e=null):(e.classList.remove("open"),s&&s(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){t.content=m;let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function y(){return!!(e&&e.classList.contains("open"))}return{open:l,close:c,setContent:p,isOpen:y,focus:n,id:t.id}}var ct="easter_theme",X={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function qe(){return localStorage.getItem(ct)||X.DARK}function dt(t){if(!Object.values(X).includes(t))throw new Error("Invalid theme");localStorage.setItem(ct,t),pt(t)}function pt(t){let e=document.body;Object.values(X).forEach(l=>{e.classList.remove(`theme-${l}`)}),e.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let i={[X.DARK]:"#050507",[X.LIGHT]:"#FFFFFF",[X.LEGACY]:"#000000"},n=i[t]||i[X.DARK];if(s.setAttribute("content",n),!document.querySelector(".background")){let l=document.createElement("div");l.className="background",document.body.prepend(l)}e.classList.add("is-animated")}function mt(){let t=qe();pt(t)}function N(t,e,s=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=s?`<p class="placeholder-action">${s}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function z(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Q(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!s)return;if(!e){s.textContent="Last updated: never";return}let i=Date.now(),n=Math.floor((i-e)/1e3),l;n<60?l=`${n}s ago`:n<3600?l=`${Math.floor(n/60)}m ago`:l=`${Math.floor(n/3600)}h ago`,s.textContent=`Last updated: ${l}`}var os=0;function ke(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!s)return;let i=s.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var te=0,se=0;function ft(t){te=t,Ce()}function gt(t){se=t,Ce()}function Ce(){let t=te+se;os=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let s=document.getElementById("alerts-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=te>9?"9+":te.toString(),r.style.display=te>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",i.appendChild(r)),r.textContent=se>9?"9+":se.toString(),r.style.display=se>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",n.appendChild(r)),r.textContent=te>9?"9+":te.toString(),r.style.display=te>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let r=l.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",l.appendChild(r)),r.textContent=se>9?"9+":se.toString(),r.style.display=se>0?"flex":"none"}}function Be(){let t=document.getElementById("alerts-list");if(!t)return;te=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Ce()}function bt(){let t=document.getElementById("blueprints-list");if(!t)return;se=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Ce()}function rs(){return"https://event.easter.company"}function ls(){return"https://discord.easter.company"}var cs="http://127.0.0.1:8100",ds="http://127.0.0.1:8300",ps={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function _e(t){let e=z(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,l)=>{let r=ps[l];return r?`<span class="${r}">`:""});let s=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return s>i&&(e+="</span>".repeat(s-i)),e}function de(t){if(!t)return"";let e=z(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(s,i)=>{let n=i.split("|").map(l=>l.trim());return n.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var ms="https://sterling-javelin-12539.upstash.io",us="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function H(){return window.location.hostname.includes("easter.company")}var P=null,ne={lastDashboard:0,lastFrontend:0},Fe=!1,vt=0,yt="dex_dashboard_snapshot";function fs(){let t=localStorage.getItem(yt);if(t)try{let e=JSON.parse(t);P=e,ne.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{P=null}}async function ut(){if(!(!H()||Fe)){Fe=!0,vt=Math.floor(Date.now()/1e3);try{let t=await vs("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,ne.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),ne.lastFrontend=Date.now(),localStorage.setItem(yt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Fe=!1}}}function gs(){if(!P||!P.agent_status)return;let t=P.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function bs(){if(!H())return;fs();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await ut(),setInterval(()=>{let s=new Date,i=Math.floor(Date.now()/1e3),n=P?i-P.timestamp:1/0,l=i-vt,r=s.getSeconds()===59,g=n>300,c=l>60;(r&&c||g&&c)&&ut(),gs()},1e3)}H()&&bs();async function vs(t,...e){try{let i=await(await fetch(ms,{method:"POST",headers:{Authorization:`Bearer ${us}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(s){return console.error("Upstash Error:",s),null}}var he=null,we=null,Ae=!1,Ie=!1;async function B(t,e={}){if(H()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),l=n.get("type")||n.get("event.type"),r=n.get("category"),g=n.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...P.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...P.blueprints||[]]:r==="messaging"?c=[...P.messaging_events||[]]:r==="system"?c=[...P.system_events||[]]:r==="cognitive"?c=[...P.cognitive_events||[]]:r==="moderation"?c=[...P.moderation_events||[]]:c=[...P.events||[]],g==="asc"?c.sort((p,y)=>p.timestamp-y.timestamp):c.sort((p,y)=>y.timestamp-p.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],l=P.profiles?P.profiles[n]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(P.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(he)try{let n=await fetch(he+t,e);if(n.ok)return n;he=null}catch{he=null}let s=rs(),i=cs;try{let n=await fetch(s+t,e);if(n.ok)return he=s,Ae&&(console.log("\u2728 Production event service restored."),Ae=!1),n;throw new Error("Primary failed")}catch{Ae||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ae=!0);try{let l=await fetch(i+t,e);if(l.ok)return he=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function He(t,e={}){if(H()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],l=(P.contacts?.members||[]).find(r=>r.id===n);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(we)try{let n=await fetch(we+t,e);if(n.ok)return n;we=null}catch{we=null}let s=ls(),i=ds;try{let n=await fetch(s+t,e);if(n.ok)return we=s,Ie&&(console.log("\u2728 Production discord service restored."),Ie=!1),n;throw new Error("Primary failed")}catch{Ie||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Ie=!0);try{let l=await fetch(i+t,e);if(l.ok)return we=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}var xt=()=>`
...
`,De=null,pe=new Set,ze=[];async function oe(t=!1){let e=document.getElementById("alerts-list");if(!e)return;ys(),t&&(e.innerHTML="<p>Updating...</p>");let s="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await B(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];De=Date.now(),Q(0,De);let r=Date.now(),g=24*60*60*1e3,c=l.filter(u=>{let f=localStorage.getItem(`alert_read_ts_${u.id}`);if(!f)return!0;let x=parseInt(f);return r-x<g});c.sort((u,f)=>{let x=k=>{let E=k.event;if(typeof E=="string")try{E=JSON.parse(E)}catch{return"low"}return(E.priority||"low").toLowerCase()},M=k=>k==="critical"?4:k==="high"?3:k==="medium"?2:1,A=M(x(u)),I=M(x(f));return A!==I?I-A:f.timestamp-u.timestamp}),ze=c;let p=u=>{let f=u.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return"low"}return(f.priority||"low").toLowerCase()},y=[],v=new Set(c.map(u=>p(u))).size>1;if(c.length>0){let u=null;c.forEach(f=>{let x=p(f);v&&x!==u&&(y.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),u=x),y.push(f)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=N("empty","No alerts yet."),Be();return}let o=u=>{let f=u.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return null}let x=(f.title||"Untitled Alert").trim(),M=(f.body||"No description provided.").trim(),A=f.summary||"",I=f.content||"",k=f.protocol||"",E=(f.priority||"low").toLowerCase(),D=!!f.alert,j=(f.category||"system").trim(),O=f.related_event_ids||[],q=f.audit_event_id,J=!!localStorage.getItem(`alert_read_ts_${u.id}`),T=new Date(u.timestamp*1e3),C=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),h=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=J?"event-border-grey":"event-border-blue";!J&&D&&(S="event-border-red"),J&&(E==="high"||E==="critical")?S="event-border-red":J&&E==="medium"&&(S="event-border-orange");let L=J?"alert-read":"alert-unread",_=pe.has(u.id),R=_?"expanded":"",V=_?"display: block;":"display: none;",U="",F="";O.length>0&&(F=`
        ...
        `,U=`
                ...
                ${ee}
            `;let Y=document.createElement("div");Y.className=`event-item notification-item ${S} ${L} ${R} cursor-pointer priority-${E}`,Y.dataset.alertId=u.id,Y.onclick=function(ae){let Z=this;if(Z.classList.contains("expanded")){Z.classList.remove("expanded"),pe.delete(u.id);let Te=Z.querySelector(".event-details");Te&&(Te.style.display="none")}else{Z.classList.add("expanded"),pe.add(u.id);let Te=Z.querySelector(".event-details");if(Te&&(Te.style.display="block"),!localStorage.getItem(`alert_read_ts_${u.id}`)){localStorage.setItem(`alert_read_ts_${u.id}`,Date.now().toString()),Z.classList.add("alert-read"),Z.classList.remove("alert-unread"),Z.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ue="event-border-grey";E==="high"||E==="critical"?Ue="event-border-red":E==="medium"&&(Ue="event-border-orange"),Z.classList.add(Ue),Be()}}};let st=`${k?k.toUpperCase():"GUARDIAN"} ALERT: ${A||x}`,is={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[j]||"bx-bell",as=E==="high"||E==="critical"?"#ff4d4d":E==="medium"?"#ffa500":"#888";Y.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${C}</span>
                    <span class="event-date">${h}</span>
                </div>
                <div class="event-icon"><i class='bx ${is}'></i></div>
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${as}; font-size: 0.8em; margin-left: 5px;">[${E.toUpperCase()}]</span>
                    </div>
                    <div class="event-message">${de(st)}</div>
                    <div class="event-details" style="${V}">
                        ${U}
                    </div>
                </div>
            `;let nt=Y.querySelector(".event-details");nt&&nt.addEventListener("click",ae=>{ae.stopPropagation()});let it=Y.querySelector(".close-details-btn");return it&&it.addEventListener("click",ae=>{ae.stopPropagation(),Y.classList.remove("expanded");let Z=Y.querySelector(".event-details");Z&&(Z.style.display="none"),pe.delete(u.id)}),Y},b=u=>{let f=document.createElement("div");f.className="notification-divider",f.dataset.alertId=u.id;let x="#888888";return u.label==="CRITICAL"?x="#ff4d4d":u.label==="HIGH"?x="#ff8888":u.label==="MEDIUM"&&(x="#ffa500"),f.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${x}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,f.innerHTML=`<span style="white-space: nowrap;">${u.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${x}44, transparent); flex-grow: 1;"></div>`,f},$=Array.from(e.children),w=new Map($.map(u=>[u.dataset.alertId,u])),a=new Set(y.map(u=>u.id));$.forEach(u=>{let f=u.dataset.alertId;(!f||!a.has(f))&&u.remove()});let d=null;y.forEach((u,f)=>{let x=w.get(u.id);if(!x||t){if(x&&x.remove(),u.type==="divider")x=b(u);else{let M=o(u);if(!M)return;x=M}if(!x)return}f===0?e.firstElementChild!==x&&e.prepend(x):d&&d.nextElementSibling!==x&&d.after(x),d=x}),De=Date.now(),Q(0,De),Be()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load alerts.","The event service may be offline."))}}function ys(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),s=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ze.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),oe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ze.forEach(n=>{pe.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),oe(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{pe.clear(),oe(!0)},s.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;ze.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,n.toString())}),pe.clear(),oe(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function Je(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await B(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||n++}),ft(n)}catch{}}var ht=()=>`
...
`,me=new Set,Ne=[],Ee=null;async function ue(t=!1){let e=document.getElementById("roadmap-list");if(e){xs();try{let s=await B("/roadmap");if(!s.ok)throw new Error("Offline");let i=await s.json();Ne=i;let n=p=>{let y=me.has(p.id),m=p.state==="published",v=p.state==="consumed",o="event-border-grey";m&&(o="event-border-blue"),v&&(o="event-border-purple");let $=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),w=document.createElement("div");w.className=`event-item notification-item ${o} cursor-pointer ${y?"expanded":""}`,w.dataset.itemId=p.id,w.onclick=u=>{if(u.target.closest("button"))return;if(w.classList.contains("expanded")){w.classList.remove("expanded");let x=w.querySelector(".event-details");x&&(x.style.display="none"),me.delete(p.id)}else{w.classList.add("expanded");let x=w.querySelector(".event-details");x&&(x.style.display="block"),me.add(p.id)}};let a=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;w.innerHTML=`
      ...
      `;let d=w.querySelector(".event-details");return d&&d.addEventListener("click",u=>{u.stopPropagation()}),w.querySelector(".edit-btn")?.addEventListener("click",()=>hs(p)),w.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ws(p)),w.querySelector(".delete-btn")?.addEventListener("click",()=>Cs(p.id)),w.querySelector(".close-details-btn")?.addEventListener("click",u=>{u.stopPropagation(),w.classList.remove("expanded");let f=w.querySelector(".event-details");f&&(f.style.display="none"),me.delete(p.id)}),w},l=Array.from(e.children),r=new Map(l.map(p=>[p.dataset.itemId,p])),g=new Set(i.map(p=>p.id));if(l.forEach(p=>{let y=p.dataset.itemId;(!y||!g.has(y))&&p.remove()}),!Ne||Ne.length===0){e.innerHTML=N("empty","Your roadmap is empty.",H()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;i.forEach((p,y)=>{let m=r.get(p.id);(!m||t)&&(m&&m.remove(),m=n(p),!m)||(y===0?e.firstElementChild!==m&&e.prepend(m):c&&c.nextElementSibling!==m&&c.after(m),c=m)})}catch{e.children.length===0&&(e.innerHTML=N("offline","Failed to load roadmap.","The event service may be offline."))}}}function xs(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),s=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ee=null;let l=document.getElementById("roadmap-editor-input");l&&(l.value="");let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="block")},t.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="none"),Ee=null},s.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input"),r=l?l.value:"";if(!r.trim())return;let g=Ee?`/roadmap/${Ee}`:"/roadmap",c=Ee?"PATCH":"POST";try{await B(g,{method:c,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})});let p=document.getElementById("roadmap-editor-container");p&&(p.style.display="none"),ue(!0)}catch(p){console.error(p)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{Ne.forEach(l=>me.add(l.id)),ue(!0)},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{me.clear(),ue(!0)},n.dataset.listenerAttached="true")}function hs(t){Ee=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let s=document.getElementById("roadmap-editor-container");s&&(s.style.display="block",s.scrollIntoView({behavior:"smooth"}))}async function ws(t){let e=t.state==="published"?"draft":"published";try{await B(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ue(!0)}catch(s){console.error(s)}}async function Cs(t){if(confirm("Delete this roadmap item?"))try{await B(`/roadmap/${t}`,{method:"DELETE"}),me.delete(t),ue(!0)}catch(e){console.error(e)}}var Et=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,Ct=null,fe=new Set,St=[];async function ge(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Es();let s="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await B(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];if(St=l,Ct=Date.now(),Q(2,Ct),l.length===0){e.innerHTML=N("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),ke(2,0);return}t&&(e.innerHTML="");let r=m=>{let v=m.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let o=(v.title||"Untitled Blueprint").trim(),b=(v.summary||v.body||"No summary provided.").trim(),$=(v.content||"").trim(),w=(v.category||"architecture").trim(),a=(v.related_services||v.affected_services||[]).map(_=>_.trim()),d=(v.implementation_path||[]).map(_=>_.trim()),u=v.source_event_ids||[],f=v.approved===!0,x=new Date(m.timestamp*1e3),M=x.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=x.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),I=fe.has(m.id),k=I?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${I?"expanded":""} ${f?"blueprint-approved":""}`,E.dataset.blueprintId=m.id,f&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let j=f?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[w]||"bx-paint";E.onclick=function(_){let R=this;if(R.classList.contains("expanded")){R.classList.remove("expanded"),fe.delete(m.id);let U=R.querySelector(".event-details");U&&(U.style.display="none")}else{R.classList.add("expanded"),fe.add(m.id);let U=R.querySelector(".event-details");U&&(U.style.display="block")}};let O="";d.length>0&&(O=`
            ...
            `;let C=E.querySelector(".blueprint-approve-btn");C&&(C.onclick=async _=>{_.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await B(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ge(!0)}catch(R){console.error("Failed to approve blueprint:",R)}});let h=E.querySelector(".blueprint-delete-btn");h&&(h.onclick=async _=>{_.stopPropagation();let R=!f;h.innerHTML=R?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await B(`/events/${m.id}`,{method:"DELETE"})).ok&&ge(!0)}catch(V){console.error("Failed to delete blueprint:",V)}});let S=E.querySelector(".event-details");S&&S.addEventListener("click",_=>{_.stopPropagation()});let L=E.querySelector(".close-details-btn");return L&&L.addEventListener("click",_=>{_.stopPropagation(),E.classList.remove("expanded");let R=E.querySelector(".event-details");R&&(R.style.display="none"),fe.delete(m.id)}),E},g=Array.from(e.children),c=new Map(g.map(m=>[m.dataset.blueprintId,m])),p=new Set(l.map(m=>m.id));g.forEach(m=>{let v=m.dataset.blueprintId;(!v||!p.has(v))&&m.remove()});let y=null;l.forEach((m,v)=>{let o=c.get(m.id);if(!o||t){o&&o.remove();let b=r(m);if(!b)return;o=b}v===0?e.firstElementChild!==o&&e.prepend(o):y&&y.nextElementSibling!==o&&y.after(o),y=o}),ke(2,l.length),bt()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load blueprints.","The event service may be offline."))}}async function Tt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await B(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&n++}),gt(n)}catch{}}function Es(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),s=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{St.forEach(i=>fe.add(i.id)),ge(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{fe.clear(),ge(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.blueprint.generated",{method:"DELETE"}),fe.clear(),ge(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var ve="STANDBY",We=[],be=null,Re=null,kt=()=>`
    <div id="progress-view-root" class="progress-container">
        ${Lt()}
    </div>
  `;function Lt(){switch(ve){case"ACTIVE":return Ss();case"COMPLETED":return Ts();case"STANDBY":default:return $s()}}function $s(){return`
    ...
    <div class="active-task-card">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            <div>
                ...
                <h2 style="margin: 5px 0 0 0; font-size: 1.2em;">${be?.title||"Processing Objective..."}</h2>
            </div>
        ...
        <div class="task-progress-bar">
            <div class="task-progress-fill" style="width: ${be?.progress||0}%"></div>
        </div>
        <div style="margin-top: 8px; display: flex; justify-content: space-between; font-size: 0.75em; font-family: 'JetBrains Mono'; color: #666;">
            ...
            <span>${be?.progress||0}% COMPLETE</span>
        </div>
    </div>
    ...
    <div class="mission-summary-card">
        ...
        <div style="margin-top: 25px; padding: 15px; background: rgba(255,255,255,0.03); border-radius: 8px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-family: 'JetBrains Mono'; font-size: 0.85em; color: #bb86fc;">${Re?.result||"Blueprint: Event-Bus-Refactor"}</span>
  ...
  `}async function $e(){let t=document.getElementById("progress-view-root");if(t&&(t.innerHTML=Lt(),ve==="ACTIVE")){let e=document.getElementById("terminal-output");e&&(e.scrollTop=e.scrollHeight)}}window.addEventListener("dex-mock-start",()=>{ve="ACTIVE",We=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."},{time:new Date().toLocaleTimeString(),msg:"Fetching mission parameters from Roadmap..."}],be={title:"Refactoring System Event Bus",progress:15},$e();let t=0,e=setInterval(()=>{if(ve!=="ACTIVE"){clearInterval(e);return}t++,be.progress=Math.min(100,be.progress+Math.floor(Math.random()*10));let s=["Analyzing file: internal/bus.go","Identified 3 performance bottlenecks.","Synthesizing optimization logic...","Applying transformations to service layer.","Running validation tests...","Verifying data integrity.","Cleaning up temporary artifacts."];t<s.length&&We.push({time:new Date().toLocaleTimeString(),msg:s[t]}),be.progress>=100&&(ve="COMPLETED",Re={duration:"1m 15s",steps:24,result:"Optimized Event Bus Logic"},clearInterval(e)),$e()},2e3)});window.addEventListener("dex-mock-stop",()=>{ve="STANDBY",$e()});window.addEventListener("dex-mock-reset",()=>{ve="STANDBY",$e()});var Mt=()=>`
...
`;async function Ge(){await Promise.all([ue(),ge(),$e()])}var Bt=()=>`
    ...
    `;async function Se(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),s=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),n=document.getElementById("cancel-chore-btn");if(e&&!e.dataset.listenerAttached&&(e.onclick=()=>{s&&(s.style.display=s.style.display==="none"?"block":"none")},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{s&&(s.style.display="none")},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let l=document.getElementById("new-chore-instruction"),r=document.getElementById("new-chore-url"),g=document.getElementById("new-chore-owner"),c=l?.value,p=r?.value,y=g?.value||"313071000877137920";if(c){i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:y,natural_instruction:c,entry_url:p,schedule:"every_6h"})}),s&&(s.style.display="none"),l&&(l.value=""),r&&(r.value=""),Se()}catch(m){console.error(m),alert("Failed to create chore")}finally{i.innerHTML="Create Task"}}},i.dataset.listenerAttached="true"),!!t)try{let l=await B("/chores");if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);let r=await l.json();if(!Array.isArray(r)||r.length===0){t.innerHTML=N("empty","No active chores.","Create one to start monitoring.");return}let g=r.map(c=>{let p=c.last_run===0?"Never":new Date(c.last_run*1e3).toLocaleString(),y=c.memory?c.memory.length:0,m=c.status==="active"?"#03dac6":"#666";return`
            ...
            `}).join("");t.innerHTML=g,t.querySelectorAll(".delete-chore-btn").forEach(c=>{c.onclick=async p=>{p.stopPropagation();let y=c.dataset.id;confirm("Delete this chore?")&&(await B(`/chores/${y}`,{method:"DELETE"}),Se())}})}catch(l){console.error("Failed to fetch chores",l)}}var ks=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`,Ls=null;async function Ke(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Ke(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=s=>{let n=s.target.closest(".user-profile-card");if(n&&n.dataset.user)try{let l=JSON.parse(n.dataset.user);Ht(l)}catch(l){console.error("Failed to parse user data",l)}},t.dataset.listenerAttached="true");try{let s=await He("/contacts");if(!s.ok)throw new Error("Service unreachable");let n=(await s.json()).members||[];if(Ls=Date.now(),n.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((r,g)=>{let c=l[r.level]??10,p=l[g.level]??10;return c!==p?c-p:r.username.localeCompare(g.username)}),t.innerHTML=n.map(r=>{let g=r.color&&r.color!==0,c=g?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",p=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",y="#888";r.level==="Me"||r.level==="Master"?y="#bb86fc":r.level==="Admin"?y="#cf6679":r.level==="Moderator"?y="#03dac6":r.level==="Contributor"&&(y="#ffa500");let m=r.level==="Me",v=m?"rgba(187, 134, 252, 0.08)":g?`${c}11`:"rgba(255,255,255,0.03)",o=m?"2px solid #bb86fc":g?`1px solid ${c}66`:"1px solid rgba(255,255,255,0.1)";return`
...
`,Pe=null,ye=new Set,Le=[],K="all",As={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Is={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Bs(t){for(let[e,s]of Object.entries(As))if(s.includes(t))return e;return"system"}function _s(t){return Is[t]||"bx-square-rounded"}async function re(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Hs();let i=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(i+=`&category=${K}`);try{let n=await B(i);if(!n.ok)throw new Error("Service unreachable");if(Le=((await n.json()).events||[]).filter(v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return!0}let b=o.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),Pe=Date.now(),Q(1,Pe),Le.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let g=v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return null}let b=o.type,$=Bs(b),w=_s(b),a=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),d="event-border-grey";a&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?d="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?d="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?d="event-border-orange":b==="system.test.completed"?d=o.test?.status==="OK"&&o.lint?.status==="OK"&&o.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let u=a?"cursor-pointer":"",f=ye.has(v.id),x=f?"expanded":"",M=f?"display: block;":"display: none;",A=new Date(v.timestamp*1e3),I=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),k=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=zt(b,o),D=o.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${o.user_level})</span>`:"",j="";if(a){let T="";if(b==="engagement.decision"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;T=`
                    ...
                    `}else if(b==="messaging.bot.sent_message"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,h="";o.eval_count&&(h=`
                        ...
                        `);let S="";if(o.chat_history&&o.chat_history.length>0){let L=o.chat_history.length,_=o.chat_history.map((R,V)=>{let U=R.name?R.name.toUpperCase():R.role.toUpperCase();!R.name&&U==="ASSISTANT"&&(U="DEXTER");let F=R.role==="user"?"#03dac6":R.role==="system"?"#ffb74d":"#bb86fc",W=V===L-1?"block":"none";return`
                    ...
                    `}else if(b==="system.analysis.audit"){let C=o.success?"#03dac6":"#ff4d4d",h=o.success?"SUCCESS":"FAILED",S=U=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${U}</h5>`,L="";o.error&&(L=`
                            <div class="event-detail-block">
                                ${S("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${z(o.error)}</pre>
                            </div>
                        `);let _="";if(o.chat_history&&o.chat_history.length>0){let U=o.chat_history.length,F=o.chat_history.map((W,ie)=>{let ee=W.name?W.name.toUpperCase():W.role.toUpperCase();!W.name&&ee==="USER"&&(ee="SYSTEM"),!W.name&&ee==="ASSISTANT"&&(ee="AGENT");let Y=W.role==="user"?"#03dac6":W.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ie}" style="display: ${ie===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${ie+1} of ${U}</span>
                                    </div>
                        ...
                        `}let R="";if(o.corrections&&o.corrections.length>0){let U=o.corrections.map((F,W)=>`
                        ...
                        `}let V="";if(o.parsed_results&&o.parsed_results.length>0){let U=o.parsed_results.map(F=>`
                ...
                `}let O=document.createElement("div");O.className=`event-item ${d} ${u} ${x}`,O.dataset.eventId=v.id,O.onclick=function(T){if(!a)return;let C=this;if(C.classList.contains("expanded")){C.classList.remove("expanded"),ye.delete(v.id);let S=C.querySelector(".event-details");S&&(S.style.display="none")}else{C.classList.add("expanded"),ye.add(v.id);let S=C.querySelector(".event-details");S&&(S.style.display="block")}},O.innerHTML=`
                <div class="event-time">
            ...
            `;let q=O.querySelector(".event-details");if(q&&q.addEventListener("click",T=>{T.stopPropagation()}),a){let T=O.querySelector(".close-details-btn");T&&T.addEventListener("click",C=>{C.stopPropagation();let h=C.target.closest(".event-item");if(h){h.classList.remove("expanded"),ye.delete(v.id);let S=h.querySelector(".event-details");S&&(S.style.display="none")}})}let G=O.querySelector(".prev-btn"),J=O.querySelector(".next-btn");if(G&&J){let T=0,C=Array.from(O.querySelectorAll(".history-slide")),h=C.length,S=()=>{C.forEach((L,_)=>{L.style.display=_===T?"block":"none"}),G.disabled=T===0,J.disabled=T===h-1,G.style.opacity=T===0?"0.5":"1",J.style.opacity=T===h-1?"0.5":"1"};G.addEventListener("click",L=>{L.stopPropagation(),T>0&&(T--,S())}),J.addEventListener("click",L=>{L.stopPropagation(),T<h-1&&(T++,S())}),S()}return O},c=Array.from(e.children),p=new Map(c.map(v=>[v.dataset.eventId,v])),y=new Set(Le.map(v=>v.id));c.forEach(v=>{let o=v.dataset.eventId;(!o||!y.has(o))&&v.remove()});let m=null;Le.forEach((v,o)=>{let b=p.get(v.id);(!b||t)&&(b&&b.remove(),b=g(v),!b)||(o===0?e.firstElementChild!==b&&e.prepend(b):m&&m.nextElementSibling!==b&&m.after(b),m=b)}),Pe=Date.now(),Q(1,Pe)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=N("offline","Failed to load events.","The event service may be offline."))}}function Hs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),s=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Le.forEach(n=>ye.add(n.id)),re(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ye.clear(),re(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{s.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),n.classList.add("active"),K=n.dataset.filter||"all",re(!0)}}),s.dataset.listenerAttached="true"),s&&s.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===K?n.classList.add("active"):n.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let n=K==="all"?"ALL":K.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(K!=="all"?l+=`?category=${K}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await B(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ye.clear(),re(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var Ds=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`);return`
        ...
        <div id="services-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,Jt=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Rt()}
        </div>`;async function Vt(){Ns(),await Promise.all([le(),Xe(),Qe(),Se()]),await Me()}var Oe=null;function Ns(){Oe||(Oe=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Oe),Oe=null;return}le(!0)},1e3))}var Pt=null,Ot=null;async function Kt(){try{return await(await B("/system_monitor")).json()}catch{return null}}async function jt(){try{return await(await B("/system/hardware")).json()}catch{return null}}async function Rs(){try{return await(await B("/processes")).json()}catch{return null}}async function Ps(){try{return await(await B("/agent/status")).json()}catch{return null}}async function Xe(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),s=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),g=a=>{if(a){if(s&&(s.innerHTML=`
            ...
            </div>`}let d=a.status==="online",u=d?"service-widget-online":"service-widget-offline",f=d?"bx-check-circle":"bx-x-circle",x=d?"OK":"BAD",M=a.version?y(a.version.str):"-",A=a.cpu&&a.cpu!=="N/A"?a.cpu:"-",I=a.memory&&a.memory!=="N/A"?a.memory:"-",k=A!=="-"?"#00ff00":"#666",E=A!=="-"?"#fff":"#666",D=I!=="-"?"#00ff00":"#666",j=I!=="-"?"#fff":"#666",O=v(a.uptime),q="";d?q=`
                <div class="service-widget-info">
    ...
    `;async function Xt(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Zt(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await Zt(t)}async function Zt(t){try{let e=await B("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let s=await e.json();if(!s||s.length===0){t.innerHTML=N("empty","No web history found.");return}let i=`
            <div style="display: flex; flex-direction: column; height: 100%;">
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Os=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[s,i]of Object.entries(t)){let n=ts.filter(l=>l.category===s);n.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let c=document.getElementById("close-terminal-btn");c&&(c.onclick=()=>Qt());let p=document.getElementById("terminal-action-btn");p&&(p.onclick=()=>Qt())}let s=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");s&&(s.innerHTML="");let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let l=document.getElementById("terminal-cmd-name");l&&(l.textContent=`dex ${t.id}`);let r=document.getElementById("terminal-status-badge");r&&(r.className="terminal-status status-running",r.textContent="Running");let g=document.getElementById("terminal-action-btn");return g&&(g.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",tt=!0,s}function Qt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",tt=!1}function es(t,e,s="output"){if(!tt||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${s}`,s==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let n=_e(e);i.innerHTML=n||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Us(t){let e=ts.find(r=>r.id===t);if(!e)return;let s=js(e);s&&es(s,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let r of i){await new Promise(c=>setTimeout(c,400+Math.random()*600));let g="output";r.includes("[ERROR]")?g="error":r.includes("[SUCCESS]")||r.includes("\u2713")?g="success":r.includes("!")&&(g="warning"),s&&es(s,r,g)}let n=document.getElementById("terminal-status-badge");n&&(n.className="terminal-status status-success",n.textContent="Completed (Demo)");let l=document.getElementById("terminal-action-btn");l&&(l.style.display="block")}function ss(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Os();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let s=e.querySelector("code"),i=s?s.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let n=e.querySelector("i");n&&(n.className="bx bx-check",n.style.color="#5eff5e",setTimeout(()=>{n.className="bx bx-copy",n.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(s=>{let i=s;s.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),s.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),s.addEventListener("click",()=>{let n=i.dataset.cmd;n&&Us(n)})})}async function qs(){if(!H())try{if(!(await B("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ns(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}ot(),rt(),qs(),mt(),at();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ss();let e=[],s=document.getElementById("windows-container");s&&s.setAttribute("data-count","0");let i=a=>{localStorage.setItem("dex_last_window",a)};function n(){for(;e.length>1;)e.shift().close(!0);let a=document.getElementById("windows-container"),d=document.querySelector("nav"),u=document.querySelector("footer"),f=window.location.pathname==="/"||window.location.pathname==="/index.html",x=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");a&&a.setAttribute("data-count",e.length.toString()),e.forEach(D=>{let j=document.getElementById(D.id);j&&j.classList.remove("hide-close")});let M=document.getElementById("dexter-menu-container"),A=document.getElementById("nav-window-switcher"),I=document.getElementById("settings-icon"),k=document.getElementById("close-all-windows"),E=window.innerWidth<880;if(!E){let D=document.getElementById("dexter-dropdown"),j=document.getElementById("dexter-menu-btn");D&&D.classList.remove("active"),j&&j.classList.remove("active"),a&&a.classList.remove("menu-open")}if(xe(e.length>0),e.length>0)if(u?.classList.add("hide"),k&&(k.style.display=E?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",d?.classList.add("window-open"),a&&(a.style.paddingTop="60px"),M&&(M.style.display=E?"flex":"none"),I&&(I.style.display=E?"block":"none"),!E&&A){let D=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(D)?(A.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),l(g)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),l(c)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),l(y)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),l(p)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),l(m)})):A.innerHTML=""}else A&&(A.innerHTML="");else d?.classList.remove("window-open"),k&&(k.style.display="none"),a&&(a.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",f||x?u?.classList.remove("hide"):u?.classList.add("hide"),M&&(M.style.display="flex"),I&&(I.style.display="block"),A&&(A.innerHTML="");Ce()}function l(a){if(a.isOpen()){a.close();return}for(;e.length>0;)e.pop().close(!0);e.push(a),a.open(),n()}function r(){[...e].forEach(d=>d.close()),e=[]}window.addEventListener("resize",n);let g=ce({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:xt(),onOpen:()=>oe(),onClose:()=>{let a=e.indexOf(g);a>-1&&e.splice(a,1),n()}}),c=ce({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Ze(),onOpen:()=>{c.setContent(Ze()),re()},onClose:()=>{let a=e.indexOf(c);a>-1&&e.splice(a,1),n()}}),p=ce({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Dt(),onOpen:()=>Ke(),onClose:()=>{let a=e.indexOf(p);a>-1&&e.splice(a,1),n()}}),y=ce({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Ft()},{icon:"bxs-component",title:"Processes",content:qt()},{icon:"bxs-brain",title:"Models",content:Jt()},{icon:"bx-globe",title:"Web",content:Yt()},{icon:"bxs-hdd",title:"Hardware",content:Wt()},{icon:"bxs-terminal",title:"Logs",content:Gt()},{icon:"bxs-zap",title:"Agents",content:Ut()},{icon:"bx-task",title:"Chores",content:Bt()}].filter(a=>H()?a.title!=="Hardware"&&a.title!=="Logs":!0),onOpen:()=>{Xe(),le(),Qe(),Xt(),Me(),Se()},onClose:()=>{let a=e.indexOf(y);a>-1&&e.splice(a,1),n()}}),m=ce({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Mt()},{icon:"bx-map-alt",title:"Roadmap",content:At()},{icon:"bx-paint",title:"Blueprints",content:It()}],onOpen:()=>Ge(),onClose:()=>{let a=e.indexOf(m);a>-1&&e.splice(a,1),n()}}),v=ce({id:"settings-window",title:"Settings",icon:"bx-cog",content:je(),onOpen:()=>{v.setContent(je()),et(v)},onClose:()=>{let a=e.indexOf(v);a>-1&&e.splice(a,1),n()}});window.dexter={viewEvent:a=>{c.isOpen()||l(c),setTimeout(()=>{let d=document.querySelector(`.event-item[data-event-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)},viewAlert:a=>{g.isOpen()||l(g),setTimeout(()=>{let d=document.querySelector(`.event-item[data-alert-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)}};let o=()=>{let a=document.getElementById("dexter-dropdown"),d=document.getElementById("dexter-menu-btn");a&&d&&(a.classList.remove("active"),d.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let a=document.getElementById("dexter-menu-btn"),d=document.getElementById("settings-icon"),u=document.getElementById("close-all-windows"),f=document.getElementById("nav-left-container"),x=document.getElementById("dexter-dropdown"),M=document.getElementById("windows-container");a&&x&&(a.onclick=I=>{I.stopPropagation();let k=window.innerWidth<880;if(k)x.style.top="",x.style.left="",x.style.right="",x.style.transform="";else{let D=a.getBoundingClientRect(),O=document.querySelector("nav").getBoundingClientRect(),q=220,G=10,T=D.left+D.width/2-q/2,C=O.right-10;T+q>C&&(T=C-q),T<10&&(T=10),x.style.top=O.bottom+G+"px",x.style.left=T+"px",x.style.right="auto",x.style.transform="none"}x.classList.toggle("active"),a.classList.toggle("active");let E=x.classList.contains("active");if(k){let D=document.querySelector("nav");E?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),D?.classList.add("window-open"),M?.classList.add("menu-open"),xe(!0)):(M?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),D?.classList.remove("window-open"),xe(!1)))}}),d&&(d.onclick=I=>{I.stopPropagation(),l(v)}),u&&(u.onclick=I=>{I.stopPropagation(),r()});let A=(I,k,E)=>{let D=document.getElementById(I);D&&(D.onclick=j=>{j.stopPropagation(),o(),E&&i(E),l(k)})};A("alerts-menu-item",g,"alerts-window"),A("events-menu-item",c,"events-window"),A("monitor-menu-item",y,"monitor-window"),A("contacts-menu-item",p,"contacts-window"),A("workspace-menu-item",m,"workspace-window"),f&&(f.onclick=I=>{if(I.stopPropagation(),x&&x.classList.contains("active")){o(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1));return}if(e.length>0)r();else{let k=window.location.pathname;if(!(k==="/"||k==="/index.html")){let j=(k.endsWith("/")&&k.length>1?k.slice(0,-1):k).split("/");j.pop();let O=j.join("/")||"/";window.location.href=O}}}),document.addEventListener("click",()=>{let I=window.innerWidth<880;x&&x.classList.contains("active")&&(o(),I&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1)))}),x&&(x.onclick=I=>I.stopPropagation())})();let $=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!$&&!w&&document.querySelector("footer")?.classList.add("hide"),H()||setInterval(()=>{c.isOpen()&&re(),g.isOpen()?oe():Je()},1e3),setInterval(()=>{H()&&(g.isOpen()?oe():Je()),m.isOpen()?Ge():Tt(),H()&&c.isOpen()&&re(),y.isOpen()&&Vt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ns):ns();})();
