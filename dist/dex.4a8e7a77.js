"use strict";(()=>{function dt(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.prepend(t)}}function pt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",i=`
    ...
    `,l=document.createElement("nav");l.innerHTML=i,document.body.prepend(l);let o=document.createElement("div");o.id="dexter-dropdown",o.className="dexter-dropdown",o.innerHTML=`
    ...
    `,document.body.appendChild(o)}function Te(t){let e=window.location.pathname,n=e==="/"||e==="/index.html",a=document.getElementById("nav-chevron"),i=document.querySelector(".nav-left");!a||!i||(t||!n?(a.style.display="block",i.style.cursor="pointer",i.classList.add("recording"),i.onmouseenter=()=>{a.style.transform="translateX(-3px)"},i.onmouseleave=()=>{a.style.transform="translateX(0)"}):(a.style.display="none",i.style.cursor="default",i.classList.remove("recording"),i.onmouseenter=null,i.onmouseleave=null))}function mt(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var ut=1e3;function me(t){let e=null,n=t.onClose||null,a=t.onOpen||null;function i(){e&&(e.style.zIndex=(++ut).toString())}function l(){if(e){e.classList.add("open"),i(),window.addEventListener("resize",o),a&&setTimeout(a,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++ut).toString(),e.addEventListener("mousedown",i);let v=t.icon||"bx-window",s="",u="",C,A='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((x,y)=>{let c=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${C}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",f=>{f.stopPropagation(),d()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach(f=>{f.addEventListener("click",()=>{if(!e)return;let p=f.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(y=>y.classList.remove("active")),f.classList.add("active"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.remove("active"));let x=e.querySelector(`.tab-content[data-tab-content="${p}"]`);x&&x.classList.add("active"),b(f,e)})}),setTimeout(()=>{e&&e.classList.add("open"),a&&a()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&b(m,e)}function b(m,v){setTimeout(()=>{let s=v.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),C=u.indexOf(m),A=s.clientWidth,f=u[Math.max(0,C-2)],p=u[Math.min(u.length-1,C+2)],x=s,y=f.offsetLeft-x.offsetLeft-25,r=p.offsetLeft+p.offsetWidth-x.offsetLeft+25-y,w=r<=A?y-(A-r)/2:m.offsetLeft-x.offsetLeft-A/2+m.offsetWidth/2;s.scrollTo({left:w,behavior:"smooth"})},350)}function d(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),n&&n(),setTimeout(()=>{e?.remove(),e=null},400)))}function h(m){t.content=m;let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function T(){return!!(e&&e.classList.contains("open"))}return{open:l,close:d,setContent:h,isOpen:T,focus:i,id:t.id}}var gt="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ze(){return localStorage.getItem(gt)||ee.DARK}function ft(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(gt,t),bt(t)}function bt(t){let e=document.body;Object.values(ee).forEach(l=>{e.classList.remove(`theme-${l}`)}),e.classList.add(`theme-${t}`);let n=document.querySelector('meta[name="theme-color"]');n||(n=document.createElement("meta"),n.name="theme-color",document.getElementsByTagName("head")[0].appendChild(n));let a={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},i=a[t]||a[ee.DARK];if(n.setAttribute("content",i),!document.querySelector(".background")){let l=document.createElement("div");l.className="background",document.body.prepend(l)}e.classList.add("is-animated")}function vt(){let t=Ze();bt(t)}function J(t,e,n=null,a="default"){let l={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=n?`<p class="placeholder-action">${n}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${a}"><i class='bx ${l} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function j(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!n)return;if(!e){n.textContent="Last updated: never";return}let a=Date.now(),i=Math.floor((a-e)/1e3),l;i<60?l=`${i}s ago`:i<3600?l=`${Math.floor(i/60)}m ago`:l=`${Math.floor(i/3600)}h ago`,n.textContent=`Last updated: ${l}`}var us=0;function Pe(t,e){let n=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!n)return;let a=n.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e.toString(),a.style.display="flex"):a.style.display="none")}var ie=0,ae=0;function xt(t){ie=t,ke()}function ht(t){ae=t,ke()}function ke(){let t=ie+ae;us=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let n=document.getElementById("alerts-menu-item");if(n){let o=n.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",n.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",a.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}let i=document.getElementById("switch-alerts");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",i.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let o=l.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",l.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}}function Xe(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ke()}function wt(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ke()}function gs(){return"https://event.easter.company"}function fs(){return"https://discord.easter.company"}var bs="http://127.0.0.1:8100",vs="http://127.0.0.1:8300",ys={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Oe(t){let e=j(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(i,l)=>{let o=ys[l];return o?`<span class="${o}">`:""});let n=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return n>a&&(e+="</span>".repeat(n-a)),e}function re(t){if(!t)return"";let e=j(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(n,a)=>{let i=a.split("|").map(l=>l.trim());return i.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${i.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var xs="https://sterling-javelin-12539.upstash.io",hs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function R(){return window.location.hostname.includes("easter.company")}var F=null,oe={lastDashboard:0,lastFrontend:0},Ye=!1,Ct=0,Et="dex_dashboard_snapshot";function ws(){let t=localStorage.getItem(Et);if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{F=null}}async function yt(){if(!(!R()||Ye)){Ye=!0,Ct=Math.floor(Date.now()/1e3);try{let t=await Ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Et,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ye=!1}}}function Cs(){if(!F||!F.agent_status)return;let t=F.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Es(){if(!R())return;ws();let t=Math.floor(Date.now()/1e3),e=F?t-F.timestamp:1/0;(!F||e>120)&&await yt(),setInterval(()=>{let n=new Date,a=Math.floor(Date.now()/1e3),i=F?a-F.timestamp:1/0,l=a-Ct,o=n.getSeconds()===59,b=i>300,d=l>60;(o&&d||b&&d)&&yt(),Cs()},1e3)}R()&&Es();async function Ts(t,...e){try{let a=await(await fetch(xs,{method:"POST",headers:{Authorization:`Bearer ${hs}`},body:JSON.stringify([t,...e])})).json();if(a.error)throw new Error(a.error);return a.result}catch(n){return console.error("Upstash Error:",n),null}}var $e=null,Se=null,Ne=!1,Re=!1;async function _(t,e={}){if(R()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(F.monitor),{status:200});if(t.startsWith("/system/options"))return new Response(JSON.stringify(F.options||{}),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(F.processes),{status:200});if(t.startsWith("/events")){let i=new URLSearchParams(t.split("?")[1]||""),l=i.get("type")||i.get("event.type"),o=i.get("category"),b=i.get("order")||"desc",d=[];return l==="system.notification.generated"?d=[...F.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...F.blueprints||[]]:o==="messaging"?d=[...F.messaging_events||[]]:o==="system"?d=[...F.system_events||[]]:o==="cognitive"?d=[...F.cognitive_events||[]]:o==="moderation"?d=[...F.moderation_events||[]]:d=[...F.events||[]],b==="asc"?d.sort((h,T)=>h.timestamp-T.timestamp):d.sort((h,T)=>T.timestamp-h.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(F.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let i=t.split("/")[2],l=F.profiles?F.profiles[i]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(F.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(F.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if($e)try{let i=await fetch($e+t,e);if(i.ok)return i;$e=null}catch{$e=null}let n=gs(),a=bs;try{let i=await fetch(n+t,e);if(i.ok)return $e=n,Ne&&(console.log("\u2728 Production event service restored."),Ne=!1),i;throw new Error("Primary failed")}catch{Ne||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),Ne=!0);try{let l=await fetch(a+t,e);if(l.ok)return $e=a,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function ue(t,e={}){if(R()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(F.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let i=t.split("/")[2],l=(F.contacts?.members||[]).find(o=>o.id===i);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(Se)try{let i=await fetch(Se+t,e);if(i.ok)return i;Se=null}catch{Se=null}let n=fs(),a=vs;try{let i=await fetch(n+t,e);if(i.ok)return Se=n,Re&&(console.log("\u2728 Production discord service restored."),Re=!1),i;throw new Error("Primary failed")}catch{Re||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),Re=!0);try{let l=await fetch(a+t,e);if(l.ok)return Se=a,l;throw new Error("Fallback failed")}catch(l){throw l}}}var Tt=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="alerts-clear" class="notif-action-btn danger" style="${R()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
        </div>
    </div>
...
`,je=null,ge=new Set,Ue=[];async function de(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let n="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await _(n);if(!a.ok)throw new Error("Service is offline or unreachable.");let l=(await a.json()).events||[];je=Date.now(),te(0,je);let o=Date.now(),b=24*60*60*1e3,d=l.filter(p=>{let x=localStorage.getItem(`alert_read_ts_${p.id}`);if(!x)return!0;let y=parseInt(x);return o-y<b});d.sort((p,x)=>{let y=E=>{let g=E.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},c=E=>E==="critical"?4:E==="high"?3:E==="medium"?2:1,r=c(y(p)),w=c(y(x));return r!==w?w-r:x.timestamp-p.timestamp}),Ue=d;let h=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return"low"}return(x.priority||"low").toLowerCase()},T=[];if(d.length===0)T.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let x=new Set(d.map(c=>h(c))).size>1,y=null;d.forEach(c=>{let r=h(c);x&&r!==y&&(T.push({id:`divider-${r}`,type:"divider",label:r.toUpperCase()}),y=r),T.push(c)})}t&&(e.innerHTML="");let m=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return null}let y=(x.title||"Untitled Alert").trim(),c=(x.body||"No description provided.").trim(),r=x.summary||"",w=x.content||"",E=x.protocol||"",g=(x.priority||"low").toLowerCase(),S=!!x.alert,B=(x.category||"system").trim(),k=x.related_event_ids||[],D=x.audit_event_id,q=!!localStorage.getItem(`alert_read_ts_${p.id}`),G=new Date(p.timestamp*1e3),H=G.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=G.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=q?"event-border-grey":"event-border-blue";!q&&S&&(L="event-border-red"),q&&(g==="high"||g==="critical")?L="event-border-red":q&&g==="medium"&&(L="event-border-orange");let I=q?"alert-read":"alert-unread",O=ge.has(p.id),P=O?"expanded":"",V=O?"display: block;":"display: none;",M="",z="";k.length>0&&(z=`
        ...
        `,M=`
            ...
            `;let lt=K.querySelector(".event-details");lt&&lt.addEventListener("click",ce=>{ce.stopPropagation()});let ct=K.querySelector(".close-details-btn");return ct&&ct.addEventListener("click",ce=>{ce.stopPropagation(),K.classList.remove("expanded");let Q=K.querySelector(".event-details");Q&&(Q.style.display="none"),ge.delete(p.id)}),K},v=p=>{let x=document.createElement("div");x.className="notification-divider",x.dataset.alertId=p.id;let y="#888888";return p.label==="CRITICAL"?y="#ff4d4d":p.label==="HIGH"?y="#ff8888":p.label==="MEDIUM"&&(y="#ffa500"),x.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,x.innerHTML=`<span style="white-space: nowrap;">${p.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,x},s=p=>{let x=document.createElement("div");x.innerHTML=J("empty",p.message,null,p.id);let y=x.firstElementChild;return y.dataset.alertId=p.id,y},u=Array.from(e.children),C=new Map(u.map(p=>[p.dataset.alertId,p])),A=new Set(T.map(p=>p.id));u.forEach(p=>{let x=p.dataset.alertId;(!x||!A.has(x))&&p.remove()});let f=null;T.forEach((p,x)=>{let y=C.get(p.id);if(!y||t){if(y&&y.remove(),p.type==="divider")y=v(p);else if(p.type==="placeholder")y=s(p);else{let c=m(p);if(!c)return;y=c}if(!y)return}x===0?e.firstElementChild!==y&&e.prepend(y):f&&f.nextElementSibling!==y&&f.after(y),f=y}),je=Date.now(),te(0,je),Xe()}catch(a){console.error("Error fetching alerts:",a),e.children.length===0&&(e.innerHTML=J("offline","Failed to load alerts.","The event service may be offline."))}}function $s(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),n=document.getElementById("alerts-close-all"),a=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ue.forEach(i=>{localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ue.forEach(i=>{ge.add(i.id),localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),de(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ge.clear(),de(!0)},n.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let i=Date.now()-48*60*60*1e3;Ue.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,i.toString())}),ge.clear(),de(!0)}catch(i){console.error("Failed to clear alerts:",i)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}async function Qe(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let a=(await e.json()).events||[],i=0;a.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}if((o.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||i++}),xt(i)}catch{}}var $t=()=>`
  <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
    <button id="roadmap-new" class="notif-action-btn" style="${R()?"display: none;":""}" title="New Idea"><i class='bx bx-plus'></i></button>
...
`,fe=new Set,kt=[],Me=null;async function be(t=!1){let e=document.getElementById("roadmap-list");if(e){Ss();try{let n=await _("/roadmap");if(!n.ok)throw new Error("Offline");let a=await n.json();kt=a;let i=m=>{let v=fe.has(m.id),s=m.state==="published",u=m.state==="consumed",C="event-border-grey";s&&(C="event-border-blue"),u&&(C="event-border-purple");let f=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),p=document.createElement("div");p.className=`event-item notification-item ${C} cursor-pointer ${v?"expanded":""}`,p.dataset.itemId=m.id,p.onclick=c=>{if(c.target.closest("button"))return;if(p.classList.contains("expanded")){p.classList.remove("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="none"),fe.delete(m.id)}else{p.classList.add("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="block"),fe.add(m.id)}};let x=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;p.innerHTML=`
        <div class="event-time">
          <span class="event-time-main">${f.split(",")[1]}</span>
          <span class="event-date">${f.split(",")[0]}</span>
        </div>
      ...
      `;let y=p.querySelector(".event-details");return y&&y.addEventListener("click",c=>{c.stopPropagation()}),p.querySelector(".edit-btn")?.addEventListener("click",()=>ks(m)),p.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ms(m)),p.querySelector(".delete-btn")?.addEventListener("click",()=>Ls(m.id)),p.querySelector(".close-details-btn")?.addEventListener("click",c=>{c.stopPropagation(),p.classList.remove("expanded");let r=p.querySelector(".event-details");r&&(r.style.display="none"),fe.delete(m.id)}),p},l=m=>{let v=document.createElement("div");v.innerHTML=J("empty",m.message,m.action,m.id);let s=v.firstElementChild;return s.dataset.itemId=m.id,s},o=[];!a||a.length===0?o.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:R()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):a.forEach(m=>o.push({...m,type:"item"}));let b=Array.from(e.children),d=new Map(b.map(m=>[m.dataset.itemId,m])),h=new Set(o.map(m=>m.id));b.forEach(m=>{let v=m.dataset.itemId;(!v||!h.has(v))&&m.remove()}),t&&(e.innerHTML="");let T=null;o.forEach((m,v)=>{let s=d.get(m.id);(!s||t)&&(s&&s.remove(),m.type==="placeholder"?s=l(m):s=i(m),!s)||(v===0?e.firstElementChild!==s&&e.prepend(s):T&&T.nextElementSibling!==s&&T.after(s),T=s)})}catch{e.children.length===0&&(e.innerHTML=J("offline","Failed to load roadmap.","The event service may be offline."))}}}function Ss(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),n=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),i=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Me=null;let l=document.getElementById("roadmap-editor-input");l&&(l.value="");let o=document.getElementById("roadmap-editor-container");o&&(o.style.display="block")},t.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="none"),Me=null},n.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input"),o=l?l.value:"";if(!o.trim())return;let b=Me?`/roadmap/${Me}`:"/roadmap",d=Me?"PATCH":"POST";try{await _(b,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:o})});let h=document.getElementById("roadmap-editor-container");h&&(h.style.display="none"),be(!0)}catch(h){console.error(h)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{kt.forEach(l=>fe.add(l.id)),be(!0)},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{fe.clear(),be(!0)},i.dataset.listenerAttached="true")}function ks(t){Me=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let n=document.getElementById("roadmap-editor-container");n&&(n.style.display="block",n.scrollIntoView({behavior:"smooth"}))}async function Ms(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),be(!0)}catch(n){console.error(n)}}async function Ls(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),fe.delete(t),be(!0)}catch(e){console.error(e)}}var Lt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
        ...
        <button id="blueprints-clear" class="notif-action-btn danger" style="${R()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
    </div>
`,At=()=>`
...
`,Mt=null,ve=new Set,It=[];async function ye(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;As();let n="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await _(n);if(!a.ok)throw new Error("Service is offline or unreachable.");let l=(await a.json()).events||[];It=l,Mt=Date.now(),te(2,Mt);let o=s=>{let u=s.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let C=(u.title||"Untitled Blueprint").trim(),A=(u.summary||u.body||"No summary provided.").trim(),f=(u.content||"").trim(),p=(u.category||"architecture").trim(),x=(u.related_services||u.affected_services||[]).map(M=>M.trim()),y=(u.implementation_path||[]).map(M=>M.trim()),c=u.source_event_ids||[],r=u.approved===!0,w=new Date(s.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=ve.has(s.id),B=S?"display: block;":"display: none;",k=document.createElement("div");k.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${r?"blueprint-approved":""}`,k.dataset.blueprintId=s.id,r&&(k.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",k.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let W=r?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[p]||"bx-paint";k.onclick=function(M){let z=this;if(z.classList.contains("expanded")){z.classList.remove("expanded"),ve.delete(s.id);let U=z.querySelector(".event-details");U&&(U.style.display="none")}else{z.classList.add("expanded"),ve.add(s.id);let U=z.querySelector(".event-details");U&&(U.style.display="block")}};let q="";y.length>0&&(q=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${y.map(M=>`<li style="margin-bottom: 5px;">${j(M)}</li>`).join("")}</ul></div>
                    </div>
                `);let G="";c.length>0&&(G=`
                    <div class="blueprint-source" style="margin-top: 15px;">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            ${c.map(M=>`
                                <a href="#" onclick="window.dexter.viewAlert('${M}'); return false;" style="color: #03dac6; text-decoration: none; font-size: 0.75em; font-family: 'JetBrains Mono', monospace; padding: 4px 8px; background: rgba(3, 218, 198, 0.05); border: 1px solid rgba(3, 218, 198, 0.1); border-radius: 4px;">
                                    <i class='bx bx-link-external'></i> ${M.substring(0,8)}...
                                </a>
                            `).join("")}
                        </div>
                    </div>
                `);let H=x.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${x.join(", ")}</span></div>`:"<div></div>",$=R(),L=r?`
            ...
            `;let I=k.querySelector(".blueprint-approve-btn");I&&(I.onclick=async M=>{M.stopPropagation(),I.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${s.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ye(!0)}catch(z){console.error("Failed to approve blueprint:",z)}});let O=k.querySelector(".blueprint-delete-btn");O&&(O.onclick=async M=>{M.stopPropagation();let z=!r;O.innerHTML=z?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${s.id}`,{method:"DELETE"})).ok&&ye(!0)}catch(N){console.error("Failed to delete blueprint:",N)}});let P=k.querySelector(".event-details");P&&P.addEventListener("click",M=>{M.stopPropagation()});let V=k.querySelector(".close-details-btn");return V&&V.addEventListener("click",M=>{M.stopPropagation(),k.classList.remove("expanded");let z=k.querySelector(".event-details");z&&(z.style.display="none"),ve.delete(s.id)}),k},b=s=>{let u=document.createElement("div");u.innerHTML=J("empty",s.message,s.action,s.id);let C=u.firstElementChild;return C.dataset.blueprintId=s.id,C},d=[];l.length===0?d.push({id:"placeholder-empty",type:"placeholder",message:"No architectural blueprints generated yet.",action:"The Imaginator will synthesize these during system idle periods."}):l.forEach(s=>d.push({...s,type:"blueprint"})),t&&(e.innerHTML="");let h=Array.from(e.children),T=new Map(h.map(s=>[s.dataset.blueprintId,s])),m=new Set(d.map(s=>s.id));h.forEach(s=>{let u=s.dataset.blueprintId;(!u||!m.has(u))&&s.remove()});let v=null;d.forEach((s,u)=>{let C=T.get(s.id);(!C||t)&&(C&&C.remove(),s.type==="placeholder"?C=b(s):C=o(s),!C)||(u===0?e.firstElementChild!==C&&e.prepend(C):v&&v.nextElementSibling!==C&&v.after(C),v=C)}),Pe(2,l.length),wt()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=J("offline","Failed to load blueprints.","The event service may be offline."))}}async function Bt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let a=(await e.json()).events||[],i=0;a.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}o.approved!==!0&&i++}),ht(i)}catch{}}function As(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),n=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{It.forEach(a=>ve.add(a.id)),ye(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ve.clear(),ye(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),ve.clear(),ye(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var le="STANDBY",Ht=null,Le=[],X=null,qe=null,_t=()=>`
  ...
  <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px; align-items: center;">
    ...
    <button id="create-chore-btn" class="notif-action-btn" style="${R()?"display: none;":""}" title="New Task"><i class='bx bx-plus'></i></button>
  </div>
`,Nt=()=>`
        <!-- Create Task Form -->
    ...
    `,Be=[],He={"313071000877137920":"Owen",dexter:"Dexter"},se=[],xe=null;async function _e(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),n=document.getElementById("create-chore-form"),a=document.getElementById("save-chore-btn"),i=document.getElementById("cancel-chore-btn"),l=document.getElementById("new-chore-owner"),o=document.getElementById("selected-recipients"),b=document.getElementById("task-filter-owner"),d=document.getElementById("new-chore-instruction"),h=document.getElementById("new-chore-url"),T=document.getElementById("new-chore-schedule"),m=document.getElementById("new-chore-time"),v=document.getElementById("new-chore-timezone"),s=document.getElementById("new-chore-time-group");if(v&&!v.dataset.initialValueAttached){let r=Intl.DateTimeFormat().resolvedOptions().timeZone,w=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===r){w=!0;break}if(!w){let E=document.createElement("option");E.value=r,E.textContent=r.replace("_"," "),v.appendChild(E)}v.value=r,v.dataset.initialValueAttached="true"}T&&s&&!T.dataset.timeListenerAttached&&(T.addEventListener("change",()=>{s.style.display=T.value==="daily"?"block":"none"}),T.dataset.timeListenerAttached="true");let u=document.getElementById("form-title"),C=document.getElementById("form-icon");function A(){if(o){if(se.length===0){o.innerHTML='<span style="color: #444; font-size: 0.8em; font-style: italic; padding: 4px;">No recipients selected</span>';return}o.innerHTML=se.sort((r,w)=>{let E=r.startsWith("channel:"),g=w.startsWith("channel:");return E&&!g?-1:!E&&g?1:0}).map(r=>{let w=He[r]||r,E=r.startsWith("channel:");return`
      ...
      `}).join(""),o.querySelectorAll(".remove-recipient").forEach(r=>{r.onclick=()=>{let w=r.dataset.id;se=se.filter(E=>E!==w),A()}})}}function f(r){r&&!se.includes(r)&&(se.push(r),A()),l&&(l.value="")}function p(r=null){if(n){if(xe=r?r.id:null,r){if(u&&(u.textContent="Update Research Task"),C&&(C.className="bx bx-edit-alt",C.style.color="#03dac6"),a&&(a.innerHTML="<i class='bx bx-check'></i> Update Task"),d&&(d.value=r.natural_instruction),h&&(h.value=r.execution_plan?.entry_url||""),T&&(T.value=r.schedule,s&&(s.style.display=r.schedule==="daily"?"block":"none")),m&&r.run_at&&(m.value=r.run_at),v&&r.timezone){let w=!1;for(let E=0;E<v.options.length;E++)if(v.options[E].value===r.timezone){w=!0;break}if(!w){let E=document.createElement("option");E.value=r.timezone,E.textContent=r.timezone.replace("_"," "),v.appendChild(E)}v.value=r.timezone}se=r.recipients||(r.owner_id?[r.owner_id]:[]),A()}else u&&(u.textContent="Initialize Research Task"),C&&(C.className="bx bx-plus-circle",C.style.color="#bb86fc"),a&&(a.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),d&&(d.value=""),h&&(h.value=""),T&&(T.value="every_24h"),se=[],A();n.style.display="block",n.scrollIntoView({behavior:"smooth",block:"start"})}}let x=document.getElementById("contacts-group"),y=document.getElementById("channels-group");if(x&&!x.dataset.populated&&!R())try{ue("/contacts").then(async r=>{r.ok&&(((await r.json()).members||[]).forEach(g=>{if(He[g.id]=g.nickname||g.username,g.id==="313071000877137920")return;let S=document.createElement("option");S.value=g.id;let B=g.nickname||g.username;S.textContent=`${B} (${g.username})`,x.appendChild(S)}),x.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}if(y&&!y.dataset.populated&&!R())try{ue("/channels").then(async r=>{r.ok&&((await r.json()).forEach(E=>{let g=`channel:${E.id}`;He[g]=E.name;let S=document.createElement("option");S.value=g,S.textContent=`#${E.name} (${E.guild})`,y.appendChild(S)}),y.dataset.populated="true")})}catch{console.warn("Failed to fetch channels for dropdown")}l&&!l.dataset.listenerAttached&&(l.onchange=()=>{f(l.value)},l.dataset.listenerAttached="true"),b&&!b.dataset.listenerAttached&&(b.onchange=()=>c(),b.dataset.listenerAttached="true");function c(){if(!t)return;let r=b?.value||"all",w=r==="all"?Be:Be.filter(g=>(g.recipients||(g.owner_id?[g.owner_id]:[])).includes(r));if(w.length===0){t.innerHTML=J("empty",r==="all"?"No active tasks.":"No tasks found for this owner.",R()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let E=w.map(g=>{let S=g.last_run===0?"Never":new Date(g.last_run*1e3).toLocaleString(),B=g.memory?g.memory.length:0,k=g.status==="active"?"#03dac6":"#666",W=(g.recipients||(g.owner_id?[g.owner_id]:[])).sort((q,G)=>{let H=q.startsWith("channel:"),$=G.startsWith("channel:");return H&&!$?-1:!H&&$?1:0}).map(q=>{let G=He[q]||q.substring(0,8),H=q.startsWith("channel:");return`<span title="${G}" style="display: flex; align-items: center; gap: 3px;"><i class='bx ${q==="dexter"?"bx-terminal":H?"bx-hash":"bx-user"}'></i>${G}</span>`}).join("<span style='color: #444;'>, </span>");return`
            ...
            `}).join("");t.innerHTML=E,t.querySelectorAll(".edit-chore-btn").forEach(g=>{g.onclick=S=>{S.stopPropagation();let B=g.dataset.id,k=Be.find(D=>D.id===B);k&&p(k)}}),t.querySelectorAll(".reset-chore-btn").forEach(g=>{g.onclick=async S=>{S.stopPropagation();let B=g.dataset.id;confirm("Reset this task? It will be re-run immediately on the next cycle.")&&(g.innerHTML="<i class='bx bx-loader-alt spin'></i>",await _(`/chores/${B}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({last_run:0})}),_e())}}),t.querySelectorAll(".delete-chore-btn").forEach(g=>{g.onclick=async S=>{S.stopPropagation();let B=g.dataset.id;confirm("Delete this task?")&&(await _(`/chores/${B}`,{method:"DELETE"}),_e())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{n&&(n.style.display==="none"||xe!==null?p(null):n.style.display="none")},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{n&&(n.style.display="none")},i.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let r=document.getElementById("new-chore-instruction"),w=document.getElementById("new-chore-url"),E=document.getElementById("new-chore-schedule"),g=r?.value,S=E?.value||"every_24h",B=S==="daily"?m?.value:"",k=S==="daily"?v?.value:"";if(!g)return;if(se.length===0){alert("Please add at least one recipient.");return}let D=a.innerHTML;a.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let W=xe?"PATCH":"POST",q=xe?`/chores/${xe}`:"/chores";await _(q,{method:W,headers:{"Content-Type":"application/json"},body:JSON.stringify({recipients:se,natural_instruction:g,entry_url:w?.value,schedule:S,run_at:B,timezone:k})}),n&&(n.style.display="none"),r&&(r.value=""),w&&(w.value=""),xe=null,se=[],_e()}catch(W){console.error(W),alert(xe?"Failed to update research task":"Failed to create research task")}finally{a.innerHTML=D}},a.dataset.listenerAttached="true");try{let r=await _("/chores");if(!r.ok)throw new Error(`HTTP error! status: ${r.status}`);if(Be=await r.json()||[],b){let E=b.value,g=new Set;Be.forEach(S=>{S.owner_id&&g.add(S.owner_id),S.recipients&&S.recipients.forEach(B=>g.add(B))}),b.innerHTML='<option value="all">All Recipients</option>',g.forEach(S=>{let B=document.createElement("option");B.value=S;let k=S.startsWith("channel:"),D=He[S]||`Recipient: ${S.substring(0,8)}`;B.textContent=(k&&!D.startsWith("#")?"#":"")+D,b.appendChild(B)}),b.value=E,b.selectedIndex===-1&&(b.value="all")}c()}catch(r){console.error("Failed to fetch chores",r)}}var Rt=()=>`
...
`;function Ut(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function qt(t){if(!document.getElementById("dex-profile-styles")){let n=document.createElement("style");n.id="dex-profile-styles",n.textContent=Ds,document.head.appendChild(n)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",n=>{n.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",ue(`/profile/${t.id}`).then(async n=>{if(n.ok){let a=await n.json();tt(e,t,a)}else{console.log("Profile not found or error, using mock data.");let a=Ut(t.id,t.username);tt(e,t,a)}}).catch(n=>{console.error("Profile fetch error:",n);let a=Ut(t.id,t.username);tt(e,t,a)})}function tt(t,e,n){let a=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",i=()=>{let C=(n.attributes||n.facts||[]).map(c=>{let r=c.key||c.k,w=c.value||c.v;return`
            <div class="fact-chip">
                <span class="fact-key">${r}:</span>
                <span class="fact-val">${w}</span>
            </div>
        `}).join(""),A=n.cognitive_model||n,f=A.technical_level||A.techLevel||0,p=A.communication_style||A.commStyle||"Unknown",x=A.patience_level||A.patience||"Unknown",y=A.vibe||"Unknown";return`
                ...
                <div class="profile-section">
                    ...
                    <div class="cog-metric">
                        ...
                        <div class="cog-bar-bg">
                            <div class="cog-bar-fill" style="width: ${Math.min(f*10,100)}%;"></div>
                        </div>
                    </div>
        ...
        `},l=()=>{let C=n.dossier||{},A=C.identity||{},f=C.career||{},p=C.personal||{},x=C.social||[];return`
            <div class="dossier-grid">
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div class="dossier-value">${f.jobTitle||"Unknown"}</div>
                        <div style="font-size: 0.8em; color: #888; margin-top: 2px;">@ ${f.company||"Unknown"}</div>
                        <div style="height: 15px;"></div>
                         <div class="dossier-label">Key Skills</div>
                         <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                            ${(f.skills||[]).map(y=>`<span style="font-size: 0.75em; background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">${y}</span>`).join("")}
                         </div>
                    </div>
                </div>
            ...
            ${Object.entries(C).map(([A,f])=>`
                <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 10px; height: 150px; background: rgba(255,255,255,0.05); border-radius: 5px; position: relative; overflow: hidden;">
                        <div style="position: absolute; bottom: 0; left: 0; width: 100%; height: ${f}%; background: ${Number(f)>50?"#03dac6":"#cf6679"}; transition: height 1s;"></div>
                    </div>
                    <div style="font-size: 0.8em; text-transform: uppercase; letter-spacing: 1px; color: #aaa;">${A.substring(0,4)}</div>
                    <div style="font-family: monospace;">${f}%</div>
                </div>
            `).join("")}
        </div>
        <div style="margin-top: 40px;">
            ...
            <div style="height: 100px; border-bottom: 1px solid #333; display: flex; align-items: flex-end; gap: 5px; padding-bottom: 5px;">
                ${Array.from({length:40}).map(()=>{let A=Math.floor(Math.random()*80)+10;return`<div style="flex: 1; background: ${Math.random()>.7?"#cf6679":Math.random()>.5?"#03dac6":"#444"}; height: ${A}%; border-radius: 2px;"></div>`}).join("")}
            </div>
    ...
    `;t.innerHTML=h;let T=t.querySelector(".profile-card"),m=t.querySelector("#profile-expand-toggle"),v=t.querySelectorAll(".profile-tab-btn"),s=t.querySelectorAll(".tab-content"),u=t.querySelector(".close-profile-btn");u&&u.addEventListener("click",()=>{t.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>t.remove(),300)}),v.forEach(C=>{C.addEventListener("click",()=>{v.forEach(p=>p.classList.remove("active")),s.forEach(p=>p.classList.remove("active")),C.classList.add("active");let A=C.dataset.tab,f=t.querySelector(`#tab-${A}`);f&&f.classList.add("active")})}),m&&m.addEventListener("click",()=>{T.classList.toggle("expanded");let C=T.classList.contains("expanded");m.innerHTML=C?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var Ft=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
        <i class='bx bx-book-content' style="color: #03dac6;"></i>
        <h2>Contacts</h2>
        <button id="contacts-refresh" class="notif-action-btn" style="margin-left: auto; ${R()?"display: none;":""}" title="Refresh Contacts"><i class='bx bx-refresh'></i></button>
    </div>
...
`,zs=null;async function st(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await st(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=n=>{let i=n.target.closest(".user-profile-card");if(i&&i.dataset.user)try{let l=JSON.parse(i.dataset.user);qt(l)}catch(l){console.error("Failed to parse user data",l)}},t.dataset.listenerAttached="true");try{let n=await ue("/contacts");if(!n.ok)throw new Error("Service unreachable");let i=(await n.json()).members||[];if(zs=Date.now(),i.length===0){t.innerHTML=J("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};i.sort((o,b)=>{let d=l[o.level]??10,h=l[b.level]??10;return d!==h?d-h:o.username.localeCompare(b.username)}),t.innerHTML=i.map(o=>{let b=o.color&&o.color!==0,d=b?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",h=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",T="#888";o.level==="Me"||o.level==="Master"?T="#bb86fc":o.level==="Admin"?T="#cf6679":o.level==="Moderator"?T="#03dac6":o.level==="Contributor"&&(T="#ffa500");let m=o.level==="Me",v=m?"rgba(187, 134, 252, 0.08)":b?`${d}11`:"rgba(255,255,255,0.03)",s=m?"2px solid #bb86fc":b?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${m?"#bb86fc":b?d:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${o.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${m?"2px solid #bb86fc":b?`2px solid ${d}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${b?d:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${o.nickname||o.username}</h3>
    ...
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="events-clear" class="notif-action-btn danger" style="${R()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
        </div>
    </div>
...
`,Fe=null,he=new Set,De=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,n]of Object.entries(Rs))if(n.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function pe(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let a=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(a+=`&category=${Z}`);try{let i=await _(a);if(!i.ok)throw new Error("Service unreachable");if(De=((await i.json()).events||[]).filter(v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Fe=Date.now(),te(1,Fe),De.length===0){e.innerHTML=J("empty","No events found for this filter.");return}t&&(e.innerHTML="");let b=v=>{let s=v.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,C=Os(u),A=js(u),f=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.bot.voice_response"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),p="event-border-grey";f&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?p="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"||u==="engagement.decision"?p="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?p="event-border-orange":u==="system.test.completed"?p=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":p="event-border-blue");let x=f?"cursor-pointer":"",y=he.has(v.id),c=y?"expanded":"",r=y?"display: block;":"display: none;",w=new Date(v.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=Jt(u,s),B=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",k="";if(f){let H="";if(u==="engagement.decision"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                    ...
                    `}else if(u==="system.attention.expired"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,L=s.timestamp-s.last_active,I=Math.floor(L/60);H=`
                    ...
                    `}else if(u==="messaging.bot.sent_message"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,L="";if(s.embed){let P=s.embed,V=P.title?`<div style="font-weight: bold; margin-bottom: 5px; color: #fff;">${j(P.title)}</div>`:"",M=P.description?`<div style="font-size: 0.9em; color: #bbb; white-space: pre-wrap;">${re(P.description)}</div>`:"",z=(P.fields||[]).map(N=>`
              <div style="margin-top: 10px;">
            ...
            `}let I="";s.eval_count&&(I=`
                        ...
                        `);let O="";if(s.chat_history&&s.chat_history.length>0){let P=s.chat_history.length,V=s.chat_history.map((M,z)=>{let N=M.name?M.name.toUpperCase():M.role.toUpperCase();!M.name&&N==="ASSISTANT"&&(N="DEXTER");let U=M.role==="user"?"#03dac6":M.role==="system"?"#ffb74d":"#bb86fc",Y=z===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${z}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${z+1} of ${P}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${j(M.content)}</div>
                                </div>
                            `}).join("");O=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(u==="messaging.bot.voice_response"){let $=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,L="",I=[],O=s.raw_input||"";if(O.startsWith("[{")&&O.endsWith("}]")){let P=O.match(/{.*?}/g);P&&(I=P.map(V=>{let M=V.substring(1,V.length-1),z=M.indexOf(" "),N=M.substring(0,z),U=M.substring(z+1);return U=U.replace(/\[\]$/,"").trim(),{role:N,content:U}}))}if(I.length>0&&s.response_raw&&I.push({role:"assistant",content:s.response_raw}),I.length>0){let P=I.length,V=I.map((M,z)=>{let N=M.role.toUpperCase();N==="ASSISTANT"&&(N="DEXTER");let U=M.role==="user"?"#03dac6":M.role==="system"?"#ffb74d":"#bb86fc",Y=z===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${z}" style="display: ${Y};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${U}; letter-spacing: 1px; font-weight: bold;">${N}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${z+1} of ${P}</span>
                    ...
                    `}else if(u==="analysis.user.message_signals"){let $=O=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${O}</h5>`,L=s.signals||{};H=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(u==="moderation.explicit_content.deleted"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.link.completed"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.router.decision"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.cli.command"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.analysis.audit"){let $=s.success?"#03dac6":"#ff4d4d",L=s.success?"SUCCESS":"FAILED",I=z=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${z}</h5>`,O="";s.error&&(O=`
                            <div class="event-detail-block">
                                ${I("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${j(s.error)}</pre>
                            </div>
                        `);let P="";if(s.chat_history&&s.chat_history.length>0){let z=s.chat_history.length,N=s.chat_history.map((U,Y)=>{let K=U.name?U.name.toUpperCase():U.role.toUpperCase();!U.name&&K==="USER"&&(K="SYSTEM"),!U.name&&K==="ASSISTANT"&&(K="AGENT");let Ce=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc";return`
                        ...
                        `}let M="";if(s.parsed_results&&s.parsed_results.length>0){let z=s.parsed_results.map(N=>`
                        ...
                        ${V}
                        ${P}
                    `}else if(u==="system.test.completed"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="error_occurred"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.cli.status"){let $=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`;H=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                    ...
                    `}else if(u==="messaging.user.sent_message"){let $="";s.attachments&&s.attachments.length>0&&($=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(I=>{let O=I.content_type&&I.content_type.startsWith("image/"),P=(I.size/1024).toFixed(1)+" KB";return`
            ...
            `;let W=D.querySelector(".event-details");if(W&&W.addEventListener("click",H=>{H.stopPropagation()}),f){let H=D.querySelector(".close-details-btn");H&&H.addEventListener("click",$=>{$.stopPropagation();let L=$.target.closest(".event-item");if(L){L.classList.remove("expanded"),he.delete(v.id);let I=L.querySelector(".event-details");I&&(I.style.display="none")}})}let q=D.querySelector(".prev-btn"),G=D.querySelector(".next-btn");if(q&&G){let H=0,$=Array.from(D.querySelectorAll(".history-slide")),L=$.length,I=()=>{$.forEach((O,P)=>{O.style.display=P===H?"block":"none"}),q.disabled=H===0,G.disabled=H===L-1,q.style.opacity=H===0?"0.5":"1",G.style.opacity=H===L-1?"0.5":"1"};q.addEventListener("click",O=>{O.stopPropagation(),H>0&&(H--,I())}),G.addEventListener("click",O=>{O.stopPropagation(),H<L-1&&(H++,I())}),I()}return D},d=Array.from(e.children),h=new Map(d.map(v=>[v.dataset.eventId,v])),T=new Set(De.map(v=>v.id));d.forEach(v=>{let s=v.dataset.eventId;(!s||!T.has(s))&&v.remove()});let m=null;De.forEach((v,s)=>{let u=h.get(v.id);(!u||t)&&(u&&u.remove(),u=b(v),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):m&&m.nextElementSibling!==u&&m.after(u),m=u)}),Fe=Date.now(),te(1,Fe)}catch(i){console.error("Error fetching events:",i),e.children.length===0&&(e.innerHTML=J("offline","Failed to load events.","The event service may be offline."))}}function Us(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),n=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{De.forEach(i=>he.add(i.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{he.clear(),pe(!0)},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{n.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),i.classList.add("active"),Z=i.dataset.filter||"all",pe(!0)}}),n.dataset.listenerAttached="true"),n&&n.querySelectorAll(".filter-btn").forEach(i=>{i.dataset.filter===Z?i.classList.add("active"):i.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let i=Z==="all"?"ALL":Z.toUpperCase();if(confirm(`Are you sure you want to delete ${i} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(Z!=="all"?l+=`?category=${Z}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");he.clear(),pe(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var qs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Wt=qs;function Gt(){return`
    ...
    `}var Fs=null;async function ze(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let n=await e.json();if(!n||n.length===0)return t.innerHTML=J("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let a=["local-ollama-0","local-cache-0"],i=n.filter(o=>!a.includes(o.id));i.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),i.reverse();let l=i.map(o=>{let b=o.logs.join(`
...
`);return`
                <div class="log-report">
                    <div class="log-report-header">
                        ...
                        <div style="display: flex; gap: 5px;">
                            ...
                            <button class="log-action-btn delete clear-logs-btn" data-service-id="${o.id}" title="Clear Logs" style="${R()?"display: none;":""}">
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(o=>{o.addEventListener("click",()=>{let b=o,d=unescape(b.dataset.logs||"");navigator.clipboard.writeText(d).then(()=>{let h=b.querySelector("i");h&&(h.classList.remove("bx-copy"),h.classList.add("bx-check"),setTimeout(()=>{h.classList.remove("bx-check"),h.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(o=>{o.addEventListener("click",async()=>{let d=o.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${d}?`))try{(await _(`/logs?service_id=${d}`,{method:"DELETE"})).ok&&ze()}catch(h){console.error("Error clearing logs:",h)}})}),Fs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=J("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Yt=()=>{let t=R()?"display: none;":"";return`
        <div class="system-section-header">
            <i class='bx bxs-pie-chart-alt-2' style="color: #03dac6;"></i>
            <h2>Summary ${R()?'<span style="color: #666; font-size: 0.6em; margin-left: 10px; font-weight: normal; font-style: italic;">* Public data is approximated</span>':""}</h2>
        ...
        <div class="system-section-header">
            ...
            <h2>Services</h2>
            <div id="global-service-controls" class="header-controls" style="margin-left: auto; gap: 8px; ${R()?"display: none;":"display: flex;"}">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Gt()}
                ...
                </div>`}if(b&&c.CPU&&c.CPU.length>0){let r=c.CPU[0];b.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}h&&(c.GPU&&c.GPU.length>0?h.innerHTML=c.GPU.map(r=>{let w=(r.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):h.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),T&&c.STORAGE&&c.STORAGE.length>0?T.innerHTML=c.STORAGE.map(r=>{let w=(r.USED/1073741824).toFixed(1),E=(r.SIZE/(1024*1024*1024)).toFixed(1),g=r.SIZE>0?(r.USED/r.SIZE*100).toFixed(0):0,S=r.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):T&&(T.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let c=await Zt();c?(m(c),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),b&&!b.hasChildNodes())){let c=await Zt();m(c)}if(!t)return;t.dataset.controlsAttached||(t.addEventListener("click",async c=>{let r=c.target.closest(".svc-btn");if(!r)return;let w=r,E=w.dataset.action,g=w.dataset.service;if(!E||!g)return;let S=w.innerHTML;w.innerHTML="<i class='bx bx-loader-alt spin'></i>",w.classList.add("loading"),w.disabled=!0;try{await _(`/system/service/${E}`,{method:"POST",body:JSON.stringify({service:g})}),setTimeout(()=>we(),1e3),setTimeout(()=>we(),3e3)}catch(B){console.error(B),alert(`Failed to ${E} ${g}`),w.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{w.innerHTML=S,w.classList.remove("loading"),w.disabled=!1},2e3)}}),t.dataset.controlsAttached="true");let v=await is();if(!v||!v.services){t.children.length===0&&(t.innerHTML=J("offline","Failed to load system metrics.","The event service may be offline."));let c=document.querySelector('[data-service-id="upstash-redis-ro"]');if(c){c.className="service-widget service-widget-offline",c.querySelector(".service-widget-status").textContent="ERROR";let r=c.querySelector(".service-widget-body");r&&(r.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Vt=R()&&oe.lastDashboard||Date.now(),te(0,Vt||0);let s=v.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let c=document.getElementById("upstash-countdown");if(c){let E=59-new Date().getSeconds();E<=0&&(E+=60),c.textContent=`${E}s`}},1e3)),Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function u(c){if(!c||c==="N/A"||c==="unknown")return"-";let r=c.match(/^(\d+\.\d+\.\d+)/);return r?r[0]:c.split(".").slice(0,3).join(".")||"-"}function C(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function A(c){if(!c||c==="N/A"||c==="unknown")return"-";let r=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!r)return"-";let w=parseInt(r[1])||0,E=parseInt(r[2])||0,g=parseInt(r[3])||0,S=parseFloat(r[4])||0,B=w*86400+E*3600+g*60+S,k=Math.floor(B/86400);if(k>0)return`${k}d`;let D=Math.floor(B/3600);if(D>0)return`${D}h`;let W=Math.floor(B/60);return W>0?`${W}m`:`${Math.floor(B)}s`}function f(c){if(c.id==="upstash-redis-ro"){let P=R()&&(oe.lastFrontend||oe.lastDashboard)||Date.now();return`
            ...
            </div>`}let r=c.status==="online",w=r?"service-widget-online":"service-widget-offline",E=r?"bx-check-circle":"bx-x-circle",g=r?"OK":"BAD",S=c.version?u(c.version.str):"-",B=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",k=c.memory&&c.memory!=="N/A"?c.memory:"-",D=B!=="-"?"#00ff00":"#666",W=B!=="-"?"#fff":"#666",q=k!=="-"?"#00ff00":"#666",G=k!=="-"?"#fff":"#666",H=A(c.uptime),$="",L=c.type!=="os"&&c.type!=="cli"&&c.type!=="prd",I="";L&&!R()&&(I=`
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                ...
                </div>${I}`:$=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${I}`;let O=R()?"easter.company":C(c.domain&&c.port?`${c.domain}:${c.port}`:"");return`<div class="service-widget ${w}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${E}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${g}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${$}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),x=new Set(s.map(c=>c.id));for(let[c,r]of p)x.has(c)||r.remove();let y=new Set;s.forEach(c=>{if(y.has(c.id))return;y.add(c.id);let r=f(c),w=p.get(c.id);if(w&&w.parentNode)if(c.id==="upstash-redis-ro"){let E=R()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),g=new Date(E).toLocaleTimeString(),S=w.querySelector(".sync-time-label");S&&(S.textContent=`Last synced: ${g}`)}else w.outerHTML!==r&&(w.outerHTML=r);else t.insertAdjacentHTML("beforeend",r)})}async function at(){let t=document.getElementById("models-widgets");if(!t)return;let e=await is();if(!e){t.children.length===0&&(t.innerHTML=J("offline","Failed to load model status.","The event service may be offline."));return}Kt=Date.now(),te(2,Kt);let n=e.models||[],a=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function i(d){let h=d.status==="Ready";return`
                ...
                </div>`}function l(d){let h=d.status==="Ready";return`
                ...
                </div>`}function o(d){let h=d.status==="Downloaded",T=h?"service-widget-online":"service-widget-offline",m=h?"OK":"MISSING",v=h&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${T}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${h?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let b="";if(a&&(b+=i(a)),e.xtts&&(b+=l(e.xtts)),b+=n.map(o).join(""),!b){t.innerHTML=J("empty","No models found.");return}t.innerHTML!==b&&(t.innerHTML=b)}async function ne(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let n=document.getElementById("guardian-sentry-val"),a=document.getElementById("guardian-idle-val"),i=document.getElementById("guardian-total-idle"),l=document.getElementById("guardian-total-active"),o=document.getElementById("guardian-total-waste"),b=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn"),h=document.getElementById("fabricator-reset-btn"),T=document.getElementById("courier-reset-btn"),m=document.getElementById("system-pause-toggle-btn");m&&!m.dataset.listenerAttached&&(m.onclick=async()=>{let c=m.querySelector(".bx-play")?"/agent/resume":"/agent/pause";m.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _(c,{method:"POST"}),await ne()}catch{m.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>ne(),2e3)}},m.dataset.listenerAttached="true"),b&&!b.dataset.listenerAttached&&(b.onclick=async()=>{b.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=all",{method:"POST"}),setTimeout(()=>{b.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{b.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{b.innerHTML="<i class='bx bx-error'></i>"}},b.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{d.innerHTML="<i class='bx bx-error'></i>"}},d.dataset.listenerAttached="true"),h&&!h.dataset.listenerAttached&&(h.onclick=async()=>{h.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{h.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{h.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{h.innerHTML="<i class='bx bx-error'></i>"}},h.dataset.listenerAttached="true"),T&&!T.dataset.listenerAttached&&(T.onclick=async()=>{T.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{T.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{T.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{T.innerHTML="<i class='bx bx-error'></i>"}},T.dataset.listenerAttached="true");let v=document.getElementById("imaginator-reset-btn");v&&!v.dataset.listenerAttached&&(v.onclick=async()=>{v.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/agent/reset?protocol=alert_review",{method:"POST"}),setTimeout(()=>{v.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{v.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),ne()}catch{v.innerHTML="<i class='bx bx-error'></i>"}},v.dataset.listenerAttached="true");let s=await Gs();if(s&&s.agents){let y=s.agents.guardian||{protocols:{}},c=s.agents.analyzer||{protocols:{}},r=s.agents.imaginator||{protocols:{}},w=s.agents.fabricator||{protocols:{}},E=s.agents.courier||{protocols:{}},g=s.system||{},S=Math.floor(Date.now()/1e3),B={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},k=M=>{M<0&&(M=0);let z=Math.floor(M/3600),N=Math.floor(M%3600/60),U=M%60;return z>0?`${z}h ${N}m`:N>0?`${N}m ${U}s`:`${U}s`},D=(M,z,N,U)=>{if(!M)return;let Y=B[U]||U.toUpperCase(),K=M.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(K&&(K.textContent=Y),!N){M.textContent="Inactive",M.style.color="#666";return}let Ce=N.status;if(Ce==="Working")M.textContent="Working",M.style.color="#bb86fc";else if(Ce==="Ready")M.textContent="Ready",M.style.color="#5eff5e";else{let Ee=N.cooldown;if(R()&&(Ee=N.next_run-S),Ee<=0)M.textContent="Ready",M.style.color="#5eff5e";else{let Ge=Math.floor(Ee/60),Ve=Ee%60;M.textContent=`${Ge}m ${Ve}s`,M.style.color="#fff"}}z&&N.stats&&(z.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
          ...
          `)};n&&D(n,document.getElementById("guardian-sentry-stats"),y.protocols.sentry,"sentry");let W=document.getElementById("analyzer-synthesis-val"),q=document.getElementById("analyzer-synthesis-stats");W&&D(W,q,c.protocols.synthesis,"synthesis");let G=document.getElementById("imaginator-alert_review-val"),H=document.getElementById("imaginator-alert_review-stats");G&&D(G,H,r.protocols.alert_review,"alert_review");let $=document.getElementById("fabricator-construction-val"),L=document.getElementById("fabricator-construction-stats");$&&D($,L,w.protocols.construction,"construction");let I=document.getElementById("courier-researcher-val"),O=document.getElementById("courier-researcher-stats");I&&D(I,O,E.protocols.researcher,"researcher");let P=document.getElementById("system-state-label"),V=document.getElementById("system-state-val");if(V&&g.state){let M=g.state,z=k(g.state_time||0);P&&(P.textContent=`State: ${M.toUpperCase()}`),V.textContent=z,M==="idle"?V.style.color=g.state_time>300?"#5eff5e":"#fff":V.style.color="#bb86fc",m&&(M==="paused"?(m.innerHTML="<i class='bx bx-play'></i>",m.title="Resume System",m.style.color="#ff9800"):(m.innerHTML="<i class='bx bx-pause'></i>",m.title="Pause System",m.style.color=""))}i&&(i.textContent=k(g.metrics?.total_idle_time||0)),l&&(l.textContent=k(g.metrics?.total_active_time||0)),o&&(o.textContent=k(g.metrics?.total_waste_time||0))}else[n,a,i,l,o].forEach(c=>{c&&(c.textContent="-",c.style.color="#666")});if(t)return;let u=await Ws(),C=[],A=[],f=[];u&&(Array.isArray(u)?C=u:(C=u.active||[],A=u.queue||[],f=u.history||[],f.sort((y,c)=>(c.end_time||0)-(y.end_time||0)))),e&&(C.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=J("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),it(e,C,!1)));let p=document.getElementById("processes-queue-widgets");p&&(A.length===0?!p.querySelector(".tab-placeholder")&&!p.querySelector('div[style*="font-style: italic"]')&&(p.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(p.innerHTML="",it(p,A,!1)));let x=document.getElementById("processes-history-widgets");x&&(f.length===0?x.querySelector(".tab-placeholder")||(x.innerHTML=J("empty","No recent history.")):(x.querySelector(".tab-placeholder")&&(x.innerHTML=""),it(x,f,!0))),Pe(1,C.length)}function it(t,e,n){function a(d){let h="";d.end_time?h=`${d.end_time-d.start_time}s`:h=`${Math.floor(Date.now()/1e3-d.start_time)}s`;let T=d.retries>0?`<span class="process-retry-badge">Retry ${d.retries}</span>`:"",m=d.channel_id,v={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent","system-courier":"Courier Agent","system-imaginator":"Imaginator Agent","system-fabricator":"Fabricator Agent"};if(v[m]?m=v[m]:/^\d+$/.test(m)&&(m=`Channel ${m}`),n)return`
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let i=n?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(i)).map(d=>[d.dataset.channelId,d])),o=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,h]of l)d&&!o.has(d)&&h.remove();let b=new Set;e.forEach(d=>{let h=`${d.channel_id}-${d.start_time}`;if(b.has(h))return;b.add(h);let T=a(d),m=l.get(h);if(m&&m.parentNode){m.outerHTML!==T&&(m.outerHTML=T);let v=t.querySelector(`[data-channel-id="${h}"]`);v&&t.appendChild(v)}else t.insertAdjacentHTML("beforeend",T)})}function We(){let t=Ze(),e="Notification"in window,n={enabled:e&&Notification.permission==="granted",supported:e};return`
            <div class="theme-selector">
                ${Object.values(ee).map(a=>`
                    <div class="theme-card ${t===a?"active":""}" data-theme="${a}">
                        ...
                        <div class="theme-info">
                            ...
                            <p>${a===ee.DARK?"Simple, clean, dark.":a===ee.LIGHT?"Heavenly, bright, and glowy.":"The original animated style."}</p>
            ...
            </div>`}function ot(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(a=>{a.addEventListener("click",function(){let i=this.dataset.theme;i&&(ft(i),t.setContent(We()),ot(t))})});let n=document.getElementById("notifications-toggle");n&&"Notification"in window?n.onclick=async a=>{let i=a.target;if(i.checked)try{await Notification.requestPermission()!=="granted"&&(i.checked=!1)}catch{i.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),i.checked=!0)}:n&&(n.disabled=!0),Vs()}async function Vs(){let t=document.getElementById("service-config-list"),e=document.getElementById("ollama-config-list");if(!t||!e)return;let n=R();try{let i=await(await _("/system/options")).json(),l=i.services||i||{},o=i.ollama||i||{},b="",d=(C,A,f)=>`
        <div class="settings-item">
            <div class="settings-item-info">
            ...
            <label class="toggle-switch">
                <input type="checkbox" class="service-device-toggle" data-service="${A}" ${f==="cuda"?"checked":""} ${n?"disabled":""}>
                <span class="toggle-slider"></span>
            </label>
        </div>`;l.stt&&(b+=d("STT Service","stt",l.stt.device||"cpu")),l.tts&&(b+=d("TTS Service","tts",l.tts.device||"cpu")),b?n&&(b+='<div style="font-size: 0.7em; color: #666; font-style: italic; margin-top: 15px; text-align: center;">* Service configuration is read-only in public mode.</div>'):b='<div style="padding: 20px; text-align: center; color: #666;">No configurable services found.</div>',t.innerHTML=b;let h="",T=o.utility_device||"cpu",m=o.utility_speed||"smart",v=n?"disabled":"";if(h+=`
        <div class="settings-item">
            <div class="settings-item-info">
        ...
        </div>`,n?h+='<div style="font-size: 0.7em; color: #666; font-style: italic; margin-top: 15px; text-align: center;">* Optimization is read-only in public mode.</div>':h+=`<div style="font-size: 0.7em; color: #ffa500; font-style: italic; margin-top: 10px; text-align: center;"><i class='bx bx-info-circle'></i> Changing these settings requires a 'dex restart' to re-apply.</div>`,e.innerHTML=h,n)return;t.querySelectorAll(".service-device-toggle").forEach(C=>{C.addEventListener("change",async A=>{let f=A.target,p=f.dataset.service,x=f.checked?"cuda":"cpu";f.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:p,key:"device",value:x})})}catch{f.checked=!f.checked,alert("Failed to update configuration.")}finally{f.disabled=!1}})});let s=document.getElementById("ollama-utility-device-select");s&&s.addEventListener("change",async C=>{let A=C.target,f=A.value;A.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:"ollama",key:"utility_device",value:f})})}catch{alert("Failed to update utility hardware setting.")}finally{A.disabled=!1}});let u=document.getElementById("ollama-utility-speed-select");u&&u.addEventListener("change",async C=>{let A=C.target,f=A.value;A.disabled=!0;try{await _("/system/options",{method:"POST",body:JSON.stringify({service:"ollama",key:"utility_speed",value:f})})}catch{alert("Failed to update utility intelligence setting.")}finally{A.disabled=!1}})}catch{t.innerHTML='<div style="padding: 20px; text-align: center; color: #cf6679;">Failed to load configuration.</div>',e.innerHTML='<div style="padding: 20px; text-align: center; color: #cf6679;">Failed to load optimization settings.</div>'}}var os=()=>`
    ...
    `;async function rs(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await as(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await as(t)}async function as(t){try{let e=await _("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let n=await e.json();if(!n||n.length===0){t.innerHTML=J("empty","No web history found.");return}let a=`
        ...
        `;n.forEach((b,d)=>{let h=new Date(b.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),T=b.screenshot?`<img src="data:image/png;base64,${b.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';a+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ks=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[n,a]of Object.entries(t)){let i=ds.filter(l=>l.category===n);i.length!==0&&(e+=`
                    ...
                    ${i.map(l=>`
                        <div class="cli-command-card ${l.dummy?"dummy":""}" data-cmd="${l.id}" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 25px; transition: all 0.3s ease; cursor: pointer; position: relative; overflow: hidden;">
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px; position: relative; z-index: 1;">
                                <i class='bx ${l.icon}' style="font-size: 2em; color: ${a.color};"></i>
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>ls());let h=document.getElementById("terminal-action-btn");h&&(h.onclick=()=>ls())}let n=document.getElementById("cli-terminal-body"),a=document.getElementById("cli-docs-pane");n&&(n.innerHTML="");let i=t.docs||{overview:t.description,details:[],extended_usage:t.usage};a&&(a.innerHTML=`
    ...
    `);let l=document.getElementById("terminal-cmd-name");l&&(l.textContent=`dex ${t.id}`);let o=document.getElementById("terminal-status-badge");o&&(o.className="terminal-status status-running",o.textContent="Running");let b=document.getElementById("terminal-action-btn");return b&&(b.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",rt=!0,n}function ls(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",rt=!1}function cs(t,e,n="output"){if(!rt||!t)return;let a=document.createElement("div");if(a.className=`terminal-line terminal-${n}`,n==="prompt")a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let i=Oe(e);a.innerHTML=i||e}t.appendChild(a),t.scrollTop=t.scrollHeight}async function Ys(t){let e=ds.find(o=>o.id===t);if(!e)return;let n=Zs(e);n&&cs(n,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let o of a){await new Promise(d=>setTimeout(d,400+Math.random()*600));let b="output";o.includes("[ERROR]")?b="error":o.includes("[SUCCESS]")||o.includes("\u2713")?b="success":o.includes("!")&&(b="warning"),n&&cs(n,o,b)}let i=document.getElementById("terminal-status-badge");i&&(i.className="terminal-status status-success",i.textContent="Completed (Demo)");let l=document.getElementById("terminal-action-btn");l&&(l.style.display="block")}function ps(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ks();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let n=e.querySelector("code"),a=n?n.textContent:"";a&&navigator.clipboard.writeText(a).then(()=>{let i=e.querySelector("i");i&&(i.className="bx bx-check",i.style.color="#5eff5e",setTimeout(()=>{i.className="bx bx-copy",i.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(n=>{let a=n;n.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),n.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),n.addEventListener("click",()=>{let i=a.dataset.cmd;i&&Ys(i)})})}async function Xs(){if(!R())try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ms(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}pt(),mt(),Xs(),vt(),dt();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&ps();let e=[],n=document.getElementById("windows-container");n&&n.setAttribute("data-count","0");let a=f=>{localStorage.setItem("dex_last_window",f)};function i(){for(;e.length>1;)e.shift().close(!0);let f=document.getElementById("windows-container"),p=document.querySelector("nav"),x=document.querySelector("footer"),y=window.location.pathname==="/"||window.location.pathname==="/index.html",c=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");f&&f.setAttribute("data-count",e.length.toString()),e.forEach(k=>{let D=document.getElementById(k.id);D&&D.classList.remove("hide-close")});let r=document.getElementById("dexter-menu-container"),w=document.getElementById("nav-window-switcher"),E=document.getElementById("settings-icon"),g=document.getElementById("docs-icon"),S=document.getElementById("close-all-windows"),B=window.innerWidth<880;if(!B){let k=document.getElementById("dexter-dropdown"),D=document.getElementById("dexter-menu-btn");k&&k.classList.remove("active"),D&&D.classList.remove("active"),f&&f.classList.remove("menu-open")}if(Te(e.length>0),e.length>0)if(x?.classList.add("hide"),S&&(S.style.display=B?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",p?.classList.add("window-open"),f&&(f.style.paddingTop="60px"),r&&(r.style.display=B?"flex":"none"),g&&(g.style.display=B?"block":"none"),E&&(E.style.display=B?"block":"none"),!B&&w){let k=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(k)?(w.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{a("alerts-window"),l(b)}),document.getElementById("switch-events")?.addEventListener("click",()=>{a("events-window"),l(d)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{a("monitor-window"),l(T)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{a("contacts-window"),l(h)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{a("workspace-window"),l(m)})):w.innerHTML=""}else w&&(w.innerHTML="");else p?.classList.remove("window-open"),S&&(S.style.display="none"),f&&(f.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",y||c?x?.classList.remove("hide"):x?.classList.add("hide"),r&&(r.style.display="flex"),g&&(g.style.display="block"),E&&(E.style.display="block"),w&&(w.innerHTML="");ke()}function l(f){if(f.isOpen()){f.close();return}for(;e.length>0;)e.pop().close(!0);e.push(f),f.open(),i()}function o(){[...e].forEach(p=>p.close()),e=[]}window.addEventListener("resize",i);let b=me({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Tt(),onOpen:()=>de(),onClose:()=>{let f=e.indexOf(b);f>-1&&e.splice(f,1),i()}}),d=me({id:"events-window",title:"Events",icon:"bx-calendar-event",content:nt(),onOpen:()=>{d.setContent(nt()),pe()},onClose:()=>{let f=e.indexOf(d);f>-1&&e.splice(f,1),i()}}),h=me({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ft(),onOpen:()=>st(),onClose:()=>{let f=e.indexOf(h);f>-1&&e.splice(f,1),i()}}),T=me({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Qt()},{icon:"bxs-component",title:"Processes",content:Xt()},{icon:"bxs-brain",title:"Models",content:es()},{icon:"bx-globe",title:"Web",content:os()},{icon:"bxs-hdd",title:"Hardware",content:ts()},{icon:"bxs-terminal",title:"Logs",content:ss()},{icon:"bxs-zap",title:"Agents",content:Yt()}].filter(f=>R()?f.title!=="Hardware"&&f.title!=="Logs":!0),onOpen:()=>{we(),ne(),at(),rs(),ze()},onClose:()=>{let f=e.indexOf(T);f>-1&&e.splice(f,1),i()}}),m=me({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Rt()},{icon:"bx-map-alt",title:"Roadmap",content:Pt()},{icon:"bx-paint",title:"Blueprints",content:Ot()},{icon:"bx-task",title:"Tasks",content:jt()}],onOpen:()=>et(),onClose:()=>{let f=e.indexOf(m);f>-1&&e.splice(f,1),i()}}),v=me({id:"settings-window",title:"Settings",icon:"bx-cog",content:We(),onOpen:()=>{v.setContent(We()),ot(v)},onClose:()=>{let f=e.indexOf(v);f>-1&&e.splice(f,1),i()}});window.dexter={viewEvent:f=>{d.isOpen()||l(d),setTimeout(()=>{let p=document.querySelector(`.event-item[data-event-id="${f}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)},viewAlert:f=>{b.isOpen()||l(b),setTimeout(()=>{let p=document.querySelector(`.event-item[data-alert-id="${f}"]`);p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),p.classList.add("flash-highlight"),p.classList.contains("expanded")||p.click(),setTimeout(()=>p.classList.remove("flash-highlight"),2e3))},500)}};let s=()=>{let f=document.getElementById("dexter-dropdown"),p=document.getElementById("dexter-menu-btn");f&&p&&(f.classList.remove("active"),p.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let f=document.getElementById("dexter-menu-btn"),p=document.getElementById("settings-icon"),x=document.getElementById("docs-icon"),y=document.getElementById("close-all-windows"),c=document.getElementById("nav-left-container"),r=document.getElementById("dexter-dropdown"),w=document.getElementById("windows-container");f&&r&&(f.onclick=g=>{g.stopPropagation();let S=window.innerWidth<880;if(S)r.style.top="",r.style.left="",r.style.right="",r.style.transform="";else{let k=f.getBoundingClientRect(),W=document.querySelector("nav").getBoundingClientRect(),q=220,G=10,$=k.left+k.width/2-q/2,L=W.right-10;$+q>L&&($=L-q),$<10&&($=10),r.style.top=W.bottom+G+"px",r.style.left=$+"px",r.style.right="auto",r.style.transform="none"}r.classList.toggle("active"),f.classList.toggle("active");let B=r.classList.contains("active");if(S){let k=document.querySelector("nav");B?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),k?.classList.add("window-open"),w?.classList.add("menu-open"),Te(!0)):(w?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),k?.classList.remove("window-open"),Te(!1)))}}),p&&(p.onclick=g=>{g.stopPropagation(),l(v)}),x&&(x.onclick=g=>{g.stopPropagation(),window.location.href="/docs"}),y&&(y.onclick=g=>{g.stopPropagation(),o()});let E=(g,S,B)=>{let k=document.getElementById(g);k&&(k.onclick=D=>{D.stopPropagation(),s(),B&&a(B),l(S)})};E("alerts-menu-item",b,"alerts-window"),E("events-menu-item",d,"events-window"),E("monitor-menu-item",T,"monitor-window"),E("contacts-menu-item",h,"contacts-window"),E("workspace-menu-item",m,"workspace-window"),c&&(c.onclick=g=>{if(g.stopPropagation(),r&&r.classList.contains("active")){s(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Te(!1));return}if(e.length>0)o();else{let S=window.location.pathname;if(!(S==="/"||S==="/index.html")){let k=S.endsWith("/")&&S.length>1?S.slice(0,-1):S;if(k.includes("/docs/page/")){window.location.href="/";return}let D=k.split("/");D.pop();let W=D.join("/")||"/";window.location.href=W}}}),document.addEventListener("click",()=>{let g=window.innerWidth<880;r&&r.classList.contains("active")&&(s(),g&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),Te(!1)))}),r&&(r.onclick=g=>g.stopPropagation())})();let C=window.location.pathname==="/"||window.location.pathname==="/index.html",A=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!C&&!A&&document.querySelector("footer")?.classList.add("hide"),R()||setInterval(()=>{d.isOpen()&&pe(),b.isOpen()?de():Qe()},1e3),setInterval(()=>{R()&&(b.isOpen()?de():Qe()),m.isOpen()?et():Bt(),R()&&d.isOpen()&&pe(),T.isOpen()&&ns()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ms):ms();})();
