"use strict";(()=>{function ct(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function dt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",i=`
    ...
    `,r=document.createElement("nav");r.innerHTML=i,document.body.prepend(r);let l=document.createElement("div");l.id="dexter-dropdown",l.className="dexter-dropdown",l.innerHTML=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var mt=1e3;function pe(t){let e=null,s=t.onClose||null,n=t.onOpen||null;function i(){e&&(e.style.zIndex=(++mt).toString())}function r(){if(e){e.classList.add("open"),i(),window.addEventListener("resize",l),n&&setTimeout(n,10);return}let u=document.getElementById("windows-container");u||(u=document.createElement("div"),u.id="windows-container",u.className="windows-container",document.body.appendChild(u)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++mt).toString(),e.addEventListener("mousedown",i);let v=t.icon||"bx-window",o="",b="",x,h='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(o=`<div class="tab-bar">${t.tabs.map((m,p)=>{let y=m.icon?`<i class="bx ${m.icon}"></i>`:`<span class="tab-glyph">${m.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,x=`<div class="window-content">${t.tabs.map((m,p)=>`<div class="tab-content ${p===0?"active":""}" data-tab-content="${p}">${m.content}${h}</div>`).join("")}</div>`):(t.title&&(b=`<div class="window-title">${t.title}</div>`),x=`<div class="window-content">${t.content||""}${h}</div>`),e.innerHTML=`
            ...
            ${x}
        `,u.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",a=>{a.stopPropagation(),c()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(a=>{a.addEventListener("click",()=>{if(!e)return;let d=a.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(p=>p.classList.remove("active")),a.classList.add("active"),e.querySelectorAll(".tab-content").forEach(p=>p.classList.remove("active"));let m=e.querySelector(`.tab-content[data-tab-content="${d}"]`);m&&m.classList.add("active"),g(a,e)})}),setTimeout(()=>{e&&e.classList.add("open"),n&&n()},10)}function l(){if(!e||!e.classList.contains("open"))return;let u=e.querySelector(".tab.active");u&&g(u,e)}function g(u,v){setTimeout(()=>{let o=v.querySelector(".tab-bar");if(!o)return;let b=Array.from(o.querySelectorAll(".tab")),x=b.indexOf(u),h=o.clientWidth,a=b[Math.max(0,x-2)],d=b[Math.min(b.length-1,x+2)],m=o,p=a.offsetLeft-m.offsetLeft-25,I=d.offsetLeft+d.offsetWidth-m.offsetLeft+25-p,L=I<=h?p-(h-I)/2:u.offsetLeft-m.offsetLeft-h/2+u.offsetWidth/2;o.scrollTo({left:L,behavior:"smooth"})},350)}function c(u=!1){e&&(window.removeEventListener("resize",l),u?(e.remove(),e=null):(e.classList.remove("open"),s&&s(),setTimeout(()=>{e?.remove(),e=null},400)))}function f(u){t.content=u;let v=e?.querySelector(".window-content");v&&(v.innerHTML=u)}function w(){return!!(e&&e.classList.contains("open"))}return{open:r,close:c,setContent:f,isOpen:w,focus:i,id:t.id}}var ut="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ge(){return localStorage.getItem(ut)||ee.DARK}function ft(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(ut,t),gt(t)}function gt(t){let e=document.body;Object.values(ee).forEach(r=>{e.classList.remove(`theme-${r}`)}),e.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let n={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},i=n[t]||n[ee.DARK];if(s.setAttribute("content",i),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}e.classList.add("is-animated")}function bt(){let t=Ge();gt(t)}function P(t,e,s=null){let i={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=s?`<p class="placeholder-action">${s}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${i} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function N(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!s)return;if(!e){s.textContent="Last updated: never";return}let n=Date.now(),i=Math.floor((n-e)/1e3),r;i<60?r=`${i}s ago`:i<3600?r=`${Math.floor(i/60)}m ago`:r=`${Math.floor(i/3600)}h ago`,s.textContent=`Last updated: ${r}`}var us=0;function Le(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!s)return;let n=s.querySelector(".notification-badge");n&&(e>0?(n.textContent=e>9?"9+":e.toString(),n.style.display="flex"):n.style.display="none")}var ie=0,ae=0;function yt(t){ie=t,Ee()}function xt(t){ae=t,Ee()}function Ee(){let t=ie+ae;us=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let s=document.getElementById("alerts-menu-item");if(s){let l=s.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",s.appendChild(l)),l.textContent=ie>9?"9+":ie.toString(),l.style.display=ie>0?"flex":"none"}let n=document.getElementById("workspace-menu-item");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",n.appendChild(l)),l.textContent=ae>9?"9+":ae.toString(),l.style.display=ae>0?"flex":"none"}let i=document.getElementById("switch-alerts");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=ie>9?"9+":ie.toString(),l.style.display=ie>0?"flex":"none"}let r=document.getElementById("switch-workspace");if(r){let l=r.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",r.appendChild(l)),l.textContent=ae>9?"9+":ae.toString(),l.style.display=ae>0?"flex":"none"}}function ze(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Ee()}function ht(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Ee()}function fs(){return"https://event.easter.company"}function gs(){return"https://discord.easter.company"}var bs="http://127.0.0.1:8100",vs="http://127.0.0.1:8300",ys={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Ne(t){let e=N(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(i,r)=>{let l=ys[r];return l?`<span class="${l}">`:""});let s=(e.match(/<span/g)||[]).length,n=(e.match(/<\/span/g)||[]).length;return s>n&&(e+="</span>".repeat(s-n)),e}function me(t){if(!t)return"";let e=N(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(s,n)=>{let i=n.split("|").map(r=>r.trim());return i.every(r=>r.match(/^:?-+:?$/))?"":`<div class="md-table-row">${i.map(r=>`<span class="md-table-cell">${r}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var xs="https://sterling-javelin-12539.upstash.io",hs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function _(){return window.location.hostname.includes("easter.company")}var j=null,oe={lastDashboard:0,lastFrontend:0},Ve=!1,wt=0,Ct="dex_dashboard_snapshot";function ws(){let t=localStorage.getItem(Ct);if(t)try{let e=JSON.parse(t);j=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{j=null}}async function vt(){if(!(!_()||Ve)){Ve=!0,wt=Math.floor(Date.now()/1e3);try{let t=await Ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);j=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Ct,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ve=!1}}}function Cs(){if(!j||!j.agent_status)return;let t=j.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function Es(){if(!_())return;ws();let t=Math.floor(Date.now()/1e3),e=j?t-j.timestamp:1/0;(!j||e>120)&&await vt(),setInterval(()=>{let s=new Date,n=Math.floor(Date.now()/1e3),i=j?n-j.timestamp:1/0,r=n-wt,l=s.getSeconds()===59,g=i>300,c=r>60;(l&&c||g&&c)&&vt(),Cs()},1e3)}_()&&Es();async function Ts(t,...e){try{let n=await(await fetch(xs,{method:"POST",headers:{Authorization:`Bearer ${hs}`},body:JSON.stringify([t,...e])})).json();if(n.error)throw new Error(n.error);return n.result}catch(s){return console.error("Upstash Error:",s),null}}var we=null,Ce=null,He=!1,De=!1;async function B(t,e={}){if(_()){if(!j)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(j.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(j.processes),{status:200});if(t.startsWith("/events")){let i=new URLSearchParams(t.split("?")[1]||""),r=i.get("type")||i.get("event.type"),l=i.get("category"),g=i.get("order")||"desc",c=[];return r==="system.notification.generated"?c=[...j.alerts||[]]:r==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...j.blueprints||[]]:l==="messaging"?c=[...j.messaging_events||[]]:l==="system"?c=[...j.system_events||[]]:l==="cognitive"?c=[...j.cognitive_events||[]]:l==="moderation"?c=[...j.moderation_events||[]]:c=[...j.events||[]],g==="asc"?c.sort((f,w)=>f.timestamp-w.timestamp):c.sort((f,w)=>w.timestamp-f.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(j.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let i=t.split("/")[2],r=j.profiles?j.profiles[i]:null;return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(j.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(we)try{let i=await fetch(we+t,e);if(i.ok)return i;we=null}catch{we=null}let s=fs(),n=bs;try{let i=await fetch(s+t,e);if(i.ok)return we=s,He&&(console.log("\u2728 Production event service restored."),He=!1),i;throw new Error("Primary failed")}catch{He||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${n}`),He=!0);try{let r=await fetch(n+t,e);if(r.ok)return we=n,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function Te(t,e={}){if(_()){if(!j)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(j.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let i=t.split("/")[2],r=(j.contacts?.members||[]).find(l=>l.id===i);return r?new Response(JSON.stringify(r),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(Ce)try{let i=await fetch(Ce+t,e);if(i.ok)return i;Ce=null}catch{Ce=null}let s=gs(),n=vs;try{let i=await fetch(s+t,e);if(i.ok)return Ce=s,De&&(console.log("\u2728 Production discord service restored."),De=!1),i;throw new Error("Primary failed")}catch{De||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${n}`),De=!0);try{let r=await fetch(n+t,e);if(r.ok)return Ce=n,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Et=()=>`
...
`,Re=null,ue=new Set,Pe=[];async function ce(t=!1){let e=document.getElementById("alerts-list");if(!e)return;$s(),t&&(e.innerHTML="<p>Updating...</p>");let s="/events?ml=1000&format=json&event.type=system.notification.generated";try{let n=await B(s);if(!n.ok)throw new Error("Service is offline or unreachable.");let r=(await n.json()).events||[];Re=Date.now(),te(0,Re);let l=Date.now(),g=24*60*60*1e3,c=r.filter(m=>{let p=localStorage.getItem(`alert_read_ts_${m.id}`);if(!p)return!0;let y=parseInt(p);return l-y<g});c.sort((m,p)=>{let y=A=>{let T=A.event;if(typeof T=="string")try{T=JSON.parse(T)}catch{return"low"}return(T.priority||"low").toLowerCase()},I=A=>A==="critical"?4:A==="high"?3:A==="medium"?2:1,L=I(y(m)),S=I(y(p));return L!==S?S-L:p.timestamp-m.timestamp}),Pe=c;let f=m=>{let p=m.event;if(typeof p=="string")try{p=JSON.parse(p)}catch{return"low"}return(p.priority||"low").toLowerCase()},w=[],v=new Set(c.map(m=>f(m))).size>1;if(c.length>0){let m=null;c.forEach(p=>{let y=f(p);v&&y!==m&&(w.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),m=y),w.push(p)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=P("empty","No alerts yet."),ze();return}let o=m=>{let p=m.event;if(typeof p=="string")try{p=JSON.parse(p)}catch{return null}let y=(p.title||"Untitled Alert").trim(),I=(p.body||"No description provided.").trim(),L=p.summary||"",S=p.content||"",A=p.protocol||"",T=(p.priority||"low").toLowerCase(),D=!!p.alert,O=(p.category||"system").trim(),U=p.related_event_ids||[],J=p.audit_event_id,W=!!localStorage.getItem(`alert_read_ts_${m.id}`),k=new Date(m.timestamp*1e3),C=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),E=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=W?"event-border-grey":"event-border-blue";!W&&D&&(M="event-border-red"),W&&(T==="high"||T==="critical")?M="event-border-red":W&&T==="medium"&&(M="event-border-orange");let R=W?"alert-read":"alert-unread",z=ue.has(m.id),$=z?"expanded":"",q=z?"display: block;":"display: none;",H="",F="";U.length>0&&(F=`
        ...
        `:X=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #fff; white-space: pre-wrap; line-height: 1.6; text-align: left;">${me(I)}</div>
            </div>
        `,H=`
                ...
                ${X}
            `;let V=document.createElement("div");V.className=`event-item notification-item ${M} ${R} ${$} cursor-pointer priority-${T}`,V.dataset.alertId=m.id,V.onclick=function(le){let Q=this;if(Q.classList.contains("expanded")){Q.classList.remove("expanded"),ue.delete(m.id);let Me=Q.querySelector(".event-details");Me&&(Me.style.display="none")}else{Q.classList.add("expanded"),ue.add(m.id);let Me=Q.querySelector(".event-details");if(Me&&(Me.style.display="block"),!localStorage.getItem(`alert_read_ts_${m.id}`)){localStorage.setItem(`alert_read_ts_${m.id}`,Date.now().toString()),Q.classList.add("alert-read"),Q.classList.remove("alert-unread"),Q.classList.remove("event-border-blue","event-border-red","event-border-purple");let We="event-border-grey";T==="high"||T==="critical"?We="event-border-red":T==="medium"&&(We="event-border-orange"),Q.classList.add(We),ze()}}};let _e=`${A?A.toUpperCase():"GUARDIAN"} ALERT: ${L||y}`,ps={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[O]||"bx-bell",ms=T==="high"||T==="critical"?"#ff4d4d":T==="medium"?"#ffa500":"#888";V.innerHTML=`
                <div class="event-time">
                    <span class="event-time-main">${C}</span>
                    <span class="event-date">${E}</span>
                </div>
                <div class="event-icon"><i class='bx ${ps}'></i></div>
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${ms}; font-size: 0.8em; margin-left: 5px;">[${T.toUpperCase()}]</span>
                    </div>
            ...
            `;let rt=V.querySelector(".event-details");rt&&rt.addEventListener("click",le=>{le.stopPropagation()});let lt=V.querySelector(".close-details-btn");return lt&&lt.addEventListener("click",le=>{le.stopPropagation(),V.classList.remove("expanded");let Q=V.querySelector(".event-details");Q&&(Q.style.display="none"),ue.delete(m.id)}),V},b=m=>{let p=document.createElement("div");p.className="notification-divider",p.dataset.alertId=m.id;let y="#888888";return m.label==="CRITICAL"?y="#ff4d4d":m.label==="HIGH"?y="#ff8888":m.label==="MEDIUM"&&(y="#ffa500"),p.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,p.innerHTML=`<span style="white-space: nowrap;">${m.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,p},x=Array.from(e.children),h=new Map(x.map(m=>[m.dataset.alertId,m])),a=new Set(w.map(m=>m.id));x.forEach(m=>{let p=m.dataset.alertId;(!p||!a.has(p))&&m.remove()});let d=null;w.forEach((m,p)=>{let y=h.get(m.id);if(!y||t){if(y&&y.remove(),m.type==="divider")y=b(m);else{let I=o(m);if(!I)return;y=I}if(!y)return}p===0?e.firstElementChild!==y&&e.prepend(y):d&&d.nextElementSibling!==y&&d.after(y),d=y}),Re=Date.now(),te(0,Re),ze()}catch(n){console.error("Error fetching alerts:",n),e.children.length===0&&(e.innerHTML=P("offline","Failed to load alerts.","The event service may be offline."))}}function $s(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),s=document.getElementById("alerts-close-all"),n=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Pe.forEach(i=>{localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ce(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Pe.forEach(i=>{ue.add(i.id),localStorage.getItem(`alert_read_ts_${i.id}`)||localStorage.setItem(`alert_read_ts_${i.id}`,Date.now().toString())}),ce(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{ue.clear(),ce(!0)},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.notification.generated",{method:"DELETE"});let i=Date.now()-48*60*60*1e3;Pe.forEach(r=>{localStorage.setItem(`alert_read_ts_${r.id}`,i.toString())}),ue.clear(),ce(!0)}catch(i){console.error("Failed to clear alerts:",i)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}async function Ke(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await B(t);if(!e.ok)return;let n=(await e.json()).events||[],i=0;n.forEach(r=>{let l=r.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${r.id}`)||i++}),yt(i)}catch{}}var Tt=()=>`
...
`,fe=new Set,Oe=[],$e=null;async function ge(t=!1){let e=document.getElementById("roadmap-list");if(e){ks();try{let s=await B("/roadmap");if(!s.ok)throw new Error("Offline");let n=await s.json();Oe=n;let i=f=>{let w=fe.has(f.id),u=f.state==="published",v=f.state==="consumed",o="event-border-grey";u&&(o="event-border-blue"),v&&(o="event-border-purple");let x=new Date(f.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${o} cursor-pointer ${w?"expanded":""}`,h.dataset.itemId=f.id,h.onclick=m=>{if(m.target.closest("button"))return;if(h.classList.contains("expanded")){h.classList.remove("expanded");let y=h.querySelector(".event-details");y&&(y.style.display="none"),fe.delete(f.id)}else{h.classList.add("expanded");let y=h.querySelector(".event-details");y&&(y.style.display="block"),fe.add(f.id)}};let a=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${f.state.toUpperCase()}]</span>`;h.innerHTML=`
        <div class="event-time">
        ...
        <div class="event-content">
          ...
          <div class="event-message" style="white-space: pre-wrap;">${N(f.content)}</div>
          <div class="event-details" style="${w?"display: block;":"display: none;"} ">
            ...
            `}
            ${v?`<div style="margin-top: 15px; font-size: 0.8em; color: #888;">Consumed at: ${new Date(f.consumed_at*1e3).toLocaleString()}</div>`:""}
          </div>
        </div>
      `;let d=h.querySelector(".event-details");return d&&d.addEventListener("click",m=>{m.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Ss(f)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ms(f)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Ls(f.id)),h.querySelector(".close-details-btn")?.addEventListener("click",m=>{m.stopPropagation(),h.classList.remove("expanded");let p=h.querySelector(".event-details");p&&(p.style.display="none"),fe.delete(f.id)}),h},r=Array.from(e.children),l=new Map(r.map(f=>[f.dataset.itemId,f])),g=new Set(n.map(f=>f.id));if(r.forEach(f=>{let w=f.dataset.itemId;(!w||!g.has(w))&&f.remove()}),!Oe||Oe.length===0){e.innerHTML=P("empty","Your roadmap is empty.",_()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;n.forEach((f,w)=>{let u=l.get(f.id);(!u||t)&&(u&&u.remove(),u=i(f),!u)||(w===0?e.firstElementChild!==u&&e.prepend(u):c&&c.nextElementSibling!==u&&c.after(u),c=u)})}catch{e.children.length===0&&(e.innerHTML=P("offline","Failed to load roadmap.","The event service may be offline."))}}}function ks(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),s=document.getElementById("roadmap-cancel"),n=document.getElementById("roadmap-expand-all"),i=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{$e=null;let r=document.getElementById("roadmap-editor-input");r&&(r.value="");let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="block")},t.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="none"),$e=null},s.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input"),l=r?r.value:"";if(!l.trim())return;let g=$e?`/roadmap/${$e}`:"/roadmap",c=$e?"PATCH":"POST";try{await B(g,{method:c,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})});let f=document.getElementById("roadmap-editor-container");f&&(f.style.display="none"),ge(!0)}catch(f){console.error(f)}},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{Oe.forEach(r=>fe.add(r.id)),ge(!0)},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{fe.clear(),ge(!0)},i.dataset.listenerAttached="true")}function Ss(t){$e=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let s=document.getElementById("roadmap-editor-container");s&&(s.style.display="block",s.scrollIntoView({behavior:"smooth"}))}async function Ms(t){let e=t.state==="published"?"draft":"published";try{await B(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ge(!0)}catch(s){console.error(s)}}async function Ls(t){if(confirm("Delete this roadmap item?"))try{await B(`/roadmap/${t}`,{method:"DELETE"}),fe.delete(t),ge(!0)}catch(e){console.error(e)}}var St=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,kt=null,be=new Set,Lt=[];async function ve(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Is();let s="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let n=await B(s);if(!n.ok)throw new Error("Service is offline or unreachable.");let r=(await n.json()).events||[];if(Lt=r,kt=Date.now(),te(2,kt),r.length===0){e.innerHTML=P("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),Le(2,0);return}t&&(e.innerHTML="");let l=u=>{let v=u.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let o=(v.title||"Untitled Blueprint").trim(),b=(v.summary||v.body||"No summary provided.").trim(),x=(v.content||"").trim(),h=(v.category||"architecture").trim(),a=(v.related_services||v.affected_services||[]).map(z=>z.trim()),d=(v.implementation_path||[]).map(z=>z.trim()),m=v.source_event_ids||[],p=v.approved===!0,y=new Date(u.timestamp*1e3),I=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),L=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=be.has(u.id),A=S?"display: block;":"display: none;",T=document.createElement("div");T.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${p?"blueprint-approved":""}`,T.dataset.blueprintId=u.id,p&&(T.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",T.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let O=p?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";T.onclick=function(z){let $=this;if($.classList.contains("expanded")){$.classList.remove("expanded"),be.delete(u.id);let H=$.querySelector(".event-details");H&&(H.style.display="none")}else{$.classList.add("expanded"),be.add(u.id);let H=$.querySelector(".event-details");H&&(H.style.display="block")}};let U="";d.length>0&&(U=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${d.map(z=>`<li style="margin-bottom: 5px;">${N(z)}</li>`).join("")}</ul></div>
                    </div>
                `);let J="";m.length>0&&(J=`
                ...
                `);let K=a.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${a.join(", ")}</span></div>`:"<div></div>",W=_(),k=p?`
            ...
            `;T.innerHTML=`
                ...
                <div class="event-content">
                    ...
                    <div class="event-details" style="${A}">
                        ...
                        <div class="detail-pre" style="margin-bottom: 15px;">${N(b)}</div>

                        <h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">Technical Details</h5>
                        <div class="event-detail-block" style="text-align: left;">
                            <div class="detail-pre">${N(x)}</div>
                        </div>
                        ${U}
                        ${J}
                        ${k}
            ...
            `;let C=T.querySelector(".blueprint-approve-btn");C&&(C.onclick=async z=>{z.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await B(`/events/${u.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ve(!0)}catch($){console.error("Failed to approve blueprint:",$)}});let E=T.querySelector(".blueprint-delete-btn");E&&(E.onclick=async z=>{z.stopPropagation();let $=!p;E.innerHTML=$?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await B(`/events/${u.id}`,{method:"DELETE"})).ok&&ve(!0)}catch(q){console.error("Failed to delete blueprint:",q)}});let M=T.querySelector(".event-details");M&&M.addEventListener("click",z=>{z.stopPropagation()});let R=T.querySelector(".close-details-btn");return R&&R.addEventListener("click",z=>{z.stopPropagation(),T.classList.remove("expanded");let $=T.querySelector(".event-details");$&&($.style.display="none"),be.delete(u.id)}),T},g=Array.from(e.children),c=new Map(g.map(u=>[u.dataset.blueprintId,u])),f=new Set(r.map(u=>u.id));g.forEach(u=>{let v=u.dataset.blueprintId;(!v||!f.has(v))&&u.remove()});let w=null;r.forEach((u,v)=>{let o=c.get(u.id);if(!o||t){o&&o.remove();let b=l(u);if(!b)return;o=b}v===0?e.firstElementChild!==o&&e.prepend(o):w&&w.nextElementSibling!==o&&w.after(o),w=o}),Le(2,r.length),ht()}catch(n){console.error("Error fetching blueprints:",n),e.children.length===0&&(e.innerHTML=P("offline","Failed to load blueprints.","The event service may be offline."))}}async function It(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await B(t);if(!e.ok)return;let n=(await e.json()).events||[],i=0;n.forEach(r=>{let l=r.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&i++}),xt(i)}catch{}}function Is(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),s=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Lt.forEach(n=>be.add(n.id)),ve(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{be.clear(),ve(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.blueprint.generated",{method:"DELETE"}),be.clear(),ve(!0)}catch(n){console.error("Failed to clear blueprints:",n)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var re="STANDBY",At=null,ke=[],Y=null,je=null,Bt=()=>`
    <div id="progress-view-root" class="progress-container">
        <!-- Initial render will happen here -->
        ${_t()}
    </div>
  `;function _t(){switch(re){case"ACTIVE":return Bs();case"COMPLETED":return _s();case"STANDBY":default:return As()}}function As(){return`
  ...
  `}async function Se(){let t=document.getElementById("progress-view-root");t&&(re!==At&&(t.innerHTML=_t(),At=re),re==="ACTIVE"&&Hs())}function Hs(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),s=document.getElementById("active-task-progress-text"),n=document.getElementById("terminal-output");if(t&&Y&&(t.innerText=Y.title),e&&Y&&(e.style.width=`${Y.progress}%`),s&&Y&&(s.innerText=`${Y.progress}% COMPLETE`),n){let i=n.children.length;if(ke.length>i){for(let r=i;r<ke.length;r++){let l=ke[r],g=document.createElement("div");g.className="terminal-line",g.innerHTML=`
            <span class="line-time">${l.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${N(l.msg)}</span>
        `,n.appendChild(g)}n.scrollTop=n.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{re="ACTIVE",ke=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],Y={title:"Refactoring System Event Bus",progress:10},Se();let t=0,e=setInterval(()=>{if(re!=="ACTIVE"){clearInterval(e);return}t++,Y.progress=Math.min(100,Y.progress+Math.floor(Math.random()*15));let s=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<s.length&&ke.push({time:new Date().toLocaleTimeString(),msg:s[t]}),Y.progress>=100&&(re="COMPLETED",je={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),Se()},1500)});window.addEventListener("dex-mock-stop",()=>{re="STANDBY",Se()});window.addEventListener("dex-mock-reset",()=>{re="STANDBY",Se()});var Ht=()=>`
...
`,Dt=()=>`
    ...
    `,Ie=[],Ze={"313071000877137920":"Owen"},ye=null;async function Ue(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),s=document.getElementById("create-chore-form"),n=document.getElementById("save-chore-btn"),i=document.getElementById("cancel-chore-btn"),r=document.getElementById("new-chore-owner"),l=document.getElementById("task-owner-label"),g=document.getElementById("task-filter-owner"),c=document.getElementById("new-chore-instruction"),f=document.getElementById("new-chore-url"),w=document.getElementById("new-chore-schedule"),u=document.getElementById("form-title"),v=document.getElementById("form-icon");function o(x=null){if(s){if(ye=x?x.id:null,x){if(u&&(u.textContent="Update Research Task"),v&&(v.className="bx bx-edit-alt",v.style.color="#03dac6"),n&&(n.innerHTML="<i class='bx bx-check'></i> Update Task"),c&&(c.value=x.natural_instruction),f&&(f.value=x.execution_plan?.entry_url||""),r&&(r.value=x.owner_id),w&&(w.value=x.schedule),r&&l){let h=r.options[r.selectedIndex];if(h){let a=h.text.split(" (")[0];h.value==="dexter"&&(a="Dexter"),l.textContent=`Report result to: ${a}`}}}else u&&(u.textContent="Initialize Research Task"),v&&(v.className="bx bx-plus-circle",v.style.color="#bb86fc"),n&&(n.innerHTML="<i class='bx bx-zap'></i> Deploy Task"),c&&(c.value=""),f&&(f.value=""),r&&(r.value="313071000877137920"),w&&(w.value="every_24h"),l&&(l.textContent="Report result to: Owen");s.style.display="block",s.scrollIntoView({behavior:"smooth",block:"start"})}}if(r&&!r.dataset.populated&&!_())try{Te("/contacts").then(async x=>{x.ok&&(((await x.json()).members||[]).forEach(d=>{if(Ze[d.id]=d.nickname||d.username,d.id==="313071000877137920")return;let m=document.createElement("option");m.value=d.id;let p=d.nickname||d.username;m.textContent=`${p} (${d.username})`,r.appendChild(m)}),r.dataset.populated="true")})}catch{console.warn("Failed to fetch contacts for dropdown")}r&&l&&!r.dataset.listenerAttached&&(r.onchange=()=>{let x=r.options[r.selectedIndex];if(x){let h=x.text.split(" (")[0];x.value==="dexter"&&(h="Dexter"),l.textContent=`Report result to: ${h}`}},r.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onchange=()=>b(),g.dataset.listenerAttached="true");function b(){if(!t)return;let x=g?.value||"all",h=x==="all"?Ie:Ie.filter(d=>d.owner_id===x);if(h.length===0){t.innerHTML=P("empty",x==="all"?"No active tasks.":"No tasks found for this owner.",_()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let a=h.map(d=>{let m=d.last_run===0?"Never":new Date(d.last_run*1e3).toLocaleString(),p=d.memory?d.memory.length:0,y=d.status==="active"?"#03dac6":"#666",I=Ze[d.owner_id]||d.owner_id.substring(0,8);return`
                <div class="service-widget wide-task-card" style="border-left: 4px solid ${y}; width: 100%; display: flex; flex-direction: column; padding: 20px;">
                    <div class="service-widget-header" style="display: flex; align-items: flex-start; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 15px; margin-bottom: 15px;">
                        <div style="display: flex; gap: 15px; flex: 1;">
                            <i class='bx bx-search-alt' style="color: ${y}; font-size: 1.5em; margin-top: 2px;"></i>
                            <div style="text-align: left;">
                                ...
                                <div style="margin-top: 8px; display: flex; gap: 15px; align-items: center;">
                                    <span style="font-size: 0.7em; color: #666; font-family: 'JetBrains Mono', monospace;"><i class='bx bx-user' style="margin-right: 4px;"></i>${I}</span>
                                    <span style="font-size: 0.7em; color: #666; font-family: 'JetBrains Mono', monospace;"><i class='bx bx-time' style="margin-right: 4px;"></i>${d.schedule}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="service-widget-body" style="display: flex; flex-wrap: wrap; gap: 30px; align-items: center;">
                        <div style="display: flex; flex-direction: column; gap: 2px;">
                            ...
                            <span style="font-size: 0.85em; color: #fff; font-family: 'JetBrains Mono';">${m}</span>
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 2px;">
                            <span style="font-size: 0.6em; color: #555; text-transform: uppercase; letter-spacing: 1px;">Items Found</span>
                            <span style="font-size: 0.85em; color: #03dac6; font-weight: bold;">${p}</span>
                        </div>
            ...
            `}).join("");t.innerHTML=a,t.querySelectorAll(".edit-chore-btn").forEach(d=>{d.onclick=m=>{m.stopPropagation();let p=d.dataset.id,y=Ie.find(I=>I.id===p);y&&o(y)}}),t.querySelectorAll(".delete-chore-btn").forEach(d=>{d.onclick=async m=>{m.stopPropagation();let p=d.dataset.id;confirm("Delete this task?")&&(await B(`/chores/${p}`,{method:"DELETE"}),Ue())}})}e&&!e.dataset.listenerAttached&&(e.onclick=()=>{s&&(s.style.display==="none"||ye!==null?o(null):s.style.display="none")},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{s&&(s.style.display="none")},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let x=document.getElementById("new-chore-instruction"),h=document.getElementById("new-chore-url"),a=document.getElementById("new-chore-owner"),d=document.getElementById("new-chore-schedule"),m=x?.value,p=a?.value||"313071000877137920",y=d?.value||"every_24h";if(!m)return;let I=n.innerHTML;n.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{let L=ye?"PATCH":"POST",S=ye?`/chores/${ye}`:"/chores";await B(S,{method:L,headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:p,natural_instruction:m,entry_url:h?.value,schedule:y})}),s&&(s.style.display="none"),x&&(x.value=""),h&&(h.value=""),ye=null,Ue()}catch(L){console.error(L),alert(ye?"Failed to update research task":"Failed to create research task")}finally{n.innerHTML=I}},n.dataset.listenerAttached="true");try{let x=await B("/chores");if(!x.ok)throw new Error(`HTTP error! status: ${x.status}`);if(Ie=await x.json()||[],g){let a=g.value,d=Array.from(new Set(Ie.map(m=>m.owner_id)));g.innerHTML='<option value="all">All Owners</option>',d.forEach(m=>{let p=document.createElement("option");p.value=m,p.textContent=Ze[m]||`Owner: ${m.substring(0,8)}`,g.appendChild(p)}),g.value=a,g.selectedIndex===-1&&(g.value="all")}b()}catch(x){console.error("Failed to fetch chores",x)}}var zt=()=>`
...
`;async function Ye(){await Promise.all([ge(),ve(),Se(),Ue()])}var Ds=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function Ot(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function jt(t){if(!document.getElementById("dex-profile-styles")){let s=document.createElement("style");s.id="dex-profile-styles",s.textContent=Ds,document.head.appendChild(s)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",s=>{s.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",Te(`/profile/${t.id}`).then(async s=>{if(s.ok){let n=await s.json();Xe(e,t,n)}else{console.log("Profile not found or error, using mock data.");let n=Ot(t.id,t.username);Xe(e,t,n)}}).catch(s=>{console.error("Profile fetch error:",s);let n=Ot(t.id,t.username);Xe(e,t,n)})}function Xe(t,e,s){let n=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",i=()=>{let x=(s.attributes||s.facts||[]).map(y=>{let I=y.key||y.k,L=y.value||y.v;return`
            <div class="fact-chip">
                <span class="fact-key">${I}:</span>
                <span class="fact-val">${L}</span>
            </div>
        `}).join(""),h=s.cognitive_model||s,a=h.technical_level||h.techLevel||0,d=h.communication_style||h.commStyle||"Unknown",m=h.patience_level||h.patience||"Unknown",p=h.vibe||"Unknown";return`
        ...
        `},r=()=>{let x=s.dossier||{},h=x.identity||{},a=x.career||{},d=x.personal||{},m=x.social||[];return`
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="margin-top: 10px;">
                            ${(d.hobbies||[]).map(p=>`<div class="dossier-list-item">${p}</div>`).join("")}
                        </div>
                    </div>
                    ...
                    <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(d.habits||[]).map(p=>`<div class="dossier-list-item">${p}</div>`).join("")}
                        </div>
                    </div>
                     ...
                     <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(d.vices||[]).map(p=>`<div class="dossier-list-item" style="color: #cf6679;">${p}</div>`).join("")}
                        </div>
                    </div>
                </div>
            ...
            ${(s.topics||[]).map(x=>`
                <div class="topic-bar">
                    <div class="topic-header">
                        <span style="color: #eee;">${x.name}</span>
                        <span style="color: #bb86fc;">${x.val}%</span>
                    </div>
                    <div class="topic-track">
                        <div class="topic-fill" style="width: ${x.val}%"></div>
                    </div>
                </div>
            `).join("")}
        </div>
        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                ...
                <div class="profile-identity">
                    <h2>${N(e.username)}</h2>
                    <div class="profile-badges">${(s.badges||[]).map(x=>`<span class="profile-badge ${x==="Creator"?"master":""}">${x}</span>`).join("")}</div>
                </div>
            </div>
    ...
    `;t.innerHTML=f;let w=t.querySelector(".profile-card"),u=t.querySelector("#profile-expand-toggle"),v=t.querySelectorAll(".profile-tab-btn"),o=t.querySelectorAll(".tab-content"),b=t.querySelector(".close-profile-btn");b&&b.addEventListener("click",()=>{t.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>t.remove(),300)}),v.forEach(x=>{x.addEventListener("click",()=>{v.forEach(d=>d.classList.remove("active")),o.forEach(d=>d.classList.remove("active")),x.classList.add("active");let h=x.dataset.tab,a=t.querySelector(`#tab-${h}`);a&&a.classList.add("active")})}),u&&u.addEventListener("click",()=>{w.classList.toggle("expanded");let x=w.classList.contains("expanded");u.innerHTML=x?"<i class='bx bx-collapse-alt'></i> Collapse View":"<i class='bx bx-expand-alt'></i> Detailed Analysis"})}var Ut=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
...
`,zs=null;async function Qe(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Qe(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=s=>{let i=s.target.closest(".user-profile-card");if(i&&i.dataset.user)try{let r=JSON.parse(i.dataset.user);jt(r)}catch(r){console.error("Failed to parse user data",r)}},t.dataset.listenerAttached="true");try{let s=await Te("/contacts");if(!s.ok)throw new Error("Service unreachable");let i=(await s.json()).members||[];if(zs=Date.now(),i.length===0){t.innerHTML=P("empty","No contacts found.","Check your Discord connection.");return}let r={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};i.sort((l,g)=>{let c=r[l.level]??10,f=r[g.level]??10;return c!==f?c-f:l.username.localeCompare(g.username)}),t.innerHTML=i.map(l=>{let g=l.color&&l.color!==0,c=g?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",f=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",w="#888";l.level==="Me"||l.level==="Master"?w="#bb86fc":l.level==="Admin"?w="#cf6679":l.level==="Moderator"?w="#03dac6":l.level==="Contributor"&&(w="#ffa500");let u=l.level==="Me",v=u?"rgba(187, 134, 252, 0.08)":g?`${c}11`:"rgba(255,255,255,0.03)",o=u?"2px solid #bb86fc":g?`1px solid ${c}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div class="card-glow" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at 0% 0%, ${u?"#bb86fc":g?c:"transparent"}33, transparent 70%); pointer-events: none;"></div>
                    <div style="position: relative;">
                        <img src="${l.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${u?"2px solid #bb86fc":g?`2px solid ${c}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        ...
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${w}; font-weight: 600; text-transform: uppercase;">${u?"DEXTER (ME)":l.level}</span>
...
`,qe=null,xe=new Set,Ae=[],Z="all",Rs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Os(t){for(let[e,s]of Object.entries(Rs))if(s.includes(t))return e;return"system"}function js(t){return Ps[t]||"bx-square-rounded"}async function de(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Us();let n=`/events?ml=${Z==="all"?100:250}&format=json`;Z!=="all"&&(n+=`&category=${Z}`);try{let i=await B(n);if(!i.ok)throw new Error("Service unreachable");if(Ae=((await i.json()).events||[]).filter(v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return!0}let b=o.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),qe=Date.now(),te(1,qe),Ae.length===0){e.innerHTML=P("empty","No events found for this filter.");return}t&&(e.innerHTML="");let g=v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return null}let b=o.type,x=Os(b),h=js(b),a=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),d="event-border-grey";a&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?d="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?d="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?d="event-border-orange":b==="system.test.completed"?d=o.test?.status==="OK"&&o.lint?.status==="OK"&&o.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let m=a?"cursor-pointer":"",p=xe.has(v.id),y=p?"expanded":"",I=p?"display: block;":"display: none;",L=new Date(v.timestamp*1e3),S=L.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=L.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=qt(b,o),D=o.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${o.user_level})</span>`:"",O="";if(a){let k="";if(b==="engagement.decision"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                    ...
                    `}else if(b==="system.attention.expired"){let C=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,E=o.timestamp-o.last_active,M=Math.floor(E/60);k=`
                    ...
                    `}else if(b==="messaging.bot.sent_message"){let C=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,E="";o.eval_count&&(E=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let M="";if(o.chat_history&&o.chat_history.length>0){let R=o.chat_history.length,z=o.chat_history.map(($,q)=>{let H=$.name?$.name.toUpperCase():$.role.toUpperCase();!$.name&&H==="ASSISTANT"&&(H="DEXTER");let F=$.role==="user"?"#03dac6":$.role==="system"?"#ffb74d":"#bb86fc",G=q===R-1?"block":"none";return`
                                <div class="history-slide" data-index="${q}" style="display: ${G};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${F}; letter-spacing: 1px; font-weight: bold;">${H}</span>
                                        <span style="font-size: 0.7em; color: #666;">Turn ${q+1} of ${R}</span>
                                    </div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${N($.content)}</div>
                                </div>
                            `}).join("");M=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(b==="analysis.user.message_signals"){let C=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,E=o.signals||{};k=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${C("Raw Model Output")}
                            <pre class="detail-pre">${N(o.raw_output)||"None"}</pre>
                        </div>
                    `}else if(b==="moderation.explicit_content.deleted"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="analysis.link.completed"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${N(o.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${C("Description")}
                            <pre class="detail-pre">${N(o.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Content Summary")}
                            <pre class="detail-pre">${N(o.summary)||"None"}</pre>
                        </div>
                    `}else if(b==="analysis.visual.completed"){let C=M=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${M}</h5>`,E="";o.base64_preview?E=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${o.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:o.url&&(E=`<div class="event-detail-block"><img src="${o.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(b==="analysis.router.decision"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Input Context")}
                            <pre class="detail-pre">${N(o.raw_input)||"None"}</pre>
                        </div>
                    `}else if(b==="system.cli.command"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Output")}
                            <pre class="detail-pre">${N(o.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(b==="system.analysis.audit"){let C=o.success?"#03dac6":"#ff4d4d",E=o.success?"SUCCESS":"FAILED",M=H=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${H}</h5>`,R="";o.error&&(R=`
                            <div class="event-detail-block">
                                ${M("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${N(o.error)}</pre>
                            </div>
                        `);let z="";if(o.chat_history&&o.chat_history.length>0){let H=o.chat_history.length,F=o.chat_history.map((G,ne)=>{let X=G.name?G.name.toUpperCase():G.role.toUpperCase();!G.name&&X==="USER"&&(X="SYSTEM"),!G.name&&X==="ASSISTANT"&&(X="AGENT");let V=G.role==="user"?"#03dac6":G.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ne}" style="display: ${ne===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${ne+1} of ${H}</span>
                                    </div>
                            ...
                            <div class="event-detail-block">
                                ...
                                <div class="history-carousel" style="position: relative; background: rgba(255,255,255,0.03); border-radius: 4px; padding: 15px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        ...
                                        <button class="carousel-btn next-btn" style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 0.8em; transition: background 0.2s;" ${H<=1?"disabled":""}>Next <i class='bx bx-chevron-right'></i></button>
                                    </div>
                                </div>
                            </div>
                        `}let $="";if(o.corrections&&o.corrections.length>0){let H=o.corrections.map((F,G)=>`
                        ...
                        `}let q="";if(o.parsed_results&&o.parsed_results.length>0){let H=o.parsed_results.map(F=>`
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${C}; font-weight: bold;">${E} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${o.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${$}
                        ${z}
                    `}else if(b==="system.test.completed"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="error_occurred"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${C("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${N(o.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Context")}
                            <pre class="detail-pre">${JSON.stringify(o.context||{},null,2)}</pre>
                        </div>
                    `}else if(b==="system.cli.status"){let C=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${C("Message")}
                            <pre class="detail-pre">${N(o.message)}</pre>
                        </div>
                    `}else if(b==="messaging.user.sent_message"){let C="";o.attachments&&o.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${o.attachments.map(M=>{let R=M.content_type&&M.content_type.startsWith("image/"),z=(M.size/1024).toFixed(1)+" KB";return`
                ...
                `}let U=document.createElement("div");U.className=`event-item ${d} ${m} ${y}`,U.dataset.eventId=v.id,U.onclick=function(k){if(!a)return;let C=this;if(C.classList.contains("expanded")){C.classList.remove("expanded"),xe.delete(v.id);let M=C.querySelector(".event-details");M&&(M.style.display="none")}else{C.classList.add("expanded"),xe.add(v.id);let M=C.querySelector(".event-details");M&&(M.style.display="block")}},U.innerHTML=`
                <div class="event-time">
            ...
            `;let J=U.querySelector(".event-details");if(J&&J.addEventListener("click",k=>{k.stopPropagation()}),a){let k=U.querySelector(".close-details-btn");k&&k.addEventListener("click",C=>{C.stopPropagation();let E=C.target.closest(".event-item");if(E){E.classList.remove("expanded"),xe.delete(v.id);let M=E.querySelector(".event-details");M&&(M.style.display="none")}})}let K=U.querySelector(".prev-btn"),W=U.querySelector(".next-btn");if(K&&W){let k=0,C=Array.from(U.querySelectorAll(".history-slide")),E=C.length,M=()=>{C.forEach((R,z)=>{R.style.display=z===k?"block":"none"}),K.disabled=k===0,W.disabled=k===E-1,K.style.opacity=k===0?"0.5":"1",W.style.opacity=k===E-1?"0.5":"1"};K.addEventListener("click",R=>{R.stopPropagation(),k>0&&(k--,M())}),W.addEventListener("click",R=>{R.stopPropagation(),k<E-1&&(k++,M())}),M()}return U},c=Array.from(e.children),f=new Map(c.map(v=>[v.dataset.eventId,v])),w=new Set(Ae.map(v=>v.id));c.forEach(v=>{let o=v.dataset.eventId;(!o||!w.has(o))&&v.remove()});let u=null;Ae.forEach((v,o)=>{let b=f.get(v.id);(!b||t)&&(b&&b.remove(),b=g(v),!b)||(o===0?e.firstElementChild!==b&&e.prepend(b):u&&u.nextElementSibling!==b&&u.after(b),u=b)}),qe=Date.now(),te(1,qe)}catch(i){console.error("Error fetching events:",i),e.children.length===0&&(e.innerHTML=P("offline","Failed to load events.","The event service may be offline."))}}function Us(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),s=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ae.forEach(i=>xe.add(i.id)),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{xe.clear(),de(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.querySelectorAll(".filter-btn").forEach(i=>{i.onclick=()=>{s.querySelectorAll(".filter-btn").forEach(r=>r.classList.remove("active")),i.classList.add("active"),Z=i.dataset.filter||"all",de(!0)}}),s.dataset.listenerAttached="true"),s&&s.querySelectorAll(".filter-btn").forEach(i=>{i.dataset.filter===Z?i.classList.add("active"):i.classList.remove("active")});let n=document.getElementById("events-clear");n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let i=Z==="all"?"ALL":Z.toUpperCase();if(confirm(`Are you sure you want to delete ${i} events from the backend? This cannot be undone.`)){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let r="/events";if(Z!=="all"?r+=`?category=${Z}`:r+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await B(r,{method:"DELETE"})).ok)throw new Error("Failed to delete events");xe.clear(),de(!0)}catch(r){console.error("Failed to clear events:",r),alert("Failed to clear events. Check console.")}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var qs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Ft=qs;function Jt(){return`
    ...
    `}var Fs=null;async function Be(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await B("/logs");if(!e.ok)throw new Error("Logs offline");let s=await e.json();if(!s||s.length===0)return t.innerHTML=P("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let n=["local-ollama-0","local-cache-0"],i=s.filter(l=>!n.includes(l.id));i.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),i.reverse();let r=i.map(l=>{let g=l.logs.join(`
`),c=[...l.logs];if(c.length<25){let w=25-c.length;for(let u=0;u<w;u++)c.push("")}else c.length>25&&(c=c.slice(-25));let f=c.map(w=>Ne(w)).join(`
`);return`
                <div class="log-report">
                    <div class="log-report-header">
                        ...
                        <div style="display: flex; gap: 5px;">
                            ...
                            <button class="log-action-btn delete clear-logs-btn" data-service-id="${l.id}" title="Clear Logs" style="${_()?"display: none;":""}">
            ...
            `}).join("");return t.innerHTML=r,document.querySelectorAll(".copy-logs-btn").forEach(l=>{l.addEventListener("click",()=>{let g=l,c=unescape(g.dataset.logs||"");navigator.clipboard.writeText(c).then(()=>{let f=g.querySelector("i");f&&(f.classList.remove("bx-copy"),f.classList.add("bx-check"),setTimeout(()=>{f.classList.remove("bx-check"),f.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(l=>{l.addEventListener("click",async()=>{let c=l.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${c}?`))try{(await B(`/logs?service_id=${c}`,{method:"DELETE"})).ok&&Be()}catch(f){console.error("Error clearing logs:",f)}})}),Fs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=P("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Kt=()=>{let t=_()?"display: none;":"";return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Jt()}
        </div>`;async function ts(){Js(),await Promise.all([se(),st(),nt()]),await Be()}var Fe=null;function Js(){Fe||(Fe=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Fe),Fe=null;return}se(!0)},1e3))}var Wt=null,Gt=null;async function ss(){try{return await(await B("/system_monitor")).json()}catch{return null}}async function Vt(){try{return await(await B("/system/hardware")).json()}catch{return null}}async function Ws(){try{return await(await B("/processes")).json()}catch{return null}}async function Gs(){try{return await(await B("/agent/status")).json()}catch{return null}}async function st(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),s=document.querySelector("#hw-os .hw-content"),n=document.querySelector("#hw-cpu .hw-content"),i=document.querySelector("#hw-ram .hw-content"),r=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),g=a=>{if(a){if(s&&(s.innerHTML=`
                ...
                </div>`),i){let d=(a.MEMORY_BYTES/1073741824).toFixed(1);i.innerHTML=`
                ...
                </div>`}if(n&&a.CPU&&a.CPU.length>0){let d=a.CPU[0];n.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}r&&(a.GPU&&a.GPU.length>0?r.innerHTML=a.GPU.map(d=>{let m=(d.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),l&&a.STORAGE&&a.STORAGE.length>0?l.innerHTML=a.STORAGE.map(d=>{let m=(d.USED/1073741824).toFixed(1),p=(d.SIZE/(1024*1024*1024)).toFixed(1),y=d.SIZE>0?(d.USED/d.SIZE*100).toFixed(0):0,I=d.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let a=await Vt();a?(g(a),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),n&&!n.hasChildNodes())){let a=await Vt();g(a)}if(!t)return;let c=await ss();if(!c||!c.services){t.children.length===0&&(t.innerHTML=P("offline","Failed to load system metrics.","The event service may be offline."));let a=document.querySelector('[data-service-id="upstash-redis-ro"]');if(a){a.className="service-widget service-widget-offline",a.querySelector(".service-widget-status").textContent="ERROR";let d=a.querySelector(".service-widget-body");d&&(d.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}Wt=_()&&oe.lastDashboard||Date.now(),te(0,Wt||0);let f=c.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let a=document.getElementById("upstash-countdown");if(a){let p=59-new Date().getSeconds();p<=0&&(p+=60),a.textContent=`${p}s`}},1e3)),Array.from(t.children).forEach(a=>{a.classList.contains("service-widget")||a.remove()});function w(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:a.split(".").slice(0,3).join(".")||"-"}function u(a){return!a||a.length<=28?a:a.substring(0,28)+"..."}function v(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let m=parseInt(d[1])||0,p=parseInt(d[2])||0,y=parseInt(d[3])||0,I=parseFloat(d[4])||0,L=m*86400+p*3600+y*60+I,S=Math.floor(L/86400);if(S>0)return`${S}d`;let A=Math.floor(L/3600);if(A>0)return`${A}h`;let T=Math.floor(L/60);return T>0?`${T}m`:`${Math.floor(L)}s`}function o(a){if(a.id==="upstash-redis-ro"){let W=_()&&(oe.lastFrontend||oe.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
            ...
            </div>`}let d=a.status==="online",m=d?"service-widget-online":"service-widget-offline",p=d?"bx-check-circle":"bx-x-circle",y=d?"OK":"BAD",I=a.version?w(a.version.str):"-",L=a.cpu&&a.cpu!=="N/A"?a.cpu:"-",S=a.memory&&a.memory!=="N/A"?a.memory:"-",A=L!=="-"?"#00ff00":"#666",T=L!=="-"?"#fff":"#666",D=S!=="-"?"#00ff00":"#666",O=S!=="-"?"#fff":"#666",U=v(a.uptime),J="";d?J=`
                ...
                </div>`:J='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let K=_()?"easter.company":u(a.domain&&a.port?`${a.domain}:${a.port}`:"");return`<div class="service-widget ${m}" data-service-id="${a.id}"><div class="service-widget-header"><i class="bx ${p}"></i><h3>${a.short_name||a.id}</h3><span class="service-widget-status">${y}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${K}</span></div>${J}</div></div>`}let b=new Map(Array.from(t.querySelectorAll(".service-widget")).map(a=>[a.dataset.serviceId,a])),x=new Set(f.map(a=>a.id));for(let[a,d]of b)x.has(a)||d.remove();let h=new Set;f.forEach(a=>{if(h.has(a.id))return;h.add(a.id);let d=o(a),m=b.get(a.id);if(m&&m.parentNode)if(a.id==="upstash-redis-ro"){let p=_()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),y=new Date(p).toLocaleTimeString(),I=m.querySelector(".sync-time-label");I&&(I.textContent=`Last synced: ${y}`)}else m.outerHTML!==d&&(m.outerHTML=d);else t.insertAdjacentHTML("beforeend",d)})}async function nt(){let t=document.getElementById("models-widgets");if(!t)return;let e=await ss();if(!e){t.children.length===0&&(t.innerHTML=P("offline","Failed to load model status.","The event service may be offline."));return}Gt=Date.now(),te(2,Gt);let s=e.models||[],n=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function i(c){let f=c.status==="Ready";return`
                ...
                </div>`}function r(c){let f=c.status==="Ready";return`
                ...
                </div>`}function l(c){let f=c.status==="Downloaded",w=f?"service-widget-online":"service-widget-offline",u=f?"OK":"MISSING",v=f&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",o=c.name;return c.type==="custom"&&o.endsWith(":latest")&&(o=o.replace(":latest","")),`<div class="service-widget ${w}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${f?"bx-check-circle":"bx-x-circle"}"></i><h3>${o}</h3><span class="service-widget-status">${u}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let g="";if(n&&(g+=i(n)),e.xtts&&(g+=r(e.xtts)),g+=s.map(l).join(""),!g){t.innerHTML=P("empty","No models found.");return}t.innerHTML!==g&&(t.innerHTML=g)}async function se(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let s=document.getElementById("guardian-sentry-val"),n=document.getElementById("guardian-idle-val"),i=document.getElementById("guardian-total-idle"),r=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),g=document.getElementById("guardian-reset-btn"),c=document.getElementById("analyzer-reset-btn"),f=document.getElementById("fabricator-reset-btn"),w=document.getElementById("courier-reset-btn"),u=document.getElementById("system-pause-toggle-btn");u&&!u.dataset.listenerAttached&&(u.onclick=async()=>{let p=u.querySelector(".bx-play")?"/agent/resume":"/agent/pause";u.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B(p,{method:"POST"}),await se()}catch{u.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>se(),2e3)}},u.dataset.listenerAttached="true"),g&&!g.dataset.listenerAttached&&(g.onclick=async()=>{g.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{g.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{g.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),se()}catch{g.innerHTML="<i class='bx bx-error'></i>"}},g.dataset.listenerAttached="true"),c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{c.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),se()}catch{c.innerHTML="<i class='bx bx-error'></i>"}},c.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onclick=async()=>{f.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/fabricator/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{f.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{f.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),se()}catch{f.innerHTML="<i class='bx bx-error'></i>"}},f.dataset.listenerAttached="true"),w&&!w.dataset.listenerAttached&&(w.onclick=async()=>{w.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/agent/reset?protocol=researcher",{method:"POST"}),setTimeout(()=>{w.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{w.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),se()}catch{w.innerHTML="<i class='bx bx-error'></i>"}},w.dataset.listenerAttached="true");let v=await Gs();if(v&&v.agents){let m=v.agents.guardian||{protocols:{}},p=v.agents.analyzer||{protocols:{}},y=v.agents.imaginator||{protocols:{}},I=v.agents.fabricator||{protocols:{}},L=v.agents.courier||{protocols:{}},S=v.system||{},A=Math.floor(Date.now()/1e3),T={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction",researcher:"Researcher"},D=$=>{$<0&&($=0);let q=Math.floor($/3600),H=Math.floor($%3600/60),F=$%60;return q>0?`${q}h ${H}m`:H>0?`${H}m ${F}s`:`${F}s`},O=($,q,H,F)=>{if(!$)return;let G=T[F]||F.toUpperCase(),ne=$.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(ne&&(ne.textContent=G),!H){$.textContent="Inactive",$.style.color="#666";return}let X=H.status;if(X==="Working")$.textContent="Working",$.style.color="#bb86fc";else if(X==="Ready")$.textContent="Ready",$.style.color="#5eff5e";else{let V=H.cooldown;if(_()&&(V=H.next_run-A),V<=0)$.textContent="Ready",$.style.color="#5eff5e";else{let _e=Math.floor(V/60),ot=V%60;$.textContent=`${_e}m ${ot}s`,$.style.color="#fff"}}q&&H.stats&&(q.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 2px;">
          ...
          `)};s&&O(s,document.getElementById("guardian-sentry-stats"),m.protocols.sentry,"sentry");let U=document.getElementById("analyzer-synthesis-val"),J=document.getElementById("analyzer-synthesis-stats");U&&O(U,J,p.protocols.synthesis,"synthesis");let K=document.getElementById("imaginator-alert_review-val"),W=document.getElementById("imaginator-alert_review-stats");K&&O(K,W,y.protocols.alert_review,"alert_review");let k=document.getElementById("fabricator-construction-val"),C=document.getElementById("fabricator-construction-stats");k&&O(k,C,I.protocols.construction,"construction");let E=document.getElementById("courier-researcher-val"),M=document.getElementById("courier-researcher-stats");E&&O(E,M,L.protocols.researcher,"researcher");let R=document.getElementById("system-state-label"),z=document.getElementById("system-state-val");if(z&&S.state){let $=S.state,q=D(S.state_time||0);R&&(R.textContent=`State: ${$.toUpperCase()}`),z.textContent=q,$==="idle"?z.style.color=S.state_time>300?"#5eff5e":"#fff":z.style.color="#bb86fc",u&&($==="paused"?(u.innerHTML="<i class='bx bx-play'></i>",u.title="Resume System",u.style.color="#ff9800"):(u.innerHTML="<i class='bx bx-pause'></i>",u.title="Pause System",u.style.color=""))}i&&(i.textContent=D(S.metrics?.total_idle_time||0)),r&&(r.textContent=D(S.metrics?.total_active_time||0)),l&&(l.textContent=D(S.metrics?.total_waste_time||0))}else[s,n,i,r,l].forEach(p=>{p&&(p.textContent="-",p.style.color="#666")});if(t)return;let o=await Ws(),b=[],x=[],h=[];o&&(Array.isArray(o)?b=o:(b=o.active||[],x=o.queue||[],h=o.history||[],h.sort((m,p)=>(p.end_time||0)-(m.end_time||0)))),e&&(b.length===0?e.querySelector(".tab-placeholder")||(e.innerHTML=P("empty","No active processes.")):((e.querySelector(".tab-placeholder")||e.querySelector("p"))&&(e.innerHTML=""),tt(e,b,!1)));let a=document.getElementById("processes-queue-widgets");a&&(x.length===0?!a.querySelector(".tab-placeholder")&&!a.querySelector('div[style*="font-style: italic"]')&&(a.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(a.innerHTML="",tt(a,x,!1)));let d=document.getElementById("processes-history-widgets");d&&(h.length===0?d.querySelector(".tab-placeholder")||(d.innerHTML=P("empty","No recent history.")):(d.querySelector(".tab-placeholder")&&(d.innerHTML=""),tt(d,h,!0))),Le(1,b.length)}function tt(t,e,s){function n(c){let f="";c.end_time?f=`${c.end_time-c.start_time}s`:f=`${Math.floor(Date.now()/1e3-c.start_time)}s`;let w=c.retries>0?`<span class="process-retry-badge">Retry ${c.retries}</span>`:"",u=c.channel_id,v={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(v[u]?u=v[u]:/^\d+$/.test(u)&&(u=`Channel ${u}`),s)return`
        <div class="process-history-item" data-channel-id="${c.channel_id}-${c.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                <div class="service-widget process-widget" data-channel-id="${c.channel_id}-${c.start_time}" style="">
                    ...
                    <div class="service-widget-body">
                        ...
                        <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${o}">${f}</span>
                        </div>
                         <div class="service-widget-info">
                ...
                </div>`}let i=s?".process-history-item":".process-widget",r=new Map(Array.from(t.querySelectorAll(i)).map(c=>[c.dataset.channelId,c])),l=new Set(e.map(c=>`${c.channel_id}-${c.start_time}`));for(let[c,f]of r)c&&!l.has(c)&&f.remove();let g=new Set;e.forEach(c=>{let f=`${c.channel_id}-${c.start_time}`;if(g.has(f))return;g.add(f);let w=n(c),u=r.get(f);if(u&&u.parentNode){u.outerHTML!==w&&(u.outerHTML=w);let v=t.querySelector(`[data-channel-id="${f}"]`);v&&t.appendChild(v)}else t.insertAdjacentHTML("beforeend",w)})}function Je(){let t=Ge(),e="Notification"in window,s={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function it(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(n=>{n.addEventListener("click",function(){let i=this.dataset.theme;i&&(ft(i),t.setContent(Je()),it(t))})});let s=document.getElementById("notifications-toggle");s&&"Notification"in window?s.onclick=async n=>{let i=n.target;if(i.checked)try{await Notification.requestPermission()!=="granted"&&(i.checked=!1)}catch{i.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),i.checked=!0)}:s&&(s.disabled=!0)}var is=()=>`
    ...
    `;async function as(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await ns(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await ns(t)}async function ns(t){try{let e=await B("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let s=await e.json();if(!s||s.length===0){t.innerHTML=P("empty","No web history found.");return}let n=`
        ...
        `;s.forEach((g,c)=>{let f=new Date(g.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),w=g.screenshot?`<img src="data:image/png;base64,${g.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';n+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Vs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[s,n]of Object.entries(t)){let i=ls.filter(r=>r.category===s);i.length!==0&&(e+=`
    ...
    </div>`,e},at=!1;function Ks(t){let e=document.getElementById("cli-terminal-overlay");if(!e){e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e);let c=document.getElementById("close-terminal-btn");c&&(c.onclick=()=>os());let f=document.getElementById("terminal-action-btn");f&&(f.onclick=()=>os())}let s=document.getElementById("cli-terminal-body"),n=document.getElementById("cli-docs-pane");s&&(s.innerHTML="");let i=t.docs||{overview:t.description,details:[],extended_usage:t.usage};n&&(n.innerHTML=`
    ...
    `);let r=document.getElementById("terminal-cmd-name");r&&(r.textContent=`dex ${t.id}`);let l=document.getElementById("terminal-status-badge");l&&(l.className="terminal-status status-running",l.textContent="Running");let g=document.getElementById("terminal-action-btn");return g&&(g.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",at=!0,s}function os(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",at=!1}function rs(t,e,s="output"){if(!at||!t)return;let n=document.createElement("div");if(n.className=`terminal-line terminal-${s}`,s==="prompt")n.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let i=Ne(e);n.innerHTML=i||e}t.appendChild(n),t.scrollTop=t.scrollHeight}async function Zs(t){let e=ls.find(l=>l.id===t);if(!e)return;let s=Ks(e);s&&rs(s,`dex ${t}`,"prompt");let n=e.demo_output||["Executing command...","\u2713 Done."];for(let l of n){await new Promise(c=>setTimeout(c,400+Math.random()*600));let g="output";l.includes("[ERROR]")?g="error":l.includes("[SUCCESS]")||l.includes("\u2713")?g="success":l.includes("!")&&(g="warning"),s&&rs(s,l,g)}let i=document.getElementById("terminal-status-badge");i&&(i.className="terminal-status status-success",i.textContent="Completed (Demo)");let r=document.getElementById("terminal-action-btn");r&&(r.style.display="block")}function cs(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Vs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let s=e.querySelector("code"),n=s?s.textContent:"";n&&navigator.clipboard.writeText(n).then(()=>{let i=e.querySelector("i");i&&(i.className="bx bx-check",i.style.color="#5eff5e",setTimeout(()=>{i.className="bx bx-copy",i.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(s=>{let n=s;s.addEventListener("mouseenter",()=>{n.style.transform="translateY(-5px)",n.style.borderColor="rgba(255,255,255,0.15)",n.style.backgroundColor="rgba(255,255,255,0.05)"}),s.addEventListener("mouseleave",()=>{n.style.transform="translateY(0)",n.style.borderColor="rgba(255,255,255,0.05)",n.style.backgroundColor="rgba(255,255,255,0.03)"}),s.addEventListener("click",()=>{let i=n.dataset.cmd;i&&Zs(i)})})}async function Ys(){if(!_())try{if(!(await B("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ds(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}dt(),pt(),Ys(),bt(),ct();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&cs();let e=[],s=document.getElementById("windows-container");s&&s.setAttribute("data-count","0");let n=a=>{localStorage.setItem("dex_last_window",a)};function i(){for(;e.length>1;)e.shift().close(!0);let a=document.getElementById("windows-container"),d=document.querySelector("nav"),m=document.querySelector("footer"),p=window.location.pathname==="/"||window.location.pathname==="/index.html",y=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");a&&a.setAttribute("data-count",e.length.toString()),e.forEach(D=>{let O=document.getElementById(D.id);O&&O.classList.remove("hide-close")});let I=document.getElementById("dexter-menu-container"),L=document.getElementById("nav-window-switcher"),S=document.getElementById("settings-icon"),A=document.getElementById("close-all-windows"),T=window.innerWidth<880;if(!T){let D=document.getElementById("dexter-dropdown"),O=document.getElementById("dexter-menu-btn");D&&D.classList.remove("active"),O&&O.classList.remove("active"),a&&a.classList.remove("menu-open")}if(he(e.length>0),e.length>0)if(m?.classList.add("hide"),A&&(A.style.display=T?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",d?.classList.add("window-open"),a&&(a.style.paddingTop="60px"),I&&(I.style.display=T?"flex":"none"),S&&(S.style.display=T?"block":"none"),!T&&L){let D=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(D)?(L.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{n("alerts-window"),r(g)}),document.getElementById("switch-events")?.addEventListener("click",()=>{n("events-window"),r(c)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{n("monitor-window"),r(w)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{n("contacts-window"),r(f)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{n("workspace-window"),r(u)})):L.innerHTML=""}else L&&(L.innerHTML="");else d?.classList.remove("window-open"),A&&(A.style.display="none"),a&&(a.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",p||y?m?.classList.remove("hide"):m?.classList.add("hide"),I&&(I.style.display="flex"),S&&(S.style.display="block"),L&&(L.innerHTML="");Ee()}function r(a){if(a.isOpen()){a.close();return}for(;e.length>0;)e.pop().close(!0);e.push(a),a.open(),i()}function l(){[...e].forEach(d=>d.close()),e=[]}window.addEventListener("resize",i);let g=pe({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Et(),onOpen:()=>ce(),onClose:()=>{let a=e.indexOf(g);a>-1&&e.splice(a,1),i()}}),c=pe({id:"events-window",title:"Events",icon:"bx-calendar-event",content:et(),onOpen:()=>{c.setContent(et()),de()},onClose:()=>{let a=e.indexOf(c);a>-1&&e.splice(a,1),i()}}),f=pe({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Ut(),onOpen:()=>Qe(),onClose:()=>{let a=e.indexOf(f);a>-1&&e.splice(a,1),i()}}),w=pe({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Yt()},{icon:"bxs-component",title:"Processes",content:Zt()},{icon:"bxs-brain",title:"Models",content:Xt()},{icon:"bx-globe",title:"Web",content:is()},{icon:"bxs-hdd",title:"Hardware",content:Qt()},{icon:"bxs-terminal",title:"Logs",content:es()},{icon:"bxs-zap",title:"Agents",content:Kt()}].filter(a=>_()?a.title!=="Hardware"&&a.title!=="Logs":!0),onOpen:()=>{st(),se(),nt(),as(),Be()},onClose:()=>{let a=e.indexOf(w);a>-1&&e.splice(a,1),i()}}),u=pe({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:zt()},{icon:"bx-map-alt",title:"Roadmap",content:Nt()},{icon:"bx-paint",title:"Blueprints",content:Rt()},{icon:"bx-task",title:"Tasks",content:Pt()}],onOpen:()=>Ye(),onClose:()=>{let a=e.indexOf(u);a>-1&&e.splice(a,1),i()}}),v=pe({id:"settings-window",title:"Settings",icon:"bx-cog",content:Je(),onOpen:()=>{v.setContent(Je()),it(v)},onClose:()=>{let a=e.indexOf(v);a>-1&&e.splice(a,1),i()}});window.dexter={viewEvent:a=>{c.isOpen()||r(c),setTimeout(()=>{let d=document.querySelector(`.event-item[data-event-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)},viewAlert:a=>{g.isOpen()||r(g),setTimeout(()=>{let d=document.querySelector(`.event-item[data-alert-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)}};let o=()=>{let a=document.getElementById("dexter-dropdown"),d=document.getElementById("dexter-menu-btn");a&&d&&(a.classList.remove("active"),d.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let a=document.getElementById("dexter-menu-btn"),d=document.getElementById("settings-icon"),m=document.getElementById("close-all-windows"),p=document.getElementById("nav-left-container"),y=document.getElementById("dexter-dropdown"),I=document.getElementById("windows-container");a&&y&&(a.onclick=S=>{S.stopPropagation();let A=window.innerWidth<880;if(A)y.style.top="",y.style.left="",y.style.right="",y.style.transform="";else{let D=a.getBoundingClientRect(),U=document.querySelector("nav").getBoundingClientRect(),J=220,K=10,k=D.left+D.width/2-J/2,C=U.right-10;k+J>C&&(k=C-J),k<10&&(k=10),y.style.top=U.bottom+K+"px",y.style.left=k+"px",y.style.right="auto",y.style.transform="none"}y.classList.toggle("active"),a.classList.toggle("active");let T=y.classList.contains("active");if(A){let D=document.querySelector("nav");T?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),D?.classList.add("window-open"),I?.classList.add("menu-open"),he(!0)):(I?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),D?.classList.remove("window-open"),he(!1)))}}),d&&(d.onclick=S=>{S.stopPropagation(),r(v)}),m&&(m.onclick=S=>{S.stopPropagation(),l()});let L=(S,A,T)=>{let D=document.getElementById(S);D&&(D.onclick=O=>{O.stopPropagation(),o(),T&&n(T),r(A)})};L("alerts-menu-item",g,"alerts-window"),L("events-menu-item",c,"events-window"),L("monitor-menu-item",w,"monitor-window"),L("contacts-menu-item",f,"contacts-window"),L("workspace-menu-item",u,"workspace-window"),p&&(p.onclick=S=>{if(S.stopPropagation(),y&&y.classList.contains("active")){o(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),he(!1));return}if(e.length>0)l();else{let A=window.location.pathname;if(!(A==="/"||A==="/index.html")){let O=(A.endsWith("/")&&A.length>1?A.slice(0,-1):A).split("/");O.pop();let U=O.join("/")||"/";window.location.href=U}}}),document.addEventListener("click",()=>{let S=window.innerWidth<880;y&&y.classList.contains("active")&&(o(),S&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),he(!1)))}),y&&(y.onclick=S=>S.stopPropagation())})();let x=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!x&&!h&&document.querySelector("footer")?.classList.add("hide"),_()||setInterval(()=>{c.isOpen()&&de(),g.isOpen()?ce():Ke()},1e3),setInterval(()=>{_()&&(g.isOpen()?ce():Ke()),u.isOpen()?Ye():It(),_()&&c.isOpen()&&de(),w.isOpen()&&ts()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ds):ds();})();
