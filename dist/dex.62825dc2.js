"use strict";(()=>{function ct(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.prepend(t)}}function dt(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,l=document.createElement("nav");l.innerHTML=n,document.body.prepend(l);let o=document.createElement("div");o.id="dexter-dropdown",o.className="dexter-dropdown",o.innerHTML=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var mt=1e3;function me(t){let e=null,a=t.onClose||null,i=t.onOpen||null;function n(){e&&(e.style.zIndex=(++mt).toString())}function l(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",o),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++mt).toString(),e.addEventListener("mousedown",n);let v=t.icon||"bx-window",s="",u="",C,A='<div class="window-bottom-spacer"></div>';t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((x,y)=>{let c=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${C}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",b=>{b.stopPropagation(),d()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach(b=>{b.addEventListener("click",()=>{if(!e)return;let p=b.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(y=>y.classList.remove("active")),b.classList.add("active"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.remove("active"));let x=e.querySelector(`.tab-content[data-tab-content="${p}"]`);x&&x.classList.add("active"),f(b,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&f(m,e)}function f(m,v){setTimeout(()=>{let s=v.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),C=u.indexOf(m),A=s.clientWidth,b=u[Math.max(0,C-2)],p=u[Math.min(u.length-1,C+2)],x=s,y=b.offsetLeft-x.offsetLeft-25,r=p.offsetLeft+p.offsetWidth-x.offsetLeft+25-y,w=r<=A?y-(A-r)/2:m.offsetLeft-x.offsetLeft-A/2+m.offsetWidth/2;s.scrollTo({left:w,behavior:"smooth"})},350)}function d(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function h(m){t.content=m;let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function T(){return!!(e&&e.classList.contains("open"))}return{open:l,close:d,setContent:h,isOpen:T,focus:n,id:t.id}}var ut="easter_theme",ee={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ze(){return localStorage.getItem(ut)||ee.DARK}function gt(t){if(!Object.values(ee).includes(t))throw new Error("Invalid theme");localStorage.setItem(ut,t),ft(t)}function ft(t){let e=document.body;Object.values(ee).forEach(l=>{e.classList.remove(`theme-${l}`)}),e.classList.add(`theme-${t}`);let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.getElementsByTagName("head")[0].appendChild(a));let i={[ee.DARK]:"#050507",[ee.LIGHT]:"#FFFFFF",[ee.LEGACY]:"#000000"},n=i[t]||i[ee.DARK];if(a.setAttribute("content",n),!document.querySelector(".background")){let l=document.createElement("div");l.className="background",document.body.prepend(l)}e.classList.add("is-animated")}function bt(){let t=Ze();ft(t)}function J(t,e,a=null,i="default"){let l={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder" data-placeholder-id="${i}"><i class='bx ${l} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function j(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function te(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let i=Date.now(),n=Math.floor((i-e)/1e3),l;n<60?l=`${n}s ago`:n<3600?l=`${Math.floor(n/60)}m ago`:l=`${Math.floor(n/3600)}h ago`,a.textContent=`Last updated: ${l}`}var ps=0;function Re(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let i=a.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var ie=0,ae=0;function yt(t){ie=t,ke()}function xt(t){ae=t,ke()}function ke(){let t=ie+ae;ps=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let a=document.getElementById("alerts-menu-item");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",a.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",i.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let o=n.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",n.appendChild(o)),o.textContent=ie>9?"9+":ie.toString(),o.style.display=ie>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let o=l.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",l.appendChild(o)),o.textContent=ae>9?"9+":ae.toString(),o.style.display=ae>0?"flex":"none"}}function Xe(){let t=document.getElementById("alerts-list");if(!t)return;ie=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ke()}function ht(){let t=document.getElementById("blueprints-list");if(!t)return;ae=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ke()}function ms(){return"https://event.easter.company"}function us(){return"https://discord.easter.company"}var gs="http://127.0.0.1:8100",fs="http://127.0.0.1:8300",bs={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Oe(t){let e=j(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,l)=>{let o=bs[l];return o?`<span class="${o}">`:""});let a=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return a>i&&(e+="</span>".repeat(a-i)),e}function re(t){if(!t)return"";let e=j(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^<strong>(.*)<\/strong>$/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(a,i)=>{let n=i.split("|").map(l=>l.trim());return n.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var vs="https://sterling-javelin-12539.upstash.io",ys="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function P(){return window.location.hostname.includes("easter.company")}var F=null,oe={lastDashboard:0,lastFrontend:0},Ye=!1,wt=0,Ct="dex_dashboard_snapshot";function xs(){let t=localStorage.getItem(Ct);if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{F=null}}async function vt(){if(!(!P()||Ye)){Ye=!0,wt=Math.floor(Date.now()/1e3);try{let t=await Cs("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);F=e,oe.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),oe.lastFrontend=Date.now(),localStorage.setItem(Ct,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Ye=!1}}}function hs(){if(!F||!F.agent_status)return;let t=F.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function ws(){if(!P())return;xs();let t=Math.floor(Date.now()/1e3),e=F?t-F.timestamp:1/0;(!F||e>120)&&await vt(),setInterval(()=>{let a=new Date,i=Math.floor(Date.now()/1e3),n=F?i-F.timestamp:1/0,l=i-wt,o=a.getSeconds()===59,f=n>300,d=l>60;(o&&d||f&&d)&&vt(),hs()},1e3)}P()&&ws();async function Cs(t,...e){try{let i=await(await fetch(vs,{method:"POST",headers:{Authorization:`Bearer ${ys}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(a){return console.error("Upstash Error:",a),null}}var $e=null,Se=null,Ne=!1,Pe=!1;async function _(t,e={}){if(P()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(F.monitor),{status:200});if(t.startsWith("/system/options"))return new Response(JSON.stringify(F.options||{}),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(F.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),l=n.get("type")||n.get("event.type"),o=n.get("category"),f=n.get("order")||"desc",d=[];return l==="system.notification.generated"?d=[...F.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?d=[...F.blueprints||[]]:o==="messaging"?d=[...F.messaging_events||[]]:o==="system"?d=[...F.system_events||[]]:o==="cognitive"?d=[...F.cognitive_events||[]]:o==="moderation"?d=[...F.moderation_events||[]]:d=[...F.events||[]],f==="asc"?d.sort((h,T)=>h.timestamp-T.timestamp):d.sort((h,T)=>T.timestamp-h.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(F.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],l=F.profiles?F.profiles[n]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(F.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify(F.chores||[]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if($e)try{let n=await fetch($e+t,e);if(n.ok)return n;$e=null}catch{$e=null}let a=ms(),i=gs;try{let n=await fetch(a+t,e);if(n.ok)return $e=a,Ne&&(console.log("\u2728 Production event service restored."),Ne=!1),n;throw new Error("Primary failed")}catch{Ne||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ne=!0);try{let l=await fetch(i+t,e);if(l.ok)return $e=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function ue(t,e={}){if(P()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(F.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],l=(F.contacts?.members||[]).find(o=>o.id===n);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(Se)try{let n=await fetch(Se+t,e);if(n.ok)return n;Se=null}catch{Se=null}let a=us(),i=fs;try{let n=await fetch(a+t,e);if(n.ok)return Se=a,Pe&&(console.log("\u2728 Production discord service restored."),Pe=!1),n;throw new Error("Primary failed")}catch{Pe||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Pe=!0);try{let l=await fetch(i+t,e);if(l.ok)return Se=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}var Et=()=>`
...
`,je=null,ge=new Set,qe=[];async function de(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Es(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await _(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];je=Date.now(),te(0,je);let o=Date.now(),f=24*60*60*1e3,d=l.filter(p=>{let x=localStorage.getItem(`alert_read_ts_${p.id}`);if(!x)return!0;let y=parseInt(x);return o-y<f});d.sort((p,x)=>{let y=E=>{let g=E.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},c=E=>E==="critical"?4:E==="high"?3:E==="medium"?2:1,r=c(y(p)),w=c(y(x));return r!==w?w-r:x.timestamp-p.timestamp}),qe=d;let h=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return"low"}return(x.priority||"low").toLowerCase()},T=[];if(d.length===0)T.push({id:"placeholder-empty",type:"placeholder",message:"No alerts, all systems nominal"});else{let x=new Set(d.map(c=>h(c))).size>1,y=null;d.forEach(c=>{let r=h(c);x&&r!==y&&(T.push({id:`divider-${r}`,type:"divider",label:r.toUpperCase()}),y=r),T.push(c)})}t&&(e.innerHTML="");let m=p=>{let x=p.event;if(typeof x=="string")try{x=JSON.parse(x)}catch{return null}let y=(x.title||"Untitled Alert").trim(),c=(x.body||"No description provided.").trim(),r=x.summary||"",w=x.content||"",E=x.protocol||"",g=(x.priority||"low").toLowerCase(),S=!!x.alert,B=(x.category||"system").trim(),k=x.related_event_ids||[],D=x.audit_event_id,U=!!localStorage.getItem(`alert_read_ts_${p.id}`),G=new Date(p.timestamp*1e3),H=G.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=G.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=U?"event-border-grey":"event-border-blue";!U&&S&&(M="event-border-red"),U&&(g==="high"||g==="critical")?M="event-border-red":U&&g==="medium"&&(M="event-border-orange");let I=U?"alert-read":"alert-unread",O=ge.has(p.id),R=O?"expanded":"",V=O?"display: block;":"display: none;",L="",z="";k.length>0&&(z=`
        ...
        `,L=`
            ...
            `;let rt=K.querySelector(".event-details");rt&&rt.addEventListener("click",ce=>{ce.stopPropagation()});let lt=K.querySelector(".close-details-btn");return lt&&lt.addEventListener("click",ce=>{ce.stopPropagation(),K.classList.remove("expanded");let Q=K.querySelector(".event-details");Q&&(Q.style.display="none"),ge.delete(p.id)}),K},v=p=>{let x=document.createElement("div");x.className="notification-divider",x.dataset.alertId=p.id;let y="#888888";return p.label==="CRITICAL"?y="#ff4d4d":p.label==="HIGH"?y="#ff8888":p.label==="MEDIUM"&&(y="#ffa500"),x.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,x.innerHTML=`<span style="white-space: nowrap;">${p.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,x},s=p=>{let x=document.createElement("div");x.innerHTML=J("empty",p.message,null,p.id);let y=x.firstElementChild;return y.dataset.alertId=p.id,y},u=Array.from(e.children),C=new Map(u.map(p=>[p.dataset.alertId,p])),A=new Set(T.map(p=>p.id));u.forEach(p=>{let x=p.dataset.alertId;(!x||!A.has(x))&&p.remove()});let b=null;T.forEach((p,x)=>{let y=C.get(p.id);if(!y||t){if(y&&y.remove(),p.type==="divider")y=v(p);else if(p.type==="placeholder")y=s(p);else{let c=m(p);if(!c)return;y=c}if(!y)return}x===0?e.firstElementChild!==y&&e.prepend(y):b&&b.nextElementSibling!==y&&b.after(y),b=y}),je=Date.now(),te(0,je),Xe()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=J("offline","Failed to load alerts.","The event service may be offline."))}}function Es(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),a=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{qe.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{qe.forEach(n=>{ge.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),de(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{ge.clear(),de(!0)},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;qe.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,n.toString())}),ge.clear(),de(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function Qe(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}if((o.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||n++}),yt(n)}catch{}}var Tt=()=>`
...
`,fe=new Set,St=[],Le=null;async function be(t=!1){let e=document.getElementById("roadmap-list");if(e){Ts();try{let a=await _("/roadmap");if(!a.ok)throw new Error("Offline");let i=await a.json();St=i;let n=m=>{let v=fe.has(m.id),s=m.state==="published",u=m.state==="consumed",C="event-border-grey";s&&(C="event-border-blue"),u&&(C="event-border-purple");let b=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),p=document.createElement("div");p.className=`event-item notification-item ${C} cursor-pointer ${v?"expanded":""}`,p.dataset.itemId=m.id,p.onclick=c=>{if(c.target.closest("button"))return;if(p.classList.contains("expanded")){p.classList.remove("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="none"),fe.delete(m.id)}else{p.classList.add("expanded");let w=p.querySelector(".event-details");w&&(w.style.display="block"),fe.add(m.id)}};let x=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;p.innerHTML=`
      ...
      `;let y=p.querySelector(".event-details");return y&&y.addEventListener("click",c=>{c.stopPropagation()}),p.querySelector(".edit-btn")?.addEventListener("click",()=>$s(m)),p.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Ss(m)),p.querySelector(".delete-btn")?.addEventListener("click",()=>ks(m.id)),p.querySelector(".close-details-btn")?.addEventListener("click",c=>{c.stopPropagation(),p.classList.remove("expanded");let r=p.querySelector(".event-details");r&&(r.style.display="none"),fe.delete(m.id)}),p},l=m=>{let v=document.createElement("div");v.innerHTML=J("empty",m.message,m.action,m.id);let s=v.firstElementChild;return s.dataset.itemId=m.id,s},o=[];!i||i.length===0?o.push({id:"placeholder-empty",type:"placeholder",message:"Your roadmap is empty.",action:P()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`}):i.forEach(m=>o.push({...m,type:"item"}));let f=Array.from(e.children),d=new Map(f.map(m=>[m.dataset.itemId,m])),h=new Set(o.map(m=>m.id));f.forEach(m=>{let v=m.dataset.itemId;(!v||!h.has(v))&&m.remove()}),t&&(e.innerHTML="");let T=null;o.forEach((m,v)=>{let s=d.get(m.id);(!s||t)&&(s&&s.remove(),m.type==="placeholder"?s=l(m):s=n(m),!s)||(v===0?e.firstElementChild!==s&&e.prepend(s):T&&T.nextElementSibling!==s&&T.after(s),T=s)})}catch{e.children.length===0&&(e.innerHTML=J("offline","Failed to load roadmap.","The event service may be offline."))}}}function Ts(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Le=null;let l=document.getElementById("roadmap-editor-input");l&&(l.value="");let o=document.getElementById("roadmap-editor-container");o&&(o.style.display="block")},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="none"),Le=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input"),o=l?l.value:"";if(!o.trim())return;let f=Le?`/roadmap/${Le}`:"/roadmap",d=Le?"PATCH":"POST";try{await _(f,{method:d,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:o})});let h=document.getElementById("roadmap-editor-container");h&&(h.style.display="none"),be(!0)}catch(h){console.error(h)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{St.forEach(l=>fe.add(l.id)),be(!0)},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{fe.clear(),be(!0)},n.dataset.listenerAttached="true")}function $s(t){Le=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let a=document.getElementById("roadmap-editor-container");a&&(a.style.display="block",a.scrollIntoView({behavior:"smooth"}))}async function Ss(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),be(!0)}catch(a){console.error(a)}}async function ks(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),fe.delete(t),be(!0)}catch(e){console.error(e)}}var Lt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,kt=null,ve=new Set,At=[];async function ye(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Ls();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await _(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];At=l,kt=Date.now(),te(2,kt);let o=s=>{let u=s.event;if(typeof u=="string")try{u=JSON.parse(u)}catch{return null}let C=(u.title||"Untitled Blueprint").trim(),A=(u.summary||u.body||"No summary provided.").trim(),b=(u.content||"").trim(),p=(u.category||"architecture").trim(),x=(u.related_services||u.affected_services||[]).map(L=>L.trim()),y=(u.implementation_path||[]).map(L=>L.trim()),c=u.source_event_ids||[],r=u.approved===!0,w=new Date(s.timestamp*1e3),E=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),g=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=ve.has(s.id),B=S?"display: block;":"display: none;",k=document.createElement("div");k.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${r?"blueprint-approved":""}`,k.dataset.blueprintId=s.id,r&&(k.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",k.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let W=r?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[p]||"bx-paint";k.onclick=function(L){let z=this;if(z.classList.contains("expanded")){z.classList.remove("expanded"),ve.delete(s.id);let q=z.querySelector(".event-details");q&&(q.style.display="none")}else{z.classList.add("expanded"),ve.add(s.id);let q=z.querySelector(".event-details");q&&(q.style.display="block")}};let U="";y.length>0&&(U=`
                ...
                `);let H=x.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${x.join(", ")}</span></div>`:"<div></div>",$=P(),M=r?`
  ...
  `}async function Ae(){let t=document.getElementById("progress-view-root");t&&(le!==Bt&&(t.innerHTML=_t(),Bt=le),le==="ACTIVE"&&Bs())}function Bs(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),a=document.getElementById("active-task-progress-text"),i=document.getElementById("terminal-output");if(t&&X&&(t.innerText=X.title),e&&X&&(e.style.width=`${X.progress}%`),a&&X&&(a.innerText=`${X.progress}% COMPLETE`),i){let n=i.children.length;if(Me.length>n){for(let l=n;l<Me.length;l++){let o=Me[l],f=document.createElement("div");f.className="terminal-line",f.innerHTML=`
...
`;function jt(t){if(!document.getElementById("dex-profile-styles")){let i=document.createElement("style");i.id="dex-profile-styles",i.textContent=Hs,document.head.appendChild(i)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",i=>{i.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden";let a=i=>{e.innerHTML=`
    ...
    `;let n=e.querySelector(".close-profile-btn");n&&n.addEventListener("click",()=>{e.click()})};ue(`/profile/${t.id}`).then(async i=>{if(i.ok){let n=await i.json();_s(e,t,n)}else console.log("Profile not found (404) or error."),a("Profile Data Unavailable")}).catch(i=>{console.error("Profile fetch error:",i),a("Connection Failed")})}function _s(t,e,a){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",n=()=>{let C=(a.attributes||a.facts||[]).map(c=>{let r=c.key||c.k,w=c.value||c.v;return`
            <div class="fact-chip">
        ...
        `},l=()=>{let C=a.dossier||{},A=C.identity||{},b=C.career||{},p=C.personal||{},x=C.social||[];return`
...
`,Ds=null;async function tt(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await tt(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=a=>{let n=a.target.closest(".user-profile-card");if(n&&n.dataset.user)try{let l=JSON.parse(n.dataset.user);jt(l)}catch(l){console.error("Failed to parse user data",l)}},t.dataset.listenerAttached="true");try{let a=await ue("/contacts");if(!a.ok)throw new Error("Service unreachable");let n=(await a.json()).members||[];if(Ds=Date.now(),n.length===0){t.innerHTML=J("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((o,f)=>{let d=l[o.level]??10,h=l[f.level]??10;return d!==h?d-h:o.username.localeCompare(f.username)}),t.innerHTML=n.map(o=>{let f=o.color&&o.color!==0,d=f?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",h=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",T="#888";o.level==="Me"||o.level==="Master"?T="#bb86fc":o.level==="Admin"?T="#cf6679":o.level==="Moderator"?T="#03dac6":o.level==="Contributor"&&(T="#ffa500");let m=o.level==="Me",v=m?"rgba(187, 134, 252, 0.08)":f?`${d}11`:"rgba(255,255,255,0.03)",s=m?"2px solid #bb86fc":f?`1px solid ${d}66`:"1px solid rgba(255,255,255,0.1)";return`
...
`,Ft=qs;function Jt(){return`
    ...
    `}var Us=null;async function ze(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let a=await e.json();if(!a||a.length===0)return t.innerHTML=J("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0"],n=a.filter(o=>!i.includes(o.id));n.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),n.reverse();let l=n.map(o=>{let f=o.logs.join(`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ...
            <div class="service-controls" style="display: flex; gap: 8px; margin-top: 10px; justify-content: flex-end;">
                ...
                </div>${I}`:$=`<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>${I}`;let O=P()?"easter.company":C(c.domain&&c.port?`${c.domain}:${c.port}`:"");return`<div class="service-widget ${w}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${E}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${g}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${O}</span></div>${$}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),x=new Set(s.map(c=>c.id));for(let[c,r]of p)x.has(c)||r.remove();let y=new Set;s.forEach(c=>{if(y.has(c.id))return;y.add(c.id);let r=b(c),w=p.get(c.id);if(w&&w.parentNode)if(c.id==="upstash-redis-ro"){let E=P()&&(oe.lastFrontend||oe.lastDashboard)||Date.now(),g=new Date(E).toLocaleTimeString(),S=w.querySelector(".sync-time-label");S&&(S.textContent=`Last synced: ${g}`)}else w.outerHTML!==r&&(w.outerHTML=r);else t.insertAdjacentHTML("beforeend",r)})}async function it(){let t=document.getElementById("models-widgets");if(!t)return;let e=await ss();if(!e){t.children.length===0&&(t.innerHTML=J("offline","Failed to load model status.","The event service may be offline."));return}Gt=Date.now(),te(2,Gt);let a=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function n(d){let h=d.status==="Ready";return`
        ...
        <div class="process-history-item" data-channel-id="${d.channel_id}-${d.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let n=a?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(n)).map(d=>[d.dataset.channelId,d])),o=new Set(e.map(d=>`${d.channel_id}-${d.start_time}`));for(let[d,h]of l)d&&!o.has(d)&&h.remove();let f=new Set;e.forEach(d=>{let h=`${d.channel_id}-${d.start_time}`;if(f.has(h))return;f.add(h);let T=i(d),m=l.get(h);if(m&&m.parentNode){m.outerHTML!==T&&(m.outerHTML=T);let v=t.querySelector(`[data-channel-id="${h}"]`);v&&t.appendChild(v)}else t.insertAdjacentHTML("beforeend",T)})}function We(){let t=Ze(),e="Notification"in window,a={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function at(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(i=>{i.addEventListener("click",function(){let n=this.dataset.theme;n&&(gt(n),t.setContent(We()),at(t))})});let a=document.getElementById("notifications-toggle");a&&"Notification"in window?a.onclick=async i=>{let n=i.target;if(n.checked)try{await Notification.requestPermission()!=="granted"&&(n.checked=!1)}catch{n.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),n.checked=!0)}:a&&(a.disabled=!0),Gs()}async function Gs(){let t=document.getElementById("service-config-list"),e=document.getElementById("ollama-config-list");if(!t||!e)return;let a=P();try{let n=await(await _("/system/options")).json(),l=n.services||n||{},o=n.ollama||n||{},f="",d=(C,A,b)=>`
        <div class="settings-item">
            <div class="settings-item-info">
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Vs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,i]of Object.entries(t)){let n=ls.filter(l=>l.category===a);n.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let d=document.getElementById("close-terminal-btn");d&&(d.onclick=()=>os());let h=document.getElementById("terminal-action-btn");h&&(h.onclick=()=>os())}let a=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");a&&(a.innerHTML="");let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let l=document.getElementById("terminal-cmd-name");l&&(l.textContent=`dex ${t.id}`);let o=document.getElementById("terminal-status-badge");o&&(o.className="terminal-status status-running",o.textContent="Running");let f=document.getElementById("terminal-action-btn");return f&&(f.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",ot=!0,a}function os(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",ot=!1}function rs(t,e,a="output"){if(!ot||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${a}`,a==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let n=Oe(e);i.innerHTML=n||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Zs(t){let e=ls.find(o=>o.id===t);if(!e)return;let a=Ks(e);a&&rs(a,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let o of i){await new Promise(d=>setTimeout(d,400+Math.random()*600));let f="output";o.includes("[ERROR]")?f="error":o.includes("[SUCCESS]")||o.includes("\u2713")?f="success":o.includes("!")&&(f="warning"),a&&rs(a,o,f)}let n=document.getElementById("terminal-status-badge");n&&(n.className="terminal-status status-success",n.textContent="Completed (Demo)");let l=document.getElementById("terminal-action-btn");l&&(l.style.display="block")}function cs(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Vs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code"),i=a?a.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let n=e.querySelector("i");n&&(n.className="bx bx-check",n.style.color="#5eff5e",setTimeout(()=>{n.className="bx bx-copy",n.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(a=>{let i=a;a.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let n=i.dataset.cmd;n&&Zs(n)})})}async function Ys(){if(!P())try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function ds(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}dt(),pt(),Ys(),bt(),ct();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&cs();let e=[],a=document.getElementById("windows-container");a&&a.setAttribute("data-count","0");let i=b=>{localStorage.setItem("dex_last_window",b)};function n(){for(;e.length>1;)e.shift().close(!0);let b=document.getElementById("windows-container"),p=document.querySelector("nav"),x=document.querySelector("footer"),y=window.location.pathname==="/"||window.location.pathname==="/index.html",c=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");b&&b.setAttribute("data-count",e.length.toString()),e.forEach(k=>{let D=document.getElementById(k.id);D&&D.classList.remove("hide-close")});let r=document.getElementById("dexter-menu-container"),w=document.getElementById("nav-window-switcher"),E=document.getElementById("settings-icon"),g=document.getElementById("docs-icon"),S=document.getElementById("close-all-windows"),B=window.innerWidth<880;if(!B){let k=document.getElementById("dexter-dropdown"),D=document.getElementById("dexter-menu-btn");k&&k.classList.remove("active"),D&&D.classList.remove("active"),b&&b.classList.remove("menu-open")}if(Te(e.length>0),e.length>0)if(x?.classList.add("hide"),S&&(S.style.display=B?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",p?.classList.add("window-open"),b&&(b.style.paddingTop="60px"),r&&(r.style.display=B?"flex":"none"),g&&(g.style.display=B?"block":"none"),E&&(E.style.display=B?"block":"none"),!B&&w){let k=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(k)?(w.innerHTML=`
