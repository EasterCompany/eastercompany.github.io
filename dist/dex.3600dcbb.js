"use strict";(()=>{function at(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function ot(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,l=document.createElement("nav");l.innerHTML=n,document.body.prepend(l);let r=document.createElement("div");r.id="dexter-dropdown",r.className="dexter-dropdown",r.innerHTML=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var lt=1e3;function pe(t){let e=null,s=t.onClose||null,i=t.onOpen||null;function n(){e&&(e.style.zIndex=(++lt).toString())}function l(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",r),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=(++lt).toString(),e.addEventListener("mousedown",n);let v=t.icon||"bx-window",o="",b="",$;t.tabs&&t.tabs.length>0?(o=`<div class="tab-bar">${t.tabs.map((d,u)=>{let g=d.icon?`<i class="bx ${d.icon}"></i>`:`<span class="tab-glyph">${d.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,$=`<div class="window-content">${t.tabs.map((d,u)=>`<div class="tab-content ${u===0?"active":""}" data-tab-content="${u}">${d.content}</div>`).join("")}</div>`):(t.title&&(b=`<div class="window-title">${t.title}</div>`),$=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${$}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",w=>{w.stopPropagation(),c()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(w=>{w.addEventListener("click",()=>{if(!e)return;let a=w.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(u=>u.classList.remove("active")),w.classList.add("active"),e.querySelectorAll(".tab-content").forEach(u=>u.classList.remove("active"));let d=e.querySelector(`.tab-content[data-tab-content="${a}"]`);d&&d.classList.add("active"),f(w,e)})}),setTimeout(()=>{e&&e.classList.add("open"),i&&i()},10)}function r(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&f(m,e)}function f(m,v){setTimeout(()=>{let o=v.querySelector(".tab-bar");if(!o)return;let b=Array.from(o.querySelectorAll(".tab")),$=b.indexOf(m),w=o.clientWidth,a=b[Math.max(0,$-2)],d=b[Math.min(b.length-1,$+2)],u=o,g=a.offsetLeft-u.offsetLeft-25,M=d.offsetLeft+d.offsetWidth-u.offsetLeft+25-g,A=M<=w?g-(w-M)/2:m.offsetLeft-u.offsetLeft-w/2+m.offsetWidth/2;o.scrollTo({left:A,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",r),m?(e.remove(),e=null):(e.classList.remove("open"),s&&s(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){t.content=m;let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function y(){return!!(e&&e.classList.contains("open"))}return{open:l,close:c,setContent:p,isOpen:y,focus:n,id:t.id}}var ct="easter_theme",Q={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Fe(){return localStorage.getItem(ct)||Q.DARK}function dt(t){if(!Object.values(Q).includes(t))throw new Error("Invalid theme");localStorage.setItem(ct,t),pt(t)}function pt(t){let e=document.body;Object.values(Q).forEach(l=>{e.classList.remove(`theme-${l}`)}),e.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let i={[Q.DARK]:"#050507",[Q.LIGHT]:"#FFFFFF",[Q.LEGACY]:"#000000"},n=i[t]||i[Q.DARK];if(s.setAttribute("content",n),!document.querySelector(".background")){let l=document.createElement("div");l.className="background",document.body.prepend(l)}e.classList.add("is-animated")}function mt(){let t=Fe();pt(t)}function N(t,e,s=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=s?`<p class="placeholder-action">${s}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function z(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function ee(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!s)return;if(!e){s.textContent="Last updated: never";return}let i=Date.now(),n=Math.floor((i-e)/1e3),l;n<60?l=`${n}s ago`:n<3600?l=`${Math.floor(n/60)}m ago`:l=`${Math.floor(n/3600)}h ago`,s.textContent=`Last updated: ${l}`}var cs=0;function ke(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!s)return;let i=s.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e.toString(),i.style.display="flex"):i.style.display="none")}var se=0,ne=0;function gt(t){se=t,Ce()}function ft(t){ne=t,Ce()}function Ce(){let t=se+ne;cs=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let s=document.getElementById("alerts-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=se>9?"9+":se.toString(),r.style.display=se>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",i.appendChild(r)),r.textContent=ne>9?"9+":ne.toString(),r.style.display=ne>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",n.appendChild(r)),r.textContent=se>9?"9+":se.toString(),r.style.display=se>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let r=l.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",l.appendChild(r)),r.textContent=ne>9?"9+":ne.toString(),r.style.display=ne>0?"flex":"none"}}function Be(){let t=document.getElementById("alerts-list");if(!t)return;se=t.querySelectorAll(".alert-unread:not(.priority-low)").length,Ce()}function bt(){let t=document.getElementById("blueprints-list");if(!t)return;ne=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,Ce()}function ds(){return"https://event.easter.company"}function ps(){return"https://discord.easter.company"}var ms="http://127.0.0.1:8100",us="http://127.0.0.1:8300",gs={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function _e(t){let e=z(t);if(!e)return e;e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,l)=>{let r=gs[l];return r?`<span class="${r}">`:""});let s=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return s>i&&(e+="</span>".repeat(s-i)),e}function me(t){if(!t)return"";let e=z(t);return e&&(e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(s,i)=>{let n=i.split("|").map(l=>l.trim());return n.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e)}var fs="https://sterling-javelin-12539.upstash.io",bs="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function _(){return window.location.hostname.includes("easter.company")}var R=null,ie={lastDashboard:0,lastFrontend:0},Je=!1,vt=0,yt="dex_dashboard_snapshot";function vs(){let t=localStorage.getItem(yt);if(t)try{let e=JSON.parse(t);R=e,ie.lastDashboard=e.timestamp?e.timestamp*1e3:0}catch{R=null}}async function ut(){if(!(!_()||Je)){Je=!0,vt=Math.floor(Date.now()/1e3);try{let t=await hs("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);R=e,ie.lastDashboard=e.timestamp?e.timestamp*1e3:Date.now(),ie.lastFrontend=Date.now(),localStorage.setItem(yt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Je=!1}}}function ys(){if(!R||!R.agent_status)return;let t=R.agent_status;t.system&&typeof t.system.state_time=="number"&&(t.system.state_time+=1)}async function xs(){if(!_())return;vs();let t=Math.floor(Date.now()/1e3),e=R?t-R.timestamp:1/0;(!R||e>120)&&await ut(),setInterval(()=>{let s=new Date,i=Math.floor(Date.now()/1e3),n=R?i-R.timestamp:1/0,l=i-vt,r=s.getSeconds()===59,f=n>300,c=l>60;(r&&c||f&&c)&&ut(),ys()},1e3)}_()&&xs();async function hs(t,...e){try{let i=await(await fetch(fs,{method:"POST",headers:{Authorization:`Bearer ${bs}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(s){return console.error("Upstash Error:",s),null}}var he=null,we=null,Ae=!1,Ie=!1;async function B(t,e={}){if(_()){if(!R)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(R.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(R.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),l=n.get("type")||n.get("event.type"),r=n.get("category"),f=n.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...R.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...R.blueprints||[]]:r==="messaging"?c=[...R.messaging_events||[]]:r==="system"?c=[...R.system_events||[]]:r==="cognitive"?c=[...R.cognitive_events||[]]:r==="moderation"?c=[...R.moderation_events||[]]:c=[...R.events||[]],f==="asc"?c.sort((p,y)=>p.timestamp-y.timestamp):c.sort((p,y)=>y.timestamp-p.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(R.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],l=R.profiles?R.profiles[n]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return t.startsWith("/web/history")?new Response(JSON.stringify(R.web_history||[]),{status:200}):t.startsWith("/chores")?new Response(JSON.stringify([]),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(he)try{let n=await fetch(he+t,e);if(n.ok)return n;he=null}catch{he=null}let s=ds(),i=ms;try{let n=await fetch(s+t,e);if(n.ok)return he=s,Ae&&(console.log("\u2728 Production event service restored."),Ae=!1),n;throw new Error("Primary failed")}catch{Ae||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Ae=!0);try{let l=await fetch(i+t,e);if(l.ok)return he=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function He(t,e={}){if(_()){if(!R)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(R.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],l=(R.contacts?.members||[]).find(r=>r.id===n);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(we)try{let n=await fetch(we+t,e);if(n.ok)return n;we=null}catch{we=null}let s=ps(),i=us;try{let n=await fetch(s+t,e);if(n.ok)return we=s,Ie&&(console.log("\u2728 Production discord service restored."),Ie=!1),n;throw new Error("Primary failed")}catch{Ie||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Ie=!0);try{let l=await fetch(i+t,e);if(l.ok)return we=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}var xt=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="alerts-clear" class="notif-action-btn danger" style="${_()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
        </div>
    </div>
...
`,De=null,ue=new Set,ze=[];async function ce(t=!1){let e=document.getElementById("alerts-list");if(!e)return;ws(),t&&(e.innerHTML="<p>Updating...</p>");let s="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await B(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];De=Date.now(),ee(0,De);let r=Date.now(),f=24*60*60*1e3,c=l.filter(u=>{let g=localStorage.getItem(`alert_read_ts_${u.id}`);if(!g)return!0;let x=parseInt(g);return r-x<f});c.sort((u,g)=>{let x=k=>{let E=k.event;if(typeof E=="string")try{E=JSON.parse(E)}catch{return"low"}return(E.priority||"low").toLowerCase()},M=k=>k==="critical"?4:k==="high"?3:k==="medium"?2:1,A=M(x(u)),I=M(x(g));return A!==I?I-A:g.timestamp-u.timestamp}),ze=c;let p=u=>{let g=u.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},y=[],v=new Set(c.map(u=>p(u))).size>1;if(c.length>0){let u=null;c.forEach(g=>{let x=p(g);v&&x!==u&&(y.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),u=x),y.push(g)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=N("empty","No alerts yet."),Be();return}let o=u=>{let g=u.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let x=(g.title||"Untitled Alert").trim(),M=(g.body||"No description provided.").trim(),A=g.summary||"",I=g.content||"",k=g.protocol||"",E=(g.priority||"low").toLowerCase(),D=!!g.alert,U=(g.category||"system").trim(),O=g.related_event_ids||[],q=g.audit_event_id,J=!!localStorage.getItem(`alert_read_ts_${u.id}`),S=new Date(u.timestamp*1e3),C=S.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),h=S.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=J?"event-border-grey":"event-border-blue";!J&&D&&(T="event-border-red"),J&&(E==="high"||E==="critical")?T="event-border-red":J&&E==="medium"&&(T="event-border-orange");let L=J?"alert-read":"alert-unread",H=ue.has(u.id),P=H?"expanded":"",V=H?"display: block;":"display: none;",j="",F="";O.length>0&&(F=`
...
`,ge=new Set,Ne=[],Ee=null;async function fe(t=!1){let e=document.getElementById("roadmap-list");if(e){Cs();try{let s=await B("/roadmap");if(!s.ok)throw new Error("Offline");let i=await s.json();Ne=i;let n=p=>{let y=ge.has(p.id),m=p.state==="published",v=p.state==="consumed",o="event-border-grey";m&&(o="event-border-blue"),v&&(o="event-border-purple");let $=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),w=document.createElement("div");w.className=`event-item notification-item ${o} cursor-pointer ${y?"expanded":""}`,w.dataset.itemId=p.id,w.onclick=u=>{if(u.target.closest("button"))return;if(w.classList.contains("expanded")){w.classList.remove("expanded");let x=w.querySelector(".event-details");x&&(x.style.display="none"),ge.delete(p.id)}else{w.classList.add("expanded");let x=w.querySelector(".event-details");x&&(x.style.display="block"),ge.add(p.id)}};let a=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;w.innerHTML=`
        <div class="event-time">
        ...
        <div class="event-content">
          ...
          <div class="event-message" style="white-space: pre-wrap;">${z(p.content)}</div>
      ...
      `;let d=w.querySelector(".event-details");return d&&d.addEventListener("click",u=>{u.stopPropagation()}),w.querySelector(".edit-btn")?.addEventListener("click",()=>Es(p)),w.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>$s(p)),w.querySelector(".delete-btn")?.addEventListener("click",()=>Ts(p.id)),w.querySelector(".close-details-btn")?.addEventListener("click",u=>{u.stopPropagation(),w.classList.remove("expanded");let g=w.querySelector(".event-details");g&&(g.style.display="none"),ge.delete(p.id)}),w},l=Array.from(e.children),r=new Map(l.map(p=>[p.dataset.itemId,p])),f=new Set(i.map(p=>p.id));if(l.forEach(p=>{let y=p.dataset.itemId;(!y||!f.has(y))&&p.remove()}),!Ne||Ne.length===0){e.innerHTML=N("empty","Your roadmap is empty.",_()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;i.forEach((p,y)=>{let m=r.get(p.id);(!m||t)&&(m&&m.remove(),m=n(p),!m)||(y===0?e.firstElementChild!==m&&e.prepend(m):c&&c.nextElementSibling!==m&&c.after(m),c=m)})}catch{e.children.length===0&&(e.innerHTML=N("offline","Failed to load roadmap.","The event service may be offline."))}}}function Cs(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),s=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ee=null;let l=document.getElementById("roadmap-editor-input");l&&(l.value="");let r=document.getElementById("roadmap-editor-container");r&&(r.style.display="block")},t.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{let l=document.getElementById("roadmap-editor-container");l&&(l.style.display="none"),Ee=null},s.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input"),r=l?l.value:"";if(!r.trim())return;let f=Ee?`/roadmap/${Ee}`:"/roadmap",c=Ee?"PATCH":"POST";try{await B(f,{method:c,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})});let p=document.getElementById("roadmap-editor-container");p&&(p.style.display="none"),fe(!0)}catch(p){console.error(p)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{Ne.forEach(l=>ge.add(l.id)),fe(!0)},i.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ge.clear(),fe(!0)},n.dataset.listenerAttached="true")}function Es(t){Ee=t.id;let e=document.getElementById("roadmap-editor-input");e&&(e.value=t.content);let s=document.getElementById("roadmap-editor-container");s&&(s.style.display="block",s.scrollIntoView({behavior:"smooth"}))}async function $s(t){let e=t.state==="published"?"draft":"published";try{await B(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),fe(!0)}catch(s){console.error(s)}}async function Ts(t){if(confirm("Delete this roadmap item?"))try{await B(`/roadmap/${t}`,{method:"DELETE"}),ge.delete(t),fe(!0)}catch(e){console.error(e)}}var Et=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
        ...
        <button id="blueprints-clear" class="notif-action-btn danger" style="${_()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
    </div>
`,$t=()=>`
...
`,Ct=null,be=new Set,Tt=[];async function ve(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Ss();let s="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await B(s);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];if(Tt=l,Ct=Date.now(),ee(2,Ct),l.length===0){e.innerHTML=N("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),ke(2,0);return}t&&(e.innerHTML="");let r=m=>{let v=m.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let o=(v.title||"Untitled Blueprint").trim(),b=(v.summary||v.body||"No summary provided.").trim(),$=(v.content||"").trim(),w=(v.category||"architecture").trim(),a=(v.related_services||v.affected_services||[]).map(H=>H.trim()),d=(v.implementation_path||[]).map(H=>H.trim()),u=v.source_event_ids||[],g=v.approved===!0,x=new Date(m.timestamp*1e3),M=x.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=x.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),I=be.has(m.id),k=I?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${I?"expanded":""} ${g?"blueprint-approved":""}`,E.dataset.blueprintId=m.id,g&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let U=g?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[w]||"bx-paint";E.onclick=function(H){let P=this;if(P.classList.contains("expanded")){P.classList.remove("expanded"),be.delete(m.id);let j=P.querySelector(".event-details");j&&(j.style.display="none")}else{P.classList.add("expanded"),be.add(m.id);let j=P.querySelector(".event-details");j&&(j.style.display="block")}};let O="";d.length>0&&(O=`
                ...
                `);let G=a.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${a.join(", ")}</span></div>`:"<div></div>",J=_(),S=g?`
            ...
            `;E.innerHTML=`
                ...
                <div class="event-icon" style="${g?"color: #03dac6;":""}"><i class='bx ${U}'></i></div>
                <div class="event-content">
            ...
            `;let C=E.querySelector(".blueprint-approve-btn");C&&(C.onclick=async H=>{H.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await B(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ve(!0)}catch(P){console.error("Failed to approve blueprint:",P)}});let h=E.querySelector(".blueprint-delete-btn");h&&(h.onclick=async H=>{H.stopPropagation();let P=!g;h.innerHTML=P?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await B(`/events/${m.id}`,{method:"DELETE"})).ok&&ve(!0)}catch(V){console.error("Failed to delete blueprint:",V)}});let T=E.querySelector(".event-details");T&&T.addEventListener("click",H=>{H.stopPropagation()});let L=E.querySelector(".close-details-btn");return L&&L.addEventListener("click",H=>{H.stopPropagation(),E.classList.remove("expanded");let P=E.querySelector(".event-details");P&&(P.style.display="none"),be.delete(m.id)}),E},f=Array.from(e.children),c=new Map(f.map(m=>[m.dataset.blueprintId,m])),p=new Set(l.map(m=>m.id));f.forEach(m=>{let v=m.dataset.blueprintId;(!v||!p.has(v))&&m.remove()});let y=null;l.forEach((m,v)=>{let o=c.get(m.id);if(!o||t){o&&o.remove();let b=r(m);if(!b)return;o=b}v===0?e.firstElementChild!==o&&e.prepend(o):y&&y.nextElementSibling!==o&&y.after(o),y=o}),ke(2,l.length),bt()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load blueprints.","The event service may be offline."))}}async function St(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await B(t);if(!e.ok)return;let i=(await e.json()).events||[],n=0;i.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&n++}),ft(n)}catch{}}function Ss(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),s=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Tt.forEach(i=>be.add(i.id)),ve(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{be.clear(),ve(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await B("/events?type=system.blueprint.generated",{method:"DELETE"}),be.clear(),ve(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var ae="STANDBY",kt=null,$e=[],Z=null,Pe=null,Mt=()=>`
  ...
  `}async function Te(){let t=document.getElementById("progress-view-root");t&&(ae!==kt&&(t.innerHTML=Lt(),kt=ae),ae==="ACTIVE"&&As())}function As(){let t=document.getElementById("active-task-title"),e=document.getElementById("active-task-progress-fill"),s=document.getElementById("active-task-progress-text"),i=document.getElementById("terminal-output");if(t&&Z&&(t.innerText=Z.title),e&&Z&&(e.style.width=`${Z.progress}%`),s&&Z&&(s.innerText=`${Z.progress}% COMPLETE`),i){let n=i.children.length;if($e.length>n){for(let l=n;l<$e.length;l++){let r=$e[l],f=document.createElement("div");f.className="terminal-line",f.innerHTML=`
            <span class="line-time">${r.time}</span>
            <span class="line-prefix">></span>
            <span class="line-msg">${z(r.msg)}</span>
        `,i.appendChild(f)}i.scrollTop=i.scrollHeight}}}window.addEventListener("dex-mock-start",()=>{ae="ACTIVE",$e=[{time:new Date().toLocaleTimeString(),msg:"Initializing cognitive engine..."},{time:new Date().toLocaleTimeString(),msg:"Connecting to event-service..."}],Z={title:"Refactoring System Event Bus",progress:10},Te();let t=0,e=setInterval(()=>{if(ae!=="ACTIVE"){clearInterval(e);return}t++,Z.progress=Math.min(100,Z.progress+Math.floor(Math.random()*15));let s=["Analyzing internal/bus.go...","Checking circular dependencies.","Optimizing channel throughput.","Writing unit tests for refactor.","Deploying to staging environment.","Verifying system integrity."];t<s.length&&$e.push({time:new Date().toLocaleTimeString(),msg:s[t]}),Z.progress>=100&&(ae="COMPLETED",Pe={duration:"1m 12s",steps:32,result:"Optimized Event Bus"},clearInterval(e)),Te()},1500)});window.addEventListener("dex-mock-stop",()=>{ae="STANDBY",Te()});window.addEventListener("dex-mock-reset",()=>{ae="STANDBY",Te()});var At=()=>`
  <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
    <button id="create-chore-btn" class="notif-action-btn" style="${_()?"display: none;":""}" title="New Task"><i class='bx bx-plus'></i></button>
  </div>
`,It=()=>`
        <!-- Create Task Form -->
    ...
    `;async function Re(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),s=document.getElementById("create-chore-form"),i=document.getElementById("save-chore-btn"),n=document.getElementById("cancel-chore-btn");if(e&&!e.dataset.listenerAttached&&(e.onclick=()=>{s&&(s.style.display=s.style.display==="none"?"block":"none")},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{s&&(s.style.display="none")},n.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let l=document.getElementById("new-chore-instruction"),r=document.getElementById("new-chore-url"),f=document.getElementById("new-chore-owner"),c=l?.value,p=r?.value,y=f?.value||"313071000877137920";if(c){i.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:y,natural_instruction:c,entry_url:p,schedule:"every_6h"})}),s&&(s.style.display="none"),l&&(l.value=""),r&&(r.value=""),Re()}catch(m){console.error(m),alert("Failed to create chore")}finally{i.innerHTML="Create Task"}}},i.dataset.listenerAttached="true"),!!t)try{let l=await B("/chores");if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);let r=await l.json();if(!Array.isArray(r)||r.length===0){t.innerHTML=N("empty","No active tasks.",_()?"Dexter is not currently performing research.":"Click the plus icon to create a research task.");return}let f=r.map(c=>{let p=c.last_run===0?"Never":new Date(c.last_run*1e3).toLocaleString(),y=c.memory?c.memory.length:0,m=c.status==="active"?"#03dac6":"#666";return`
                <div class="service-widget" style="border-left: 3px solid ${m}; width: 100%;">
                    <div class="service-widget-header">
                        <i class='bx bx-search-alt' style="color: ${m}"></i>
            ...
            `}).join("");t.innerHTML=f,t.querySelectorAll(".delete-chore-btn").forEach(c=>{c.onclick=async p=>{p.stopPropagation();let y=c.dataset.id;confirm("Delete this task?")&&(await B(`/chores/${y}`,{method:"DELETE"}),Re())}})}catch(l){console.error("Failed to fetch chores",l)}}var Bt=()=>`
...
`;async function Ge(){await Promise.all([fe(),ve(),Te(),Re()])}var Is=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`;function zt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Nt(t){if(!document.getElementById("dex-profile-styles")){let s=document.createElement("style");s.id="dex-profile-styles",s.textContent=Is,document.head.appendChild(s)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",s=>{s.target===e&&(e.classList.remove("active"),document.body.style.overflow="",setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),document.body.style.overflow="hidden",He(`/profile/${t.id}`).then(async s=>{if(s.ok){let i=await s.json();Ve(e,t,i)}else{console.log("Profile not found or error, using mock data.");let i=zt(t.id,t.username);Ve(e,t,i)}}).catch(s=>{console.error("Profile fetch error:",s);let i=zt(t.id,t.username);Ve(e,t,i)})}function Ve(t,e,s){let i=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",n=()=>{let $=(s.attributes||s.facts||[]).map(x=>{let M=x.key||x.k,A=x.value||x.v;return`
        ...
        `},l=()=>{let $=s.dossier||{},w=$.identity||{},a=$.career||{},d=$.personal||{},u=$.social||[];return`
...
`,Bs=null;async function Ke(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Ke(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=s=>{let n=s.target.closest(".user-profile-card");if(n&&n.dataset.user)try{let l=JSON.parse(n.dataset.user);Nt(l)}catch(l){console.error("Failed to parse user data",l)}},t.dataset.listenerAttached="true");try{let s=await He("/contacts");if(!s.ok)throw new Error("Service unreachable");let n=(await s.json()).members||[];if(Bs=Date.now(),n.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((r,f)=>{let c=l[r.level]??10,p=l[f.level]??10;return c!==p?c-p:r.username.localeCompare(f.username)}),t.innerHTML=n.map(r=>{let f=r.color&&r.color!==0,c=f?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",p=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",y="#888";r.level==="Me"||r.level==="Master"?y="#bb86fc":r.level==="Admin"?y="#cf6679":r.level==="Moderator"?y="#03dac6":r.level==="Contributor"&&(y="#ffa500");let m=r.level==="Me",v=m?"rgba(187, 134, 252, 0.08)":f?`${c}11`:"rgba(255,255,255,0.03)",o=m?"2px solid #bb86fc":f?`1px solid ${c}66`:"1px solid rgba(255,255,255,0.1)";return`
                <div class="user-profile-card" 
                    ...
                    <div style="position: relative;">
                        <img src="${r.avatar_url}" style="width: 45px; height: 45px; border-radius: 50%; background: #222; border: ${m?"2px solid #bb86fc":f?`2px solid ${c}`:"none"};" onerror="this.src='https://cdn.discordapp.com/embed/avatars/0.png'">
                    ...
                    <div class="user-info" style="text-align: left; flex: 1; min-width: 0;">
                        <h3 style="margin: 0; font-size: 0.95em; color: ${f?c:"#fff"}; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;">${r.username}</h3>
                        <div style="display: flex; align-items: center; gap: 5px; margin-top: 2px;">
                            <span style="font-size: 0.75em; color: ${y}; font-weight: 600; text-transform: uppercase;">${m?"DEXTER (ME)":r.level}</span>
                        </div>
    ...
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="events-clear" class="notif-action-btn danger" style="${_()?"display: none;":""}" title="Clear"><i class='bx bx-trash'></i></button>
        </div>
    </div>
...
`,Oe=null,ye=new Set,Me=[],K="all",Hs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},Ds={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function zs(t){for(let[e,s]of Object.entries(Hs))if(s.includes(t))return e;return"system"}function Ns(t){return Ds[t]||"bx-square-rounded"}async function de(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Ps();let i=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(i+=`&category=${K}`);try{let n=await B(i);if(!n.ok)throw new Error("Service unreachable");if(Me=((await n.json()).events||[]).filter(v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return!0}let b=o.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),Oe=Date.now(),ee(1,Oe),Me.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let f=v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return null}let b=o.type,$=zs(b),w=Ns(b),a=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),d="event-border-grey";a&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?d="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?d="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?d="event-border-orange":b==="system.test.completed"?d=o.test?.status==="OK"&&o.lint?.status==="OK"&&o.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let u=a?"cursor-pointer":"",g=ye.has(v.id),x=g?"expanded":"",M=g?"display: block;":"display: none;",A=new Date(v.timestamp*1e3),I=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),k=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=Rt(b,o),D=o.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${o.user_level})</span>`:"",U="";if(a){let S="";if(b==="engagement.decision"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                    ...
                    `}else if(b==="system.attention.expired"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,h=o.timestamp-o.last_active,T=Math.floor(h/60);S=`
                        ...
                        <div class="event-detail-block">
                            ...
                            <div class="detail-pre">${me(o.last_input||"None")}</div>
                        </div>
                        <div class="event-detail-block">
                            ${C("Thought Process (Last Output)")}
                            <div class="detail-pre">${me(o.last_output||"None")}</div>
                        </div>
                    `}else if(b==="messaging.bot.sent_message"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,h="";o.eval_count&&(h=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let T="";if(o.chat_history&&o.chat_history.length>0){let L=o.chat_history.length,H=o.chat_history.map((P,V)=>{let j=P.name?P.name.toUpperCase():P.role.toUpperCase();!P.name&&j==="ASSISTANT"&&(j="DEXTER");let F=P.role==="user"?"#03dac6":P.role==="system"?"#ffb74d":"#bb86fc",W=V===L-1?"block":"none";return`
                                <div class="history-slide" data-index="${V}" style="display: ${W};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${F}; letter-spacing: 1px; font-weight: bold;">${j}</span>
                        ...
                        `}
                    `}else if(b==="analysis.user.message_signals"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,h=o.signals||{};S=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="event-detail-block" style="margin-top: 15px;">
                            ${C("Raw Model Output")}
                            <pre class="detail-pre">${z(o.raw_output)||"None"}</pre>
                        </div>
                    `}else if(b==="moderation.explicit_content.deleted"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="analysis.link.completed"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            ...
                            <span class="detail-value">${z(o.title)||"N/A"}</span>
                        </div>
                        <div class="event-detail-block">
                            ${C("Description")}
                            <pre class="detail-pre">${z(o.description)||"None"}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Content Summary")}
                            <pre class="detail-pre">${z(o.summary)||"None"}</pre>
                        </div>
                    `}else if(b==="analysis.visual.completed"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,h="";o.base64_preview?h=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${o.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:o.url&&(h=`<div class="event-detail-block"><img src="${o.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(b==="analysis.router.decision"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Input Context")}
                            <pre class="detail-pre">${z(o.raw_input)||"None"}</pre>
                        </div>
                    `}else if(b==="system.cli.command"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row">
                        ...
                        <div class="event-detail-block">
                            ${C("Output")}
                            <pre class="detail-pre">${z(o.output)||"No output recorded."}</pre>
                        </div>
                    `}else if(b==="system.analysis.audit"){let C=o.success?"#03dac6":"#ff4d4d",h=o.success?"SUCCESS":"FAILED",T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,L="";o.error&&(L=`
                            <div class="event-detail-block">
                                ${T("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${z(o.error)}</pre>
                            </div>
                        `);let H="";if(o.chat_history&&o.chat_history.length>0){let j=o.chat_history.length,F=o.chat_history.map((W,re)=>{let te=W.name?W.name.toUpperCase():W.role.toUpperCase();!W.name&&te==="USER"&&(te="SYSTEM"),!W.name&&te==="ASSISTANT"&&(te="AGENT");let X=W.role==="user"?"#03dac6":W.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${re}" style="display: ${re===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${re+1} of ${j}</span>
                                    </div>
                        ...
                        `}let P="";if(o.corrections&&o.corrections.length>0){let j=o.corrections.map((F,W)=>`
                        ...
                        `).join("");P=`
                            <div class="event-detail-block">
                                ${T(`Corrections (${o.corrections.length})`)}
                                ${j}
                            </div>
                        `}let V="";if(o.parsed_results&&o.parsed_results.length>0){let j=o.parsed_results.map(F=>`
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${C}; font-weight: bold;">${h} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${o.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${P}
                        ${H}
                    `}else if(b==="system.test.completed"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row">
                    ...
                    `}else if(b==="error_occurred"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                        ...
                        <div class="event-detail-block">
                            ${C("Error Message")}
                            <pre class="detail-pre" style="color: #ff4d4d;">${z(o.error)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${C("Context")}
                            <pre class="detail-pre">${JSON.stringify(o.context||{},null,2)}</pre>
                        </div>
                    `}else if(b==="system.cli.status"){let C=h=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${h}</h5>`;S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                        ...
                        <div class="event-detail-block">
                            ${C("Message")}
                            <pre class="detail-pre">${z(o.message)}</pre>
                        </div>
                    `}else if(b==="messaging.user.sent_message"){let C="";o.attachments&&o.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${o.attachments.map(T=>{let L=T.content_type&&T.content_type.startsWith("image/"),H=(T.size/1024).toFixed(1)+" KB";return`
            ...
            `;let q=O.querySelector(".event-details");if(q&&q.addEventListener("click",S=>{S.stopPropagation()}),a){let S=O.querySelector(".close-details-btn");S&&S.addEventListener("click",C=>{C.stopPropagation();let h=C.target.closest(".event-item");if(h){h.classList.remove("expanded"),ye.delete(v.id);let T=h.querySelector(".event-details");T&&(T.style.display="none")}})}let G=O.querySelector(".prev-btn"),J=O.querySelector(".next-btn");if(G&&J){let S=0,C=Array.from(O.querySelectorAll(".history-slide")),h=C.length,T=()=>{C.forEach((L,H)=>{L.style.display=H===S?"block":"none"}),G.disabled=S===0,J.disabled=S===h-1,G.style.opacity=S===0?"0.5":"1",J.style.opacity=S===h-1?"0.5":"1"};G.addEventListener("click",L=>{L.stopPropagation(),S>0&&(S--,T())}),J.addEventListener("click",L=>{L.stopPropagation(),S<h-1&&(S++,T())}),T()}return O},c=Array.from(e.children),p=new Map(c.map(v=>[v.dataset.eventId,v])),y=new Set(Me.map(v=>v.id));c.forEach(v=>{let o=v.dataset.eventId;(!o||!y.has(o))&&v.remove()});let m=null;Me.forEach((v,o)=>{let b=p.get(v.id);(!b||t)&&(b&&b.remove(),b=f(v),!b)||(o===0?e.firstElementChild!==b&&e.prepend(b):m&&m.nextElementSibling!==b&&m.after(b),m=b)}),Oe=Date.now(),ee(1,Oe)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=N("offline","Failed to load events.","The event service may be offline."))}}function Ps(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),s=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Me.forEach(n=>ye.add(n.id)),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ye.clear(),de(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{s.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),n.classList.add("active"),K=n.dataset.filter||"all",de(!0)}}),s.dataset.listenerAttached="true"),s&&s.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===K?n.classList.add("active"):n.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let n=K==="all"?"ALL":K.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(K!=="all"?l+=`?category=${K}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await B(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ye.clear(),de(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var Rs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,Ot=Rs;function Ut(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var Os=null;async function Le(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await B("/logs");if(!e.ok)throw new Error("Logs offline");let s=await e.json();if(!s||s.length===0)return t.innerHTML=N("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0"],n=s.filter(r=>!i.includes(r.id));n.forEach(r=>{r.logs&&Array.isArray(r.logs)?r.logs.reverse():r.logs=[]}),n.reverse();let l=n.map(r=>{let f=r.logs.join(`
`),c=[...r.logs];if(c.length<25){let y=25-c.length;for(let m=0;m<y;m++)c.push("")}else c.length>25&&(c=c.slice(-25));let p=c.map(y=>_e(y)).join(`
`);return`
                <div class="log-report">
                    <div class="log-report-header">
                        ...
                        <div style="display: flex; gap: 5px;">
                            ...
                            <button class="log-action-btn delete clear-logs-btn" data-service-id="${r.id}" title="Clear Logs" style="${_()?"display: none;":""}">
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(r=>{r.addEventListener("click",()=>{let f=r,c=unescape(f.dataset.logs||"");navigator.clipboard.writeText(c).then(()=>{let p=f.querySelector("i");p&&(p.classList.remove("bx-copy"),p.classList.add("bx-check"),setTimeout(()=>{p.classList.remove("bx-check"),p.classList.add("bx-copy")},2e3))})})}),document.querySelectorAll(".clear-logs-btn").forEach(r=>{r.addEventListener("click",async()=>{let c=r.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${c}?`))try{(await B(`/logs?service_id=${c}`,{method:"DELETE"})).ok&&Le()}catch(p){console.error("Error clearing logs:",p)}})}),Os=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=N("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Jt=()=>{let t=_()?"display: none;":"";return`
        <div class="system-section-header">
            <i class='bx bxs-pie-chart-alt-2' style="color: #03dac6;"></i>
            <h2>Summary ${_()?'<span style="color: #666; font-size: 0.6em; margin-left: 10px; font-weight: normal; font-style: italic;">* Public data is approximated</span>':""}</h2>
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${Ut()}
        </div>`;async function Yt(){Us(),await Promise.all([oe(),Xe(),Qe()]),await Le()}var Ue=null;function Us(){Ue||(Ue=setInterval(()=>{if(!document.getElementById("guardian-sentry-val")){clearInterval(Ue),Ue=null;return}oe(!0)},1e3))}var jt=null,qt=null;async function Xt(){try{return await(await B("/system_monitor")).json()}catch{return null}}async function Ft(){try{return await(await B("/system/hardware")).json()}catch{return null}}async function js(){try{return await(await B("/processes")).json()}catch{return null}}async function qs(){try{return await(await B("/agent/status")).json()}catch{return null}}async function Xe(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),s=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),f=a=>{if(a){if(s&&(s.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let a=await Ft();a?(f(a),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),i&&!i.hasChildNodes())){let a=await Ft();f(a)}if(!t)return;let c=await Xt();if(!c||!c.services){t.children.length===0&&(t.innerHTML=N("offline","Failed to load system metrics.","The event service may be offline."));let a=document.querySelector('[data-service-id="upstash-redis-ro"]');if(a){a.className="service-widget service-widget-offline",a.querySelector(".service-widget-status").textContent="ERROR";let d=a.querySelector(".service-widget-body");d&&(d.innerHTML='<div class="service-widget-footer offline"><span>CONNECTION FAILED</span></div>')}return}jt=_()&&ie.lastDashboard||Date.now(),ee(0,jt||0);let p=c.services||[];window.updateCountdownInterval||(window.updateCountdownInterval=setInterval(()=>{let a=document.getElementById("upstash-countdown");if(a){let g=59-new Date().getSeconds();g<=0&&(g+=60),a.textContent=`${g}s`}},1e3)),Array.from(t.children).forEach(a=>{a.classList.contains("service-widget")||a.remove()});function y(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:a.split(".").slice(0,3).join(".")||"-"}function m(a){return!a||a.length<=28?a:a.substring(0,28)+"..."}function v(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let u=parseInt(d[1])||0,g=parseInt(d[2])||0,x=parseInt(d[3])||0,M=parseFloat(d[4])||0,A=u*86400+g*3600+x*60+M,I=Math.floor(A/86400);if(I>0)return`${I}d`;let k=Math.floor(A/3600);if(k>0)return`${k}h`;let E=Math.floor(A/60);return E>0?`${E}m`:`${Math.floor(A)}s`}function o(a){if(a.id==="upstash-redis-ro"){let J=_()&&(ie.lastFrontend||ie.lastDashboard)||Date.now();return`
            <div class="service-widget service-widget-online" data-service-id="upstash-redis-ro">
            ...
            </div>`}let d=a.status==="online",u=d?"service-widget-online":"service-widget-offline",g=d?"bx-check-circle":"bx-x-circle",x=d?"OK":"BAD",M=a.version?y(a.version.str):"-",A=a.cpu&&a.cpu!=="N/A"?a.cpu:"-",I=a.memory&&a.memory!=="N/A"?a.memory:"-",k=A!=="-"?"#00ff00":"#666",E=A!=="-"?"#fff":"#666",D=I!=="-"?"#00ff00":"#666",U=I!=="-"?"#fff":"#666",O=v(a.uptime),q="";d?q=`
                <div class="service-widget-info">
                ...
                <div class="service-widget-footer">
                    ...
                    <div class="service-widget-item">
                        ...
                        <span style="color: ${U};">${I}</span>
                    </div>
                </div>`:q='<div class="service-widget-footer offline" style="justify-content: center; opacity: 0.5; letter-spacing: 2px; font-weight: bold;"><span>OFFLINE</span></div>';let G=_()?"easter.company":m(a.domain&&a.port?`${a.domain}:${a.port}`:"");return`<div class="service-widget ${u}" data-service-id="${a.id}"><div class="service-widget-header"><i class="bx ${g}"></i><h3>${a.short_name||a.id}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${G}</span></div>${q}</div></div>`}let b=new Map(Array.from(t.querySelectorAll(".service-widget")).map(a=>[a.dataset.serviceId,a])),$=new Set(p.map(a=>a.id));for(let[a,d]of b)$.has(a)||d.remove();let w=new Set;p.forEach(a=>{if(w.has(a.id))return;w.add(a.id);let d=o(a),u=b.get(a.id);if(u&&u.parentNode)if(a.id==="upstash-redis-ro"){let g=_()&&(ie.lastFrontend||ie.lastDashboard)||Date.now(),x=new Date(g).toLocaleTimeString(),M=u.querySelector(".sync-time-label");M&&(M.textContent=`Last synced: ${x}`)}else u.outerHTML!==d&&(u.outerHTML=d);else t.insertAdjacentHTML("beforeend",d)})}async function Qe(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Xt();if(!e){t.children.length===0&&(t.innerHTML=N("offline","Failed to load model status.","The event service may be offline."));return}qt=Date.now(),ee(2,qt);let s=e.models||[],i=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function n(c){let p=c.status==="Ready";return`
                ...
                </div>`}function r(c){let p=c.status==="Downloaded",y=p?"service-widget-online":"service-widget-offline",m=p?"OK":"MISSING",v=p&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",o=c.name;return c.type==="custom"&&o.endsWith(":latest")&&(o=o.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${p?"bx-check-circle":"bx-x-circle"}"></i><h3>${o}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let f="";if(i&&(f+=n(i)),e.xtts&&(f+=l(e.xtts)),f+=s.map(r).join(""),!f){t.innerHTML=N("empty","No models found.");return}t.innerHTML!==f&&(t.innerHTML=f)}async function oe(t=!1){let e=document.getElementById("processes-widgets");if(!e&&!t)return;let s=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),l=document.getElementById("guardian-total-active"),r=document.getElementById("guardian-total-waste"),f=document.getElementById("guardian-reset-btn"),c=document.getElementById("analyzer-reset-btn"),p=document.getElementById("fabricator-reset-btn"),y=document.getElementById("system-pause-toggle-btn");y&&!y.dataset.listenerAttached&&(y.onclick=async()=>{let u=y.querySelector(".bx-play")?"/agent/resume":"/agent/pause";y.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B(u,{method:"POST"}),await oe()}catch{y.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>oe(),2e3)}},y.dataset.listenerAttached="true"),f&&!f.dataset.listenerAttached&&(f.onclick=async()=>{f.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{f.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{f.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{f.innerHTML="<i class='bx bx-error'></i>"}},f.dataset.listenerAttached="true"),c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{c.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{c.innerHTML="<i class='bx bx-error'></i>"}},c.dataset.listenerAttached="true"),p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{p.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await B("/fabricator/reset?protocol=construction",{method:"POST"}),setTimeout(()=>{p.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{p.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),oe()}catch{p.innerHTML="<i class='bx bx-error'></i>"}},p.dataset.listenerAttached="true");let m=await qs();if(m&&m.agents){let d=m.agents.guardian||{protocols:{}},u=m.agents.analyzer||{protocols:{}},g=m.agents.imaginator||{protocols:{}},x=m.agents.fabricator||{protocols:{}},M=m.system||{},A=Math.floor(Date.now()/1e3),I={sentry:"Sentry",synthesis:"Synthesis",alert_review:"Alert Review",construction:"Construction"},k=h=>{h<0&&(h=0);let T=Math.floor(h/3600),L=Math.floor(h%3600/60),H=h%60;return T>0?`${T}h ${L}m`:L>0?`${L}m ${H}s`:`${H}s`},E=(h,T,L,H)=>{if(!h)return;let P=I[H]||H.toUpperCase(),V=h.parentElement?.querySelector('span[style*="text-transform: uppercase"]');if(V&&(V.textContent=P),!L){h.textContent="Inactive",h.style.color="#666";return}let j=L.status;if(j==="Working")h.textContent="Working",h.style.color="#bb86fc";else if(j==="Ready")h.textContent="Ready",h.style.color="#5eff5e";else{let F=L.cooldown;if(_()&&(F=L.next_run-A),F<=0)h.textContent="Ready",h.style.color="#5eff5e";else{let W=Math.floor(F/60),re=F%60;h.textContent=`${W}m ${re}s`,h.style.color="#fff"}}T&&L.stats&&(T.innerHTML=`
        ...
        <div class="process-history-item" data-channel-id="${c.channel_id}-${c.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
                ...
                <div class="service-widget process-widget" data-channel-id="${c.channel_id}-${c.start_time}" style="">
                    ...
                    <div class="service-widget-body">
                        <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${o}">${c.state}</span>
                        </div>
                        <div class="service-widget-info">
                            <span class="info-label">Duration:</span>
                            <span class="info-value" style="color: ${o}">${p}</span>
                        </div>
                         <div class="service-widget-info">
                            <span class="info-label">PID:</span>
                            <span class="info-value" style="color: ${o}">${c.pid}</span>
                        </div>
                    </div>
                </div>`}let n=s?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(n)).map(c=>[c.dataset.channelId,c])),r=new Set(e.map(c=>`${c.channel_id}-${c.start_time}`));for(let[c,p]of l)c&&!r.has(c)&&p.remove();let f=new Set;e.forEach(c=>{let p=`${c.channel_id}-${c.start_time}`;if(f.has(p))return;f.add(p);let y=i(c),m=l.get(p);if(m&&m.parentNode){m.outerHTML!==y&&(m.outerHTML=y);let v=t.querySelector(`[data-channel-id="${p}"]`);v&&t.appendChild(v)}else t.insertAdjacentHTML("beforeend",y)})}function je(){let t=Fe(),e="Notification"in window,s={enabled:e&&Notification.permission==="granted",supported:e};return`
            ...
            </div>`}function et(t){let e=document.querySelector("#settings-window .window-content");if(!e)return;e.querySelectorAll(".theme-card").forEach(i=>{i.addEventListener("click",function(){let n=this.dataset.theme;n&&(dt(n),t.setContent(je()),et(t))})});let s=document.getElementById("notifications-toggle");s&&"Notification"in window?s.onclick=async i=>{let n=i.target;if(n.checked)try{await Notification.requestPermission()!=="granted"&&(n.checked=!1)}catch{n.checked=!1}else Notification.permission==="granted"&&(alert("To disable notifications, please use your browser settings."),n.checked=!0)}:s&&(s.disabled=!0)}var es=()=>`
    ...
    `;async function ts(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Qt(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await Qt(t)}async function Qt(t){try{let e=await B("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let s=await e.json();if(!s||s.length===0){t.innerHTML=N("empty","No web history found.");return}let i=`
        ...
        `;s.forEach((f,c)=>{let p=new Date(f.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),y=f.screenshot?`<img src="data:image/png;base64,${f.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';i+=`
                <div class="web-card" style="flex: 0 0 100%; height: 100%; display: flex; flex-direction: column; scroll-snap-align: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; box-sizing: border-box; max-width: 100%; overflow: hidden;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 10px; flex-shrink: 0;">
                        ...
                        <span style="color: #888; font-size: 0.8em; font-family: monospace;">${p}</span>
                    </div>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Fs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[s,i]of Object.entries(t)){let n=is.filter(l=>l.category===s);n.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e);let c=document.getElementById("close-terminal-btn");c&&(c.onclick=()=>ss());let p=document.getElementById("terminal-action-btn");p&&(p.onclick=()=>ss())}let s=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");s&&(s.innerHTML="");let n=t.docs||{overview:t.description,details:[],extended_usage:t.usage};i&&(i.innerHTML=`
    ...
    `);let l=document.getElementById("terminal-cmd-name");l&&(l.textContent=`dex ${t.id}`);let r=document.getElementById("terminal-status-badge");r&&(r.className="terminal-status status-running",r.textContent="Running");let f=document.getElementById("terminal-action-btn");return f&&(f.style.display="none"),e.classList.add("active"),document.body.style.overflow="hidden",tt=!0,s}function ss(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),document.body.style.overflow="",tt=!1}function ns(t,e,s="output"){if(!tt||!t)return;let i=document.createElement("div");if(i.className=`terminal-line terminal-${s}`,s==="prompt")i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`;else{let n=_e(e);i.innerHTML=n||e}t.appendChild(i),t.scrollTop=t.scrollHeight}async function Ws(t){let e=is.find(r=>r.id===t);if(!e)return;let s=Js(e);s&&ns(s,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let r of i){await new Promise(c=>setTimeout(c,400+Math.random()*600));let f="output";r.includes("[ERROR]")?f="error":r.includes("[SUCCESS]")||r.includes("\u2713")?f="success":r.includes("!")&&(f="warning"),s&&ns(s,r,f)}let n=document.getElementById("terminal-status-badge");n&&(n.className="terminal-status status-success",n.textContent="Completed (Demo)");let l=document.getElementById("terminal-action-btn");l&&(l.style.display="block")}function as(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Fs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let s=e.querySelector("code"),i=s?s.textContent:"";i&&navigator.clipboard.writeText(i).then(()=>{let n=e.querySelector("i");n&&(n.className="bx bx-check",n.style.color="#5eff5e",setTimeout(()=>{n.className="bx bx-copy",n.style.color="#bb86fc"},2e3))})}),t.querySelectorAll(".cli-command-card").forEach(s=>{let i=s;s.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),s.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),s.addEventListener("click",()=>{let n=i.dataset.cmd;n&&Ws(n)})})}async function Gs(){if(!_())try{if(!(await B("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function os(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}ot(),rt(),Gs(),mt(),at();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&as();let e=[],s=document.getElementById("windows-container");s&&s.setAttribute("data-count","0");let i=a=>{localStorage.setItem("dex_last_window",a)};function n(){for(;e.length>1;)e.shift().close(!0);let a=document.getElementById("windows-container"),d=document.querySelector("nav"),u=document.querySelector("footer"),g=window.location.pathname==="/"||window.location.pathname==="/index.html",x=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");a&&a.setAttribute("data-count",e.length.toString()),e.forEach(D=>{let U=document.getElementById(D.id);U&&U.classList.remove("hide-close")});let M=document.getElementById("dexter-menu-container"),A=document.getElementById("nav-window-switcher"),I=document.getElementById("settings-icon"),k=document.getElementById("close-all-windows"),E=window.innerWidth<880;if(!E){let D=document.getElementById("dexter-dropdown"),U=document.getElementById("dexter-menu-btn");D&&D.classList.remove("active"),U&&U.classList.remove("active"),a&&a.classList.remove("menu-open")}if(xe(e.length>0),e.length>0)if(u?.classList.add("hide"),k&&(k.style.display=E?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),document.body.style.overflow="hidden",d?.classList.add("window-open"),a&&(a.style.paddingTop="60px"),M&&(M.style.display=E?"flex":"none"),I&&(I.style.display=E?"block":"none"),!E&&A){let D=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(D)?(A.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts")?.addEventListener("click",()=>{i("alerts-window"),l(f)}),document.getElementById("switch-events")?.addEventListener("click",()=>{i("events-window"),l(c)}),document.getElementById("switch-monitor")?.addEventListener("click",()=>{i("monitor-window"),l(y)}),document.getElementById("switch-contacts")?.addEventListener("click",()=>{i("contacts-window"),l(p)}),document.getElementById("switch-workspace")?.addEventListener("click",()=>{i("workspace-window"),l(m)})):A.innerHTML=""}else A&&(A.innerHTML="");else d?.classList.remove("window-open"),k&&(k.style.display="none"),a&&(a.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.body.style.overflow="",g||x?u?.classList.remove("hide"):u?.classList.add("hide"),M&&(M.style.display="flex"),I&&(I.style.display="block"),A&&(A.innerHTML="");Ce()}function l(a){if(a.isOpen()){a.close();return}for(;e.length>0;)e.pop().close(!0);e.push(a),a.open(),n()}function r(){[...e].forEach(d=>d.close()),e=[]}window.addEventListener("resize",n);let f=pe({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:xt(),onOpen:()=>ce(),onClose:()=>{let a=e.indexOf(f);a>-1&&e.splice(a,1),n()}}),c=pe({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Ze(),onOpen:()=>{c.setContent(Ze()),de()},onClose:()=>{let a=e.indexOf(c);a>-1&&e.splice(a,1),n()}}),p=pe({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:Pt(),onOpen:()=>Ke(),onClose:()=>{let a=e.indexOf(p);a>-1&&e.splice(a,1),n()}}),y=pe({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Gt()},{icon:"bxs-component",title:"Processes",content:Wt()},{icon:"bxs-brain",title:"Models",content:Vt()},{icon:"bx-globe",title:"Web",content:es()},{icon:"bxs-hdd",title:"Hardware",content:Kt()},{icon:"bxs-terminal",title:"Logs",content:Zt()},{icon:"bxs-zap",title:"Agents",content:Jt()}].filter(a=>_()?a.title!=="Hardware"&&a.title!=="Logs":!0),onOpen:()=>{Xe(),oe(),Qe(),ts(),Le()},onClose:()=>{let a=e.indexOf(y);a>-1&&e.splice(a,1),n()}}),m=pe({id:"workspace-window",title:"Workspace",icon:"bx-brain",tabs:[{icon:"bx-loader-circle",title:"Progress",content:Bt()},{icon:"bx-map-alt",title:"Roadmap",content:_t()},{icon:"bx-paint",title:"Blueprints",content:Ht()},{icon:"bx-task",title:"Tasks",content:Dt()}],onOpen:()=>Ge(),onClose:()=>{let a=e.indexOf(m);a>-1&&e.splice(a,1),n()}}),v=pe({id:"settings-window",title:"Settings",icon:"bx-cog",content:je(),onOpen:()=>{v.setContent(je()),et(v)},onClose:()=>{let a=e.indexOf(v);a>-1&&e.splice(a,1),n()}});window.dexter={viewEvent:a=>{c.isOpen()||l(c),setTimeout(()=>{let d=document.querySelector(`.event-item[data-event-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)},viewAlert:a=>{f.isOpen()||l(f),setTimeout(()=>{let d=document.querySelector(`.event-item[data-alert-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)}};let o=()=>{let a=document.getElementById("dexter-dropdown"),d=document.getElementById("dexter-menu-btn");a&&d&&(a.classList.remove("active"),d.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let a=document.getElementById("dexter-menu-btn"),d=document.getElementById("settings-icon"),u=document.getElementById("close-all-windows"),g=document.getElementById("nav-left-container"),x=document.getElementById("dexter-dropdown"),M=document.getElementById("windows-container");a&&x&&(a.onclick=I=>{I.stopPropagation();let k=window.innerWidth<880;if(k)x.style.top="",x.style.left="",x.style.right="",x.style.transform="";else{let D=a.getBoundingClientRect(),O=document.querySelector("nav").getBoundingClientRect(),q=220,G=10,S=D.left+D.width/2-q/2,C=O.right-10;S+q>C&&(S=C-q),S<10&&(S=10),x.style.top=O.bottom+G+"px",x.style.left=S+"px",x.style.right="auto",x.style.transform="none"}x.classList.toggle("active"),a.classList.toggle("active");let E=x.classList.contains("active");if(k){let D=document.querySelector("nav");E?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),D?.classList.add("window-open"),M?.classList.add("menu-open"),xe(!0)):(M?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),D?.classList.remove("window-open"),xe(!1)))}}),d&&(d.onclick=I=>{I.stopPropagation(),l(v)}),u&&(u.onclick=I=>{I.stopPropagation(),r()});let A=(I,k,E)=>{let D=document.getElementById(I);D&&(D.onclick=U=>{U.stopPropagation(),o(),E&&i(E),l(k)})};A("alerts-menu-item",f,"alerts-window"),A("events-menu-item",c,"events-window"),A("monitor-menu-item",y,"monitor-window"),A("contacts-menu-item",p,"contacts-window"),A("workspace-menu-item",m,"workspace-window"),g&&(g.onclick=I=>{if(I.stopPropagation(),x&&x.classList.contains("active")){o(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1));return}if(e.length>0)r();else{let k=window.location.pathname;if(!(k==="/"||k==="/index.html")){let U=(k.endsWith("/")&&k.length>1?k.slice(0,-1):k).split("/");U.pop();let O=U.join("/")||"/";window.location.href=O}}}),document.addEventListener("click",()=>{let I=window.innerWidth<880;x&&x.classList.contains("active")&&(o(),I&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),xe(!1)))}),x&&(x.onclick=I=>I.stopPropagation())})();let $=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!$&&!w&&document.querySelector("footer")?.classList.add("hide"),_()||setInterval(()=>{c.isOpen()&&de(),f.isOpen()?ce():We()},1e3),setInterval(()=>{_()&&(f.isOpen()?ce():We()),m.isOpen()?Ge():St(),_()&&c.isOpen()&&de(),y.isOpen()&&Yt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",os):os();})();
