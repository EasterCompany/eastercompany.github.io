(()=>{function Re(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Pe(t=!1){let e=window.location.pathname,l=e==="/"||e==="/index.html",a=`
    ...
    `}
        ...
        `}
    `,g=document.createElement("nav");g.innerHTML=a,document.body.prepend(g)}function Oe(t){let e=window.location.pathname,l=e==="/"||e==="/index.html",o=document.getElementById("nav-chevron"),s=document.querySelector(".nav-left");!o||!s||(t||!l?(o.style.display="block",s.style.cursor="pointer",s.classList.add("recording"),s.onmouseenter=()=>{o.style.transform="translateX(-3px)"},s.onmouseleave=()=>{o.style.transform="translateX(0)"}):(o.style.display="none",s.style.cursor="default",s.classList.remove("recording"),s.onmouseenter=null,s.onmouseleave=null))}function ze(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ue=1e3;function W(t){let e=null,l=t.onClose||null,o=t.onOpen||null;function s(){e&&(e.style.zIndex=++Ue)}function a(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",g),o&&setTimeout(o,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ue,e.addEventListener("mousedown",s);let v=t.icon||"bx-window",n="",u="",T;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((x,i)=>{let c=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,T=`<div class="window-content">${t.tabs.map((x,i)=>`<div class="tab-content ${i===0?"active":""}" data-tab-content="${i}">${x.content}</div>`).join("")}</div>`):(t.title&&(u=`<div class="window-title">${t.title}</div>`),T=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${T}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",w=>{w.stopPropagation(),d()}),window.addEventListener("resize",g),t.tabs&&e.querySelectorAll(".tab").forEach(w=>{w.addEventListener("click",()=>{let r=w.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(x=>x.classList.remove("active")),w.classList.add("active"),e.querySelectorAll(".tab-content").forEach(x=>x.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${r}"]`).classList.add("active"),p(w,e)})}),setTimeout(()=>{e.classList.add("open"),o&&o()},10)}function g(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&p(f,e)}function p(f,v){setTimeout(()=>{let n=v.querySelector(".tab-bar");if(!n)return;let u=Array.from(n.querySelectorAll(".tab")),T=u.indexOf(f),w=n.clientWidth,r=u[Math.max(0,T-2)],x=u[Math.min(u.length-1,T+2)],i=r.offsetLeft-n.offsetLeft-25,b=x.offsetLeft+x.offsetWidth-n.offsetLeft+25-i,S=b<=w?i-(w-b)/2:f.offsetLeft-n.offsetLeft-w/2+f.offsetWidth/2;n.scrollTo({left:S,behavior:"smooth"})},350)}function d(f=!1){e&&(window.removeEventListener("resize",g),f?(e.remove(),e=null):(e.classList.remove("open"),l&&l(),setTimeout(()=>{e?.remove(),e=null},400)))}function m(f){let v=e?.querySelector(".window-content");v&&(v.innerHTML=f)}function y(){return e&&e.classList.contains("open")}return{open:a,close:d,setContent:m,isOpen:y,focus:s,id:t.id}}function qe(){return!0}function Fe(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function je(t){localStorage.setItem("easter_user_email",t.trim())}var Ge="easter_theme",j={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ae(){return localStorage.getItem(Ge)||j.DARK}function We(t){if(!Object.values(j).includes(t))throw new Error("Invalid theme");localStorage.setItem(Ge,t),pe(t)}function pe(t){let e=document.body;if(Object.values(j).forEach(o=>{e.classList.remove(`theme-${o}`)}),e.classList.add(`theme-${t}`),[j.LIGHT,j.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let o=document.createElement("div");o.className="background",document.body.prepend(o)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function Ve(){let t=ae();pe(t)}function I(t,e,l=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",a=l?`<p class="placeholder-action">${l}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${a}</div>`}function M(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function U(t,e){let l=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!l)return;if(!e){l.textContent="Last updated: never";return}let o=Date.now(),s=Math.floor((o-e)/1e3),a;s<60?a=`${s}s ago`:s<3600?a=`${Math.floor(s/60)}m ago`:a=`${Math.floor(s/3600)}h ago`,l.textContent=`Last updated: ${a}`}var Ke=0;function Je(){return Ke}function oe(t,e){let l=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!l)return;let o=l.querySelector(".notification-badge");o&&(e>0?(o.textContent=e>9?"9+":e,o.style.display="flex"):o.style.display="none")}function le(t){Ke=t;let e=document.getElementById("dexter-nav-badge");e&&(t>0?e.style.display="flex":e.style.display="none");let l=document.getElementById("alerts-menu-item");if(l){let s=l.querySelector(".notification-badge");s||(s=document.createElement("span"),s.className="notification-badge",s.style.marginLeft="auto",l.appendChild(s)),t>0?(s.textContent=t>9?"9+":t,s.style.display="flex"):s.style.display="none"}let o=document.getElementById("switch-alerts");if(o){let s=o.querySelector(".notification-badge");s||(s=document.createElement("span"),s.className="notification-badge",s.style.marginLeft="8px",o.appendChild(s)),t>0?(s.textContent=t>9?"9+":t,s.style.display="flex"):s.style.display="none"}}function ge(){let t=document.getElementById("alerts-list");if(!t)return;let e=t.querySelectorAll(".alert-unread:not(.priority-low)").length;le(e)}function $e(){return"https://event.easter.company"}function Lt(){return"https://discord.easter.company"}var kt="http://127.0.0.1:8100",It="http://127.0.0.1:8300",At={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function fe(t){let e=M(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,a)=>{let g=At[a];return g?`<span class="${g}">`:""});let l=(e.match(/<span/g)||[]).length,o=(e.match(/<\/span/g)||[]).length;return l>o&&(e+="</span>".repeat(l-o)),e}function re(t){if(!t)return"";let e=M(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(l,o)=>{let s=o.split("|").map(a=>a.trim());return s.every(a=>a.match(/^:?-+:?$/))?"":`<div class="md-table-row">${s.map(a=>`<span class="md-table-cell">${a}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Z=null,ee=null,me=!1,ue=!1;async function L(t,e={}){if(Z)try{let s=await fetch(Z+t,e);if(s.ok)return s;Z=null}catch{Z=null}let l=$e(),o=kt;try{let s=await fetch(l+t,e);if(s.ok)return Z=l,me&&(console.log("\u2728 Production event service restored."),me=!1),s;throw new Error("Primary failed")}catch{me||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${o}`),me=!0);try{let a=await fetch(o+t,e);if(a.ok)return Z=o,a;throw new Error("Fallback failed")}catch(a){throw a}}}async function Ye(t,e={}){if(ee)try{let s=await fetch(ee+t,e);if(s.ok)return s;ee=null}catch{ee=null}let l=Lt(),o=It;try{let s=await fetch(l+t,e);if(s.ok)return ee=l,ue&&(console.log("\u2728 Production discord service restored."),ue=!1),s;throw new Error("Primary failed")}catch{ue||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${o}`),ue=!0);try{let a=await fetch(o+t,e);if(a.ok)return ee=o,a;throw new Error("Fallback failed")}catch(a){throw a}}}var Xe=()=>`
...
`,be=null,V=new Set,ve=[];async function K(t=!1){let e=document.getElementById("alerts-list");if(!e)return;_t(),t&&(e.innerHTML="<p>Updating...</p>");let l="/events?ml=1000&format=json&event.type=system.notification.generated";try{let o=await L(l);if(!o.ok)throw new Error("Service is offline or unreachable.");let a=(await o.json()).events||[];be=Date.now(),U(0,be);let g=Date.now(),p=24*60*60*1e3,d=a.filter(i=>{let c=localStorage.getItem(`alert_read_ts_${i.id}`);if(!c)return!0;let b=parseInt(c);return g-b<p});d.sort((i,c)=>{let b=E=>{let k=E.event;if(typeof k=="string")try{k=JSON.parse(k)}catch{return"low"}return(k.priority||"low").toLowerCase()},S=E=>E==="critical"?4:E==="high"?3:E==="medium"?2:1,h=S(b(i)),$=S(b(c));return h!==$?$-h:c.timestamp-i.timestamp}),ve=d;let m=i=>{let c=i.event;if(typeof c=="string")try{c=JSON.parse(c)}catch{return"low"}return(c.priority||"low").toLowerCase()},y=[],v=new Set(d.map(i=>m(i))).size>1;if(d.length>0){let i=null;d.forEach(c=>{let b=m(c);v&&b!==i&&(y.push({id:`divider-${b}`,type:"divider",label:b.toUpperCase()}),i=b),y.push(c)})}if(t&&(e.innerHTML=""),d.length===0){e.innerHTML=I("empty","No alerts yet."),ge();return}let n=i=>{let c=i.event;if(typeof c=="string")try{c=JSON.parse(c)}catch{return null}let b=(c.title||"Untitled Alert").trim(),S=(c.body||"No description provided.").trim(),h=(c.priority||"low").toLowerCase(),$=!!c.alert,E=(c.category||"system").trim(),k=c.related_event_ids||[],A=c.audit_event_id,H=!!localStorage.getItem(`alert_read_ts_${i.id}`),z=new Date(i.timestamp*1e3),C=z.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),B=z.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),_=H?"event-border-grey":"event-border-blue";!H&&$&&(_="event-border-red"),H&&(h==="high"||h==="critical")?_="event-border-red":H&&h==="medium"&&(_="event-border-orange");let N=H?"alert-read":"alert-unread",D=V.has(i.id),P=D?"expanded":"",q=D?"display: block;":"display: none;",Me="",Be="";k.length>0&&(Be=`
...
`,J=new Set,tt=[],te=null;async function Y(t=!1){let e=document.getElementById("roadmap-list");if(e){Mt();try{let l=await L("/roadmap");if(!l.ok)throw new Error("Offline");let o=await l.json();if(tt=o,o.length===0){e.innerHTML=I("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let s=m=>{let y=J.has(m.id),f=m.state==="draft",v=m.state==="published",n=m.state==="consumed",u="event-border-grey";v&&(u="event-border-blue"),n&&(u="event-border-purple");let w=new Date(m.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),r=document.createElement("div");r.className=`event-item notification-item ${u} cursor-pointer ${y?"expanded":""}`,r.dataset.itemId=m.id,r.onclick=c=>{if(c.target.closest("button"))return;r.classList.contains("expanded")?(r.classList.remove("expanded"),r.querySelector(".event-details").style.display="none",J.delete(m.id)):(r.classList.add("expanded"),r.querySelector(".event-details").style.display="block",J.add(m.id))};let x=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${m.state.toUpperCase()}]</span>`;r.innerHTML=`
      ...
      `;let i=r.querySelector(".event-details");return i&&i.addEventListener("click",c=>{c.stopPropagation()}),r.querySelector(".edit-btn")?.addEventListener("click",()=>Bt(m)),r.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Dt(m)),r.querySelector(".delete-btn")?.addEventListener("click",()=>Ht(m.id)),r.querySelector(".close-details-btn")?.addEventListener("click",c=>{c.stopPropagation(),r.classList.remove("expanded"),r.querySelector(".event-details").style.display="none",J.delete(m.id)}),r},a=Array.from(e.children),g=new Map(a.map(m=>[m.dataset.itemId,m])),p=new Set(o.map(m=>m.id));a.forEach(m=>{let y=m.dataset.itemId;(!y||!p.has(y))&&m.remove()});let d=null;o.forEach((m,y)=>{let f=g.get(m.id);(!f||t)&&(f&&f.remove(),f=s(m),!f)||(y===0?e.firstElementChild!==f&&e.prepend(f):d&&d.nextElementSibling!==f&&d.after(f),d=f)})}catch{e.children.length===0&&(e.innerHTML=I("offline","Failed to load roadmap.","The event service may be offline."))}}}function Mt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),l=document.getElementById("roadmap-cancel"),o=document.getElementById("roadmap-expand-all"),s=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{te=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",te=null},l.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let a=document.getElementById("roadmap-editor-input").value;if(!a.trim())return;let g=te?`/roadmap/${te}`:"/roadmap",p=te?"PATCH":"POST";try{await L(g,{method:p,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:a})}),document.getElementById("roadmap-editor-container").style.display="none",Y(!0)}catch(d){console.error(d)}},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{tt.forEach(a=>J.add(a.id)),Y(!0)},o.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{J.clear(),Y(!0)},s.dataset.listenerAttached="true")}function Bt(t){te=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function Dt(t){let e=t.state==="published"?"draft":"published";try{await L(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),Y(!0)}catch(l){console.error(l)}}async function Ht(t){if(confirm("Delete this roadmap item?"))try{await L(`/roadmap/${t}`,{method:"DELETE"}),J.delete(t),Y(!0)}catch(e){console.error(e)}}var nt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,st=null,se=new Set,at=[];async function ne(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Nt();let l="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let o=await L(l);if(!o.ok)throw new Error("Service is offline or unreachable.");let a=(await o.json()).events||[];if(at=a,st=Date.now(),U(2,st),a.length===0){e.innerHTML=I("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),oe(2,0);return}t&&(e.innerHTML="");let g=f=>{let v=f.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let n=(v.title||"Untitled Blueprint").trim(),u=(v.summary||v.body||"No summary provided.").trim(),T=(v.content||"").trim(),w=(v.category||"architecture").trim(),r=(v.affected_services||[]).map(D=>D.trim()),x=(v.implementation_path||[]).map(D=>D.trim()),i=v.approved===!0,c=new Date(f.timestamp*1e3),b=c.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=c.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),h=se.has(f.id),$=h?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${h?"expanded":""} ${i?"blueprint-approved":""}`,E.dataset.blueprintId=f.id,i&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let A=i?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[w]||"bx-paint";E.onclick=function(D){if(this.classList.contains("expanded")){this.classList.remove("expanded"),se.delete(f.id);let q=this.querySelector(".event-details");q&&(q.style.display="none")}else{this.classList.add("expanded"),se.add(f.id);let q=this.querySelector(".event-details");q&&(q.style.display="block")}};let R="";x.length>0&&(R=`
                ...
                `);let H=r.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${r.join(", ")}</span></div>`:"<div></div>",z=i?`
            ...
            `;E.innerHTML=`
                ...
                <div class="event-icon" style="${i?"color: #03dac6;":""}"><i class='bx ${A}'></i></div>
                <div class="event-content">
            ...
            `;let C=E.querySelector(".blueprint-approve-btn");C&&(C.onclick=async D=>{D.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await L(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ne(!0)}catch(P){console.error("Failed to approve blueprint:",P)}});let B=E.querySelector(".blueprint-delete-btn");B&&(B.onclick=async D=>{D.stopPropagation();let P=!i;B.innerHTML=P?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await L(`/events/${f.id}`,{method:"DELETE"})).ok&&ne(!0)}catch(q){console.error("Failed to delete blueprint:",q)}});let _=E.querySelector(".event-details");_&&_.addEventListener("click",D=>{D.stopPropagation()});let N=E.querySelector(".close-details-btn");return N&&N.addEventListener("click",D=>{D.stopPropagation(),E.classList.remove("expanded");let P=E.querySelector(".event-details");P&&(P.style.display="none"),se.delete(f.id)}),E},p=Array.from(e.children),d=new Map(p.map(f=>[f.dataset.blueprintId,f])),m=new Set(a.map(f=>f.id));p.forEach(f=>{let v=f.dataset.blueprintId;(!v||!m.has(v))&&f.remove()});let y=null;a.forEach((f,v)=>{let n=d.get(f.id);(!n||t)&&(n&&n.remove(),n=g(f),!n)||(v===0?e.firstElementChild!==n&&e.prepend(n):y&&y.nextElementSibling!==n&&y.after(n),y=n)}),oe(2,a.length)}catch(o){console.error("Error fetching blueprints:",o),e.children.length===0&&(e.innerHTML=I("offline","Failed to load blueprints.","The event service may be offline."))}}function Nt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{at.forEach(l=>se.add(l.id)),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{se.clear(),ne(!0)},e.dataset.listenerAttached="true")}var ot=()=>`
...
`,xe=null,X=new Set,ce=[],O="all",Ot={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered","system.notification.logged"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.logged","analysis.link.completed","analysis.visual.completed"],moderation:["moderation.explicit_content.deleted"]},zt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","system.blueprint.logged":"bx-paint","system.notification.logged":"bx-bell","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Ut(t){for(let[e,l]of Object.entries(Ot))if(l.includes(t))return e;return"system"}function qt(t){return zt[t]||"bx-square-rounded"}async function Q(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Ft();let o=`/events?ml=${O==="all"?100:250}&format=json&exclude_types=system.notification.generated`;try{let s=await L(o);if(!s.ok)throw new Error("Service unreachable");if(ce=((await s.json()).events||[]).filter(v=>{let n=v.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return!0}let u=n.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),xe=Date.now(),U(1,xe),ce.length===0){e.innerHTML=I("empty","No events found for this filter.");return}t&&(e.innerHTML="");let p=v=>{let n=v.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return null}let u=n.type,T=Ut(u),w=qt(u),r=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),x="event-border-grey";r&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?x="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="system.analysis.audit"?x="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?x="event-border-orange":u==="system.test.completed"?x=n.test?.status==="OK"&&n.lint?.status==="OK"&&n.format?.status==="OK"?"event-border-blue":"event-border-red":x="event-border-blue");let i=r?"cursor-pointer":"",c=X.has(v.id),b=c?"expanded":"",S=c?"display: block;":"display: none;",h=new Date(v.timestamp*1e3),$=h.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),E=h.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=rt(u,n),A=n.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${n.user_level})</span>`:"",R="";if(r){let C="";if(u==="engagement.decision")C=`
                    ...
                    `;else if(u==="messaging.user.sent_message"){let B="";n.attachments&&n.attachments.length>0&&(B=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${n.attachments.map(N=>{let D=N.content_type&&N.content_type.startsWith("image/"),P=(N.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ...
                                    <div class="attachment-info">
                                        ...
                                        <span class="attachment-meta">${N.content_type} \u2022 ${P}</span>
                                    </div>
                                </div>`}).join("")}</div>
                            </div>`),C=`
                        <div class="event-detail-row">
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ct()}
        </div>`;async function yt(){await Promise.all([ye(),ke(),Ie()]),await de()}var dt=null,pt=null;async function ht(){try{return await(await L("/system_monitor")).json()}catch{return null}}async function mt(){try{return await(await L("/system/hardware")).json()}catch{return null}}async function Gt(){try{return await(await L("/processes")).json()}catch{return null}}async function Wt(){try{return await(await L("/agent/status")).json()}catch{return null}}async function ke(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),l=document.querySelector("#hw-os .hw-content"),o=document.querySelector("#hw-cpu .hw-content"),s=document.querySelector("#hw-ram .hw-content"),a=document.querySelector("#hw-gpu .hw-content"),g=document.querySelector("#hw-storage .hw-content"),p=r=>{if(r){if(l&&(l.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}a&&(r.GPU&&r.GPU.length>0?a.innerHTML=r.GPU.map(x=>{let i=(x.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):a.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),g&&r.STORAGE&&r.STORAGE.length>0?g.innerHTML=r.STORAGE.map(x=>{let i=(x.USED/1073741824).toFixed(1),c=(x.SIZE/(1024*1024*1024)).toFixed(1),b=x.SIZE>0?(x.USED/x.SIZE*100).toFixed(0):0,S=x.MOUNT_POINT||"Unmounted";return`
                ...
                </div>`}function a(d){let m=d.status==="Ready";return`
                ...
                </div>`}function g(d){let m=d.status==="Downloaded",y=m?"service-widget-online":"service-widget-offline",f=m?"OK":"MISSING",v=m&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",n=d.name;return d.type==="custom"&&n.endsWith(":latest")&&(n=n.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${m?"bx-check-circle":"bx-x-circle"}"></i><h3>${n}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let p="";if(o&&(p+=s(o)),e.xtts&&(p+=a(e.xtts)),p+=l.map(g).join(""),!p){t.innerHTML=I("empty","No models found.");return}t.innerHTML!==p&&(t.innerHTML=p)}async function ye(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-t1-val"),l=document.getElementById("guardian-t2-val"),o=document.getElementById("guardian-idle-val"),s=document.getElementById("guardian-total-idle"),a=document.getElementById("guardian-total-active"),g=document.getElementById("guardian-total-waste"),p=document.getElementById("guardian-reset-btn");p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{p.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await L("/guardian/reset?tier=all",{method:"POST"}),setTimeout(()=>{p.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{p.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),ye()}catch{p.innerHTML="<i class='bx bx-error'></i> Failed"}},p.dataset.listenerAttached="true");let d=await Wt();if(d){let T=Math.floor(Date.now()/1e3),w=d.active_tier,r=b=>{b<0&&(b=0);let S=Math.floor(b/3600),h=Math.floor(b%3600/60),$=b%60;return S>0?`${S}h ${h}m`:h>0?`${h}m ${$}s`:`${$}s`},x=(b,S,h,$)=>{if(w===$)b.textContent="Working",b.style.color="#bb86fc";else if($==="t1"&&w==="tests")b.textContent="Testing",b.style.color="#03dac6";else if(h){let k=h.next_run-T;if(k<=0)b.textContent="Ready",b.style.color="#5eff5e";else{let A=Math.floor(k/60),R=k%60;b.textContent=`${A}m ${R}s`,b.style.color="#fff"}}S&&h&&(S.innerHTML=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Kt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[l,o]of Object.entries(t)){let s=$t.filter(a=>a.category===l);s.length!==0&&(e+=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),_e=!0,l}function wt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),_e=!1}function Et(t,e,l="output"){if(!_e)return;let o=document.createElement("div");o.className=`terminal-line terminal-${l}`,l==="prompt"?o.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:o.innerHTML=fe(e),t.appendChild(o),t.scrollTop=t.scrollHeight}async function Yt(t){let e=$t.find(s=>s.id===t);if(!e)return;let l=Jt(e);Et(l,`dex ${t}`,"prompt");let o=e.demo_output||["Executing command...","\u2713 Done."];for(let s of o){await new Promise(g=>setTimeout(g,400+Math.random()*600));let a="output";s.includes("[ERROR]")?a="error":s.includes("[SUCCESS]")||s.includes("\u2713")?a="success":s.includes("!")&&(a="warning"),Et(l,s,a)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function St(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Kt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let l=e.querySelector("code").textContent;navigator.clipboard.writeText(l).then(()=>{let o=e.querySelector("i");o.className="bx bx-check",o.style.color="#5eff5e",setTimeout(()=>{o.className="bx bx-copy",o.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.transform="translateY(-5px)",l.style.borderColor="rgba(255,255,255,0.15)",l.style.backgroundColor="rgba(255,255,255,0.05)"}),l.addEventListener("mouseleave",()=>{l.style.transform="translateY(0)",l.style.borderColor="rgba(255,255,255,0.05)",l.style.backgroundColor="rgba(255,255,255,0.03)"}),l.addEventListener("click",()=>{let o=l.dataset.cmd;Yt(o)})})}async function Xt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${$e()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Tt(){Xt(),Ve(),Re();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&St();let e=qe();Pe(e),ze();let l=document.getElementById("nav-left-container");l&&l.addEventListener("click",()=>{if(a.length>0)f();else{let i=window.location.pathname;if(!(i==="/"||i==="/index.html")){let S=(i.endsWith("/")&&i.length>1?i.slice(0,-1):i).split("/");S.pop();let h=S.join("/")||"/";window.location.href=h}}});let o=window.location.pathname==="/"||window.location.pathname==="/index.html",s=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!o&&!s&&document.querySelector("footer")?.classList.add("hide");let a=[],g=document.getElementById("windows-container");g&&g.setAttribute("data-count","0");let p=i=>{localStorage.setItem("dex_last_window",i)};function d(){return 1}function m(){for(;a.length>1;)a.shift().close(!0);let i=document.getElementById("windows-container"),c=document.querySelector("nav"),b=document.querySelector("footer"),S=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");i&&i.setAttribute("data-count",a.length),a.forEach(A=>{let R=document.getElementById(A.id);R&&R.classList.remove("hide-close")}),pe(ae());let $=document.getElementById("dexter-menu-container"),E=document.getElementById("nav-window-switcher"),k=document.getElementById("settings-icon");if(Oe(a.length>0),a.length>0){if(b?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),c?.classList.add("window-open"),i&&(i.style.paddingTop="60px"),$&&($.style.display="none"),k&&(k.style.display="none"),E){let A=a[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(A)?(E.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{p("alerts-window"),y(v)}),document.getElementById("switch-events").addEventListener("click",()=>{p("events-window"),y(n)}),document.getElementById("switch-monitor").addEventListener("click",()=>{p("monitor-window"),y(T)}),document.getElementById("switch-contacts").addEventListener("click",()=>{p("contacts-window"),y(u)}),document.getElementById("switch-workspace").addEventListener("click",()=>{p("workspace-window"),y(w)})):E.innerHTML=""}}else c?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),i&&(i.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),S||h?b?.classList.remove("hide"):b?.classList.add("hide"),$&&($.style.display="flex"),k&&(k.style.display="block"),E&&(E.innerHTML="");le(Je())}function y(i){if(i.isOpen()){i.close();return}for(;a.length>0;)a.pop().close(!0);a.push(i),i.open(),m()}function f(){[...a].forEach(c=>c.close()),a=[]}window.addEventListener("resize",m);let v=W({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Xe(),onOpen:()=>K(),onClose:()=>{let i=a.indexOf(v);i>-1&&a.splice(i,1),m()}}),n=W({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Ce(),onOpen:()=>{n.setContent(Ce()),Q()},onClose:()=>{let i=a.indexOf(n);i>-1&&a.splice(i,1),m()}}),u=W({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:lt(),onOpen:()=>Te(),onClose:()=>{let i=a.indexOf(u);i>-1&&a.splice(i,1),m()}}),T=W({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:ft()},{icon:"bxs-component",title:"Processes",content:gt()},{icon:"bxs-brain",title:"Models",content:bt()},{icon:"bxs-hdd",title:"Hardware",content:vt()},{icon:"bxs-terminal",title:"Logs",content:xt()},{icon:"bxs-zap",title:"Agents",content:ut()}],onOpen:()=>{ke(),ye(),Ie(),de()},onClose:()=>{let i=a.indexOf(T);i>-1&&a.splice(i,1),m()}}),w=W({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:ot(),onOpen:()=>Se(),onClose:()=>{let i=a.indexOf(w);i>-1&&a.splice(i,1),m()}}),r=W({id:"settings-window",title:"Settings",icon:"bx-cog",content:he(),onOpen:()=>{r.setContent(he()),Ae(r)},onClose:()=>{let i=a.indexOf(r);i>-1&&a.splice(i,1),m()}}),x=W({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="/dexter/contribute" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});if(window.dexter={viewEvent:i=>{n.isOpen()||y(n),setTimeout(()=>{let c=document.querySelector(`.event-item[data-event-id="${i}"]`);c&&(c.scrollIntoView({behavior:"smooth",block:"center"}),c.classList.add("flash-highlight"),c.classList.contains("expanded")||c.click(),setTimeout(()=>c.classList.remove("flash-highlight"),2e3))},500)},viewAlert:i=>{v.isOpen()||y(v),setTimeout(()=>{let c=document.querySelector(`.event-item[data-alert-id="${i}"]`);c&&(c.scrollIntoView({behavior:"smooth",block:"center"}),c.classList.add("flash-highlight"),c.classList.contains("expanded")||c.click(),setTimeout(()=>c.classList.remove("flash-highlight"),2e3))},500)}},e){let i=document.getElementById("dexter-dropdown");i&&(i.innerHTML=`
