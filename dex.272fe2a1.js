(()=>{function Ze(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ke(t=!1){let e=window.location.pathname,i=e==="/"||e==="/index.html",o=`
    ...
    `}
        ...
        `}
    `,l=document.createElement("nav");l.innerHTML=o,document.body.prepend(l)}function Ye(t){let e=window.location.pathname,i=e==="/"||e==="/index.html",a=document.getElementById("nav-chevron"),n=document.querySelector(".nav-left");!a||!n||(t||!i?(a.style.display="block",n.style.cursor="pointer",n.classList.add("recording"),n.onmouseenter=()=>{a.style.transform="translateX(-3px)"},n.onmouseleave=()=>{a.style.transform="translateX(0)"}):(a.style.display="none",n.style.cursor="default",n.classList.remove("recording"),n.onmouseenter=null,n.onmouseleave=null))}function Xe(){if(document.querySelector("footer"))return;let t=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Qe=1e3;function ie(t){let e=null,i=t.onClose||null,a=t.onOpen||null;function n(){e&&(e.style.zIndex=++Qe)}function o(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let g=document.getElementById("windows-container");g||(g=document.createElement("div"),g.id="windows-container",g.className="windows-container",document.body.appendChild(g)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Qe,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",f="",E;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${E}
        `,g.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),p()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let c=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),u(y,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let g=e.querySelector(".tab.active");g&&u(g,e)}function u(g,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let f=Array.from(s.querySelectorAll(".tab")),E=f.indexOf(g),y=s.clientWidth,c=f[Math.max(0,E-2)],v=f[Math.min(f.length-1,E+2)],r=c.offsetLeft-s.offsetLeft-25,h=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,M=h<=y?r-(y-h)/2:g.offsetLeft-s.offsetLeft-y/2+g.offsetWidth/2;s.scrollTo({left:M,behavior:"smooth"})},350)}function p(g=!1){e&&(window.removeEventListener("resize",l),g?(e.remove(),e=null):(e.classList.remove("open"),i&&i(),setTimeout(()=>{e?.remove(),e=null},400)))}function m(g){let b=e?.querySelector(".window-content");b&&(b.innerHTML=g)}function x(){return e&&e.classList.contains("open")}return{open:o,close:p,setContent:m,isOpen:x,focus:n,id:t.id}}function et(){return!!localStorage.getItem("easter_user_email")}function tt(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function st(t){localStorage.setItem("easter_user_email",t.trim())}var it="easter_theme",Y={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ye(){return localStorage.getItem(it)||Y.DARK}function nt(t){if(!Object.values(Y).includes(t))throw new Error("Invalid theme");localStorage.setItem(it,t),Ee(t)}function Ee(t){let e=document.body;if(Object.values(Y).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[Y.LIGHT,Y.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function at(){let t=ye();Ee(t)}function N(t,e,i=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",o=i?`<p class="placeholder-action">${i}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${o}</div>`}function B(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!i)return;if(!e){i.textContent="Last updated: never";return}let a=Date.now(),n=Math.floor((a-e)/1e3),o;n<60?o=`${n}s ago`:n<3600?o=`${Math.floor(n/60)}m ago`:o=`${Math.floor(n/3600)}h ago`,i.textContent=`Last updated: ${o}`}var Jt=0;function he(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!i)return;let a=i.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var X=0,Q=0;function rt(t){X=t,be()}function lt(t){Q=t,be()}function be(){let t=X+Q;Jt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let i=document.getElementById("alerts-menu-item");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",i.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=Q>9?"9+":Q,l.style.display=Q>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}let o=document.getElementById("switch-workspace");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",o.appendChild(l)),l.textContent=Q>9?"9+":Q,l.style.display=Q>0?"flex":"none"}}function Te(){let t=document.getElementById("alerts-list");if(!t)return;X=t.querySelectorAll(".alert-unread:not(.priority-low)").length,be()}function ct(){let t=document.getElementById("blueprints-list");if(!t)return;Q=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,be()}function Gt(){return"https://event.easter.company"}function Wt(){return"https://discord.easter.company"}var Vt="http://127.0.0.1:8100",Zt="http://127.0.0.1:8300",Kt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Le(t){let e=B(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,o)=>{let l=Kt[o];return l?`<span class="${l}">`:""});let i=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return i>a&&(e+="</span>".repeat(i-a)),e}function oe(t){if(!t)return"";let e=B(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(i,a)=>{let n=a.split("|").map(o=>o.trim());return n.every(o=>o.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(o=>`<span class="md-table-cell">${o}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Yt="https://sterling-javelin-12539.upstash.io",Xt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function ee(){return window.location.hostname==="easter.company"}var F=null,dt="dex_dashboard_snapshot";function Qt(){let t=localStorage.getItem(dt);if(t)try{F=JSON.parse(t)}catch{F=null}}async function ot(){if(!ee())return;let t=await ts("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);F=e,localStorage.setItem(dt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}function es(){if(!ee())return;Qt();let t=Date.now();(!F||t/1e3-F.timestamp>120)&&ot(),setInterval(()=>{new Date().getSeconds()===59&&ot()},1e3)}ee()&&es();async function ts(t,...e){try{let a=await(await fetch(Yt,{method:"POST",headers:{Authorization:`Bearer ${Xt}`},body:JSON.stringify([t,...e])})).json();if(a.error)throw new Error(a.error);return a.result}catch(i){return console.error("Upstash Error:",i),null}}var fe=null,ge=null,ke=!1,Se=!1;async function _(t,e={}){if(ee()){if(!F)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(F.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(F.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),o=n.get("type")||n.get("event.type"),l=n.get("category"),u=n.get("order")||"desc",p=[];return o==="system.notification.generated"?p=[...F.alerts||[]]:l==="messaging"?p=[...F.messaging_events||[]]:l==="system"?p=[...F.system_events||[]]:l==="cognitive"?p=[...F.cognitive_events||[]]:l==="moderation"?p=[...F.moderation_events||[]]:p=[...F.events||[]],u==="asc"?p.sort((m,x)=>m.timestamp-x.timestamp):p.sort((m,x)=>x.timestamp-m.timestamp),new Response(JSON.stringify({events:p,count:p.length}),{status:200})}return t.startsWith("/logs")?new Response(JSON.stringify([]),{status:200}):t.startsWith("/system/hardware")?new Response(JSON.stringify({}),{status:200}):t.startsWith("/agent/status")||t.startsWith("/guardian/status")?new Response(JSON.stringify({}),{status:200}):new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(fe)try{let n=await fetch(fe+t,e);if(n.ok)return n;fe=null}catch{fe=null}let i=Gt(),a=Vt;try{let n=await fetch(i+t,e);if(n.ok)return fe=i,ke&&(console.log("\u2728 Production event service restored."),ke=!1),n;throw new Error("Primary failed")}catch{ke||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),ke=!0);try{let o=await fetch(a+t,e);if(o.ok)return fe=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}async function Me(t,e={}){if(ge)try{let n=await fetch(ge+t,e);if(n.ok)return n;ge=null}catch{ge=null}let i=Wt(),a=Zt;try{let n=await fetch(i+t,e);if(n.ok)return ge=i,Se&&(console.log("\u2728 Production discord service restored."),Se=!1),n;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),Se=!0);try{let o=await fetch(a+t,e);if(o.ok)return ge=a,o;throw new Error("Fallback failed")}catch(o){throw o}}}var pt=()=>`
...
`;function wt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"VS Code"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function Ct(t){if(!document.getElementById("dex-profile-styles")){let i=document.createElement("style");i.id="dex-profile-styles",i.textContent=ls,document.head.appendChild(i)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",i=>{i.target===e&&(e.classList.remove("active"),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),Me(`/profile/${t.id}`).then(async i=>{if(i.ok){let a=await i.json();Re(e,t,a)}else{console.log("Profile not found or error, using mock data.");let a=wt(t.id,t.username);Re(e,t,a)}}).catch(i=>{console.error("Profile fetch error:",i);let a=wt(t.id,t.username);Re(e,t,a)})}function Re(t,e,i){let a=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",n=()=>{let E=(i.badges||[]).map(M=>`<span class="profile-badge ${M==="Creator"?"master":""}">${M}</span>`).join(""),y=(i.attributes||i.facts||[]).map(M=>{let A=M.key||M.k,L=M.value||M.v;return`
            <div class="fact-chip">
...
`,cs=null;async function Pe(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...",await Pe(),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=i=>{let a=i.target.closest(".user-profile-card");if(a)try{let n=JSON.parse(a.dataset.user);Ct(n)}catch(n){console.error("Failed to parse user data",n)}},t.dataset.listenerAttached="true");try{let i=await Me("/contacts");if(!i.ok)throw new Error("Service unreachable");let n=(await i.json()).members||[];if(cs=Date.now(),n.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let o={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((l,u)=>{let p=o[l.level]??10,m=o[u.level]??10;return p!==m?p-m:l.username.localeCompare(u.username)}),t.innerHTML=n.map(l=>{let u=l.color?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",p=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",m="#888";l.level==="Me"||l.level==="Master"?m="#bb86fc":l.level==="Admin"?m="#cf6679":l.level==="Moderator"?m="#03dac6":l.level==="Contributor"&&(m="#ffa500");let x=l.level==="Me",g=x?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",b=x?"2px solid #bb86fc":`1px solid ${u}33`;return`
...
`,_e=null,me=new Set,we=[],J="all",ps={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},ms={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function us(t){for(let[e,i]of Object.entries(ps))if(i.includes(t))return e;return"system"}function fs(t){return ms[t]||"bx-square-rounded"}async function ae(t=!1){let e=document.getElementById("events-timeline");if(!e)return;gs();let a=`/events?ml=${J==="all"?100:250}&format=json`;J!=="all"&&(a+=`&category=${J}`);try{let n=await _(a);if(!n.ok)throw new Error("Service unreachable");if(we=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let f=s.type;return!(f==="system.blueprint.generated"||f==="system.notification.generated")}),_e=Date.now(),W(1,_e),we.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let u=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let f=s.type,E=us(f),y=fs(f),c=f==="engagement.decision"||f==="messaging.bot.sent_message"||f==="messaging.user.sent_message"||f==="moderation.explicit_content.deleted"||f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="analysis.user.message_signals"||f==="system.cli.command"||f==="system.analysis.audit"||f==="system.test.completed"||f==="error_occurred"||f==="system.cli.status"||f==="system.attention.expired"||f.startsWith("system.roadmap")||f.startsWith("system.process"),v="event-border-grey";c&&(f==="moderation.explicit_content.deleted"||f==="error_occurred"?v="event-border-red":f==="analysis.link.completed"||f==="analysis.visual.completed"||f==="analysis.router.decision"||f==="system.analysis.audit"||f==="analysis.user.message_signals"?v="event-border-purple":f==="system.attention.expired"||f==="system.cli.command"||f==="system.cli.status"?v="event-border-orange":f==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",d=me.has(b.id),h=d?"expanded":"",M=d?"display: block;":"display: none;",A=new Date(b.timestamp*1e3),L=A.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),I=A.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),w=Et(f,s),H=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",D="";if(c){let S="";if(f==="engagement.decision"){let C=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;S=`
                    ...
                    `}else if(f==="system.attention.expired"){let C=k=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${k}</h5>`,$=s.timestamp-s.last_active,T=Math.floor($/60);S=`
                    ...
                    `}else if(f==="messaging.bot.sent_message"){let C=k=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${k}</h5>`,$="";s.eval_count&&($=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let T="";if(s.chat_history&&s.chat_history.length>0){let k=s.chat_history.length,R=s.chat_history.map((P,te)=>{let j=P.role.toUpperCase();j==="ASSISTANT"&&(j="DEXTER");let q=P.role==="user"?"#03dac6":P.role==="system"?"#ffb74d":"#bb86fc",Z=te===k-1?"block":"none";return`
                                <div class="history-slide" data-index="${te}" style="display: ${Z};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${te+1} of ${k}</span>
                                    </div>
                        ...
                        `}
                    `}else if(f==="analysis.user.message_signals"){let C=k=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${k}</h5>`,$=s.signals||{};S=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(f==="system.analysis.audit"){let C=s.success?"#03dac6":"#ff4d4d",$=s.success?"SUCCESS":"FAILED",T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,k="";s.error&&(k=`
                            <div class="event-detail-block">
                                ${T("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${B(s.error)}</pre>
                            </div>
                        `);let R="";if(s.chat_history&&s.chat_history.length>0){let j=s.chat_history.length,q=s.chat_history.map((Z,ue)=>{let K=Z.role.toUpperCase();K==="USER"&&(K="SYSTEM"),K==="ASSISTANT"&&(K="AGENT");let G=Z.role==="user"?"#03dac6":Z.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ue}" style="display: ${ue===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; text-transform: uppercase; color: ${G}; letter-spacing: 1px; font-weight: bold;">${K}</span>
                        ...
                        `}let P="";if(s.corrections&&s.corrections.length>0){let j=s.corrections.map((q,Z)=>`
                        ...
                        `}let te="";if(s.parsed_results&&s.parsed_results.length>0){let j=s.parsed_results.map(q=>`
                    ...
                    `}else if(f==="messaging.user.sent_message"){let C="";s.attachments&&s.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(T=>{let k=T.content_type&&T.content_type.startsWith("image/"),R=(T.size/1024).toFixed(1)+" KB";return`
                ...
                ${Object.values(Y).map(n=>`
                    <div class="theme-card ${t===n?"active":""}" data-theme="${n}">
                        ...
                        <div class="theme-info">
                            ...
                            <p>${n===Y.DARK?"Simple, clean, dark.":n===Y.LIGHT?"Heavenly, bright, and glowy.":"The original animated style."}</p>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ws=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[i,a]of Object.entries(t)){let n=Ot.filter(o=>o.category===i);n.length!==0&&(e+=`
