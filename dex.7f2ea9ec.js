(()=>{function Ge(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function We(t=!1){let e=window.location.pathname,a=e==="/"||e==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ke=1e3;function ee(t){let e=null,a=t.onClose||null,o=t.onOpen||null;function n(){e&&(e.style.zIndex=++Ke)}function i(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),o&&setTimeout(o,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ke,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",u="",I;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${I}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),p()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let c=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),m(h,e)})}),setTimeout(()=>{e.classList.add("open"),o&&o()},10)}function l(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&m(f,e)}function m(f,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),I=u.indexOf(f),h=s.clientWidth,c=u[Math.max(0,I-2)],v=u[Math.min(u.length-1,I+2)],r=c.offsetLeft-s.offsetLeft-25,y=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,C=y<=h?r-(h-y)/2:f.offsetLeft-s.offsetLeft-h/2+f.offsetWidth/2;s.scrollTo({left:C,behavior:"smooth"})},350)}function p(f=!1){e&&(window.removeEventListener("resize",l),f?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function g(f){let b=e?.querySelector(".window-content");b&&(b.innerHTML=f)}function x(){return e&&e.classList.contains("open")}return{open:i,close:p,setContent:g,isOpen:x,focus:n,id:t.id}}function Ye(){return!0}function Xe(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Qe(t){localStorage.setItem("easter_user_email",t.trim())}var Ze="easter_theme",K={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function be(){return localStorage.getItem(Ze)||K.DARK}function et(t){if(!Object.values(K).includes(t))throw new Error("Invalid theme");localStorage.setItem(Ze,t),we(t)}function we(t){let e=document.body;if(Object.values(K).forEach(o=>{e.classList.remove(`theme-${o}`)}),e.classList.add(`theme-${t}`),[K.LIGHT,K.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let o=document.createElement("div");o.className="background",document.body.prepend(o)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function tt(){let t=be();we(t)}function B(t,e,a=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",i=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${i}</div>`}function D(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let o=Date.now(),n=Math.floor((o-e)/1e3),i;n<60?i=`${n}s ago`:n<3600?i=`${Math.floor(n/60)}m ago`:i=`${Math.floor(n/3600)}h ago`,a.textContent=`Last updated: ${i}`}var Rt=0;function ve(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let o=a.querySelector(".notification-badge");o&&(e>0?(o.textContent=e>9?"9+":e,o.style.display="flex"):o.style.display="none")}var Y=0,X=0;function st(t){Y=t,ue()}function nt(t){X=t,ue()}function ue(){let t=Y+X;Rt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let a=document.getElementById("alerts-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let o=document.getElementById("workspace-menu-item");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",o.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let i=document.getElementById("switch-workspace");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}}function Se(){let t=document.getElementById("alerts-list");if(!t)return;Y=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ue()}function it(){let t=document.getElementById("blueprints-list");if(!t)return;X=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ue()}function Be(){return"https://event.easter.company"}function Pt(){return"https://discord.easter.company"}var Ot="http://127.0.0.1:8100",Ut="http://127.0.0.1:8300",qt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Ce(t){let e=D(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,i)=>{let l=qt[i];return l?`<span class="${l}">`:""});let a=(e.match(/<span/g)||[]).length,o=(e.match(/<\/span/g)||[]).length;return a>o&&(e+="</span>".repeat(a-o)),e}function te(t){if(!t)return"";let e=D(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(a,o)=>{let n=o.split("|").map(i=>i.trim());return n.every(i=>i.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(i=>`<span class="md-table-cell">${i}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e=e.split(/\n\n+/).map(a=>a.trim().startsWith("<")?a:`<p class="md-para">${a.trim()}</p>`).join(`
`),e}var pe=null,me=null,Ee=!1,$e=!1;async function M(t,e={}){if(pe)try{let n=await fetch(pe+t,e);if(n.ok)return n;pe=null}catch{pe=null}let a=Be(),o=Ot;try{let n=await fetch(a+t,e);if(n.ok)return pe=a,Ee&&(console.log("\u2728 Production event service restored."),Ee=!1),n;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${o}`),Ee=!0);try{let i=await fetch(o+t,e);if(i.ok)return pe=o,i;throw new Error("Fallback failed")}catch(i){throw i}}}async function at(t,e={}){if(me)try{let n=await fetch(me+t,e);if(n.ok)return n;me=null}catch{me=null}let a=Pt(),o=Ut;try{let n=await fetch(a+t,e);if(n.ok)return me=a,$e&&(console.log("\u2728 Production discord service restored."),$e=!1),n;throw new Error("Primary failed")}catch{$e||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${o}`),$e=!0);try{let i=await fetch(o+t,e);if(i.ok)return me=o,i;throw new Error("Fallback failed")}catch(i){throw i}}}var ot=()=>`
...
`,ke=null,se=new Set,Te=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;jt(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let o=await M(a);if(!o.ok)throw new Error("Service is offline or unreachable.");let i=(await o.json()).events||[];ke=Date.now(),W(0,ke);let l=Date.now(),m=24*60*60*1e3,p=i.filter(r=>{let d=localStorage.getItem(`alert_read_ts_${r.id}`);if(!d)return!0;let y=parseInt(d);return l-y<m});p.sort((r,d)=>{let y=_=>{let E=_.event;if(typeof E=="string")try{E=JSON.parse(E)}catch{return"low"}return(E.priority||"low").toLowerCase()},C=_=>_==="critical"?4:_==="high"?3:_==="medium"?2:1,T=C(y(r)),S=C(y(d));return T!==S?S-T:d.timestamp-r.timestamp}),Te=p;let g=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return"low"}return(d.priority||"low").toLowerCase()},x=[],b=new Set(p.map(r=>g(r))).size>1;if(p.length>0){let r=null;p.forEach(d=>{let y=g(d);b&&y!==r&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),r=y),x.push(d)})}if(t&&(e.innerHTML=""),p.length===0){e.innerHTML=B("empty","No alerts yet."),Se();return}let s=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return null}let y=(d.title||"Untitled Alert").trim(),C=(d.body||"No description provided.").trim(),T=d.summary||"",S=d.content||"",_=d.protocol||"",E=(d.priority||"low").toLowerCase(),N=!!d.alert,P=(d.category||"system").trim(),H=d.related_event_ids||[],R=d.audit_event_id,q=!!localStorage.getItem(`alert_read_ts_${r.id}`),k=new Date(r.timestamp*1e3),w=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),$=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=q?"event-border-grey":"event-border-blue";!q&&N&&(A="event-border-red"),q&&(E==="high"||E==="critical")?A="event-border-red":q&&E==="medium"&&(A="event-border-orange");let L=q?"alert-read":"alert-unread",z=se.has(r.id),U=z?"expanded":"",he=z?"display: block;":"display: none;",F="",j="";H.length>0&&(j=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="detail-pre" style="color: #ddd; font-size: 0.85em;">${te(S)}</div>
            </div>
        `:V=`
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="detail-pre" style="color: #fff;">${te(C)}</div>
            </div>
        `,F=`
            ...
            `;let je=G.querySelector(".event-details");je&&je.addEventListener("click",Z=>{Z.stopPropagation()});let Fe=G.querySelector(".close-details-btn");return Fe&&Fe.addEventListener("click",Z=>{Z.stopPropagation(),G.classList.remove("expanded");let _e=G.querySelector(".event-details");_e&&(_e.style.display="none"),se.delete(r.id)}),G},u=r=>{let d=document.createElement("div");d.className="notification-divider",d.dataset.alertId=r.id;let y="#888888";return r.label==="CRITICAL"?y="#ff4d4d":r.label==="HIGH"?y="#ff8888":r.label==="MEDIUM"&&(y="#ffa500"),d.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,d.innerHTML=`<span style="white-space: nowrap;">${r.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,d},I=Array.from(e.children),h=new Map(I.map(r=>[r.dataset.alertId,r])),c=new Set(x.map(r=>r.id));I.forEach(r=>{let d=r.dataset.alertId;(!d||!c.has(d))&&r.remove()});let v=null;x.forEach((r,d)=>{let y=h.get(r.id);(!y||t)&&(y&&y.remove(),r.type==="divider"?y=u(r):y=s(r),!y)||(d===0?e.firstElementChild!==y&&e.prepend(y):v&&v.nextElementSibling!==y&&v.after(y),v=y)}),ke=Date.now(),W(0,ke),Se()}catch(o){console.error("Error fetching alerts:",o),e.children.length===0&&(e.innerHTML=B("offline","Failed to load alerts.","The event service may be offline."))}}function jt(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),a=document.getElementById("alerts-close-all"),o=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Te.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Te.forEach(n=>{se.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ne(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{se.clear(),ne(!0)},a.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){o.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;Te.forEach(i=>{localStorage.setItem(`alert_read_ts_${i.id}`,n.toString())}),se.clear(),ne(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{o.innerHTML="<i class='bx bx-trash'></i> Clear"}}},o.dataset.listenerAttached="true")}async function rt(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await M(t);if(!e.ok)return;let o=(await e.json()).events||[],n=0;o.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${i.id}`)||n++}),st(n)}catch{}}var lt=()=>`
...
`,ie=new Set,dt=[],ge=null;async function ae(t=!1){let e=document.getElementById("roadmap-list");if(e){Ft();try{let a=await M("/roadmap");if(!a.ok)throw new Error("Offline");let o=await a.json();dt=o;let n=g=>{let x=ie.has(g.id),f=g.state==="published",b=g.state==="consumed",s="event-border-grey";f&&(s="event-border-blue"),b&&(s="event-border-purple");let I=new Date(g.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${s} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=g.id,h.onclick=r=>{if(r.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ie.delete(g.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",ie.add(g.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${g.state.toUpperCase()}]</span>`;h.innerHTML=`
      ...
      `;let v=h.querySelector(".event-details");return v&&v.addEventListener("click",r=>{r.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Gt(g)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Wt(g)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Jt(g.id)),h.querySelector(".close-details-btn")?.addEventListener("click",r=>{r.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ie.delete(g.id)}),h},i=Array.from(e.children),l=new Map(i.map(g=>[g.dataset.itemId,g])),m=new Set(o.map(g=>g.id));if(i.forEach(g=>{let x=g.dataset.itemId;(!x||!m.has(x))&&g.remove()}),o.length===0){e.innerHTML=B("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let p=null;o.forEach((g,x)=>{let f=l.get(g.id);(!f||t)&&(f&&f.remove(),f=n(g),!f)||(x===0?e.firstElementChild!==f&&e.prepend(f):p&&p.nextElementSibling!==f&&p.after(f),p=f)})}catch{e.children.length===0&&(e.innerHTML=B("offline","Failed to load roadmap.","The event service may be offline."))}}}function Ft(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),o=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ge=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",ge=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let i=document.getElementById("roadmap-editor-input").value;if(!i.trim())return;let l=ge?`/roadmap/${ge}`:"/roadmap",m=ge?"PATCH":"POST";try{await M(l,{method:m,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:i})}),document.getElementById("roadmap-editor-container").style.display="none",ae(!0)}catch(p){console.error(p)}},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{dt.forEach(i=>ie.add(i.id)),ae(!0)},o.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ie.clear(),ae(!0)},n.dataset.listenerAttached="true")}function Gt(t){ge=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function Wt(t){let e=t.state==="published"?"draft":"published";try{await M(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ae(!0)}catch(a){console.error(a)}}async function Jt(t){if(confirm("Delete this roadmap item?"))try{await M(`/roadmap/${t}`,{method:"DELETE"}),ie.delete(t),ae(!0)}catch(e){console.error(e)}}var mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,pt=null,oe=new Set,gt=[];async function re(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Vt();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let o=await M(a);if(!o.ok)throw new Error("Service is offline or unreachable.");let i=(await o.json()).events||[];if(gt=i,pt=Date.now(),W(2,pt),i.length===0){e.innerHTML=B("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),ve(2,0);return}t&&(e.innerHTML="");let l=f=>{let b=f.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let s=(b.title||"Untitled Blueprint").trim(),u=(b.summary||b.body||"No summary provided.").trim(),I=(b.content||"").trim(),h=(b.category||"architecture").trim(),c=(b.related_services||b.affected_services||[]).map(L=>L.trim()),v=(b.implementation_path||[]).map(L=>L.trim()),r=b.source_event_ids||[],d=b.approved===!0,y=new Date(f.timestamp*1e3),C=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=oe.has(f.id),_=S?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${d?"blueprint-approved":""}`,E.dataset.blueprintId=f.id,d&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let P=d?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";E.onclick=function(L){if(this.classList.contains("expanded")){this.classList.remove("expanded"),oe.delete(f.id);let U=this.querySelector(".event-details");U&&(U.style.display="none")}else{this.classList.add("expanded"),oe.add(f.id);let U=this.querySelector(".event-details");U&&(U.style.display="block")}};let H="";v.length>0&&(H=`
            ...
            `;let k=E.querySelector(".blueprint-approve-btn");k&&(k.onclick=async L=>{L.stopPropagation(),k.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await M(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&re(!0)}catch(z){console.error("Failed to approve blueprint:",z)}});let w=E.querySelector(".blueprint-delete-btn");w&&(w.onclick=async L=>{L.stopPropagation();let z=!d;w.innerHTML=z?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await M(`/events/${f.id}`,{method:"DELETE"})).ok&&re(!0)}catch(U){console.error("Failed to delete blueprint:",U)}});let $=E.querySelector(".event-details");$&&$.addEventListener("click",L=>{L.stopPropagation()});let A=E.querySelector(".close-details-btn");return A&&A.addEventListener("click",L=>{L.stopPropagation(),E.classList.remove("expanded");let z=E.querySelector(".event-details");z&&(z.style.display="none"),oe.delete(f.id)}),E},m=Array.from(e.children),p=new Map(m.map(f=>[f.dataset.blueprintId,f])),g=new Set(i.map(f=>f.id));m.forEach(f=>{let b=f.dataset.blueprintId;(!b||!g.has(b))&&f.remove()});let x=null;i.forEach((f,b)=>{let s=p.get(f.id);(!s||t)&&(s&&s.remove(),s=l(f),!s)||(b===0?e.firstElementChild!==s&&e.prepend(s):x&&x.nextElementSibling!==s&&x.after(s),x=s)}),ve(2,i.length),it()}catch(o){console.error("Error fetching blueprints:",o),e.children.length===0&&(e.innerHTML=B("offline","Failed to load blueprints.","The event service may be offline."))}}async function ft(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await M(t);if(!e.ok)return;let o=(await e.json()).events||[],n=0;o.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),nt(n)}catch{}}function Vt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),a=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{gt.forEach(o=>oe.add(o.id)),re(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{oe.clear(),re(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.blueprint.generated",{method:"DELETE"}),oe.clear(),re(!0)}catch(o){console.error("Failed to clear blueprints:",o)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var bt=()=>`
...
`,Le=null,le=new Set,xe=[],O="all",Xt={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision"],moderation:["moderation.explicit_content.deleted"]},Qt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Zt(t){for(let[e,a]of Object.entries(Xt))if(a.includes(t))return e;return"system"}function es(t){return Qt[t]||"bx-square-rounded"}async function ce(t=!1){let e=document.getElementById("events-timeline");if(!e)return;ts();let o=`/events?ml=${O==="all"?100:250}&format=json`;O!=="all"&&(o+=`&category=${O}`);try{let n=await M(o);if(!n.ok)throw new Error("Service unreachable");if(xe=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Le=Date.now(),W(1,Le),xe.length===0){e.innerHTML=B("empty","No events found for this filter.");return}t&&(e.innerHTML="");let m=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,I=Zt(u),h=es(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),v="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?v="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"?v="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?v="event-border-orange":u==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",d=le.has(b.id),y=d?"expanded":"",C=d?"display: block;":"display: none;",T=new Date(b.timestamp*1e3),S=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=xt(u,s),N=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",P="";if(c){let k="";if(u==="engagement.decision"){let w=$=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${$}</h5>`;k=`
                    ...
                    `}else if(u==="system.attention.expired"){let w=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,$=s.timestamp-s.last_active,A=Math.floor($/60);k=`
                    ...
                    `}else if(u==="system.analysis.audit"){let w=s.success?"#03dac6":"#ff4d4d",$=s.success?"SUCCESS":"FAILED",A=F=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${F}</h5>`,L="";s.error&&(L=`
                            <div class="event-detail-block">
                                ${A("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${D(s.error)}</pre>
                            </div>
                        `);let z="";if(s.chat_history&&s.chat_history.length>0){let F=s.chat_history.length,j=s.chat_history.map((Q,de)=>{let V=Q.role.toUpperCase();V==="USER"&&(V="SYSTEM"),V==="ASSISTANT"&&(V="AGENT");let G=Q.role==="user"?"#03dac6":Q.role==="system"?"#ffb74d":"#bb86fc";return`
                    ...
                    `}else if(u==="messaging.user.sent_message"){let w="";s.attachments&&s.attachments.length>0&&(w=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(A=>{let L=A.content_type&&A.content_type.startsWith("image/"),z=(A.size/1024).toFixed(1)+" KB";return`
            ...
            `;let R=H.querySelector(".event-details");if(R&&R.addEventListener("click",k=>{k.stopPropagation()}),c){let k=H.querySelector(".close-details-btn");k&&k.addEventListener("click",w=>{w.stopPropagation();let $=w.target.closest(".event-item");if($){$.classList.remove("expanded"),le.delete(b.id);let A=$.querySelector(".event-details");A&&(A.style.display="none")}})}let J=H.querySelector(".prev-btn"),q=H.querySelector(".next-btn");if(J&&q){let k=0,w=H.querySelectorAll(".history-slide"),$=w.length,A=()=>{w.forEach((L,z)=>{L.style.display=z===k?"block":"none"}),J.disabled=k===0,q.disabled=k===$-1,J.style.opacity=k===0?"0.5":"1",q.style.opacity=k===$-1?"0.5":"1"};J.addEventListener("click",L=>{L.stopPropagation(),k>0&&(k--,A())}),q.addEventListener("click",L=>{L.stopPropagation(),k<$-1&&(k++,A())}),A()}return H},p=Array.from(e.children),g=new Map(p.map(b=>[b.dataset.eventId,b])),x=new Set(xe.map(b=>b.id));p.forEach(b=>{let s=b.dataset.eventId;(!s||!x.has(s))&&b.remove()});let f=null;xe.forEach((b,s)=>{let u=g.get(b.id);(!u||t)&&(u&&u.remove(),u=m(b),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):f&&f.nextElementSibling!==u&&f.after(u),f=u)}),Le=Date.now(),W(1,Le)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=B("offline","Failed to load events.","The event service may be offline."))}}function ts(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),a=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{xe.forEach(n=>le.add(n.id)),ce(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{le.clear(),ce(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{a.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active")),n.classList.add("active"),O=n.dataset.filter,ce(!0)}}),a.dataset.listenerAttached="true"),a&&a.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===O?n.classList.add("active"):n.classList.remove("active")});let o=document.getElementById("events-clear");o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{let n=O==="all"?"ALL":O.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){o.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let i="/events";if(O!=="all"?i+=`?category=${O}`:i+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await M(i,{method:"DELETE"})).ok)throw new Error("Failed to delete events");le.clear(),ce(!0)}catch(i){console.error("Failed to clear events:",i),alert("Failed to clear events. Check console.")}finally{o.innerHTML="<i class='bx bx-trash'></i> Clear"}}},o.dataset.listenerAttached="true")}function yt(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var ss=null;async function ye(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await M("/logs");if(!e.ok)throw new Error("Logs offline");let a=await e.json();if(!a||a.length===0)return t.innerHTML=B("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let o=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],n=a.filter(l=>!o.includes(l.id));n.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),n.reverse();let i=n.map(l=>{let m=l.logs.join(`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${yt()}
        </div>`;async function It(){await Promise.all([Ie(),Re(),Pe()]),await ye()}var ht=null,wt=null;async function At(){try{return await(await M("/system_monitor")).json()}catch{return null}}async function Et(){try{return await(await M("/system/hardware")).json()}catch{return null}}async function ns(){try{return await(await M("/processes")).json()}catch{return null}}async function is(){try{return await(await M("/agent/status")).json()}catch{return null}}async function Re(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),a=document.querySelector("#hw-os .hw-content"),o=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),i=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),m=c=>{if(c){if(a&&(a.innerHTML=`
                ...
                </div>`}if(o&&c.CPU&&c.CPU.length>0){let v=c.CPU[0];o.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let c=await Et();c?(m(c),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},e.dataset.listenerAttached="true"),o&&!o.hasChildNodes())){let c=await Et();m(c)}if(!t)return;let p=await At();if(!p||!p.services){t.children.length===0&&(t.innerHTML=B("offline","Failed to load system metrics.","The event service may be offline."));return}ht=Date.now(),W(0,ht);let g=p.services||[];Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function x(c){return!c||c==="N/A"||c==="unknown"||c.trim()===""?"-":c}function f(c){if(!c||c==="N/A"||c==="unknown")return"-";let v=c.match(/^(\d+\.\d+\.\d+)/);return v?v[0]:c.split(".").slice(0,3).join(".")||"-"}function b(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function s(c){if(!c||c==="N/A"||c==="unknown")return"-";let v=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!v)return"-";let r=parseInt(v[1])||0,d=parseInt(v[2])||0,y=parseInt(v[3])||0,C=parseFloat(v[4])||0,T=r*86400+d*3600+y*60+C,S=Math.floor(T/86400);if(S>0)return`${S}d`;let _=Math.floor(T/3600);if(_>0)return`${_}h`;let E=Math.floor(T/60);return E>0?`${E}m`:`${Math.floor(T)}s`}function u(c){let v=c.status==="online",r=v?"service-widget-online":"service-widget-offline",d=v?"bx-check-circle":"bx-x-circle",y=v?"OK":"BAD",C=c.version?f(c.version.str):"-",T=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",S=c.memory&&c.memory!=="N/A"?c.memory:"-",_=T!=="-"?"#00ff00":"#666",E=T!=="-"?"#fff":"#666",N=S!=="-"?"#00ff00":"#666",P=S!=="-"?"#fff":"#666",H=s(c.uptime),R="";return v?R=`
                ...
                </div>`}function l(p){let g=p.status==="Downloaded",x=g?"service-widget-online":"service-widget-offline",f=g?"OK":"MISSING",b=g&&p.size>0?`${(p.size/1e9).toFixed(2)} GB`:"-",s=p.name;return p.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${p.name}"><div class="service-widget-header"><i class="bx ${g?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${p.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let m="";if(o&&(m+=n(o)),e.xtts&&(m+=i(e.xtts)),m+=a.map(l).join(""),!m){t.innerHTML=B("empty","No models found.");return}t.innerHTML!==m&&(t.innerHTML=m)}async function Ie(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),a=document.getElementById("guardian-architect-val"),o=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),i=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),m=document.getElementById("guardian-reset-btn");m&&!m.dataset.listenerAttached&&(m.onclick=async()=>{m.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await M("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{m.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{m.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),Ie()}catch{m.innerHTML="<i class='bx bx-error'></i> Failed"}},m.dataset.listenerAttached="true");let p=await is();if(p){let I=Math.floor(Date.now()/1e3),h=p.active_tier,c=p.protocol_aliases||{sentry:"Sentry",architect:"Architect"},v=C=>{C<0&&(C=0);let T=Math.floor(C/3600),S=Math.floor(C%3600/60),_=C%60;return T>0?`${T}h ${S}m`:S>0?`${S}m ${_}s`:`${_}s`},r=(C,T,S,_)=>{if(!C)return;let E=c[_]||_.toUpperCase(),N=C.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(N&&(N.textContent=E),h&&h.includes(E))C.textContent="Working",C.style.color="#bb86fc";else if(S){let H=S.next_run-I;if(H<=0)C.textContent="Ready",C.style.color="#5eff5e";else{let R=Math.floor(H/60),J=H%60;C.textContent=`${R}m ${J}s`,C.style.color="#fff"}}T&&S&&(T.innerHTML=`
        ...
        `)};e&&r(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry"),a&&r(a,document.getElementById("guardian-architect-stats"),p.architect,"architect");let d=document.getElementById("system-state-label"),y=document.getElementById("system-state-val");if(y&&p.system_state){let C=p.system_state,T=v(p.system_state_time||0);d&&(d.textContent=`State: ${C.toUpperCase()}`),y.textContent=T,C==="idle"?y.style.color=p.system_state_time>300?"#5eff5e":"#fff":y.style.color="#bb86fc"}n&&(n.textContent=v(p.total_idle_time||0)),i&&(i.textContent=v(p.total_active_time||0)),l&&(l.textContent=v(p.total_waste_time||0))}else[e,a,o,n,i,l].forEach(h=>{h&&(h.textContent="-",h.style.color="#666")});let g=await ns(),x=[],f=[],b=[];g&&(Array.isArray(g)?x=g:(x=g.active||[],f=g.queue||[],b=g.history||[],b.sort((I,h)=>(h.end_time||0)-(I.end_time||0)))),x.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=B("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),ze(t,x,!1));let s=document.getElementById("processes-queue-widgets");s&&(f.length===0?!s.querySelector(".tab-placeholder")&&!s.querySelector('div[style*="font-style: italic"]')&&(s.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(s.innerHTML="",ze(s,f,!1)));let u=document.getElementById("processes-history-widgets");u&&(b.length===0?u.querySelector(".tab-placeholder")||(u.innerHTML=B("empty","No recent history.")):(u.querySelector(".tab-placeholder")&&(u.innerHTML=""),ze(u,b,!0))),ve(1,x.length)}function ze(t,e,a){function o(m){let p="";m.end_time?p=`${m.end_time-m.start_time}s`:p=`${Math.floor(Date.now()/1e3-m.start_time)}s`;let g=m.retries>0?`<span class="process-retry-badge">Retry ${m.retries}</span>`:"",x=m.channel_id,f={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation"};if(f[x]?x=f[x]:/^\d+$/.test(x)&&(x=`Channel ${x}`),a)return`
        <div class="process-history-item" data-channel-id="${m.channel_id}-${m.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            ...
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                </div>`}let n=a?".process-history-item":".process-widget",i=new Map(Array.from(t.querySelectorAll(n)).map(m=>[m.dataset.channelId,m])),l=new Set(e.map(m=>`${m.channel_id}-${m.start_time}`));for(let[m,p]of i)l.has(m)||p.remove();e.forEach(m=>{let p=`${m.channel_id}-${m.start_time}`,g=o(m),x=i.get(p);if(x){x.outerHTML!==g&&(x.outerHTML=g);let f=t.querySelector(`[data-channel-id="${p}"]`);f&&t.appendChild(f)}else t.insertAdjacentHTML("beforeend",g)})}function Ae(){let t=be(),e=Xe()||"master@easter.company",a={enabled:Notification.permission==="granted",supported:"Notification"in window},o=localStorage.getItem("easter_analytics_enabled")!=="false";return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],os=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
        <div class="cli-dashboard">
            ...
            <div class="cli-divider">
                ...
                <span>Interactive Demos (v${as})</span>
                <i class='bx bx-chevron-down'></i>
            </div>
    `;for(let[a,o]of Object.entries(t)){let n=Bt.filter(i=>i.category===a);n.length!==0&&(e+=`
    ...
    </div>`,e},Ue=!1;function rs(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ue=!0,a}function _t(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ue=!1}function Mt(t,e,a="output"){if(!Ue)return;let o=document.createElement("div");o.className=`terminal-line terminal-${a}`,a==="prompt"?o.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:o.innerHTML=Ce(e),t.appendChild(o),t.scrollTop=t.scrollHeight}async function ls(t){let e=Bt.find(n=>n.id===t);if(!e)return;let a=rs(e);Mt(a,`dex ${t}`,"prompt");let o=e.demo_output||["Executing command...","\u2713 Done."];for(let n of o){await new Promise(l=>setTimeout(l,400+Math.random()*600));let i="output";n.includes("[ERROR]")?i="error":n.includes("[SUCCESS]")||n.includes("\u2713")?i="success":n.includes("!")&&(i="warning"),Mt(a,n,i)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Dt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=os();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code").textContent;navigator.clipboard.writeText(a).then(()=>{let o=e.querySelector("i");o.className="bx bx-check",o.style.color="#5eff5e",setTimeout(()=>{o.className="bx bx-copy",o.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(a=>{a.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let o=a.dataset.cmd;ls(o)})})}async function cs(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${Be()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Ht(){cs(),tt(),Ge();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&Dt();let e=Ye();We(e),Ve();let a=document.getElementById("nav-left-container");a&&a.addEventListener("click",()=>{if(i.length>0)f();else{let r=window.location.pathname;if(!(r==="/"||r==="/index.html")){let C=(r.endsWith("/")&&r.length>1?r.slice(0,-1):r).split("/");C.pop();let T=C.join("/")||"/";window.location.href=T}}});let o=window.location.pathname==="/"||window.location.pathname==="/index.html",n=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!o&&!n&&document.querySelector("footer")?.classList.add("hide");let i=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let m=r=>{localStorage.setItem("dex_last_window",r)};function p(){return 1}function g(){for(;i.length>1;)i.shift().close(!0);let r=document.getElementById("windows-container"),d=document.querySelector("nav"),y=document.querySelector("footer"),C=window.location.pathname==="/"||window.location.pathname==="/index.html",T=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");r&&r.setAttribute("data-count",i.length),i.forEach(N=>{let P=document.getElementById(N.id);P&&P.classList.remove("hide-close")}),we(be());let S=document.getElementById("dexter-menu-container"),_=document.getElementById("nav-window-switcher"),E=document.getElementById("settings-icon");if(Je(i.length>0),i.length>0){if(y?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),d?.classList.add("window-open"),r&&(r.style.paddingTop="60px"),S&&(S.style.display="none"),E&&(E.style.display="none"),_){let N=i[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(N)?(_.innerHTML=`
