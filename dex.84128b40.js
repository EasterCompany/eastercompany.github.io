(()=>{function Ge(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function We(t=!1){let e=window.location.pathname,o=e==="/"||e==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ze=1e3;function te(t){let e=null,o=t.onClose||null,a=t.onOpen||null;function n(){e&&(e.style.zIndex=++Ze)}function i(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ze,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",u="",I;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${I}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),p()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let c=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),m(h,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&m(f,e)}function m(f,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),I=u.indexOf(f),h=s.clientWidth,c=u[Math.max(0,I-2)],v=u[Math.min(u.length-1,I+2)],r=c.offsetLeft-s.offsetLeft-25,y=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,S=y<=h?r-(h-y)/2:f.offsetLeft-s.offsetLeft-h/2+f.offsetWidth/2;s.scrollTo({left:S,behavior:"smooth"})},350)}function p(f=!1){e&&(window.removeEventListener("resize",l),f?(e.remove(),e=null):(e.classList.remove("open"),o&&o(),setTimeout(()=>{e?.remove(),e=null},400)))}function g(f){let b=e?.querySelector(".window-content");b&&(b.innerHTML=f)}function x(){return e&&e.classList.contains("open")}return{open:i,close:p,setContent:g,isOpen:x,focus:n,id:t.id}}function Ke(){return!0}function Ye(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Xe(t){localStorage.setItem("easter_user_email",t.trim())}var Qe="easter_theme",Z={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ve(){return localStorage.getItem(Qe)||Z.DARK}function et(t){if(!Object.values(Z).includes(t))throw new Error("Invalid theme");localStorage.setItem(Qe,t),Ce(t)}function Ce(t){let e=document.body;if(Object.values(Z).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[Z.LIGHT,Z.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function tt(){let t=ve();Ce(t)}function D(t,e,o=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",i=o?`<p class="placeholder-action">${o}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${i}</div>`}function B(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!o)return;if(!e){o.textContent="Last updated: never";return}let a=Date.now(),n=Math.floor((a-e)/1e3),i;n<60?i=`${n}s ago`:n<3600?i=`${Math.floor(n/60)}m ago`:i=`${Math.floor(n/3600)}h ago`,o.textContent=`Last updated: ${i}`}var Pt=0;function xe(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!o)return;let a=o.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var K=0,Y=0;function st(t){K=t,ge()}function nt(t){Y=t,ge()}function ge(){let t=K+Y;Pt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let o=document.getElementById("alerts-menu-item");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",o.appendChild(l)),l.textContent=K>9?"9+":K,l.style.display=K>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=K>9?"9+":K,l.style.display=K>0?"flex":"none"}let i=document.getElementById("switch-workspace");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}}function $e(){let t=document.getElementById("alerts-list");if(!t)return;K=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ge()}function it(){let t=document.getElementById("blueprints-list");if(!t)return;Y=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ge()}function Be(){return"https://event.easter.company"}function Ot(){return"https://discord.easter.company"}var Ut="http://127.0.0.1:8100",qt="http://127.0.0.1:8300",jt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Se(t){let e=B(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,i)=>{let l=jt[i];return l?`<span class="${l}">`:""});let o=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return o>a&&(e+="</span>".repeat(o-a)),e}function se(t){if(!t)return"";let e=B(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(o,a)=>{let n=a.split("|").map(i=>i.trim());return n.every(i=>i.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(i=>`<span class="md-table-cell">${i}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var me=null,ue=null,we=!1,Ee=!1;async function _(t,e={}){if(me)try{let n=await fetch(me+t,e);if(n.ok)return n;me=null}catch{me=null}let o=Be(),a=Ut;try{let n=await fetch(o+t,e);if(n.ok)return me=o,we&&(console.log("\u2728 Production event service restored."),we=!1),n;throw new Error("Primary failed")}catch{we||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),we=!0);try{let i=await fetch(a+t,e);if(i.ok)return me=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}async function at(t,e={}){if(ue)try{let n=await fetch(ue+t,e);if(n.ok)return n;ue=null}catch{ue=null}let o=Ot(),a=qt;try{let n=await fetch(o+t,e);if(n.ok)return ue=o,Ee&&(console.log("\u2728 Production discord service restored."),Ee=!1),n;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),Ee=!0);try{let i=await fetch(a+t,e);if(i.ok)return ue=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}var ot=()=>`
...
`,ke=null,ne=new Set,Te=[];async function ie(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Ft(),t&&(e.innerHTML="<p>Updating...</p>");let o="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await _(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];ke=Date.now(),W(0,ke);let l=Date.now(),m=24*60*60*1e3,p=i.filter(r=>{let d=localStorage.getItem(`alert_read_ts_${r.id}`);if(!d)return!0;let y=parseInt(d);return l-y<m});p.sort((r,d)=>{let y=M=>{let E=M.event;if(typeof E=="string")try{E=JSON.parse(E)}catch{return"low"}return(E.priority||"low").toLowerCase()},S=M=>M==="critical"?4:M==="high"?3:M==="medium"?2:1,L=S(y(r)),$=S(y(d));return L!==$?$-L:d.timestamp-r.timestamp}),Te=p;let g=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return"low"}return(d.priority||"low").toLowerCase()},x=[],b=new Set(p.map(r=>g(r))).size>1;if(p.length>0){let r=null;p.forEach(d=>{let y=g(d);b&&y!==r&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),r=y),x.push(d)})}if(t&&(e.innerHTML=""),p.length===0){e.innerHTML=D("empty","No alerts yet."),$e();return}let s=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return null}let y=(d.title||"Untitled Alert").trim(),S=(d.body||"No description provided.").trim(),L=d.summary||"",$=d.content||"",M=d.protocol||"",E=(d.priority||"low").toLowerCase(),z=!!d.alert,O=(d.category||"system").trim(),H=d.related_event_ids||[],P=d.audit_event_id,F=!!localStorage.getItem(`alert_read_ts_${r.id}`),k=new Date(r.timestamp*1e3),C=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),w=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=F?"event-border-grey":"event-border-blue";!F&&z&&(T="event-border-red"),F&&(E==="high"||E==="critical")?T="event-border-red":F&&E==="medium"&&(T="event-border-orange");let A=F?"alert-read":"alert-unread",N=ne.has(r.id),R=N?"expanded":"",X=N?"display: block;":"display: none;",j="",U="";H.length>0&&(U=`
        ...
        `,j=`
                ...
                ${V}
            `;let G=document.createElement("div");G.className=`event-item notification-item ${T} ${A} ${R} cursor-pointer priority-${E}`,G.dataset.alertId=r.id,G.onclick=function(ee){if(this.classList.contains("expanded")){this.classList.remove("expanded"),ne.delete(r.id);let be=this.querySelector(".event-details");be&&(be.style.display="none")}else{this.classList.add("expanded"),ne.add(r.id);let be=this.querySelector(".event-details");if(be&&(be.style.display="block"),!localStorage.getItem(`alert_read_ts_${r.id}`)){localStorage.setItem(`alert_read_ts_${r.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let _e="event-border-grey";E==="high"||E==="critical"?_e="event-border-red":E==="medium"&&(_e="event-border-orange"),this.classList.add(_e),$e()}}};let qe=`${M?M.toUpperCase():"GUARDIAN"} ALERT: ${L||y}`,zt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[O]||"bx-bell",Rt=E==="high"||E==="critical"?"#ff4d4d":E==="medium"?"#ffa500":"#888";G.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Rt}; font-size: 0.8em; margin-left: 5px;">[${E.toUpperCase()}]</span>
                    </div>
...
`,ae=new Set,dt=[],fe=null;async function oe(t=!1){let e=document.getElementById("roadmap-list");if(e){Gt();try{let o=await _("/roadmap");if(!o.ok)throw new Error("Offline");let a=await o.json();dt=a;let n=g=>{let x=ae.has(g.id),f=g.state==="published",b=g.state==="consumed",s="event-border-grey";f&&(s="event-border-blue"),b&&(s="event-border-purple");let I=new Date(g.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${s} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=g.id,h.onclick=r=>{if(r.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ae.delete(g.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",ae.add(g.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${g.state.toUpperCase()}]</span>`;h.innerHTML=`
      ...
      `;let v=h.querySelector(".event-details");return v&&v.addEventListener("click",r=>{r.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Wt(g)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Jt(g)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Vt(g.id)),h.querySelector(".close-details-btn")?.addEventListener("click",r=>{r.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ae.delete(g.id)}),h},i=Array.from(e.children),l=new Map(i.map(g=>[g.dataset.itemId,g])),m=new Set(a.map(g=>g.id));if(i.forEach(g=>{let x=g.dataset.itemId;(!x||!m.has(x))&&g.remove()}),a.length===0){e.innerHTML=D("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let p=null;a.forEach((g,x)=>{let f=l.get(g.id);(!f||t)&&(f&&f.remove(),f=n(g),!f)||(x===0?e.firstElementChild!==f&&e.prepend(f):p&&p.nextElementSibling!==f&&p.after(f),p=f)})}catch{e.children.length===0&&(e.innerHTML=D("offline","Failed to load roadmap.","The event service may be offline."))}}}function Gt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),o=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{fe=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",fe=null},o.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let i=document.getElementById("roadmap-editor-input").value;if(!i.trim())return;let l=fe?`/roadmap/${fe}`:"/roadmap",m=fe?"PATCH":"POST";try{await _(l,{method:m,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:i})}),document.getElementById("roadmap-editor-container").style.display="none",oe(!0)}catch(p){console.error(p)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{dt.forEach(i=>ae.add(i.id)),oe(!0)},a.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ae.clear(),oe(!0)},n.dataset.listenerAttached="true")}function Wt(t){fe=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function Jt(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),oe(!0)}catch(o){console.error(o)}}async function Vt(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),ae.delete(t),oe(!0)}catch(e){console.error(e)}}var mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,pt=null,re=new Set,gt=[];async function le(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Zt();let o="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await _(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];if(gt=i,pt=Date.now(),W(2,pt),i.length===0){e.innerHTML=D("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),xe(2,0);return}t&&(e.innerHTML="");let l=f=>{let b=f.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let s=(b.title||"Untitled Blueprint").trim(),u=(b.summary||b.body||"No summary provided.").trim(),I=(b.content||"").trim(),h=(b.category||"architecture").trim(),c=(b.related_services||b.affected_services||[]).map(A=>A.trim()),v=(b.implementation_path||[]).map(A=>A.trim()),r=b.source_event_ids||[],d=b.approved===!0,y=new Date(f.timestamp*1e3),S=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),L=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=re.has(f.id),M=$?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${$?"expanded":""} ${d?"blueprint-approved":""}`,E.dataset.blueprintId=f.id,d&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let O=d?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";E.onclick=function(A){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(f.id);let R=this.querySelector(".event-details");R&&(R.style.display="none")}else{this.classList.add("expanded"),re.add(f.id);let R=this.querySelector(".event-details");R&&(R.style.display="block")}};let H="";v.length>0&&(H=`
                ...
                `);let J=c.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${c.join(", ")}</span></div>`:"<div></div>",F=d?`
            ...
            `;let k=E.querySelector(".blueprint-approve-btn");k&&(k.onclick=async A=>{A.stopPropagation(),k.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&le(!0)}catch(N){console.error("Failed to approve blueprint:",N)}});let C=E.querySelector(".blueprint-delete-btn");C&&(C.onclick=async A=>{A.stopPropagation();let N=!d;C.innerHTML=N?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${f.id}`,{method:"DELETE"})).ok&&le(!0)}catch(R){console.error("Failed to delete blueprint:",R)}});let w=E.querySelector(".event-details");w&&w.addEventListener("click",A=>{A.stopPropagation()});let T=E.querySelector(".close-details-btn");return T&&T.addEventListener("click",A=>{A.stopPropagation(),E.classList.remove("expanded");let N=E.querySelector(".event-details");N&&(N.style.display="none"),re.delete(f.id)}),E},m=Array.from(e.children),p=new Map(m.map(f=>[f.dataset.blueprintId,f])),g=new Set(i.map(f=>f.id));m.forEach(f=>{let b=f.dataset.blueprintId;(!b||!g.has(b))&&f.remove()});let x=null;i.forEach((f,b)=>{let s=p.get(f.id);(!s||t)&&(s&&s.remove(),s=l(f),!s)||(b===0?e.firstElementChild!==s&&e.prepend(s):x&&x.nextElementSibling!==s&&x.after(s),x=s)}),xe(2,i.length),it()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=D("offline","Failed to load blueprints.","The event service may be offline."))}}async function ft(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),nt(n)}catch{}}function Zt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),o=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{gt.forEach(a=>re.add(a.id)),le(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{re.clear(),le(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){o.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),re.clear(),le(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{o.innerHTML="<i class='bx bx-trash'></i> Clear"}}},o.dataset.listenerAttached="true")}var bt=()=>`
...
`;async function De(){await Promise.all([oe(),le()])}var vt=()=>`
...
`,Le=null,ce=new Set,ye=[],q="all",Xt={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision"],moderation:["moderation.explicit_content.deleted"]},Qt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function es(t){for(let[e,o]of Object.entries(Xt))if(o.includes(t))return e;return"system"}function ts(t){return Qt[t]||"bx-square-rounded"}async function de(t=!1){let e=document.getElementById("events-timeline");if(!e)return;ss();let a=`/events?ml=${q==="all"?100:250}&format=json`;q!=="all"&&(a+=`&category=${q}`);try{let n=await _(a);if(!n.ok)throw new Error("Service unreachable");if(ye=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Le=Date.now(),W(1,Le),ye.length===0){e.innerHTML=D("empty","No events found for this filter.");return}t&&(e.innerHTML="");let m=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,I=es(u),h=ts(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),v="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?v="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"?v="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?v="event-border-orange":u==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",d=ce.has(b.id),y=d?"expanded":"",S=d?"display: block;":"display: none;",L=new Date(b.timestamp*1e3),$=L.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),M=L.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=xt(u,s),z=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",O="";if(c){let k="";if(u==="engagement.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                    ...
                    `}else if(u==="system.attention.expired"){let C=A=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${A}</h5>`,w=s.timestamp-s.last_active,T=Math.floor(w/60);k=`
                    ...
                    `}else if(u==="messaging.bot.sent_message"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,w="";if(s.chat_history&&s.chat_history.length>0){let T=s.chat_history.length,A=s.chat_history.map((N,R)=>{let X=N.role.toUpperCase();X==="ASSISTANT"&&(X="DEXTER");let j=N.role==="user"?"#03dac6":N.role==="system"?"#ffb74d":"#bb86fc",U=R===T-1?"block":"none";return`
                                <div class="history-slide" data-index="${R}" style="display: ${U};">
                                    ...
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${B(N.content)}</div>
                                </div>
                            `}).join("");w=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(u==="moderation.explicit_content.deleted"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.link.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="analysis.visual.completed"){let C=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,w="";s.base64_preview?w=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(w=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="analysis.router.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.cli.command"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="system.analysis.audit"){let C=s.success?"#03dac6":"#ff4d4d",w=s.success?"SUCCESS":"FAILED",T=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,A="";s.error&&(A=`
                            <div class="event-detail-block">
                                ${T("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${B(s.error)}</pre>
                            </div>
                        `);let N="";if(s.chat_history&&s.chat_history.length>0){let j=s.chat_history.length,U=s.chat_history.map((Q,pe)=>{let V=Q.role.toUpperCase();V==="USER"&&(V="SYSTEM"),V==="ASSISTANT"&&(V="AGENT");let G=Q.role==="user"?"#03dac6":Q.role==="system"?"#ffb74d":"#bb86fc";return`
                        ...
                        `}let R="";if(s.corrections&&s.corrections.length>0){let j=s.corrections.map((U,Q)=>`
                        ...
                        `}let X="";if(s.parsed_results&&s.parsed_results.length>0){let j=s.parsed_results.map(U=>`
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            ...
                            <div style="flex: 1; min-width: 150px; text-align: center;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${C}; font-weight: bold;">${w} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${s.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        ${R}
                        ${N}
                    `}else if(u==="system.test.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row">
                    ...
                    `}else if(u==="error_occurred"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.cli.status"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;k=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                    ...
                    `}else if(u==="messaging.user.sent_message"){let C="";s.attachments&&s.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(T=>{let A=T.content_type&&T.content_type.startsWith("image/"),N=(T.size/1024).toFixed(1)+" KB";return`
            ...
            `;let P=H.querySelector(".event-details");if(P&&P.addEventListener("click",k=>{k.stopPropagation()}),c){let k=H.querySelector(".close-details-btn");k&&k.addEventListener("click",C=>{C.stopPropagation();let w=C.target.closest(".event-item");if(w){w.classList.remove("expanded"),ce.delete(b.id);let T=w.querySelector(".event-details");T&&(T.style.display="none")}})}let J=H.querySelector(".prev-btn"),F=H.querySelector(".next-btn");if(J&&F){let k=0,C=H.querySelectorAll(".history-slide"),w=C.length,T=()=>{C.forEach((A,N)=>{A.style.display=N===k?"block":"none"}),J.disabled=k===0,F.disabled=k===w-1,J.style.opacity=k===0?"0.5":"1",F.style.opacity=k===w-1?"0.5":"1"};J.addEventListener("click",A=>{A.stopPropagation(),k>0&&(k--,T())}),F.addEventListener("click",A=>{A.stopPropagation(),k<w-1&&(k++,T())}),T()}return H},p=Array.from(e.children),g=new Map(p.map(b=>[b.dataset.eventId,b])),x=new Set(ye.map(b=>b.id));p.forEach(b=>{let s=b.dataset.eventId;(!s||!x.has(s))&&b.remove()});let f=null;ye.forEach((b,s)=>{let u=g.get(b.id);(!u||t)&&(u&&u.remove(),u=m(b),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):f&&f.nextElementSibling!==u&&f.after(u),f=u)}),Le=Date.now(),W(1,Le)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=D("offline","Failed to load events.","The event service may be offline."))}}function ss(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),o=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ye.forEach(n=>ce.add(n.id)),de(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ce.clear(),de(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{o.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active")),n.classList.add("active"),q=n.dataset.filter,de(!0)}}),o.dataset.listenerAttached="true"),o&&o.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===q?n.classList.add("active"):n.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let n=q==="all"?"ALL":q.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let i="/events";if(q!=="all"?i+=`?category=${q}`:i+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(i,{method:"DELETE"})).ok)throw new Error("Failed to delete events");ce.clear(),de(!0)}catch(i){console.error("Failed to clear events:",i),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var ns=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,yt=ns;function ht(){return`
    ...
    `}var is=null;async function he(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let o=await e.json();if(!o||o.length===0)return t.innerHTML=D("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let a=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],n=o.filter(l=>!a.includes(l.id));n.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),n.reverse();let i=n.map(l=>{let m=l.logs.join(`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ht()}
        </div>`;async function It(){await Promise.all([Ae(),Re(),Pe()]),await he()}var Ct=null,wt=null;async function Mt(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function Et(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function as(){try{return await(await _("/processes")).json()}catch{return null}}async function os(){try{return await(await _("/agent/status")).json()}catch{return null}}async function Re(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),o=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),i=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),m=c=>{if(c){if(o&&(o.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let c=await Et();c?(m(c),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},e.dataset.listenerAttached="true"),a&&!a.hasChildNodes())){let c=await Et();m(c)}if(!t)return;let p=await Mt();if(!p||!p.services){t.children.length===0&&(t.innerHTML=D("offline","Failed to load system metrics.","The event service may be offline."));return}Ct=Date.now(),W(0,Ct);let g=p.services||[];Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function x(c){return!c||c==="N/A"||c==="unknown"||c.trim()===""?"-":c}function f(c){if(!c||c==="N/A"||c==="unknown")return"-";let v=c.match(/^(\d+\.\d+\.\d+)/);return v?v[0]:c.split(".").slice(0,3).join(".")||"-"}function b(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function s(c){if(!c||c==="N/A"||c==="unknown")return"-";let v=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!v)return"-";let r=parseInt(v[1])||0,d=parseInt(v[2])||0,y=parseInt(v[3])||0,S=parseFloat(v[4])||0,L=r*86400+d*3600+y*60+S,$=Math.floor(L/86400);if($>0)return`${$}d`;let M=Math.floor(L/3600);if(M>0)return`${M}h`;let E=Math.floor(L/60);return E>0?`${E}m`:`${Math.floor(L)}s`}function u(c){let v=c.status==="online",r=v?"service-widget-online":"service-widget-offline",d=v?"bx-check-circle":"bx-x-circle",y=v?"OK":"BAD",S=c.version?f(c.version.str):"-",L=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",$=c.memory&&c.memory!=="N/A"?c.memory:"-",M=L!=="-"?"#00ff00":"#666",E=L!=="-"?"#fff":"#666",z=$!=="-"?"#00ff00":"#666",O=$!=="-"?"#fff":"#666",H=s(c.uptime),P="";return v?P=`
                ...
                </div>`}function l(p){let g=p.status==="Downloaded",x=g?"service-widget-online":"service-widget-offline",f=g?"OK":"MISSING",b=g&&p.size>0?`${(p.size/1e9).toFixed(2)} GB`:"-",s=p.name;return p.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${p.name}"><div class="service-widget-header"><i class="bx ${g?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${p.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let m="";if(a&&(m+=n(a)),e.xtts&&(m+=i(e.xtts)),m+=o.map(l).join(""),!m){t.innerHTML=D("empty","No models found.");return}t.innerHTML!==m&&(t.innerHTML=m)}async function Ae(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),o=document.getElementById("guardian-architect-val"),a=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),i=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),m=document.getElementById("guardian-reset-btn");m&&!m.dataset.listenerAttached&&(m.onclick=async()=>{m.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await _("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{m.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{m.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),Ae()}catch{m.innerHTML="<i class='bx bx-error'></i> Failed"}},m.dataset.listenerAttached="true");let p=await os();if(p){let I=Math.floor(Date.now()/1e3),h=p.active_tier,c=p.protocol_aliases||{sentry:"Sentry",architect:"Architect"},v=S=>{S<0&&(S=0);let L=Math.floor(S/3600),$=Math.floor(S%3600/60),M=S%60;return L>0?`${L}h ${$}m`:$>0?`${$}m ${M}s`:`${M}s`},r=(S,L,$,M)=>{if(!S)return;let E=c[M]||M.toUpperCase(),z=S.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(z&&(z.textContent=E),h&&h.includes(E))S.textContent="Working",S.style.color="#bb86fc";else if($){let H=$.next_run-I;if(H<=0)S.textContent="Ready",S.style.color="#5eff5e";else{let P=Math.floor(H/60),J=H%60;S.textContent=`${P}m ${J}s`,S.style.color="#fff"}}L&&$&&(L.innerHTML=`
