(()=>{function Fe(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ge(t=!1){let e=window.location.pathname,o=e==="/"||e==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Ve=1e3;function ee(t){let e=null,o=t.onClose||null,a=t.onOpen||null;function n(){e&&(e.style.zIndex=++Ve)}function i(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Ve,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",u="",I;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,r)=>{let d=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${I}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),p()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let c=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),m(h,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&m(f,e)}function m(f,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),I=u.indexOf(f),h=s.clientWidth,c=u[Math.max(0,I-2)],v=u[Math.min(u.length-1,I+2)],r=c.offsetLeft-s.offsetLeft-25,y=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-r,C=y<=h?r-(h-y)/2:f.offsetLeft-s.offsetLeft-h/2+f.offsetWidth/2;s.scrollTo({left:C,behavior:"smooth"})},350)}function p(f=!1){e&&(window.removeEventListener("resize",l),f?(e.remove(),e=null):(e.classList.remove("open"),o&&o(),setTimeout(()=>{e?.remove(),e=null},400)))}function g(f){let b=e?.querySelector(".window-content");b&&(b.innerHTML=f)}function x(){return e&&e.classList.contains("open")}return{open:i,close:p,setContent:g,isOpen:x,focus:n,id:t.id}}function Ke(){return!0}function Ye(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Xe(t){localStorage.setItem("easter_user_email",t.trim())}var Qe="easter_theme",K={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function be(){return localStorage.getItem(Qe)||K.DARK}function Ze(t){if(!Object.values(K).includes(t))throw new Error("Invalid theme");localStorage.setItem(Qe,t),we(t)}function we(t){let e=document.body;if(Object.values(K).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[K.LIGHT,K.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function et(){let t=be();we(t)}function B(t,e,o=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",i=o?`<p class="placeholder-action">${o}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${i}</div>`}function D(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!o)return;if(!e){o.textContent="Last updated: never";return}let a=Date.now(),n=Math.floor((a-e)/1e3),i;n<60?i=`${n}s ago`:n<3600?i=`${Math.floor(n/60)}m ago`:i=`${Math.floor(n/3600)}h ago`,o.textContent=`Last updated: ${i}`}var Nt=0;function ve(t,e){let o=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!o)return;let a=o.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var Y=0,X=0;function tt(t){Y=t,ue()}function st(t){X=t,ue()}function ue(){let t=Y+X;Nt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let o=document.getElementById("alerts-menu-item");if(o){let l=o.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",o.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=Y>9?"9+":Y,l.style.display=Y>0?"flex":"none"}let i=document.getElementById("switch-workspace");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=X>9?"9+":X,l.style.display=X>0?"flex":"none"}}function Se(){let t=document.getElementById("alerts-list");if(!t)return;Y=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ue()}function nt(){let t=document.getElementById("blueprints-list");if(!t)return;X=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ue()}function Be(){return"https://event.easter.company"}function Pt(){return"https://discord.easter.company"}var Rt="http://127.0.0.1:8100",Ot="http://127.0.0.1:8300",Ut={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Ce(t){let e=D(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,i)=>{let l=Ut[i];return l?`<span class="${l}">`:""});let o=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return o>a&&(e+="</span>".repeat(o-a)),e}function te(t){if(!t)return"";let e=D(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(o,a)=>{let n=a.split("|").map(i=>i.trim());return n.every(i=>i.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(i=>`<span class="md-table-cell">${i}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var pe=null,me=null,Ee=!1,$e=!1;async function M(t,e={}){if(pe)try{let n=await fetch(pe+t,e);if(n.ok)return n;pe=null}catch{pe=null}let o=Be(),a=Rt;try{let n=await fetch(o+t,e);if(n.ok)return pe=o,Ee&&(console.log("\u2728 Production event service restored."),Ee=!1),n;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),Ee=!0);try{let i=await fetch(a+t,e);if(i.ok)return pe=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}async function it(t,e={}){if(me)try{let n=await fetch(me+t,e);if(n.ok)return n;me=null}catch{me=null}let o=Pt(),a=Ot;try{let n=await fetch(o+t,e);if(n.ok)return me=o,$e&&(console.log("\u2728 Production discord service restored."),$e=!1),n;throw new Error("Primary failed")}catch{$e||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),$e=!0);try{let i=await fetch(a+t,e);if(i.ok)return me=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}var at=()=>`
...
`,ke=null,se=new Set,Te=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;qt(),t&&(e.innerHTML="<p>Updating...</p>");let o="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await M(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];ke=Date.now(),W(0,ke);let l=Date.now(),m=24*60*60*1e3,p=i.filter(r=>{let d=localStorage.getItem(`alert_read_ts_${r.id}`);if(!d)return!0;let y=parseInt(d);return l-y<m});p.sort((r,d)=>{let y=_=>{let S=_.event;if(typeof S=="string")try{S=JSON.parse(S)}catch{return"low"}return(S.priority||"low").toLowerCase()},C=_=>_==="critical"?4:_==="high"?3:_==="medium"?2:1,T=C(y(r)),$=C(y(d));return T!==$?$-T:d.timestamp-r.timestamp}),Te=p;let g=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return"low"}return(d.priority||"low").toLowerCase()},x=[],b=new Set(p.map(r=>g(r))).size>1;if(p.length>0){let r=null;p.forEach(d=>{let y=g(d);b&&y!==r&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),r=y),x.push(d)})}if(t&&(e.innerHTML=""),p.length===0){e.innerHTML=B("empty","No alerts yet."),Se();return}let s=r=>{let d=r.event;if(typeof d=="string")try{d=JSON.parse(d)}catch{return null}let y=(d.title||"Untitled Alert").trim(),C=(d.body||"No description provided.").trim(),T=d.summary||"",$=d.content||"",_=d.protocol||"",S=(d.priority||"low").toLowerCase(),z=!!d.alert,P=(d.category||"system").trim(),H=d.related_event_ids||[],R=d.audit_event_id,q=!!localStorage.getItem(`alert_read_ts_${r.id}`),k=new Date(r.timestamp*1e3),w=k.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),E=k.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=q?"event-border-grey":"event-border-blue";!q&&z&&(A="event-border-red"),q&&(S==="high"||S==="critical")?A="event-border-red":q&&S==="medium"&&(A="event-border-orange");let L=q?"alert-read":"alert-unread",N=se.has(r.id),U=N?"expanded":"",he=N?"display: block;":"display: none;",F="",j="";H.length>0&&(j=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                ${$?`<div class="detail-pre" style="color: #ddd; font-size: 0.85em;">${te($)}</div>`:""}
            </div>
        `:V=`
            <div class="event-detail-block" style="text-align: left;">
...
`,dt=null,oe=new Set,ut=[];async function re(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Jt();let o="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await M(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];if(ut=i,dt=Date.now(),W(2,dt),i.length===0){e.innerHTML=B("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),ve(2,0);return}t&&(e.innerHTML="");let l=f=>{let b=f.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let s=(b.title||"Untitled Blueprint").trim(),u=(b.summary||b.body||"No summary provided.").trim(),I=(b.content||"").trim(),h=(b.category||"architecture").trim(),c=(b.related_services||b.affected_services||[]).map(L=>L.trim()),v=(b.implementation_path||[]).map(L=>L.trim()),r=b.source_event_ids||[],d=b.approved===!0,y=new Date(f.timestamp*1e3),C=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=oe.has(f.id),_=$?"display: block;":"display: none;",S=document.createElement("div");S.className=`event-item notification-item event-border-purple cursor-pointer ${$?"expanded":""} ${d?"blueprint-approved":""}`,S.dataset.blueprintId=f.id,d&&(S.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",S.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let P=d?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";S.onclick=function(L){if(this.classList.contains("expanded")){this.classList.remove("expanded"),oe.delete(f.id);let U=this.querySelector(".event-details");U&&(U.style.display="none")}else{this.classList.add("expanded"),oe.add(f.id);let U=this.querySelector(".event-details");U&&(U.style.display="block")}};let H="";v.length>0&&(H=`
            ...
            `;let k=S.querySelector(".blueprint-approve-btn");k&&(k.onclick=async L=>{L.stopPropagation(),k.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await M(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&re(!0)}catch(N){console.error("Failed to approve blueprint:",N)}});let w=S.querySelector(".blueprint-delete-btn");w&&(w.onclick=async L=>{L.stopPropagation();let N=!d;w.innerHTML=N?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await M(`/events/${f.id}`,{method:"DELETE"})).ok&&re(!0)}catch(U){console.error("Failed to delete blueprint:",U)}});let E=S.querySelector(".event-details");E&&E.addEventListener("click",L=>{L.stopPropagation()});let A=S.querySelector(".close-details-btn");return A&&A.addEventListener("click",L=>{L.stopPropagation(),S.classList.remove("expanded");let N=S.querySelector(".event-details");N&&(N.style.display="none"),oe.delete(f.id)}),S},m=Array.from(e.children),p=new Map(m.map(f=>[f.dataset.blueprintId,f])),g=new Set(i.map(f=>f.id));m.forEach(f=>{let b=f.dataset.blueprintId;(!b||!g.has(b))&&f.remove()});let x=null;i.forEach((f,b)=>{let s=p.get(f.id);(!s||t)&&(s&&s.remove(),s=l(f),!s)||(b===0?e.firstElementChild!==s&&e.prepend(s):x&&x.nextElementSibling!==s&&x.after(s),x=s)}),ve(2,i.length),nt()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=B("offline","Failed to load blueprints.","The event service may be offline."))}}async function gt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await M(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),st(n)}catch{}}function Jt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),o=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ut.forEach(a=>oe.add(a.id)),re(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{oe.clear(),re(!0)},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){o.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.blueprint.generated",{method:"DELETE"}),oe.clear(),re(!0)}catch(a){console.error("Failed to clear blueprints:",a)}finally{o.innerHTML="<i class='bx bx-trash'></i> Clear"}}},o.dataset.listenerAttached="true")}var ft=()=>`
...
`;async function De(){await Promise.all([ae(),re()])}var bt=()=>`
...
`,Le=null,le=new Set,xe=[],O="all",Yt={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision"],moderation:["moderation.explicit_content.deleted"]},Xt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Qt(t){for(let[e,o]of Object.entries(Yt))if(o.includes(t))return e;return"system"}function Zt(t){return Xt[t]||"bx-square-rounded"}async function ce(t=!1){let e=document.getElementById("events-timeline");if(!e)return;es();let a=`/events?ml=${O==="all"?100:250}&format=json`;O!=="all"&&(a+=`&category=${O}`);try{let n=await M(a);if(!n.ok)throw new Error("Service unreachable");if(xe=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Le=Date.now(),W(1,Le),xe.length===0){e.innerHTML=B("empty","No events found for this filter.");return}t&&(e.innerHTML="");let m=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,I=Qt(u),h=Zt(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),v="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?v="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"?v="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?v="event-border-orange":u==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let r=c?"cursor-pointer":"",d=le.has(b.id),y=d?"expanded":"",C=d?"display: block;":"display: none;",T=new Date(b.timestamp*1e3),$=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=vt(u,s),z=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",P="";if(c){let k="";if(u==="engagement.decision"){let w=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;k=`
                    ...
                    `}else if(u==="system.analysis.audit"){let w=s.success?"#03dac6":"#ff4d4d",E=s.success?"SUCCESS":"FAILED",A=F=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${F}</h5>`,L="";s.error&&(L=`
                        ...
                        `);let N="";if(s.chat_history&&s.chat_history.length>0){let F=s.chat_history.length,j=s.chat_history.map((Q,de)=>{let V=Q.role.toUpperCase();V==="USER"&&(V="SYSTEM"),V==="ASSISTANT"&&(V="AGENT");let G=Q.role==="user"?"#03dac6":Q.role==="system"?"#ffb74d":"#bb86fc";return`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${xt()}
        </div>`;async function Lt(){await Promise.all([Ie(),Pe(),Re()]),await ye()}var yt=null,ht=null;async function It(){try{return await(await M("/system_monitor")).json()}catch{return null}}async function wt(){try{return await(await M("/system/hardware")).json()}catch{return null}}async function ss(){try{return await(await M("/processes")).json()}catch{return null}}async function ns(){try{return await(await M("/agent/status")).json()}catch{return null}}async function Pe(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),o=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),i=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),m=c=>{if(c){if(o&&(o.innerHTML=`
        ...
        `)};e&&r(e,document.getElementById("guardian-t1-stats"),p.t1,"t1"),o&&r(o,document.getElementById("guardian-t2-stats"),p.t2,"t2");let d=document.getElementById("system-state-label"),y=document.getElementById("system-state-val");if(y&&p.system_state){let C=p.system_state,T=v(p.system_state_time||0);d&&(d.textContent=`State: ${C.toUpperCase()}`),y.textContent=T,C==="idle"?y.style.color=p.system_state_time>300?"#5eff5e":"#fff":y.style.color="#bb86fc"}n&&(n.textContent=v(p.total_idle_time||0)),i&&(i.textContent=v(p.total_active_time||0)),l&&(l.textContent=v(p.total_waste_time||0))}else[e,o,a,n,i,l].forEach(h=>{h&&(h.textContent="-",h.style.color="#666")});let g=await ss(),x=[],f=[],b=[];g&&(Array.isArray(g)?x=g:(x=g.active||[],f=g.queue||[],b=g.history||[],b.sort((I,h)=>(h.end_time||0)-(I.end_time||0)))),x.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=B("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),Ne(t,x,!1));let s=document.getElementById("processes-queue-widgets");s&&(f.length===0?!s.querySelector(".tab-placeholder")&&!s.querySelector('div[style*="font-style: italic"]')&&(s.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(s.innerHTML="",Ne(s,f,!1)));let u=document.getElementById("processes-history-widgets");u&&(b.length===0?u.querySelector(".tab-placeholder")||(u.innerHTML=B("empty","No recent history.")):(u.querySelector(".tab-placeholder")&&(u.innerHTML=""),Ne(u,b,!0))),ve(1,x.length)}function Ne(t,e,o){function a(m){let p="";m.end_time?p=`${m.end_time-m.start_time}s`:p=`${Math.floor(Date.now()/1e3-m.start_time)}s`;let g=m.retries>0?`<span class="process-retry-badge">Retry ${m.retries}</span>`:"",x=m.channel_id,f={"system-guardian":"Guardian Worker","system-cli-op":"CLI Operation"};if(f[x]?x=f[x]:/^\d+$/.test(x)&&(x=`Channel ${x}`),o)return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],as=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[o,a]of Object.entries(t)){let n=Mt.filter(i=>i.category===o);n.length!==0&&(e+=`
