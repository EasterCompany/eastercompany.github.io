(()=>{function Ie(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function ke(t=!1){let e=window.location.pathname,a=e==="/"||e==="/index.html",l=t?`
        <div class="nav-right">
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var _e=1e3;function G(t){let e=null,a=t.onClose||null,l=t.onOpen||null;function s(){e&&(e.style.zIndex=++_e)}function r(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",c),l&&setTimeout(l,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",e.style.zIndex=++_e,e.addEventListener("mousedown",s);let m=t.icon||"bx-window",i="",n="",o;t.tabs&&t.tabs.length>0?(i=`<div class="tab-bar">${t.tabs.map((w,d)=>{let b=w.icon?`<i class="bx ${w.icon}"></i>`:`<span class="tab-glyph">${w.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,o=`<div class="window-content">${t.tabs.map((w,d)=>`<div class="tab-content ${d===0?"active":""}" data-tab-content="${d}">${w.content}</div>`).join("")}</div>`):(t.title&&(n=`<div class="window-title">${t.title}</div>`),o=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${o}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",f=>{f.stopPropagation(),u()}),window.addEventListener("resize",c),t.tabs&&e.querySelectorAll(".tab").forEach(f=>{f.addEventListener("click",()=>{let h=f.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(w=>w.classList.remove("active")),f.classList.add("active"),e.querySelectorAll(".tab-content").forEach(w=>w.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${h}"]`).classList.add("active"),g(f,e)})}),setTimeout(()=>{e.classList.add("open"),l&&l()},10)}function c(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&g(p,e)}function g(p,m){setTimeout(()=>{let i=m.querySelector(".tab-bar");if(!i)return;let n=Array.from(i.querySelectorAll(".tab")),o=n.indexOf(p),f=i.clientWidth,h=n[Math.max(0,o-2)],w=n[Math.min(n.length-1,o+2)],d=h.offsetLeft-i.offsetLeft-25,y=w.offsetLeft+w.offsetWidth-i.offsetLeft+25-d,A=y<=f?d-(f-y)/2:p.offsetLeft-i.offsetLeft-f/2+p.offsetWidth/2;i.scrollTo({left:A,behavior:"smooth"})},350)}function u(p=!1){e&&(window.removeEventListener("resize",c),p?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function v(p){let m=e?.querySelector(".window-content");m&&(m.innerHTML=p)}function x(){return e&&e.classList.contains("open")}return{open:r,close:u,setContent:v,isOpen:x,focus:s,id:t.id}}function De(){return!0}function Me(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Be(t){localStorage.setItem("easter_user_email",t.trim())}var Ne="easter_theme",R={DARK:"dark",LIGHT:"light",LEGACY:"legacy",LUCID:"lucid"};function te(){return localStorage.getItem(Ne)||R.DARK}function He(t){if(!Object.values(R).includes(t))throw new Error("Invalid theme");localStorage.setItem(Ne,t),ie(t)}function ie(t,e=!1){let a=document.body;if(e||(a.classList.add("theme-transitioning"),setTimeout(()=>{a.classList.remove("theme-transitioning")},300)),Object.values(R).forEach(s=>{a.classList.remove(`theme-${s}`)}),a.classList.add(`theme-${t}`),[R.LIGHT,R.LEGACY,R.LUCID].includes(t)){if(a.classList.add("is-animated"),!document.querySelector(".background")){let s=document.createElement("div");s.className="background",document.body.prepend(s)}}else{a.classList.remove("is-animated");let s=document.querySelector(".background");s&&(e?s.remove():(s.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{s.remove()},400)))}}function Re(){let t=te();ie(t,!0)}function C(t,e,a=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function I(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function B(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let l=Date.now(),s=Math.floor((l-e)/1e3),r;s<60?r=`${s}s ago`:s<3600?r=`${Math.floor(s/60)}m ago`:r=`${Math.floor(s/3600)}h ago`,a.textContent=`Last updated: ${r}`}function O(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let l=a.querySelector(".notification-badge");l&&(e>0?(l.textContent=e>9?"9+":e,l.style.display="flex"):l.style.display="none")}function oe(){let t=document.getElementById("notifications-list");if(!t)return;let e=t.querySelectorAll(".notification-unread").length;O(0,e)}function be(){return"https://event.easter.company"}function mt(){return"https://discord.easter.company"}var pt="http://127.0.0.1:8100",ut="http://127.0.0.1:8300",gt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function le(t){let e=I(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,r)=>{let c=gt[r];return c?`<span class="${c}">`:""});let a=(e.match(/<span/g)||[]).length,l=(e.match(/<\/span/g)||[]).length;return a>l&&(e+="</span>".repeat(a-l)),e}var V=null,W=null,ne=!1,ae=!1;async function k(t,e={}){if(V)try{let s=await fetch(V+t,e);if(s.ok)return s;V=null}catch{V=null}let a=be(),l=pt;try{let s=await fetch(a+t,e);if(s.ok)return V=a,ne&&(console.log("\u2728 Production event service restored."),ne=!1),s;throw new Error("Primary failed")}catch{ne||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${l}`),ne=!0);try{let r=await fetch(l+t,e);if(r.ok)return V=l,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function Oe(t,e={}){if(W)try{let s=await fetch(W+t,e);if(s.ok)return s;W=null}catch{W=null}let a=mt(),l=ut;try{let s=await fetch(a+t,e);if(s.ok)return W=a,ae&&(console.log("\u2728 Production discord service restored."),ae=!1),s;throw new Error("Primary failed")}catch{ae||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${l}`),ae=!0);try{let r=await fetch(l+t,e);if(r.ok)return W=l,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Pe=()=>`
...
`,re=null,z=new Set,ce=[];async function F(t=!1){let e=document.getElementById("notifications-list");if(!e)return;ft(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let l=await k(a);if(!l.ok)throw new Error("Service is offline or unreachable.");let r=(await l.json()).events||[];re=Date.now(),B(0,re);let c=Date.now(),g=24*60*60*1e3,u=r.filter(d=>{let b=localStorage.getItem(`notification_read_ts_${d.id}`);if(!b)return!0;let y=parseInt(b);return c-y<g});u.sort((d,b)=>{let y=T=>{let _=T.event;if(typeof _=="string")try{_=JSON.parse(_)}catch{return"low"}return(_.priority||"low").toLowerCase()},A=T=>T==="critical"?4:T==="high"?3:T==="medium"?2:1,L=A(y(d)),E=A(y(b));return L!==E?E-L:b.timestamp-d.timestamp}),ce=u;let v=d=>{let b=d.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return"low"}return(b.priority||"low").toLowerCase()},x=[],m=new Set(u.map(d=>v(d))).size>1;if(u.length>0){let d=null;u.forEach(b=>{let y=v(b);m&&y!==d&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),d=y),x.push(b)})}if(t&&(e.innerHTML=""),u.length===0){e.innerHTML=C("empty","No notifications yet."),oe();return}let i=d=>{let b=d.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let y=b.title||"Untitled Notification",A=b.body||"No description provided.",L=b.priority||"low",E=!!b.alert,T=b.category||"system",_=b.related_event_ids||[],H=!!localStorage.getItem(`notification_read_ts_${d.id}`),P=new Date(d.timestamp*1e3),D=P.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=P.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=H?"event-border-grey":"event-border-blue";!H&&E&&($="event-border-red"),H&&(L==="high"||L==="critical")?$="event-border-red":H&&L==="medium"&&($="event-border-orange");let N=H?"notification-read":"notification-unread",M=z.has(d.id),ue=M?"expanded":"",ge=M?"display: block;":"display: none;",$e="",Ce="";_.length>0&&(Ce=`
            ...
            `;let U=document.createElement("div");U.className=`event-item notification-item ${$} ${N} ${ue} cursor-pointer`,U.dataset.notificationId=d.id,U.onclick=function(Z){if(this.classList.contains("expanded")){this.classList.remove("expanded"),z.delete(d.id);let ee=this.querySelector(".event-details");ee&&(ee.style.display="none")}else{this.classList.add("expanded"),z.add(d.id);let ee=this.querySelector(".event-details");if(ee&&(ee.style.display="block"),!localStorage.getItem(`notification_read_ts_${d.id}`)){localStorage.setItem(`notification_read_ts_${d.id}`,Date.now().toString()),this.classList.add("notification-read"),this.classList.remove("notification-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let ve="event-border-grey";L==="high"||L==="critical"?ve="event-border-red":L==="medium"&&(ve="event-border-orange"),this.classList.add(ve),oe()}}};let Ht=y,dt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[T]||"bx-bell";U.innerHTML=`
                ...
                <div class="event-content">
                    <div class="event-service">${T.toUpperCase()} ${E?'<span class="alert-badge" style="color: #ff4d4d; font-size: 0.8em; margin-left: 5px;">[ALERT]</span>':""}</div>
            ...
            `;let Te=U.querySelector(".close-details-btn");return Te&&Te.addEventListener("click",Z=>{Z.stopPropagation(),U.classList.remove("expanded");let fe=U.querySelector(".event-details");fe&&(fe.style.display="none"),z.delete(d.id)}),U},n=d=>{let b=document.createElement("div");b.className="notification-divider",b.dataset.notificationId=d.id;let y="#888888";return d.label==="CRITICAL"?y="#ff4d4d":d.label==="HIGH"?y="#ff8888":d.label==="MEDIUM"&&(y="#ffa500"),b.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,b.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,b},o=Array.from(e.children),f=new Map(o.map(d=>[d.dataset.notificationId,d])),h=new Set(x.map(d=>d.id));o.forEach(d=>{let b=d.dataset.notificationId;(!b||!h.has(b))&&d.remove()});let w=null;x.forEach((d,b)=>{let y=f.get(d.id);(!y||t)&&(y&&y.remove(),d.type==="divider"?y=n(d):y=i(d),!y)||(b===0?e.firstElementChild!==y&&e.prepend(y):w&&w.nextElementSibling!==y&&w.after(y),w=y)}),re=Date.now(),B(0,re),oe()}catch(l){console.error("Error fetching notifications:",l),e.children.length===0&&(e.innerHTML=C("offline","Failed to load notifications.","The event service may be offline or unreachable."))}}function ft(){let t=document.getElementById("notif-read-all"),e=document.getElementById("notif-expand-all"),a=document.getElementById("notif-close-all"),l=document.getElementById("notif-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ce.forEach(s=>{localStorage.getItem(`notification_read_ts_${s.id}`)||localStorage.setItem(`notification_read_ts_${s.id}`,Date.now().toString())}),F(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ce.forEach(s=>{z.add(s.id),localStorage.getItem(`notification_read_ts_${s.id}`)||localStorage.setItem(`notification_read_ts_${s.id}`,Date.now().toString())}),F(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{z.clear(),F(!0)},a.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.onclick=()=>{let s=Date.now()-1728e5;ce.forEach(r=>{localStorage.setItem(`notification_read_ts_${r.id}`,s.toString())}),z.clear(),F(!0)},l.dataset.listenerAttached="true")}var Ue=()=>`
  <div class="notifications-actions">
...
`,q=new Set,ze=[],K=null;async function j(t=!1){let e=document.getElementById("roadmap-list");if(e){vt();try{let a=await k("/roadmap");if(!a.ok)throw new Error("Offline");let l=await a.json();if(ze=l,l.length===0){e.innerHTML=C("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let s=v=>{let x=q.has(v.id),p=v.state==="draft",m=v.state==="published",i=v.state==="consumed",n="event-border-grey";m&&(n="event-border-blue"),i&&(n="event-border-purple");let f=new Date(v.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${n} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=v.id,h.onclick=d=>{if(d.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",q.delete(v.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",q.add(v.id))};let w=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${v.state.toUpperCase()}]</span>`;return h.innerHTML=`
        <div class="event-time">
      ...
      `,h.querySelector(".edit-btn")?.addEventListener("click",()=>bt(v)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>ht(v)),h.querySelector(".delete-btn")?.addEventListener("click",()=>yt(v.id)),h.querySelector(".close-details-btn")?.addEventListener("click",d=>{d.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",q.delete(v.id)}),h},r=Array.from(e.children),c=new Map(r.map(v=>[v.dataset.itemId,v])),g=new Set(l.map(v=>v.id));r.forEach(v=>{let x=v.dataset.itemId;(!x||!g.has(x))&&v.remove()});let u=null;l.forEach((v,x)=>{let p=c.get(v.id);(!p||t)&&(p&&p.remove(),p=s(v),!p)||(x===0?e.firstElementChild!==p&&e.prepend(p):u&&u.nextElementSibling!==p&&u.after(p),u=p)})}catch{e.innerHTML=C("error","Failed to load roadmap.")}}}function vt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),l=document.getElementById("roadmap-expand-all"),s=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{K=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",K=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input").value;if(!r.trim())return;let c=K?`/roadmap/${K}`:"/roadmap",g=K?"PATCH":"POST";try{await k(c,{method:g,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})}),document.getElementById("roadmap-editor-container").style.display="none",j(!0)}catch(u){console.error(u)}},e.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.onclick=()=>{ze.forEach(r=>q.add(r.id)),j(!0)},l.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{q.clear(),j(!0)},s.dataset.listenerAttached="true")}function bt(t){K=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function ht(t){let e=t.state==="published"?"draft":"published";try{await k(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),j(!0)}catch(a){console.error(a)}}async function yt(t){if(confirm("Delete this roadmap item?"))try{await k(`/roadmap/${t}`,{method:"DELETE"}),q.delete(t),j(!0)}catch(e){console.error(e)}}var qe=()=>`
    <div class="notifications-actions">
...
`,Fe=null,J=new Set,je=[];async function de(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;xt();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let l=await k(a);if(!l.ok)throw new Error("Service is offline or unreachable.");let r=(await l.json()).events||[];if(je=r,Fe=Date.now(),B(2,Fe),r.length===0){e.innerHTML=C("empty","No architectural blueprints generated yet.","The Analyst Worker will generate these when idle."),O(1,0);return}t&&(e.innerHTML="");let c=p=>{let m=p.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let i=m.title||"Untitled Blueprint",n=m.summary||m.body||"No summary provided.",o=m.content||"",f=m.category||"architecture",h=m.affected_services||[],w=m.implementation_path||[],d=new Date(p.timestamp*1e3),b=d.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),y=d.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=J.has(p.id),L=A?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${A?"expanded":""}`,E.dataset.blueprintId=p.id;let _={architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[f]||"bx-paint";E.onclick=function(D){if(this.classList.contains("expanded")){this.classList.remove("expanded"),J.delete(p.id);let $=this.querySelector(".event-details");$&&($.style.display="none")}else{this.classList.add("expanded"),J.add(p.id);let $=this.querySelector(".event-details");$&&($.style.display="block")}};let Q=h.length>0?`<div class="blueprint-meta-row"><strong>Affected:</strong> ${h.join(", ")}</div>`:"",H="";w.length>0&&(H=`
                    <div class="blueprint-path">
                        <h5>Implementation Path</h5>
                        <ul>
                            ${w.map(D=>`<li>${I(D)}</li>`).join("")}
                        </ul>
                    </div>
                `),E.innerHTML=`
                <div class="event-time">
...
`,me=null,Y=new Set,se=[],pe="all",Et={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed"],moderation:["moderation.explicit_content.deleted"]},St={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Je(t){for(let[e,a]of Object.entries(Et))if(a.includes(t))return e;return"system"}function Lt(t){return St[t]||"bx-square-rounded"}async function X(t=!1){let e=document.getElementById("events-timeline");if(!e)return;$t();let l=`/events?ml=${pe==="all"?100:250}&format=json&exclude_types=system.notification.generated`;try{let s=await k(l);if(!s.ok)throw new Error("Service is offline or unreachable.");let c=(await s.json()).events||[],g=c;if(pe!=="all"&&(g=c.filter(i=>{let n=i.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return!1}return Je(n.type)===pe})),se=g.slice(0,50),me=Date.now(),B(1,me),se.length===0){e.innerHTML=C("empty","No events found for this filter.");return}t&&(e.innerHTML="");let u=i=>{let n=i.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return null}let o=n.type,f=Je(o),h=Lt(o),w=o==="engagement.decision"||o==="messaging.bot.sent_message"||o==="messaging.user.sent_message"||o==="moderation.explicit_content.deleted"||o==="analysis.link.completed"||o==="analysis.visual.completed"||o==="system.cli.command"||o==="system.analysis.audit"||o==="system.test.completed"||o==="error_occurred"||o==="system.cli.status"||o.startsWith("system.roadmap")||o.startsWith("system.process"),d="event-border-grey";w&&(o==="moderation.explicit_content.deleted"||o==="error_occurred"?d="event-border-red":o==="analysis.link.completed"||o==="analysis.visual.completed"||o==="system.analysis.audit"?d="event-border-purple":o==="system.cli.command"||o==="system.cli.status"?d="event-border-orange":o==="system.test.completed"?d=n.test?.status==="OK"&&n.lint?.status==="OK"&&n.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let b=w?"cursor-pointer":"",y=Y.has(i.id),A=y?"expanded":"",L=y?"display: block;":"display: none;",E=new Date(i.timestamp*1e3),T=E.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=E.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),Q=Ke(o,n),H=n.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${n.user_level})</span>`:"",P="";if(w){let S="";if(o==="engagement.decision")S=`
                    ...
                    `;else if(o==="messaging.bot.sent_message")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="moderation.explicit_content.deleted")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="analysis.link.completed")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="analysis.visual.completed"){let $="";n.base64_preview?$=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${n.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:n.url&&($=`<div class="event-detail-block"><img src="${n.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),S=`
                        <div class="event-detail-row">
                    ...
                    `}else if(o==="system.cli.command")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="system.analysis.audit")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="system.test.completed")S=`
                        <div class="event-detail-row">
                    ...
                    `;else if(o==="messaging.user.sent_message"){let $="";n.attachments&&n.attachments.length>0&&($=`
                            <div class="event-detail-block">
                                <span class="detail-label">Attachments:</span>
                                <div class="attachments-grid">${n.attachments.map(M=>{let ue=M.content_type&&M.content_type.startsWith("image/"),ge=(M.size/1024).toFixed(1)+" KB";return`
                ...
                `}let D=document.createElement("div");if(D.className=`event-item ${d} ${b} ${A}`,D.dataset.eventId=i.id,D.onclick=function(S){if(!w)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),Y.delete(i.id);let N=this.querySelector(".event-details");N&&(N.style.display="none")}else{this.classList.add("expanded"),Y.add(i.id);let N=this.querySelector(".event-details");N&&(N.style.display="block")}},D.innerHTML=`
                <div class="event-time">
            ...
            `,w){let S=D.querySelector(".close-details-btn");S&&S.addEventListener("click",$=>{$.stopPropagation();let N=$.target.closest(".event-item");if(N){N.classList.remove("expanded"),Y.delete(i.id);let M=N.querySelector(".event-details");M&&(M.style.display="none")}})}return D},v=Array.from(e.children),x=new Map(v.map(i=>[i.dataset.eventId,i])),p=new Set(se.map(i=>i.id));v.forEach(i=>{let n=i.dataset.eventId;(!n||!p.has(n))&&i.remove()});let m=null;se.forEach((i,n)=>{let o=x.get(i.id);(!o||t)&&(o&&o.remove(),o=u(i),!o)||(n===0?e.firstElementChild!==o&&e.prepend(o):m&&m.nextElementSibling!==o&&m.after(o),m=o)}),me=Date.now(),B(1,me)}catch(s){console.error("Error fetching events:",s),e.children.length===0&&(e.innerHTML=C("offline","Failed to load events.","The event service may be offline or unreachable."))}}function $t(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),a=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{se.forEach(l=>Y.add(l.id)),X(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Y.clear(),X(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.querySelectorAll(".filter-btn").forEach(l=>{l.onclick=()=>{a.querySelectorAll(".filter-btn").forEach(s=>s.classList.remove("active")),l.classList.add("active"),pe=l.dataset.filter,X(!0)}}),a.dataset.listenerAttached="true")}function Xe(){return`
    ...
    `}var Ct=null;async function xe(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await k("/logs");if(!e.ok)throw new Error("Logs offline");let a=await e.json();if(!a||a.length===0)return t.innerHTML='<p style="text-align: center; opacity: 0.5; padding: 20px;">No logs found.</p>',!1;let l=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],s=a.filter(c=>!l.includes(c.id));s.forEach(c=>{c.logs&&Array.isArray(c.logs)?c.logs.reverse():c.logs=[]}),s.reverse();let r=s.map(c=>{let g=c.logs.join(`
...
`);return`
    ...
    `;async function we(){await Promise.all([nt(),kt(),At()]),await xe()}var Qe=null,Ze=null,et=null;async function it(){try{return await(await k("/system_monitor")).json()}catch{return null}}async function tt(){try{return await(await k("/system/hardware")).json()}catch{return null}}async function Tt(){try{return await(await k("/processes")).json()}catch{return null}}async function It(){try{return await(await k("/analyst/status")).json()}catch{return null}}async function kt(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-info-content"),a=document.getElementById("hardware-refresh-btn"),l=i=>{if(!i){e.innerHTML='<p style="color: #ff4d4d;">Failed to load hardware info.</p>';return}let n="",o=(i.MEMORY_BYTES/(1024*1024*1024)).toFixed(1);if(n+=`
            <div class="service-widget" style="padding: 10px; min-height: 80px;">
                ...
                <div class="service-widget-body">
                    <span style="font-size: 1.2em; font-weight: bold; color: #fff;">${o} GB</span>
                ...
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                ...
                </div>`}if(i.GPU&&i.GPU.length>0&&i.GPU.forEach((f,h)=>{let w=(f.VRAM/1073741824).toFixed(1);n+=`
                    <div class="service-widget" style="padding: 10px; min-height: 80px;">
                        <div class="service-widget-header" style="margin-bottom: 5px;">
                    ...
                    </div>`}),i.STORAGE&&i.STORAGE.length>0){let f=0,h=0;i.STORAGE.forEach(y=>{f+=y.USED,h+=y.SIZE});let w=(f/(1024*1024*1024)).toFixed(1),d=(h/(1024*1024*1024)).toFixed(1),b=h>0?(f/h*100).toFixed(0):0;n+=`
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                    <div class="service-widget-header" style="margin-bottom: 5px;">
                ...
                </div>`:_='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${o}" data-service-id="${i.id}"><div class="service-widget-header"><i class="bx ${f}"></i><h3>${i.short_name||i.id}</h3><span class="service-widget-status">${h}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${u(i.domain&&i.port?`${i.domain}:${i.port}`:"")}</span></div>${_}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(i=>[i.dataset.serviceId,i])),m=new Set(r.map(i=>i.id));for(let[i,n]of p)m.has(i)||n.remove();r.forEach(i=>{let n=x(i),o=p.get(i.id);o?o.outerHTML!==n&&(o.outerHTML=n):t.insertAdjacentHTML("beforeend",n)})}async function At(){let t=document.getElementById("models-widgets");if(!t)return;let e=await it();if(!e){t.innerHTML=C("offline","Failed to load model status.");return}Ze=Date.now(),B(3,Ze);let a=e.models||[],l=e.whisper;Array.from(t.children).forEach(g=>{g.classList.contains("service-widget")||g.remove()});function s(g){let u=g.status==="Ready";return`
                ...
                </div>`}function r(g){let u=g.status==="Downloaded",v=u?"service-widget-online":"service-widget-offline",x=u?"OK":"MISSING",p=u&&g.size>0?`${(g.size/1e9).toFixed(2)} GB`:"-",m=g.name;return g.type==="custom"&&m.endsWith(":latest")&&(m=m.replace(":latest","")),`<div class="service-widget ${v}" data-model-name="${g.name}"><div class="service-widget-header"><i class="bx ${u?"bx-check-circle":"bx-x-circle"}"></i><h3>${m}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${g.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${p}</span></div></div></div>`}let c="";if(l&&(c+=s(l)),c+=a.map(r).join(""),!c){t.innerHTML=C("empty","No models found.");return}t.innerHTML!==c&&(t.innerHTML=c)}async function nt(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("analyst-t1-val"),a=document.getElementById("analyst-t2-val"),l=document.getElementById("analyst-t3-val"),s=document.getElementById("analyst-idle-val"),r=document.getElementById("analyst-reset-btn");r&&!r.dataset.listenerAttached&&(r.onclick=async()=>{r.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await k("/analyst/reset?tier=all",{method:"POST"}),setTimeout(()=>{r.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{r.innerHTML="<i class='bx bx-refresh'></i> Reset Analyst"},2e3)},500),nt()}catch{r.innerHTML="<i class='bx bx-error'></i> Failed"}},r.dataset.listenerAttached="true");let c=await It();if(c){let m=Math.floor(Date.now()/1e3),i=c.active_tier,n=(o,f,h)=>{if(i===h||h==="guardian"&&i==="tests"){o.textContent="Working",o.style.color="#bb86fc";return}let w=f-m;if(w<=0)o.textContent="Ready",o.style.color="#5eff5e";else{let d=Math.floor(w/60),b=w%60;o.textContent=`${d}m ${b}s`,o.style.color="#fff"}};if(e&&c.guardian&&n(e,c.guardian.next_run,"guardian"),a&&c.architect&&n(a,c.architect.next_run,"architect"),l&&c.strategist&&n(l,c.strategist.next_run,"strategist"),s&&c.system_idle_time!==void 0){let o=c.system_idle_time,f=Math.floor(o/60),h=o%60;s.textContent=`${f}m ${h}s`,o>300?s.style.color="#5eff5e":o>60?s.style.color="#ffa500":s.style.color="#fff"}}else[e,a,l,s].forEach(i=>{i&&(i.textContent="Offline",i.style.color="#ff4d4d")});let g=await Tt(),u=document.getElementById("vitals-processes-val");if(u)if(g){let m=g.length;u.textContent=m>0?`${m} Active`:"Idle",u.style.color=m>0?"#bb86fc":"#fff"}else u.textContent="-",u.style.color="#888";if(g===null){t.innerHTML=C("offline","Failed to load process status.");return}if(et=Date.now(),B(3,et),g.length===0){t.innerHTML=C("empty","No active processes."),O(3,0);return}(t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML="");function v(m){let i=Math.floor(Date.now()/1e3-m.start_time),n=m.retries>0?`<span class="process-retry-badge">Retry ${m.retries}</span>`:"",o=m.channel_id,f={"system-discord":"Discord Engine","system-analyst":"Analyst Worker","system-cli-op":"CLI Operation"};return f[o]?o=f[o]:/^\d+$/.test(o)&&(o=`Channel ${o}`),`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Dt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,l]of Object.entries(t)){let s=lt.filter(r=>r.category===a);s.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>at(),document.getElementById("terminal-action-btn").onclick=()=>at());let a=document.getElementById("cli-terminal-body"),l=document.getElementById("cli-docs-pane");a.innerHTML="";let s=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return l.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Le=!0,a}function at(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Le=!1}function ot(t,e,a="output"){if(!Le)return;let l=document.createElement("div");l.className=`terminal-line terminal-${a}`,a==="prompt"?l.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:l.innerHTML=le(e),t.appendChild(l),t.scrollTop=t.scrollHeight}async function Bt(t){let e=lt.find(s=>s.id===t);if(!e)return;let a=Mt(e);ot(a,`dex ${t}`,"prompt");let l=e.demo_output||["Executing command...","\u2713 Done."];for(let s of l){await new Promise(c=>setTimeout(c,400+Math.random()*600));let r="output";s.includes("[ERROR]")?r="error":s.includes("[SUCCESS]")||s.includes("\u2713")?r="success":s.includes("!")&&(r="warning"),ot(a,s,r)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function rt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Dt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code").textContent;navigator.clipboard.writeText(a).then(()=>{let l=e.querySelector("i");l.className="bx bx-check",l.style.color="#5eff5e",setTimeout(()=>{l.className="bx bx-copy",l.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(a=>{a.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let l=a.dataset.cmd;Bt(l)})})}async function Nt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${be()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable. Redirecting to 404."),window.location.href="/404.html"}}function ct(){Nt(),Re(),Ie();let t=window.location.pathname;(t==="/dex"||t==="/dex/"||t.includes("/dex/index.html"))&&!t.includes("/contribute")&&rt();let e=De();ke(e),Ae();let a=window.location.pathname==="/"||window.location.pathname==="/index.html",l=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!l&&document.querySelector("footer")?.classList.add("hide");let s=[],r=document.getElementById("windows-container");r&&r.setAttribute("data-count","0");function c(){return window.innerWidth>=1900?2:1}function g(){let o=c();for(;s.length>o;)s.shift().close(!0);let f=document.getElementById("windows-container"),h=document.querySelector("nav"),w=document.querySelector("footer"),d=window.location.pathname.includes("/dex"),b=window.location.pathname.includes("404")||!!document.getElementById("error-main-view"),y=window.location.pathname==="/"||window.location.pathname==="/index.html";f&&f.setAttribute("data-count",s.length);let A=s.length>1||s.length===1&&window.innerWidth<1200;s.forEach(E=>{let T=document.getElementById(E.id);T&&(s.length===1?T.classList.add("hide-close"):T.classList.remove("hide-close"))});let L={"feed-window":"feed-icon","monitor-window":"monitor-icon","workspace-window":"workspace-icon","settings-window":"settings-icon"};Object.values(L).forEach(E=>document.getElementById(E)?.classList.remove("active")),s.forEach(E=>{let T=L[E.id];T&&document.getElementById(T)?.classList.add("active")}),ie(te(),!1,s.length>0),s.length>0?(w?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),h?.classList.add("window-open"),A?f&&(f.style.paddingTop="60px"):f&&(f.style.paddingTop="100px")):(h?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),f&&(f.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),y||b?w?.classList.remove("hide"):w?.classList.add("hide"))}function u(o){if(o.isOpen()){o.close();return}let f=c();s.length>=f&&s.shift().close(!0),s.push(o),o.open(),g()}function v(){[...s].forEach(f=>f.close()),s=[]}window.addEventListener("resize",g);let x=G({id:"feed-window",icon:"bx-news",tabs:[{icon:"bx-bell",title:"Notifications",content:Pe()},{icon:"bx-calendar-event",title:"Events",content:Ye()}],onOpen:()=>{F(),X()},onClose:()=>{let o=s.indexOf(x);o>-1&&s.splice(o,1),g()}}),p=G({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bx-server",title:"System",content:st()},{icon:"bx-book-content",title:"Contacts",content:We()}],onOpen:()=>{we(),ye()},onClose:()=>{let o=s.indexOf(p);o>-1&&s.splice(o,1),g()}}),m=G({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:Ge(),onOpen:()=>he(),onClose:()=>{let o=s.indexOf(m);o>-1&&s.splice(o,1),g()}}),i=G({id:"settings-window",title:"Settings",icon:"bx-cog",content:Ee(),onOpen:()=>Se(i),onClose:()=>{let o=s.indexOf(i);o>-1&&s.splice(o,1),g()}}),n=G({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="/dex/contribute" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});e?(document.getElementById("feed-icon")?.addEventListener("click",()=>u(x)),document.getElementById("monitor-icon")?.addEventListener("click",()=>u(p)),document.getElementById("workspace-icon")?.addEventListener("click",()=>u(m)),document.getElementById("settings-icon")?.addEventListener("click",()=>u(i)),document.getElementById("close-all-windows")?.addEventListener("click",()=>v()),setInterval(()=>{x.isOpen()&&(F(),X()),p.isOpen()&&we(),m.isOpen()&&he()},5e3)):document.getElementById("login-btn")?.addEventListener("click",()=>{n.open(),setTimeout(()=>{document.getElementById("login-form")?.addEventListener("submit",o=>{o.preventDefault();try{Be(document.getElementById("email-input").value),window.location.reload()}catch(f){let h=document.getElementById("login-error");h&&(h.textContent=f.message,h.style.display="block")}})},100)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ct):ct();})();
