(()=>{function Ye(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Xe(){let t=window.location.pathname,e=t==="/"||t==="/index.html",a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var et=1e3;function ne(t){let e=null,s=t.onClose||null,n=t.onOpen||null;function a(){e&&(e.style.zIndex=++et)}function l(){if(e){e.classList.add("open"),a(),window.addEventListener("resize",r),n&&setTimeout(n,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++et,e.addEventListener("mousedown",a);let v=t.icon||"bx-window",o="",b="",S;t.tabs&&t.tabs.length>0?(o=`<div class="tab-bar">${t.tabs.map((d,u)=>{let f=d.icon?`<i class="bx ${d.icon}"></i>`:`<span class="tab-glyph">${d.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${S}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),c()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let i=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(d=>d.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(d=>d.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${i}"]`).classList.add("active"),g(h,e)})}),setTimeout(()=>{e.classList.add("open"),n&&n()},10)}function r(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&g(m,e)}function g(m,v){setTimeout(()=>{let o=v.querySelector(".tab-bar");if(!o)return;let b=Array.from(o.querySelectorAll(".tab")),S=b.indexOf(m),h=o.clientWidth,i=b[Math.max(0,S-2)],d=b[Math.min(b.length-1,S+2)],u=i.offsetLeft-o.offsetLeft-25,w=d.offsetLeft+d.offsetWidth-o.offsetLeft+25-u,A=w<=h?u-(h-w)/2:m.offsetLeft-o.offsetLeft-h/2+m.offsetWidth/2;o.scrollTo({left:A,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",r),m?(e.remove(),e=null):(e.classList.remove("open"),s&&s(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function x(){return e&&e.classList.contains("open")}return{open:l,close:c,setContent:p,isOpen:x,focus:a,id:t.id}}var tt="easter_theme",ae={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function Ne(){return localStorage.getItem(tt)||ae.DARK}function st(t){if(!Object.values(ae).includes(t))throw new Error("Invalid theme");localStorage.setItem(tt,t),it(t)}function it(t){let e=document.body;if(Object.values(ae).forEach(s=>{e.classList.remove(`theme-${s}`)}),e.classList.add(`theme-${t}`),!document.querySelector(".background")){let s=document.createElement("div");s.className="background",document.body.prepend(s)}e.classList.add("is-animated")}function nt(){let t=Ne();it(t)}function O(t,e,s=null){let a={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=s?`<p class="placeholder-action">${s}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${a} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function H(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function K(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!s)return;if(!e){s.textContent="Last updated: never";return}let n=Date.now(),a=Math.floor((n-e)/1e3),l;a<60?l=`${a}s ago`:a<3600?l=`${Math.floor(a/60)}m ago`:l=`${Math.floor(a/3600)}h ago`,s.textContent=`Last updated: ${l}`}var jt=0;function he(t,e){let s=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!s)return;let n=s.querySelector(".notification-badge");n&&(e>0?(n.textContent=e>9?"9+":e,n.style.display="flex"):n.style.display="none")}var Q=0,ee=0;function ot(t){Q=t,ve()}function rt(t){ee=t,ve()}function ve(){let t=Q+ee;jt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let s=document.getElementById("alerts-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=Q>9?"9+":Q,r.style.display=Q>0?"flex":"none"}let n=document.getElementById("workspace-menu-item");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",n.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let a=document.getElementById("switch-alerts");if(a){let r=a.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",a.appendChild(r)),r.textContent=Q>9?"9+":Q,r.style.display=Q>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let r=l.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",l.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}}function ke(){let t=document.getElementById("alerts-list");if(!t)return;Q=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ve()}function lt(){let t=document.getElementById("blueprints-list");if(!t)return;ee=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ve()}function Ft(){return"https://event.easter.company"}function Jt(){return"https://discord.easter.company"}var Gt="http://127.0.0.1:8100",Wt="http://127.0.0.1:8300",Vt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Te(t){let e=H(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(a,l)=>{let r=Vt[l];return r?`<span class="${r}">`:""});let s=(e.match(/<span/g)||[]).length,n=(e.match(/<\/span/g)||[]).length;return s>n&&(e+="</span>".repeat(s-n)),e}function oe(t){if(!t)return"";let e=H(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(s,n)=>{let a=n.split("|").map(l=>l.trim());return a.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${a.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Zt="https://sterling-javelin-12539.upstash.io",Kt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function D(){return window.location.hostname==="easter.company"}var P=null,He=!1,ct="dex_dashboard_snapshot";function Yt(){let t=localStorage.getItem(ct);if(t)try{P=JSON.parse(t)}catch{P=null}}async function at(){if(!(!D()||He)){He=!0;try{let t=await es("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,localStorage.setItem(ct,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{He=!1}}}function Xt(){if(!P||!P.agent_status)return;let t=P.agent_status;typeof t.system_state_time=="number"&&(t.system_state_time+=1)}async function Qt(){if(!D())return;Yt();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await at(),setInterval(()=>{let s=new Date,n=Math.floor(Date.now()/1e3),a=P?n-P.timestamp:1/0;(s.getSeconds()===59||a>300)&&at(),Xt()},1e3)}D()&&Qt();async function es(t,...e){try{let n=await(await fetch(Zt,{method:"POST",headers:{Authorization:`Bearer ${Kt}`},body:JSON.stringify([t,...e])})).json();if(n.error)throw new Error(n.error);return n.result}catch(s){return console.error("Upstash Error:",s),null}}var ge=null,be=null,Se=!1,Ee=!1;async function z(t,e={}){if(D()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let a=new URLSearchParams(t.split("?")[1]||""),l=a.get("type")||a.get("event.type"),r=a.get("category"),g=a.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...P.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...P.blueprints||[]]:r==="messaging"?c=[...P.messaging_events||[]]:r==="system"?c=[...P.system_events||[]]:r==="cognitive"?c=[...P.cognitive_events||[]]:r==="moderation"?c=[...P.moderation_events||[]]:c=[...P.events||[]],g==="asc"?c.sort((p,x)=>p.timestamp-x.timestamp):c.sort((p,x)=>x.timestamp-p.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let a=t.split("/")[2],l=P.profiles?P.profiles[a]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ge)try{let a=await fetch(ge+t,e);if(a.ok)return a;ge=null}catch{ge=null}let s=Ft(),n=Gt;try{let a=await fetch(s+t,e);if(a.ok)return ge=s,Se&&(console.log("\u2728 Production event service restored."),Se=!1),a;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${n}`),Se=!0);try{let l=await fetch(n+t,e);if(l.ok)return ge=n,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function Me(t,e={}){if(D()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let a=t.split("/")[2],l=(P.contacts?.members||[]).find(r=>r.id===a);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(be)try{let a=await fetch(be+t,e);if(a.ok)return a;be=null}catch{be=null}let s=Jt(),n=Wt;try{let a=await fetch(s+t,e);if(a.ok)return be=s,Ee&&(console.log("\u2728 Production discord service restored."),Ee=!1),a;throw new Error("Primary failed")}catch{Ee||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${n}`),Ee=!0);try{let l=await fetch(n+t,e);if(l.ok)return be=n,l;throw new Error("Fallback failed")}catch(l){throw l}}}var dt=()=>`
...
`,Le=null,re=new Set,Ae=[];async function se(t=!1){let e=document.getElementById("alerts-list");if(!e)return;ts(),t&&(e.innerHTML="<p>Updating...</p>");let s="/events?ml=1000&format=json&event.type=system.notification.generated";try{let n=await z(s);if(!n.ok)throw new Error("Service is offline or unreachable.");let l=(await n.json()).events||[];Le=Date.now(),K(0,Le);let r=Date.now(),g=24*60*60*1e3,c=l.filter(u=>{let f=localStorage.getItem(`alert_read_ts_${u.id}`);if(!f)return!0;let w=parseInt(f);return r-w<g});c.sort((u,f)=>{let w=k=>{let y=k.event;if(typeof y=="string")try{y=JSON.parse(y)}catch{return"low"}return(y.priority||"low").toLowerCase()},A=k=>k==="critical"?4:k==="high"?3:k==="medium"?2:1,L=A(w(u)),E=A(w(f));return L!==E?E-L:f.timestamp-u.timestamp}),Ae=c;let p=u=>{let f=u.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return"low"}return(f.priority||"low").toLowerCase()},x=[],v=new Set(c.map(u=>p(u))).size>1;if(c.length>0){let u=null;c.forEach(f=>{let w=p(f);v&&w!==u&&(x.push({id:`divider-${w}`,type:"divider",label:w.toUpperCase()}),u=w),x.push(f)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=O("empty","No alerts yet."),ke();return}let o=u=>{let f=u.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return null}let w=(f.title||"Untitled Alert").trim(),A=(f.body||"No description provided.").trim(),L=f.summary||"",E=f.content||"",k=f.protocol||"",y=(f.priority||"low").toLowerCase(),I=!!f.alert,_=(f.category||"system").trim(),N=f.related_event_ids||[],j=f.audit_event_id,F=!!localStorage.getItem(`alert_read_ts_${u.id}`),T=new Date(u.timestamp*1e3),$=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),C=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),M=F?"event-border-grey":"event-border-blue";!F&&I&&(M="event-border-red"),F&&(y==="high"||y==="critical")?M="event-border-red":F&&y==="medium"&&(M="event-border-orange");let R=F?"alert-read":"alert-unread",B=re.has(u.id),U=B?"expanded":"",q=B?"display: block;":"display: none;",J="",G="";N.length>0&&(G=`
        ...
        `,J=`
            ...
            `;let Ze=Z.querySelector(".event-details");Ze&&Ze.addEventListener("click",te=>{te.stopPropagation()});let Ke=Z.querySelector(".close-details-btn");return Ke&&Ke.addEventListener("click",te=>{te.stopPropagation(),Z.classList.remove("expanded");let De=Z.querySelector(".event-details");De&&(De.style.display="none"),re.delete(u.id)}),Z},b=u=>{let f=document.createElement("div");f.className="notification-divider",f.dataset.alertId=u.id;let w="#888888";return u.label==="CRITICAL"?w="#ff4d4d":u.label==="HIGH"?w="#ff8888":u.label==="MEDIUM"&&(w="#ffa500"),f.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${w}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,f.innerHTML=`<span style="white-space: nowrap;">${u.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${w}44, transparent); flex-grow: 1;"></div>`,f},S=Array.from(e.children),h=new Map(S.map(u=>[u.dataset.alertId,u])),i=new Set(x.map(u=>u.id));S.forEach(u=>{let f=u.dataset.alertId;(!f||!i.has(f))&&u.remove()});let d=null;x.forEach((u,f)=>{let w=h.get(u.id);(!w||t)&&(w&&w.remove(),u.type==="divider"?w=b(u):w=o(u),!w)||(f===0?e.firstElementChild!==w&&e.prepend(w):d&&d.nextElementSibling!==w&&d.after(w),d=w)}),Le=Date.now(),K(0,Le),ke()}catch(n){console.error("Error fetching alerts:",n),e.children.length===0&&(e.innerHTML=O("offline","Failed to load alerts.","The event service may be offline."))}}function ts(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),s=document.getElementById("alerts-close-all"),n=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ae.forEach(a=>{localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),se(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ae.forEach(a=>{re.add(a.id),localStorage.getItem(`alert_read_ts_${a.id}`)||localStorage.setItem(`alert_read_ts_${a.id}`,Date.now().toString())}),se(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{re.clear(),se(!0)},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await z("/events?type=system.notification.generated",{method:"DELETE"});let a=Date.now()-48*60*60*1e3;Ae.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,a.toString())}),re.clear(),se(!0)}catch(a){console.error("Failed to clear alerts:",a)}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}async function Pe(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await z(t);if(!e.ok)return;let n=(await e.json()).events||[],a=0;n.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||a++}),ot(a)}catch{}}var pt=()=>`
...
`;function yt(t,e){return{...t==="313071000877137920"?{techLevel:11,commStyle:"Direct / Efficient",patience:"Infinite",vibe:"Architect",facts:[{k:"Role",v:"Creator"},{k:"Lang",v:"Go"},{k:"OS",v:"Linux"},{k:"Editor",v:"Neovim"}],badges:["Creator","Admin","Architect"],stats:{msgs:14052,tokens:"45.2M",lastSeen:"Now"},topics:[{name:"System Architecture",val:85},{name:"Code Review",val:60},{name:"Music / Vibes",val:30},{name:"Debugging",val:45}],traits:{openness:95,conscientiousness:90,extraversion:40,agreeableness:60,neuroticism:15},dossier:{identity:{fullName:"Owen Easter",ageRange:"25-30",gender:"Male",location:"United Kingdom",sexuality:"Heterosexual",relationship:"Single"},career:{jobTitle:"Founder / Systems Architect",company:"Easter Company",skills:["Go","Distributed Systems","AI Integration"]},personal:{hobbies:["Synthwave Production","Coding","Gaming"],habits:["Late Night Coding","Coffee Consumption","System Optimization"],vices:["Perfectionism"],virtues:["Efficiency","Vision"]},social:[{name:"Dexter",relation:"Creation / AI",trust:"100%"},{name:"Sarah",relation:"Close Friend",trust:"95%"},{name:"Mike",relation:"Developer Peer",trust:"88%"}]}}:{techLevel:[2,4,6,8,3,5][Math.floor(Math.random()*6)],commStyle:["Verbose","Casual","Formal","Chaotic","Inquisitive"][Math.floor(Math.random()*5)],patience:Math.random()>.5?"High":"Medium",vibe:["NPC","Guest","Lurker","Regular","Fan"][Math.floor(Math.random()*5)],facts:[{k:"Role",v:"User"},{k:"Interest",v:Math.random()>.5?"Coding":"Gaming"}],badges:["User"],stats:{msgs:Math.floor(Math.random()*500),tokens:Math.floor(Math.random()*100)+"K",lastSeen:Math.floor(Math.random()*24)+"h ago"},topics:[{name:"General Chat",val:80},{name:"Troubleshooting",val:40},{name:"Off-Topic",val:20}],traits:{openness:Math.floor(Math.random()*100),conscientiousness:Math.floor(Math.random()*100),extraversion:Math.floor(Math.random()*100),agreeableness:Math.floor(Math.random()*100),neuroticism:Math.floor(Math.random()*100)},dossier:{identity:{fullName:"Unknown Subject",ageRange:"Unknown",gender:"Unknown",location:"Global",sexuality:"Unknown",relationship:"Unknown"},career:{jobTitle:"Unknown",company:"Unknown",skills:["General User"]},personal:{hobbies:["Lurking","Chatting"],habits:["Unknown"],vices:["None Observed"],virtues:["None Observed"]},social:[]}},id:t,username:e}}function ht(t){if(!document.getElementById("dex-profile-styles")){let s=document.createElement("style");s.id="dex-profile-styles",s.textContent=rs,document.head.appendChild(s)}let e=document.createElement("div");e.className="profile-overlay",e.innerHTML=`
    ...
    `,e.addEventListener("click",s=>{s.target===e&&(e.classList.remove("active"),setTimeout(()=>e.remove(),300))}),document.body.appendChild(e),requestAnimationFrame(()=>e.classList.add("active")),Me(`/profile/${t.id}`).then(async s=>{if(s.ok){let n=await s.json();Oe(e,t,n)}else{console.log("Profile not found or error, using mock data.");let n=yt(t.id,t.username);Oe(e,t,n)}}).catch(s=>{console.error("Profile fetch error:",s);let n=yt(t.id,t.username);Oe(e,t,n)})}function Oe(t,e,s){let n=e.status==="online"?"#03dac6":e.status==="idle"?"#ffb74d":"#cf6679",a=()=>{let S=(s.badges||[]).map(A=>`<span class="profile-badge ${A==="Creator"?"master":""}">${A}</span>`).join(""),h=(s.attributes||s.facts||[]).map(A=>{let L=A.key||A.k,E=A.value||A.v;return`
            <div class="fact-chip">
...
`,ls=null;async function Ue(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Ue(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=s=>{let n=s.target.closest(".user-profile-card");if(n)try{let a=JSON.parse(n.dataset.user);ht(a)}catch(a){console.error("Failed to parse user data",a)}},t.dataset.listenerAttached="true");try{let s=await Me("/contacts");if(!s.ok)throw new Error("Service unreachable");let a=(await s.json()).members||[];if(ls=Date.now(),a.length===0){t.innerHTML=O("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};a.sort((r,g)=>{let c=l[r.level]??10,p=l[g.level]??10;return c!==p?c-p:r.username.localeCompare(g.username)}),t.innerHTML=a.map(r=>{let g=r.color?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",c=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",p="#888";r.level==="Me"||r.level==="Master"?p="#bb86fc":r.level==="Admin"?p="#cf6679":r.level==="Moderator"?p="#03dac6":r.level==="Contributor"&&(p="#ffa500");let x=r.level==="Me",m=x?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",v=x?"2px solid #bb86fc":`1px solid ${g}33`;return`
...
`,_e=null,me=new Set,we=[],W="all",ds={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},ps={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function ms(t){for(let[e,s]of Object.entries(ds))if(s.includes(t))return e;return"system"}function us(t){return ps[t]||"bx-square-rounded"}async function ie(t=!1){let e=document.getElementById("events-timeline");if(!e)return;fs();let n=`/events?ml=${W==="all"?100:250}&format=json`;W!=="all"&&(n+=`&category=${W}`);try{let a=await z(n);if(!a.ok)throw new Error("Service unreachable");if(we=((await a.json()).events||[]).filter(v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return!0}let b=o.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),_e=Date.now(),K(1,_e),we.length===0){e.innerHTML=O("empty","No events found for this filter.");return}t&&(e.innerHTML="");let g=v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return null}let b=o.type,S=ms(b),h=us(b),i=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),d="event-border-grey";i&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?d="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?d="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?d="event-border-orange":b==="system.test.completed"?d=o.test?.status==="OK"&&o.lint?.status==="OK"&&o.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let u=i?"cursor-pointer":"",f=me.has(v.id),w=f?"expanded":"",A=f?"display: block;":"display: none;",L=new Date(v.timestamp*1e3),E=L.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),k=L.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),y=Ct(b,o),I=o.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${o.user_level})</span>`:"",_="";if(i){let T="";if(b==="engagement.decision"){let $=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;T=`
                    ...
                    `}else if(b==="messaging.bot.sent_message"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,C="";o.eval_count&&(C=`
                        ...
                        `);let M="";if(o.chat_history&&o.chat_history.length>0){let R=o.chat_history.length,B=o.chat_history.map((U,q)=>{let J=U.role.toUpperCase();J==="ASSISTANT"&&(J="DEXTER");let G=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",Y=q===R-1?"block":"none";return`
                    ...
                    `}else if(b==="system.analysis.audit"){let $=o.success?"#03dac6":"#ff4d4d",C=o.success?"SUCCESS":"FAILED",M=J=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${J}</h5>`,R="";o.error&&(R=`
                        ...
                        `);let B="";if(o.chat_history&&o.chat_history.length>0){let J=o.chat_history.length,G=o.chat_history.map((Y,ue)=>{let X=Y.role.toUpperCase();X==="USER"&&(X="SYSTEM"),X==="ASSISTANT"&&(X="AGENT");let Z=Y.role==="user"?"#03dac6":Y.role==="system"?"#ffb74d":"#bb86fc";return`
                        ...
                        `}let U="";if(o.corrections&&o.corrections.length>0){let J=o.corrections.map((G,Y)=>`
            ...
            `;let j=N.querySelector(".event-details");if(j&&j.addEventListener("click",T=>{T.stopPropagation()}),i){let T=N.querySelector(".close-details-btn");T&&T.addEventListener("click",$=>{$.stopPropagation();let C=$.target.closest(".event-item");if(C){C.classList.remove("expanded"),me.delete(v.id);let M=C.querySelector(".event-details");M&&(M.style.display="none")}})}let V=N.querySelector(".prev-btn"),F=N.querySelector(".next-btn");if(V&&F){let T=0,$=N.querySelectorAll(".history-slide"),C=$.length,M=()=>{$.forEach((R,B)=>{R.style.display=B===T?"block":"none"}),V.disabled=T===0,F.disabled=T===C-1,V.style.opacity=T===0?"0.5":"1",F.style.opacity=T===C-1?"0.5":"1"};V.addEventListener("click",R=>{R.stopPropagation(),T>0&&(T--,M())}),F.addEventListener("click",R=>{R.stopPropagation(),T<C-1&&(T++,M())}),M()}return N},c=Array.from(e.children),p=new Map(c.map(v=>[v.dataset.eventId,v])),x=new Set(we.map(v=>v.id));c.forEach(v=>{let o=v.dataset.eventId;(!o||!x.has(o))&&v.remove()});let m=null;we.forEach((v,o)=>{let b=p.get(v.id);(!b||t)&&(b&&b.remove(),b=g(v),!b)||(o===0?e.firstElementChild!==b&&e.prepend(b):m&&m.nextElementSibling!==b&&m.after(b),m=b)}),_e=Date.now(),K(1,_e)}catch(a){console.error("Error fetching events:",a),e.children.length===0&&(e.innerHTML=O("offline","Failed to load events.","The event service may be offline."))}}function fs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),s=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{we.forEach(a=>me.add(a.id)),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ie(!0)},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.querySelectorAll(".filter-btn").forEach(a=>{a.onclick=()=>{s.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),a.classList.add("active"),W=a.dataset.filter,ie(!0)}}),s.dataset.listenerAttached="true"),s&&s.querySelectorAll(".filter-btn").forEach(a=>{a.dataset.filter===W?a.classList.add("active"):a.classList.remove("active")});let n=document.getElementById("events-clear");n&&!n.dataset.listenerAttached&&(n.onclick=async()=>{let a=W==="all"?"ALL":W.toUpperCase();if(confirm(`Are you sure you want to delete ${a} events from the backend? This cannot be undone.`)){n.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(W!=="all"?l+=`?category=${W}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await z(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ie(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{n.innerHTML="<i class='bx bx-trash'></i> Clear"}}},n.dataset.listenerAttached="true")}var gs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,$t=gs;function St(){return`
    ...
    `}var bs=null;async function Ce(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await z("/logs");if(!e.ok)throw new Error("Logs offline");let s=await e.json();if(!s||s.length===0)return t.innerHTML=O("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let n=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],a=s.filter(r=>!n.includes(r.id));a.forEach(r=>{r.logs&&Array.isArray(r.logs)?r.logs.reverse():r.logs=[]}),a.reverse();let l=a.map(r=>{let g=r.logs.join(`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${St()}
        </div>`;async function Dt(){await Promise.all([$e(),Fe(),Je()]),await Ce()}var Et=null,kt=null;async function zt(){try{return await(await z("/system_monitor")).json()}catch{return null}}async function Tt(){try{return await(await z("/system/hardware")).json()}catch{return null}}async function vs(){try{return await(await z("/processes")).json()}catch{return null}}async function xs(){try{return await(await z("/agent/status")).json()}catch{return null}}async function Fe(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),s=document.querySelector("#hw-os .hw-content"),n=document.querySelector("#hw-cpu .hw-content"),a=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),g=i=>{if(i){if(s&&(s.innerHTML=`
                ...
                </div>`),a){let d=(i.MEMORY_BYTES/1073741824).toFixed(1);a.innerHTML=`
                ...
                </div>`}if(n&&i.CPU&&i.CPU.length>0){let d=i.CPU[0];n.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let i=await Tt();i?(g(i),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),n&&!n.hasChildNodes())){let i=await Tt();g(i)}if(!t)return;let c=await zt();if(!c||!c.services){t.children.length===0&&(t.innerHTML=O("offline","Failed to load system metrics.","The event service may be offline."));return}Et=Date.now(),K(0,Et);let p=c.services||[];Array.from(t.children).forEach(i=>{i.classList.contains("service-widget")||i.remove()});function x(i){return!i||i==="N/A"||i==="unknown"||i.trim()===""?"-":i}function m(i){if(!i||i==="N/A"||i==="unknown")return"-";let d=i.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:i.split(".").slice(0,3).join(".")||"-"}function v(i){return!i||i.length<=28?i:i.substring(0,28)+"..."}function o(i){if(!i||i==="N/A"||i==="unknown")return"-";let d=i.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let u=parseInt(d[1])||0,f=parseInt(d[2])||0,w=parseInt(d[3])||0,A=parseFloat(d[4])||0,L=u*86400+f*3600+w*60+A,E=Math.floor(L/86400);if(E>0)return`${E}d`;let k=Math.floor(L/3600);if(k>0)return`${k}h`;let y=Math.floor(L/60);return y>0?`${y}m`:`${Math.floor(L)}s`}function b(i){let d=i.status==="online",u=d?"service-widget-online":"service-widget-offline",f=d?"bx-check-circle":"bx-x-circle",w=d?"OK":"BAD",A=i.version?m(i.version.str):"-",L=i.cpu&&i.cpu!=="N/A"?i.cpu:"-",E=i.memory&&i.memory!=="N/A"?i.memory:"-",k=L!=="-"?"#00ff00":"#666",y=L!=="-"?"#fff":"#666",I=E!=="-"?"#00ff00":"#666",_=E!=="-"?"#fff":"#666",N=o(i.uptime),j="";d?j=`
        ...
        `)};e&&w(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry",i),s&&w(s,document.getElementById("guardian-architect-stats"),p.architect,"architect",i);let A=document.getElementById("analyzer-synthesis-val"),L=document.getElementById("analyzer-synthesis-stats");A&&w(A,L,p.synthesis,"synthesis",d);let E=document.getElementById("system-state-label"),k=document.getElementById("system-state-val");if(k&&p.system_state){let y=p.system_state,I=f(p.system_state_time||0);E&&(E.textContent=`State: ${y.toUpperCase()}`),k.textContent=I,y==="idle"?k.style.color=p.system_state_time>300?"#5eff5e":"#fff":k.style.color="#bb86fc"}a&&(a.textContent=f(p.total_idle_time||0)),l&&(l.textContent=f(p.total_active_time||0)),r&&(r.textContent=f(p.total_waste_time||0))}else[e,s,n,a,l,r].forEach(i=>{i&&(i.textContent="-",i.style.color="#666")});let x=await vs(),m=[],v=[],o=[];x&&(Array.isArray(x)?m=x:(m=x.active||[],v=x.queue||[],o=x.history||[],o.sort((h,i)=>(i.end_time||0)-(h.end_time||0)))),m.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=O("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),je(t,m,!1));let b=document.getElementById("processes-queue-widgets");b&&(v.length===0?!b.querySelector(".tab-placeholder")&&!b.querySelector('div[style*="font-style: italic"]')&&(b.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(b.innerHTML="",je(b,v,!1)));let S=document.getElementById("processes-history-widgets");S&&(o.length===0?S.querySelector(".tab-placeholder")||(S.innerHTML=O("empty","No recent history.")):(S.querySelector(".tab-placeholder")&&(S.innerHTML=""),je(S,o,!0))),he(1,m.length)}function je(t,e,s){function n(g){let c="";g.end_time?c=`${g.end_time-g.start_time}s`:c=`${Math.floor(Date.now()/1e3-g.start_time)}s`;let p=g.retries>0?`<span class="process-retry-badge">Retry ${g.retries}</span>`:"",x=g.channel_id,m={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(m[x]?x=m[x]:/^\d+$/.test(x)&&(x=`Channel ${x}`),s)return`
                ...
                ${Object.values(ae).map(n=>`
                    <div class="theme-card ${t===n?"active":""}" data-theme="${n}">
                        ...
                        <div class="theme-info">
                            ...
                            <p>${n===ae.DARK?"Simple, clean, dark.":n===ae.LIGHT?"Heavenly, bright, and glowy.":"The original animated style."}</p>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],hs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[s,n]of Object.entries(t)){let a=Pt.filter(l=>l.category===s);a.length!==0&&(e+=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>Nt(),document.getElementById("terminal-action-btn").onclick=()=>Nt());let s=document.getElementById("cli-terminal-body"),n=document.getElementById("cli-docs-pane");s.innerHTML="";let a=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return n.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),We=!0,s}function Nt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),We=!1}function Ht(t,e,s="output"){if(!We)return;let n=document.createElement("div");n.className=`terminal-line terminal-${s}`,s==="prompt"?n.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:n.innerHTML=Te(e),t.appendChild(n),t.scrollTop=t.scrollHeight}async function Cs(t){let e=Pt.find(a=>a.id===t);if(!e)return;let s=ws(e);Ht(s,`dex ${t}`,"prompt");let n=e.demo_output||["Executing command...","\u2713 Done."];for(let a of n){await new Promise(r=>setTimeout(r,400+Math.random()*600));let l="output";a.includes("[ERROR]")?l="error":a.includes("[SUCCESS]")||a.includes("\u2713")?l="success":a.includes("!")&&(l="warning"),Ht(s,a,l)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Rt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=hs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let s=e.querySelector("code").textContent;navigator.clipboard.writeText(s).then(()=>{let n=e.querySelector("i");n.className="bx bx-check",n.style.color="#5eff5e",setTimeout(()=>{n.className="bx bx-copy",n.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(s=>{s.addEventListener("mouseenter",()=>{s.style.transform="translateY(-5px)",s.style.borderColor="rgba(255,255,255,0.15)",s.style.backgroundColor="rgba(255,255,255,0.05)"}),s.addEventListener("mouseleave",()=>{s.style.transform="translateY(0)",s.style.borderColor="rgba(255,255,255,0.05)",s.style.backgroundColor="rgba(255,255,255,0.03)"}),s.addEventListener("click",()=>{let n=s.dataset.cmd;Cs(n)})})}async function $s(){if(!D())try{if(!(await z("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Ot(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}Xe(),Qe(),$s(),nt(),Ye();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Rt();let e=[],s=document.getElementById("windows-container");s&&s.setAttribute("data-count","0");let n=i=>{localStorage.setItem("dex_last_window",i)};function a(){for(;e.length>1;)e.shift().close(!0);let i=document.getElementById("windows-container"),d=document.querySelector("nav"),u=document.querySelector("footer"),f=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");i&&i.setAttribute("data-count",e.length),e.forEach(I=>{let _=document.getElementById(I.id);_&&_.classList.remove("hide-close")});let A=document.getElementById("dexter-menu-container"),L=document.getElementById("nav-window-switcher"),E=document.getElementById("settings-icon"),k=document.getElementById("close-all-windows"),y=window.innerWidth<880;if(!y){let I=document.getElementById("dexter-dropdown"),_=document.getElementById("dexter-menu-btn");I&&I.classList.remove("active"),_&&_.classList.remove("active"),i&&i.classList.remove("menu-open")}if(fe(e.length>0),e.length>0)if(u?.classList.add("hide"),k&&(k.style.display=y?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),d?.classList.add("window-open"),i&&(i.style.paddingTop="60px"),A&&(A.style.display=y?"flex":"none"),E&&(E.style.display=y?"block":"none"),!y&&L){let I=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(I)?(L.innerHTML=`
