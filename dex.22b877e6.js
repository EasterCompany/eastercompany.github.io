(()=>{function Pe(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Oe(t=!1){let e=window.location.pathname,r=e==="/"||e==="/index.html",i=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var je=1e3;function X(t){let e=null,r=t.onClose||null,a=t.onOpen||null;function n(){e&&(e.style.zIndex=++je)}function i(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),a&&setTimeout(a,10);return}let f=document.getElementById("windows-container");f||(f=document.createElement("div"),f.id="windows-container",f.className="windows-container",document.body.appendChild(f)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++je,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",s="",u="",L;t.tabs&&t.tabs.length>0?(s=`<div class="tab-bar">${t.tabs.map((v,o)=>{let m=v.icon?`<i class="bx ${v.icon}"></i>`:`<span class="tab-glyph">${v.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${L}
        `,f.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),d()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let c=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(v=>v.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),p(h,e)})}),setTimeout(()=>{e.classList.add("open"),a&&a()},10)}function l(){if(!e||!e.classList.contains("open"))return;let f=e.querySelector(".tab.active");f&&p(f,e)}function p(f,b){setTimeout(()=>{let s=b.querySelector(".tab-bar");if(!s)return;let u=Array.from(s.querySelectorAll(".tab")),L=u.indexOf(f),h=s.clientWidth,c=u[Math.max(0,L-2)],v=u[Math.min(u.length-1,L+2)],o=c.offsetLeft-s.offsetLeft-25,y=v.offsetLeft+v.offsetWidth-s.offsetLeft+25-o,C=y<=h?o-(h-y)/2:f.offsetLeft-s.offsetLeft-h/2+f.offsetWidth/2;s.scrollTo({left:C,behavior:"smooth"})},350)}function d(f=!1){e&&(window.removeEventListener("resize",l),f?(e.remove(),e=null):(e.classList.remove("open"),r&&r(),setTimeout(()=>{e?.remove(),e=null},400)))}function g(f){let b=e?.querySelector(".window-content");b&&(b.innerHTML=f)}function x(){return e&&e.classList.contains("open")}return{open:i,close:d,setContent:g,isOpen:x,focus:n,id:t.id}}function Fe(){return!0}function Ge(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function We(t){localStorage.setItem("easter_user_email",t.trim())}var Je="easter_theme",J={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function pe(){return localStorage.getItem(Je)||J.DARK}function Ve(t){if(!Object.values(J).includes(t))throw new Error("Invalid theme");localStorage.setItem(Je,t),be(t)}function be(t){let e=document.body;if(Object.values(J).forEach(a=>{e.classList.remove(`theme-${a}`)}),e.classList.add(`theme-${t}`),[J.LIGHT,J.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let a=document.createElement("div");a.className="background",document.body.prepend(a)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function Ke(){let t=pe();be(t)}function B(t,e,r=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",i=r?`<p class="placeholder-action">${r}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${i}</div>`}function _(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function G(t,e){let r=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!r)return;if(!e){r.textContent="Last updated: never";return}let a=Date.now(),n=Math.floor((a-e)/1e3),i;n<60?i=`${n}s ago`:n<3600?i=`${Math.floor(n/60)}m ago`:i=`${Math.floor(n/3600)}h ago`,r.textContent=`Last updated: ${i}`}var _t=0;function me(t,e){let r=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!r)return;let a=r.querySelector(".notification-badge");a&&(e>0?(a.textContent=e>9?"9+":e,a.style.display="flex"):a.style.display="none")}var V=0,K=0;function Ye(t){V=t,oe()}function Xe(t){K=t,oe()}function oe(){let t=V+K;_t=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let r=document.getElementById("alerts-menu-item");if(r){let l=r.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",r.appendChild(l)),l.textContent=V>9?"9+":V,l.style.display=V>0?"flex":"none"}let a=document.getElementById("workspace-menu-item");if(a){let l=a.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",a.appendChild(l)),l.textContent=K>9?"9+":K,l.style.display=K>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=V>9?"9+":V,l.style.display=V>0?"flex":"none"}let i=document.getElementById("switch-workspace");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",i.appendChild(l)),l.textContent=K>9?"9+":K,l.style.display=K>0?"flex":"none"}}function ye(){let t=document.getElementById("alerts-list");if(!t)return;V=t.querySelectorAll(".alert-unread:not(.priority-low)").length,oe()}function Qe(){let t=document.getElementById("blueprints-list");if(!t)return;K=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,oe()}function Le(){return"https://event.easter.company"}function Mt(){return"https://discord.easter.company"}var Bt="http://127.0.0.1:8100",Dt="http://127.0.0.1:8300",Ht={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function he(t){let e=_(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,i)=>{let l=Ht[i];return l?`<span class="${l}">`:""});let r=(e.match(/<span/g)||[]).length,a=(e.match(/<\/span/g)||[]).length;return r>a&&(e+="</span>".repeat(r-a)),e}function ue(t){if(!t)return"";let e=_(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(r,a)=>{let n=a.split("|").map(i=>i.trim());return n.every(i=>i.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(i=>`<span class="md-table-cell">${i}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var ie=null,ae=null,ve=!1,xe=!1;async function M(t,e={}){if(ie)try{let n=await fetch(ie+t,e);if(n.ok)return n;ie=null}catch{ie=null}let r=Le(),a=Bt;try{let n=await fetch(r+t,e);if(n.ok)return ie=r,ve&&(console.log("\u2728 Production event service restored."),ve=!1),n;throw new Error("Primary failed")}catch{ve||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${a}`),ve=!0);try{let i=await fetch(a+t,e);if(i.ok)return ie=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}async function Ze(t,e={}){if(ae)try{let n=await fetch(ae+t,e);if(n.ok)return n;ae=null}catch{ae=null}let r=Mt(),a=Dt;try{let n=await fetch(r+t,e);if(n.ok)return ae=r,xe&&(console.log("\u2728 Production discord service restored."),xe=!1),n;throw new Error("Primary failed")}catch{xe||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${a}`),xe=!0);try{let i=await fetch(a+t,e);if(i.ok)return ae=a,i;throw new Error("Fallback failed")}catch(i){throw i}}}var et=()=>`
...
`,we=null,Q=new Set,Ee=[];async function Z(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Nt(),t&&(e.innerHTML="<p>Updating...</p>");let r="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await M(r);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];we=Date.now(),G(0,we);let l=Date.now(),p=24*60*60*1e3,d=i.filter(o=>{let m=localStorage.getItem(`alert_read_ts_${o.id}`);if(!m)return!0;let y=parseInt(m);return l-y<p});d.sort((o,m)=>{let y=T=>{let k=T.event;if(typeof k=="string")try{k=JSON.parse(k)}catch{return"low"}return(k.priority||"low").toLowerCase()},C=T=>T==="critical"?4:T==="high"?3:T==="medium"?2:1,w=C(y(o)),$=C(y(m));return w!==$?$-w:m.timestamp-o.timestamp}),Ee=d;let g=o=>{let m=o.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return"low"}return(m.priority||"low").toLowerCase()},x=[],b=new Set(d.map(o=>g(o))).size>1;if(d.length>0){let o=null;d.forEach(m=>{let y=g(m);b&&y!==o&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),o=y),x.push(m)})}if(t&&(e.innerHTML=""),d.length===0){e.innerHTML=B("empty","No alerts yet."),ye();return}let s=o=>{let m=o.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let y=(m.title||"Untitled Alert").trim(),C=(m.body||"No description provided.").trim(),w=(m.priority||"low").toLowerCase(),$=!!m.alert,T=(m.category||"system").trim(),k=m.related_event_ids||[],N=m.audit_event_id,D=!!localStorage.getItem(`alert_read_ts_${o.id}`),P=new Date(o.timestamp*1e3),I=P.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=P.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=D?"event-border-grey":"event-border-blue";!D&&$&&(E="event-border-red"),D&&(w==="high"||w==="critical")?E="event-border-red":D&&w==="medium"&&(E="event-border-orange");let A=D?"alert-read":"alert-unread",j=Q.has(o.id),W=j?"expanded":"",H=j?"display: block;":"display: none;",O="",z="";k.length>0&&(z=`
            <div style="flex: 1; min-width: 150px;">
                ...
                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
                    ${k.map(Y=>`<a href="#" onclick="window.dexter.viewEvent('${Y}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px;">${Y.substring(0,8)}...</a>`).join(", ")}
                </div>
            </div>`);let R="";N&&(R=`
            <div style="flex: 1; min-width: 120px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05);">
                    ...
                    <div style="flex: 1; min-width: 100px;">
                        ...
                        <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; text-transform: capitalize;">${T}</div>
                    </div>
                    ${R}
                    ${z}
                </div>
            ...
            `;let F=document.createElement("div");F.className=`event-item notification-item ${E} ${A} ${W} cursor-pointer priority-${w}`,F.dataset.alertId=o.id,F.onclick=function(Y){if(this.classList.contains("expanded")){this.classList.remove("expanded"),Q.delete(o.id);let de=this.querySelector(".event-details");de&&(de.style.display="none")}else{this.classList.add("expanded"),Q.add(o.id);let de=this.querySelector(".event-details");if(de&&(de.style.display="block"),!localStorage.getItem(`alert_read_ts_${o.id}`)){localStorage.setItem(`alert_read_ts_${o.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Te="event-border-grey";w==="high"||w==="critical"?Te="event-border-red":w==="medium"&&(Te="event-border-orange"),this.classList.add(Te),ye()}}};let ns=y,At={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[T]||"bx-bell";F.innerHTML=`
            ...
            `;let ze=F.querySelector(".event-details");ze&&ze.addEventListener("click",Y=>{Y.stopPropagation()});let Re=F.querySelector(".close-details-btn");return Re&&Re.addEventListener("click",Y=>{Y.stopPropagation(),F.classList.remove("expanded");let ke=F.querySelector(".event-details");ke&&(ke.style.display="none"),Q.delete(o.id)}),F},u=o=>{let m=document.createElement("div");m.className="notification-divider",m.dataset.alertId=o.id;let y="#888888";return o.label==="CRITICAL"?y="#ff4d4d":o.label==="HIGH"?y="#ff8888":o.label==="MEDIUM"&&(y="#ffa500"),m.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${y}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,m.innerHTML=`<span style="white-space: nowrap;">${o.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${y}44, transparent); flex-grow: 1;"></div>`,m},L=Array.from(e.children),h=new Map(L.map(o=>[o.dataset.alertId,o])),c=new Set(x.map(o=>o.id));L.forEach(o=>{let m=o.dataset.alertId;(!m||!c.has(m))&&o.remove()});let v=null;x.forEach((o,m)=>{let y=h.get(o.id);(!y||t)&&(y&&y.remove(),o.type==="divider"?y=u(o):y=s(o),!y)||(m===0?e.firstElementChild!==y&&e.prepend(y):v&&v.nextElementSibling!==y&&v.after(y),v=y)}),we=Date.now(),G(0,we),ye()}catch(a){console.error("Error fetching alerts:",a),e.children.length===0&&(e.innerHTML=B("offline","Failed to load alerts.","The event service may be offline."))}}function Nt(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),r=document.getElementById("alerts-close-all"),a=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ee.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),Z(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ee.forEach(n=>{Q.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),Z(!0)},e.dataset.listenerAttached="true"),r&&!r.dataset.listenerAttached&&(r.onclick=()=>{Q.clear(),Z(!0)},r.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;Ee.forEach(i=>{localStorage.setItem(`alert_read_ts_${i.id}`,n.toString())}),Q.clear(),Z(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}async function tt(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await M(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${i.id}`)||n++}),Ye(n)}catch{}}var st=()=>`
...
`,ee=new Set,it=[],re=null;async function te(t=!1){let e=document.getElementById("roadmap-list");if(e){zt();try{let r=await M("/roadmap");if(!r.ok)throw new Error("Offline");let a=await r.json();it=a;let n=g=>{let x=ee.has(g.id),f=g.state==="published",b=g.state==="consumed",s="event-border-grey";f&&(s="event-border-blue"),b&&(s="event-border-purple");let L=new Date(g.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${s} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=g.id,h.onclick=o=>{if(o.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ee.delete(g.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",ee.add(g.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${g.state.toUpperCase()}]</span>`;h.innerHTML=`
      ...
      `;let v=h.querySelector(".event-details");return v&&v.addEventListener("click",o=>{o.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>Rt(g)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>Pt(g)),h.querySelector(".delete-btn")?.addEventListener("click",()=>Ot(g.id)),h.querySelector(".close-details-btn")?.addEventListener("click",o=>{o.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",ee.delete(g.id)}),h},i=Array.from(e.children),l=new Map(i.map(g=>[g.dataset.itemId,g])),p=new Set(a.map(g=>g.id));if(i.forEach(g=>{let x=g.dataset.itemId;(!x||!p.has(x))&&g.remove()}),a.length===0){e.innerHTML=B("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let d=null;a.forEach((g,x)=>{let f=l.get(g.id);(!f||t)&&(f&&f.remove(),f=n(g),!f)||(x===0?e.firstElementChild!==f&&e.prepend(f):d&&d.nextElementSibling!==f&&d.after(f),d=f)})}catch{e.children.length===0&&(e.innerHTML=B("offline","Failed to load roadmap.","The event service may be offline."))}}}function zt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),r=document.getElementById("roadmap-cancel"),a=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{re=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),r&&!r.dataset.listenerAttached&&(r.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",re=null},r.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let i=document.getElementById("roadmap-editor-input").value;if(!i.trim())return;let l=re?`/roadmap/${re}`:"/roadmap",p=re?"PATCH":"POST";try{await M(l,{method:p,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:i})}),document.getElementById("roadmap-editor-container").style.display="none",te(!0)}catch(d){console.error(d)}},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{it.forEach(i=>ee.add(i.id)),te(!0)},a.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{ee.clear(),te(!0)},n.dataset.listenerAttached="true")}function Rt(t){re=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function Pt(t){let e=t.state==="published"?"draft":"published";try{await M(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),te(!0)}catch(r){console.error(r)}}async function Ot(t){if(confirm("Delete this roadmap item?"))try{await M(`/roadmap/${t}`,{method:"DELETE"}),ee.delete(t),te(!0)}catch(e){console.error(e)}}var ot=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,at=null,le=new Set,lt=[];async function ce(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Ut();let r="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await M(r);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];if(lt=i,at=Date.now(),G(2,at),i.length===0){e.innerHTML=B("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),me(2,0);return}t&&(e.innerHTML="");let l=f=>{let b=f.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let s=(b.title||"Untitled Blueprint").trim(),u=(b.summary||b.body||"No summary provided.").trim(),L=(b.content||"").trim(),h=(b.category||"architecture").trim(),c=(b.affected_services||[]).map(H=>H.trim()),v=(b.implementation_path||[]).map(H=>H.trim()),o=b.source_event_ids||[],m=b.approved===!0,y=new Date(f.timestamp*1e3),C=y.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),w=y.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=le.has(f.id),T=$?"display: block;":"display: none;",k=document.createElement("div");k.className=`event-item notification-item event-border-purple cursor-pointer ${$?"expanded":""} ${m?"blueprint-approved":""}`,k.dataset.blueprintId=f.id,m&&(k.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",k.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let q=m?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";k.onclick=function(H){if(this.classList.contains("expanded")){this.classList.remove("expanded"),le.delete(f.id);let z=this.querySelector(".event-details");z&&(z.style.display="none")}else{this.classList.add("expanded"),le.add(f.id);let z=this.querySelector(".event-details");z&&(z.style.display="block")}};let D="";v.length>0&&(D=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${v.map(H=>`<li style="margin-bottom: 5px;">${_(H)}</li>`).join("")}</ul></div>
                    </div>
                `);let P="";o.length>0&&(P=`
            ...
            `;let E=k.querySelector(".blueprint-approve-btn");E&&(E.onclick=async H=>{H.stopPropagation(),E.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await M(`/events/${f.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&ce(!0)}catch(O){console.error("Failed to approve blueprint:",O)}});let A=k.querySelector(".blueprint-delete-btn");A&&(A.onclick=async H=>{H.stopPropagation();let O=!m;A.innerHTML=O?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await M(`/events/${f.id}`,{method:"DELETE"})).ok&&ce(!0)}catch(z){console.error("Failed to delete blueprint:",z)}});let j=k.querySelector(".event-details");j&&j.addEventListener("click",H=>{H.stopPropagation()});let W=k.querySelector(".close-details-btn");return W&&W.addEventListener("click",H=>{H.stopPropagation(),k.classList.remove("expanded");let O=k.querySelector(".event-details");O&&(O.style.display="none"),le.delete(f.id)}),k},p=Array.from(e.children),d=new Map(p.map(f=>[f.dataset.blueprintId,f])),g=new Set(i.map(f=>f.id));p.forEach(f=>{let b=f.dataset.blueprintId;(!b||!g.has(b))&&f.remove()});let x=null;i.forEach((f,b)=>{let s=d.get(f.id);(!s||t)&&(s&&s.remove(),s=l(f),!s)||(b===0?e.firstElementChild!==s&&e.prepend(s):x&&x.nextElementSibling!==s&&x.after(s),x=s)}),me(2,i.length),Qe()}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=B("offline","Failed to load blueprints.","The event service may be offline."))}}async function ct(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await M(t);if(!e.ok)return;let a=(await e.json()).events||[],n=0;a.forEach(i=>{let l=i.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),Xe(n)}catch{}}function Ut(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{lt.forEach(r=>le.add(r.id)),ce(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{le.clear(),ce(!0)},e.dataset.listenerAttached="true")}var dt=()=>`
...
`;async function Ie(){await Promise.all([te(),ce()])}var pt=()=>`
...
`,$e=null,se=new Set,ge=[],U="all",Ft={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision"],moderation:["moderation.explicit_content.deleted"]},Gt={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function Wt(t){for(let[e,r]of Object.entries(Ft))if(r.includes(t))return e;return"system"}function Jt(t){return Gt[t]||"bx-square-rounded"}async function ne(t=!1){let e=document.getElementById("events-timeline");if(!e)return;Vt();let a=`/events?ml=${U==="all"?100:250}&format=json`;U!=="all"&&(a+=`&category=${U}`);try{let n=await M(a);if(!n.ok)throw new Error("Service unreachable");if(ge=((await n.json()).events||[]).filter(b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return!0}let u=s.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),$e=Date.now(),G(1,$e),ge.length===0){e.innerHTML=B("empty","No events found for this filter.");return}t&&(e.innerHTML="");let p=b=>{let s=b.event;if(typeof s=="string")try{s=JSON.parse(s)}catch{return null}let u=s.type,L=Wt(u),h=Jt(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),v="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?v="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"?v="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?v="event-border-orange":u==="system.test.completed"?v=s.test?.status==="OK"&&s.lint?.status==="OK"&&s.format?.status==="OK"?"event-border-blue":"event-border-red":v="event-border-blue");let o=c?"cursor-pointer":"",m=se.has(b.id),y=m?"expanded":"",C=m?"display: block;":"display: none;",w=new Date(b.timestamp*1e3),$=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),T=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),k=mt(u,s),N=s.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${s.user_level})</span>`:"",q="";if(c){let I="";if(u==="engagement.decision"){let S=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`;I=`
                    ...
                    `}else if(u==="system.attention.expired"){let S=j=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${j}</h5>`,E=s.timestamp-s.last_active,A=Math.floor(E/60);I=`
                    ...
                    `}else if(u==="analysis.visual.completed"){let S=A=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${A}</h5>`,E="";s.base64_preview?E=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${s.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:s.url&&(E=`<div class="event-detail-block"><img src="${s.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),I=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.analysis.audit"){let S=s.success?"#03dac6":"#ff4d4d",E=s.success?"SUCCESS":"FAILED",A=z=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${z}</h5>`,j="";s.error&&(j=`
                            <div class="event-detail-block">
                                ${A("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${_(s.error)}</pre>
                            </div>
                        `);let W="";if(s.chat_history&&s.chat_history.length>0){let z=s.chat_history.map(R=>`
                                <div style="margin-bottom: 10px; padding: 10px; background: rgba(255,255,255,0.03); border-radius: 4px;">
                                    <div style="font-size: 0.65em; text-transform: uppercase; color: ${R.role==="user"?"#03dac6":R.role==="system"?"#ffb74d":"#bb86fc"}; letter-spacing: 1px; margin-bottom: 4px; font-weight: bold;">${R.role}</div>
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto;">${_(R.content)}</div>
                                </div>
                            `).join("");W=`
                            <div class="event-detail-block">
                        ...
                        `}let H="";if(s.corrections&&s.corrections.length>0){let z=s.corrections.map((R,F)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                ...
                                ${R.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${_(R.snippet)}</div>`:""}
                            </div>
                        `).join("");H=`
                            <div class="event-detail-block">
                        ...
                        `}let O="";if(s.parsed_results&&s.parsed_results.length>0){let z=s.parsed_results.map(R=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${_(R.title)}</div>
                                <div style="color: #ddd;">${_(R.summary)}</div>
                            </div>
                        `).join("");O=`
                            <div class="event-detail-block">
                                ${A("Parsed Results")}
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <div style="flex: 1; min-width: 150px;">
                                ...
                                <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: ${S}; font-weight: bold;">${E} <span style="font-weight: normal; opacity: 0.6; font-size: 0.9em;">(${s.attempts} att)</span></div>
                            </div>
                            <div style="flex: 1; min-width: 100px;">
                        ...
                        <div class="event-detail-block">
                            ${A("Input Context")}
                            <pre class="detail-pre" style="max-height: 200px; overflow-y: auto; color: #fff;">${_(s.input_context)}</pre>
                        </div>
                        <div class="event-detail-block">
                            ${A("Raw Output")}
                            <pre class="detail-pre" style="max-height: 300px; overflow-y: auto; color: #fff;">${_(s.raw_output||"(empty)")}</pre>
                        </div>
                    ...
                    `}else if(u==="messaging.user.sent_message"){let S="";s.attachments&&s.attachments.length>0&&(S=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${s.attachments.map(A=>{let j=A.content_type&&A.content_type.startsWith("image/"),W=(A.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${j?`<div class="attachment-thumb-container"><img src="${A.url}" alt="${A.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                ...
                `}let D=document.createElement("div");D.className=`event-item ${v} ${o} ${y}`,D.dataset.eventId=b.id,D.onclick=function(I){if(!c)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),se.delete(b.id);let E=this.querySelector(".event-details");E&&(E.style.display="none")}else{this.classList.add("expanded"),se.add(b.id);let E=this.querySelector(".event-details");E&&(E.style.display="block")}},D.innerHTML=`
                <div class="event-time">
            ...
            `;let P=D.querySelector(".event-details");if(P&&P.addEventListener("click",I=>{I.stopPropagation()}),c){let I=D.querySelector(".close-details-btn");I&&I.addEventListener("click",S=>{S.stopPropagation();let E=S.target.closest(".event-item");if(E){E.classList.remove("expanded"),se.delete(b.id);let A=E.querySelector(".event-details");A&&(A.style.display="none")}})}return D},d=Array.from(e.children),g=new Map(d.map(b=>[b.dataset.eventId,b])),x=new Set(ge.map(b=>b.id));d.forEach(b=>{let s=b.dataset.eventId;(!s||!x.has(s))&&b.remove()});let f=null;ge.forEach((b,s)=>{let u=g.get(b.id);(!u||t)&&(u&&u.remove(),u=p(b),!u)||(s===0?e.firstElementChild!==u&&e.prepend(u):f&&f.nextElementSibling!==u&&f.after(u),f=u)}),$e=Date.now(),G(1,$e)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=B("offline","Failed to load events.","The event service may be offline."))}}function Vt(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),r=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ge.forEach(n=>se.add(n.id)),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{se.clear(),ne(!0)},e.dataset.listenerAttached="true"),r&&!r.dataset.listenerAttached&&(r.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{r.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active")),n.classList.add("active"),U=n.dataset.filter,ne(!0)}}),r.dataset.listenerAttached="true"),r&&r.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===U?n.classList.add("active"):n.classList.remove("active")});let a=document.getElementById("events-clear");a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{let n=U==="all"?"ALL":U.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let i="/events";if(U!=="all"?i+=`?category=${U}`:i+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await M(i,{method:"DELETE"})).ok)throw new Error("Failed to delete events");se.clear(),ne(!0)}catch(i){console.error("Failed to clear events:",i),alert("Failed to clear events. Check console.")}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}function ut(){return`
        <div id="logs-container" class="logs-container"></div>
    `}var Kt=null;async function fe(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await M("/logs");if(!e.ok)throw new Error("Logs offline");let r=await e.json();if(!r||r.length===0)return t.innerHTML=B("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let a=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],n=r.filter(l=>!a.includes(l.id));n.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),n.reverse();let i=n.map(l=>{let p=l.logs.join(`
`),d=[...l.logs];if(d.length<25){let x=25-d.length;for(let f=0;f<x;f++)d.push("")}else d.length>25&&(d=d.slice(-25));let g=d.map(x=>he(x)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=i,document.querySelectorAll(".copy-logs-btn").forEach(l=>{l.addEventListener("click",()=>{let p=unescape(l.dataset.logs);navigator.clipboard.writeText(p).then(()=>{let d=l.querySelector("i");d.classList.remove("bx-copy"),d.classList.add("bx-check"),setTimeout(()=>{d.classList.remove("bx-check"),d.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(l=>{l.addEventListener("click",async()=>{let p=l.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${p}?`))try{(await M(`/logs?service_id=${p}`,{method:"DELETE"})).ok&&fe()}catch(d){console.error("Error clearing logs:",d)}})}),Kt=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=B("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var vt=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ut()}
        </div>`;async function $t(){await Promise.all([Se(),Be(),De()]),await fe()}var gt=null,ft=null;async function St(){try{return await(await M("/system_monitor")).json()}catch{return null}}async function bt(){try{return await(await M("/system/hardware")).json()}catch{return null}}async function Yt(){try{return await(await M("/processes")).json()}catch{return null}}async function Xt(){try{return await(await M("/agent/status")).json()}catch{return null}}async function Be(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),r=document.querySelector("#hw-os .hw-content"),a=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),i=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),p=c=>{if(c){if(r&&(r.innerHTML=`
                ...
                </div>`:P='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${o}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${m}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${y}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${b(c.domain&&c.port?`${c.domain}:${c.port}`:"")}</span></div>${P}</div></div>`}let L=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),h=new Set(g.map(c=>c.id));for(let[c,v]of L)h.has(c)||v.remove();g.forEach(c=>{let v=u(c),o=L.get(c.id);o?o.outerHTML!==v&&(o.outerHTML=v):t.insertAdjacentHTML("beforeend",v)})}async function De(){let t=document.getElementById("models-widgets");if(!t)return;let e=await St();if(!e){t.children.length===0&&(t.innerHTML=B("offline","Failed to load model status.","The event service may be offline."));return}ft=Date.now(),G(2,ft);let r=e.models||[],a=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function n(d){let g=d.status==="Ready";return`
                ...
                </div>`}function l(d){let g=d.status==="Downloaded",x=g?"service-widget-online":"service-widget-offline",f=g?"OK":"MISSING",b=g&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",s=d.name;return d.type==="custom"&&s.endsWith(":latest")&&(s=s.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${g?"bx-check-circle":"bx-x-circle"}"></i><h3>${s}</h3><span class="service-widget-status">${f}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let p="";if(a&&(p+=n(a)),e.xtts&&(p+=i(e.xtts)),p+=r.map(l).join(""),!p){t.innerHTML=B("empty","No models found.");return}t.innerHTML!==p&&(t.innerHTML=p)}async function Se(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-t1-val"),r=document.getElementById("guardian-t2-val"),a=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),i=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),p=document.getElementById("guardian-reset-btn");p&&!p.dataset.listenerAttached&&(p.onclick=async()=>{p.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await M("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{p.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{p.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),Se()}catch{p.innerHTML="<i class='bx bx-error'></i> Failed"}},p.dataset.listenerAttached="true");let d=await Xt();if(d){let L=Math.floor(Date.now()/1e3),h=d.active_tier,c=d.protocol_aliases||{t1:"Sentry",t2:"Architect"},v=C=>{C<0&&(C=0);let w=Math.floor(C/3600),$=Math.floor(C%3600/60),T=C%60;return w>0?`${w}h ${$}m`:$>0?`${$}m ${T}s`:`${T}s`},o=(C,w,$,T)=>{let k=c[T]||T.toUpperCase(),N=C.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(N&&(N.textContent=k),h===T)C.textContent="Working",C.style.color="#bb86fc";else if(T==="t1"&&h==="tests")C.textContent="Testing",C.style.color="#03dac6";else if($){let D=$.next_run-L;if(D<=0)C.textContent="Ready",C.style.color="#5eff5e";else{let P=Math.floor(D/60),I=D%60;C.textContent=`${P}m ${I}s`,C.style.color="#fff"}}w&&$&&(w.innerHTML=`
                ...
                ${Object.values(J).map(n=>`
                    <div class="theme-card ${t===n?"active":""}" data-theme="${n}">
                        ...
                        <div class="theme-info">
                            ...
                            <p>${n===J.DARK?"Simple, clean, dark.":n===J.LIGHT?"Heavenly, bright, and glowy.":"The original animated style."}</p>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Zt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[r,a]of Object.entries(t)){let n=Tt.filter(i=>i.category===r);n.length!==0&&(e+=`
    ...
    </div>`,e},Ne=!1;function es(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ne=!0,r}function Ct(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ne=!1}function kt(t,e,r="output"){if(!Ne)return;let a=document.createElement("div");a.className=`terminal-line terminal-${r}`,r==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=he(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function ts(t){let e=Tt.find(n=>n.id===t);if(!e)return;let r=es(e);kt(r,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let n of a){await new Promise(l=>setTimeout(l,400+Math.random()*600));let i="output";n.includes("[ERROR]")?i="error":n.includes("[SUCCESS]")||n.includes("\u2713")?i="success":n.includes("!")&&(i="warning"),kt(r,n,i)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Lt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Zt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let r=e.querySelector("code").textContent;navigator.clipboard.writeText(r).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(r=>{r.addEventListener("mouseenter",()=>{r.style.transform="translateY(-5px)",r.style.borderColor="rgba(255,255,255,0.15)",r.style.backgroundColor="rgba(255,255,255,0.05)"}),r.addEventListener("mouseleave",()=>{r.style.transform="translateY(0)",r.style.borderColor="rgba(255,255,255,0.05)",r.style.backgroundColor="rgba(255,255,255,0.03)"}),r.addEventListener("click",()=>{let a=r.dataset.cmd;ts(a)})})}async function ss(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${Le()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function It(){ss(),Ke(),Pe();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&Lt();let e=Fe();Oe(e),qe();let r=document.getElementById("nav-left-container");r&&r.addEventListener("click",()=>{if(i.length>0)f();else{let o=window.location.pathname;if(!(o==="/"||o==="/index.html")){let C=(o.endsWith("/")&&o.length>1?o.slice(0,-1):o).split("/");C.pop();let w=C.join("/")||"/";window.location.href=w}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",n=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!n&&document.querySelector("footer")?.classList.add("hide");let i=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let p=o=>{localStorage.setItem("dex_last_window",o)};function d(){return 1}function g(){for(;i.length>1;)i.shift().close(!0);let o=document.getElementById("windows-container"),m=document.querySelector("nav"),y=document.querySelector("footer"),C=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");o&&o.setAttribute("data-count",i.length),i.forEach(N=>{let q=document.getElementById(N.id);q&&q.classList.remove("hide-close")}),be(pe());let $=document.getElementById("dexter-menu-container"),T=document.getElementById("nav-window-switcher"),k=document.getElementById("settings-icon");if(Ue(i.length>0),i.length>0){if(y?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),m?.classList.add("window-open"),o&&(o.style.paddingTop="60px"),$&&($.style.display="none"),k&&(k.style.display="none"),T){let N=i[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(N)?(T.innerHTML=`
