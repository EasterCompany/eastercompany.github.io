(()=>{function Xe(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Qe(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var tt=1e3;function ae(t){let e=null,i=t.onClose||null,s=t.onOpen||null;function n(){e&&(e.style.zIndex=++tt)}function l(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",r),s&&setTimeout(s,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++tt,e.addEventListener("mousedown",n);let v=t.icon||"bx-window",o="",b="",E;t.tabs&&t.tabs.length>0?(o=`<div class="tab-bar">${t.tabs.map((d,f)=>{let g=d.icon?`<i class="bx ${d.icon}"></i>`:`<span class="tab-glyph">${d.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${E}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",h=>{h.stopPropagation(),c()}),window.addEventListener("resize",r),t.tabs&&e.querySelectorAll(".tab").forEach(h=>{h.addEventListener("click",()=>{let a=h.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(d=>d.classList.remove("active")),h.classList.add("active"),e.querySelectorAll(".tab-content").forEach(d=>d.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${a}"]`).classList.add("active"),u(h,e)})}),setTimeout(()=>{e.classList.add("open"),s&&s()},10)}function r(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&u(m,e)}function u(m,v){setTimeout(()=>{let o=v.querySelector(".tab-bar");if(!o)return;let b=Array.from(o.querySelectorAll(".tab")),E=b.indexOf(m),h=o.clientWidth,a=b[Math.max(0,E-2)],d=b[Math.min(b.length-1,E+2)],f=a.offsetLeft-o.offsetLeft-25,w=d.offsetLeft+d.offsetWidth-o.offsetLeft+25-f,A=w<=h?f-(h-w)/2:m.offsetLeft-o.offsetLeft-h/2+m.offsetWidth/2;o.scrollTo({left:A,behavior:"smooth"})},350)}function c(m=!1){e&&(window.removeEventListener("resize",r),m?(e.remove(),e=null):(e.classList.remove("open"),i&&i(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){let v=e?.querySelector(".window-content");v&&(v.innerHTML=m)}function x(){return e&&e.classList.contains("open")}return{open:l,close:c,setContent:p,isOpen:x,focus:n,id:t.id}}var st="easter_theme",Z={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function He(){return localStorage.getItem(st)||Z.DARK}function it(t){if(!Object.values(Z).includes(t))throw new Error("Invalid theme");localStorage.setItem(st,t),nt(t)}function nt(t){let e=document.documentElement,i=document.body;Object.values(Z).forEach(r=>{i.classList.remove(`theme-${r}`)}),i.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let n={[Z.DARK]:"#050507",[Z.LIGHT]:"#FFFFFF",[Z.LEGACY]:"#000000"},l=n[t]||n[Z.DARK];if(s.setAttribute("content",l),!document.querySelector(".background")){let r=document.createElement("div");r.className="background",document.body.prepend(r)}i.classList.add("is-animated")}function at(){let t=He();nt(t)}function O(t,e,i=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=i?`<p class="placeholder-action">${i}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function H(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Y(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!i)return;if(!e){i.textContent="Last updated: never";return}let s=Date.now(),n=Math.floor((s-e)/1e3),l;n<60?l=`${n}s ago`:n<3600?l=`${Math.floor(n/60)}m ago`:l=`${Math.floor(n/3600)}h ago`,i.textContent=`Last updated: ${l}`}var Jt=0;function we(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!i)return;let s=i.querySelector(".notification-badge");s&&(e>0?(s.textContent=e>9?"9+":e,s.style.display="flex"):s.style.display="none")}var ee=0,te=0;function rt(t){ee=t,ve()}function lt(t){te=t,ve()}function ve(){let t=ee+te;Jt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let i=document.getElementById("alerts-menu-item");if(i){let r=i.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",i.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let s=document.getElementById("workspace-menu-item");if(s){let r=s.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="auto",s.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let r=n.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",n.appendChild(r)),r.textContent=ee>9?"9+":ee,r.style.display=ee>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let r=l.querySelector(".notification-badge");r||(r=document.createElement("span"),r.className="notification-badge",r.style.marginLeft="8px",l.appendChild(r)),r.textContent=te>9?"9+":te,r.style.display=te>0?"flex":"none"}}function Te(){let t=document.getElementById("alerts-list");if(!t)return;ee=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ve()}function ct(){let t=document.getElementById("blueprints-list");if(!t)return;te=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ve()}function Gt(){return"https://event.easter.company"}function Wt(){return"https://discord.easter.company"}var Vt="http://127.0.0.1:8100",Kt="http://127.0.0.1:8300",Zt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Le(t){let e=H(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,l)=>{let r=Zt[l];return r?`<span class="${r}">`:""});let i=(e.match(/<span/g)||[]).length,s=(e.match(/<\/span/g)||[]).length;return i>s&&(e+="</span>".repeat(i-s)),e}function oe(t){if(!t)return"";let e=H(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(i,s)=>{let n=s.split("|").map(l=>l.trim());return n.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Yt="https://sterling-javelin-12539.upstash.io",Xt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function z(){return window.location.hostname==="easter.company"}var P=null,Pe=!1,dt="dex_dashboard_snapshot";function Qt(){let t=localStorage.getItem(dt);if(t)try{P=JSON.parse(t)}catch{P=null}}async function ot(){if(!(!z()||Pe)){Pe=!0;try{let t=await ss("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);P=e,localStorage.setItem(dt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Pe=!1}}}function es(){if(!P||!P.agent_status)return;let t=P.agent_status;typeof t.system_state_time=="number"&&(t.system_state_time+=1)}async function ts(){if(!z())return;Qt();let t=Math.floor(Date.now()/1e3),e=P?t-P.timestamp:1/0;(!P||e>120)&&await ot(),setInterval(()=>{let i=new Date,s=Math.floor(Date.now()/1e3),n=P?s-P.timestamp:1/0;(i.getSeconds()===59||n>300)&&ot(),es()},1e3)}z()&&ts();async function ss(t,...e){try{let s=await(await fetch(Yt,{method:"POST",headers:{Authorization:`Bearer ${Xt}`},body:JSON.stringify([t,...e])})).json();if(s.error)throw new Error(s.error);return s.result}catch(i){return console.error("Upstash Error:",i),null}}var ge=null,be=null,Se=!1,ke=!1;async function _(t,e={}){if(z()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(P.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(P.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),l=n.get("type")||n.get("event.type"),r=n.get("category"),u=n.get("order")||"desc",c=[];return l==="system.notification.generated"?c=[...P.alerts||[]]:l==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?c=[...P.blueprints||[]]:r==="messaging"?c=[...P.messaging_events||[]]:r==="system"?c=[...P.system_events||[]]:r==="cognitive"?c=[...P.cognitive_events||[]]:r==="moderation"?c=[...P.moderation_events||[]]:c=[...P.events||[]],u==="asc"?c.sort((p,x)=>p.timestamp-x.timestamp):c.sort((p,x)=>x.timestamp-p.timestamp),new Response(JSON.stringify({events:c,count:c.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(P.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],l=P.profiles?P.profiles[n]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ge)try{let n=await fetch(ge+t,e);if(n.ok)return n;ge=null}catch{ge=null}let i=Gt(),s=Vt;try{let n=await fetch(i+t,e);if(n.ok)return ge=i,Se&&(console.log("\u2728 Production event service restored."),Se=!1),n;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${s}`),Se=!0);try{let l=await fetch(s+t,e);if(l.ok)return ge=s,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function Me(t,e={}){if(z()){if(!P)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(P.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],l=(P.contacts?.members||[]).find(r=>r.id===n);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(be)try{let n=await fetch(be+t,e);if(n.ok)return n;be=null}catch{be=null}let i=Wt(),s=Kt;try{let n=await fetch(i+t,e);if(n.ok)return be=i,ke&&(console.log("\u2728 Production discord service restored."),ke=!1),n;throw new Error("Primary failed")}catch{ke||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${s}`),ke=!0);try{let l=await fetch(s+t,e);if(l.ok)return be=s,l;throw new Error("Fallback failed")}catch(l){throw l}}}var pt=()=>`
...
`,Ae=null,re=new Set,Ie=[];async function ie(t=!1){let e=document.getElementById("alerts-list");if(!e)return;is(),t&&(e.innerHTML="<p>Updating...</p>");let i="/events?ml=1000&format=json&event.type=system.notification.generated";try{let s=await _(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let l=(await s.json()).events||[];Ae=Date.now(),Y(0,Ae);let r=Date.now(),u=24*60*60*1e3,c=l.filter(f=>{let g=localStorage.getItem(`alert_read_ts_${f.id}`);if(!g)return!0;let w=parseInt(g);return r-w<u});c.sort((f,g)=>{let w=k=>{let y=k.event;if(typeof y=="string")try{y=JSON.parse(y)}catch{return"low"}return(y.priority||"low").toLowerCase()},A=k=>k==="critical"?4:k==="high"?3:k==="medium"?2:1,M=A(w(f)),S=A(w(g));return M!==S?S-M:g.timestamp-f.timestamp}),Ie=c;let p=f=>{let g=f.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},x=[],v=new Set(c.map(f=>p(f))).size>1;if(c.length>0){let f=null;c.forEach(g=>{let w=p(g);v&&w!==f&&(x.push({id:`divider-${w}`,type:"divider",label:w.toUpperCase()}),f=w),x.push(g)})}if(t&&(e.innerHTML=""),c.length===0){e.innerHTML=O("empty","No alerts yet."),Te();return}let o=f=>{let g=f.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let w=(g.title||"Untitled Alert").trim(),A=(g.body||"No description provided.").trim(),M=g.summary||"",S=g.content||"",k=g.protocol||"",y=(g.priority||"low").toLowerCase(),I=!!g.alert,B=(g.category||"system").trim(),N=g.related_event_ids||[],q=g.audit_event_id,F=!!localStorage.getItem(`alert_read_ts_${f.id}`),T=new Date(f.timestamp*1e3),$=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),C=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=F?"event-border-grey":"event-border-blue";!F&&I&&(L="event-border-red"),F&&(y==="high"||y==="critical")?L="event-border-red":F&&y==="medium"&&(L="event-border-orange");let R=F?"alert-read":"alert-unread",D=re.has(f.id),U=D?"expanded":"",j=D?"display: block;":"display: none;",J="",G="";N.length>0&&(G=`
        ...
        `,J=`
            ...
            `;let K=document.createElement("div");K.className=`event-item notification-item ${L} ${R} ${U} cursor-pointer priority-${y}`,K.dataset.alertId=f.id,K.onclick=function(se){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(f.id);let he=this.querySelector(".event-details");he&&(he.style.display="none")}else{this.classList.add("expanded"),re.add(f.id);let he=this.querySelector(".event-details");if(he&&(he.style.display="block"),!localStorage.getItem(`alert_read_ts_${f.id}`)){localStorage.setItem(`alert_read_ts_${f.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ne="event-border-grey";y==="high"||y==="critical"?Ne="event-border-red":y==="medium"&&(Ne="event-border-orange"),this.classList.add(Ne),Te()}}};let Ke=`${k?k.toUpperCase():"GUARDIAN"} ALERT: ${M||w}`,qt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[B]||"bx-bell",Ft=y==="high"||y==="critical"?"#ff4d4d":y==="medium"?"#ffa500":"#888";K.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Ft}; font-size: 0.8em; margin-left: 5px;">[${y.toUpperCase()}]</span>
                    </div>
            ...
            `;let Ze=K.querySelector(".event-details");Ze&&Ze.addEventListener("click",se=>{se.stopPropagation()});let Ye=K.querySelector(".close-details-btn");return Ye&&Ye.addEventListener("click",se=>{se.stopPropagation(),K.classList.remove("expanded");let ze=K.querySelector(".event-details");ze&&(ze.style.display="none"),re.delete(f.id)}),K},b=f=>{let g=document.createElement("div");g.className="notification-divider",g.dataset.alertId=f.id;let w="#888888";return f.label==="CRITICAL"?w="#ff4d4d":f.label==="HIGH"?w="#ff8888":f.label==="MEDIUM"&&(w="#ffa500"),g.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${w}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,g.innerHTML=`<span style="white-space: nowrap;">${f.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${w}44, transparent); flex-grow: 1;"></div>`,g},E=Array.from(e.children),h=new Map(E.map(f=>[f.dataset.alertId,f])),a=new Set(x.map(f=>f.id));E.forEach(f=>{let g=f.dataset.alertId;(!g||!a.has(g))&&f.remove()});let d=null;x.forEach((f,g)=>{let w=h.get(f.id);(!w||t)&&(w&&w.remove(),f.type==="divider"?w=b(f):w=o(f),!w)||(g===0?e.firstElementChild!==w&&e.prepend(w):d&&d.nextElementSibling!==w&&d.after(w),d=w)}),Ae=Date.now(),Y(0,Ae),Te()}catch(s){console.error("Error fetching alerts:",s),e.children.length===0&&(e.innerHTML=O("offline","Failed to load alerts.","The event service may be offline."))}}function is(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),i=document.getElementById("alerts-close-all"),s=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ie.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ie.forEach(n=>{re.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ie(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{re.clear(),ie(!0)},i.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;Ie.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,n.toString())}),re.clear(),ie(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}async function Re(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await _(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}if((r.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||n++}),rt(n)}catch{}}var mt=()=>`
...
`,le=new Set,Be=[],xe=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){ns();try{let i=await _("/roadmap");if(!i.ok)throw new Error("Offline");let s=await i.json();Be=s;let n=p=>{let x=le.has(p.id),m=p.state==="published",v=p.state==="consumed",o="event-border-grey";m&&(o="event-border-blue"),v&&(o="event-border-purple");let E=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${o} cursor-pointer ${x?"expanded":""}`,h.dataset.itemId=p.id,h.onclick=f=>{if(f.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",le.delete(p.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",le.add(p.id))};let a=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;h.innerHTML=`
      ...
      `;let d=h.querySelector(".event-details");return d&&d.addEventListener("click",f=>{f.stopPropagation()}),h.querySelector(".edit-btn")?.addEventListener("click",()=>as(p)),h.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>os(p)),h.querySelector(".delete-btn")?.addEventListener("click",()=>rs(p.id)),h.querySelector(".close-details-btn")?.addEventListener("click",f=>{f.stopPropagation(),h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",le.delete(p.id)}),h},l=Array.from(e.children),r=new Map(l.map(p=>[p.dataset.itemId,p])),u=new Set(s.map(p=>p.id));if(l.forEach(p=>{let x=p.dataset.itemId;(!x||!u.has(x))&&p.remove()}),!Be||Be.length===0){e.innerHTML=O("empty","Your roadmap is empty.",z()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let c=null;s.forEach((p,x)=>{let m=r.get(p.id);(!m||t)&&(m&&m.remove(),m=n(p),!m)||(x===0?e.firstElementChild!==m&&e.prepend(m):c&&c.nextElementSibling!==m&&c.after(m),c=m)})}catch{e.children.length===0&&(e.innerHTML=O("offline","Failed to load roadmap.","The event service may be offline."))}}}function ns(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),i=document.getElementById("roadmap-cancel"),s=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{xe=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",xe=null},i.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input").value;if(!l.trim())return;let r=xe?`/roadmap/${xe}`:"/roadmap",u=xe?"PATCH":"POST";try{await _(r,{method:u,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(c){console.error(c)}},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{Be.forEach(l=>le.add(l.id)),ce(!0)},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{le.clear(),ce(!0)},n.dataset.listenerAttached="true")}function as(t){xe=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function os(t){let e=t.state==="published"?"draft":"published";try{await _(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(i){console.error(i)}}async function rs(t){if(confirm("Delete this roadmap item?"))try{await _(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var gt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,ft=null,de=new Set,vt=[];async function pe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;ls();let i="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let s=await _(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let l=(await s.json()).events||[];if(vt=l,ft=Date.now(),Y(2,ft),l.length===0){e.innerHTML=O("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),we(2,0);return}t&&(e.innerHTML="");let r=m=>{let v=m.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let o=(v.title||"Untitled Blueprint").trim(),b=(v.summary||v.body||"No summary provided.").trim(),E=(v.content||"").trim(),h=(v.category||"architecture").trim(),a=(v.related_services||v.affected_services||[]).map(D=>D.trim()),d=(v.implementation_path||[]).map(D=>D.trim()),f=v.source_event_ids||[],g=v.approved===!0,w=new Date(m.timestamp*1e3),A=w.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),M=w.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=de.has(m.id),k=S?"display: block;":"display: none;",y=document.createElement("div");y.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${g?"blueprint-approved":""}`,y.dataset.blueprintId=m.id,g&&(y.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",y.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let B=g?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[h]||"bx-paint";y.onclick=function(D){if(this.classList.contains("expanded")){this.classList.remove("expanded"),de.delete(m.id);let j=this.querySelector(".event-details");j&&(j.style.display="none")}else{this.classList.add("expanded"),de.add(m.id);let j=this.querySelector(".event-details");j&&(j.style.display="block")}};let N="";d.length>0&&(N=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${d.map(D=>`<li style="margin-bottom: 5px;">${H(D)}</li>`).join("")}</ul></div>
                    </div>
                `);let q="";f.length>0&&(q=`
                ...
                `);let V=a.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${a.join(", ")}</span></div>`:"<div></div>",F=z(),T=g?`
            ...
            `;y.innerHTML=`
                ...
                <div class="event-icon" style="${g?"color: #03dac6;":""}"><i class='bx ${B}'></i></div>
                <div class="event-content">
            ...
            `;let $=y.querySelector(".blueprint-approve-btn");$&&($.onclick=async D=>{D.stopPropagation(),$.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await _(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&pe(!0)}catch(U){console.error("Failed to approve blueprint:",U)}});let C=y.querySelector(".blueprint-delete-btn");C&&(C.onclick=async D=>{D.stopPropagation();let U=!g;C.innerHTML=U?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await _(`/events/${m.id}`,{method:"DELETE"})).ok&&pe(!0)}catch(j){console.error("Failed to delete blueprint:",j)}});let L=y.querySelector(".event-details");L&&L.addEventListener("click",D=>{D.stopPropagation()});let R=y.querySelector(".close-details-btn");return R&&R.addEventListener("click",D=>{D.stopPropagation(),y.classList.remove("expanded");let U=y.querySelector(".event-details");U&&(U.style.display="none"),de.delete(m.id)}),y},u=Array.from(e.children),c=new Map(u.map(m=>[m.dataset.blueprintId,m])),p=new Set(l.map(m=>m.id));u.forEach(m=>{let v=m.dataset.blueprintId;(!v||!p.has(v))&&m.remove()});let x=null;l.forEach((m,v)=>{let o=c.get(m.id);(!o||t)&&(o&&o.remove(),o=r(m),!o)||(v===0?e.firstElementChild!==o&&e.prepend(o):x&&x.nextElementSibling!==o&&x.after(o),x=o)}),we(2,l.length),ct()}catch(s){console.error("Error fetching blueprints:",s),e.children.length===0&&(e.innerHTML=O("offline","Failed to load blueprints.","The event service may be offline."))}}async function xt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await _(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(l=>{let r=l.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{r={}}r.approved!==!0&&n++}),lt(n)}catch{}}function ls(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),i=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{vt.forEach(s=>de.add(s.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{de.clear(),pe(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await _("/events?type=system.blueprint.generated",{method:"DELETE"}),de.clear(),pe(!0)}catch(s){console.error("Failed to clear blueprints:",s)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var yt=()=>`
...
`;async function Oe(){await Promise.all([ce(),pe()])}var ht=()=>`
    ...
    `;async function ye(){let t=document.getElementById("chores-list"),e=document.getElementById("create-chore-btn"),i=document.getElementById("create-chore-form"),s=document.getElementById("save-chore-btn"),n=document.getElementById("cancel-chore-btn");if(e&&!e.dataset.listenerAttached&&(e.onclick=()=>{i.style.display=i.style.display==="none"?"block":"none"},e.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{i.style.display="none"},n.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let l=document.getElementById("new-chore-instruction").value,r=document.getElementById("new-chore-url").value,u=document.getElementById("new-chore-owner").value||"313071000877137920";if(l){s.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/chores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_id:u,natural_instruction:l,entry_url:r,schedule:"every_6h"})}),i.style.display="none",document.getElementById("new-chore-instruction").value="",document.getElementById("new-chore-url").value="",ye()}catch(c){console.error(c),alert("Failed to create chore")}finally{s.innerHTML="Create Task"}}},s.dataset.listenerAttached="true"),!!t)try{let r=await(await _("/chores")).json();if(!r||r.length===0){t.innerHTML=O("empty","No active chores.","Create one to start monitoring.");return}let u=r.map(c=>{let p=c.last_run===0?"Never":new Date(c.last_run*1e3).toLocaleString(),x=c.memory?c.memory.length:0,m=c.status==="active"?"#03dac6":"#666";return`
            ...
            `}).join("");t.innerHTML=u,t.querySelectorAll(".delete-chore-btn").forEach(c=>{c.onclick=async p=>{p.stopPropagation(),confirm("Delete this chore?")&&(await _(`/chores/${c.dataset.id}`,{method:"DELETE"}),ye())}})}catch(l){console.error("Failed to fetch chores",l)}}var cs=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
...
`,ds=null;async function je(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await je(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=i=>{let s=i.target.closest(".user-profile-card");if(s)try{let n=JSON.parse(s.dataset.user);Ct(n)}catch(n){console.error("Failed to parse user data",n)}},t.dataset.listenerAttached="true");try{let i=await Me("/contacts");if(!i.ok)throw new Error("Service unreachable");let n=(await i.json()).members||[];if(ds=Date.now(),n.length===0){t.innerHTML=O("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((r,u)=>{let c=l[r.level]??10,p=l[u.level]??10;return c!==p?c-p:r.username.localeCompare(u.username)}),t.innerHTML=n.map(r=>{let u=r.color?"#"+r.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",c=r.status==="online"?"#5eff5e":r.status==="idle"?"#ffa500":r.status==="dnd"?"#ff4d4d":"#666",p="#888";r.level==="Me"||r.level==="Master"?p="#bb86fc":r.level==="Admin"?p="#cf6679":r.level==="Moderator"?p="#03dac6":r.level==="Contributor"&&(p="#ffa500");let x=r.level==="Me",m=x?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",v=x?"2px solid #bb86fc":`1px solid ${u}33`;return`
...
`,_e=null,me=new Set,Ce=[],W="all",ms={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},us={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function fs(t){for(let[e,i]of Object.entries(ms))if(i.includes(t))return e;return"system"}function gs(t){return us[t]||"bx-square-rounded"}async function ne(t=!1){let e=document.getElementById("events-timeline");if(!e)return;bs();let s=`/events?ml=${W==="all"?100:250}&format=json`;W!=="all"&&(s+=`&category=${W}`);try{let n=await _(s);if(!n.ok)throw new Error("Service unreachable");if(Ce=((await n.json()).events||[]).filter(v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return!0}let b=o.type;return!(b==="system.blueprint.generated"||b==="system.notification.generated")}),_e=Date.now(),Y(1,_e),Ce.length===0){e.innerHTML=O("empty","No events found for this filter.");return}t&&(e.innerHTML="");let u=v=>{let o=v.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{return null}let b=o.type,E=fs(b),h=gs(b),a=b==="engagement.decision"||b==="messaging.bot.sent_message"||b==="messaging.user.sent_message"||b==="moderation.explicit_content.deleted"||b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="analysis.user.message_signals"||b==="system.cli.command"||b==="system.analysis.audit"||b==="system.test.completed"||b==="error_occurred"||b==="system.cli.status"||b==="system.attention.expired"||b.startsWith("system.roadmap")||b.startsWith("system.process"),d="event-border-grey";a&&(b==="moderation.explicit_content.deleted"||b==="error_occurred"?d="event-border-red":b==="analysis.link.completed"||b==="analysis.visual.completed"||b==="analysis.router.decision"||b==="system.analysis.audit"||b==="analysis.user.message_signals"?d="event-border-purple":b==="system.attention.expired"||b==="system.cli.command"||b==="system.cli.status"?d="event-border-orange":b==="system.test.completed"?d=o.test?.status==="OK"&&o.lint?.status==="OK"&&o.format?.status==="OK"?"event-border-blue":"event-border-red":d="event-border-blue");let f=a?"cursor-pointer":"",g=me.has(v.id),w=g?"expanded":"",A=g?"display: block;":"display: none;",M=new Date(v.timestamp*1e3),S=M.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),k=M.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),y=Et(b,o),I=o.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${o.user_level})</span>`:"",B="";if(a){let T="";if(b==="engagement.decision"){let $=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;T=`
                    ...
                    `}else if(b==="system.attention.expired"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,C=o.timestamp-o.last_active,L=Math.floor(C/60);T=`
                    ...
                    `}else if(b==="messaging.bot.sent_message"){let $=R=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${R}</h5>`,C="";o.eval_count&&(C=`
                        ...
                        `);let L="";if(o.chat_history&&o.chat_history.length>0){let R=o.chat_history.length,D=o.chat_history.map((U,j)=>{let J=U.role.toUpperCase();J==="ASSISTANT"&&(J="DEXTER");let G=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",X=j===R-1?"block":"none";return`
                                <div class="history-slide" data-index="${j}" style="display: ${X};">
                    ...
                    `}else if(b==="system.analysis.audit"){let $=o.success?"#03dac6":"#ff4d4d",C=o.success?"SUCCESS":"FAILED",L=J=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${J}</h5>`,R="";o.error&&(R=`
                            <div class="event-detail-block">
                                ${L("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${H(o.error)}</pre>
                            </div>
                        `);let D="";if(o.chat_history&&o.chat_history.length>0){let J=o.chat_history.length,G=o.chat_history.map((X,ue)=>{let Q=X.role.toUpperCase();Q==="USER"&&(Q="SYSTEM"),Q==="ASSISTANT"&&(Q="AGENT");let K=X.role==="user"?"#03dac6":X.role==="system"?"#ffb74d":"#bb86fc";return`
                    ...
                    `}else if(b==="messaging.user.sent_message"){let $="";o.attachments&&o.attachments.length>0&&($=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${o.attachments.map(L=>{let R=L.content_type&&L.content_type.startsWith("image/"),D=(L.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${R?`<div class="attachment-thumb-container"><img src="${L.url}" alt="${L.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
            ...
            `;let q=N.querySelector(".event-details");if(q&&q.addEventListener("click",T=>{T.stopPropagation()}),a){let T=N.querySelector(".close-details-btn");T&&T.addEventListener("click",$=>{$.stopPropagation();let C=$.target.closest(".event-item");if(C){C.classList.remove("expanded"),me.delete(v.id);let L=C.querySelector(".event-details");L&&(L.style.display="none")}})}let V=N.querySelector(".prev-btn"),F=N.querySelector(".next-btn");if(V&&F){let T=0,$=N.querySelectorAll(".history-slide"),C=$.length,L=()=>{$.forEach((R,D)=>{R.style.display=D===T?"block":"none"}),V.disabled=T===0,F.disabled=T===C-1,V.style.opacity=T===0?"0.5":"1",F.style.opacity=T===C-1?"0.5":"1"};V.addEventListener("click",R=>{R.stopPropagation(),T>0&&(T--,L())}),F.addEventListener("click",R=>{R.stopPropagation(),T<C-1&&(T++,L())}),L()}return N},c=Array.from(e.children),p=new Map(c.map(v=>[v.dataset.eventId,v])),x=new Set(Ce.map(v=>v.id));c.forEach(v=>{let o=v.dataset.eventId;(!o||!x.has(o))&&v.remove()});let m=null;Ce.forEach((v,o)=>{let b=p.get(v.id);(!b||t)&&(b&&b.remove(),b=u(v),!b)||(o===0?e.firstElementChild!==b&&e.prepend(b):m&&m.nextElementSibling!==b&&m.after(b),m=b)}),_e=Date.now(),Y(1,_e)}catch(n){console.error("Error fetching events:",n),e.children.length===0&&(e.innerHTML=O("offline","Failed to load events.","The event service may be offline."))}}function bs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),i=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ce.forEach(n=>me.add(n.id)),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ne(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.querySelectorAll(".filter-btn").forEach(n=>{n.onclick=()=>{i.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),n.classList.add("active"),W=n.dataset.filter,ne(!0)}}),i.dataset.listenerAttached="true"),i&&i.querySelectorAll(".filter-btn").forEach(n=>{n.dataset.filter===W?n.classList.add("active"):n.classList.remove("active")});let s=document.getElementById("events-clear");s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{let n=W==="all"?"ALL":W.toUpperCase();if(confirm(`Are you sure you want to delete ${n} events from the backend? This cannot be undone.`)){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(W!=="all"?l+=`?category=${W}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await _(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ne(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}var vs=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,St=vs;function kt(){return`
    ...
    `}var xs=null;async function $e(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await _("/logs");if(!e.ok)throw new Error("Logs offline");let i=await e.json();if(!i||i.length===0)return t.innerHTML=O("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let s=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],n=i.filter(r=>!s.includes(r.id));n.forEach(r=>{r.logs&&Array.isArray(r.logs)?r.logs.reverse():r.logs=[]}),n.reverse();let l=n.map(r=>{let u=r.logs.join(`
`),c=[...r.logs];if(c.length<25){let x=25-c.length;for(let m=0;m<x;m++)c.push("")}else c.length>25&&(c=c.slice(-25));let p=c.map(x=>Le(x)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(r=>{r.addEventListener("click",()=>{let u=unescape(r.dataset.logs);navigator.clipboard.writeText(u).then(()=>{let c=r.querySelector("i");c.classList.remove("bx-copy"),c.classList.add("bx-check"),setTimeout(()=>{c.classList.remove("bx-check"),c.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(r=>{r.addEventListener("click",async()=>{let u=r.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${u}?`))try{(await _(`/logs?service_id=${u}`,{method:"DELETE"})).ok&&$e()}catch(c){console.error("Error clearing logs:",c)}})}),xs=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=O("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var At=()=>{let t=z()?"display: none;":"";return`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${kt()}
        </div>`;async function Nt(){await Promise.all([Ee(),Je(),Ge(),ye()]),await $e()}var Tt=null,Lt=null;async function Ht(){try{return await(await _("/system_monitor")).json()}catch{return null}}async function Mt(){try{return await(await _("/system/hardware")).json()}catch{return null}}async function ys(){try{return await(await _("/processes")).json()}catch{return null}}async function hs(){try{return await(await _("/agent/status")).json()}catch{return null}}async function Je(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),i=document.querySelector("#hw-os .hw-content"),s=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),r=document.querySelector("#hw-storage .hw-content"),u=a=>{if(a){if(i&&(i.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):r&&(r.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let a=await Mt();a?(u(a),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),s&&!s.hasChildNodes())){let a=await Mt();u(a)}if(!t)return;let c=await Ht();if(!c||!c.services){t.children.length===0&&(t.innerHTML=O("offline","Failed to load system metrics.","The event service may be offline."));return}Tt=Date.now(),Y(0,Tt);let p=c.services||[];Array.from(t.children).forEach(a=>{a.classList.contains("service-widget")||a.remove()});function x(a){return!a||a==="N/A"||a==="unknown"||a.trim()===""?"-":a}function m(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:a.split(".").slice(0,3).join(".")||"-"}function v(a){return!a||a.length<=28?a:a.substring(0,28)+"..."}function o(a){if(!a||a==="N/A"||a==="unknown")return"-";let d=a.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let f=parseInt(d[1])||0,g=parseInt(d[2])||0,w=parseInt(d[3])||0,A=parseFloat(d[4])||0,M=f*86400+g*3600+w*60+A,S=Math.floor(M/86400);if(S>0)return`${S}d`;let k=Math.floor(M/3600);if(k>0)return`${k}h`;let y=Math.floor(M/60);return y>0?`${y}m`:`${Math.floor(M)}s`}function b(a){let d=a.status==="online",f=d?"service-widget-online":"service-widget-offline",g=d?"bx-check-circle":"bx-x-circle",w=d?"OK":"BAD",A=a.version?m(a.version.str):"-",M=a.cpu&&a.cpu!=="N/A"?a.cpu:"-",S=a.memory&&a.memory!=="N/A"?a.memory:"-",k=M!=="-"?"#00ff00":"#666",y=M!=="-"?"#fff":"#666",I=S!=="-"?"#00ff00":"#666",B=S!=="-"?"#fff":"#666",N=o(a.uptime),q="";d?q=`
                <div class="service-widget-info">
                ...
                </div>`:q='<div class="service-widget-footer offline"><span>OFFLINE</span></div>';let V=z()?"easter.company":v(a.domain&&a.port?`${a.domain}:${a.port}`:"");return`<div class="service-widget ${f}" data-service-id="${a.id}"><div class="service-widget-header"><i class="bx ${g}"></i><h3>${a.short_name||a.id}</h3><span class="service-widget-status">${w}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${V}</span></div>${q}</div></div>`}let E=new Map(Array.from(t.querySelectorAll(".service-widget")).map(a=>[a.dataset.serviceId,a])),h=new Set(p.map(a=>a.id));for(let[a,d]of E)h.has(a)||d.remove();p.forEach(a=>{let d=b(a),f=E.get(a.id);f?f.outerHTML!==d&&(f.outerHTML=d):t.insertAdjacentHTML("beforeend",d)})}async function Ge(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Ht();if(!e){t.children.length===0&&(t.innerHTML=O("offline","Failed to load model status.","The event service may be offline."));return}Lt=Date.now(),Y(2,Lt);let i=e.models||[],s=e.whisper;Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function n(c){let p=c.status==="Ready";return`
                ...
                </div>`}function r(c){let p=c.status==="Downloaded",x=p?"service-widget-online":"service-widget-offline",m=p?"OK":"MISSING",v=p&&c.size>0?`${(c.size/1e9).toFixed(2)} GB`:"-",o=c.name;return c.type==="custom"&&o.endsWith(":latest")&&(o=o.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${c.name}"><div class="service-widget-header"><i class="bx ${p?"bx-check-circle":"bx-x-circle"}"></i><h3>${o}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${c.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${v}</span></div></div></div>`}let u="";if(s&&(u+=n(s)),e.xtts&&(u+=l(e.xtts)),u+=i.map(r).join(""),!u){t.innerHTML=O("empty","No models found.");return}t.innerHTML!==u&&(t.innerHTML=u)}async function Ee(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-architect-val"),s=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),l=document.getElementById("guardian-total-active"),r=document.getElementById("guardian-total-waste"),u=document.getElementById("guardian-reset-btn"),c=document.getElementById("analyzer-reset-btn");u&&!u.dataset.listenerAttached&&(u.onclick=async()=>{u.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{u.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{u.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),Ee()}catch{u.innerHTML="<i class='bx bx-error'></i>"}},u.dataset.listenerAttached="true"),c&&!c.dataset.listenerAttached&&(c.onclick=async()=>{c.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await _("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{c.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{c.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),Ee()}catch{c.innerHTML="<i class='bx bx-error'></i>"}},c.dataset.listenerAttached="true");let p=await hs();if(p){let h=Math.floor(Date.now()/1e3),a=p.active_tier,d=p.active_synthesis,f=p.protocol_aliases||{sentry:"Sentry",architect:"Architect",synthesis:"Synthesis"},g=y=>{y<0&&(y=0);let I=Math.floor(y/3600),B=Math.floor(y%3600/60),N=y%60;return I>0?`${I}h ${B}m`:B>0?`${B}m ${N}s`:`${N}s`},w=(y,I,B,N,q)=>{if(!y)return;let V=f[N]||N.toUpperCase(),F=y.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(F&&(F.textContent=V),q&&q.includes(N))y.textContent="Working",y.style.color="#bb86fc";else if(B){let $=B.next_run-h;if($<=0)y.textContent="Ready",y.style.color="#5eff5e";else{let C=Math.floor($/60),L=$%60;y.textContent=`${C}m ${L}s`,y.style.color="#fff"}}I&&B&&(I.innerHTML=`
        ...
        `)};e&&w(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry",a),i&&w(i,document.getElementById("guardian-architect-stats"),p.architect,"architect",a);let A=document.getElementById("analyzer-synthesis-val"),M=document.getElementById("analyzer-synthesis-stats");A&&w(A,M,p.synthesis,"synthesis",d);let S=document.getElementById("system-state-label"),k=document.getElementById("system-state-val");if(k&&p.system_state){let y=p.system_state,I=g(p.system_state_time||0);S&&(S.textContent=`State: ${y.toUpperCase()}`),k.textContent=I,y==="idle"?k.style.color=p.system_state_time>300?"#5eff5e":"#fff":k.style.color="#bb86fc"}n&&(n.textContent=g(p.total_idle_time||0)),l&&(l.textContent=g(p.total_active_time||0)),r&&(r.textContent=g(p.total_waste_time||0))}else[e,i,s,n,l,r].forEach(a=>{a&&(a.textContent="-",a.style.color="#666")});let x=await ys(),m=[],v=[],o=[];x&&(Array.isArray(x)?m=x:(m=x.active||[],v=x.queue||[],o=x.history||[],o.sort((h,a)=>(a.end_time||0)-(h.end_time||0)))),m.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=O("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),Fe(t,m,!1));let b=document.getElementById("processes-queue-widgets");b&&(v.length===0?!b.querySelector(".tab-placeholder")&&!b.querySelector('div[style*="font-style: italic"]')&&(b.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(b.innerHTML="",Fe(b,v,!1)));let E=document.getElementById("processes-history-widgets");E&&(o.length===0?E.querySelector(".tab-placeholder")||(E.innerHTML=O("empty","No recent history.")):(E.querySelector(".tab-placeholder")&&(E.innerHTML=""),Fe(E,o,!0))),we(1,m.length)}function Fe(t,e,i){function s(u){let c="";u.end_time?c=`${u.end_time-u.start_time}s`:c=`${Math.floor(Date.now()/1e3-u.start_time)}s`;let p=u.retries>0?`<span class="process-retry-badge">Retry ${u.retries}</span>`:"",x=u.channel_id,m={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(m[x]?x=m[x]:/^\d+$/.test(x)&&(x=`Channel ${x}`),i)return`
                ...
                <div class="service-widget process-widget" data-channel-id="${u.channel_id}-${u.start_time}" style="">
                    ...
                    <div class="service-widget-body">
                        <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${v}">${u.state}</span>
                        </div>
                        <div class="service-widget-info">
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],ws=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[i,s]of Object.entries(t)){let n=Ot.filter(l=>l.category===i);n.length!==0&&(e+=`
    ...
    </div>`,e},Ve=!1;function Cs(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ve=!0,i}function Pt(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ve=!1}function Rt(t,e,i="output"){if(!Ve)return;let s=document.createElement("div");s.className=`terminal-line terminal-${i}`,i==="prompt"?s.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:s.innerHTML=Le(e),t.appendChild(s),t.scrollTop=t.scrollHeight}async function $s(t){let e=Ot.find(n=>n.id===t);if(!e)return;let i=Cs(e);Rt(i,`dex ${t}`,"prompt");let s=e.demo_output||["Executing command...","\u2713 Done."];for(let n of s){await new Promise(r=>setTimeout(r,400+Math.random()*600));let l="output";n.includes("[ERROR]")?l="error":n.includes("[SUCCESS]")||n.includes("\u2713")?l="success":n.includes("!")&&(l="warning"),Rt(i,n,l)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Ut(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=ws();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let i=e.querySelector("code").textContent;navigator.clipboard.writeText(i).then(()=>{let s=e.querySelector("i");s.className="bx bx-check",s.style.color="#5eff5e",setTimeout(()=>{s.className="bx bx-copy",s.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(i=>{i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),i.addEventListener("click",()=>{let s=i.dataset.cmd;$s(s)})})}async function Es(){if(!z())try{if(!(await _("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function jt(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}Qe(),et(),Es(),at(),Xe();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Ut();let e=[],i=document.getElementById("windows-container");i&&i.setAttribute("data-count","0");let s=a=>{localStorage.setItem("dex_last_window",a)};function n(){for(;e.length>1;)e.shift().close(!0);let a=document.getElementById("windows-container"),d=document.querySelector("nav"),f=document.querySelector("footer"),g=window.location.pathname==="/"||window.location.pathname==="/index.html",w=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");a&&a.setAttribute("data-count",e.length),e.forEach(I=>{let B=document.getElementById(I.id);B&&B.classList.remove("hide-close")});let A=document.getElementById("dexter-menu-container"),M=document.getElementById("nav-window-switcher"),S=document.getElementById("settings-icon"),k=document.getElementById("close-all-windows"),y=window.innerWidth<880;if(!y){let I=document.getElementById("dexter-dropdown"),B=document.getElementById("dexter-menu-btn");I&&I.classList.remove("active"),B&&B.classList.remove("active"),a&&a.classList.remove("menu-open")}if(fe(e.length>0),e.length>0)if(f?.classList.add("hide"),k&&(k.style.display=y?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),d?.classList.add("window-open"),a&&(a.style.paddingTop="60px"),A&&(A.style.display=y?"flex":"none"),S&&(S.style.display=y?"block":"none"),!y&&M){let I=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(I)?(M.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{s("alerts-window"),l(u)}),document.getElementById("switch-events").addEventListener("click",()=>{s("events-window"),l(c)}),document.getElementById("switch-monitor").addEventListener("click",()=>{s("monitor-window"),l(x)}),document.getElementById("switch-contacts").addEventListener("click",()=>{s("contacts-window"),l(p)}),document.getElementById("switch-workspace").addEventListener("click",()=>{s("workspace-window"),l(m)})):M.innerHTML=""}else M&&(M.innerHTML="");else d?.classList.remove("window-open"),k&&(k.style.display="none"),a&&(a.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),g||w?f?.classList.remove("hide"):f?.classList.add("hide"),A&&(A.style.display="flex"),S&&(S.style.display="block"),M&&(M.innerHTML="");ve()}function l(a){if(a.isOpen()){a.close();return}for(;e.length>0;)e.pop().close(!0);e.push(a),a.open(),n()}function r(){[...e].forEach(d=>d.close()),e=[]}window.addEventListener("resize",n);let u=ae({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:pt(),onOpen:()=>ie(),onClose:()=>{let a=e.indexOf(u);a>-1&&e.splice(a,1),n()}}),c=ae({id:"events-window",title:"Events",icon:"bx-calendar-event",content:qe(),onOpen:()=>{c.setContent(qe()),ne()},onClose:()=>{let a=e.indexOf(c);a>-1&&e.splice(a,1),n()}}),p=ae({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:$t(),onOpen:()=>je(),onClose:()=>{let a=e.indexOf(p);a>-1&&e.splice(a,1),n()}}),x=ae({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Bt()},{icon:"bxs-component",title:"Processes",content:It()},{icon:"bxs-brain",title:"Models",content:_t()},{icon:"bxs-hdd",title:"Hardware",content:Dt()},{icon:"bxs-terminal",title:"Logs",content:zt()},{icon:"bxs-zap",title:"Agents",content:At()},{icon:"bx-task",title:"Chores",content:ht()}].filter(a=>z()?a.title!=="Hardware"&&a.title!=="Logs":!0),onOpen:()=>{Je(),Ee(),Ge(),$e(),ye()},onClose:()=>{let a=e.indexOf(x);a>-1&&e.splice(a,1),n()}}),m=ae({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:yt(),onOpen:()=>Oe(),onClose:()=>{let a=e.indexOf(m);a>-1&&e.splice(a,1),n()}}),v=ae({id:"settings-window",title:"Settings",icon:"bx-cog",content:De(),onOpen:()=>{v.setContent(De()),We(v)},onClose:()=>{let a=e.indexOf(v);a>-1&&e.splice(a,1),n()}});window.dexter={viewEvent:a=>{c.isOpen()||l(c),setTimeout(()=>{let d=document.querySelector(`.event-item[data-event-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)},viewAlert:a=>{u.isOpen()||l(u),setTimeout(()=>{let d=document.querySelector(`.event-item[data-alert-id="${a}"]`);d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("flash-highlight"),d.classList.contains("expanded")||d.click(),setTimeout(()=>d.classList.remove("flash-highlight"),2e3))},500)}};let o=()=>{let a=document.getElementById("dexter-dropdown"),d=document.getElementById("dexter-menu-btn");a&&d&&(a.classList.remove("active"),d.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let a=document.getElementById("dexter-menu-btn"),d=document.getElementById("settings-icon"),f=document.getElementById("close-all-windows"),g=document.getElementById("nav-left-container"),w=document.getElementById("dexter-dropdown"),A=document.getElementById("windows-container");a&&w&&(a.onclick=S=>{S.stopPropagation();let k=window.innerWidth<880;w.classList.toggle("active"),a.classList.toggle("active");let y=w.classList.contains("active");if(k){let I=document.querySelector("nav");y?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),I?.classList.add("window-open"),A?.classList.add("menu-open"),fe(!0)):(A?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),I?.classList.remove("window-open"),fe(!1)))}}),d&&(d.onclick=S=>{S.stopPropagation(),l(v)}),f&&(f.onclick=S=>{S.stopPropagation(),r()});let M=(S,k,y)=>{let I=document.getElementById(S);I&&(I.onclick=B=>{B.stopPropagation(),o(),y&&s(y),l(k)})};M("alerts-menu-item",u,"alerts-window"),M("events-menu-item",c,"events-window"),M("monitor-menu-item",x,"monitor-window"),M("contacts-menu-item",p,"contacts-window"),M("workspace-menu-item",m,"workspace-window"),g&&(g.onclick=S=>{if(S.stopPropagation(),w&&w.classList.contains("active")){o(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1));return}if(e.length>0)r();else{let k=window.location.pathname;if(!(k==="/"||k==="/index.html")){let B=(k.endsWith("/")&&k.length>1?k.slice(0,-1):k).split("/");B.pop();let N=B.join("/")||"/";window.location.href=N}}}),document.addEventListener("click",()=>{let S=window.innerWidth<880;w&&w.classList.contains("active")&&(o(),S&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1)))}),w&&(w.onclick=S=>S.stopPropagation())})();let E=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!E&&!h&&document.querySelector("footer")?.classList.add("hide"),z()||setInterval(()=>{c.isOpen()&&ne(),u.isOpen()?ie():Re()},1e3),setInterval(()=>{z()&&(u.isOpen()?ie():Re()),m.isOpen()?Oe():xt(),z()&&c.isOpen()&&ne(),x.isOpen()&&Nt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jt):jt();})();
