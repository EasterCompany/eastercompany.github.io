...
const CLI_COMMANDS: CliCommand[] = [
  ...
  },
  {
    ...
    demo_output: [
      ...
      '',
      '\x1b[1mInitializing Sentry Analysis...\x1b[0m',
  ...
  },
  {
    ...
    demo_output: [
      ...
      'web      127.0.0.1:8201   0.0.5    main     b1c2d3e  \x1b[32mOK\x1b[0m       14h22m           0.0%     42.1 MB',
      'model    127.0.0.1:8400   OK       \x1b[90m--\x1b[0m       \x1b[90m--\x1b[0m       \x1b[32mOK\x1b[0m       4d12h            0.5%     8.4 GB',
  ...
  },
  {
    ...
    title: 'Model',
    icon: 'bx-brain',
    description: 'Run the Model Hub executable or sync neural models.',
    usage: 'dex model [pull|sync|list]',
    category: 'system',
    docs: {
      ...
      extended_usage: 'dex model pull\ndex model run gemma-2-2b',
    },
    demo_output: [
      '\x1b[34m[HUB]\x1b[0m Synchronizing custom Dexter models...',
      'Pulling base models...',
      'Pulling gemma-2-2b... \x1b[32m[100%]\x1b[0m',
      '\x1b[32m✓ Successfully pulled model: gemma-2-2b\x1b[0m',
      'Creating custom Dexter models...',
      '  Rebuilding dex-commit from gemma-2-2b...',
      '\x1b[32m✓   Created dex-commit\x1b[0m',
      '\x1b[32m✓ Models are up-to-date.\x1b[0m',
    ],
  },
  {
    id: 'system',
