      ...
      if (relatedEventIDs.length > 0) {
        relatedEventsHtml = `
                    <div class="event-detail-row">
                        ...
                        <span class="detail-value">${relatedEventIDs.map(id => `<a href="#" onclick="window.dexter.viewEvent('${id}'); return false;" style="color: #03dac6; text-decoration: none; margin-right: 5px; font-family: monospace; width: fit-content;">${id.substring(0, 8)}...</a>`).join(', ')}</span>
                    </div>`;
      }
      ...
      if (auditEventID) {
        generatedByHtml = `
              <div class="event-detail-row">
                  ...
                  <span class="detail-value"><a href="#" onclick="window.dexter.viewEvent('${auditEventID}'); return false;" style="color: #bb86fc; text-decoration: none; font-family: monospace; border-bottom: 1px dashed #bb86fc; width: fit-content;">${auditEventID.substring(0, 8)}...</a></span>
              </div>`;
      }
