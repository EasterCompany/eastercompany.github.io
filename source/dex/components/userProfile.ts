...
function renderProfileContent(overlay: HTMLElement, user: any, data: any) {
  const statusColor =
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="height: 15px;"></div>
                         ...
                         <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                            ${(career.skills || []).map((s: string) => `<span style="font-size: 0.75em; background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">${s}</span>`).join('')}
                         </div>
                    </div>
                </div>
                ...
                <div class="dossier-column">
                    ...
                    <div class="dossier-item">
                        ...
                        <div style="margin-top: 10px;">
                            ${(personal.hobbies || []).map((h: string) => `<div class="dossier-list-item">${h}</div>`).join('')}
                        </div>
                    </div>
                    ...
                    <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(personal.habits || []).map((h: string) => `<div class="dossier-list-item">${h}</div>`).join('')}
                        </div>
                    </div>
                     ...
                     <div class="dossier-item" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px;">
                            ${(personal.vices || []).map((h: string) => `<div class="dossier-list-item" style="color: #cf6679;">${h}</div>`).join('')}
                        </div>
                    </div>
                </div>
              ...
              .map(
                ...
                <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 10px; height: 150px; background: rgba(255,255,255,0.05); border-radius: 5px; position: relative; overflow: hidden;">
                        <div style="position: absolute; bottom: 0; left: 0; width: 100%; height: ${val}%; background: ${Number(val) > 50 ? '#03dac6' : '#cf6679'}; transition: height 1s;"></div>
                    </div>
        ...
        <div class="profile-card">
            ...
            <div class="profile-header">
                ...
                <div class="profile-identity">
                    ...
                    <div class="profile-badges">${(data.badges || []).map((b: string) => `<span class="profile-badge ${b === 'Creator' ? 'master' : ''}">${b}</span>`).join('')}</div>
                </div>
            </div>
  ...
  // Elements
  const card = overlay.querySelector('.profile-card') as HTMLElement;
  ...
  tabs.forEach((btn) => {
    btn.addEventListener('click', () => {
      ...
      const targetTab = overlay.querySelector(`#tab-${tabId}`);
