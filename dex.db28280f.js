(()=>{function Ve(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ze(){let t=window.location.pathname,e=t==="/"||t==="/index.html",s=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Xe=1e3;function ae(t){let e=null,a=t.onClose||null,i=t.onOpen||null;function s(){e&&(e.style.zIndex=++Xe)}function l(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",o),i&&setTimeout(i,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++Xe,e.addEventListener("mousedown",s);let f=t.icon||"bx-window",n="",u="",k;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((x,g)=>{let r=x.icon?`<i class="bx ${x.icon}"></i>`:`<span class="tab-glyph">${x.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
                ...
                `}).join("")}</div>`,k=`<div class="window-content">${t.tabs.map((x,g)=>`<div class="tab-content ${g===0?"active":""}" data-tab-content="${g}">${x.content}</div>`).join("")}</div>`):(t.title&&(u=`<div class="window-title">${t.title}</div>`),k=`<div class="window-content">${t.content||""}</div>`),e.innerHTML=`
            ...
            ${k}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",$=>{$.stopPropagation(),d()}),window.addEventListener("resize",o),t.tabs&&e.querySelectorAll(".tab").forEach($=>{$.addEventListener("click",()=>{let c=$.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(x=>x.classList.remove("active")),$.classList.add("active"),e.querySelectorAll(".tab-content").forEach(x=>x.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${c}"]`).classList.add("active"),b($,e)})}),setTimeout(()=>{e.classList.add("open"),i&&i()},10)}function o(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&b(m,e)}function b(m,f){setTimeout(()=>{let n=f.querySelector(".tab-bar");if(!n)return;let u=Array.from(n.querySelectorAll(".tab")),k=u.indexOf(m),$=n.clientWidth,c=u[Math.max(0,k-2)],x=u[Math.min(u.length-1,k+2)],g=c.offsetLeft-n.offsetLeft-25,v=x.offsetLeft+x.offsetWidth-n.offsetLeft+25-g,L=v<=$?g-($-v)/2:m.offsetLeft-n.offsetLeft-$/2+m.offsetWidth/2;n.scrollTo({left:L,behavior:"smooth"})},350)}function d(m=!1){e&&(window.removeEventListener("resize",o),m?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){let f=e?.querySelector(".window-content");f&&(f.innerHTML=m)}function y(){return e&&e.classList.contains("open")}return{open:l,close:d,setContent:p,isOpen:y,focus:s,id:t.id}}var Qe="easter_theme",X={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function ye(){return localStorage.getItem(Qe)||X.DARK}function et(t){if(!Object.values(X).includes(t))throw new Error("Invalid theme");localStorage.setItem(Qe,t),Ee(t)}function Ee(t){let e=document.body;if(Object.values(X).forEach(i=>{e.classList.remove(`theme-${i}`)}),e.classList.add(`theme-${t}`),[X.LIGHT,X.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let i=document.createElement("div");i.className="background",document.body.prepend(i)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function tt(){let t=ye();Ee(t)}function N(t,e,a=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",l=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${l}</div>`}function D(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Z(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let i=Date.now(),s=Math.floor((i-e)/1e3),l;s<60?l=`${s}s ago`:s<3600?l=`${Math.floor(s/60)}m ago`:l=`${Math.floor(s/3600)}h ago`,a.textContent=`Last updated: ${l}`}var Pt=0;function he(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let i=a.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e,i.style.display="flex"):i.style.display="none")}var Q=0,ee=0;function nt(t){Q=t,be()}function it(t){ee=t,be()}function be(){let t=Q+ee;Pt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let a=document.getElementById("alerts-menu-item");if(a){let o=a.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",a.appendChild(o)),o.textContent=Q>9?"9+":Q,o.style.display=Q>0?"flex":"none"}let i=document.getElementById("workspace-menu-item");if(i){let o=i.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="auto",i.appendChild(o)),o.textContent=ee>9?"9+":ee,o.style.display=ee>0?"flex":"none"}let s=document.getElementById("switch-alerts");if(s){let o=s.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",s.appendChild(o)),o.textContent=Q>9?"9+":Q,o.style.display=Q>0?"flex":"none"}let l=document.getElementById("switch-workspace");if(l){let o=l.querySelector(".notification-badge");o||(o=document.createElement("span"),o.className="notification-badge",o.style.marginLeft="8px",l.appendChild(o)),o.textContent=ee>9?"9+":ee,o.style.display=ee>0?"flex":"none"}}function ke(){let t=document.getElementById("alerts-list");if(!t)return;Q=t.querySelectorAll(".alert-unread:not(.priority-low)").length,be()}function at(){let t=document.getElementById("blueprints-list");if(!t)return;ee=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,be()}function Ot(){return"https://event.easter.company"}function Ut(){return"https://discord.easter.company"}var qt="http://127.0.0.1:8100",jt="http://127.0.0.1:8300",Ft={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Le(t){let e=D(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,l)=>{let o=Ft[l];return o?`<span class="${o}">`:""});let a=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return a>i&&(e+="</span>".repeat(a-i)),e}function oe(t){if(!t)return"";let e=D(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(a,i)=>{let s=i.split("|").map(l=>l.trim());return s.every(l=>l.match(/^:?-+:?$/))?"":`<div class="md-table-row">${s.map(l=>`<span class="md-table-cell">${l}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var Jt="https://sterling-javelin-12539.upstash.io",Gt="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function B(){return window.location.hostname==="easter.company"}var R=null,ot="dex_dashboard_snapshot";function Wt(){let t=localStorage.getItem(ot);if(t)try{R=JSON.parse(t)}catch{R=null}}async function st(){if(!B())return;let t=await Kt("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);R=e,localStorage.setItem(ot,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}function Vt(){if(!R||!R.agent_status)return;let t=R.agent_status;typeof t.system_state_time=="number"&&(t.system_state_time+=1)}function Zt(){if(!B())return;Wt();let t=Date.now();(!R||t/1e3-R.timestamp>120)&&st(),setInterval(()=>{new Date().getSeconds()===59&&st(),Vt()},1e3)}B()&&Zt();async function Kt(t,...e){try{let i=await(await fetch(Jt,{method:"POST",headers:{Authorization:`Bearer ${Gt}`},body:JSON.stringify([t,...e])})).json();if(i.error)throw new Error(i.error);return i.result}catch(a){return console.error("Upstash Error:",a),null}}var fe=null,ge=null,Se=!1,Te=!1;async function M(t,e={}){if(B()){if(!R)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(R.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(R.processes),{status:200});if(t.startsWith("/events")){let s=new URLSearchParams(t.split("?")[1]||""),l=s.get("type")||s.get("event.type"),o=s.get("category"),b=s.get("order")||"desc",d=[];return l==="system.notification.generated"?d=[...R.alerts||[]]:o==="messaging"?d=[...R.messaging_events||[]]:o==="system"?d=[...R.system_events||[]]:o==="cognitive"?d=[...R.cognitive_events||[]]:o==="moderation"?d=[...R.moderation_events||[]]:d=[...R.events||[]],b==="asc"?d.sort((p,y)=>p.timestamp-y.timestamp):d.sort((p,y)=>y.timestamp-p.timestamp),new Response(JSON.stringify({events:d,count:d.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(R.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let s=t.split("/")[2],l=R.profiles?R.profiles[s]:null;return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(fe)try{let s=await fetch(fe+t,e);if(s.ok)return s;fe=null}catch{fe=null}let a=Ot(),i=qt;try{let s=await fetch(a+t,e);if(s.ok)return fe=a,Se&&(console.log("\u2728 Production event service restored."),Se=!1),s;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),Se=!0);try{let l=await fetch(i+t,e);if(l.ok)return fe=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}async function rt(t,e={}){if(B()){if(!R)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(R.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let s=t.split("/")[2],l=(R.contacts?.members||[]).find(o=>o.id===s);return l?new Response(JSON.stringify(l),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(ge)try{let s=await fetch(ge+t,e);if(s.ok)return s;ge=null}catch{ge=null}let a=Ut(),i=jt;try{let s=await fetch(a+t,e);if(s.ok)return ge=a,Te&&(console.log("\u2728 Production discord service restored."),Te=!1),s;throw new Error("Primary failed")}catch{Te||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),Te=!0);try{let l=await fetch(i+t,e);if(l.ok)return ge=i,l;throw new Error("Fallback failed")}catch(l){throw l}}}var lt=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="alerts-clear" class="notif-action-btn danger" style="${B()?"display: none;":""}"><i class='bx bx-trash'></i> Clear</button>
        </div>
    </div>
...
`,Ae=null,re=new Set,Me=[];async function ne(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Yt(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await M(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];Ae=Date.now(),Z(0,Ae);let o=Date.now(),b=24*60*60*1e3,d=l.filter(g=>{let r=localStorage.getItem(`alert_read_ts_${g.id}`);if(!r)return!0;let v=parseInt(r);return o-v<b});d.sort((g,r)=>{let v=_=>{let h=_.event;if(typeof h=="string")try{h=JSON.parse(h)}catch{return"low"}return(h.priority||"low").toLowerCase()},L=_=>_==="critical"?4:_==="high"?3:_==="medium"?2:1,z=L(v(g)),H=L(v(r));return z!==H?H-z:r.timestamp-g.timestamp}),Me=d;let p=g=>{let r=g.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{return"low"}return(r.priority||"low").toLowerCase()},y=[],f=new Set(d.map(g=>p(g))).size>1;if(d.length>0){let g=null;d.forEach(r=>{let v=p(r);f&&v!==g&&(y.push({id:`divider-${v}`,type:"divider",label:v.toUpperCase()}),g=v),y.push(r)})}if(t&&(e.innerHTML=""),d.length===0){e.innerHTML=N("empty","No alerts yet."),ke();return}let n=g=>{let r=g.event;if(typeof r=="string")try{r=JSON.parse(r)}catch{return null}let v=(r.title||"Untitled Alert").trim(),L=(r.body||"No description provided.").trim(),z=r.summary||"",H=r.content||"",_=r.protocol||"",h=(r.priority||"low").toLowerCase(),P=!!r.alert,A=(r.category||"system").trim(),I=r.related_event_ids||[],q=r.audit_event_id,j=!!localStorage.getItem(`alert_read_ts_${g.id}`),S=new Date(g.timestamp*1e3),w=S.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),C=S.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=j?"event-border-grey":"event-border-blue";!j&&P&&(T="event-border-red"),j&&(h==="high"||h==="critical")?T="event-border-red":j&&h==="medium"&&(T="event-border-orange");let E=j?"alert-read":"alert-unread",O=re.has(g.id),U=O?"expanded":"",te=O?"display: block;":"display: none;",F="",J="";I.length>0&&(J=`
            ...
            <div class="event-detail-block" style="text-align: left;">
                ...
                <div class="md-para" style="color: #ddd; font-size: 0.85em; white-space: pre-wrap; line-height: 1.6; text-align: left;">${oe(H)}</div>
            </div>
        `:Y=`
            <div class="event-detail-block" style="text-align: left;">
        ...
        `,F=`
                <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                    <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        <div class="metadata-value" style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee;">${r.related_services&&r.related_services.length>0?r.related_services.join(", "):r.related||"SYSTEM"}</div>
                    </div>
                    <div style="flex: 1; min-width: 100px; text-align: center;">
                ...
                ${Y}
            `;let V=document.createElement("div");V.className=`event-item notification-item ${T} ${E} ${U} cursor-pointer priority-${h}`,V.dataset.alertId=g.id,V.onclick=function(se){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(g.id);let xe=this.querySelector(".event-details");xe&&(xe.style.display="none")}else{this.classList.add("expanded"),re.add(g.id);let xe=this.querySelector(".event-details");if(xe&&(xe.style.display="block"),!localStorage.getItem(`alert_read_ts_${g.id}`)){localStorage.setItem(`alert_read_ts_${g.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let ze="event-border-grey";h==="high"||h==="critical"?ze="event-border-red":h==="medium"&&(ze="event-border-orange"),this.classList.add(ze),ke()}}};let Je=`${_?_.toUpperCase():"GUARDIAN"} ALERT: ${z||v}`,Nt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[A]||"bx-bell",Rt=h==="high"||h==="critical"?"#ff4d4d":h==="medium"?"#ffa500":"#888";V.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Rt}; font-size: 0.8em; margin-left: 5px;">[${h.toUpperCase()}]</span>
                    </div>
            ...
            `;let Ge=V.querySelector(".event-details");Ge&&Ge.addEventListener("click",se=>{se.stopPropagation()});let We=V.querySelector(".close-details-btn");return We&&We.addEventListener("click",se=>{se.stopPropagation(),V.classList.remove("expanded");let De=V.querySelector(".event-details");De&&(De.style.display="none"),re.delete(g.id)}),V},u=g=>{let r=document.createElement("div");r.className="notification-divider",r.dataset.alertId=g.id;let v="#888888";return g.label==="CRITICAL"?v="#ff4d4d":g.label==="HIGH"?v="#ff8888":g.label==="MEDIUM"&&(v="#ffa500"),r.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${v}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,r.innerHTML=`<span style="white-space: nowrap;">${g.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${v}44, transparent); flex-grow: 1;"></div>`,r},k=Array.from(e.children),$=new Map(k.map(g=>[g.dataset.alertId,g])),c=new Set(y.map(g=>g.id));k.forEach(g=>{let r=g.dataset.alertId;(!r||!c.has(r))&&g.remove()});let x=null;y.forEach((g,r)=>{let v=$.get(g.id);(!v||t)&&(v&&v.remove(),g.type==="divider"?v=u(g):v=n(g),!v)||(r===0?e.firstElementChild!==v&&e.prepend(v):x&&x.nextElementSibling!==v&&x.after(v),x=v)}),Ae=Date.now(),Z(0,Ae),ke()}catch(i){console.error("Error fetching alerts:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load alerts.","The event service may be offline."))}}function Yt(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),a=document.getElementById("alerts-close-all"),i=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Me.forEach(s=>{localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),ne(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Me.forEach(s=>{re.add(s.id),localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),ne(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{re.clear(),ne(!0)},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.notification.generated",{method:"DELETE"});let s=Date.now()-48*60*60*1e3;Me.forEach(l=>{localStorage.setItem(`alert_read_ts_${l.id}`,s.toString())}),re.clear(),ne(!0)}catch(s){console.error("Failed to clear alerts:",s)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}async function He(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await M(t);if(!e.ok)return;let i=(await e.json()).events||[],s=0;i.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}if((o.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${l.id}`)||s++}),nt(s)}catch{}}var ct=()=>`
  <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
    <button id="roadmap-new" class="notif-action-btn" style="${B()?"display: none;":""}"><i class='bx bx-plus'></i> New Idea</button>
...
`,le=new Set,_e=[],ve=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){Xt();try{let a=await M("/roadmap");if(!a.ok)throw new Error("Offline");let i=await a.json();_e=i;let s=p=>{let y=le.has(p.id),m=p.state==="published",f=p.state==="consumed",n="event-border-grey";m&&(n="event-border-blue"),f&&(n="event-border-purple");let k=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),$=document.createElement("div");$.className=`event-item notification-item ${n} cursor-pointer ${y?"expanded":""}`,$.dataset.itemId=p.id,$.onclick=g=>{if(g.target.closest("button"))return;$.classList.contains("expanded")?($.classList.remove("expanded"),$.querySelector(".event-details").style.display="none",le.delete(p.id)):($.classList.add("expanded"),$.querySelector(".event-details").style.display="block",le.add(p.id))};let c=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;$.innerHTML=`
        <div class="event-time">
      ...
      `;let x=$.querySelector(".event-details");return x&&x.addEventListener("click",g=>{g.stopPropagation()}),$.querySelector(".edit-btn")?.addEventListener("click",()=>Qt(p)),$.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>es(p)),$.querySelector(".delete-btn")?.addEventListener("click",()=>ts(p.id)),$.querySelector(".close-details-btn")?.addEventListener("click",g=>{g.stopPropagation(),$.classList.remove("expanded"),$.querySelector(".event-details").style.display="none",le.delete(p.id)}),$},l=Array.from(e.children),o=new Map(l.map(p=>[p.dataset.itemId,p])),b=new Set(i.map(p=>p.id));if(l.forEach(p=>{let y=p.dataset.itemId;(!y||!b.has(y))&&p.remove()}),!_e||_e.length===0){e.innerHTML=N("empty","Your roadmap is empty.",B()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let d=null;i.forEach((p,y)=>{let m=o.get(p.id);(!m||t)&&(m&&m.remove(),m=s(p),!m)||(y===0?e.firstElementChild!==m&&e.prepend(m):d&&d.nextElementSibling!==m&&d.after(m),d=m)})}catch{e.children.length===0&&(e.innerHTML=N("offline","Failed to load roadmap.","The event service may be offline."))}}}function Xt(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),i=document.getElementById("roadmap-expand-all"),s=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ve=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",ve=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let l=document.getElementById("roadmap-editor-input").value;if(!l.trim())return;let o=ve?`/roadmap/${ve}`:"/roadmap",b=ve?"PATCH":"POST";try{await M(o,{method:b,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:l})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(d){console.error(d)}},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{_e.forEach(l=>le.add(l.id)),ce(!0)},i.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{le.clear(),ce(!0)},s.dataset.listenerAttached="true")}function Qt(t){ve=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function es(t){let e=t.state==="published"?"draft":"published";try{await M(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(a){console.error(a)}}async function ts(t){if(confirm("Delete this roadmap item?"))try{await M(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var mt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
        <button id="blueprints-expand-all" class="notif-action-btn"><i class='bx bx-expand'></i> Expand All</button>
        <button id="blueprints-close-all" class="notif-action-btn"><i class='bx bx-collapse'></i> Close All</button>
        <button id="blueprints-clear" class="notif-action-btn danger" style="${B()?"display: none;":""}"><i class='bx bx-trash'></i> Clear</button>
    </div>
`,ut=()=>`
...
`,pt=null,de=new Set,ft=[];async function pe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;ss();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await M(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let l=(await i.json()).events||[];if(ft=l,pt=Date.now(),Z(2,pt),l.length===0){e.innerHTML=N("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),he(2,0);return}t&&(e.innerHTML="");let o=m=>{let f=m.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return null}let n=(f.title||"Untitled Blueprint").trim(),u=(f.summary||f.body||"No summary provided.").trim(),k=(f.content||"").trim(),$=(f.category||"architecture").trim(),c=(f.related_services||f.affected_services||[]).map(E=>E.trim()),x=(f.implementation_path||[]).map(E=>E.trim()),g=f.source_event_ids||[],r=f.approved===!0,v=new Date(m.timestamp*1e3),L=v.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),z=v.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),H=de.has(m.id),_=H?"display: block;":"display: none;",h=document.createElement("div");h.className=`event-item notification-item event-border-purple cursor-pointer ${H?"expanded":""} ${r?"blueprint-approved":""}`,h.dataset.blueprintId=m.id,r&&(h.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",h.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let A=r?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[$]||"bx-paint";h.onclick=function(E){if(this.classList.contains("expanded")){this.classList.remove("expanded"),de.delete(m.id);let U=this.querySelector(".event-details");U&&(U.style.display="none")}else{this.classList.add("expanded"),de.add(m.id);let U=this.querySelector(".event-details");U&&(U.style.display="block")}};let I="";x.length>0&&(I=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${x.map(E=>`<li style="margin-bottom: 5px;">${D(E)}</li>`).join("")}</ul></div>
                    </div>
                `);let q="";g.length>0&&(q=`
                ...
                `);let W=c.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${c.join(", ")}</span></div>`:"<div></div>",j=r?`
            ...
            `;h.innerHTML=`
                ...
                <div class="event-icon" style="${r?"color: #03dac6;":""}"><i class='bx ${A}'></i></div>
                <div class="event-content">
            ...
            `;let S=h.querySelector(".blueprint-approve-btn");S&&(S.onclick=async E=>{E.stopPropagation(),S.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await M(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&pe(!0)}catch(O){console.error("Failed to approve blueprint:",O)}});let w=h.querySelector(".blueprint-delete-btn");w&&(w.onclick=async E=>{E.stopPropagation();let O=!r;w.innerHTML=O?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await M(`/events/${m.id}`,{method:"DELETE"})).ok&&pe(!0)}catch(U){console.error("Failed to delete blueprint:",U)}});let C=h.querySelector(".event-details");C&&C.addEventListener("click",E=>{E.stopPropagation()});let T=h.querySelector(".close-details-btn");return T&&T.addEventListener("click",E=>{E.stopPropagation(),h.classList.remove("expanded");let O=h.querySelector(".event-details");O&&(O.style.display="none"),de.delete(m.id)}),h},b=Array.from(e.children),d=new Map(b.map(m=>[m.dataset.blueprintId,m])),p=new Set(l.map(m=>m.id));b.forEach(m=>{let f=m.dataset.blueprintId;(!f||!p.has(f))&&m.remove()});let y=null;l.forEach((m,f)=>{let n=d.get(m.id);(!n||t)&&(n&&n.remove(),n=o(m),!n)||(f===0?e.firstElementChild!==n&&e.prepend(n):y&&y.nextElementSibling!==n&&y.after(n),y=n)}),he(2,l.length),at()}catch(i){console.error("Error fetching blueprints:",i),e.children.length===0&&(e.innerHTML=N("offline","Failed to load blueprints.","The event service may be offline."))}}async function gt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await M(t);if(!e.ok)return;let i=(await e.json()).events||[],s=0;i.forEach(l=>{let o=l.event;if(typeof o=="string")try{o=JSON.parse(o)}catch{o={}}o.approved!==!0&&s++}),it(s)}catch{}}function ss(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),a=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{ft.forEach(i=>de.add(i.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{de.clear(),pe(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){a.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await M("/events?type=system.blueprint.generated",{method:"DELETE"}),de.clear(),pe(!0)}catch(i){console.error("Failed to clear blueprints:",i)}finally{a.innerHTML="<i class='bx bx-trash'></i> Clear"}}},a.dataset.listenerAttached="true")}var bt=()=>`
...
`;async function Ne(){await Promise.all([ce(),pe()])}var vt=()=>`
    <div class="system-section-header" style="margin-bottom: 20px;">
        <i class='bx bx-book-content' style="color: #03dac6;"></i>
        <h2>Contacts</h2>
        <button id="contacts-refresh" class="notif-action-btn" style="margin-left: auto; ${B()?"display: none;":""}"><i class='bx bx-refresh'></i> Refresh</button>
    </div>
...
`,ns=null;async function Re(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...",await Re(),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=a=>{let i=a.target.closest(".user-profile-card");if(i)try{let s=JSON.parse(i.dataset.user);showUserProfile(s)}catch(s){console.error("Failed to parse user data",s)}},t.dataset.listenerAttached="true");try{let a=await rt("/contacts");if(!a.ok)throw new Error("Service unreachable");let s=(await a.json()).members||[];if(ns=Date.now(),s.length===0){t.innerHTML=N("empty","No contacts found.","Check your Discord connection.");return}let l={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};s.sort((o,b)=>{let d=l[o.level]??10,p=l[b.level]??10;return d!==p?d-p:o.username.localeCompare(b.username)}),t.innerHTML=s.map(o=>{let b=o.color?"#"+o.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",d=o.status==="online"?"#5eff5e":o.status==="idle"?"#ffa500":o.status==="dnd"?"#ff4d4d":"#666",p="#888";o.level==="Me"||o.level==="Master"?p="#bb86fc":o.level==="Admin"?p="#cf6679":o.level==="Moderator"?p="#03dac6":o.level==="Contributor"&&(p="#ffa500");let y=o.level==="Me",m=y?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",f=y?"2px solid #bb86fc":`1px solid ${b}33`;return`
                <div class="user-profile-card" 
                     data-user="${JSON.stringify(o).replace(/"/g,"&quot;")}"
                     style="background: ${m}; padding: 15px; border-radius: 8px; border: ${f}; display: flex; align-items: center; gap: 12px; position: relative; overflow: hidden; cursor: pointer; transition: transform 0.2s, background 0.2s;">
    ...
    <div class="system-section-header" style="margin-bottom: 20px;">
        ...
        <div class="alerts-actions" style="margin-left: auto; display: flex; gap: 10px; padding: 0;">
            ...
            <button id="events-clear" class="notif-action-btn danger" style="${B()?"display: none;":""}"><i class='bx bx-trash'></i> Clear</button>
        </div>
    </div>
...
`,Ie=null,me=new Set,we=[],G="all",as={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},os={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function rs(t){for(let[e,a]of Object.entries(as))if(a.includes(t))return e;return"system"}function ls(t){return os[t]||"bx-square-rounded"}async function ie(t=!1){let e=document.getElementById("events-timeline");if(!e)return;cs();let i=`/events?ml=${G==="all"?100:250}&format=json`;G!=="all"&&(i+=`&category=${G}`);try{let s=await M(i);if(!s.ok)throw new Error("Service unreachable");if(we=((await s.json()).events||[]).filter(f=>{let n=f.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return!0}let u=n.type;return!(u==="system.blueprint.generated"||u==="system.notification.generated")}),Ie=Date.now(),Z(1,Ie),we.length===0){e.innerHTML=N("empty","No events found for this filter.");return}t&&(e.innerHTML="");let b=f=>{let n=f.event;if(typeof n=="string")try{n=JSON.parse(n)}catch{return null}let u=n.type,k=rs(u),$=ls(u),c=u==="engagement.decision"||u==="messaging.bot.sent_message"||u==="messaging.user.sent_message"||u==="moderation.explicit_content.deleted"||u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="analysis.user.message_signals"||u==="system.cli.command"||u==="system.analysis.audit"||u==="system.test.completed"||u==="error_occurred"||u==="system.cli.status"||u==="system.attention.expired"||u.startsWith("system.roadmap")||u.startsWith("system.process"),x="event-border-grey";c&&(u==="moderation.explicit_content.deleted"||u==="error_occurred"?x="event-border-red":u==="analysis.link.completed"||u==="analysis.visual.completed"||u==="analysis.router.decision"||u==="system.analysis.audit"||u==="analysis.user.message_signals"?x="event-border-purple":u==="system.attention.expired"||u==="system.cli.command"||u==="system.cli.status"?x="event-border-orange":u==="system.test.completed"?x=n.test?.status==="OK"&&n.lint?.status==="OK"&&n.format?.status==="OK"?"event-border-blue":"event-border-red":x="event-border-blue");let g=c?"cursor-pointer":"",r=me.has(f.id),v=r?"expanded":"",L=r?"display: block;":"display: none;",z=new Date(f.timestamp*1e3),H=z.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=z.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),h=xt(u,n),P=n.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${n.user_level})</span>`:"",A="";if(c){let S="";if(u==="engagement.decision"){let w=C=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${C}</h5>`;S=`
                    ...
                    `}else if(u==="system.attention.expired"){let w=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`,C=n.timestamp-n.last_active,T=Math.floor(C/60);S=`
                    ...
                    `}else if(u==="messaging.bot.sent_message"){let w=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`,C="";n.eval_count&&(C=`
                            <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                                <div style="flex: 1; min-width: 100px; text-align: center;">
                        ...
                        `);let T="";if(n.chat_history&&n.chat_history.length>0){let E=n.chat_history.length,O=n.chat_history.map((U,te)=>{let F=U.role.toUpperCase();F==="ASSISTANT"&&(F="DEXTER");let J=U.role==="user"?"#03dac6":U.role==="system"?"#ffb74d":"#bb86fc",K=te===E-1?"block":"none";return`
                                <div class="history-slide" data-index="${te}" style="display: ${K};">
                                    ...
                                    <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.85em; color: #eee; white-space: pre-wrap; overflow-x: auto; background: rgba(0,0,0,0.2); padding: 10px; border-radius: 4px; max-height: 300px; overflow-y: auto;">${D(U.content)}</div>
                                </div>
                            `}).join("");T=`
                            <div class="event-detail-block">
                        ...
                        `}
                    `}else if(u==="analysis.user.message_signals"){let w=E=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${E}</h5>`,C=n.signals||{};S=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(u==="analysis.visual.completed"){let w=T=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${T}</h5>`,C="";n.base64_preview?C=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${n.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:n.url&&(C=`<div class="event-detail-block"><img src="${n.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),S=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(u==="system.analysis.audit"){let w=n.success?"#03dac6":"#ff4d4d",C=n.success?"SUCCESS":"FAILED",T=F=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${F}</h5>`,E="";n.error&&(E=`
                            <div class="event-detail-block">
                                ${T("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${D(n.error)}</pre>
                            </div>
                        `);let O="";if(n.chat_history&&n.chat_history.length>0){let F=n.chat_history.length,J=n.chat_history.map((K,ue)=>{let Y=K.role.toUpperCase();Y==="USER"&&(Y="SYSTEM"),Y==="ASSISTANT"&&(Y="AGENT");let V=K.role==="user"?"#03dac6":K.role==="system"?"#ffb74d":"#bb86fc";return`
                        ...
                        `}let U="";if(n.corrections&&n.corrections.length>0){let F=n.corrections.map((J,K)=>`
                        ...
                        `}let te="";if(n.parsed_results&&n.parsed_results.length>0){let F=n.parsed_results.map(J=>`
                    ...
                    `}else if(u==="messaging.user.sent_message"){let w="";n.attachments&&n.attachments.length>0&&(w=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${n.attachments.map(T=>{let E=T.content_type&&T.content_type.startsWith("image/"),O=(T.size/1024).toFixed(1)+" KB";return`
                ...
                `}let I=document.createElement("div");I.className=`event-item ${x} ${g} ${v}`,I.dataset.eventId=f.id,I.onclick=function(S){if(!c)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),me.delete(f.id);let C=this.querySelector(".event-details");C&&(C.style.display="none")}else{this.classList.add("expanded"),me.add(f.id);let C=this.querySelector(".event-details");C&&(C.style.display="block")}},I.innerHTML=`
                <div class="event-time">
            ...
            `;let q=I.querySelector(".event-details");if(q&&q.addEventListener("click",S=>{S.stopPropagation()}),c){let S=I.querySelector(".close-details-btn");S&&S.addEventListener("click",w=>{w.stopPropagation();let C=w.target.closest(".event-item");if(C){C.classList.remove("expanded"),me.delete(f.id);let T=C.querySelector(".event-details");T&&(T.style.display="none")}})}let W=I.querySelector(".prev-btn"),j=I.querySelector(".next-btn");if(W&&j){let S=0,w=I.querySelectorAll(".history-slide"),C=w.length,T=()=>{w.forEach((E,O)=>{E.style.display=O===S?"block":"none"}),W.disabled=S===0,j.disabled=S===C-1,W.style.opacity=S===0?"0.5":"1",j.style.opacity=S===C-1?"0.5":"1"};W.addEventListener("click",E=>{E.stopPropagation(),S>0&&(S--,T())}),j.addEventListener("click",E=>{E.stopPropagation(),S<C-1&&(S++,T())}),T()}return I},d=Array.from(e.children),p=new Map(d.map(f=>[f.dataset.eventId,f])),y=new Set(we.map(f=>f.id));d.forEach(f=>{let n=f.dataset.eventId;(!n||!y.has(n))&&f.remove()});let m=null;we.forEach((f,n)=>{let u=p.get(f.id);(!u||t)&&(u&&u.remove(),u=b(f),!u)||(n===0?e.firstElementChild!==u&&e.prepend(u):m&&m.nextElementSibling!==u&&m.after(u),m=u)}),Ie=Date.now(),Z(1,Ie)}catch(s){console.error("Error fetching events:",s),e.children.length===0&&(e.innerHTML=N("offline","Failed to load events.","The event service may be offline."))}}function cs(){let t=document.getElementById("events-expand-all"),e=document.getElementById("events-close-all"),a=document.getElementById("event-filters");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{we.forEach(s=>me.add(s.id)),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{me.clear(),ie(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.querySelectorAll(".filter-btn").forEach(s=>{s.onclick=()=>{a.querySelectorAll(".filter-btn").forEach(l=>l.classList.remove("active")),s.classList.add("active"),G=s.dataset.filter,ie(!0)}}),a.dataset.listenerAttached="true"),a&&a.querySelectorAll(".filter-btn").forEach(s=>{s.dataset.filter===G?s.classList.add("active"):s.classList.remove("active")});let i=document.getElementById("events-clear");i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{let s=G==="all"?"ALL":G.toUpperCase();if(confirm(`Are you sure you want to delete ${s} events from the backend? This cannot be undone.`)){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{let l="/events";if(G!=="all"?l+=`?category=${G}`:l+="?exclude_types=system.blueprint.generated,system.notification.generated",!(await M(l,{method:"DELETE"})).ok)throw new Error("Failed to delete events");me.clear(),ie(!0)}catch(l){console.error("Failed to clear events:",l),alert("Failed to clear events. Check console.")}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var ds=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 348 346" style="color: #bb86fc; fill: currentColor; margin-right: 10px; min-width: 24px; margin-left: 0; max-width: 25px;">
...
`,yt=ds;function ht(){return`
    ...
    `}var ps=null;async function Ce(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await M("/logs");if(!e.ok)throw new Error("Logs offline");let a=await e.json();if(!a||a.length===0)return t.innerHTML=N("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let i=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],s=a.filter(o=>!i.includes(o.id));s.forEach(o=>{o.logs&&Array.isArray(o.logs)?o.logs.reverse():o.logs=[]}),s.reverse();let l=s.map(o=>{let b=o.logs.join(`
`),d=[...o.logs];if(d.length<25){let y=25-d.length;for(let m=0;m<y;m++)d.push("")}else d.length>25&&(d=d.slice(-25));let p=d.map(y=>Le(y)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=l,document.querySelectorAll(".copy-logs-btn").forEach(o=>{o.addEventListener("click",()=>{let b=unescape(o.dataset.logs);navigator.clipboard.writeText(b).then(()=>{let d=o.querySelector("i");d.classList.remove("bx-copy"),d.classList.add("bx-check"),setTimeout(()=>{d.classList.remove("bx-check"),d.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(o=>{o.addEventListener("click",async()=>{let b=o.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${b}?`))try{(await M(`/logs?service_id=${b}`,{method:"DELETE"})).ok&&Ce()}catch(d){console.error("Error clearing logs:",d)}})}),ps=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=N("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var Et=()=>{let t=B()?"display: none;":"";return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ht()}
        </div>`;async function Mt(){await Promise.all([$e(),Ue(),qe()]),await Ce()}var wt=null,Ct=null;async function _t(){try{return await(await M("/system_monitor")).json()}catch{return null}}async function $t(){try{return await(await M("/system/hardware")).json()}catch{return null}}async function ms(){try{return await(await M("/processes")).json()}catch{return null}}async function us(){try{return await(await M("/agent/status")).json()}catch{return null}}async function Ue(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),a=document.querySelector("#hw-os .hw-content"),i=document.querySelector("#hw-cpu .hw-content"),s=document.querySelector("#hw-ram .hw-content"),l=document.querySelector("#hw-gpu .hw-content"),o=document.querySelector("#hw-storage .hw-content"),b=c=>{if(c){if(a&&(a.innerHTML=`
                ...
                </div>`),s){let x=(c.MEMORY_BYTES/1073741824).toFixed(1);s.innerHTML=`
                ...
                </div>`}if(i&&c.CPU&&c.CPU.length>0){let x=c.CPU[0];i.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                ...
                </div>`}l&&(c.GPU&&c.GPU.length>0?l.innerHTML=c.GPU.map(x=>{let g=(x.VRAM/1073741824).toFixed(1);return`
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),o&&c.STORAGE&&c.STORAGE.length>0?o.innerHTML=c.STORAGE.map(x=>{let g=(x.USED/1073741824).toFixed(1),r=(x.SIZE/(1024*1024*1024)).toFixed(1),v=x.SIZE>0?(x.USED/x.SIZE*100).toFixed(0):0,L=x.MOUNT_POINT||"Unmounted";return`
                    <div style="padding: 15px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                        ...
                        <div style="display: flex; justify-content: space-between; font-size: 0.75em; color: #888; margin-bottom: 6px; text-transform: uppercase; font-weight: 600; letter-spacing: 0.5px;">
                            <span>${g} GB Used</span>
                            <span>${r} GB Total</span>
                        </div>
                        <div style="background: rgba(255,255,255,0.05); height: 6px; border-radius: 3px; overflow: hidden;">
                             <div style="background: ${v>90?"#cf6679":"#03dac6"}; width: ${v}%; height: 100%; box-shadow: 0 0 10px ${v>90?"#cf667944":"#03dac644"};"></div>
                        </div>
                    </div>`}).join(""):o&&(o.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let c=await $t();c?(b(c),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},e.dataset.listenerAttached="true"),i&&!i.hasChildNodes())){let c=await $t();b(c)}if(!t)return;let d=await _t();if(!d||!d.services){t.children.length===0&&(t.innerHTML=N("offline","Failed to load system metrics.","The event service may be offline."));return}wt=Date.now(),Z(0,wt);let p=d.services||[];Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function y(c){return!c||c==="N/A"||c==="unknown"||c.trim()===""?"-":c}function m(c){if(!c||c==="N/A"||c==="unknown")return"-";let x=c.match(/^(\d+\.\d+\.\d+)/);return x?x[0]:c.split(".").slice(0,3).join(".")||"-"}function f(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function n(c){if(!c||c==="N/A"||c==="unknown")return"-";let x=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!x)return"-";let g=parseInt(x[1])||0,r=parseInt(x[2])||0,v=parseInt(x[3])||0,L=parseFloat(x[4])||0,z=g*86400+r*3600+v*60+L,H=Math.floor(z/86400);if(H>0)return`${H}d`;let _=Math.floor(z/3600);if(_>0)return`${_}h`;let h=Math.floor(z/60);return h>0?`${h}m`:`${Math.floor(z)}s`}function u(c){let x=c.status==="online",g=x?"service-widget-online":"service-widget-offline",r=x?"bx-check-circle":"bx-x-circle",v=x?"OK":"BAD",L=c.version?m(c.version.str):"-",z=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",H=c.memory&&c.memory!=="N/A"?c.memory:"-",_=z!=="-"?"#00ff00":"#666",h=z!=="-"?"#fff":"#666",P=H!=="-"?"#00ff00":"#666",A=H!=="-"?"#fff":"#666",I=n(c.uptime),q="";x?q=`
                ...
                </div>`:q='<div class="service-widget-footer offline"><span>OFFLINE</span></div>';let W=B()?"easter.company":f(c.domain&&c.port?`${c.domain}:${c.port}`:"");return`<div class="service-widget ${g}" data-service-id="${c.id}"><div class="service-widget-header"><i class="bx ${r}"></i><h3>${c.short_name||c.id}</h3><span class="service-widget-status">${v}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${W}</span></div>${q}</div></div>`}let k=new Map(Array.from(t.querySelectorAll(".service-widget")).map(c=>[c.dataset.serviceId,c])),$=new Set(p.map(c=>c.id));for(let[c,x]of k)$.has(c)||x.remove();p.forEach(c=>{let x=u(c),g=k.get(c.id);g?g.outerHTML!==x&&(g.outerHTML=x):t.insertAdjacentHTML("beforeend",x)})}async function qe(){let t=document.getElementById("models-widgets");if(!t)return;let e=await _t();if(!e){t.children.length===0&&(t.innerHTML=N("offline","Failed to load model status.","The event service may be offline."));return}Ct=Date.now(),Z(2,Ct);let a=e.models||[],i=e.whisper;Array.from(t.children).forEach(d=>{d.classList.contains("service-widget")||d.remove()});function s(d){let p=d.status==="Ready";return`
                ...
                </div>`}function l(d){let p=d.status==="Ready";return`
                ...
                </div>`}function o(d){let p=d.status==="Downloaded",y=p?"service-widget-online":"service-widget-offline",m=p?"OK":"MISSING",f=p&&d.size>0?`${(d.size/1e9).toFixed(2)} GB`:"-",n=d.name;return d.type==="custom"&&n.endsWith(":latest")&&(n=n.replace(":latest","")),`<div class="service-widget ${y}" data-model-name="${d.name}"><div class="service-widget-header"><i class="bx ${p?"bx-check-circle":"bx-x-circle"}"></i><h3>${n}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${d.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${f}</span></div></div></div>`}let b="";if(i&&(b+=s(i)),e.xtts&&(b+=l(e.xtts)),b+=a.map(o).join(""),!b){t.innerHTML=N("empty","No models found.");return}t.innerHTML!==b&&(t.innerHTML=b)}async function $e(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),a=document.getElementById("guardian-architect-val"),i=document.getElementById("guardian-idle-val"),s=document.getElementById("guardian-total-idle"),l=document.getElementById("guardian-total-active"),o=document.getElementById("guardian-total-waste"),b=document.getElementById("guardian-reset-btn"),d=document.getElementById("analyzer-reset-btn");b&&!b.dataset.listenerAttached&&(b.onclick=async()=>{b.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await M("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{b.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{b.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),$e()}catch{b.innerHTML="<i class='bx bx-error'></i> Failed"}},b.dataset.listenerAttached="true"),d&&!d.dataset.listenerAttached&&(d.onclick=async()=>{d.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await M("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{d.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{d.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),$e()}catch{d.innerHTML="<i class='bx bx-error'></i> Failed"}},d.dataset.listenerAttached="true");let p=await us();if(p){let $=Math.floor(Date.now()/1e3),c=p.active_tier,x=p.active_synthesis,g=p.protocol_aliases||{sentry:"Sentry",architect:"Architect",synthesis:"Synthesis"},r=h=>{h<0&&(h=0);let P=Math.floor(h/3600),A=Math.floor(h%3600/60),I=h%60;return P>0?`${P}h ${A}m`:A>0?`${A}m ${I}s`:`${I}s`},v=(h,P,A,I,q)=>{if(!h)return;let W=g[I]||I.toUpperCase(),j=h.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(j&&(j.textContent=W),q&&q.includes(I))h.textContent="Working",h.style.color="#bb86fc";else if(A){let w=A.next_run-$;if(w<=0)h.textContent="Ready",h.style.color="#5eff5e";else{let C=Math.floor(w/60),T=w%60;h.textContent=`${C}m ${T}s`,h.style.color="#fff"}}P&&A&&(P.innerHTML=`
        ...
        `)};e&&v(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry",c),a&&v(a,document.getElementById("guardian-architect-stats"),p.architect,"architect",c);let L=document.getElementById("analyzer-synthesis-val"),z=document.getElementById("analyzer-synthesis-stats");L&&v(L,z,p.synthesis,"synthesis",x);let H=document.getElementById("system-state-label"),_=document.getElementById("system-state-val");if(_&&p.system_state){let h=p.system_state,P=r(p.system_state_time||0);H&&(H.textContent=`State: ${h.toUpperCase()}`),_.textContent=P,h==="idle"?_.style.color=p.system_state_time>300?"#5eff5e":"#fff":_.style.color="#bb86fc"}s&&(s.textContent=r(p.total_idle_time||0)),l&&(l.textContent=r(p.total_active_time||0)),o&&(o.textContent=r(p.total_waste_time||0))}else[e,a,i,s,l,o].forEach(c=>{c&&(c.textContent="-",c.style.color="#666")});let y=await ms(),m=[],f=[],n=[];y&&(Array.isArray(y)?m=y:(m=y.active||[],f=y.queue||[],n=y.history||[],n.sort(($,c)=>(c.end_time||0)-($.end_time||0)))),m.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=N("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),Oe(t,m,!1));let u=document.getElementById("processes-queue-widgets");u&&(f.length===0?!u.querySelector(".tab-placeholder")&&!u.querySelector('div[style*="font-style: italic"]')&&(u.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(u.innerHTML="",Oe(u,f,!1)));let k=document.getElementById("processes-history-widgets");k&&(n.length===0?k.querySelector(".tab-placeholder")||(k.innerHTML=N("empty","No recent history.")):(k.querySelector(".tab-placeholder")&&(k.innerHTML=""),Oe(k,n,!0))),he(1,m.length)}function Oe(t,e,a){function i(b){let d="";b.end_time?d=`${b.end_time-b.start_time}s`:d=`${Math.floor(Date.now()/1e3-b.start_time)}s`;let p=b.retries>0?`<span class="process-retry-badge">Retry ${b.retries}</span>`:"",y=b.channel_id,m={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(m[y]?y=m[y]:/^\d+$/.test(y)&&(y=`Channel ${y}`),a)return`
        ...
        </div>`;let f="#fff";return`
                <div class="service-widget process-widget" data-channel-id="${b.channel_id}-${b.start_time}" style="">
                    <div class="service-widget-header">
                        <i class="bx bx-cog" style="color: ${f}"></i>
                        <h3 style="color: ${f}">${y}</h3>
                        ${p}
                    </div>
                    <div class="service-widget-body">
                        <div class="service-widget-info">
                            <span class="info-label">State:</span>
                            <span class="info-value" style="color: ${f}">${b.state}</span>
                        </div>
                        <div class="service-widget-info">
                            <span class="info-label">Duration:</span>
                            <span class="info-value" style="color: ${f}">${d}</span>
                        </div>
                         <div class="service-widget-info">
                            <span class="info-label">PID:</span>
                            <span class="info-value" style="color: ${f}">${b.pid}</span>
                        </div>
                    </div>
                </div>`}let s=a?".process-history-item":".process-widget",l=new Map(Array.from(t.querySelectorAll(s)).map(b=>[b.dataset.channelId,b])),o=new Set(e.map(b=>`${b.channel_id}-${b.start_time}`));for(let[b,d]of l)o.has(b)||d.remove();e.forEach(b=>{let d=`${b.channel_id}-${b.start_time}`,p=i(b),y=l.get(d);if(y){y.outerHTML!==p&&(y.outerHTML=p);let m=t.querySelector(`[data-channel-id="${d}"]`);m&&t.appendChild(m)}else t.insertAdjacentHTML("beforeend",p)})}function Be(){let t=ye(),e={enabled:Notification.permission==="granted",supported:"Notification"in window};return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],gs=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,i]of Object.entries(t)){let s=Dt.filter(l=>l.category===a);s.length!==0&&(e+=`
    ...
    </div>`,e},Fe=!1;function bs(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>It(),document.getElementById("terminal-action-btn").onclick=()=>It());let a=document.getElementById("cli-terminal-body"),i=document.getElementById("cli-docs-pane");a.innerHTML="";let s=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return i.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Fe=!0,a}function It(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Fe=!1}function Bt(t,e,a="output"){if(!Fe)return;let i=document.createElement("div");i.className=`terminal-line terminal-${a}`,a==="prompt"?i.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:i.innerHTML=Le(e),t.appendChild(i),t.scrollTop=t.scrollHeight}async function vs(t){let e=Dt.find(s=>s.id===t);if(!e)return;let a=bs(e);Bt(a,`dex ${t}`,"prompt");let i=e.demo_output||["Executing command...","\u2713 Done."];for(let s of i){await new Promise(o=>setTimeout(o,400+Math.random()*600));let l="output";s.includes("[ERROR]")?l="error":s.includes("[SUCCESS]")||s.includes("\u2713")?l="success":s.includes("!")&&(l="warning"),Bt(a,s,l)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function zt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=gs();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code").textContent;navigator.clipboard.writeText(a).then(()=>{let i=e.querySelector("i");i.className="bx bx-check",i.style.color="#5eff5e",setTimeout(()=>{i.className="bx bx-copy",i.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(a=>{a.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let i=a.dataset.cmd;vs(i)})})}async function xs(){try{if(!(await M("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Ht(){xs(),tt(),Ve();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&zt(),Ze(),Ye();let e=document.getElementById("nav-left-container");e&&e.addEventListener("click",()=>{if(s.length>0)y();else{let r=window.location.pathname;if(!(r==="/"||r==="/index.html")){let z=(r.endsWith("/")&&r.length>1?r.slice(0,-1):r).split("/");z.pop();let H=z.join("/")||"/";window.location.href=H}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",i=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!i&&document.querySelector("footer")?.classList.add("hide");let s=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let o=r=>{localStorage.setItem("dex_last_window",r)};function b(){return 1}function d(){for(;s.length>1;)s.shift().close(!0);let r=document.getElementById("windows-container"),v=document.querySelector("nav"),L=document.querySelector("footer"),z=window.location.pathname==="/"||window.location.pathname==="/index.html",H=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");r&&r.setAttribute("data-count",s.length),s.forEach(A=>{let I=document.getElementById(A.id);I&&I.classList.remove("hide-close")}),Ee(ye());let _=document.getElementById("dexter-menu-container"),h=document.getElementById("nav-window-switcher"),P=document.getElementById("settings-icon");if(Ke(s.length>0),s.length>0){if(L?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),v?.classList.add("window-open"),r&&(r.style.paddingTop="60px"),_&&(_.style.display="none"),P&&(P.style.display="none"),h){let A=s[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(A)?(h.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{o("alerts-window"),p(m)}),document.getElementById("switch-events").addEventListener("click",()=>{o("events-window"),p(f)}),document.getElementById("switch-monitor").addEventListener("click",()=>{o("monitor-window"),p(u)}),document.getElementById("switch-contacts").addEventListener("click",()=>{o("contacts-window"),p(n)}),document.getElementById("switch-workspace").addEventListener("click",()=>{o("workspace-window"),p(k)})):h.innerHTML=""}}else v?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),r&&(r.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),z||H?L?.classList.remove("hide"):L?.classList.add("hide"),_&&(_.style.display="flex"),P&&(P.style.display="block"),h&&(h.innerHTML="");be()}function p(r){if(r.isOpen()){r.close();return}for(;s.length>0;)s.pop().close(!0);s.push(r),r.open(),d()}function y(){[...s].forEach(v=>v.close()),s=[]}window.addEventListener("resize",d);let m=ae({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:lt(),onOpen:()=>ne(),onClose:()=>{let r=s.indexOf(m);r>-1&&s.splice(r,1),d()}}),f=ae({id:"events-window",title:"Events",icon:"bx-calendar-event",content:Pe(),onOpen:()=>{f.setContent(Pe()),ie()},onClose:()=>{let r=s.indexOf(f);r>-1&&s.splice(r,1),d()}}),n=ae({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:vt(),onOpen:()=>Re(),onClose:()=>{let r=s.indexOf(n);r>-1&&s.splice(r,1),d()}}),u=ae({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Tt()},{icon:"bxs-component",title:"Processes",content:St()},{icon:"bxs-brain",title:"Models",content:kt()},{icon:"bxs-hdd",title:"Hardware",content:Lt()},{icon:"bxs-terminal",title:"Logs",content:At()},{icon:"bxs-zap",title:"Agents",content:Et()}].filter(r=>B()?r.title!=="Hardware"&&r.title!=="Logs":!0),onOpen:()=>{Ue(),$e(),qe(),Ce()},onClose:()=>{let r=s.indexOf(u);r>-1&&s.splice(r,1),d()}}),k=ae({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:bt(),onOpen:()=>Ne(),onClose:()=>{let r=s.indexOf(k);r>-1&&s.splice(r,1),d()}}),$=ae({id:"settings-window",title:"Settings",icon:"bx-cog",content:Be(),onOpen:()=>{$.setContent(Be()),je($)},onClose:()=>{let r=s.indexOf($);r>-1&&s.splice(r,1),d()}});window.dexter={viewEvent:r=>{f.isOpen()||p(f),setTimeout(()=>{let v=document.querySelector(`.event-item[data-event-id="${r}"]`);v&&(v.scrollIntoView({behavior:"smooth",block:"center"}),v.classList.add("flash-highlight"),v.classList.contains("expanded")||v.click(),setTimeout(()=>v.classList.remove("flash-highlight"),2e3))},500)},viewAlert:r=>{m.isOpen()||p(m),setTimeout(()=>{let v=document.querySelector(`.event-item[data-alert-id="${r}"]`);v&&(v.scrollIntoView({behavior:"smooth",block:"center"}),v.classList.add("flash-highlight"),v.classList.contains("expanded")||v.click(),setTimeout(()=>v.classList.remove("flash-highlight"),2e3))},500)}};let c=document.getElementById("dexter-dropdown");c&&(c.innerHTML=`
          ...
          <div class="dropdown-item" id="workspace-menu-item"><i class='bx bx-brain'></i> Workspace</div>
      `);let x=document.getElementById("dexter-menu-container"),g=document.getElementById("dexter-menu-btn");x&&c&&g&&(x.addEventListener("mouseenter",()=>{c.classList.add("active"),g.classList.add("active")}),x.addEventListener("mouseleave",()=>{c.classList.remove("active"),g.classList.remove("active")}),g.addEventListener("click",r=>{r.stopPropagation();let v=localStorage.getItem("dex_last_window")||"alerts-window",L=null;v==="alerts-window"?L=m:v==="events-window"?L=f:v==="monitor-window"?L=u:v==="contacts-window"?L=n:v==="workspace-window"&&(L=k),L&&p(L)})),document.getElementById("alerts-menu-item")?.addEventListener("click",()=>{o("alerts-window"),p(m)}),document.getElementById("events-menu-item")?.addEventListener("click",()=>{o("events-window"),p(f)}),document.getElementById("monitor-menu-item")?.addEventListener("click",()=>{o("monitor-window"),p(u)}),document.getElementById("contacts-menu-item")?.addEventListener("click",()=>{o("contacts-window"),p(n)}),document.getElementById("workspace-menu-item")?.addEventListener("click",()=>{o("workspace-window"),p(k)}),document.getElementById("settings-icon")?.addEventListener("click",()=>p($)),document.getElementById("close-all-windows")?.addEventListener("click",()=>y()),B()||setInterval(()=>{f.isOpen()&&ie(),m.isOpen()?ne():He()},1e3),setInterval(()=>{B()&&(m.isOpen()?ne():He()),k.isOpen()?Ne():gt(),B()&&f.isOpen()&&ie(),u.isOpen()&&Mt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ht):Ht();})();
