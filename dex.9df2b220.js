(()=>{function Xe(){if(!document.querySelector(".grid-overlay")){let t=document.createElement("div");t.className="grid-overlay",document.body.appendChild(t)}console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Qe(){let t=window.location.pathname,e=t==="/"||t==="/index.html",n=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var tt=1e3;function ae(t){let e=null,i=t.onClose||null,s=t.onOpen||null;function n(){e&&(e.style.zIndex=++tt)}function c(){if(e){e.classList.add("open"),n(),window.addEventListener("resize",l),s&&setTimeout(s,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++tt,e.addEventListener("mousedown",n);let b=t.icon||"bx-window",a="",g="",$;t.tabs&&t.tabs.length>0?(a=`<div class="tab-bar">${t.tabs.map((r,d)=>{let f=r.icon?`<i class="bx ${r.icon}"></i>`:`<span class="tab-glyph">${r.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${$}
        `,m.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),o()}),window.addEventListener("resize",l),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let u=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(r=>r.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(r=>r.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${u}"]`).classList.add("active"),v(y,e)})}),setTimeout(()=>{e.classList.add("open"),s&&s()},10)}function l(){if(!e||!e.classList.contains("open"))return;let m=e.querySelector(".tab.active");m&&v(m,e)}function v(m,b){setTimeout(()=>{let a=b.querySelector(".tab-bar");if(!a)return;let g=Array.from(a.querySelectorAll(".tab")),$=g.indexOf(m),y=a.clientWidth,u=g[Math.max(0,$-2)],r=g[Math.min(g.length-1,$+2)],d=u.offsetLeft-a.offsetLeft-25,h=r.offsetLeft+r.offsetWidth-a.offsetLeft+25-d,A=h<=y?d-(y-h)/2:m.offsetLeft-a.offsetLeft-y/2+m.offsetWidth/2;a.scrollTo({left:A,behavior:"smooth"})},350)}function o(m=!1){e&&(window.removeEventListener("resize",l),m?(e.remove(),e=null):(e.classList.remove("open"),i&&i(),setTimeout(()=>{e?.remove(),e=null},400)))}function p(m){let b=e?.querySelector(".window-content");b&&(b.innerHTML=m)}function x(){return e&&e.classList.contains("open")}return{open:c,close:o,setContent:p,isOpen:x,focus:n,id:t.id}}var st="easter_theme",Y={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function He(){return localStorage.getItem(st)||Y.DARK}function it(t){if(!Object.values(Y).includes(t))throw new Error("Invalid theme");localStorage.setItem(st,t),nt(t)}function nt(t){let e=document.documentElement,i=document.body;Object.values(Y).forEach(l=>{i.classList.remove(`theme-${l}`)}),i.classList.add(`theme-${t}`);let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.getElementsByTagName("head")[0].appendChild(s));let n={[Y.DARK]:"#050507",[Y.LIGHT]:"#FFFFFF",[Y.LEGACY]:"#000000"},c=n[t]||n[Y.DARK];if(s.setAttribute("content",c),!document.querySelector(".background")){let l=document.createElement("div");l.className="background",document.body.prepend(l)}i.classList.add("is-animated")}function at(){let t=He();nt(t)}function H(t,e,i=null){let n={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",c=i?`<p class="placeholder-action">${i}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${n} placeholder-icon'></i><p class="placeholder-message">${e}</p>${c}</div>`}function R(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function X(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!i)return;if(!e){i.textContent="Last updated: never";return}let s=Date.now(),n=Math.floor((s-e)/1e3),c;n<60?c=`${n}s ago`:n<3600?c=`${Math.floor(n/60)}m ago`:c=`${Math.floor(n/3600)}h ago`,i.textContent=`Last updated: ${c}`}var Vt=0;function we(t,e){let i=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!i)return;let s=i.querySelector(".notification-badge");s&&(e>0?(s.textContent=e>9?"9+":e,s.style.display="flex"):s.style.display="none")}var ee=0,te=0;function rt(t){ee=t,ve()}function lt(t){te=t,ve()}function ve(){let t=ee+te;Vt=t;let e=document.getElementById("dexter-nav-badge");e&&(e.style.display=t>0?"flex":"none");let i=document.getElementById("alerts-menu-item");if(i){let l=i.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",i.appendChild(l)),l.textContent=ee>9?"9+":ee,l.style.display=ee>0?"flex":"none"}let s=document.getElementById("workspace-menu-item");if(s){let l=s.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="auto",s.appendChild(l)),l.textContent=te>9?"9+":te,l.style.display=te>0?"flex":"none"}let n=document.getElementById("switch-alerts");if(n){let l=n.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",n.appendChild(l)),l.textContent=ee>9?"9+":ee,l.style.display=ee>0?"flex":"none"}let c=document.getElementById("switch-workspace");if(c){let l=c.querySelector(".notification-badge");l||(l=document.createElement("span"),l.className="notification-badge",l.style.marginLeft="8px",c.appendChild(l)),l.textContent=te>9?"9+":te,l.style.display=te>0?"flex":"none"}}function Te(){let t=document.getElementById("alerts-list");if(!t)return;ee=t.querySelectorAll(".alert-unread:not(.priority-low)").length,ve()}function ct(){let t=document.getElementById("blueprints-list");if(!t)return;te=t.querySelectorAll(".event-item:not(.blueprint-approved)").length,ve()}function Kt(){return"https://event.easter.company"}function Zt(){return"https://discord.easter.company"}var Yt="http://127.0.0.1:8100",Xt="http://127.0.0.1:8300",Qt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function Le(t){let e=R(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(n,c)=>{let l=Qt[c];return l?`<span class="${l}">`:""});let i=(e.match(/<span/g)||[]).length,s=(e.match(/<\/span/g)||[]).length;return i>s&&(e+="</span>".repeat(i-s)),e}function oe(t){if(!t)return"";let e=R(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^\|(.+)\|$/gm,(i,s)=>{let n=s.split("|").map(c=>c.trim());return n.every(c=>c.match(/^:?-+:?$/))?"":`<div class="md-table-row">${n.map(c=>`<span class="md-table-cell">${c}</span>`).join("")}</div>`}),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var es="https://sterling-javelin-12539.upstash.io",ts="AjD7AAIgcDLTsB2z5ZUJmdu6PPARA5_w2VGIiEdO34oEKjK3VKsuiw";function z(){return window.location.hostname==="easter.company"}var O=null,Pe=!1,dt="dex_dashboard_snapshot";function ss(){let t=localStorage.getItem(dt);if(t)try{O=JSON.parse(t)}catch{O=null}}async function ot(){if(!(!z()||Pe)){Pe=!0;try{let t=await as("GET","state:dashboard:full");if(t)try{let e=JSON.parse(t);O=e,localStorage.setItem(dt,JSON.stringify(e))}catch(e){console.error("Failed to parse dashboard snapshot:",e)}}finally{Pe=!1}}}function is(){if(!O||!O.agent_status)return;let t=O.agent_status;typeof t.system_state_time=="number"&&(t.system_state_time+=1)}async function ns(){if(!z())return;ss();let t=Math.floor(Date.now()/1e3),e=O?t-O.timestamp:1/0;(!O||e>120)&&await ot(),setInterval(()=>{let i=new Date,s=Math.floor(Date.now()/1e3),n=O?s-O.timestamp:1/0;(i.getSeconds()===59||n>300)&&ot(),is()},1e3)}z()&&ns();async function as(t,...e){try{let s=await(await fetch(es,{method:"POST",headers:{Authorization:`Bearer ${ts}`},body:JSON.stringify([t,...e])})).json();if(s.error)throw new Error(s.error);return s.result}catch(i){return console.error("Upstash Error:",i),null}}var ge=null,be=null,Se=!1,ke=!1;async function I(t,e={}){if(z()){if(!O)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t.startsWith("/system_monitor")||t.startsWith("/system/status"))return new Response(JSON.stringify(O.monitor),{status:200});if(t.startsWith("/processes"))return new Response(JSON.stringify(O.processes),{status:200});if(t.startsWith("/events")){let n=new URLSearchParams(t.split("?")[1]||""),c=n.get("type")||n.get("event.type"),l=n.get("category"),v=n.get("order")||"desc",o=[];return c==="system.notification.generated"?o=[...O.alerts||[]]:c==="system.blueprint.generated"||t.includes("event.type=system.blueprint.generated")?o=[...O.blueprints||[]]:l==="messaging"?o=[...O.messaging_events||[]]:l==="system"?o=[...O.system_events||[]]:l==="cognitive"?o=[...O.cognitive_events||[]]:l==="moderation"?o=[...O.moderation_events||[]]:o=[...O.events||[]],v==="asc"?o.sort((p,x)=>p.timestamp-x.timestamp):o.sort((p,x)=>x.timestamp-p.timestamp),new Response(JSON.stringify({events:o,count:o.length}),{status:200})}if(t.startsWith("/logs"))return new Response(JSON.stringify([]),{status:200});if(t.startsWith("/system/hardware"))return new Response(JSON.stringify({}),{status:200});if(t.startsWith("/agent/status")||t.startsWith("/guardian/status"))return new Response(JSON.stringify(O.agent_status||{}),{status:200});if(t.startsWith("/profile/")){let n=t.split("/")[2],c=O.profiles?O.profiles[n]:null;return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Profile not found"}),{status:404})}return new Response(JSON.stringify({error:"Not available in public demo"}),{status:404})}if(ge)try{let n=await fetch(ge+t,e);if(n.ok)return n;ge=null}catch{ge=null}let i=Kt(),s=Yt;try{let n=await fetch(i+t,e);if(n.ok)return ge=i,Se&&(console.log("\u2728 Production event service restored."),Se=!1),n;throw new Error("Primary failed")}catch{Se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${s}`),Se=!0);try{let c=await fetch(s+t,e);if(c.ok)return ge=s,c;throw new Error("Fallback failed")}catch(c){throw c}}}async function Me(t,e={}){if(z()){if(!O)return new Response(JSON.stringify({error:"Initializing dashboard cache..."}),{status:503});if(t==="/contacts")return new Response(JSON.stringify(O.contacts||{members:[]}),{status:200});if(t.startsWith("/member/")){let n=t.split("/")[2],c=(O.contacts?.members||[]).find(l=>l.id===n);return c?new Response(JSON.stringify(c),{status:200}):new Response(JSON.stringify({error:"Member not found"}),{status:404})}return new Response(JSON.stringify({error:"Discord API not public"}),{status:404})}if(be)try{let n=await fetch(be+t,e);if(n.ok)return n;be=null}catch{be=null}let i=Zt(),s=Xt;try{let n=await fetch(i+t,e);if(n.ok)return be=i,ke&&(console.log("\u2728 Production discord service restored."),ke=!1),n;throw new Error("Primary failed")}catch{ke||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${s}`),ke=!0);try{let c=await fetch(s+t,e);if(c.ok)return be=s,c;throw new Error("Fallback failed")}catch(c){throw c}}}var pt=()=>`
...
`,Ae=null,re=new Set,Ie=[];async function ie(t=!1){let e=document.getElementById("alerts-list");if(!e)return;os(),t&&(e.innerHTML="<p>Updating...</p>");let i="/events?ml=1000&format=json&event.type=system.notification.generated";try{let s=await I(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let c=(await s.json()).events||[];Ae=Date.now(),X(0,Ae);let l=Date.now(),v=24*60*60*1e3,o=c.filter(d=>{let f=localStorage.getItem(`alert_read_ts_${d.id}`);if(!f)return!0;let h=parseInt(f);return l-h<v});o.sort((d,f)=>{let h=k=>{let E=k.event;if(typeof E=="string")try{E=JSON.parse(E)}catch{return"low"}return(E.priority||"low").toLowerCase()},A=k=>k==="critical"?4:k==="high"?3:k==="medium"?2:1,_=A(h(d)),S=A(h(f));return _!==S?S-_:f.timestamp-d.timestamp}),Ie=o;let p=d=>{let f=d.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return"low"}return(f.priority||"low").toLowerCase()},x=[],b=new Set(o.map(d=>p(d))).size>1;if(o.length>0){let d=null;o.forEach(f=>{let h=p(f);b&&h!==d&&(x.push({id:`divider-${h}`,type:"divider",label:h.toUpperCase()}),d=h),x.push(f)})}if(t&&(e.innerHTML=""),o.length===0){e.innerHTML=H("empty","No alerts yet."),Te();return}let a=d=>{let f=d.event;if(typeof f=="string")try{f=JSON.parse(f)}catch{return null}let h=(f.title||"Untitled Alert").trim(),A=(f.body||"No description provided.").trim(),_=f.summary||"",S=f.content||"",k=f.protocol||"",E=(f.priority||"low").toLowerCase(),B=!!f.alert,M=(f.category||"system").trim(),N=f.related_event_ids||[],U=f.audit_event_id,F=!!localStorage.getItem(`alert_read_ts_${d.id}`),T=new Date(d.timestamp*1e3),C=T.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),w=T.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),L=F?"event-border-grey":"event-border-blue";!F&&B&&(L="event-border-red"),F&&(E==="high"||E==="critical")?L="event-border-red":F&&E==="medium"&&(L="event-border-orange");let P=F?"alert-read":"alert-unread",D=re.has(d.id),j=D?"expanded":"",J=D?"display: block;":"display: none;",G="",W="";N.length>0&&(W=`
        ...
        `,G=`
            ...
            `;let Z=document.createElement("div");Z.className=`event-item notification-item ${L} ${P} ${j} cursor-pointer priority-${E}`,Z.dataset.alertId=d.id,Z.onclick=function(se){if(this.classList.contains("expanded")){this.classList.remove("expanded"),re.delete(d.id);let he=this.querySelector(".event-details");he&&(he.style.display="none")}else{this.classList.add("expanded"),re.add(d.id);let he=this.querySelector(".event-details");if(he&&(he.style.display="block"),!localStorage.getItem(`alert_read_ts_${d.id}`)){localStorage.setItem(`alert_read_ts_${d.id}`,Date.now().toString()),this.classList.add("alert-read"),this.classList.remove("alert-unread"),this.classList.remove("event-border-blue","event-border-red","event-border-purple");let Ne="event-border-grey";E==="high"||E==="critical"?Ne="event-border-red":E==="medium"&&(Ne="event-border-orange"),this.classList.add(Ne),Te()}}};let Ke=`${k?k.toUpperCase():"GUARDIAN"} ALERT: ${_||h}`,Gt={system:"bx-cog",messaging:"bx-message-detail",cognitive:"bx-brain",moderation:"bx-shield-x",lifecycle:"bx-git-branch"}[M]||"bx-bell",Wt=E==="high"||E==="critical"?"#ff4d4d":E==="medium"?"#ffa500":"#888";Z.innerHTML=`
                ...
                <div class="event-content" style="text-align: left;">
                    <div class="event-service">
                        DEXTER <span class="alert-badge" style="color: ${Wt}; font-size: 0.8em; margin-left: 5px;">[${E.toUpperCase()}]</span>
                    </div>
            ...
            `;let Ze=Z.querySelector(".event-details");Ze&&Ze.addEventListener("click",se=>{se.stopPropagation()});let Ye=Z.querySelector(".close-details-btn");return Ye&&Ye.addEventListener("click",se=>{se.stopPropagation(),Z.classList.remove("expanded");let ze=Z.querySelector(".event-details");ze&&(ze.style.display="none"),re.delete(d.id)}),Z},g=d=>{let f=document.createElement("div");f.className="notification-divider",f.dataset.alertId=d.id;let h="#888888";return d.label==="CRITICAL"?h="#ff4d4d":d.label==="HIGH"?h="#ff8888":d.label==="MEDIUM"&&(h="#ffa500"),f.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${h}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,f.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${h}44, transparent); flex-grow: 1;"></div>`,f},$=Array.from(e.children),y=new Map($.map(d=>[d.dataset.alertId,d])),u=new Set(x.map(d=>d.id));$.forEach(d=>{let f=d.dataset.alertId;(!f||!u.has(f))&&d.remove()});let r=null;x.forEach((d,f)=>{let h=y.get(d.id);(!h||t)&&(h&&h.remove(),d.type==="divider"?h=g(d):h=a(d),!h)||(f===0?e.firstElementChild!==h&&e.prepend(h):r&&r.nextElementSibling!==h&&r.after(h),r=h)}),Ae=Date.now(),X(0,Ae),Te()}catch(s){console.error("Error fetching alerts:",s),e.children.length===0&&(e.innerHTML=H("offline","Failed to load alerts.","The event service may be offline."))}}function os(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),i=document.getElementById("alerts-close-all"),s=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{Ie.forEach(n=>{localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ie(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{Ie.forEach(n=>{re.add(n.id),localStorage.getItem(`alert_read_ts_${n.id}`)||localStorage.setItem(`alert_read_ts_${n.id}`,Date.now().toString())}),ie(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{re.clear(),ie(!0)},i.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=async()=>{if(confirm("Are you sure you want to delete all alerts from the backend?")){s.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.notification.generated",{method:"DELETE"});let n=Date.now()-48*60*60*1e3;Ie.forEach(c=>{localStorage.setItem(`alert_read_ts_${c.id}`,n.toString())}),re.clear(),ie(!0)}catch(n){console.error("Failed to clear alerts:",n)}finally{s.innerHTML="<i class='bx bx-trash'></i> Clear"}}},s.dataset.listenerAttached="true")}async function Re(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(c=>{let l=c.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}if((l.priority||"low").toLowerCase()==="low")return;localStorage.getItem(`alert_read_ts_${c.id}`)||n++}),rt(n)}catch{}}var mt=()=>`
...
`,le=new Set,Be=[],xe=null;async function ce(t=!1){let e=document.getElementById("roadmap-list");if(e){rs();try{let i=await I("/roadmap");if(!i.ok)throw new Error("Offline");let s=await i.json();Be=s;let n=p=>{let x=le.has(p.id),m=p.state==="published",b=p.state==="consumed",a="event-border-grey";m&&(a="event-border-blue"),b&&(a="event-border-purple");let $=new Date(p.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),y=document.createElement("div");y.className=`event-item notification-item ${a} cursor-pointer ${x?"expanded":""}`,y.dataset.itemId=p.id,y.onclick=d=>{if(d.target.closest("button"))return;y.classList.contains("expanded")?(y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(p.id)):(y.classList.add("expanded"),y.querySelector(".event-details").style.display="block",le.add(p.id))};let u=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${p.state.toUpperCase()}]</span>`;y.innerHTML=`
        <div class="event-time">
        ...
        <div class="event-content">
          ...
          <div class="event-message" style="white-space: pre-wrap;">${R(p.content)}</div>
      ...
      `;let r=y.querySelector(".event-details");return r&&r.addEventListener("click",d=>{d.stopPropagation()}),y.querySelector(".edit-btn")?.addEventListener("click",()=>ls(p)),y.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>cs(p)),y.querySelector(".delete-btn")?.addEventListener("click",()=>ds(p.id)),y.querySelector(".close-details-btn")?.addEventListener("click",d=>{d.stopPropagation(),y.classList.remove("expanded"),y.querySelector(".event-details").style.display="none",le.delete(p.id)}),y},c=Array.from(e.children),l=new Map(c.map(p=>[p.dataset.itemId,p])),v=new Set(s.map(p=>p.id));if(c.forEach(p=>{let x=p.dataset.itemId;(!x||!v.has(x))&&p.remove()}),!Be||Be.length===0){e.innerHTML=H("empty","Your roadmap is empty.",z()?"Dexter is currently idle.":`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let o=null;s.forEach((p,x)=>{let m=l.get(p.id);(!m||t)&&(m&&m.remove(),m=n(p),!m)||(x===0?e.firstElementChild!==m&&e.prepend(m):o&&o.nextElementSibling!==m&&o.after(m),o=m)})}catch{e.children.length===0&&(e.innerHTML=H("offline","Failed to load roadmap.","The event service may be offline."))}}}function rs(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),i=document.getElementById("roadmap-cancel"),s=document.getElementById("roadmap-expand-all"),n=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{xe=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",xe=null},i.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let c=document.getElementById("roadmap-editor-input").value;if(!c.trim())return;let l=xe?`/roadmap/${xe}`:"/roadmap",v=xe?"PATCH":"POST";try{await I(l,{method:v,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:c})}),document.getElementById("roadmap-editor-container").style.display="none",ce(!0)}catch(o){console.error(o)}},e.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{Be.forEach(c=>le.add(c.id)),ce(!0)},s.dataset.listenerAttached="true"),n&&!n.dataset.listenerAttached&&(n.onclick=()=>{le.clear(),ce(!0)},n.dataset.listenerAttached="true")}function ls(t){xe=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function cs(t){let e=t.state==="published"?"draft":"published";try{await I(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),ce(!0)}catch(i){console.error(i)}}async function ds(t){if(confirm("Delete this roadmap item?"))try{await I(`/roadmap/${t}`,{method:"DELETE"}),le.delete(t),ce(!0)}catch(e){console.error(e)}}var gt=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`,ft=null,de=new Set,vt=[];async function pe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;ps();let i="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let s=await I(i);if(!s.ok)throw new Error("Service is offline or unreachable.");let c=(await s.json()).events||[];if(vt=c,ft=Date.now(),X(2,ft),c.length===0){e.innerHTML=H("empty","No architectural blueprints generated yet.","The Guardian will generate these when idle."),we(2,0);return}t&&(e.innerHTML="");let l=m=>{let b=m.event;if(typeof b=="string")try{b=JSON.parse(b)}catch{return null}let a=(b.title||"Untitled Blueprint").trim(),g=(b.summary||b.body||"No summary provided.").trim(),$=(b.content||"").trim(),y=(b.category||"architecture").trim(),u=(b.related_services||b.affected_services||[]).map(D=>D.trim()),r=(b.implementation_path||[]).map(D=>D.trim()),d=b.source_event_ids||[],f=b.approved===!0,h=new Date(m.timestamp*1e3),A=h.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),_=h.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),S=de.has(m.id),k=S?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${S?"expanded":""} ${f?"blueprint-approved":""}`,E.dataset.blueprintId=m.id,f&&(E.style.boxShadow="0 0 20px rgba(3, 218, 198, 0.15)",E.style.background="linear-gradient(135deg, rgba(3, 218, 198, 0.05) 0%, rgba(187, 134, 252, 0.05) 100%)");let M=f?"bx-check-shield":{architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[y]||"bx-paint";E.onclick=function(D){if(this.classList.contains("expanded")){this.classList.remove("expanded"),de.delete(m.id);let J=this.querySelector(".event-details");J&&(J.style.display="none")}else{this.classList.add("expanded"),de.add(m.id);let J=this.querySelector(".event-details");J&&(J.style.display="block")}};let N="";r.length>0&&(N=`
                    <div class="blueprint-path" style="margin-top: 15px;">
                        ...
                        <div class="detail-pre"><ul style="margin: 0; padding-left: 20px;">${r.map(D=>`<li style="margin-bottom: 5px;">${R(D)}</li>`).join("")}</ul></div>
                    </div>
                `);let U="";d.length>0&&(U=`
                ...
                `);let q=u.length>0?`<div style="display: flex; align-items: center; gap: 8px; color: #666; font-size: 0.75em;"><span style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Related:</span> <span style="background: rgba(255,255,255,0.05); padding: 2px 8px; border-radius: 4px;">${u.join(", ")}</span></div>`:"<div></div>",F=z(),T=f?`
            ...
            `;E.innerHTML=`
                ...
                <div class="event-icon" style="${f?"color: #03dac6;":""}"><i class='bx ${M}'></i></div>
                <div class="event-content">
            ...
            `;let C=E.querySelector(".blueprint-approve-btn");C&&(C.onclick=async D=>{D.stopPropagation(),C.innerHTML="<i class='bx bx-loader-alt spin'></i> Approving...";try{(await I(`/events/${m.id}`,{method:"PATCH",body:JSON.stringify({approved:!0})})).ok&&pe(!0)}catch(j){console.error("Failed to approve blueprint:",j)}});let w=E.querySelector(".blueprint-delete-btn");w&&(w.onclick=async D=>{D.stopPropagation();let j=!f;w.innerHTML=j?"<i class='bx bx-loader-alt spin'></i> Declining...":"<i class='bx bx-loader-alt spin'></i> Deleting...";try{(await I(`/events/${m.id}`,{method:"DELETE"})).ok&&pe(!0)}catch(J){console.error("Failed to delete blueprint:",J)}});let L=E.querySelector(".event-details");L&&L.addEventListener("click",D=>{D.stopPropagation()});let P=E.querySelector(".close-details-btn");return P&&P.addEventListener("click",D=>{D.stopPropagation(),E.classList.remove("expanded");let j=E.querySelector(".event-details");j&&(j.style.display="none"),de.delete(m.id)}),E},v=Array.from(e.children),o=new Map(v.map(m=>[m.dataset.blueprintId,m])),p=new Set(c.map(m=>m.id));v.forEach(m=>{let b=m.dataset.blueprintId;(!b||!p.has(b))&&m.remove()});let x=null;c.forEach((m,b)=>{let a=o.get(m.id);(!a||t)&&(a&&a.remove(),a=l(m),!a)||(b===0?e.firstElementChild!==a&&e.prepend(a):x&&x.nextElementSibling!==a&&x.after(a),x=a)}),we(2,c.length),ct()}catch(s){console.error("Error fetching blueprints:",s),e.children.length===0&&(e.innerHTML=H("offline","Failed to load blueprints.","The event service may be offline."))}}async function xt(){let t="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let e=await I(t);if(!e.ok)return;let s=(await e.json()).events||[],n=0;s.forEach(c=>{let l=c.event;if(typeof l=="string")try{l=JSON.parse(l)}catch{l={}}l.approved!==!0&&n++}),lt(n)}catch{}}function ps(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all"),i=document.getElementById("blueprints-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{vt.forEach(s=>de.add(s.id)),pe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{de.clear(),pe(!0)},e.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=async()=>{if(confirm("Are you sure you want to delete all UNAPPROVED blueprints?")){i.innerHTML="<i class='bx bx-loader-alt spin'></i> Clearing...";try{await I("/events?type=system.blueprint.generated",{method:"DELETE"}),de.clear(),pe(!0)}catch(s){console.error("Failed to clear blueprints:",s)}finally{i.innerHTML="<i class='bx bx-trash'></i> Clear"}}},i.dataset.listenerAttached="true")}var yt=()=>`
                ...
                <div class="service-widget" style="border-left: 3px solid ${m}; width: 100%;">
                    ...
                    <div class="service-widget-body">
                        ...
                        <div class="service-widget-info" style="grid-column: span 2; margin-top: 5px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 5px;">
                            ...
                            <span class="info-value" style="font-size: 0.8em; opacity: 0.8; word-break: break-all;">${o.execution_plan.entry_url||"Auto-detected"}</span>
                        </div>
                    </div>
                </div>
            `}).join("");t.innerHTML=v,t.querySelectorAll(".delete-chore-btn").forEach(o=>{o.onclick=async p=>{p.stopPropagation(),confirm("Delete this chore?")&&(await I(`/chores/${o.dataset.id}`,{method:"DELETE"}),ye())}})}catch(c){console.error("Failed to fetch chores",c)}}var ms=`
    .profile-overlay {
        position: fixed;
        top: 0;
        left: 0;
    ...
    `,p=`
        <div class="profile-card">
            ...
            <div class="profile-body">
                ...
                <div id="tab-raw" class="tab-content">${o()}</div>
            </div>
...
`,us=null;async function je(){let t=document.getElementById("contacts-list");if(!t)return;let e=document.getElementById("contacts-refresh");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await je(),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),t.dataset.listenerAttached||(t.onclick=i=>{let s=i.target.closest(".user-profile-card");if(s)try{let n=JSON.parse(s.dataset.user);Ct(n)}catch(n){console.error("Failed to parse user data",n)}},t.dataset.listenerAttached="true");try{let i=await Me("/contacts");if(!i.ok)throw new Error("Service unreachable");let n=(await i.json()).members||[];if(us=Date.now(),n.length===0){t.innerHTML=H("empty","No contacts found.","Check your Discord connection.");return}let c={Me:0,Master:1,Admin:2,Moderator:3,Contributor:4,User:5};n.sort((l,v)=>{let o=c[l.level]??10,p=c[v.level]??10;return o!==p?o-p:l.username.localeCompare(v.username)}),t.innerHTML=n.map(l=>{let v=l.color?"#"+l.color.toString(16).padStart(6,"0"):"rgba(255,255,255,0.1)",o=l.status==="online"?"#5eff5e":l.status==="idle"?"#ffa500":l.status==="dnd"?"#ff4d4d":"#666",p="#888";l.level==="Me"||l.level==="Master"?p="#bb86fc":l.level==="Admin"?p="#cf6679":l.level==="Moderator"?p="#03dac6":l.level==="Contributor"&&(p="#ffa500");let x=l.level==="Me",m=x?"rgba(187, 134, 252, 0.08)":"rgba(255,255,255,0.03)",b=x?"2px solid #bb86fc":`1px solid ${v}33`;return`
                <div class="user-profile-card" 
                    ...
                    <div style="position: relative;">
                        ...
                        <div style="position: absolute; bottom: 0; right: 0; width: 12px; height: 12px; background: ${o}; border: 2px solid #1a1a1a; border-radius: 50%;"></div>
                    </div>
...
`,_e=null,me=new Set,Ce=[],K="all",gs={messaging:["message_received","messaging.user.sent_message","messaging.bot.sent_message","messaging.user.transcribed","voice_transcribed","bot_response","messaging.user.joined_voice","messaging.user.left_voice","messaging.bot.joined_voice","messaging.bot.voice_response","messaging.user.speaking.started","messaging.user.speaking.stopped","messaging.webhook.message"],system:["system.cli.command","system.cli.status","system.status.change","metric_recorded","log_entry","error_occurred","webhook.processed","messaging.bot.status_update","messaging.user.joined_server","system.test.completed","system.build.completed","system.roadmap.created","system.roadmap.updated","system.process.registered","system.process.unregistered"],cognitive:["engagement.decision","system.analysis.audit","system.blueprint.generated","analysis.link.completed","analysis.visual.completed","analysis.router.decision","analysis.user.message_signals"],moderation:["moderation.explicit_content.deleted"]},bs={message_received:"bx-message-detail","messaging.user.sent_message":"bx-message-rounded-dots","messaging.bot.sent_message":"bx-bot","messaging.user.transcribed":"bx-microphone",voice_transcribed:"bx-microphone","messaging.user.joined_voice":"bx-phone-incoming","messaging.user.left_voice":"bx-phone-outgoing","messaging.webhook.message":"bx-cloud-lightning","system.cli.command":"bx-terminal","system.cli.status":"bx-info-circle","system.test.completed":"bx-check-shield","system.build.completed":"bx-package","system.roadmap.created":"bx-map-pin","system.roadmap.updated":"bx-map-alt","system.process.registered":"bx-play-circle","system.process.unregistered":"bx-stop-circle",error_occurred:"bx-error-alt","engagement.decision":"bx-brain","system.analysis.audit":"bx-search-alt","system.blueprint.generated":"bx-paint","analysis.link.completed":"bx-link","analysis.visual.completed":"bx-image","analysis.router.decision":"bx-git-branch","analysis.user.message_signals":"bx-pulse","moderation.explicit_content.deleted":"bx-shield-x","system.status.change":"bx-refresh",metric_recorded:"bx-line-chart"};function vs(t){for(let[e,i]of Object.entries(gs))if(i.includes(t))return e;return"system"}function xs(t){return bs[t]||"bx-square-rounded"}async function ne(t=!1){let e=document.getElementById("events-timeline");if(!e)return;ys();let s=`/events?ml=${K==="all"?100:250}&format=json`;K!=="all"&&(s+=`&category=${K}`);try{let n=await I(s);if(!n.ok)throw new Error("Service unreachable");if(Ce=((await n.json()).events||[]).filter(b=>{let a=b.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return!0}let g=a.type;return!(g==="system.blueprint.generated"||g==="system.notification.generated")}),_e=Date.now(),X(1,_e),Ce.length===0){e.innerHTML=H("empty","No events found for this filter.");return}t&&(e.innerHTML="");let v=b=>{let a=b.event;if(typeof a=="string")try{a=JSON.parse(a)}catch{return null}let g=a.type,$=vs(g),y=xs(g),u=g==="engagement.decision"||g==="messaging.bot.sent_message"||g==="messaging.user.sent_message"||g==="moderation.explicit_content.deleted"||g==="analysis.link.completed"||g==="analysis.visual.completed"||g==="analysis.router.decision"||g==="analysis.user.message_signals"||g==="system.cli.command"||g==="system.analysis.audit"||g==="system.test.completed"||g==="error_occurred"||g==="system.cli.status"||g==="system.attention.expired"||g.startsWith("system.roadmap")||g.startsWith("system.process"),r="event-border-grey";u&&(g==="moderation.explicit_content.deleted"||g==="error_occurred"?r="event-border-red":g==="analysis.link.completed"||g==="analysis.visual.completed"||g==="analysis.router.decision"||g==="system.analysis.audit"||g==="analysis.user.message_signals"?r="event-border-purple":g==="system.attention.expired"||g==="system.cli.command"||g==="system.cli.status"?r="event-border-orange":g==="system.test.completed"?r=a.test?.status==="OK"&&a.lint?.status==="OK"&&a.format?.status==="OK"?"event-border-blue":"event-border-red":r="event-border-blue");let d=u?"cursor-pointer":"",f=me.has(b.id),h=f?"expanded":"",A=f?"display: block;":"display: none;",_=new Date(b.timestamp*1e3),S=_.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),k=_.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=Et(g,a),B=a.user_level?`<span style="font-size: 0.8em; opacity: 0.6; margin-left: 5px;">(${a.user_level})</span>`:"",M="";if(u){let T="";if(g==="engagement.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                    ...
                    `}else if(g==="system.attention.expired"){let C=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,w=a.timestamp-a.last_active,L=Math.floor(w/60);T=`
                    ...
                    `}else if(g==="messaging.bot.sent_message"){let C=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,w="";a.eval_count&&(w=`
                        ...
                        `);let L="";if(a.chat_history&&a.chat_history.length>0){let P=a.chat_history.length,D=a.chat_history.map((j,J)=>{let G=j.name?j.name.toUpperCase():j.role.toUpperCase();!j.name&&G==="ASSISTANT"&&(G="DEXTER");let W=j.role==="user"?"#03dac6":j.role==="system"?"#ffb74d":"#bb86fc",V=J===P-1?"block":"none";return`
                                <div class="history-slide" data-index="${J}" style="display: ${V};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span style="font-size: 0.7em; color: ${W}; letter-spacing: 1px; font-weight: bold;">${G}</span>
                        ...
                        `}
                    `}else if(g==="analysis.user.message_signals"){let C=P=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${P}</h5>`,w=a.signals||{};T=`
                        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 4px; border: 1px solid rgba(255,255,255,0.05); justify-content: space-between; align-items: center;">
                            <div style="flex: 1; min-width: 100px; text-align: center;">
                    ...
                    `}else if(g==="moderation.explicit_content.deleted"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="analysis.link.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="analysis.visual.completed"){let C=L=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${L}</h5>`,w="";a.base64_preview?w=`<div class="event-detail-block"><img src="data:image/jpeg;base64,${a.base64_preview}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`:a.url&&(w=`<div class="event-detail-block"><img src="${a.url}" class="event-image-preview" style="max-width: 100%; border-radius: 4px; margin-top: 10px;"></div>`),T=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(g==="analysis.router.decision"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="system.cli.command"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="system.analysis.audit"){let C=a.success?"#03dac6":"#ff4d4d",w=a.success?"SUCCESS":"FAILED",L=G=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${G}</h5>`,P="";a.error&&(P=`
                            <div class="event-detail-block">
                                ${L("Error")}
                                <pre class="detail-pre" style="color: #ff4d4d; border-color: rgba(255, 77, 77, 0.2);">${R(a.error)}</pre>
                            </div>
                        `);let D="";if(a.chat_history&&a.chat_history.length>0){let G=a.chat_history.length,W=a.chat_history.map((V,ue)=>{let Q=V.name?V.name.toUpperCase():V.role.toUpperCase();!V.name&&Q==="USER"&&(Q="SYSTEM"),!V.name&&Q==="ASSISTANT"&&(Q="AGENT");let Z=V.role==="user"?"#03dac6":V.role==="system"?"#ffb74d":"#bb86fc";return`
                                <div class="history-slide" data-index="${ue}" style="display: ${ue===0?"block":"none"};">
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        ...
                                        <span style="font-size: 0.7em; color: #666;">Turn ${ue+1} of ${G}</span>
                                    </div>
                            ...
                            <div class="event-detail-block">
                                ...
                                <div class="history-carousel" style="position: relative; background: rgba(255,255,255,0.03); border-radius: 4px; padding: 15px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        ...
                                        <button class="carousel-btn next-btn" style="background: rgba(255,255,255,0.1); border: none; color: #fff; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 0.8em; transition: background 0.2s;" ${G<=1?"disabled":""}>Next <i class='bx bx-chevron-right'></i></button>
                                    </div>
                                </div>
                            </div>
                        `}let j="";if(a.corrections&&a.corrections.length>0){let G=a.corrections.map((W,V)=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(255, 77, 77, 0.1); border-left: 2px solid #ff4d4d; font-size: 0.85em;">
                                <div style="color: #ff4d4d; font-weight: bold; margin-bottom: 4px;">[${W.type}] ${W.guidance}</div>
                                ${W.snippet?`<div style="font-family: monospace; color: #aaa; background: rgba(0,0,0,0.3); padding: 4px;">${R(W.snippet)}</div>`:""}
                            </div>
                        `).join("");j=`
                            <div class="event-detail-block">
                        ...
                        `}let J="";if(a.parsed_results&&a.parsed_results.length>0){let G=a.parsed_results.map(W=>`
                            <div style="margin-bottom: 8px; padding: 8px; background: rgba(3, 218, 198, 0.1); border-left: 2px solid #03dac6; font-size: 0.85em;">
                                <div style="color: #03dac6; font-weight: bold; margin-bottom: 4px;">${R(W.title)}</div>
                                <div style="color: #ddd;">${R(W.summary)}</div>
                            </div>
                        `).join("");J=`
                            <div class="event-detail-block">
                                ${L("Parsed Results")}
                        ...
                        ${j}
                        ${D}
                    `}else if(g==="system.test.completed"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row">
                    ...
                    `}else if(g==="error_occurred"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                    ...
                    `}else if(g==="system.cli.status"){let C=w=>`<h5 style="margin-bottom: 8px; text-align: left; font-family: 'JetBrains Mono', monospace; font-size: 0.75em; text-transform: uppercase; letter-spacing: 1.5px; color: #888;">${w}</h5>`;T=`
                        <div class="event-detail-row" style="margin-bottom: 15px;">
                            <span class="detail-label">Status:</span>
                    ...
                    `}else if(g==="messaging.user.sent_message"){let C="";a.attachments&&a.attachments.length>0&&(C=`
                            <div class="event-detail-block">
                                ...
                                <div class="attachments-grid">${a.attachments.map(L=>{let P=L.content_type&&L.content_type.startsWith("image/"),D=(L.size/1024).toFixed(1)+" KB";return`
                                <div class="attachment-item">
                                    ${P?`<div class="attachment-thumb-container"><img src="${L.url}" alt="${L.filename}" class="attachment-thumb"></div>`:`<div class="attachment-icon-container"><i class='bx bx-file attachment-icon'></i></div>`}
                ...
                `}let N=document.createElement("div");N.className=`event-item ${r} ${d} ${h}`,N.dataset.eventId=b.id,N.onclick=function(T){if(!u)return;if(this.classList.contains("expanded")){this.classList.remove("expanded"),me.delete(b.id);let w=this.querySelector(".event-details");w&&(w.style.display="none")}else{this.classList.add("expanded"),me.add(b.id);let w=this.querySelector(".event-details");w&&(w.style.display="block")}},N.innerHTML=`
                <div class="event-time">
...
`,St=hs;function kt(){return`
    ...
    `}var ws=null;async function $e(){let t=document.getElementById("logs-container");if(!t)return!1;t.classList.remove("placeholder-active");try{let e=await I("/logs");if(!e.ok)throw new Error("Logs offline");let i=await e.json();if(!i||i.length===0)return t.innerHTML=H("empty","No logs found.","Services are quiet."),t.classList.add("placeholder-active"),!1;let s=["local-ollama-0","local-cache-0","cloud-cache-0","cloud-cache-1"],n=i.filter(l=>!s.includes(l.id));n.forEach(l=>{l.logs&&Array.isArray(l.logs)?l.logs.reverse():l.logs=[]}),n.reverse();let c=n.map(l=>{let v=l.logs.join(`
`),o=[...l.logs];if(o.length<25){let x=25-o.length;for(let m=0;m<x;m++)o.push("")}else o.length>25&&(o=o.slice(-25));let p=o.map(x=>Le(x)).join(`
`);return`
            ...
            `}).join("");return t.innerHTML=c,document.querySelectorAll(".copy-logs-btn").forEach(l=>{l.addEventListener("click",()=>{let v=unescape(l.dataset.logs);navigator.clipboard.writeText(v).then(()=>{let o=l.querySelector("i");o.classList.remove("bx-copy"),o.classList.add("bx-check"),setTimeout(()=>{o.classList.remove("bx-check"),o.classList.add("bx-copy")},2e3)})})}),document.querySelectorAll(".clear-logs-btn").forEach(l=>{l.addEventListener("click",async()=>{let v=l.dataset.serviceId;if(confirm(`Are you sure you want to clear logs for ${v}?`))try{(await I(`/logs?service_id=${v}`,{method:"DELETE"})).ok&&$e()}catch(o){console.error("Error clearing logs:",o)}})}),ws=Date.now(),!0}catch(e){return console.error("Error fetching logs:",e),t.children.length===0&&(t.innerHTML=H("offline","Failed to load logs.","The event service may be offline."),t.classList.add("placeholder-active")),!1}}var At=()=>{let t=z()?"display: none;":"";return`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${kt()}
        </div>`;async function Nt(){await Promise.all([Ee(),Je(),Ge(),ye()]),await $e()}var Tt=null,Lt=null;async function Ht(){try{return await(await I("/system_monitor")).json()}catch{return null}}async function Mt(){try{return await(await I("/system/hardware")).json()}catch{return null}}async function Cs(){try{return await(await I("/processes")).json()}catch{return null}}async function $s(){try{return await(await I("/agent/status")).json()}catch{return null}}async function Je(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),i=document.querySelector("#hw-os .hw-content"),s=document.querySelector("#hw-cpu .hw-content"),n=document.querySelector("#hw-ram .hw-content"),c=document.querySelector("#hw-gpu .hw-content"),l=document.querySelector("#hw-storage .hw-content"),v=r=>{if(r){if(i&&(i.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 30px;">
                        ...
                        </div>`}).join('<div style="height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;"></div>'):c.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No GPU detected</p>'),l&&r.STORAGE&&r.STORAGE.length>0?l.innerHTML=r.STORAGE.map(d=>{let f=(d.USED/1073741824).toFixed(1),h=(d.SIZE/(1024*1024*1024)).toFixed(1),A=d.SIZE>0?(d.USED/d.SIZE*100).toFixed(0):0,_=d.MOUNT_POINT||"Unmounted";return`
                    ...
                    </div>`}).join(""):l&&(l.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>";let r=await Mt();r?(v(r),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)):(e.innerHTML="<i class='bx bx-error'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3))},e.dataset.listenerAttached="true"),s&&!s.hasChildNodes())){let r=await Mt();v(r)}if(!t)return;let o=await Ht();if(!o||!o.services){t.children.length===0&&(t.innerHTML=H("offline","Failed to load system metrics.","The event service may be offline."));return}Tt=Date.now(),X(0,Tt);let p=o.services||[];Array.from(t.children).forEach(r=>{r.classList.contains("service-widget")||r.remove()});function x(r){return!r||r==="N/A"||r==="unknown"||r.trim()===""?"-":r}function m(r){if(!r||r==="N/A"||r==="unknown")return"-";let d=r.match(/^(\d+\.\d+\.\d+)/);return d?d[0]:r.split(".").slice(0,3).join(".")||"-"}function b(r){return!r||r.length<=28?r:r.substring(0,28)+"..."}function a(r){if(!r||r==="N/A"||r==="unknown")return"-";let d=r.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!d)return"-";let f=parseInt(d[1])||0,h=parseInt(d[2])||0,A=parseInt(d[3])||0,_=parseFloat(d[4])||0,S=f*86400+h*3600+A*60+_,k=Math.floor(S/86400);if(k>0)return`${k}d`;let E=Math.floor(S/3600);if(E>0)return`${E}h`;let B=Math.floor(S/60);return B>0?`${B}m`:`${Math.floor(S)}s`}function g(r){let d=r.status==="online",f=d?"service-widget-online":"service-widget-offline",h=d?"bx-check-circle":"bx-x-circle",A=d?"OK":"BAD",_=r.version?m(r.version.str):"-",S=r.cpu&&r.cpu!=="N/A"?r.cpu:"-",k=r.memory&&r.memory!=="N/A"?r.memory:"-",E=S!=="-"?"#00ff00":"#666",B=S!=="-"?"#fff":"#666",M=k!=="-"?"#00ff00":"#666",N=k!=="-"?"#fff":"#666",U=a(r.uptime),q="";d?q=`
                <div class="service-widget-info">
                ...
                </div>`:q='<div class="service-widget-footer offline"><span>OFFLINE</span></div>';let F=z()?"easter.company":b(r.domain&&r.port?`${r.domain}:${r.port}`:"");return`<div class="service-widget ${f}" data-service-id="${r.id}"><div class="service-widget-header"><i class="bx ${h}"></i><h3>${r.short_name||r.id}</h3><span class="service-widget-status">${A}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${F}</span></div>${q}</div></div>`}let $=new Map(Array.from(t.querySelectorAll(".service-widget")).map(r=>[r.dataset.serviceId,r])),y=new Set(p.map(r=>r.id));for(let[r,d]of $)y.has(r)||d.remove();let u=new Set;p.forEach(r=>{if(u.has(r.id))return;u.add(r.id);let d=g(r),f=$.get(r.id);f&&f.parentNode?f.outerHTML!==d&&(f.outerHTML=d):t.insertAdjacentHTML("beforeend",d)})}async function Ge(){let t=document.getElementById("models-widgets");if(!t)return;let e=await Ht();if(!e){t.children.length===0&&(t.innerHTML=H("offline","Failed to load model status.","The event service may be offline."));return}Lt=Date.now(),X(2,Lt);let i=e.models||[],s=e.whisper;Array.from(t.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function n(o){let p=o.status==="Ready";return`
                ...
                </div>`}function c(o){let p=o.status==="Ready";return`
                ...
                </div>`}function l(o){let p=o.status==="Downloaded",x=p?"service-widget-online":"service-widget-offline",m=p?"OK":"MISSING",b=p&&o.size>0?`${(o.size/1e9).toFixed(2)} GB`:"-",a=o.name;return o.type==="custom"&&a.endsWith(":latest")&&(a=a.replace(":latest","")),`<div class="service-widget ${x}" data-model-name="${o.name}"><div class="service-widget-header"><i class="bx ${p?"bx-check-circle":"bx-x-circle"}"></i><h3>${a}</h3><span class="service-widget-status">${m}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${o.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${b}</span></div></div></div>`}let v="";if(s&&(v+=n(s)),e.xtts&&(v+=c(e.xtts)),v+=i.map(l).join(""),!v){t.innerHTML=H("empty","No models found.");return}t.innerHTML!==v&&(t.innerHTML=v)}async function Ee(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("guardian-sentry-val"),i=document.getElementById("guardian-architect-val"),s=document.getElementById("guardian-idle-val"),n=document.getElementById("guardian-total-idle"),c=document.getElementById("guardian-total-active"),l=document.getElementById("guardian-total-waste"),v=document.getElementById("guardian-reset-btn"),o=document.getElementById("analyzer-reset-btn");v&&!v.dataset.listenerAttached&&(v.onclick=async()=>{v.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/guardian/reset?protocol=all",{method:"POST"}),setTimeout(()=>{v.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{v.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),Ee()}catch{v.innerHTML="<i class='bx bx-error'></i>"}},v.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=async()=>{o.innerHTML="<i class='bx bx-loader-alt spin'></i>";try{await I("/analyzer/reset?protocol=synthesis",{method:"POST"}),setTimeout(()=>{o.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{o.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},500),Ee()}catch{o.innerHTML="<i class='bx bx-error'></i>"}},o.dataset.listenerAttached="true");let p=await $s();if(p){let y=Math.floor(Date.now()/1e3),u=p.active_tier,r=p.active_synthesis,d=p.protocol_aliases||{sentry:"Sentry",architect:"Architect",synthesis:"Synthesis"},f=M=>{M<0&&(M=0);let N=Math.floor(M/3600),U=Math.floor(M%3600/60),q=M%60;return N>0?`${N}h ${U}m`:U>0?`${U}m ${q}s`:`${q}s`},h=(M,N,U,q,F)=>{if(!M)return;let T=d[q]||q.toUpperCase(),C=M.parentElement.querySelector('span[style*="text-transform: uppercase"]');if(C&&(C.textContent=T),F&&F.includes(q))M.textContent="Working",M.style.color="#bb86fc";else if(U){let L=U.next_run-y;if(L<=0)M.textContent="Ready",M.style.color="#5eff5e";else{let P=Math.floor(L/60),D=L%60;M.textContent=`${P}m ${D}s`,M.style.color="#fff"}}N&&U&&(N.innerHTML=`
        ...
        `)};e&&h(e,document.getElementById("guardian-sentry-stats"),p.sentry,"sentry",u),i&&h(i,document.getElementById("guardian-architect-stats"),p.architect,"architect",u);let A=document.getElementById("analyzer-synthesis-val"),_=document.getElementById("analyzer-synthesis-stats");A&&h(A,_,p.synthesis,"synthesis",r);let S=document.getElementById("imaginator-alert_review-val"),k=document.getElementById("imaginator-alert_review-stats");S&&h(S,k,p.alert_review,"alert_review",u);let E=document.getElementById("system-state-label"),B=document.getElementById("system-state-val");if(B&&p.system_state){let M=p.system_state,N=f(p.system_state_time||0);E&&(E.textContent=`State: ${M.toUpperCase()}`),B.textContent=N,M==="idle"?B.style.color=p.system_state_time>300?"#5eff5e":"#fff":B.style.color="#bb86fc"}n&&(n.textContent=f(p.total_idle_time||0)),c&&(c.textContent=f(p.total_active_time||0)),l&&(l.textContent=f(p.total_waste_time||0))}else[e,i,s,n,c,l].forEach(u=>{u&&(u.textContent="-",u.style.color="#666")});let x=await Cs(),m=[],b=[],a=[];x&&(Array.isArray(x)?m=x:(m=x.active||[],b=x.queue||[],a=x.history||[],a.sort((y,u)=>(u.end_time||0)-(y.end_time||0)))),m.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=H("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),Fe(t,m,!1));let g=document.getElementById("processes-queue-widgets");g&&(b.length===0?!g.querySelector(".tab-placeholder")&&!g.querySelector('div[style*="font-style: italic"]')&&(g.innerHTML='<div style="width: 100%; text-align: center; padding: 20px; color: #666; font-style: italic; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.05);">Queue is empty</div>'):(g.innerHTML="",Fe(g,b,!1)));let $=document.getElementById("processes-history-widgets");$&&(a.length===0?$.querySelector(".tab-placeholder")||($.innerHTML=H("empty","No recent history.")):($.querySelector(".tab-placeholder")&&($.innerHTML=""),Fe($,a,!0))),we(1,m.length)}function Fe(t,e,i){function s(o){let p="";o.end_time?p=`${o.end_time-o.start_time}s`:p=`${Math.floor(Date.now()/1e3-o.start_time)}s`;let x=o.retries>0?`<span class="process-retry-badge">Retry ${o.retries}</span>`:"",m=o.channel_id,b={"system-guardian":"Guardian Agent","system-cli-op":"CLI Operation","system-analyzer":"Analyzer Agent"};if(b[m]?m=b[m]:/^\d+$/.test(m)&&(m=`Channel ${m}`),i)return`
        <div class="process-history-item" data-channel-id="${o.channel_id}-${o.start_time}" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 15px; background: rgba(255,255,255,0.03); border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); font-family: 'JetBrains Mono', monospace; font-size: 0.85em;">
            <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
                <i class='bx bx-check-circle' style="color: #03dac6; font-size: 1.1em;"></i>
                <span style="color: #fff; font-weight: 600;">${m}</span>
                <span style="color: #666; font-size: 0.9em; background: rgba(0,0,0,0.2); padding: 1px 6px; border-radius: 4px;">${o.state}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 20px; color: #888;">
                ...
                <div class="service-widget process-widget" data-channel-id="${o.channel_id}-${o.start_time}" style="">
                    <div class="service-widget-header">
                    ...
                    <div class="service-widget-body">
                        <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${a}">${o.state}</span>
                        </div>
                        <div class="service-widget-info">
                         ...
                         <div class="service-widget-info">
                            ...
                            <span class="info-value" style="color: ${a}">${o.pid}</span>
                        </div>
                    </div>
                </div>`}let n=i?".process-history-item":".process-widget",c=new Map(Array.from(t.querySelectorAll(n)).map(o=>[o.dataset.channelId,o])),l=new Set(e.map(o=>`${o.channel_id}-${o.start_time}`));for(let[o,p]of c)l.has(o)||p.remove();let v=new Set;e.forEach(o=>{let p=`${o.channel_id}-${o.start_time}`;if(v.has(p))return;v.add(p);let x=s(o),m=c.get(p);if(m&&m.parentNode){m.outerHTML!==x&&(m.outerHTML=x);let b=t.querySelector(`[data-channel-id="${p}"]`);b&&t.appendChild(b)}else t.insertAdjacentHTML("beforeend",x)})}function De(){let t=He(),e="Notification"in window,i={enabled:e&&Notification.permission==="granted",supported:e};return`
    ...
    `;async function Ot(){let t=document.getElementById("web-history-content");if(!t)return;let e=document.getElementById("web-refresh-btn");e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i>",await Pt(t),e.innerHTML="<i class='bx bx-check'></i>",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i>"},2e3)},e.dataset.listenerAttached="true"),await Pt(t)}async function Pt(t){try{let e=await I("/web/history");if(!e.ok)throw new Error("Failed to fetch history");let i=await e.json();if(!i||i.length===0){t.innerHTML=H("empty","No web history found.");return}let s=`
        ...
        `;i.forEach((v,o)=>{let p=new Date(v.timestamp*1e3).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),x=v.screenshot?`<img src="data:image/png;base64,${v.screenshot}" style="width: 100%; max-height: 45%; object-fit: contain; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; flex-shrink: 0; background: #000;">`:'<div style="width: 100%; height: 80px; background: rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: center; color: #666; margin-bottom: 15px; border-radius: 8px; flex-shrink: 0;">No Screenshot</div>';s+=`
                <div class="web-card" style="flex: 0 0 100%; height: 100%; display: flex; flex-direction: column; scroll-snap-align: center; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 20px; box-sizing: border-box; max-width: 100%; overflow: hidden;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 10px; flex-shrink: 0;">
                        <span style="color: #03dac6; font-weight: bold; font-family: monospace;">#${o+1}</span>
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Es=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ve=!0,i}function Ut(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ve=!1}function jt(t,e,i="output"){if(!Ve)return;let s=document.createElement("div");s.className=`terminal-line terminal-${i}`,i==="prompt"?s.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:s.innerHTML=Le(e),t.appendChild(s),t.scrollTop=t.scrollHeight}async function ks(t){let e=qt.find(n=>n.id===t);if(!e)return;let i=Ss(e);jt(i,`dex ${t}`,"prompt");let s=e.demo_output||["Executing command...","\u2713 Done."];for(let n of s){await new Promise(l=>setTimeout(l,400+Math.random()*600));let c="output";n.includes("[ERROR]")?c="error":n.includes("[SUCCESS]")||n.includes("\u2713")?c="success":n.includes("!")&&(c="warning"),jt(i,n,c)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Ft(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Es();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let i=e.querySelector("code").textContent;navigator.clipboard.writeText(i).then(()=>{let s=e.querySelector("i");s.className="bx bx-check",s.style.color="#5eff5e",setTimeout(()=>{s.className="bx bx-copy",s.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(i=>{i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-5px)",i.style.borderColor="rgba(255,255,255,0.15)",i.style.backgroundColor="rgba(255,255,255,0.05)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)",i.style.borderColor="rgba(255,255,255,0.05)",i.style.backgroundColor="rgba(255,255,255,0.03)"}),i.addEventListener("click",()=>{let s=i.dataset.cmd;ks(s)})})}async function Ts(){if(!z())try{if(!(await I("/system/status",{method:"GET"})).ok)throw new Error("Service unhealthy")}catch(t){console.error("Service health check failed:",t)}}function Jt(){if(window.location.protocol==="http:"&&window.location.hostname==="easter.company"){window.location.replace("https://"+window.location.hostname+window.location.pathname+window.location.search);return}Qe(),et(),Ts(),at(),Xe();let t=window.location.pathname;(t==="/dexter"||t==="/dexter/")&&Ft();let e=[],i=document.getElementById("windows-container");i&&i.setAttribute("data-count","0");let s=u=>{localStorage.setItem("dex_last_window",u)};function n(){for(;e.length>1;)e.shift().close(!0);let u=document.getElementById("windows-container"),r=document.querySelector("nav"),d=document.querySelector("footer"),f=window.location.pathname==="/"||window.location.pathname==="/index.html",h=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");u&&u.setAttribute("data-count",e.length),e.forEach(B=>{let M=document.getElementById(B.id);M&&M.classList.remove("hide-close")});let A=document.getElementById("dexter-menu-container"),_=document.getElementById("nav-window-switcher"),S=document.getElementById("settings-icon"),k=document.getElementById("close-all-windows"),E=window.innerWidth<880;if(!E){let B=document.getElementById("dexter-dropdown"),M=document.getElementById("dexter-menu-btn");B&&B.classList.remove("active"),M&&M.classList.remove("active"),u&&u.classList.remove("menu-open")}if(fe(e.length>0),e.length>0)if(d?.classList.add("hide"),k&&(k.style.display=E?"none":"block"),document.querySelector("main")?.style.setProperty("opacity","0","important"),r?.classList.add("window-open"),u&&(u.style.paddingTop="60px"),A&&(A.style.display=E?"flex":"none"),S&&(S.style.display=E?"block":"none"),!E&&_){let B=e[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(B)?(_.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{s("alerts-window"),c(v)}),document.getElementById("switch-events").addEventListener("click",()=>{s("events-window"),c(o)}),document.getElementById("switch-monitor").addEventListener("click",()=>{s("monitor-window"),c(x)}),document.getElementById("switch-contacts").addEventListener("click",()=>{s("contacts-window"),c(p)}),document.getElementById("switch-workspace").addEventListener("click",()=>{s("workspace-window"),c(m)})):_.innerHTML=""}else _&&(_.innerHTML="");else r?.classList.remove("window-open"),k&&(k.style.display="none"),u&&(u.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),f||h?d?.classList.remove("hide"):d?.classList.add("hide"),A&&(A.style.display="flex"),S&&(S.style.display="block"),_&&(_.innerHTML="");ve()}function c(u){if(u.isOpen()){u.close();return}for(;e.length>0;)e.pop().close(!0);e.push(u),u.open(),n()}function l(){[...e].forEach(r=>r.close()),e=[]}window.addEventListener("resize",n);let v=ae({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:pt(),onOpen:()=>ie(),onClose:()=>{let u=e.indexOf(v);u>-1&&e.splice(u,1),n()}}),o=ae({id:"events-window",title:"Events",icon:"bx-calendar-event",content:qe(),onOpen:()=>{o.setContent(qe()),ne()},onClose:()=>{let u=e.indexOf(o);u>-1&&e.splice(u,1),n()}}),p=ae({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:$t(),onOpen:()=>je(),onClose:()=>{let u=e.indexOf(p);u>-1&&e.splice(u,1),n()}}),x=ae({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:Bt()},{icon:"bxs-component",title:"Processes",content:It()},{icon:"bxs-brain",title:"Models",content:_t()},{icon:"bx-globe",title:"Web",content:Rt()},{icon:"bxs-hdd",title:"Hardware",content:Dt()},{icon:"bxs-terminal",title:"Logs",content:zt()},{icon:"bxs-zap",title:"Agents",content:At()},{icon:"bx-task",title:"Chores",content:ht()}].filter(u=>z()?u.title!=="Hardware"&&u.title!=="Logs":!0),onOpen:()=>{Je(),Ee(),Ge(),Ot(),$e(),ye()},onClose:()=>{let u=e.indexOf(x);u>-1&&e.splice(u,1),n()}}),m=ae({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:yt(),onOpen:()=>Oe(),onClose:()=>{let u=e.indexOf(m);u>-1&&e.splice(u,1),n()}}),b=ae({id:"settings-window",title:"Settings",icon:"bx-cog",content:De(),onOpen:()=>{b.setContent(De()),We(b)},onClose:()=>{let u=e.indexOf(b);u>-1&&e.splice(u,1),n()}});window.dexter={viewEvent:u=>{o.isOpen()||c(o),setTimeout(()=>{let r=document.querySelector(`.event-item[data-event-id="${u}"]`);r&&(r.scrollIntoView({behavior:"smooth",block:"center"}),r.classList.add("flash-highlight"),r.classList.contains("expanded")||r.click(),setTimeout(()=>r.classList.remove("flash-highlight"),2e3))},500)},viewAlert:u=>{v.isOpen()||c(v),setTimeout(()=>{let r=document.querySelector(`.event-item[data-alert-id="${u}"]`);r&&(r.scrollIntoView({behavior:"smooth",block:"center"}),r.classList.add("flash-highlight"),r.classList.contains("expanded")||r.click(),setTimeout(()=>r.classList.remove("flash-highlight"),2e3))},500)}};let a=()=>{let u=document.getElementById("dexter-dropdown"),r=document.getElementById("dexter-menu-btn");u&&r&&(u.classList.remove("active"),r.classList.remove("active"),window.innerWidth<880&&document.getElementById("windows-container")?.classList.remove("menu-open"))};(()=>{let u=document.getElementById("dexter-menu-btn"),r=document.getElementById("settings-icon"),d=document.getElementById("close-all-windows"),f=document.getElementById("nav-left-container"),h=document.getElementById("dexter-dropdown"),A=document.getElementById("windows-container");u&&h&&(u.onclick=S=>{S.stopPropagation();let k=window.innerWidth<880;h.classList.toggle("active"),u.classList.toggle("active");let E=h.classList.contains("active");if(k){let B=document.querySelector("nav");E?(document.querySelector("footer")?.classList.add("hide"),document.querySelector("main")?.style.setProperty("opacity","0","important"),B?.classList.add("window-open"),A?.classList.add("menu-open"),fe(!0)):(A?.classList.remove("menu-open"),e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),B?.classList.remove("window-open"),fe(!1)))}}),r&&(r.onclick=S=>{S.stopPropagation(),c(b)}),d&&(d.onclick=S=>{S.stopPropagation(),l()});let _=(S,k,E)=>{let B=document.getElementById(S);B&&(B.onclick=M=>{M.stopPropagation(),a(),E&&s(E),c(k)})};_("alerts-menu-item",v,"alerts-window"),_("events-menu-item",o,"events-window"),_("monitor-menu-item",x,"monitor-window"),_("contacts-menu-item",p,"contacts-window"),_("workspace-menu-item",m,"workspace-window"),f&&(f.onclick=S=>{if(S.stopPropagation(),h&&h.classList.contains("active")){a(),window.innerWidth<880&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1));return}if(e.length>0)l();else{let k=window.location.pathname;if(!(k==="/"||k==="/index.html")){let M=(k.endsWith("/")&&k.length>1?k.slice(0,-1):k).split("/");M.pop();let N=M.join("/")||"/";window.location.href=N}}}),document.addEventListener("click",()=>{let S=window.innerWidth<880;h&&h.classList.contains("active")&&(a(),S&&e.length===0&&(document.querySelector("footer")?.classList.remove("hide"),document.querySelector("main")?.style.setProperty("opacity","1","important"),document.querySelector("nav")?.classList.remove("window-open"),fe(!1)))}),h&&(h.onclick=S=>S.stopPropagation())})();let $=window.location.pathname==="/"||window.location.pathname==="/index.html",y=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!$&&!y&&document.querySelector("footer")?.classList.add("hide"),z()||setInterval(()=>{o.isOpen()&&ne(),v.isOpen()?ie():Re()},1e3),setInterval(()=>{z()&&(v.isOpen()?ie():Re()),m.isOpen()?Oe():xt(),z()&&o.isOpen()&&ne(),x.isOpen()&&Nt()},5e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Jt):Jt();})();
