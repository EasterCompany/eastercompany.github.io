(()=>{function Me(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Be(t=!1){let e=window.location.pathname,a=e==="/"||e==="/index.html",o=t?`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var He=1e3;function q(t){let e=null,a=t.onClose||null,o=t.onOpen||null;function s(){e&&(e.style.zIndex=++He)}function r(){if(e){e.classList.add("open"),s(),window.addEventListener("resize",c),o&&setTimeout(o,10);return}let u=document.getElementById("windows-container");u||(u=document.createElement("div"),u.id="windows-container",u.className="windows-container",document.body.appendChild(u)),e=document.createElement("div"),e.id=t.id,e.className="window",t.tabs&&t.tabs.length>0&&e.classList.add("has-tabs"),e.style.zIndex=++He,e.addEventListener("mousedown",s);let p=t.icon||"bx-window",n="",i="",l;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((m,d)=>{let g=m.icon?`<i class="bx ${m.icon}"></i>`:`<span class="tab-glyph">${m.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${l}
        `,u.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),v()}),window.addEventListener("resize",c),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let x=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(m=>m.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(m=>m.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${x}"]`).classList.add("active"),b(y,e)})}),setTimeout(()=>{e.classList.add("open"),o&&o()},10)}function c(){if(!e||!e.classList.contains("open"))return;let u=e.querySelector(".tab.active");u&&b(u,e)}function b(u,p){setTimeout(()=>{let n=p.querySelector(".tab-bar");if(!n)return;let i=Array.from(n.querySelectorAll(".tab")),l=i.indexOf(u),y=n.clientWidth,x=i[Math.max(0,l-2)],m=i[Math.min(i.length-1,l+2)],d=x.offsetLeft-n.offsetLeft-25,h=m.offsetLeft+m.offsetWidth-n.offsetLeft+25-d,C=h<=y?d-(y-h)/2:u.offsetLeft-n.offsetLeft-y/2+u.offsetWidth/2;n.scrollTo({left:C,behavior:"smooth"})},350)}function v(u=!1){e&&(window.removeEventListener("resize",c),u?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function f(u){let p=e?.querySelector(".window-content");p&&(p.innerHTML=u)}function w(){return e&&e.classList.contains("open")}return{open:r,close:v,setContent:f,isOpen:w,focus:s,id:t.id}}function Ne(){return!0}function Re(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Pe(t){localStorage.setItem("easter_user_email",t.trim())}var Oe="easter_theme",z={DARK:"dark",LIGHT:"light",LEGACY:"legacy"};function se(){return localStorage.getItem(Oe)||z.DARK}function Ue(t){if(!Object.values(z).includes(t))throw new Error("Invalid theme");localStorage.setItem(Oe,t),oe(t)}function oe(t){let e=document.body;if(Object.values(z).forEach(o=>{e.classList.remove(`theme-${o}`)}),e.classList.add(`theme-${t}`),[z.LIGHT,z.LEGACY].includes(t)){if(e.classList.add("is-animated"),!document.querySelector(".background")){let o=document.createElement("div");o.className="background",document.body.prepend(o)}}else e.classList.remove("is-animated"),document.querySelector(".background")?.remove()}function ze(){let t=se();oe(t)}function $(t,e,a=null){let s={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${s} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function A(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function D(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let o=Date.now(),s=Math.floor((o-e)/1e3),r;s<60?r=`${s}s ago`:s<3600?r=`${Math.floor(s/60)}m ago`:r=`${Math.floor(s/3600)}h ago`,a.textContent=`Last updated: ${r}`}function F(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let o=a.querySelector(".notification-badge");o&&(e>0?(o.textContent=e>9?"9+":e,o.style.display="flex"):o.style.display="none")}function Ee(t){let e=document.getElementById("dexter-nav-badge");e&&(t>0?e.style.display="flex":e.style.display="none");let a=document.getElementById("alerts-menu-item");if(a){let s=a.querySelector(".notification-badge");s||(s=document.createElement("span"),s.className="notification-badge",s.style.marginLeft="auto",a.appendChild(s)),t>0?(s.textContent=t>9?"9+":t,s.style.display="flex"):s.style.display="none"}let o=document.getElementById("switch-alerts");if(o){let s=o.querySelector(".notification-badge");s||(s=document.createElement("span"),s.className="notification-badge",s.style.marginLeft="8px",o.appendChild(s)),t>0?(s.textContent=t>9?"9+":t,s.style.display="flex"):s.style.display="none"}}function ce(){let t=document.getElementById("alerts-list");if(!t)return;let e=t.querySelectorAll(".alert-unread").length;Ee(e)}function Se(){return"https://event.easter.company"}function $t(){return"https://discord.easter.company"}var Lt="http://127.0.0.1:8100",Ct="http://127.0.0.1:8300",Tt={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function de(t){let e=A(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(s,r)=>{let c=Tt[r];return c?`<span class="${c}">`:""});let a=(e.match(/<span/g)||[]).length,o=(e.match(/<\/span/g)||[]).length;return a>o&&(e+="</span>".repeat(a-o)),e}function qe(t){if(!t)return"";let e=A(t);return e=e.replace(/```([\s\S]*?)```/g,'<pre class="md-code-block">$1</pre>'),e=e.replace(/`([^`]+)`/g,'<code class="md-inline-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*]+)\*/g,"<em>$1</em>"),e=e.replace(/^# (.*$)/gm,'<h3 class="md-header">$1</h3>'),e=e.replace(/^## (.*$)/gm,'<h4 class="md-header">$1</h4>'),e=e.replace(/^### (.*$)/gm,'<h5 class="md-header">$1</h5>'),e=e.replace(/^- (.*$)/gm,'<div class="md-list-item"><span class="md-bullet">\u2022</span> $1</div>'),e=e.replace(/^(\d+)\. (.*$)/gm,'<div class="md-list-item"><span class="md-number">$1.</span> $2</div>'),e}var J=null,Y=null,le=!1,re=!1;async function T(t,e={}){if(J)try{let s=await fetch(J+t,e);if(s.ok)return s;J=null}catch{J=null}let a=Se(),o=Lt;try{let s=await fetch(a+t,e);if(s.ok)return J=a,le&&(console.log("\u2728 Production event service restored."),le=!1),s;throw new Error("Primary failed")}catch{le||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${o}`),le=!0);try{let r=await fetch(o+t,e);if(r.ok)return J=o,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function Fe(t,e={}){if(Y)try{let s=await fetch(Y+t,e);if(s.ok)return s;Y=null}catch{Y=null}let a=$t(),o=Ct;try{let s=await fetch(a+t,e);if(s.ok)return Y=a,re&&(console.log("\u2728 Production discord service restored."),re=!1),s;throw new Error("Primary failed")}catch{re||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${o}`),re=!0);try{let r=await fetch(o+t,e);if(r.ok)return Y=o,r;throw new Error("Fallback failed")}catch(r){throw r}}}var je=()=>`
...
`,me=null,G=new Set,pe=[];async function W(t=!1){let e=document.getElementById("alerts-list");if(!e)return;kt(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let o=await T(a);if(!o.ok)throw new Error("Service is offline or unreachable.");let r=(await o.json()).events||[];me=Date.now(),D(0,me);let c=Date.now(),b=24*60*60*1e3,v=r.filter(d=>{let g=localStorage.getItem(`alert_read_ts_${d.id}`);if(!g)return!0;let h=parseInt(g);return c-h<b});v.sort((d,g)=>{let h=I=>{let k=I.event;if(typeof k=="string")try{k=JSON.parse(k)}catch{return"low"}return(k.priority||"low").toLowerCase()},C=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,S=C(h(d)),L=C(h(g));return S!==L?L-S:g.timestamp-d.timestamp}),pe=v;let f=d=>{let g=d.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return"low"}return(g.priority||"low").toLowerCase()},w=[],p=new Set(v.map(d=>f(d))).size>1;if(v.length>0){let d=null;v.forEach(g=>{let h=f(g);p&&h!==d&&(w.push({id:`divider-${h}`,type:"divider",label:h.toUpperCase()}),d=h),w.push(g)})}if(t&&(e.innerHTML=""),v.length===0){e.innerHTML=$("empty","No alerts yet."),ce();return}let n=d=>{let g=d.event;if(typeof g=="string")try{g=JSON.parse(g)}catch{return null}let h=g.title||"Untitled Alert",C=g.body||"No description provided.",S=g.priority||"low",L=!!g.alert,I=g.category||"system",k=g.related_event_ids||[],B=!!localStorage.getItem(`alert_read_ts_${d.id}`),O=new Date(d.timestamp*1e3),R=O.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),P=O.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),E=B?"event-border-grey":"event-border-blue";!B&&L&&(E="event-border-red"),B&&(S==="high"||S==="critical")?E="event-border-red":B&&S==="medium"&&(E="event-border-orange");let _=B?"alert-read":"alert-unread",H=G.has(d.id),N=H?"expanded":"",ye=H?"display: block;":"display: none;",ae="",Ie="";k.length>0&&(Ie=`
...
`+C)}</div>
            ...
            `;let Ae=U.querySelector(".event-details");Ae&&Ae.addEventListener("click",j=>{j.stopPropagation()});let _e=U.querySelector(".close-details-btn");return _e&&_e.addEventListener("click",j=>{j.stopPropagation(),U.classList.remove("expanded");let xe=U.querySelector(".event-details");xe&&(xe.style.display="none"),G.delete(d.id)}),U},i=d=>{let g=document.createElement("div");g.className="notification-divider",g.dataset.alertId=d.id;let h="#888888";return d.label==="CRITICAL"?h="#ff4d4d":d.label==="HIGH"?h="#ff8888":d.label==="MEDIUM"&&(h="#ffa500"),g.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${h}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,g.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${h}44, transparent); flex-grow: 1;"></div>`,g},l=Array.from(e.children),y=new Map(l.map(d=>[d.dataset.alertId,d])),x=new Set(w.map(d=>d.id));l.forEach(d=>{let g=d.dataset.alertId;(!g||!x.has(g))&&d.remove()});let m=null;w.forEach((d,g)=>{let h=y.get(d.id);(!h||t)&&(h&&h.remove(),d.type==="divider"?h=i(d):h=n(d),!h)||(g===0?e.firstElementChild!==h&&e.prepend(h):m&&m.nextElementSibling!==h&&m.after(h),m=h)}),me=Date.now(),D(0,me),ce()}catch(o){console.error("Error fetching alerts:",o),e.children.length===0&&(e.innerHTML=$("offline","Failed to load alerts.","The event service may be offline."))}}function kt(){let t=document.getElementById("alerts-read-all"),e=document.getElementById("alerts-expand-all"),a=document.getElementById("alerts-close-all"),o=document.getElementById("alerts-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{pe.forEach(s=>{localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),W(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{pe.forEach(s=>{G.add(s.id),localStorage.getItem(`alert_read_ts_${s.id}`)||localStorage.setItem(`alert_read_ts_${s.id}`,Date.now().toString())}),W(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{G.clear(),W(!0)},a.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{let s=Date.now()-1728e5;pe.forEach(r=>{localStorage.setItem(`alert_read_ts_${r.id}`,s.toString())}),G.clear(),W(!0)},o.dataset.listenerAttached="true")}async function Ge(){let t="/events?ml=1000&format=json&event.type=system.notification.generated";try{let e=await T(t);if(!e.ok)return;let o=(await e.json()).events||[],s=0;o.forEach(r=>{localStorage.getItem(`alert_read_ts_${r.id}`)||s++}),Ee(s)}catch{}}var We=()=>`
...
`,V=new Set,Ke=[],X=null;async function K(t=!1){let e=document.getElementById("roadmap-list");if(e){It();try{let a=await T("/roadmap");if(!a.ok)throw new Error("Offline");let o=await a.json();if(Ke=o,o.length===0){e.innerHTML=$("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let s=f=>{let w=V.has(f.id),u=f.state==="draft",p=f.state==="published",n=f.state==="consumed",i="event-border-grey";p&&(i="event-border-blue"),n&&(i="event-border-purple");let y=new Date(f.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),x=document.createElement("div");x.className=`event-item notification-item ${i} cursor-pointer ${w?"expanded":""}`,x.dataset.itemId=f.id,x.onclick=g=>{if(g.target.closest("button"))return;x.classList.contains("expanded")?(x.classList.remove("expanded"),x.querySelector(".event-details").style.display="none",V.delete(f.id)):(x.classList.add("expanded"),x.querySelector(".event-details").style.display="block",V.add(f.id))};let m=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${f.state.toUpperCase()}]</span>`;x.innerHTML=`
      ...
      `;let d=x.querySelector(".event-details");return d&&d.addEventListener("click",g=>{g.stopPropagation()}),x.querySelector(".edit-btn")?.addEventListener("click",()=>At(f)),x.querySelector(".publish-toggle-btn")?.addEventListener("click",()=>_t(f)),x.querySelector(".delete-btn")?.addEventListener("click",()=>Mt(f.id)),x.querySelector(".close-details-btn")?.addEventListener("click",g=>{g.stopPropagation(),x.classList.remove("expanded"),x.querySelector(".event-details").style.display="none",V.delete(f.id)}),x},r=Array.from(e.children),c=new Map(r.map(f=>[f.dataset.itemId,f])),b=new Set(o.map(f=>f.id));r.forEach(f=>{let w=f.dataset.itemId;(!w||!b.has(w))&&f.remove()});let v=null;o.forEach((f,w)=>{let u=c.get(f.id);(!u||t)&&(u&&u.remove(),u=s(f),!u)||(w===0?e.firstElementChild!==u&&e.prepend(u):v&&v.nextElementSibling!==u&&v.after(u),v=u)})}catch{e.children.length===0&&(e.innerHTML=$("offline","Failed to load roadmap.","The event service may be offline."))}}}function It(){let t=document.getElementById("roadmap-new"),e=document.getElementById("roadmap-save"),a=document.getElementById("roadmap-cancel"),o=document.getElementById("roadmap-expand-all"),s=document.getElementById("roadmap-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{X=null,document.getElementById("roadmap-editor-input").value="",document.getElementById("roadmap-editor-container").style.display="block"},t.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{document.getElementById("roadmap-editor-container").style.display="none",X=null},a.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=async()=>{let r=document.getElementById("roadmap-editor-input").value;if(!r.trim())return;let c=X?`/roadmap/${X}`:"/roadmap",b=X?"PATCH":"POST";try{await T(c,{method:b,headers:{"Content-Type":"application/json"},body:JSON.stringify({content:r})}),document.getElementById("roadmap-editor-container").style.display="none",K(!0)}catch(v){console.error(v)}},e.dataset.listenerAttached="true"),o&&!o.dataset.listenerAttached&&(o.onclick=()=>{Ke.forEach(r=>V.add(r.id)),K(!0)},o.dataset.listenerAttached="true"),s&&!s.dataset.listenerAttached&&(s.onclick=()=>{V.clear(),K(!0)},s.dataset.listenerAttached="true")}function At(t){X=t.id,document.getElementById("roadmap-editor-input").value=t.content,document.getElementById("roadmap-editor-container").style.display="block",document.getElementById("roadmap-editor-container").scrollIntoView({behavior:"smooth"})}async function _t(t){let e=t.state==="published"?"draft":"published";try{await T(`/roadmap/${t.id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({state:e})}),K(!0)}catch(a){console.error(a)}}async function Mt(t){if(confirm("Delete this roadmap item?"))try{await T(`/roadmap/${t}`,{method:"DELETE"}),V.delete(t),K(!0)}catch(e){console.error(e)}}var Ye=()=>`
    <div class="alerts-actions" style="margin: 0; padding: 0; background: none; border: none; box-shadow: none; display: flex; gap: 10px;">
...
`;async function $e(){await Promise.all([K(),ue()])}var tt=()=>`
    <div class="alerts-actions">
...
`);return`
        ...
        <div id="processes-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,pt=()=>`
        <div class="system-section-header">
            <i class='bx bxs-server' style="color: #03dac6;"></i>
            <h2>Services</h2>
        </div>
        <div id="services-widgets" class="system-monitor-widgets" style="margin-bottom: 30px;"></div>`,ut=()=>`
        <div class="system-section-header">
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${at()}
        </div>`;async function ft(){await Promise.all([be(),Le(),Ce()]),await ie()}var ot=null,lt=null,rt=null;async function bt(){try{return await(await T("/system_monitor")).json()}catch{return null}}async function ct(){try{return await(await T("/system/hardware")).json()}catch{return null}}async function Ut(){try{return await(await T("/processes")).json()}catch{return null}}async function zt(){try{return await(await T("/analyst/status")).json()}catch{return null}}async function Le(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-info-content"),a=document.getElementById("hardware-refresh-btn"),o=n=>{if(!n){e.children.length===0&&(e.innerHTML=$("offline","Failed to load hardware info.","The event service may be offline."));return}let i="",l=(n.MEMORY_BYTES/(1024*1024*1024)).toFixed(1);if(i+=`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Ft=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `;for(let[a,o]of Object.entries(t)){let s=xt.filter(r=>r.category===a);s.length!==0&&(e+=`
    ...
    </div>`,e},ke=!1;function jt(t){let e=document.getElementById("cli-terminal-overlay");e||(e=document.createElement("div"),e.id="cli-terminal-overlay",e.className="cli-execution-overlay",e.innerHTML=`
        ...
        `,document.body.appendChild(e),document.getElementById("close-terminal-btn").onclick=()=>ht(),document.getElementById("terminal-action-btn").onclick=()=>ht());let a=document.getElementById("cli-terminal-body"),o=document.getElementById("cli-docs-pane");a.innerHTML="";let s=t.docs||{overview:t.description,details:[],extended_usage:t.usage};return o.innerHTML=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),ke=!0,a}function ht(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),ke=!1}function yt(t,e,a="output"){if(!ke)return;let o=document.createElement("div");o.className=`terminal-line terminal-${a}`,a==="prompt"?o.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:o.innerHTML=de(e),t.appendChild(o),t.scrollTop=t.scrollHeight}async function Gt(t){let e=xt.find(s=>s.id===t);if(!e)return;let a=jt(e);yt(a,`dex ${t}`,"prompt");let o=e.demo_output||["Executing command...","\u2713 Done."];for(let s of o){await new Promise(c=>setTimeout(c,400+Math.random()*600));let r="output";s.includes("[ERROR]")?r="error":s.includes("[SUCCESS]")||s.includes("\u2713")?r="success":s.includes("!")&&(r="warning"),yt(a,s,r)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function wt(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Ft();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let a=e.querySelector("code").textContent;navigator.clipboard.writeText(a).then(()=>{let o=e.querySelector("i");o.className="bx bx-check",o.style.color="#5eff5e",setTimeout(()=>{o.className="bx bx-copy",o.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(a=>{a.addEventListener("mouseenter",()=>{a.style.transform="translateY(-5px)",a.style.borderColor="rgba(255,255,255,0.15)",a.style.backgroundColor="rgba(255,255,255,0.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="translateY(0)",a.style.borderColor="rgba(255,255,255,0.05)",a.style.backgroundColor="rgba(255,255,255,0.03)"}),a.addEventListener("click",()=>{let o=a.dataset.cmd;Gt(o)})})}async function Wt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${Se()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable. Redirecting to 404."),window.location.href="/404.html"}}function Et(){Wt(),ze(),Me();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&wt();let e=Ne();Be(e),De();let a=window.location.pathname==="/"||window.location.pathname==="/index.html",o=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!o&&document.querySelector("footer")?.classList.add("hide");let s=[],r=document.getElementById("windows-container");r&&r.setAttribute("data-count","0");let c=m=>{localStorage.setItem("dex_last_window",m)};function b(){return 1}function v(){for(;s.length>1;)s.shift().close(!0);let m=document.getElementById("windows-container"),d=document.querySelector("nav"),g=document.querySelector("footer"),h=window.location.pathname==="/"||window.location.pathname==="/index.html",C=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");m&&m.setAttribute("data-count",s.length);let S=s.length>0;s.forEach(M=>{let B=document.getElementById(M.id);B&&B.classList.remove("hide-close")}),oe(se());let L=document.getElementById("dexter-menu-container"),I=document.getElementById("nav-window-switcher"),k=document.getElementById("settings-icon");if(s.length>0){if(g?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),d?.classList.add("window-open"),m&&(m.style.paddingTop="60px"),L&&(L.style.display="none"),k&&(k.style.display="none"),I){let M=s[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(M)?(I.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{c("alerts-window"),f(u)}),document.getElementById("switch-events").addEventListener("click",()=>{c("events-window"),f(p)}),document.getElementById("switch-monitor").addEventListener("click",()=>{c("monitor-window"),f(i)}),document.getElementById("switch-contacts").addEventListener("click",()=>{c("contacts-window"),f(n)}),document.getElementById("switch-workspace").addEventListener("click",()=>{c("workspace-window"),f(l)})):I.innerHTML=""}}else d?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),m&&(m.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),h||C?g?.classList.remove("hide"):g?.classList.add("hide"),L&&(L.style.display="flex"),k&&(k.style.display="block"),I&&(I.innerHTML="")}function f(m){if(m.isOpen()){m.close();return}for(;s.length>0;)s.pop().close(!0);s.push(m),m.open(),v()}function w(){[...s].forEach(d=>d.close()),s=[]}window.addEventListener("resize",v);let u=q({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:je(),onOpen:()=>W(),onClose:()=>{let m=s.indexOf(u);m>-1&&s.splice(m,1),v()}}),p=q({id:"events-window",title:"Events",icon:"bx-calendar-event",content:it(),onOpen:()=>ee(),onClose:()=>{let m=s.indexOf(p);m>-1&&s.splice(m,1),v()}}),n=q({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:tt(),onOpen:()=>ge(),onClose:()=>{let m=s.indexOf(n);m>-1&&s.splice(m,1),v()}}),i=q({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:pt()},{icon:"bxs-component",title:"Processes",content:mt()},{icon:"bxs-brain",title:"Models",content:ut()},{icon:"bxs-hdd",title:"Hardware",content:gt()},{icon:"bxs-terminal",title:"Logs",content:vt()},{icon:"bxs-zap",title:"Analyst",content:dt()}],onOpen:()=>{Le(),be(),Ce(),ie()},onClose:()=>{let m=s.indexOf(i);m>-1&&s.splice(m,1),v()}}),l=q({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:Ze(),onOpen:()=>$e(),onClose:()=>{let m=s.indexOf(l);m>-1&&s.splice(m,1),v()}}),y=q({id:"settings-window",title:"Settings",icon:"bx-cog",content:he(),onOpen:()=>{y.setContent(he()),Te(y)},onClose:()=>{let m=s.indexOf(y);m>-1&&s.splice(m,1),v()}}),x=q({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="/dexter/contribute" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});if(e){let m=document.getElementById("dexter-dropdown");m&&(m.innerHTML=`
