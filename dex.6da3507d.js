(()=>{function se(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function ne(t=!1){let p=`
        <div class="nav-left">
    ...
    `,g=document.createElement("nav");g.innerHTML=p,document.body.prepend(g)}function ie(){let t=`
    ...
    `,s=document.createElement("footer");s.innerHTML=t,document.body.appendChild(s)}function J(t){let s=null,p=t.onClose||null,g=t.onOpen||null;function b(){if(s){s.classList.add("open"),g&&setTimeout(g,10);return}let m=document.getElementById("windows-container");m||(m=document.createElement("div"),m.id="windows-container",m.className="windows-container",document.body.appendChild(m)),s=document.createElement("div"),s.id=t.id,s.className="window";let y=t.icon||"bx-window",F="",x="",N;t.tabs&&t.tabs.length>0?(F=`<div class="tab-bar">${t.tabs.map((v,M)=>{let W;return v.icon?W=`<i class="bx ${v.icon}"></i>`:v.title&&v.title.length>0?W=`<span class="tab-glyph">${v.title.charAt(0).toUpperCase()}</span>`:W='<i class="bx bx-question-mark"></i>',`
        ...
        `;s.innerHTML=D+N,m.appendChild(s);let B=s.querySelector(".window-close");B&&B.addEventListener("click",O=>{O.stopPropagation(),h()}),t.tabs&&t.tabs.length>0&&s.querySelectorAll(".tab").forEach(j=>{j.addEventListener("click",()=>{let v=j.getAttribute("data-tab-index");s.querySelectorAll(".tab").forEach(M=>M.classList.remove("active")),j.classList.add("active"),s.querySelectorAll(".tab-content").forEach(M=>M.classList.remove("active")),s.querySelector(`.tab-content[data-tab-content="${v}"]`).classList.add("active")})}),setTimeout(()=>{s.classList.add("open"),g&&g()},10)}function h(m=!1){s&&(m?(s.classList.add("switching"),s.classList.remove("open"),setTimeout(()=>{s&&s.parentNode&&s.parentNode.removeChild(s),s=null},200)):(s.classList.remove("open"),p&&p(),setTimeout(()=>{s&&s.parentNode&&s.parentNode.removeChild(s),s=null},400)))}function w(m){if(s){let y=s.querySelector(".window-content");y&&(y.innerHTML=m)}}function E(){return s&&s.classList.contains("open")}return{open:b,close:h,setContent:w,isOpen:E,id:t.id}}var X="easter_user_email";function ae(){return localStorage.getItem(X)!==null}function Q(){return localStorage.getItem(X)}function oe(t){if(!t||!t.includes("@"))throw new Error("Invalid email address");if(!t.trim().toLowerCase().endsWith("@easter.company"))throw new Error("Access denied. Please check your credentials.");localStorage.setItem(X,t.trim())}var re="easter_theme",L={AUTO:"auto",DEFAULT:"default",ANIMATED:"animated"};function ee(){return localStorage.getItem(re)||L.AUTO}function ue(){let t=window.innerWidth,s=window.innerHeight,p=window.innerHeight===window.screen.height&&window.innerWidth===window.screen.width;return t>1920&&s>1080?L.ANIMATED:(t===1920&&s===1080&&p||t<=1920||s<=1080,L.DEFAULT)}function le(t){if(!Object.values(L).includes(t))throw new Error("Invalid theme");localStorage.setItem(re,t),Z(t)}function Z(t,s=!1){let p=document.body,g=t===L.AUTO?ue():t;if(s||(p.classList.add("theme-transitioning"),setTimeout(()=>{p.classList.remove("theme-transitioning")},300)),Object.values(L).forEach(b=>{p.classList.remove(`theme-${b}`)}),p.classList.add(`theme-${t}`),g===L.ANIMATED){if(!document.querySelector(".background")){let b=document.createElement("div");b.className="background",document.body.prepend(b)}}else{let b=document.querySelector(".background");b&&(s?b.remove():(b.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{b.remove()},400)))}}function ce(){let t=ee();if(Z(t,!0),t===L.AUTO){let s;window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{Z(L.AUTO)},300)})}}function z(t,s,p=null){let b={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",h=p?`<p class="placeholder-action">${p}</p>`:"";return`
...
`);return`
            ...
            `}).join("");return t.innerHTML=F,document.querySelectorAll(".copy-logs-btn").forEach(x=>{x.addEventListener("click",()=>{let N=unescape(x.dataset.logs);navigator.clipboard.writeText(N).then(()=>{let D=x.querySelector("i");D.classList.remove("bx-copy"),D.classList.add("bx-check"),setTimeout(()=>{D.classList.remove("bx-check"),D.classList.add("bx-copy")},2e3)})})}),!0}catch(w){return console.error("Error fetching logs:",w),t.classList.add("placeholder-active"),t.innerHTML=z("offline","Failed to load logs.","The event service may be offline, unreachable, or blocked by a browser extension (e.g., ad blocker)."),!1}}function pe(){console.log("Welcome to Easter Company."),ce(),se();let t=ae();ne(t),ie();let s=document.querySelector("footer"),p=null;function g(){p=null,s?.classList.remove("hide"),document.querySelectorAll(".nav-right i").forEach(n=>n.classList.remove("active","inactive"))}function b(n,r=null){let a=p&&p.id===n.id;p&&p.close(!a),a?p=null:setTimeout(()=>{n.open(),p=n,document.querySelectorAll(".nav-right i").forEach(l=>{let u=l===r;l.classList.toggle("active",u),l.classList.toggle("inactive",!u&&r)}),s?.classList.add("hide")},p?220:0)}function h(n,r,a=null){let u={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[n]||"bx-info-circle",f=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${u} placeholder-icon'></i><p class="placeholder-message">${r}</p>${f}</div>`}let w=null,E=null,m=null,y=null,F=()=>localStorage.getItem("service_map")?'<div id="services-widgets" class="system-monitor-widgets"><p>Loading services...</p></div>':h("config","No service map configured.","Upload service-map.json in Settings."),x=()=>localStorage.getItem("service_map")?'<div id="models-widgets" class="system-monitor-widgets"><p>Loading models...</p></div>':h("config","No service map configured.","Upload service-map.json in Settings."),N=()=>'<div id="events-timeline" class="events-timeline"><p>Loading events...</p></div>';async function D(){if(!localStorage.getItem("service_map"))return null;try{let r=(JSON.parse(localStorage.getItem("service_map")).services?.cs||[]).find(f=>f.id==="dex-event-service");if(!r)return null;let l=`http://${r.domain==="0.0.0.0"?"localhost":r.domain}:${r.port}/system_monitor_metrics`,u=await fetch(l);if(!u.ok)throw new Error(`HTTP error! status: ${u.status}`);return await u.json()}catch(n){return console.error("Error fetching system data:",n),null}}async function B(){let n=document.getElementById("services-widgets");if(!n)return;let r=await D();if(!r||!r.services){n.innerHTML=h("offline","Failed to load system metrics.","The event service may be offline or unreachable.");return}w=Date.now(),v(4,w);let a=r.services||[];Array.from(n.children).forEach(e=>{e.classList.contains("service-widget")||e.remove()});function l(e){return!e||e==="N/A"||e==="unknown"||e.trim()===""?"-":e}function u(e){if(!e||e==="N/A"||e==="unknown")return"-";let i=e.match(/^(\d+\.\d+\.\d+)/);return i?i[0]:e.split(".").slice(0,3).join(".")||"-"}function f(e){return!e||e.length<=28?e:e.substring(0,28)+"..."}function d(e){if(!e||!e.includes("%"))return"#666";let i=parseFloat(e);return i<30?"#00ff00":i<60?"#88ff00":i<80?"#ffaa00":"#ff0000"}function o(e){if(!e||e==="N/A"||e==="unknown")return"-";let i=e.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!i)return"-";let k=parseInt(i[1])||0,C=parseInt(i[2])||0,U=parseInt(i[3])||0,S=parseFloat(i[4])||0,A=k*86400+C*3600+U*60+S,I=Math.floor(A/86400);if(I>0)return`${I}d`;let H=Math.floor(A/3600);if(H>0)return`${H}h`;let _=Math.floor(A/60);return _>0?`${_}m`:`${Math.floor(A)}s`}function $(e){let i=e.status==="online",k=i?"service-widget-online":"service-widget-offline",C=i?"bx-check-circle":"bx-x-circle",U=i?"OK":"BAD",S=e.version?u(e.version.str):"-",A=l(e.cpu),I=l(e.memory),H=d(A),_=d(I),K=o(e.uptime),R="";return i?R=`<div class="service-widget-info"><span class="info-label">Version:</span><span class="info-value metric-version-monospace">${S}</span></div><div class="service-widget-footer"><div class="service-widget-item"><i class="bx bx-time-five"></i><span>${K}</span></div><div class="service-widget-item"><i class="bx bxs-microchip" style="color: ${H};"></i><span style="color: ${H};">${A}</span></div><div class="service-widget-item"><i class="bx bxs-chip" style="color: ${_};"></i><span style="color: ${_};">${I}</span></div></div>`:R='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${k}" data-service-id="${e.id}"><div class="service-widget-header"><i class="bx ${C}"></i><h3>${e.short_name||e.id}</h3><span class="service-widget-status">${U}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${f(e.domain&&e.port?`${e.domain}:${e.port}`:"")}</span></div>${R}</div></div>`}let T=new Map(Array.from(n.querySelectorAll(".service-widget")).map(e=>[e.dataset.serviceId,e])),c=new Set(a.map(e=>e.id));for(let[e,i]of T)c.has(e)||i.remove();a.forEach(e=>{let i=$(e),k=T.get(e.id);k?k.outerHTML!==i&&(k.outerHTML=i):n.insertAdjacentHTML("beforeend",i)})}async function O(){let n=document.getElementById("models-widgets");if(!n)return;let r=await D();if(!r){n.innerHTML=h("offline","Failed to load model status.");return}y=Date.now(),v(3,y);let a=r.models||[],l=r.whisper;Array.from(n.children).forEach(o=>{o.classList.contains("service-widget")||o.remove()});function u(o){let $=o.status==="Ready";return`
                ...
                </div>`}function f(o){let $=o.status==="Downloaded",T=$?"service-widget-online":"service-widget-offline",c=$?"OK":"MISSING",e=$&&o.size>0?`${(o.size/1e9).toFixed(2)} GB`:"-",i=o.name;return o.type==="custom"&&i.endsWith(":latest")&&(i=i.replace(":latest","")),`<div class="service-widget ${T}" data-model-name="${o.name}"><div class="service-widget-header"><i class="bx ${$?"bx-check-circle":"bx-x-circle"}"></i><h3>${i}</h3><span class="service-widget-status">${c}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${o.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${e}</span></div></div></div>`}let d="";if(l&&(d+=u(l)),d+=a.map(f).join(""),!d){n.innerHTML=h("empty","No models found.");return}n.innerHTML!==d&&(n.innerHTML=d)}async function j(){let n=document.getElementById("events-timeline");if(!n)return;let r=localStorage.getItem("service_map");if(!r){n.innerHTML=h("config","No service map configured.","Upload service-map.json in Settings.");return}let a=null;try{a=(JSON.parse(r).services?.cs||[]).find(d=>d.id==="dex-event-service")}catch{n.innerHTML=h("error","Invalid service map data.");return}if(!a){n.innerHTML=h("error","Event service not found in service map.");return}let u=`http://${a.domain==="0.0.0.0"?"localhost":a.domain}:${a.port}/events?ml=50&format=json`;try{let f=await fetch(u);if(!f.ok)throw new Error("Service is offline or unreachable.");let o=(await f.json()).events||[];if(o.length===0){n.innerHTML=h("empty","No events found.");return}let $=o.map(T=>{let c=T.event;if(typeof c=="string")try{c=JSON.parse(c)}catch{return""}let e=c.type,i=e==="engagement.decision",k=i?"event-border-blue":"event-border-grey",C=i?"cursor-pointer":"",U=new Date(T.timestamp*1e3),S=U.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),A=U.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),I=`${e}`;e==="message_received"||e==="messaging.user.sent_message"?I=`${c.user_name||c.user} in ${c.channel_name||c.channel}: ${c.content||c.message}`:e==="engagement.decision"?I=`Engagement Decision: ${c.decision} (${c.reason})`:e==="bot_response"?I=`Bot Responded: ${c.response}`:(e==="voice_transcribed"||e==="messaging.user.transcribed")&&(I=`${c.user_name||c.user_id} said: ${c.transcription}`);let H="";return i&&(H=`
