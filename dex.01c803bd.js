(()=>{function He(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ne(t=!1){let e=window.location.pathname,o=e==="/"||e==="/index.html",i=`
    ...
    `}
        ...
        `}
    `,l=document.createElement("nav");l.innerHTML=i,document.body.prepend(l)}function Pe(t){let e=window.location.pathname,o=e==="/"||e==="/index.html",a=document.getElementById("nav-chevron"),s=document.querySelector(".nav-left");!a||!s||(t||!o?(a.style.display="block",s.style.cursor="pointer",s.classList.add("recording"),s.onmouseenter=()=>{a.style.transform="translateX(-3px)"},s.onmouseleave=()=>{a.style.transform="translateX(0)"}):(a.style.display="none",s.style.cursor="default",s.classList.remove("recording"),s.onmouseenter=null,s.onmouseleave=null))}function Re(){if(document.querySelector("footer"))return;let t=`
...
`,ue=null,G=new Set,ge=[];async function W(t=!1){let e=document.getElementById("alerts-list");if(!e)return;Bt(),t&&(e.innerHTML="<p>Updating...</p>");let o="/events?ml=1000&format=json&event.type=system.notification.generated";try{let a=await k(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];ue=Date.now(),O(0,ue);let l=Date.now(),f=24*60*60*1e3,v=i.filter(n=>{let m=localStorage.getItem(`alert_read_ts_${n.id}`);if(!m)return!0;let y=parseInt(m);return l-y<f});v.sort((n,m)=>{let y=I=>{let A=I.event;if(typeof A=="string")try{A=JSON.parse(A)}catch{return"low"}return(A.priority||"low").toLowerCase()},$=I=>I==="critical"?4:I==="high"?3:I==="medium"?2:1,E=$(y(n)),S=$(y(m));return E!==S?S-E:m.timestamp-n.timestamp}),ge=v;let d=n=>{let m=n.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return"low"}return(m.priority||"low").toLowerCase()},x=[],h=new Set(v.map(n=>d(n))).size>1;if(v.length>0){let n=null;v.forEach(m=>{let y=d(m);h&&y!==n&&(x.push({id:`divider-${y}`,type:"divider",label:y.toUpperCase()}),n=y),x.push(m)})}if(t&&(e.innerHTML=""),v.length===0){e.innerHTML=C("empty","No alerts yet."),me();return}let b=n=>{let m=n.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let y=m.title||"Untitled Alert",$=m.body||"No description provided.",E=m.priority||"low",S=!!m.alert,I=m.category||"system",A=m.related_event_ids||[],D=m.audit_event_id,_=!!localStorage.getItem(`alert_read_ts_${n.id}`),H=new Date(n.timestamp*1e3),R=H.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),L=H.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),T=_?"event-border-grey":"event-border-blue";!_&&S&&(T="event-border-red"),_&&(E==="high"||E==="critical")?T="event-border-red":_&&E==="medium"&&(T="event-border-orange");let N=_?"alert-read":"alert-unread",P=G.has(n.id),xe=P?"expanded":"",he=P?"display: block;":"display: none;",Ae="",_e="";A.length>0&&(_e=`
...
`,et=null,ee=new Set,nt=[];async function fe(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;Rt();let o="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let a=await k(o);if(!a.ok)throw new Error("Service is offline or unreachable.");let i=(await a.json()).events||[];if(nt=i,et=Date.now(),O(2,et),i.length===0){e.innerHTML=C("empty","No architectural blueprints generated yet.","The Analyst Worker will generate these when idle."),ne(1,0);return}t&&(e.innerHTML="");let l=u=>{let h=u.event;if(typeof h=="string")try{h=JSON.parse(h)}catch{return null}let b=h.title||"Untitled Blueprint",r=h.summary||h.body||"No summary provided.",p=h.content||"",c=h.category||"architecture",g=h.affected_services||[],w=h.implementation_path||[],n=new Date(u.timestamp*1e3),m=n.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),y=n.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),$=ee.has(u.id),E=$?"display: block;":"display: none;",S=document.createElement("div");S.className=`event-item notification-item event-border-purple cursor-pointer ${$?"expanded":""}`,S.dataset.blueprintId=u.id;let A={architecture:"bx-vector",optimization:"bx-trending-up",feature:"bx-extension",security:"bx-shield-lock"}[c]||"bx-paint";S.onclick=function(R){if(this.classList.contains("expanded")){this.classList.remove("expanded"),ee.delete(u.id);let T=this.querySelector(".event-details");T&&(T.style.display="none")}else{this.classList.add("expanded"),ee.add(u.id);let T=this.querySelector(".event-details");T&&(T.style.display="block")}};let D=g.length>0?`<div class="event-detail-row"><span class="detail-label">Related Services:</span> <span class="detail-value">${g.join(", ")}</span></div>`:"",B="";w.length>0&&(B=`
            ...
            `;let _=S.querySelector(".event-details");_&&_.addEventListener("click",R=>{R.stopPropagation()});let H=S.querySelector(".close-details-btn");return H&&H.addEventListener("click",R=>{R.stopPropagation(),S.classList.remove("expanded");let L=S.querySelector(".event-details");L&&(L.style.display="none"),ee.delete(u.id)}),S},f=Array.from(e.children),v=new Map(f.map(u=>[u.dataset.blueprintId,u])),d=new Set(i.map(u=>u.id));f.forEach(u=>{let h=u.dataset.blueprintId;(!h||!d.has(h))&&u.remove()});let x=null;i.forEach((u,h)=>{let b=v.get(u.id);(!b||t)&&(b&&b.remove(),b=l(u),!b)||(h===0?e.firstElementChild!==b&&e.prepend(b):x&&x.nextElementSibling!==b&&x.after(b),x=b)}),ne(2,i.length)}catch(a){console.error("Error fetching blueprints:",a),e.children.length===0&&(e.innerHTML=C("offline","Failed to load blueprints.","The event service may be offline."))}}function Rt(){let t=document.getElementById("blueprints-expand-all"),e=document.getElementById("blueprints-close-all");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{nt.forEach(o=>ee.add(o.id)),fe(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{ee.clear(),fe(!0)},e.dataset.listenerAttached="true")}var it=()=>`
...
`);return`
        ...
        <div id="logs-container-wrapper" style="margin-bottom: 20px;">
            ${ct()}
        </div>`;async function wt(){await Promise.all([be(),Ce(),Te()]),await le()}var dt=null,mt=null,pt=null;async function Et(){try{return await(await k("/system_monitor")).json()}catch{return null}}async function ut(){try{return await(await k("/system/hardware")).json()}catch{return null}}async function Wt(){try{return await(await k("/processes")).json()}catch{return null}}async function Vt(){try{return await(await k("/analyst/status")).json()}catch{return null}}async function Ce(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-refresh-btn"),o=document.querySelector("#hw-cpu .hw-content"),a=document.querySelector("#hw-ram .hw-content"),s=document.querySelector("#hw-gpu .hw-content"),i=document.querySelector("#hw-storage .hw-content"),l=c=>{if(c){if(a){let g=(c.MEMORY_BYTES/1073741824).toFixed(1);a.innerHTML=`
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                    ...
                    </div>`}).join(""):i&&(i.innerHTML='<p style="text-align: center; color: #666; margin: 0;">No storage devices found</p>')}};if(e&&(e.dataset.listenerAttached||(e.onclick=async()=>{e.innerHTML="<i class='bx bx-loader-alt spin'></i> Refreshing...";let c=await ut();c?(l(c),e.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3)):(e.innerHTML="<i class='bx bx-error'></i> Failed",setTimeout(()=>{e.innerHTML="<i class='bx bx-refresh'></i> Refresh"},2e3))},e.dataset.listenerAttached="true"),o&&!o.hasChildNodes())){let c=await ut();l(c)}if(!t)return;let f=await Et();if(!f||!f.services){t.children.length===0&&(t.innerHTML=C("offline","Failed to load system metrics.","The event service may be offline."));return}dt=Date.now(),O(0,dt);let v=f.services||[];Array.from(t.children).forEach(c=>{c.classList.contains("service-widget")||c.remove()});function d(c){return!c||c==="N/A"||c==="unknown"||c.trim()===""?"-":c}function x(c){if(!c||c==="N/A"||c==="unknown")return"-";let g=c.match(/^(\d+\.\d+\.\d+)/);return g?g[0]:c.split(".").slice(0,3).join(".")||"-"}function u(c){return!c||c.length<=28?c:c.substring(0,28)+"..."}function h(c){if(!c||c==="N/A"||c==="unknown")return"-";let g=c.match(/(?:(\d+)d)?(?:(\d+)h)?(?:(\d+)m)?(?:([\d.]+)s)?/);if(!g)return"-";let w=parseInt(g[1])||0,n=parseInt(g[2])||0,m=parseInt(g[3])||0,y=parseFloat(g[4])||0,$=w*86400+n*3600+m*60+y,E=Math.floor($/86400);if(E>0)return`${E}d`;let S=Math.floor($/3600);if(S>0)return`${S}h`;let I=Math.floor($/60);return I>0?`${I}m`:`${Math.floor($)}s`}function b(c){let g=c.status==="online",w=g?"service-widget-online":"service-widget-offline",n=g?"bx-check-circle":"bx-x-circle",m=g?"OK":"BAD",y=c.version?x(c.version.str):"-",$=c.cpu&&c.cpu!=="N/A"?c.cpu:"-",E=c.memory&&c.memory!=="N/A"?c.memory:"-",S=$!=="-"?"#00ff00":"#666",I=$!=="-"?"#fff":"#666",A=E!=="-"?"#00ff00":"#666",D=E!=="-"?"#fff":"#666",B=h(c.uptime),_="";return g?_=`
                ...
                </div>`}function i(f){let v=f.status==="Downloaded",d=v?"service-widget-online":"service-widget-offline",x=v?"OK":"MISSING",u=v&&f.size>0?`${(f.size/1e9).toFixed(2)} GB`:"-",h=f.name;return f.type==="custom"&&h.endsWith(":latest")&&(h=h.replace(":latest","")),`<div class="service-widget ${d}" data-model-name="${f.name}"><div class="service-widget-header"><i class="bx ${v?"bx-check-circle":"bx-x-circle"}"></i><h3>${h}</h3><span class="service-widget-status">${x}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Type:</span><span class="info-value">${f.type}</span></div><div class="service-widget-info"><span class="info-label">Size:</span><span class="info-value">${u}</span></div></div></div>`}let l="";if(a&&(l+=s(a)),l+=o.map(i).join(""),!l){t.innerHTML=C("empty","No models found.");return}t.innerHTML!==l&&(t.innerHTML=l)}async function be(){let t=document.getElementById("processes-widgets");if(!t)return;let e=document.getElementById("analyst-t1-val"),o=document.getElementById("analyst-t2-val"),a=document.getElementById("analyst-t3-val"),s=document.getElementById("analyst-idle-val"),i=document.getElementById("analyst-total-idle"),l=document.getElementById("analyst-total-active"),f=document.getElementById("analyst-total-waste"),v=document.getElementById("analyst-reset-btn");v&&!v.dataset.listenerAttached&&(v.onclick=async()=>{v.innerHTML="<i class='bx bx-loader-alt spin'></i> Resetting...";try{await k("/analyst/reset?tier=all",{method:"POST"}),setTimeout(()=>{v.innerHTML="<i class='bx bx-check'></i> Done",setTimeout(()=>{v.innerHTML="<i class='bx bx-refresh'></i> Reset"},2e3)},500),be()}catch{v.innerHTML="<i class='bx bx-error'></i> Failed"}},v.dataset.listenerAttached="true");let d=await Vt();if(d){let p=Math.floor(Date.now()/1e3),c=d.active_tier,g=n=>{n<0&&(n=0);let m=Math.floor(n/3600),y=Math.floor(n%3600/60),$=n%60;return m>0?`${m}h ${y}m`:y>0?`${y}m ${$}s`:`${$}s`},w=(n,m,y)=>{if(c===y||y==="guardian"&&c==="tests"){n.textContent="Working",n.style.color="#bb86fc";return}let $=m-p;if($<=0)n.textContent="Ready",n.style.color="#5eff5e";else{let E=Math.floor($/60),S=$%60;n.textContent=`${E}m ${S}s`,n.style.color="#fff"}};if(e&&d.guardian&&w(e,d.guardian.next_run,"guardian"),o&&d.architect&&w(o,d.architect.next_run,"architect"),a&&d.strategist&&w(a,d.strategist.next_run,"strategist"),s&&d.system_idle_time!==void 0){let n=d.system_idle_time;s.textContent=g(n),n>300?s.style.color="#5eff5e":n>60?s.style.color="#ffa500":s.style.color="#fff"}i&&(i.textContent=g(d.total_idle_time||0)),l&&(l.textContent=g(d.total_active_time||0)),f&&(f.textContent=g(d.total_waste_time||0))}else[e,o,a,s,i,l,f].forEach(c=>{c&&(c.textContent="-",c.style.color="#666")});let x=await Wt(),u=[],h=[];x&&(Array.isArray(x)?u=x:(u=x.active||[],h=x.history||[]));let b=document.getElementById("vitals-processes-val");if(b)if(x){let p=u.length;b.textContent=p>0?`${p} Active`:"Idle",b.style.color=p>0?"#bb86fc":"#fff"}else b.textContent="-",b.style.color="#888";if(x===null){t.children.length===0&&(t.innerHTML=C("offline","Failed to load process status.","The event service may be offline."));return}pt=Date.now(),O(1,pt),u.length===0?t.querySelector(".tab-placeholder")||(t.innerHTML=C("empty","No active processes.")):((t.querySelector(".tab-placeholder")||t.querySelector("p"))&&(t.innerHTML=""),gt(t,u,!1));let r=document.getElementById("processes-history-widgets");r&&(h.length===0?r.querySelector(".tab-placeholder")||(r.innerHTML=C("empty","No recent history.")):(r.querySelector(".tab-placeholder")&&(r.innerHTML=""),gt(r,h,!0))),ne(1,u.length)}function gt(t,e,o){function a(l){let f="";l.end_time?f=`${l.end_time-l.start_time}s`:f=`${Math.floor(Date.now()/1e3-l.start_time)}s`;let v=l.retries>0?`<span class="process-retry-badge">Retry ${l.retries}</span>`:"",d=l.channel_id,x={"system-discord":"Discord Engine","system-analyst":"Analyst Worker","system-cli-op":"CLI Operation"};x[d]?d=x[d]:/^\d+$/.test(d)&&(d=`Channel ${d}`);let u=o?"#888":"#fff",h=o?"border-left: 3px solid #666;":"";return`
                ...
                </div>`}let s=new Map(Array.from(t.querySelectorAll(".process-widget")).map(l=>[l.dataset.channelId,l])),i=new Set(e.map(l=>`${l.channel_id}-${l.start_time}`));for(let[l,f]of s)i.has(l)||f.remove();e.forEach(l=>{let f=`${l.channel_id}-${l.start_time}`,v=a(l),d=s.get(f);d?d.outerHTML!==v&&(d.outerHTML=v):t.insertAdjacentHTML("beforeend",v)})}function ye(){let t=se(),e=ze()||"master@easter.company",o={enabled:Notification.permission==="granted",supported:"Notification"in window},a=localStorage.getItem("easter_analytics_enabled")!=="false";return`
...
dex config reset`},demo_output:["{",'  "id": "event-service",','  "short_name": "event",','  "type": "be",','  "port": 8100,','  "domain": "127.0.0.1",','  "log_path": "~/Dexter/logs/event-service.log"',"}"]}],Jt=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
    ...
    `,document.getElementById("terminal-cmd-name").textContent=`dex ${t.id}`,document.getElementById("terminal-status-badge").className="terminal-status status-running",document.getElementById("terminal-status-badge").textContent="Running",document.getElementById("terminal-action-btn").style.display="none",e.classList.add("active"),Ie=!0,o}function $t(){let t=document.getElementById("cli-terminal-overlay");t&&t.classList.remove("active"),Ie=!1}function St(t,e,o="output"){if(!Ie)return;let a=document.createElement("div");a.className=`terminal-line terminal-${o}`,o==="prompt"?a.innerHTML=`<span class="terminal-prompt">$</span> ${e}`:a.innerHTML=pe(e),t.appendChild(a),t.scrollTop=t.scrollHeight}async function Xt(t){let e=Lt.find(s=>s.id===t);if(!e)return;let o=Yt(e);St(o,`dex ${t}`,"prompt");let a=e.demo_output||["Executing command...","\u2713 Done."];for(let s of a){await new Promise(l=>setTimeout(l,400+Math.random()*600));let i="output";s.includes("[ERROR]")?i="error":s.includes("[SUCCESS]")||s.includes("\u2713")?i="success":s.includes("!")&&(i="warning"),St(o,s,i)}document.getElementById("terminal-status-badge").className="terminal-status status-success",document.getElementById("terminal-status-badge").textContent="Completed (Demo)",document.getElementById("terminal-action-btn").style.display="block"}function Ct(){let t=document.getElementById("cli-interface-container");if(!t)return;t.innerHTML=Jt();let e=document.getElementById("install-command-copy");e&&e.addEventListener("click",()=>{let o=e.querySelector("code").textContent;navigator.clipboard.writeText(o).then(()=>{let a=e.querySelector("i");a.className="bx bx-check",a.style.color="#5eff5e",setTimeout(()=>{a.className="bx bx-copy",a.style.color="#bb86fc"},2e3)})}),t.querySelectorAll(".cli-command-card").forEach(o=>{o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-5px)",o.style.borderColor="rgba(255,255,255,0.15)",o.style.backgroundColor="rgba(255,255,255,0.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)",o.style.borderColor="rgba(255,255,255,0.05)",o.style.backgroundColor="rgba(255,255,255,0.03)"}),o.addEventListener("click",()=>{let a=o.dataset.cmd;Xt(a)})})}async function Zt(){if(window.location.hostname==="easter.company")try{if(!(await fetch(`${$e()}/system/status`,{method:"HEAD"})).ok)throw new Error("Service unhealthy")}catch{console.error("Production event service unreachable.")}}function Tt(){Zt(),Ge(),He();let t=window.location.pathname;(t.includes("/dexter/cli")||t==="/cli"||t==="/cli/")&&Ct();let e=Ue();Ne(e),Re();let o=document.getElementById("nav-left-container");o&&o.addEventListener("click",()=>{if(i.length>0)u();else{let n=window.location.pathname;if(!(n==="/"||n==="/index.html")){let $=(n.endsWith("/")&&n.length>1?n.slice(0,-1):n).split("/");$.pop();let E=$.join("/")||"/";window.location.href=E}}});let a=window.location.pathname==="/"||window.location.pathname==="/index.html",s=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");!a&&!s&&document.querySelector("footer")?.classList.add("hide");let i=[],l=document.getElementById("windows-container");l&&l.setAttribute("data-count","0");let f=n=>{localStorage.setItem("dex_last_window",n)};function v(){return 1}function d(){for(;i.length>1;)i.shift().close(!0);let n=document.getElementById("windows-container"),m=document.querySelector("nav"),y=document.querySelector("footer"),$=window.location.pathname==="/"||window.location.pathname==="/index.html",E=window.location.pathname.includes("404")||!!document.getElementById("error-main-view");n&&n.setAttribute("data-count",i.length);let S=i.length>0;i.forEach(B=>{let _=document.getElementById(B.id);_&&_.classList.remove("hide-close")}),re(se());let I=document.getElementById("dexter-menu-container"),A=document.getElementById("nav-window-switcher"),D=document.getElementById("settings-icon");if(Pe(i.length>0),i.length>0){if(y?.classList.add("hide"),document.getElementById("close-all-windows")?.style.setProperty("display","block"),document.querySelector("main")?.style.setProperty("opacity","0.3","important"),m?.classList.add("window-open"),n&&(n.style.paddingTop="60px"),I&&(I.style.display="none"),D&&(D.style.display="none"),A){let B=i[0].id;["alerts-window","events-window","monitor-window","contacts-window","workspace-window"].includes(B)?(A.innerHTML=`
                  ...
                  `,document.getElementById("switch-alerts").addEventListener("click",()=>{f("alerts-window"),x(h)}),document.getElementById("switch-events").addEventListener("click",()=>{f("events-window"),x(b)}),document.getElementById("switch-monitor").addEventListener("click",()=>{f("monitor-window"),x(p)}),document.getElementById("switch-contacts").addEventListener("click",()=>{f("contacts-window"),x(r)}),document.getElementById("switch-workspace").addEventListener("click",()=>{f("workspace-window"),x(c)})):A.innerHTML=""}}else m?.classList.remove("window-open"),document.getElementById("close-all-windows")?.style.setProperty("display","none"),n&&(n.style.paddingTop="100px"),document.querySelector("main")?.style.setProperty("opacity","1","important"),$||E?y?.classList.remove("hide"):y?.classList.add("hide"),I&&(I.style.display="flex"),D&&(D.style.display="block"),A&&(A.innerHTML="");ie(Ve())}function x(n){if(n.isOpen()){n.close();return}for(;i.length>0;)i.pop().close(!0);i.push(n),n.open(),d()}function u(){[...i].forEach(m=>m.close()),i=[]}window.addEventListener("resize",d);let h=j({id:"alerts-window",title:"Alerts",icon:"bx-bell",content:Je(),onOpen:()=>W(),onClose:()=>{let n=i.indexOf(h);n>-1&&i.splice(n,1),d()}}),b=j({id:"events-window",title:"Events",icon:"bx-calendar-event",content:rt(),onOpen:()=>Y(),onClose:()=>{let n=i.indexOf(b);n>-1&&i.splice(n,1),d()}}),r=j({id:"contacts-window",title:"Contacts",icon:"bx-book-content",content:at(),onOpen:()=>Le(),onClose:()=>{let n=i.indexOf(r);n>-1&&i.splice(n,1),d()}}),p=j({id:"monitor-window",icon:"bx-pulse",tabs:[{icon:"bxs-server",title:"Services",content:bt()},{icon:"bxs-component",title:"Processes",content:vt()},{icon:"bxs-brain",title:"Models",content:yt()},{icon:"bxs-hdd",title:"Hardware",content:xt()},{icon:"bxs-terminal",title:"Logs",content:ht()},{icon:"bxs-zap",title:"Agents",content:ft()}],onOpen:()=>{Ce(),be(),Te(),le()},onClose:()=>{let n=i.indexOf(p);n>-1&&i.splice(n,1),d()}}),c=j({id:"workspace-window",title:"Workspace",icon:"bx-brain",content:it(),onOpen:()=>Se(),onClose:()=>{let n=i.indexOf(c);n>-1&&i.splice(n,1),d()}}),g=j({id:"settings-window",title:"Settings",icon:"bx-cog",content:ye(),onOpen:()=>{g.setContent(ye()),ke(g)},onClose:()=>{let n=i.indexOf(g);n>-1&&i.splice(n,1),d()}}),w=j({id:"login-window",title:"Welcome",content:'<div class="login-split-container"><div class="login-top-section"><div class="login-form"><p>Enter your email to continue</p><form id="login-form"><input type="email" id="email-input" placeholder="you@easter.company" required autocomplete="email" /><button type="submit">Continue</button><div id="login-error" class="error" style="display: none;"></div></form></div></div><div class="login-bottom-section"><div class="login-disclaimer"><h2>Early Access</h2><p>Contribute on <a href="/dexter/contribute" target="_blank" rel="noopener noreferrer">GitHub</a> to unlock early access.</p></div></div></div>',icon:"bx-log-in"});if(window.dexter={viewEvent:n=>{b.isOpen()||x(b),setTimeout(()=>{let m=document.querySelector(`.event-item[data-event-id="${n}"]`);m&&(m.scrollIntoView({behavior:"smooth",block:"center"}),m.classList.add("flash-highlight"),m.classList.contains("expanded")||m.click(),setTimeout(()=>m.classList.remove("flash-highlight"),2e3))},500)},viewAlert:n=>{h.isOpen()||x(h),setTimeout(()=>{let m=document.querySelector(`.event-item[data-alert-id="${n}"]`);m&&(m.scrollIntoView({behavior:"smooth",block:"center"}),m.classList.add("flash-highlight"),m.classList.contains("expanded")||m.click(),setTimeout(()=>m.classList.remove("flash-highlight"),2e3))},500)}},e){let n=document.getElementById("dexter-dropdown");n&&(n.innerHTML=`
