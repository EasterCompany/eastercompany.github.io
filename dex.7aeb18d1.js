(()=>{function _e(){console.log("Applying base styles dynamically (e.g., for background animation or theme toggles).")}function Ae(t=!1){let a=`
    ...
    `,e=document.createElement("footer");e.innerHTML=t,document.body.appendChild(e)}var Me=1e3;function G(t){let e=null,a=t.onClose||null,i=t.onOpen||null;function o(){e&&(e.style.zIndex=++Me)}function r(){if(e){e.classList.add("open"),o(),window.addEventListener("resize",c),i&&setTimeout(i,10);return}let p=document.getElementById("windows-container");p||(p=document.createElement("div"),p.id="windows-container",p.className="windows-container",document.body.appendChild(p)),e=document.createElement("div"),e.id=t.id,e.className="window",e.style.zIndex=++Me,e.addEventListener("mousedown",o);let m=t.icon||"bx-window",n="",s="",l;t.tabs&&t.tabs.length>0?(n=`<div class="tab-bar">${t.tabs.map((w,d)=>{let v=w.icon?`<i class="bx ${w.icon}"></i>`:`<span class="tab-glyph">${w.title?.charAt(0).toUpperCase()||"?"}</span>`;return`
            ...
            ${l}
        `,p.appendChild(e),e.querySelector(".window-close")?.addEventListener("click",y=>{y.stopPropagation(),u()}),window.addEventListener("resize",c),t.tabs&&e.querySelectorAll(".tab").forEach(y=>{y.addEventListener("click",()=>{let h=y.getAttribute("data-tab-index");e.querySelectorAll(".tab").forEach(w=>w.classList.remove("active")),y.classList.add("active"),e.querySelectorAll(".tab-content").forEach(w=>w.classList.remove("active")),e.querySelector(`.tab-content[data-tab-content="${h}"]`).classList.add("active"),g(y,e)})}),setTimeout(()=>{e.classList.add("open"),i&&i()},10)}function c(){if(!e||!e.classList.contains("open"))return;let p=e.querySelector(".tab.active");p&&g(p,e)}function g(p,m){setTimeout(()=>{let n=m.querySelector(".tab-bar");if(!n)return;let s=Array.from(n.querySelectorAll(".tab")),l=s.indexOf(p),y=n.clientWidth,h=s[Math.max(0,l-2)],w=s[Math.min(s.length-1,l+2)],d=h.offsetLeft-n.offsetLeft-25,x=w.offsetLeft+w.offsetWidth-n.offsetLeft+25-d,C=x<=y?d-(y-x)/2:p.offsetLeft-n.offsetLeft-y/2+p.offsetWidth/2;n.scrollTo({left:C,behavior:"smooth"})},350)}function u(p=!1){e&&(window.removeEventListener("resize",c),p?(e.remove(),e=null):(e.classList.remove("open"),a&&a(),setTimeout(()=>{e?.remove(),e=null},400)))}function f(p){let m=e?.querySelector(".window-content");m&&(m.innerHTML=p)}function b(){return e&&e.classList.contains("open")}return{open:r,close:u,setContent:f,isOpen:b,focus:o,id:t.id}}function Be(){return!0}function De(){return localStorage.getItem("easter_user_email")||"master@easter.company"}function Ne(t){localStorage.setItem("easter_user_email",t.trim())}var He="easter_theme",B={AUTO:"auto",DEFAULT:"default",ANIMATED:"animated"};function ve(){return localStorage.getItem(He)||B.AUTO}function dt(){let t=window.innerWidth,e=window.innerHeight,a=window.innerHeight===window.screen.height&&window.innerWidth===window.screen.width;return t>1920&&e>1080?B.ANIMATED:(t===1920&&e===1080&&a||t<=1920||e<=1080,B.DEFAULT)}function Oe(t){if(!Object.values(B).includes(t))throw new Error("Invalid theme");localStorage.setItem(He,t),ge(t)}function ge(t,e=!1){let a=document.body,i=t===B.AUTO?dt():t;if(e||(a.classList.add("theme-transitioning"),setTimeout(()=>{a.classList.remove("theme-transitioning")},300)),Object.values(B).forEach(o=>{a.classList.remove(`theme-${o}`)}),a.classList.add(`theme-${t}`),i===B.ANIMATED){if(!document.querySelector(".background")){let o=document.createElement("div");o.className="background",document.body.prepend(o)}}else{let o=document.querySelector(".background");o&&(e?o.remove():(o.style.animation="fadeOutBackground 0.4s ease forwards",setTimeout(()=>{o.remove()},400)))}}function Pe(){let t=ve();if(ge(t,!0),t===B.AUTO){let e;window.addEventListener("resize",()=>{clearTimeout(e),e=setTimeout(()=>{ge(B.AUTO)},300)})}}function T(t,e,a=null){let o={config:"bx-cog",error:"bx-error-circle",empty:"bx-info-circle",offline:"bx-wifi-off"}[t]||"bx-info-circle",r=a?`<p class="placeholder-action">${a}</p>`:"";return`<div class="tab-placeholder"><i class='bx ${o} placeholder-icon'></i><p class="placeholder-message">${e}</p>${r}</div>`}function k(t){return t&&t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function D(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"] .tab-subtitle`);if(!a)return;if(!e){a.textContent="Last updated: never";return}let i=Date.now(),o=Math.floor((i-e)/1e3),r;o<60?r=`${o}s ago`:o<3600?r=`${Math.floor(o/60)}m ago`:r=`${Math.floor(o/3600)}h ago`,a.textContent=`Last updated: ${r}`}function z(t,e){let a=document.querySelector(`.tab[data-tab-index="${t}"]`);if(!a)return;let i=a.querySelector(".notification-badge");i&&(e>0?(i.textContent=e>9?"9+":e,i.style.display="flex"):i.style.display="none")}function ie(){let t=document.getElementById("notifications-list");if(!t)return;let e=t.querySelectorAll(".notification-unread").length;z(0,e)}function ye(){return"https://event.easter.company"}function pt(){return"https://discord.easter.company"}var mt="http://127.0.0.1:8100",ut="http://127.0.0.1:8300",ft={31:"ansi-red",91:"ansi-bright-red",32:"ansi-green",33:"ansi-yellow",34:"ansi-blue",35:"ansi-purple",36:"ansi-cyan",37:"ansi-white",90:"ansi-dark-gray"};function ae(t){let e=k(t);e=e.replace(/\x1b\[0m/g,"</span>"),e=e.replace(/\x1b\[(\d+)m/g,(o,r)=>{let c=ft[r];return c?`<span class="${c}">`:""});let a=(e.match(/<span/g)||[]).length,i=(e.match(/<\/span/g)||[]).length;return a>i&&(e+="</span>".repeat(a-i)),e}var V=null,J=null,se=!1,ne=!1;async function L(t,e={}){if(V)try{let o=await fetch(V+t,e);if(o.ok)return o;V=null}catch{V=null}let a=ye(),i=mt;try{let o=await fetch(a+t,e);if(o.ok)return V=a,se&&(console.log("\u2728 Production event service restored."),se=!1),o;throw new Error("Primary failed")}catch{se||(console.warn(`\u{1F310} Production service unreachable. Falling back to local: ${i}`),se=!0);try{let r=await fetch(i+t,e);if(r.ok)return V=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}async function ze(t,e={}){if(J)try{let o=await fetch(J+t,e);if(o.ok)return o;J=null}catch{J=null}let a=pt(),i=ut;try{let o=await fetch(a+t,e);if(o.ok)return J=a,ne&&(console.log("\u2728 Production discord service restored."),ne=!1),o;throw new Error("Primary failed")}catch{ne||(console.warn(`\u{1F310} Production discord service unreachable. Falling back to local: ${i}`),ne=!0);try{let r=await fetch(i+t,e);if(r.ok)return J=i,r;throw new Error("Fallback failed")}catch(r){throw r}}}var Ue=()=>`
...
`,oe=null,R=new Set,le=[];async function j(t=!1){let e=document.getElementById("notifications-list");if(!e)return;gt(),t&&(e.innerHTML="<p>Updating...</p>");let a="/events?ml=1000&format=json&event.type=system.notification.generated";try{let i=await L(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];oe=Date.now(),D(0,oe);let c=Date.now(),g=24*60*60*1e3,u=r.filter(d=>{let v=localStorage.getItem(`notification_read_ts_${d.id}`);if(!v)return!0;let x=parseInt(v);return c-x<g});u.sort((d,v)=>{let x=N=>{let _=N.event;if(typeof _=="string")try{_=JSON.parse(_)}catch{return"low"}return(_.priority||"low").toLowerCase()},C=N=>N==="critical"?4:N==="high"?3:N==="medium"?2:1,$=C(x(d)),E=C(x(v));return $!==E?E-$:v.timestamp-d.timestamp}),le=u;let f=d=>{let v=d.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return"low"}return(v.priority||"low").toLowerCase()},b=[],m=new Set(u.map(d=>f(d))).size>1;if(u.length>0){let d=null;u.forEach(v=>{let x=f(v);m&&x!==d&&(b.push({id:`divider-${x}`,type:"divider",label:x.toUpperCase()}),d=x),b.push(v)})}if(t&&(e.innerHTML=""),u.length===0){e.innerHTML=T("empty","No notifications yet."),ie();return}let n=d=>{let v=d.event;if(typeof v=="string")try{v=JSON.parse(v)}catch{return null}let x=v.title||"Untitled Notification",C=v.body||"No description provided.",$=v.priority||"low",E=!!v.alert,N=v.category||"system",_=v.related_event_ids||[],H=!!localStorage.getItem(`notification_read_ts_${d.id}`),P=new Date(d.timestamp*1e3),I=P.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),S=P.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),A=H?"event-border-grey":"event-border-blue";!H&&E&&(A="event-border-red"),H&&($==="high"||$==="critical")?A="event-border-red":H&&$==="medium"&&(A="event-border-orange");let O=H?"notification-read":"notification-unread",M=R.has(d.id),pe=M?"expanded":"",me=M?"display: block;":"display: none;",Se="",ke="";_.length>0&&(ke=`
            ...
            `;let Ce=U.querySelector(".close-details-btn");return Ce&&Ce.addEventListener("click",Q=>{Q.stopPropagation(),U.classList.remove("expanded");let ue=U.querySelector(".event-details");ue&&(ue.style.display="none"),R.delete(d.id)}),U},s=d=>{let v=document.createElement("div");v.className="notification-divider",v.dataset.notificationId=d.id;let x="#888888";return d.label==="CRITICAL"?x="#ff4d4d":d.label==="HIGH"?x="#ff8888":d.label==="MEDIUM"&&(x="#ffa500"),v.style.cssText=`display: flex; align-items: center; gap: 15px; color: ${x}; font-size: 0.7em; font-weight: 700; margin: 20px 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; opacity: 0.8;`,v.innerHTML=`<span style="white-space: nowrap;">${d.label} PRIORITY</span><div style="height: 1px; background: linear-gradient(to right, ${x}44, transparent); flex-grow: 1;"></div>`,v},l=Array.from(e.children),y=new Map(l.map(d=>[d.dataset.notificationId,d])),h=new Set(b.map(d=>d.id));l.forEach(d=>{let v=d.dataset.notificationId;(!v||!h.has(v))&&d.remove()});let w=null;b.forEach((d,v)=>{let x=y.get(d.id);(!x||t)&&(x&&x.remove(),d.type==="divider"?x=s(d):x=n(d),!x)||(v===0?e.firstElementChild!==x&&e.prepend(x):w&&w.nextElementSibling!==x&&w.after(x),w=x)}),oe=Date.now(),D(0,oe),ie()}catch(i){console.error("Error fetching notifications:",i),e.children.length===0&&(e.innerHTML=T("offline","Failed to load notifications.","The event service may be offline or unreachable."))}}function gt(){let t=document.getElementById("notif-read-all"),e=document.getElementById("notif-expand-all"),a=document.getElementById("notif-close-all"),i=document.getElementById("notif-clear");t&&!t.dataset.listenerAttached&&(t.onclick=()=>{le.forEach(o=>{localStorage.getItem(`notification_read_ts_${o.id}`)||localStorage.setItem(`notification_read_ts_${o.id}`,Date.now().toString())}),j(!0)},t.dataset.listenerAttached="true"),e&&!e.dataset.listenerAttached&&(e.onclick=()=>{le.forEach(o=>{R.add(o.id),localStorage.getItem(`notification_read_ts_${o.id}`)||localStorage.setItem(`notification_read_ts_${o.id}`,Date.now().toString())}),j(!0)},e.dataset.listenerAttached="true"),a&&!a.dataset.listenerAttached&&(a.onclick=()=>{R.clear(),j(!0)},a.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.onclick=()=>{let o=Date.now()-1728e5;le.forEach(r=>{localStorage.setItem(`notification_read_ts_${r.id}`,o.toString())}),R.clear(),j(!0)},i.dataset.listenerAttached="true")}var Re=()=>`
  <div class="notifications-actions">
...
`,q=new Set,je=[],K=null;async function F(t=!1){let e=document.getElementById("roadmap-list");if(e){vt();try{let a=await L("/roadmap");if(!a.ok)throw new Error("Offline");let i=await a.json();if(je=i,i.length===0){e.innerHTML=T("empty","Your roadmap is empty.",`Click "New Idea" to start planning Dexter's future.`);return}t&&(e.innerHTML="");let o=f=>{let b=q.has(f.id),p=f.state==="draft",m=f.state==="published",n=f.state==="consumed",s="event-border-grey";m&&(s="event-border-blue"),n&&(s="event-border-purple");let y=new Date(f.created_at*1e3).toLocaleDateString(navigator.language,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),h=document.createElement("div");h.className=`event-item notification-item ${s} cursor-pointer ${b?"expanded":""}`,h.dataset.itemId=f.id,h.onclick=d=>{if(d.target.closest("button"))return;h.classList.contains("expanded")?(h.classList.remove("expanded"),h.querySelector(".event-details").style.display="none",q.delete(f.id)):(h.classList.add("expanded"),h.querySelector(".event-details").style.display="block",q.add(f.id))};let w=`<span style="font-size: 0.7em; opacity: 0.6; margin-left: 10px;">[${f.state.toUpperCase()}]</span>`;return h.innerHTML=`
        <div class="event-time">
...
`,qe=null,Y=new Set,We=[];async function re(t=!1){let e=document.getElementById("blueprints-list");if(!e)return;xt();let a="/events?ml=1000&format=json&event.type=system.blueprint.generated";try{let i=await L(a);if(!i.ok)throw new Error("Service is offline or unreachable.");let r=(await i.json()).events||[];if(We=r,qe=Date.now(),D(2,qe),r.length===0){e.innerHTML=T("empty","No architectural blueprints generated yet.","The Analyst Worker will generate these when idle."),z(1,0);return}t&&(e.innerHTML="");let c=p=>{let m=p.event;if(typeof m=="string")try{m=JSON.parse(m)}catch{return null}let n=m.title||"Untitled Blueprint",s=m.summary||m.body||"No summary provided.",l=m.content||"",y=m.category||"architecture",h=m.affected_services||[],w=m.implementation_path||[],d=new Date(p.timestamp*1e3),v=d.toLocaleTimeString(navigator.language,{hour:"2-digit",minute:"2-digit",second:"2-digit"}),x=d.toLocaleDateString(navigator.language,{month:"short",day:"numeric"}),C=Y.has(p.id),$=C?"display: block;":"display: none;",E=document.createElement("div");E.className=`event-item notification-item event-border-purple cursor-pointer ${C?"expanded":""}`,E.dataset.blueprintId=p.id,E.onclick=function(H){if(this.classList.contains("expanded")){this.classList.remove("expanded"),Y.delete(p.id);let I=this.querySelector(".event-details");I&&(I.style.display="none")}else{this.classList.add("expanded"),Y.add(p.id);let I=this.querySelector(".event-details");I&&(I.style.display="block")}};let N=h.length>0?`<div class="blueprint-meta-row"><strong>Affected:</strong> ${h.join(", ")}</div>`:"",_="";w.length>0&&(_=`
...
`);return`
    ...
    `;async function we(){await Promise.all([at(),_t(),At()]),await xe()}var Qe=null,et=null,tt=null;async function it(){try{return await(await L("/system_monitor")).json()}catch{return null}}async function st(){try{return await(await L("/system/hardware")).json()}catch{return null}}async function kt(){try{return await(await L("/processes")).json()}catch{return null}}async function Ct(){try{return await(await L("/analyst/status")).json()}catch{return null}}async function _t(){let t=document.getElementById("services-widgets"),e=document.getElementById("hardware-info-content"),a=document.getElementById("hardware-refresh-btn"),i=n=>{if(!n){e.innerHTML='<p style="color: #ff4d4d;">Failed to load hardware info.</p>';return}let s="",l=(n.MEMORY_BYTES/(1024*1024*1024)).toFixed(1);if(s+=`
            <div class="service-widget" style="padding: 10px; min-height: 80px;">
                ...
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                ...
                </div>`}if(n.GPU&&n.GPU.length>0&&n.GPU.forEach((y,h)=>{let w=(y.VRAM/1073741824).toFixed(1);s+=`
                    <div class="service-widget" style="padding: 10px; min-height: 80px;">
                        <div class="service-widget-header" style="margin-bottom: 5px;">
                    ...
                    </div>`}),n.STORAGE&&n.STORAGE.length>0){let y=0,h=0;n.STORAGE.forEach(x=>{y+=x.USED,h+=x.SIZE});let w=(y/(1024*1024*1024)).toFixed(1),d=(h/(1024*1024*1024)).toFixed(1),v=h>0?(y/h*100).toFixed(0):0;s+=`
                <div class="service-widget" style="padding: 10px; min-height: 80px;">
                    <div class="service-widget-header" style="margin-bottom: 5px;">
                ...
                </div>`:_='<div class="service-widget-footer offline"><span>OFFLINE</span></div>',`<div class="service-widget ${l}" data-service-id="${n.id}"><div class="service-widget-header"><i class="bx ${y}"></i><h3>${n.short_name||n.id}</h3><span class="service-widget-status">${h}</span></div><div class="service-widget-body"><div class="service-widget-info"><span class="info-label">Address:</span><span class="info-value">${u(n.domain&&n.port?`${n.domain}:${n.port}`:"")}</span></div>${_}</div></div>`}let p=new Map(Array.from(t.querySelectorAll(".service-widget")).map(n=>[n.dataset.serviceId,n])),m=new Set(r.map(n=>n.id));for(let[n,s]of p)m.has(n)||s.remove();r.forEach(n=>{let s=b(n),l=p.get(n.id);l?l.outerHTML!==s&&(l.outerHTML=s):t.insertAdjacentHTML("beforeend",s)})}async function At(){let t=document.getElementById("models-widgets");if(!t)return;let e=await it();if(!e){t.innerHTML=T("offline","Failed to load model status.");return}et=Date.now(),D(3,et);let a=e.models||[],i=e.whisper;Array.from(t.children).forEach(g=>{g.classList.contains("service-widget")||g.remove()});function o(g){let u=g.status==="Ready";return`
...
dex config set <service> <field> <value>`}}],It=()=>{let t={cognitive:{title:"Cognitive Core",icon:"bx-brain",color:"#bb86fc"},lifecycle:{title:"Development Lifecycle",icon:"bx-git-branch",color:"#03dac6"},system:{title:"System Management",icon:"bx-cog",color:"#aaa"}},e=`
